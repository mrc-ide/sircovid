...
// [[dust::param(s_ICU_R, has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE)]]
...
// [[dust::param(gamma_ICU_R, has_default = TRUE, default_value = 0.1, rank = 0, min = -Inf, max = Inf, integer = FALSE)]]
...
// [[dust::param(gamma_stepdown, has_default = TRUE, default_value = 0.1, rank = 0, min = -Inf, max = Inf, integer = FALSE)]]
...
public:
  ...
  struct init_t {
    ...
    int dim_aux_R_stepdown_conf_12;
    int dim_aux_R_stepdown_conf_2;
    int dim_aux_R_stepdown_conf_3;
    int dim_aux_R_stepdown_unconf;
    int dim_aux_R_stepdown_unconf_1;
    int dim_aux_R_stepdown_unconf_12;
    int dim_aux_R_stepdown_unconf_2;
    int dim_aux_R_stepdown_unconf_3;
    int dim_beta_step;
    ...
    int dim_new_R_stepdown_conf_12;
    int dim_new_R_stepdown_conf_2;
    int dim_new_R_stepdown_conf_3;
    int dim_new_R_stepdown_unconf;
    int dim_new_R_stepdown_unconf_1;
    int dim_new_R_stepdown_unconf_12;
    int dim_new_R_stepdown_unconf_2;
    int dim_new_R_stepdown_unconf_3;
    ...
    int dim_R_stepdown_conf_12;
    int dim_R_stepdown_conf_2;
    int dim_R_stepdown_conf_3;
    int dim_R_stepdown_unconf;
    int dim_R_stepdown_unconf_1;
    int dim_R_stepdown_unconf_12;
    int dim_R_stepdown_unconf_2;
    int dim_R_stepdown_unconf_3;
  ...
  void update(size_t step, const real_t * state, dust::rng_state_t<real_t>& rng_state, real_t * state_next) {
    ...
    for (int i = 1; i <= internal.dim_n_R_stepdown_conf_1; ++i) {
      for (int j = 1; j <= internal.dim_n_R_stepdown_conf_2; ++j) {
        for (int k = 1; k <= internal.dim_n_R_stepdown_conf_3; ++k) {
          internal.n_R_stepdown_conf[i - 1 + internal.dim_n_R_stepdown_conf_1 * (j - 1) + internal.dim_n_R_stepdown_conf_12 * (k - 1)] = dust::distr::rbinom(rng_state, std::round(R_stepdown_conf[internal.dim_R_stepdown_conf_12 * (k - 1) + internal.dim_R_stepdown_conf_1 * (j - 1) + i - 1]), internal.p_R_stepdown);
        }
      }
    }
    for (int i = 1; i <= internal.dim_n_R_stepdown_unconf_1; ++i) {
      for (int j = 1; j <= internal.dim_n_R_stepdown_unconf_2; ++j) {
        for (int k = 1; k <= internal.dim_n_R_stepdown_unconf_3; ++k) {
          internal.n_R_stepdown_unconf[i - 1 + internal.dim_n_R_stepdown_unconf_1 * (j - 1) + internal.dim_n_R_stepdown_unconf_12 * (k - 1)] = dust::distr::rbinom(rng_state, std::round(R_stepdown_unconf[internal.dim_R_stepdown_unconf_12 * (k - 1) + internal.dim_R_stepdown_unconf_1 * (j - 1) + i - 1]), internal.p_R_stepdown);
        }
      }
    }
    ...
    for (int i = 1; i <= internal.dim_aux_R_stepdown_conf_1; ++i) {
      for (int j = 1; j <= internal.dim_aux_R_stepdown_conf_2; ++j) {
        for (int k = 1; k <= internal.dim_aux_R_stepdown_conf_3; ++k) {
          internal.aux_R_stepdown_conf[i - 1 + internal.dim_aux_R_stepdown_conf_1 * (j - 1) + internal.dim_aux_R_stepdown_conf_12 * (k - 1)] = R_stepdown_conf[internal.dim_R_stepdown_conf_12 * (k - 1) + internal.dim_R_stepdown_conf_1 * (j - 1) + i - 1];
        }
      }
    }
    for (int i = 1; i <= internal.dim_aux_R_stepdown_conf_1; ++i) {
      int j = 1;
      for (int k = 1; k <= internal.dim_aux_R_stepdown_conf_3; ++k) {
        internal.aux_R_stepdown_conf[i - 1 + internal.dim_aux_R_stepdown_conf_1 * (j - 1) + internal.dim_aux_R_stepdown_conf_12 * (k - 1)] = internal.aux_R_stepdown_conf[internal.dim_aux_R_stepdown_conf_12 * (k - 1) + internal.dim_aux_R_stepdown_conf_1 * (j - 1) + i - 1] + internal.n_II_ICU_R_conf[internal.dim_n_II_ICU_R_conf_12 * (k - 1) + internal.dim_n_II_ICU_R_conf_1 * (internal.s_ICU_R - 1) + i - 1];
      }
    }
    for (int i = 1; i <= internal.dim_aux_R_stepdown_conf_1; ++i) {
      for (int j = 2; j <= internal.s_stepdown; ++j) {
        for (int k = 1; k <= internal.dim_aux_R_stepdown_conf_3; ++k) {
          internal.aux_R_stepdown_conf[i - 1 + internal.dim_aux_R_stepdown_conf_1 * (j - 1) + internal.dim_aux_R_stepdown_conf_12 * (k - 1)] = internal.aux_R_stepdown_conf[internal.dim_aux_R_stepdown_conf_12 * (k - 1) + internal.dim_aux_R_stepdown_conf_1 * (j - 1) + i - 1] + internal.n_R_stepdown_conf[internal.dim_n_R_stepdown_conf_12 * (k - 1) + internal.dim_n_R_stepdown_conf_1 * (j - 1 - 1) + i - 1];
        }
      }
    }
    for (int i = 1; i <= internal.dim_aux_R_stepdown_conf_1; ++i) {
      for (int j = 1; j <= internal.s_stepdown; ++j) {
        for (int k = 1; k <= internal.dim_aux_R_stepdown_conf_3; ++k) {
          internal.aux_R_stepdown_conf[i - 1 + internal.dim_aux_R_stepdown_conf_1 * (j - 1) + internal.dim_aux_R_stepdown_conf_12 * (k - 1)] = internal.aux_R_stepdown_conf[internal.dim_aux_R_stepdown_conf_12 * (k - 1) + internal.dim_aux_R_stepdown_conf_1 * (j - 1) + i - 1] - internal.n_R_stepdown_conf[internal.dim_n_R_stepdown_conf_12 * (k - 1) + internal.dim_n_R_stepdown_conf_1 * (j - 1) + i - 1];
        }
      }
    }
    for (int i = 1; i <= internal.dim_aux_R_stepdown_unconf_1; ++i) {
      for (int j = 1; j <= internal.dim_aux_R_stepdown_unconf_2; ++j) {
        for (int k = 1; k <= internal.dim_aux_R_stepdown_unconf_3; ++k) {
          internal.aux_R_stepdown_unconf[i - 1 + internal.dim_aux_R_stepdown_unconf_1 * (j - 1) + internal.dim_aux_R_stepdown_unconf_12 * (k - 1)] = R_stepdown_unconf[internal.dim_R_stepdown_unconf_12 * (k - 1) + internal.dim_R_stepdown_unconf_1 * (j - 1) + i - 1];
        }
      }
    }
    for (int i = 1; i <= internal.dim_aux_R_stepdown_unconf_1; ++i) {
      int j = 1;
      for (int k = 1; k <= internal.dim_aux_R_stepdown_unconf_3; ++k) {
        internal.aux_R_stepdown_unconf[i - 1 + internal.dim_aux_R_stepdown_unconf_1 * (j - 1) + internal.dim_aux_R_stepdown_unconf_12 * (k - 1)] = internal.aux_R_stepdown_unconf[internal.dim_aux_R_stepdown_unconf_12 * (k - 1) + internal.dim_aux_R_stepdown_unconf_1 * (j - 1) + i - 1] + internal.n_II_ICU_R_unconf[internal.dim_n_II_ICU_R_unconf_12 * (k - 1) + internal.dim_n_II_ICU_R_unconf_1 * (internal.s_ICU_R - 1) + i - 1];
      }
    }
    for (int i = 1; i <= internal.dim_aux_R_stepdown_unconf_1; ++i) {
      for (int j = 2; j <= internal.s_stepdown; ++j) {
        for (int k = 1; k <= internal.dim_aux_R_stepdown_unconf_3; ++k) {
          internal.aux_R_stepdown_unconf[i - 1 + internal.dim_aux_R_stepdown_unconf_1 * (j - 1) + internal.dim_aux_R_stepdown_unconf_12 * (k - 1)] = internal.aux_R_stepdown_unconf[internal.dim_aux_R_stepdown_unconf_12 * (k - 1) + internal.dim_aux_R_stepdown_unconf_1 * (j - 1) + i - 1] + internal.n_R_stepdown_unconf[internal.dim_n_R_stepdown_unconf_12 * (k - 1) + internal.dim_n_R_stepdown_unconf_1 * (j - 1 - 1) + i - 1];
        }
      }
    }
    for (int i = 1; i <= internal.dim_aux_R_stepdown_unconf_1; ++i) {
      for (int j = 1; j <= internal.s_stepdown; ++j) {
        for (int k = 1; k <= internal.dim_aux_R_stepdown_unconf_3; ++k) {
          internal.aux_R_stepdown_unconf[i - 1 + internal.dim_aux_R_stepdown_unconf_1 * (j - 1) + internal.dim_aux_R_stepdown_unconf_12 * (k - 1)] = internal.aux_R_stepdown_unconf[internal.dim_aux_R_stepdown_unconf_12 * (k - 1) + internal.dim_aux_R_stepdown_unconf_1 * (j - 1) + i - 1] - internal.n_R_stepdown_unconf[internal.dim_n_R_stepdown_unconf_12 * (k - 1) + internal.dim_n_R_stepdown_unconf_1 * (j - 1) + i - 1];
        }
      }
    }
    ...
    for (int i = 1; i <= internal.dim_delta_R_1; ++i) {
      for (int j = 1; j <= internal.dim_delta_R_2; ++j) {
        internal.delta_R[i - 1 + internal.dim_delta_R_1 * (j - 1)] = internal.n_II_asympt[internal.dim_n_II_asympt_12 * (j - 1) + internal.dim_n_II_asympt_1 * (internal.s_asympt - 1) + i - 1] + internal.n_II_mild[internal.dim_n_II_mild_12 * (j - 1) + internal.dim_n_II_mild_1 * (internal.s_mild - 1) + i - 1] + internal.n_ILI_to_R[internal.dim_n_ILI_to_R_1 * (j - 1) + i - 1] + internal.n_II_hosp_R_conf[internal.dim_n_II_hosp_R_conf_12 * (j - 1) + internal.dim_n_II_hosp_R_conf_1 * (internal.s_hosp_R - 1) + i - 1] + internal.n_II_hosp_R_unconf[internal.dim_n_II_hosp_R_unconf_12 * (j - 1) + internal.dim_n_II_hosp_R_unconf_1 * (internal.s_hosp_R - 1) + i - 1] + internal.n_R_stepdown_conf[internal.dim_n_R_stepdown_conf_12 * (j - 1) + internal.dim_n_R_stepdown_conf_1 * (internal.s_stepdown - 1) + i - 1] + internal.n_R_stepdown_unconf[internal.dim_n_R_stepdown_unconf_12 * (j - 1) + internal.dim_n_R_stepdown_unconf_1 * (internal.s_stepdown - 1) + i - 1];
      }
    }
    ...
    for (int i = 1; i <= internal.dim_n_R_stepdown_unconf_to_conf_1; ++i) {
      for (int j = 1; j <= internal.dim_n_R_stepdown_unconf_to_conf_2; ++j) {
        for (int k = 1; k <= internal.dim_n_R_stepdown_unconf_to_conf_3; ++k) {
          internal.n_R_stepdown_unconf_to_conf[i - 1 + internal.dim_n_R_stepdown_unconf_to_conf_1 * (j - 1) + internal.dim_n_R_stepdown_unconf_to_conf_12 * (k - 1)] = dust::distr::rbinom(rng_state, std::round(internal.aux_R_stepdown_unconf[internal.dim_aux_R_stepdown_unconf_12 * (k - 1) + internal.dim_aux_R_stepdown_unconf_1 * (j - 1) + i - 1]), internal.p_test);
        }
      }
    }
    ...
    for (int i = 1; i <= internal.dim_new_R_stepdown_conf_1; ++i) {
      for (int j = 1; j <= internal.dim_new_R_stepdown_conf_2; ++j) {
        for (int k = 1; k <= internal.dim_new_R_stepdown_conf_3; ++k) {
          internal.new_R_stepdown_conf[i - 1 + internal.dim_new_R_stepdown_conf_1 * (j - 1) + internal.dim_new_R_stepdown_conf_12 * (k - 1)] = internal.aux_R_stepdown_conf[internal.dim_aux_R_stepdown_conf_12 * (k - 1) + internal.dim_aux_R_stepdown_conf_1 * (j - 1) + i - 1] + internal.n_R_stepdown_unconf_to_conf[internal.dim_n_R_stepdown_unconf_to_conf_12 * (k - 1) + internal.dim_n_R_stepdown_unconf_to_conf_1 * (j - 1) + i - 1];
        }
      }
    }
    for (int i = 1; i <= internal.dim_new_R_stepdown_unconf_1; ++i) {
      for (int j = 1; j <= internal.dim_new_R_stepdown_unconf_2; ++j) {
        for (int k = 1; k <= internal.dim_new_R_stepdown_unconf_3; ++k) {
          internal.new_R_stepdown_unconf[i - 1 + internal.dim_new_R_stepdown_unconf_1 * (j - 1) + internal.dim_new_R_stepdown_unconf_12 * (k - 1)] = internal.aux_R_stepdown_unconf[internal.dim_aux_R_stepdown_unconf_12 * (k - 1) + internal.dim_aux_R_stepdown_unconf_1 * (j - 1) + i - 1] - internal.n_R_stepdown_unconf_to_conf[internal.dim_n_R_stepdown_unconf_to_conf_12 * (k - 1) + internal.dim_n_R_stepdown_unconf_to_conf_1 * (j - 1) + i - 1];
        }
      }
    }
    ...
    for (int i = 1; i <= internal.dim_R_stepdown_conf_1; ++i) {
      for (int j = 1; j <= internal.dim_R_stepdown_conf_2; ++j) {
        for (int k = 1; k <= internal.dim_R_stepdown_conf_3; ++k) {
          state_next[internal.offset_variable_R_stepdown_conf + i - 1 + internal.dim_R_stepdown_conf_1 * (j - 1) + internal.dim_R_stepdown_conf_12 * (k - 1)] = internal.new_R_stepdown_conf[internal.dim_new_R_stepdown_conf_12 * (k - 1) + internal.dim_new_R_stepdown_conf_1 * (j - 1) + i - 1];
        }
      }
    }
    for (int i = 1; i <= internal.dim_R_stepdown_unconf_1; ++i) {
      for (int j = 1; j <= internal.dim_R_stepdown_unconf_2; ++j) {
        for (int k = 1; k <= internal.dim_R_stepdown_unconf_3; ++k) {
          state_next[internal.offset_variable_R_stepdown_unconf + i - 1 + internal.dim_R_stepdown_unconf_1 * (j - 1) + internal.dim_R_stepdown_unconf_12 * (k - 1)] = internal.new_R_stepdown_unconf[internal.dim_new_R_stepdown_unconf_12 * (k - 1) + internal.dim_new_R_stepdown_unconf_1 * (j - 1) + i - 1];
        }
      }
    }
...
carehomes::init_t dust_data<carehomes>(cpp11::list user) {
  ...
  internal.s_ICU_R = user_get_scalar<int>(user, "s_ICU_R", internal.s_ICU_R, NA_REAL, NA_REAL);
  ...
  internal.dim_aux_II_ICU_R_conf_3 = internal.n_vacc_classes;
  internal.dim_aux_II_ICU_R_unconf_1 = internal.n_groups;
  internal.dim_aux_II_ICU_R_unconf_2 = internal.s_ICU_R;
  internal.dim_aux_II_ICU_R_unconf_3 = internal.n_vacc_classes;
  ...
  internal.dim_I_ICU_R_conf_3 = internal.n_vacc_classes;
  internal.dim_I_ICU_R_unconf_1 = internal.n_groups;
  internal.dim_I_ICU_R_unconf_2 = internal.s_ICU_R;
  internal.dim_I_ICU_R_unconf_3 = internal.n_vacc_classes;
  ...
  internal.dim_n_II_ICU_R_conf_3 = internal.n_vacc_classes;
  internal.dim_n_II_ICU_R_unconf_1 = internal.n_groups;
  internal.dim_n_II_ICU_R_unconf_2 = internal.s_ICU_R;
  internal.dim_n_II_ICU_R_unconf_3 = internal.n_vacc_classes;
  ...
  internal.dim_n_ILI_to_triage_D_2 = internal.n_vacc_classes;
  internal.dim_n_ILI_to_triage_D_conf_1 = internal.n_groups;
  internal.dim_n_ILI_to_triage_D_conf_2 = internal.n_vacc_classes;
  internal.dim_n_ILI_to_triage_R_1 = internal.n_groups;
  internal.dim_n_ILI_to_triage_R_2 = internal.n_vacc_classes;
  ...
  internal.dim_n_R_stepdown_conf_3 = internal.n_vacc_classes;
  internal.dim_n_R_stepdown_unconf_1 = internal.n_groups;
  internal.dim_n_R_stepdown_unconf_2 = internal.s_stepdown;
  internal.dim_n_R_stepdown_unconf_3 = internal.n_vacc_classes;
  ...
  internal.dim_n_R_stepdown_unconf_to_conf_3 = internal.n_vacc_classes;
  ...
  internal.dim_new_I_ICU_R_conf_3 = internal.n_vacc_classes;
  internal.dim_new_I_ICU_R_unconf_1 = internal.n_groups;
  internal.dim_new_I_ICU_R_unconf_2 = internal.s_ICU_R;
  internal.dim_new_I_ICU_R_unconf_3 = internal.n_vacc_classes;
  ...
  internal.dim_new_R_stepdown_conf_3 = internal.n_vacc_classes;
  internal.dim_new_R_stepdown_unconf_1 = internal.n_groups;
  internal.dim_new_R_stepdown_unconf_2 = internal.s_stepdown;
  internal.dim_new_R_stepdown_unconf_3 = internal.n_vacc_classes;
  ...
  internal.dim_R_stepdown_conf_3 = internal.n_vacc_classes;
  internal.dim_R_stepdown_unconf_1 = internal.n_groups;
  internal.dim_R_stepdown_unconf_2 = internal.s_stepdown;
  internal.dim_R_stepdown_unconf_3 = internal.n_vacc_classes;
  ...
  internal.dim_aux_R_stepdown_conf = internal.dim_aux_R_stepdown_conf_1 * internal.dim_aux_R_stepdown_conf_2 * internal.dim_aux_R_stepdown_conf_3;
  internal.dim_aux_R_stepdown_conf_12 = internal.dim_aux_R_stepdown_conf_1 * internal.dim_aux_R_stepdown_conf_2;
  internal.dim_aux_R_stepdown_unconf = internal.dim_aux_R_stepdown_unconf_1 * internal.dim_aux_R_stepdown_unconf_2 * internal.dim_aux_R_stepdown_unconf_3;
  internal.dim_aux_R_stepdown_unconf_12 = internal.dim_aux_R_stepdown_unconf_1 * internal.dim_aux_R_stepdown_unconf_2;
  ...
  internal.dim_n_R_stepdown_conf = internal.dim_n_R_stepdown_conf_1 * internal.dim_n_R_stepdown_conf_2 * internal.dim_n_R_stepdown_conf_3;
  internal.dim_n_R_stepdown_conf_12 = internal.dim_n_R_stepdown_conf_1 * internal.dim_n_R_stepdown_conf_2;
  internal.dim_n_R_stepdown_unconf = internal.dim_n_R_stepdown_unconf_1 * internal.dim_n_R_stepdown_unconf_2 * internal.dim_n_R_stepdown_unconf_3;
  internal.dim_n_R_stepdown_unconf_12 = internal.dim_n_R_stepdown_unconf_1 * internal.dim_n_R_stepdown_unconf_2;
  internal.dim_n_R_stepdown_unconf_to_conf = internal.dim_n_R_stepdown_unconf_to_conf_1 * internal.dim_n_R_stepdown_unconf_to_conf_2 * internal.dim_n_R_stepdown_unconf_to_conf_3;
  internal.dim_n_R_stepdown_unconf_to_conf_12 = internal.dim_n_R_stepdown_unconf_to_conf_1 * internal.dim_n_R_stepdown_unconf_to_conf_2;
  ...
  internal.dim_new_R_stepdown_conf = internal.dim_new_R_stepdown_conf_1 * internal.dim_new_R_stepdown_conf_2 * internal.dim_new_R_stepdown_conf_3;
  internal.dim_new_R_stepdown_conf_12 = internal.dim_new_R_stepdown_conf_1 * internal.dim_new_R_stepdown_conf_2;
  internal.dim_new_R_stepdown_unconf = internal.dim_new_R_stepdown_unconf_1 * internal.dim_new_R_stepdown_unconf_2 * internal.dim_new_R_stepdown_unconf_3;
  internal.dim_new_R_stepdown_unconf_12 = internal.dim_new_R_stepdown_unconf_1 * internal.dim_new_R_stepdown_unconf_2;
  ...
  internal.dim_R_stepdown_conf = internal.dim_R_stepdown_conf_1 * internal.dim_R_stepdown_conf_2 * internal.dim_R_stepdown_conf_3;
  internal.dim_R_stepdown_conf_12 = internal.dim_R_stepdown_conf_1 * internal.dim_R_stepdown_conf_2;
  internal.dim_R_stepdown_unconf = internal.dim_R_stepdown_unconf_1 * internal.dim_R_stepdown_unconf_2 * internal.dim_R_stepdown_unconf_3;
  internal.dim_R_stepdown_unconf_12 = internal.dim_R_stepdown_unconf_1 * internal.dim_R_stepdown_unconf_2;
  ...
  for (int i = 1; i <= internal.dim_R_stepdown_conf_1; ++i) {
    for (int j = 1; j <= internal.dim_R_stepdown_conf_2; ++j) {
      for (int k = 1; k <= internal.dim_R_stepdown_conf_3; ++k) {
        internal.initial_R_stepdown_conf[i - 1 + internal.dim_R_stepdown_conf_1 * (j - 1) + internal.dim_R_stepdown_conf_12 * (k - 1)] = 0;
      }
    }
  }
  for (int i = 1; i <= internal.dim_R_stepdown_unconf_1; ++i) {
    for (int j = 1; j <= internal.dim_R_stepdown_unconf_2; ++j) {
      for (int k = 1; k <= internal.dim_R_stepdown_unconf_3; ++k) {
        internal.initial_R_stepdown_unconf[i - 1 + internal.dim_R_stepdown_unconf_1 * (j - 1) + internal.dim_R_stepdown_unconf_12 * (k - 1)] = 0;
      }
    }
  }
  for (int i = 1; i <= internal.dim_S_1; ++i) {
  ...
  internal.offset_variable_I_ICU_R_conf = 17 + internal.dim_D_hosp + internal.dim_D_comm + internal.dim_cum_admit_by_age + internal.dim_N_tot + internal.dim_S + internal.dim_R_neg + internal.dim_R + internal.dim_PCR_neg + internal.dim_E + internal.dim_I_asympt + internal.dim_I_mild + internal.dim_I_ILI + internal.dim_I_comm_D + internal.dim_I_triage_R_unconf + internal.dim_I_triage_R_conf + internal.dim_I_triage_D_unconf + internal.dim_I_triage_D_conf + internal.dim_I_hosp_R_unconf + internal.dim_I_hosp_R_conf + internal.dim_I_hosp_D_unconf + internal.dim_I_hosp_D_conf + internal.dim_I_ICU_R_unconf;
  internal.offset_variable_I_ICU_R_unconf = 17 + internal.dim_D_hosp + internal.dim_D_comm + internal.dim_cum_admit_by_age + internal.dim_N_tot + internal.dim_S + internal.dim_R_neg + internal.dim_R + internal.dim_PCR_neg + internal.dim_E + internal.dim_I_asympt + internal.dim_I_mild + internal.dim_I_ILI + internal.dim_I_comm_D + internal.dim_I_triage_R_unconf + internal.dim_I_triage_R_conf + internal.dim_I_triage_D_unconf + internal.dim_I_triage_D_conf + internal.dim_I_hosp_R_unconf + internal.dim_I_hosp_R_conf + internal.dim_I_hosp_D_unconf + internal.dim_I_hosp_D_conf;
  ...
  internal.offset_variable_I_triage_D_conf = 17 + internal.dim_D_hosp + internal.dim_D_comm + internal.dim_cum_admit_by_age + internal.dim_N_tot + internal.dim_S + internal.dim_R_neg + internal.dim_R + internal.dim_PCR_neg + internal.dim_E + internal.dim_I_asympt + internal.dim_I_mild + internal.dim_I_ILI + internal.dim_I_comm_D + internal.dim_I_triage_R_unconf + internal.dim_I_triage_R_conf + internal.dim_I_triage_D_unconf;
  internal.offset_variable_I_triage_D_unconf = 17 + internal.dim_D_hosp + internal.dim_D_comm + internal.dim_cum_admit_by_age + internal.dim_N_tot + internal.dim_S + internal.dim_R_neg + internal.dim_R + internal.dim_PCR_neg + internal.dim_E + internal.dim_I_asympt + internal.dim_I_mild + internal.dim_I_ILI + internal.dim_I_comm_D + internal.dim_I_triage_R_unconf + internal.dim_I_triage_R_conf;
  internal.offset_variable_I_triage_R_conf = 17 + internal.dim_D_hosp + internal.dim_D_comm + internal.dim_cum_admit_by_age + internal.dim_N_tot + internal.dim_S + internal.dim_R_neg + internal.dim_R + internal.dim_PCR_neg + internal.dim_E + internal.dim_I_asympt + internal.dim_I_mild + internal.dim_I_ILI + internal.dim_I_comm_D + internal.dim_I_triage_R_unconf;
  internal.offset_variable_I_triage_R_unconf = 17 + internal.dim_D_hosp + internal.dim_D_comm + internal.dim_cum_admit_by_age + internal.dim_N_tot + internal.dim_S + internal.dim_R_neg + internal.dim_R + internal.dim_PCR_neg + internal.dim_E + internal.dim_I_asympt + internal.dim_I_mild + internal.dim_I_ILI + internal.dim_I_comm_D;
  ...
  internal.offset_variable_R_stepdown_conf = 17 + internal.dim_D_hosp + internal.dim_D_comm + internal.dim_cum_admit_by_age + internal.dim_N_tot + internal.dim_S + internal.dim_R_neg + internal.dim_R + internal.dim_PCR_neg + internal.dim_E + internal.dim_I_asympt + internal.dim_I_mild + internal.dim_I_ILI + internal.dim_I_comm_D + internal.dim_I_triage_R_unconf + internal.dim_I_triage_R_conf + internal.dim_I_triage_D_unconf + internal.dim_I_triage_D_conf + internal.dim_I_hosp_R_unconf + internal.dim_I_hosp_R_conf + internal.dim_I_hosp_D_unconf + internal.dim_I_hosp_D_conf + internal.dim_I_ICU_R_unconf + internal.dim_I_ICU_R_conf + internal.dim_I_ICU_D_unconf + internal.dim_I_ICU_D_conf + internal.dim_R_stepdown_unconf;
  internal.offset_variable_R_stepdown_unconf = 17 + internal.dim_D_hosp + internal.dim_D_comm + internal.dim_cum_admit_by_age + internal.dim_N_tot + internal.dim_S + internal.dim_R_neg + internal.dim_R + internal.dim_PCR_neg + internal.dim_E + internal.dim_I_asympt + internal.dim_I_mild + internal.dim_I_ILI + internal.dim_I_comm_D + internal.dim_I_triage_R_unconf + internal.dim_I_triage_R_conf + internal.dim_I_triage_D_unconf + internal.dim_I_triage_D_conf + internal.dim_I_hosp_R_unconf + internal.dim_I_hosp_R_conf + internal.dim_I_hosp_D_unconf + internal.dim_I_hosp_D_conf + internal.dim_I_ICU_R_unconf + internal.dim_I_ICU_R_conf + internal.dim_I_ICU_D_unconf + internal.dim_I_ICU_D_conf;
...
cpp11::sexp dust_info<carehomes>(const carehomes::init_t& internal) {
  cpp11::writable::strings nms({"time", "cum_infections", "cum_admit_conf", "cum_new_conf", "beta_out", "N_tot2", "N_tot3", "I_ICU_tot", "general_tot", "hosp_tot", "D_hosp_tot", "D_comm_tot", "D_tot", "sero_pos", "cum_sympt_cases", "cum_sympt_cases_over25", "react_pos", "D_hosp", "D_comm", "cum_admit_by_age", "N_tot", "S", "R_neg", "R", "PCR_neg", "E", "I_asympt", "I_mild", "I_ILI", "I_comm_D", "I_triage_R_unconf", "I_triage_R_conf", "I_triage_D_unconf", "I_triage_D_conf", "I_hosp_R_unconf", "I_hosp_R_conf", "I_hosp_D_unconf", "I_hosp_D_conf", "I_ICU_R_unconf", "I_ICU_R_conf", "I_ICU_D_unconf", "I_ICU_D_conf", "R_stepdown_unconf", "R_stepdown_conf", "R_pre", "R_pos", "PCR_pre", "PCR_pos"});
  ...
  dim[42] = cpp11::writable::integers({internal.dim_R_stepdown_unconf_1, internal.dim_R_stepdown_unconf_2, internal.dim_R_stepdown_unconf_3});
  dim[43] = cpp11::writable::integers({internal.dim_R_stepdown_conf_1, internal.dim_R_stepdown_conf_2, internal.dim_R_stepdown_conf_3});
  dim[44] = cpp11::writable::integers({internal.dim_R_pre_1, internal.dim_R_pre_2, internal.dim_R_pre_3});
  dim[45] = cpp11::writable::integers({internal.dim_R_pos_1, internal.dim_R_pos_2, internal.dim_R_pos_3});
  dim[46] = cpp11::writable::integers({internal.dim_PCR_pre_1, internal.dim_PCR_pre_2, internal.dim_PCR_pre_3});
  dim[47] = cpp11::writable::integers({internal.dim_PCR_pos_1, internal.dim_PCR_pos_2, internal.dim_PCR_pos_3});
  dim.names() = nms;
  ...
  index[42] = integer_sequence(internal.offset_variable_R_stepdown_unconf + 1, internal.dim_R_stepdown_unconf);
  index[43] = integer_sequence(internal.offset_variable_R_stepdown_conf + 1, internal.dim_R_stepdown_conf);
  index[44] = integer_sequence(internal.offset_variable_R_pre + 1, internal.dim_R_pre);
  index[45] = integer_sequence(internal.offset_variable_R_pos + 1, internal.dim_R_pos);
  index[46] = integer_sequence(internal.offset_variable_PCR_pre + 1, internal.dim_PCR_pre);
  index[47] = integer_sequence(internal.offset_variable_PCR_pos + 1, internal.dim_PCR_pos);
  index.names() = nms;
