...
public:
  ...
  struct shared_t {
    ...
    std::vector<real_t> initial_cum_D_by_age;
    ...
    int offset_variable_cum_D_by_age;
  ...
  std::vector<real_t> initial(size_t step) {
    ...
    std::copy(shared->initial_cum_D_by_age.begin(), shared->initial_cum_D_by_age.end(), state.begin() + shared->offset_variable_cum_D_by_age);
  ...
  void update(size_t step, const real_t * state, dust::rng_state_t<real_t>& rng_state, real_t * state_next) {
    ...
    const real_t * cum_D_by_age = state + shared->offset_variable_cum_D_by_age;
    ...
    for (int i = 1; i <= shared->dim_cum_D_by_age; ++i) {
      state_next[shared->offset_variable_cum_D_by_age + i - 1] = cum_D_by_age[i - 1] + odin_sum3(internal.n_I_C_to_H_D.data(), i - 1, i, 0, shared->dim_n_I_C_to_H_D_2, 0, shared->dim_n_I_C_to_H_D_3, shared->dim_n_I_C_to_H_D_1, shared->dim_n_I_C_to_H_D_12) + odin_sum3(internal.n_I_C_to_H_D_conf.data(), i - 1, i, 0, shared->dim_n_I_C_to_H_D_conf_2, 0, shared->dim_n_I_C_to_H_D_conf_3, shared->dim_n_I_C_to_H_D_conf_1, shared->dim_n_I_C_to_H_D_conf_12) + odin_sum3(internal.n_ICU_pre_unconf_to_ICU_D_unconf.data(), i - 1, i, 0, shared->dim_n_ICU_pre_unconf_to_ICU_D_unconf_2, 0, shared->dim_n_ICU_pre_unconf_to_ICU_D_unconf_3, shared->dim_n_ICU_pre_unconf_to_ICU_D_unconf_1, shared->dim_n_ICU_pre_unconf_to_ICU_D_unconf_12) + odin_sum3(internal.n_ICU_pre_conf_to_ICU_D_conf.data(), i - 1, i, 0, shared->dim_n_ICU_pre_conf_to_ICU_D_conf_2, 0, shared->dim_n_ICU_pre_conf_to_ICU_D_conf_3, shared->dim_n_ICU_pre_conf_to_ICU_D_conf_1, shared->dim_n_ICU_pre_conf_to_ICU_D_conf_12) + odin_sum3(internal.n_ICU_pre_unconf_to_ICU_W_D_unconf.data(), i - 1, i, 0, shared->dim_n_ICU_pre_unconf_to_ICU_W_D_unconf_2, 0, shared->dim_n_ICU_pre_unconf_to_ICU_W_D_unconf_3, shared->dim_n_ICU_pre_unconf_to_ICU_W_D_unconf_1, shared->dim_n_ICU_pre_unconf_to_ICU_W_D_unconf_12) + odin_sum3(internal.n_ICU_pre_conf_to_ICU_W_D_conf.data(), i - 1, i, 0, shared->dim_n_ICU_pre_conf_to_ICU_W_D_conf_2, 0, shared->dim_n_ICU_pre_conf_to_ICU_W_D_conf_3, shared->dim_n_ICU_pre_conf_to_ICU_W_D_conf_1, shared->dim_n_ICU_pre_conf_to_ICU_W_D_conf_12);
    }
...
dust::pars_t<carehomes> dust_pars<carehomes>(cpp11::list user) {
  ...
  shared->dim_cum_D_by_age = shared->n_groups;
  ...
  shared->initial_cum_D_by_age = std::vector<real_t>(shared->dim_cum_D_by_age);
  ...
  for (int i = 1; i <= shared->dim_cum_D_by_age; ++i) {
    shared->initial_cum_D_by_age[i - 1] = 0;
  }
  for (int i = 1; i <= shared->dim_cum_admit_by_age; ++i) {
  ...
  shared->offset_variable_N_tot = 25 + shared->dim_cum_infections_per_strain + shared->dim_D_hosp + shared->dim_D_comm + shared->dim_cum_admit_by_age + shared->dim_cum_D_by_age;
  shared->offset_variable_cum_D_by_age = 25 + shared->dim_cum_infections_per_strain + shared->dim_D_hosp + shared->dim_D_comm + shared->dim_cum_admit_by_age;
  shared->offset_variable_cum_admit_by_age = 25 + shared->dim_cum_infections_per_strain + shared->dim_D_hosp + shared->dim_D_comm;
  shared->offset_variable_cum_n_S_vaccinated = 25 + shared->dim_cum_infections_per_strain + shared->dim_D_hosp + shared->dim_D_comm + shared->dim_cum_admit_by_age + shared->dim_cum_D_by_age + shared->dim_N_tot;
  ...
  shared->offset_variable_S = 25 + shared->dim_cum_infections_per_strain + shared->dim_D_hosp + shared->dim_D_comm + shared->dim_cum_admit_by_age + shared->dim_cum_D_by_age + shared->dim_N_tot + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_vaccinated;
  ...
  shared->offset_variable_cum_n_E_vaccinated = 25 + shared->dim_cum_infections_per_strain + shared->dim_D_hosp + shared->dim_D_comm + shared->dim_cum_admit_by_age + shared->dim_cum_D_by_age + shared->dim_N_tot + shared->dim_cum_n_S_vaccinated;
  shared->offset_variable_cum_n_I_A_vaccinated = 25 + shared->dim_cum_infections_per_strain + shared->dim_D_hosp + shared->dim_D_comm + shared->dim_cum_admit_by_age + shared->dim_cum_D_by_age + shared->dim_N_tot + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_E_vaccinated;
  shared->offset_variable_cum_n_R_vaccinated = 25 + shared->dim_cum_infections_per_strain + shared->dim_D_hosp + shared->dim_D_comm + shared->dim_cum_admit_by_age + shared->dim_cum_D_by_age + shared->dim_N_tot + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated;
  shared->offset_variable_cum_n_vaccinated = 25 + shared->dim_cum_infections_per_strain + shared->dim_D_hosp + shared->dim_D_comm + shared->dim_cum_admit_by_age + shared->dim_cum_D_by_age + shared->dim_N_tot + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_R_vaccinated;
...
cpp11::sexp dust_info<carehomes>(const dust::pars_t<carehomes>& pars) {
  ...
  cpp11::writable::strings nms({"time", "admit_conf_inc", "new_conf_inc", "cum_infections", "cum_admit_conf", "cum_new_conf", "beta_out", "N_tot2", "N_tot3", "ICU_tot", "general_tot", "hosp_tot", "D_hosp_tot", "D_comm_tot", "D_comm_inc", "D_hosp_inc", "D_tot", "sero_pos", "cum_sympt_cases", "cum_sympt_cases_over25", "cum_sympt_cases_non_variant_over25", "sympt_cases_inc", "sympt_cases_over25_inc", "sympt_cases_non_variant_over25_inc", "react_pos", "cum_infections_per_strain", "D_hosp", "D_comm", "cum_admit_by_age", "cum_D_by_age", "N_tot", "cum_n_S_vaccinated", "cum_n_E_vaccinated", "cum_n_I_A_vaccinated", "cum_n_R_vaccinated", "cum_n_vaccinated", "S", "prob_strain", "I_weighted", "T_sero_neg", "R", "T_PCR_neg", "E", "I_A", "I_C", "G_D", "ICU_pre_unconf", "ICU_pre_conf", "H_R_unconf", "H_R_conf", "H_D_unconf", "H_D_conf", "ICU_W_R_unconf", "ICU_W_R_conf", "ICU_W_D_unconf", "ICU_W_D_conf", "ICU_D_unconf", "ICU_D_conf", "W_R_unconf", "W_R_conf", "W_D_unconf", "W_D_conf", "T_sero_pre", "T_sero_pos", "T_PCR_pre", "T_PCR_pos"});
  ...
  dim[29] = cpp11::writable::integers({shared->dim_cum_D_by_age});
  ...
  dim[35] = cpp11::writable::integers({shared->dim_cum_n_vaccinated_1, shared->dim_cum_n_vaccinated_2});
  dim[36] = cpp11::writable::integers({shared->dim_S_1, shared->dim_S_2});
  dim[37] = cpp11::writable::integers({shared->dim_prob_strain_1, shared->dim_prob_strain_2});
  dim[38] = cpp11::writable::integers({shared->dim_I_weighted_1, shared->dim_I_weighted_2});
  dim[39] = cpp11::writable::integers({shared->dim_T_sero_neg_1, shared->dim_T_sero_neg_2, shared->dim_T_sero_neg_3});
  dim[40] = cpp11::writable::integers({shared->dim_R_1, shared->dim_R_2, shared->dim_R_3});
  dim[41] = cpp11::writable::integers({shared->dim_T_PCR_neg_1, shared->dim_T_PCR_neg_2, shared->dim_T_PCR_neg_3});
  dim[42] = cpp11::writable::integers({shared->dim_E_1, shared->dim_E_2, shared->dim_E_3, shared->dim_E_4});
  dim[43] = cpp11::writable::integers({shared->dim_I_A_1, shared->dim_I_A_2, shared->dim_I_A_3, shared->dim_I_A_4});
  ...
  index[29] = integer_sequence(shared->offset_variable_cum_D_by_age + 1, shared->dim_cum_D_by_age);
  ...
  index[35] = integer_sequence(shared->offset_variable_cum_n_vaccinated + 1, shared->dim_cum_n_vaccinated);
  index[36] = integer_sequence(shared->offset_variable_S + 1, shared->dim_S);
  ...
  index[39] = integer_sequence(shared->offset_variable_T_sero_neg + 1, shared->dim_T_sero_neg);
  index[40] = integer_sequence(shared->offset_variable_R + 1, shared->dim_R);
  index[41] = integer_sequence(shared->offset_variable_T_PCR_neg + 1, shared->dim_T_PCR_neg);
  index[42] = integer_sequence(shared->offset_variable_E + 1, shared->dim_E);
