...
public:
  ...
  std::vector<real_t> initial(size_t step) {
    ...
    std::copy(internal.initial_prob_strain.begin(), internal.initial_prob_strain.end(), state.begin() + internal.offset_variable_prob_strain);
  ...
  void update(size_t step, const real_t * state, dust::rng_state_t<real_t>& rng_state, real_t * state_next) {
    ...
    for (int i = 1; i <= internal.dim_prob_strain_1; ++i) {
      for (int j = 1; j <= internal.dim_prob_strain_2; ++j) {
        state_next[internal.offset_variable_prob_strain + i - 1 + internal.dim_prob_strain_1 * (j - 1)] = internal.lambda[internal.dim_lambda_1 * (j - 1) + i - 1] / (real_t) odin_sum2(internal.lambda.data(), i - 1, i, 0, internal.dim_lambda_2, internal.dim_lambda_1);
      }
    }
...
carehomes::init_t dust_data<carehomes>(cpp11::list user) {
  ...
  internal.dim_prob_strain_1 = internal.n_groups;
  internal.dim_prob_strain_2 = internal.n_strains;
  ...
  internal.dim_prob_strain = internal.dim_prob_strain_1 * internal.dim_prob_strain_2;
  ...
  internal.initial_prob_strain = std::vector<real_t>(internal.dim_prob_strain);
  ...
  for (int i = 1; i <= internal.dim_prob_strain_1; ++i) {
    for (int j = 1; j <= internal.dim_prob_strain_2; ++j) {
      internal.initial_prob_strain[i - 1 + internal.dim_prob_strain_1 * (j - 1)] = 0;
    }
  }
  ...
  internal.offset_variable_prob_strain = 17 + internal.dim_cum_infections_per_strain + internal.dim_D_hosp + internal.dim_D_comm + internal.dim_cum_admit_by_age + internal.dim_N_tot + internal.dim_cum_n_S_vaccinated + internal.dim_cum_n_E_vaccinated + internal.dim_cum_n_I_A_vaccinated + internal.dim_cum_n_R_vaccinated + internal.dim_cum_n_vaccinated + internal.dim_S;
...
cpp11::sexp dust_info<carehomes>(const carehomes::init_t& internal) {
  ...
  dim[28] = cpp11::writable::integers({internal.dim_prob_strain_1, internal.dim_prob_strain_2});
  dim[29] = cpp11::writable::integers({internal.dim_T_sero_neg_1, internal.dim_T_sero_neg_2, internal.dim_T_sero_neg_3});
  dim[30] = cpp11::writable::integers({internal.dim_R_1, internal.dim_R_2, internal.dim_R_3});
  dim[31] = cpp11::writable::integers({internal.dim_T_PCR_neg_1, internal.dim_T_PCR_neg_2, internal.dim_T_PCR_neg_3});
  dim[32] = cpp11::writable::integers({internal.dim_E_1, internal.dim_E_2, internal.dim_E_3, internal.dim_E_4});
  dim[33] = cpp11::writable::integers({internal.dim_I_A_1, internal.dim_I_A_2, internal.dim_I_A_3, internal.dim_I_A_4});
  dim[34] = cpp11::writable::integers({internal.dim_I_C_1, internal.dim_I_C_2, internal.dim_I_C_3, internal.dim_I_C_4});
  dim[35] = cpp11::writable::integers({internal.dim_G_D_1, internal.dim_G_D_2, internal.dim_G_D_3, internal.dim_G_D_4});
  dim[36] = cpp11::writable::integers({internal.dim_ICU_pre_unconf_1, internal.dim_ICU_pre_unconf_2, internal.dim_ICU_pre_unconf_3, internal.dim_ICU_pre_unconf_4});
  dim[37] = cpp11::writable::integers({internal.dim_ICU_pre_conf_1, internal.dim_ICU_pre_conf_2, internal.dim_ICU_pre_conf_3, internal.dim_ICU_pre_conf_4});
  dim[38] = cpp11::writable::integers({internal.dim_H_R_unconf_1, internal.dim_H_R_unconf_2, internal.dim_H_R_unconf_3, internal.dim_H_R_unconf_4});
  dim[39] = cpp11::writable::integers({internal.dim_H_R_conf_1, internal.dim_H_R_conf_2, internal.dim_H_R_conf_3, internal.dim_H_R_conf_4});
  dim[40] = cpp11::writable::integers({internal.dim_H_D_unconf_1, internal.dim_H_D_unconf_2, internal.dim_H_D_unconf_3, internal.dim_H_D_unconf_4});
  dim[41] = cpp11::writable::integers({internal.dim_H_D_conf_1, internal.dim_H_D_conf_2, internal.dim_H_D_conf_3, internal.dim_H_D_conf_4});
  dim[42] = cpp11::writable::integers({internal.dim_ICU_W_R_unconf_1, internal.dim_ICU_W_R_unconf_2, internal.dim_ICU_W_R_unconf_3, internal.dim_ICU_W_R_unconf_4});
  dim[43] = cpp11::writable::integers({internal.dim_ICU_W_R_conf_1, internal.dim_ICU_W_R_conf_2, internal.dim_ICU_W_R_conf_3, internal.dim_ICU_W_R_conf_4});
  dim[44] = cpp11::writable::integers({internal.dim_ICU_W_D_unconf_1, internal.dim_ICU_W_D_unconf_2, internal.dim_ICU_W_D_unconf_3, internal.dim_ICU_W_D_unconf_4});
  dim[45] = cpp11::writable::integers({internal.dim_ICU_W_D_conf_1, internal.dim_ICU_W_D_conf_2, internal.dim_ICU_W_D_conf_3, internal.dim_ICU_W_D_conf_4});
  dim[46] = cpp11::writable::integers({internal.dim_ICU_D_unconf_1, internal.dim_ICU_D_unconf_2, internal.dim_ICU_D_unconf_3, internal.dim_ICU_D_unconf_4});
  dim[47] = cpp11::writable::integers({internal.dim_ICU_D_conf_1, internal.dim_ICU_D_conf_2, internal.dim_ICU_D_conf_3, internal.dim_ICU_D_conf_4});
  dim[48] = cpp11::writable::integers({internal.dim_W_R_unconf_1, internal.dim_W_R_unconf_2, internal.dim_W_R_unconf_3, internal.dim_W_R_unconf_4});
  dim[49] = cpp11::writable::integers({internal.dim_W_R_conf_1, internal.dim_W_R_conf_2, internal.dim_W_R_conf_3, internal.dim_W_R_conf_4});
  dim[50] = cpp11::writable::integers({internal.dim_W_D_unconf_1, internal.dim_W_D_unconf_2, internal.dim_W_D_unconf_3, internal.dim_W_D_unconf_4});
  dim[51] = cpp11::writable::integers({internal.dim_W_D_conf_1, internal.dim_W_D_conf_2, internal.dim_W_D_conf_3, internal.dim_W_D_conf_4});
  dim[52] = cpp11::writable::integers({internal.dim_T_sero_pre_1, internal.dim_T_sero_pre_2, internal.dim_T_sero_pre_3, internal.dim_T_sero_pre_4});
  dim[53] = cpp11::writable::integers({internal.dim_T_sero_pos_1, internal.dim_T_sero_pos_2, internal.dim_T_sero_pos_3, internal.dim_T_sero_pos_4});
  dim[54] = cpp11::writable::integers({internal.dim_T_PCR_pre_1, internal.dim_T_PCR_pre_2, internal.dim_T_PCR_pre_3, internal.dim_T_PCR_pre_4});
  dim[55] = cpp11::writable::integers({internal.dim_T_PCR_pos_1, internal.dim_T_PCR_pos_2, internal.dim_T_PCR_pos_3, internal.dim_T_PCR_pos_4});
  dim.names() = nms;
  ...
  index[28] = integer_sequence(internal.offset_variable_prob_strain + 1, internal.dim_prob_strain);
  index[29] = integer_sequence(internal.offset_variable_T_sero_neg + 1, internal.dim_T_sero_neg);
  index[30] = integer_sequence(internal.offset_variable_R + 1, internal.dim_R);
  index[31] = integer_sequence(internal.offset_variable_T_PCR_neg + 1, internal.dim_T_PCR_neg);
  index[32] = integer_sequence(internal.offset_variable_E + 1, internal.dim_E);
  index[33] = integer_sequence(internal.offset_variable_I_A + 1, internal.dim_I_A);
  index[34] = integer_sequence(internal.offset_variable_I_C + 1, internal.dim_I_C);
  index[35] = integer_sequence(internal.offset_variable_G_D + 1, internal.dim_G_D);
  index[36] = integer_sequence(internal.offset_variable_ICU_pre_unconf + 1, internal.dim_ICU_pre_unconf);
  index[37] = integer_sequence(internal.offset_variable_ICU_pre_conf + 1, internal.dim_ICU_pre_conf);
  index[38] = integer_sequence(internal.offset_variable_H_R_unconf + 1, internal.dim_H_R_unconf);
  index[39] = integer_sequence(internal.offset_variable_H_R_conf + 1, internal.dim_H_R_conf);
  index[40] = integer_sequence(internal.offset_variable_H_D_unconf + 1, internal.dim_H_D_unconf);
  index[41] = integer_sequence(internal.offset_variable_H_D_conf + 1, internal.dim_H_D_conf);
  index[42] = integer_sequence(internal.offset_variable_ICU_W_R_unconf + 1, internal.dim_ICU_W_R_unconf);
  index[43] = integer_sequence(internal.offset_variable_ICU_W_R_conf + 1, internal.dim_ICU_W_R_conf);
  index[44] = integer_sequence(internal.offset_variable_ICU_W_D_unconf + 1, internal.dim_ICU_W_D_unconf);
  index[45] = integer_sequence(internal.offset_variable_ICU_W_D_conf + 1, internal.dim_ICU_W_D_conf);
  index[46] = integer_sequence(internal.offset_variable_ICU_D_unconf + 1, internal.dim_ICU_D_unconf);
  index[47] = integer_sequence(internal.offset_variable_ICU_D_conf + 1, internal.dim_ICU_D_conf);
  index[48] = integer_sequence(internal.offset_variable_W_R_unconf + 1, internal.dim_W_R_unconf);
  index[49] = integer_sequence(internal.offset_variable_W_R_conf + 1, internal.dim_W_R_conf);
  index[50] = integer_sequence(internal.offset_variable_W_D_unconf + 1, internal.dim_W_D_unconf);
  index[51] = integer_sequence(internal.offset_variable_W_D_conf + 1, internal.dim_W_D_conf);
  index[52] = integer_sequence(internal.offset_variable_T_sero_pre + 1, internal.dim_T_sero_pre);
  index[53] = integer_sequence(internal.offset_variable_T_sero_pos + 1, internal.dim_T_sero_pos);
  index[54] = integer_sequence(internal.offset_variable_T_PCR_pre + 1, internal.dim_T_PCR_pre);
  index[55] = integer_sequence(internal.offset_variable_T_PCR_pos + 1, internal.dim_T_PCR_pos);
  index.names() = nms;
