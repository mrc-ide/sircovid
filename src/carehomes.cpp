...
public:
  ...
  struct init_t {
    ...
    int dim_n_EE_2;
    int dim_n_EE_3;
    int dim_n_EE_E_next_vacc_class;
    int dim_n_EE_E_next_vacc_class_1;
    int dim_n_EE_E_next_vacc_class_12;
    int dim_n_EE_E_next_vacc_class_2;
    int dim_n_EE_E_next_vacc_class_3;
    int dim_n_EI_asympt;
    ...
    int dim_n_SE_1;
    int dim_n_SE_2;
    int dim_n_SE_S_next_vacc_class;
    int dim_n_SE_S_next_vacc_class_1;
    int dim_n_SE_S_next_vacc_class_2;
    int dim_N_tot;
    ...
    std::vector<real_t> n_EE_E_next_vacc_class;
  ...
  void update(size_t step, const real_t * state, dust::rng_state_t<real_t>& rng_state, real_t * state_next) {
    ...
    for (int i = 1; i <= internal.dim_n_EE_E_next_vacc_class_1; ++i) {
      for (int j = 1; j <= internal.dim_n_EE_E_next_vacc_class_2; ++j) {
        for (int k = 1; k <= internal.dim_n_EE_E_next_vacc_class_3; ++k) {
          internal.n_EE_E_next_vacc_class[i - 1 + internal.dim_n_EE_E_next_vacc_class_1 * (j - 1) + internal.dim_n_EE_E_next_vacc_class_12 * (k - 1)] = dust::distr::rbinom(rng_state, std::round(internal.n_E_progress[internal.dim_n_E_progress_12 * (k - 1) + internal.dim_n_E_progress_1 * (j - 1) + i - 1]), internal.p_E_next_vacc_class[internal.dim_p_E_next_vacc_class_12 * (k - 1) + internal.dim_p_E_next_vacc_class_1 * (j - 1) + i - 1]);
        }
      }
    }
    ...
    for (int i = 1; i <= internal.dim_n_EE_1; ++i) {
      for (int j = 1; j <= internal.dim_n_EE_2; ++j) {
        for (int k = 1; k <= internal.n_vacc_classes; ++k) {
          internal.n_EE[i - 1 + internal.dim_n_EE_1 * (j - 1) + internal.dim_n_EE_12 * (k - 1)] = internal.n_E_progress[internal.dim_n_E_progress_12 * (k - 1) + internal.dim_n_E_progress_1 * (j - 1) + i - 1] - internal.n_EE_E_next_vacc_class[internal.dim_n_EE_E_next_vacc_class_12 * (k - 1) + internal.dim_n_EE_E_next_vacc_class_1 * (j - 1) + i - 1];
        }
      }
    }
    ...
    for (int i = 1; i <= internal.dim_n_SE_S_next_vacc_class_1; ++i) {
      for (int j = 1; j <= internal.dim_n_SE_S_next_vacc_class_2; ++j) {
        internal.n_SE_S_next_vacc_class[i - 1 + internal.dim_n_SE_S_next_vacc_class_1 * (j - 1)] = dust::distr::rbinom(rng_state, std::round(internal.n_S_progress[internal.dim_n_S_progress_1 * (j - 1) + i - 1]), internal.p_S_next_vacc_class[internal.dim_p_S_next_vacc_class_1 * (j - 1) + i - 1]);
      }
    }
    ...
    for (int i = 1; i <= internal.dim_n_SE_1; ++i) {
      for (int j = 1; j <= internal.n_vacc_classes; ++j) {
        internal.n_SE[i - 1 + internal.dim_n_SE_1 * (j - 1)] = internal.n_S_progress[internal.dim_n_S_progress_1 * (j - 1) + i - 1] - internal.n_SE_S_next_vacc_class[internal.dim_n_SE_S_next_vacc_class_1 * (j - 1) + i - 1];
      }
    }
...
carehomes::init_t dust_data<carehomes>(cpp11::list user) {
  ...
  internal.dim_n_EE_E_next_vacc_class_1 = internal.n_groups;
  internal.dim_n_EE_E_next_vacc_class_2 = internal.s_E;
  internal.dim_n_EE_E_next_vacc_class_3 = internal.n_vacc_classes;
  ...
  internal.dim_n_EE_E_next_vacc_class = internal.dim_n_EE_E_next_vacc_class_1 * internal.dim_n_EE_E_next_vacc_class_2 * internal.dim_n_EE_E_next_vacc_class_3;
  internal.dim_n_EE_E_next_vacc_class_12 = internal.dim_n_EE_E_next_vacc_class_1 * internal.dim_n_EE_E_next_vacc_class_2;
  ...
  internal.n_EE_E_next_vacc_class = std::vector<real_t>(internal.dim_n_EE_E_next_vacc_class);
