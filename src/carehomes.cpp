...
typename T::real_t compare(const typename T::real_t * state,
  ...
  const real_t model_icu = state[39];
  const real_t model_general = state[40];
  const real_t model_hosp = model_icu + model_general;
  const real_t model_deaths_carehomes = state[56];
  const real_t model_deaths_comm = state[54];
  const real_t model_deaths_hosp = state[57];
  const real_t model_admitted = state[1];
  const real_t model_diagnoses = state[9];
  const real_t model_all_admission = model_admitted + model_diagnoses;
  const real_t model_sero_pos_1 = state[59];
  const real_t model_sero_pos_2 = state[60];
  const real_t model_sympt_cases = state[65];
  const real_t model_sympt_cases_non_variant =
    state[66];
  const real_t model_sympt_cases_over25 = state[67];
  const real_t model_sympt_cases_non_variant_over25 =
    state[68];
  const real_t model_react_pos = state[69];
...
public:
  ...
  struct shared_t {
    ...
    real_t initial_D_hosp_inc_0_34;
    real_t initial_D_hosp_inc_35_54;
    real_t initial_D_hosp_inc_55_64;
    real_t initial_D_hosp_inc_65_74;
    real_t initial_D_hosp_inc_75_plus;
    real_t initial_D_hosp_tot;
    real_t initial_D_hosp_tot_0_34;
    real_t initial_D_hosp_tot_35_54;
    real_t initial_D_hosp_tot_55_64;
    real_t initial_D_hosp_tot_65_74;
    real_t initial_D_hosp_tot_75_plus;
    ...
    real_t initial_admit_conf_inc_0_34;
    real_t initial_admit_conf_inc_0_64;
    real_t initial_admit_conf_inc_35_54;
    real_t initial_admit_conf_inc_55_64;
    real_t initial_admit_conf_inc_65_74;
    real_t initial_admit_conf_inc_65_plus;
    real_t initial_admit_conf_inc_75_plus;
    real_t initial_beta_out;
    std::vector<real_t> initial_cum_admit_by_age;
    real_t initial_cum_admit_conf;
    real_t initial_cum_admit_conf_0_34;
    real_t initial_cum_admit_conf_0_64;
    real_t initial_cum_admit_conf_35_54;
    real_t initial_cum_admit_conf_55_64;
    real_t initial_cum_admit_conf_65_74;
    real_t initial_cum_admit_conf_65_plus;
    real_t initial_cum_admit_conf_75_plus;
    ...
    real_t initial_cum_new_conf_0_34;
    real_t initial_cum_new_conf_0_64;
    real_t initial_cum_new_conf_35_54;
    real_t initial_cum_new_conf_55_64;
    real_t initial_cum_new_conf_65_74;
    real_t initial_cum_new_conf_65_plus;
    real_t initial_cum_new_conf_75_plus;
    ...
    real_t initial_new_conf_inc_0_34;
    real_t initial_new_conf_inc_0_64;
    real_t initial_new_conf_inc_35_54;
    real_t initial_new_conf_inc_55_64;
    real_t initial_new_conf_inc_65_74;
    real_t initial_new_conf_inc_65_plus;
    real_t initial_new_conf_inc_75_plus;
  ...
  size_t size() {
    return shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_H_D_conf + shared->dim_H_D_unconf + shared->dim_H_R_conf + shared->dim_H_R_unconf + shared->dim_ICU_D_conf + shared->dim_ICU_D_unconf + shared->dim_ICU_W_D_conf + shared->dim_ICU_W_D_unconf + shared->dim_ICU_W_R_conf + shared->dim_ICU_W_R_unconf + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_PCR_pos + shared->dim_T_PCR_pre + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_T_sero_pos_1 + shared->dim_T_sero_pos_2 + shared->dim_T_sero_pre_1 + shared->dim_T_sero_pre_2 + shared->dim_W_D_conf + shared->dim_W_D_unconf + shared->dim_W_R_conf + shared->dim_W_R_unconf + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  }
  std::vector<real_t> initial(size_t step) {
    std::vector<real_t> state(shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_H_D_conf + shared->dim_H_D_unconf + shared->dim_H_R_conf + shared->dim_H_R_unconf + shared->dim_ICU_D_conf + shared->dim_ICU_D_unconf + shared->dim_ICU_W_D_conf + shared->dim_ICU_W_D_unconf + shared->dim_ICU_W_R_conf + shared->dim_ICU_W_R_unconf + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_PCR_pos + shared->dim_T_PCR_pre + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_T_sero_pos_1 + shared->dim_T_sero_pos_2 + shared->dim_T_sero_pre_1 + shared->dim_T_sero_pre_2 + shared->dim_W_D_conf + shared->dim_W_D_unconf + shared->dim_W_R_conf + shared->dim_W_R_unconf + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70);
    state[0] = shared->initial_time;
    state[1] = shared->initial_admit_conf_inc;
    state[2] = shared->initial_admit_conf_inc_0_64;
    state[3] = shared->initial_admit_conf_inc_65_plus;
    state[4] = shared->initial_admit_conf_inc_0_34;
    state[5] = shared->initial_admit_conf_inc_35_54;
    state[6] = shared->initial_admit_conf_inc_55_64;
    state[7] = shared->initial_admit_conf_inc_65_74;
    state[8] = shared->initial_admit_conf_inc_75_plus;
    state[9] = shared->initial_new_conf_inc;
    state[10] = shared->initial_new_conf_inc_0_64;
    state[11] = shared->initial_new_conf_inc_65_plus;
    state[12] = shared->initial_new_conf_inc_0_34;
    state[13] = shared->initial_new_conf_inc_35_54;
    state[14] = shared->initial_new_conf_inc_55_64;
    state[15] = shared->initial_new_conf_inc_65_74;
    state[16] = shared->initial_new_conf_inc_75_plus;
    state[17] = shared->initial_cum_infections;
    state[18] = shared->initial_infections_inc;
    state[19] = shared->initial_cum_admit_conf;
    state[20] = shared->initial_cum_new_conf;
    state[21] = shared->initial_cum_admit_conf_0_64;
    state[22] = shared->initial_cum_admit_conf_65_plus;
    state[23] = shared->initial_cum_new_conf_0_64;
    state[24] = shared->initial_cum_new_conf_65_plus;
    state[25] = shared->initial_cum_admit_conf_0_34;
    state[26] = shared->initial_cum_admit_conf_35_54;
    state[27] = shared->initial_cum_admit_conf_55_64;
    state[28] = shared->initial_cum_admit_conf_65_74;
    state[29] = shared->initial_cum_admit_conf_75_plus;
    state[30] = shared->initial_cum_new_conf_0_34;
    state[31] = shared->initial_cum_new_conf_35_54;
    state[32] = shared->initial_cum_new_conf_55_64;
    state[33] = shared->initial_cum_new_conf_65_74;
    state[34] = shared->initial_cum_new_conf_75_plus;
    state[35] = shared->initial_beta_out;
    state[36] = shared->initial_N_tot_sero_1;
    state[37] = shared->initial_N_tot_sero_2;
    state[38] = shared->initial_N_tot_PCR;
    state[39] = shared->initial_ICU_tot;
    state[40] = shared->initial_general_tot;
    state[41] = shared->initial_hosp_tot;
    state[42] = shared->initial_D_hosp_tot;
    state[43] = shared->initial_D_hosp_tot_0_34;
    state[44] = shared->initial_D_hosp_inc_0_34;
    state[45] = shared->initial_D_hosp_tot_35_54;
    state[46] = shared->initial_D_hosp_inc_35_54;
    state[47] = shared->initial_D_hosp_tot_55_64;
    state[48] = shared->initial_D_hosp_inc_55_64;
    state[49] = shared->initial_D_hosp_tot_65_74;
    state[50] = shared->initial_D_hosp_inc_65_74;
    state[51] = shared->initial_D_hosp_tot_75_plus;
    state[52] = shared->initial_D_hosp_inc_75_plus;
    state[53] = shared->initial_D_comm_tot;
    state[54] = shared->initial_D_comm_inc;
    state[55] = shared->initial_D_carehomes_tot;
    state[56] = shared->initial_D_carehomes_inc;
    state[57] = shared->initial_D_hosp_inc;
    state[58] = shared->initial_D_tot;
    state[59] = shared->initial_sero_pos_1;
    state[60] = shared->initial_sero_pos_2;
    state[61] = shared->initial_cum_sympt_cases;
    state[62] = shared->initial_cum_sympt_cases_non_variant;
    state[63] = shared->initial_cum_sympt_cases_over25;
    state[64] = shared->initial_cum_sympt_cases_non_variant_over25;
    state[65] = shared->initial_sympt_cases_inc;
    state[66] = shared->initial_sympt_cases_non_variant_inc;
    state[67] = shared->initial_sympt_cases_over25_inc;
    state[68] = shared->initial_sympt_cases_non_variant_over25_inc;
    state[69] = shared->initial_react_pos;
    std::copy(shared->initial_cum_infections_per_strain.begin(), shared->initial_cum_infections_per_strain.end(), state.begin() + 70);
  ...
  HOST void update(size_t step, const real_t * state, dust::rng_state_t<real_t>& rng_state, real_t * state_next) {
    ...
    const real_t cum_admit_conf = state[19];
    const real_t cum_admit_conf_0_64 = state[21];
    const real_t cum_admit_conf_65_plus = state[22];
    const real_t cum_admit_conf_0_34 = state[25];
    const real_t cum_admit_conf_35_54 = state[26];
    const real_t cum_admit_conf_55_64 = state[27];
    const real_t cum_admit_conf_65_74 = state[28];
    const real_t cum_admit_conf_75_plus = state[29];
    const real_t cum_new_conf = state[20];
    const real_t cum_new_conf_0_64 = state[23];
    const real_t cum_new_conf_65_plus = state[24];
    const real_t cum_new_conf_0_34 = state[30];
    const real_t cum_new_conf_35_54 = state[31];
    const real_t cum_new_conf_55_64 = state[32];
    const real_t cum_new_conf_65_74 = state[33];
    const real_t cum_new_conf_75_plus = state[34];
    ...
    const real_t admit_conf_inc_0_64 = state[2];
    const real_t admit_conf_inc_65_plus = state[3];
    const real_t admit_conf_inc_0_34 = state[4];
    const real_t admit_conf_inc_35_54 = state[5];
    const real_t admit_conf_inc_55_64 = state[6];
    const real_t admit_conf_inc_65_74 = state[7];
    const real_t admit_conf_inc_75_plus = state[8];
    const real_t new_conf_inc = state[9];
    const real_t new_conf_inc_0_64 = state[10];
    const real_t new_conf_inc_65_plus = state[11];
    const real_t new_conf_inc_0_34 = state[12];
    const real_t new_conf_inc_35_54 = state[13];
    const real_t new_conf_inc_55_64 = state[14];
    const real_t new_conf_inc_65_74 = state[15];
    const real_t new_conf_inc_75_plus = state[16];
    const real_t * cum_admit_by_age = state + shared->offset_variable_cum_admit_by_age;
    const real_t cum_infections = state[17];
    const real_t infections_inc = state[18];
    const real_t * cum_infections_per_strain = state + 70;
    const real_t * D = state + shared->offset_variable_D;
    const real_t D_hosp_tot = state[42];
    const real_t D_hosp_tot_0_34 = state[43];
    const real_t D_hosp_inc_0_34 = state[44];
    const real_t D_hosp_tot_35_54 = state[45];
    const real_t D_hosp_inc_35_54 = state[46];
    const real_t D_hosp_tot_55_64 = state[47];
    const real_t D_hosp_inc_55_64 = state[48];
    const real_t D_hosp_tot_65_74 = state[49];
    const real_t D_hosp_inc_65_74 = state[50];
    const real_t D_hosp_tot_75_plus = state[51];
    const real_t D_hosp_inc_75_plus = state[52];
    const real_t D_comm_tot = state[53];
    const real_t D_comm_inc = state[54];
    const real_t D_carehomes_tot = state[55];
    const real_t D_carehomes_inc = state[56];
    const real_t D_hosp_inc = state[57];
    const real_t D_tot = state[58];
    const real_t cum_sympt_cases = state[61];
    const real_t cum_sympt_cases_non_variant = state[62];
    const real_t cum_sympt_cases_over25 = state[63];
    const real_t cum_sympt_cases_non_variant_over25 = state[64];
    const real_t sympt_cases_inc = state[65];
    const real_t sympt_cases_non_variant_inc = state[66];
    const real_t sympt_cases_over25_inc = state[67];
    const real_t sympt_cases_non_variant_over25_inc = state[68];
    const real_t * vaccine_missed_doses = state + shared->offset_variable_vaccine_missed_doses;
    state_next[38] = odin_sum1<real_t>(S, 0, shared->dim_S) + odin_sum1<real_t>(T_PCR_pre, 0, shared->dim_T_PCR_pre) + odin_sum1<real_t>(T_PCR_pos, 0, shared->dim_T_PCR_pos) + odin_sum1<real_t>(T_PCR_neg, 0, shared->dim_T_PCR_neg);
    state_next[36] = odin_sum1<real_t>(S, 0, shared->dim_S) + odin_sum1<real_t>(T_sero_pre_1, 0, shared->dim_T_sero_pre_1) + odin_sum1<real_t>(T_sero_pos_1, 0, shared->dim_T_sero_pos_1) + odin_sum1<real_t>(T_sero_neg_1, 0, shared->dim_T_sero_neg_1) + odin_sum1<real_t>(E, 0, shared->dim_E);
    state_next[37] = odin_sum1<real_t>(S, 0, shared->dim_S) + odin_sum1<real_t>(T_sero_pre_2, 0, shared->dim_T_sero_pre_2) + odin_sum1<real_t>(T_sero_pos_2, 0, shared->dim_T_sero_pos_2) + odin_sum1<real_t>(T_sero_neg_2, 0, shared->dim_T_sero_neg_2) + odin_sum1<real_t>(E, 0, shared->dim_E);
      ...
      for (int j = 1; j <= shared->dim_n_H_R_unconf_progress_2; ++j) {
        for (int k = 1; k <= shared->dim_n_H_R_unconf_progress_3; ++k) {
          for (int l = 1; l <= shared->dim_n_H_R_unconf_progress_4; ++l) {
            internal.n_H_R_unconf_progress[i - 1 + shared->dim_n_H_R_unconf_progress_1 * (j - 1) + shared->dim_n_H_R_unconf_progress_12 * (k - 1) + shared->dim_n_H_R_unconf_progress_123 * (l - 1)] = dust::distr::rbinom<real_t>(rng_state, H_R_unconf[shared->dim_H_R_unconf_123 * (l - 1) + shared->dim_H_R_unconf_12 * (k - 1) + shared->dim_H_R_unconf_1 * (j - 1) + i - 1], internal.p_H_R_progress[j - 1]);
          }
        }
      }
    }
      ...
      for (int j = 1; j <= shared->dim_n_ICU_W_D_conf_progress_2; ++j) {
        for (int k = 1; k <= shared->dim_n_ICU_W_D_conf_progress_3; ++k) {
          for (int l = 1; l <= shared->dim_n_ICU_W_D_conf_progress_4; ++l) {
            internal.n_ICU_W_D_conf_progress[i - 1 + shared->dim_n_ICU_W_D_conf_progress_1 * (j - 1) + shared->dim_n_ICU_W_D_conf_progress_12 * (k - 1) + shared->dim_n_ICU_W_D_conf_progress_123 * (l - 1)] = dust::distr::rbinom<real_t>(rng_state, ICU_W_D_conf[shared->dim_ICU_W_D_conf_123 * (l - 1) + shared->dim_ICU_W_D_conf_12 * (k - 1) + shared->dim_ICU_W_D_conf_1 * (j - 1) + i - 1], internal.p_ICU_W_D_progress[j - 1]);
          }
        }
      }
    }
      ...
      for (int j = 1; j <= shared->dim_n_ICU_W_R_conf_progress_2; ++j) {
        for (int k = 1; k <= shared->dim_n_ICU_W_R_conf_progress_3; ++k) {
          for (int l = 1; l <= shared->dim_n_ICU_W_R_conf_progress_4; ++l) {
            internal.n_ICU_W_R_conf_progress[i - 1 + shared->dim_n_ICU_W_R_conf_progress_1 * (j - 1) + shared->dim_n_ICU_W_R_conf_progress_12 * (k - 1) + shared->dim_n_ICU_W_R_conf_progress_123 * (l - 1)] = dust::distr::rbinom<real_t>(rng_state, ICU_W_R_conf[shared->dim_ICU_W_R_conf_123 * (l - 1) + shared->dim_ICU_W_R_conf_12 * (k - 1) + shared->dim_ICU_W_R_conf_1 * (j - 1) + i - 1], internal.p_ICU_W_R_progress[j - 1]);
          }
        }
      }
    }
      ...
      for (int j = 1; j <= shared->dim_n_ICU_W_R_unconf_progress_2; ++j) {
        for (int k = 1; k <= shared->dim_n_ICU_W_R_unconf_progress_3; ++k) {
          for (int l = 1; l <= shared->dim_n_ICU_W_R_unconf_progress_4; ++l) {
            internal.n_ICU_W_R_unconf_progress[i - 1 + shared->dim_n_ICU_W_R_unconf_progress_1 * (j - 1) + shared->dim_n_ICU_W_R_unconf_progress_12 * (k - 1) + shared->dim_n_ICU_W_R_unconf_progress_123 * (l - 1)] = dust::distr::rbinom<real_t>(rng_state, ICU_W_R_unconf[shared->dim_ICU_W_R_unconf_123 * (l - 1) + shared->dim_ICU_W_R_unconf_12 * (k - 1) + shared->dim_ICU_W_R_unconf_1 * (j - 1) + i - 1], internal.p_ICU_W_R_progress[j - 1]);
          }
        }
      }
    }
      ...
      for (int j = 1; j <= shared->dim_n_ICU_pre_conf_progress_2; ++j) {
        for (int k = 1; k <= shared->dim_n_ICU_pre_conf_progress_3; ++k) {
          for (int l = 1; l <= shared->dim_n_ICU_pre_conf_progress_4; ++l) {
            internal.n_ICU_pre_conf_progress[i - 1 + shared->dim_n_ICU_pre_conf_progress_1 * (j - 1) + shared->dim_n_ICU_pre_conf_progress_12 * (k - 1) + shared->dim_n_ICU_pre_conf_progress_123 * (l - 1)] = dust::distr::rbinom<real_t>(rng_state, ICU_pre_conf[shared->dim_ICU_pre_conf_123 * (l - 1) + shared->dim_ICU_pre_conf_12 * (k - 1) + shared->dim_ICU_pre_conf_1 * (j - 1) + i - 1], internal.p_ICU_pre_progress[j - 1]);
          }
        }
      }
    }
      ...
      for (int j = 1; j <= shared->dim_n_ICU_pre_unconf_progress_2; ++j) {
        for (int k = 1; k <= shared->dim_n_ICU_pre_unconf_progress_3; ++k) {
          for (int l = 1; l <= shared->dim_n_ICU_pre_unconf_progress_4; ++l) {
            internal.n_ICU_pre_unconf_progress[i - 1 + shared->dim_n_ICU_pre_unconf_progress_1 * (j - 1) + shared->dim_n_ICU_pre_unconf_progress_12 * (k - 1) + shared->dim_n_ICU_pre_unconf_progress_123 * (l - 1)] = dust::distr::rbinom<real_t>(rng_state, ICU_pre_unconf[shared->dim_ICU_pre_unconf_123 * (l - 1) + shared->dim_ICU_pre_unconf_12 * (k - 1) + shared->dim_ICU_pre_unconf_1 * (j - 1) + i - 1], internal.p_ICU_pre_progress[j - 1]);
          }
        }
      }
    }
      ...
      for (int j = 1; j <= shared->dim_n_W_D_conf_progress_2; ++j) {
        for (int k = 1; k <= shared->dim_n_W_D_conf_progress_3; ++k) {
          for (int l = 1; l <= shared->dim_n_W_D_conf_progress_4; ++l) {
            internal.n_W_D_conf_progress[i - 1 + shared->dim_n_W_D_conf_progress_1 * (j - 1) + shared->dim_n_W_D_conf_progress_12 * (k - 1) + shared->dim_n_W_D_conf_progress_123 * (l - 1)] = dust::distr::rbinom<real_t>(rng_state, W_D_conf[shared->dim_W_D_conf_123 * (l - 1) + shared->dim_W_D_conf_12 * (k - 1) + shared->dim_W_D_conf_1 * (j - 1) + i - 1], internal.p_W_D_progress[j - 1]);
          }
        }
      }
    }
      ...
      for (int j = 1; j <= shared->dim_n_W_D_unconf_progress_2; ++j) {
        for (int k = 1; k <= shared->dim_n_W_D_unconf_progress_3; ++k) {
          for (int l = 1; l <= shared->dim_n_W_D_unconf_progress_4; ++l) {
            internal.n_W_D_unconf_progress[i - 1 + shared->dim_n_W_D_unconf_progress_1 * (j - 1) + shared->dim_n_W_D_unconf_progress_12 * (k - 1) + shared->dim_n_W_D_unconf_progress_123 * (l - 1)] = dust::distr::rbinom<real_t>(rng_state, W_D_unconf[shared->dim_W_D_unconf_123 * (l - 1) + shared->dim_W_D_unconf_12 * (k - 1) + shared->dim_W_D_unconf_1 * (j - 1) + i - 1], internal.p_W_D_progress[j - 1]);
          }
        }
      }
    }
      ...
      for (int j = 1; j <= shared->dim_n_W_R_unconf_progress_2; ++j) {
        for (int k = 1; k <= shared->dim_n_W_R_unconf_progress_3; ++k) {
          for (int l = 1; l <= shared->dim_n_W_R_unconf_progress_4; ++l) {
            internal.n_W_R_unconf_progress[i - 1 + shared->dim_n_W_R_unconf_progress_1 * (j - 1) + shared->dim_n_W_R_unconf_progress_12 * (k - 1) + shared->dim_n_W_R_unconf_progress_123 * (l - 1)] = dust::distr::rbinom<real_t>(rng_state, W_R_unconf[shared->dim_W_R_unconf_123 * (l - 1) + shared->dim_W_R_unconf_12 * (k - 1) + shared->dim_W_R_unconf_1 * (j - 1) + i - 1], internal.p_W_R_progress[j - 1]);
          }
        }
      }
    }
    ...
    for (int i = 1; i <= shared->dim_delta_D_hosp_disag_1; ++i) {
      for (int j = 1; j <= shared->dim_delta_D_hosp_disag_2; ++j) {
        internal.delta_D_hosp_disag[i - 1 + shared->dim_delta_D_hosp_disag_1 * (j - 1)] = odin_sum4<real_t>(internal.n_H_D_unconf_progress.data(), i - 1, i, 0, shared->dim_n_H_D_unconf_progress_2, shared->k_H_D - 1, shared->k_H_D, j - 1, j, shared->dim_n_H_D_unconf_progress_1, shared->dim_n_H_D_unconf_progress_12, shared->dim_n_H_D_unconf_progress_123) + odin_sum4<real_t>(internal.n_H_D_conf_progress.data(), i - 1, i, 0, shared->dim_n_H_D_conf_progress_2, shared->k_H_D - 1, shared->k_H_D, j - 1, j, shared->dim_n_H_D_conf_progress_1, shared->dim_n_H_D_conf_progress_12, shared->dim_n_H_D_conf_progress_123) + odin_sum4<real_t>(internal.n_ICU_D_unconf_progress.data(), i - 1, i, 0, shared->dim_n_ICU_D_unconf_progress_2, shared->k_ICU_D - 1, shared->k_ICU_D, j - 1, j, shared->dim_n_ICU_D_unconf_progress_1, shared->dim_n_ICU_D_unconf_progress_12, shared->dim_n_ICU_D_unconf_progress_123) + odin_sum4<real_t>(internal.n_ICU_D_conf_progress.data(), i - 1, i, 0, shared->dim_n_ICU_D_conf_progress_2, shared->k_ICU_D - 1, shared->k_ICU_D, j - 1, j, shared->dim_n_ICU_D_conf_progress_1, shared->dim_n_ICU_D_conf_progress_12, shared->dim_n_ICU_D_conf_progress_123) + odin_sum4<real_t>(internal.n_W_D_unconf_progress.data(), i - 1, i, 0, shared->dim_n_W_D_unconf_progress_2, shared->k_W_D - 1, shared->k_W_D, j - 1, j, shared->dim_n_W_D_unconf_progress_1, shared->dim_n_W_D_unconf_progress_12, shared->dim_n_W_D_unconf_progress_123) + odin_sum4<real_t>(internal.n_W_D_conf_progress.data(), i - 1, i, 0, shared->dim_n_W_D_conf_progress_2, shared->k_W_D - 1, shared->k_W_D, j - 1, j, shared->dim_n_W_D_conf_progress_1, shared->dim_n_W_D_conf_progress_12, shared->dim_n_W_D_conf_progress_123);
      }
    }
    ...
    for (int i = 1; i <= shared->dim_n_ICU_pre_conf_to_ICU_D_conf_1; ++i) {
      for (int j = 1; j <= shared->dim_n_ICU_pre_conf_to_ICU_D_conf_2; ++j) {
        for (int k = 1; k <= shared->dim_n_ICU_pre_conf_to_ICU_D_conf_3; ++k) {
          internal.n_ICU_pre_conf_to_ICU_D_conf[i - 1 + shared->dim_n_ICU_pre_conf_to_ICU_D_conf_1 * (j - 1) + shared->dim_n_ICU_pre_conf_to_ICU_D_conf_12 * (k - 1)] = dust::distr::rbinom<real_t>(rng_state, internal.n_ICU_pre_conf_progress[shared->dim_n_ICU_pre_conf_progress_123 * (k - 1) + shared->dim_n_ICU_pre_conf_progress_12 * (shared->k_ICU_pre - 1) + shared->dim_n_ICU_pre_conf_progress_1 * (j - 1) + i - 1], internal.p_ICU_D[shared->dim_p_ICU_D_12 * (k - 1) + shared->dim_p_ICU_D_1 * (j - 1) + i - 1]);
        }
      }
    }
    for (int i = 1; i <= shared->dim_n_ICU_pre_unconf_to_ICU_D_unconf_1; ++i) {
      for (int j = 1; j <= shared->dim_n_ICU_pre_unconf_to_ICU_D_unconf_2; ++j) {
        for (int k = 1; k <= shared->dim_n_ICU_pre_unconf_to_ICU_D_unconf_3; ++k) {
          internal.n_ICU_pre_unconf_to_ICU_D_unconf[i - 1 + shared->dim_n_ICU_pre_unconf_to_ICU_D_unconf_1 * (j - 1) + shared->dim_n_ICU_pre_unconf_to_ICU_D_unconf_12 * (k - 1)] = dust::distr::rbinom<real_t>(rng_state, internal.n_ICU_pre_unconf_progress[shared->dim_n_ICU_pre_unconf_progress_123 * (k - 1) + shared->dim_n_ICU_pre_unconf_progress_12 * (shared->k_ICU_pre - 1) + shared->dim_n_ICU_pre_unconf_progress_1 * (j - 1) + i - 1], internal.p_ICU_D[shared->dim_p_ICU_D_12 * (k - 1) + shared->dim_p_ICU_D_1 * (j - 1) + i - 1]);
        }
      }
    }
      ...
      for (int j = 1; j <= shared->dim_n_H_D_unconf_to_conf_2; ++j) {
        for (int k = 1; k <= shared->dim_n_H_D_unconf_to_conf_3; ++k) {
          for (int l = 1; l <= shared->dim_n_H_D_unconf_to_conf_4; ++l) {
            internal.n_H_D_unconf_to_conf[i - 1 + shared->dim_n_H_D_unconf_to_conf_1 * (j - 1) + shared->dim_n_H_D_unconf_to_conf_12 * (k - 1) + shared->dim_n_H_D_unconf_to_conf_123 * (l - 1)] = dust::distr::rbinom<real_t>(rng_state, internal.aux_H_D_unconf[shared->dim_aux_H_D_unconf_123 * (l - 1) + shared->dim_aux_H_D_unconf_12 * (k - 1) + shared->dim_aux_H_D_unconf_1 * (j - 1) + i - 1], shared->p_test);
          }
        }
      }
    }
      ...
      for (int j = 1; j <= shared->dim_n_H_R_unconf_to_conf_2; ++j) {
        for (int k = 1; k <= shared->dim_n_H_R_unconf_to_conf_3; ++k) {
          for (int l = 1; l <= shared->dim_n_H_R_unconf_to_conf_4; ++l) {
            internal.n_H_R_unconf_to_conf[i - 1 + shared->dim_n_H_R_unconf_to_conf_1 * (j - 1) + shared->dim_n_H_R_unconf_to_conf_12 * (k - 1) + shared->dim_n_H_R_unconf_to_conf_123 * (l - 1)] = dust::distr::rbinom<real_t>(rng_state, internal.aux_H_R_unconf[shared->dim_aux_H_R_unconf_123 * (l - 1) + shared->dim_aux_H_R_unconf_12 * (k - 1) + shared->dim_aux_H_R_unconf_1 * (j - 1) + i - 1], shared->p_test);
          }
        }
      }
    }
    for (int i = 1; i <= shared->dim_n_ICU_pre_conf_to_ICU_W_D_conf_1; ++i) {
      for (int j = 1; j <= shared->dim_n_ICU_pre_conf_to_ICU_W_D_conf_2; ++j) {
        for (int k = 1; k <= shared->dim_n_ICU_pre_conf_to_ICU_W_D_conf_3; ++k) {
          internal.n_ICU_pre_conf_to_ICU_W_D_conf[i - 1 + shared->dim_n_ICU_pre_conf_to_ICU_W_D_conf_1 * (j - 1) + shared->dim_n_ICU_pre_conf_to_ICU_W_D_conf_12 * (k - 1)] = dust::distr::rbinom<real_t>(rng_state, internal.n_ICU_pre_conf_progress[shared->dim_n_ICU_pre_conf_progress_123 * (k - 1) + shared->dim_n_ICU_pre_conf_progress_12 * (shared->k_ICU_pre - 1) + shared->dim_n_ICU_pre_conf_progress_1 * (j - 1) + i - 1] - internal.n_ICU_pre_conf_to_ICU_D_conf[shared->dim_n_ICU_pre_conf_to_ICU_D_conf_12 * (k - 1) + shared->dim_n_ICU_pre_conf_to_ICU_D_conf_1 * (j - 1) + i - 1], internal.p_W_D[shared->dim_p_W_D_12 * (k - 1) + shared->dim_p_W_D_1 * (j - 1) + i - 1]);
        }
      }
    }
    for (int i = 1; i <= shared->dim_n_ICU_pre_unconf_to_ICU_W_D_unconf_1; ++i) {
      for (int j = 1; j <= shared->dim_n_ICU_pre_unconf_to_ICU_W_D_unconf_2; ++j) {
        for (int k = 1; k <= shared->dim_n_ICU_pre_unconf_to_ICU_W_D_unconf_3; ++k) {
          internal.n_ICU_pre_unconf_to_ICU_W_D_unconf[i - 1 + shared->dim_n_ICU_pre_unconf_to_ICU_W_D_unconf_1 * (j - 1) + shared->dim_n_ICU_pre_unconf_to_ICU_W_D_unconf_12 * (k - 1)] = dust::distr::rbinom<real_t>(rng_state, internal.n_ICU_pre_unconf_progress[shared->dim_n_ICU_pre_unconf_progress_123 * (k - 1) + shared->dim_n_ICU_pre_unconf_progress_12 * (shared->k_ICU_pre - 1) + shared->dim_n_ICU_pre_unconf_progress_1 * (j - 1) + i - 1] - internal.n_ICU_pre_unconf_to_ICU_D_unconf[shared->dim_n_ICU_pre_unconf_to_ICU_D_unconf_12 * (k - 1) + shared->dim_n_ICU_pre_unconf_to_ICU_D_unconf_1 * (j - 1) + i - 1], internal.p_W_D[shared->dim_p_W_D_12 * (k - 1) + shared->dim_p_W_D_1 * (j - 1) + i - 1]);
        }
      }
    }
      ...
      for (int j = 1; j <= shared->dim_n_ICU_pre_unconf_to_conf_2; ++j) {
        for (int k = 1; k <= shared->dim_n_ICU_pre_unconf_to_conf_3; ++k) {
          for (int l = 1; l <= shared->dim_n_ICU_pre_unconf_to_conf_4; ++l) {
            internal.n_ICU_pre_unconf_to_conf[i - 1 + shared->dim_n_ICU_pre_unconf_to_conf_1 * (j - 1) + shared->dim_n_ICU_pre_unconf_to_conf_12 * (k - 1) + shared->dim_n_ICU_pre_unconf_to_conf_123 * (l - 1)] = dust::distr::rbinom<real_t>(rng_state, internal.aux_ICU_pre_unconf[shared->dim_aux_ICU_pre_unconf_123 * (l - 1) + shared->dim_aux_ICU_pre_unconf_12 * (k - 1) + shared->dim_aux_ICU_pre_unconf_1 * (j - 1) + i - 1], shared->p_test);
          }
        }
      }
    }
      ...
      for (int j = 1; j <= shared->dim_n_W_D_unconf_to_conf_2; ++j) {
        for (int k = 1; k <= shared->dim_n_W_D_unconf_to_conf_3; ++k) {
          for (int l = 1; l <= shared->dim_n_W_D_unconf_to_conf_4; ++l) {
            internal.n_W_D_unconf_to_conf[i - 1 + shared->dim_n_W_D_unconf_to_conf_1 * (j - 1) + shared->dim_n_W_D_unconf_to_conf_12 * (k - 1) + shared->dim_n_W_D_unconf_to_conf_123 * (l - 1)] = dust::distr::rbinom<real_t>(rng_state, internal.aux_W_D_unconf[shared->dim_aux_W_D_unconf_123 * (l - 1) + shared->dim_aux_W_D_unconf_12 * (k - 1) + shared->dim_aux_W_D_unconf_1 * (j - 1) + i - 1], shared->p_test);
          }
        }
      }
    }
      ...
      for (int j = 1; j <= shared->dim_n_W_R_unconf_to_conf_2; ++j) {
        for (int k = 1; k <= shared->dim_n_W_R_unconf_to_conf_3; ++k) {
          for (int l = 1; l <= shared->dim_n_W_R_unconf_to_conf_4; ++l) {
            internal.n_W_R_unconf_to_conf[i - 1 + shared->dim_n_W_R_unconf_to_conf_1 * (j - 1) + shared->dim_n_W_R_unconf_to_conf_12 * (k - 1) + shared->dim_n_W_R_unconf_to_conf_123 * (l - 1)] = dust::distr::rbinom<real_t>(rng_state, internal.aux_W_R_unconf[shared->dim_aux_W_R_unconf_123 * (l - 1) + shared->dim_aux_W_R_unconf_12 * (k - 1) + shared->dim_aux_W_R_unconf_1 * (j - 1) + i - 1], shared->p_test);
          }
        }
      }
    }
    ...
    state_next[59] = odin_sum4<real_t>(internal.new_T_sero_pos_1.data(), 3, 13, 0, shared->dim_new_T_sero_pos_1_2, 0, shared->dim_new_T_sero_pos_1_3, 0, shared->dim_new_T_sero_pos_1_4, shared->dim_new_T_sero_pos_1_1, shared->dim_new_T_sero_pos_1_12, shared->dim_new_T_sero_pos_1_123);
    state_next[60] = odin_sum4<real_t>(internal.new_T_sero_pos_2.data(), 3, 13, 0, shared->dim_new_T_sero_pos_2_2, 0, shared->dim_new_T_sero_pos_2_3, 0, shared->dim_new_T_sero_pos_2_4, shared->dim_new_T_sero_pos_2_1, shared->dim_new_T_sero_pos_2_12, shared->dim_new_T_sero_pos_2_123);
    ...
    real_t delta_D_hosp_tot_0_34 = odin_sum1<real_t>(internal.delta_D_hosp.data(), 0, 7) + internal.delta_D_hosp[17] * 0.29999999999999999;
    real_t delta_D_hosp_tot_35_54 = odin_sum1<real_t>(internal.delta_D_hosp.data(), 7, 11) + internal.delta_D_hosp[17] * 0.40000000000000002;
    real_t delta_D_hosp_tot_55_64 = odin_sum1<real_t>(internal.delta_D_hosp.data(), 11, 13) + internal.delta_D_hosp[17] * 0.29999999999999999;
    real_t delta_D_hosp_tot_65_74 = odin_sum1<real_t>(internal.delta_D_hosp.data(), 13, 15) + internal.delta_D_hosp[18] * 0.29999999999999999;
    real_t delta_D_hosp_tot_75_plus = odin_sum1<real_t>(internal.delta_D_hosp.data(), 15, 17) + internal.delta_D_hosp[18] * 0.69999999999999996;
      ...
      for (int j = 1; j <= shared->dim_n_ICU_D_unconf_to_conf_2; ++j) {
        for (int k = 1; k <= shared->dim_n_ICU_D_unconf_to_conf_3; ++k) {
          for (int l = 1; l <= shared->dim_n_ICU_D_unconf_to_conf_4; ++l) {
            internal.n_ICU_D_unconf_to_conf[i - 1 + shared->dim_n_ICU_D_unconf_to_conf_1 * (j - 1) + shared->dim_n_ICU_D_unconf_to_conf_12 * (k - 1) + shared->dim_n_ICU_D_unconf_to_conf_123 * (l - 1)] = dust::distr::rbinom<real_t>(rng_state, internal.aux_ICU_D_unconf[shared->dim_aux_ICU_D_unconf_123 * (l - 1) + shared->dim_aux_ICU_D_unconf_12 * (k - 1) + shared->dim_aux_ICU_D_unconf_1 * (j - 1) + i - 1], shared->p_test);
          }
        }
      }
    }
      ...
      for (int j = 1; j <= shared->dim_n_ICU_W_D_unconf_to_conf_2; ++j) {
        for (int k = 1; k <= shared->dim_n_ICU_W_D_unconf_to_conf_3; ++k) {
          for (int l = 1; l <= shared->dim_n_ICU_W_D_unconf_to_conf_4; ++l) {
            internal.n_ICU_W_D_unconf_to_conf[i - 1 + shared->dim_n_ICU_W_D_unconf_to_conf_1 * (j - 1) + shared->dim_n_ICU_W_D_unconf_to_conf_12 * (k - 1) + shared->dim_n_ICU_W_D_unconf_to_conf_123 * (l - 1)] = dust::distr::rbinom<real_t>(rng_state, internal.aux_ICU_W_D_unconf[shared->dim_aux_ICU_W_D_unconf_123 * (l - 1) + shared->dim_aux_ICU_W_D_unconf_12 * (k - 1) + shared->dim_aux_ICU_W_D_unconf_1 * (j - 1) + i - 1], shared->p_test);
          }
        }
      }
    }
    ...
    state_next[56] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_D_carehomes_tot : D_carehomes_inc + delta_D_carehomes_tot);
    state_next[55] = D_carehomes_tot + delta_D_carehomes_tot;
    state_next[54] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_D_comm_tot : D_comm_inc + delta_D_comm_tot);
    state_next[53] = D_comm_tot + delta_D_comm_tot;
    state_next[57] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_D_hosp_tot : D_hosp_inc + delta_D_hosp_tot);
    state_next[44] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_D_hosp_tot_0_34 : D_hosp_inc_0_34 + delta_D_hosp_tot_0_34);
    state_next[46] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_D_hosp_tot_35_54 : D_hosp_inc_35_54 + delta_D_hosp_tot_35_54);
    state_next[48] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_D_hosp_tot_55_64 : D_hosp_inc_55_64 + delta_D_hosp_tot_55_64);
    state_next[50] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_D_hosp_tot_65_74 : D_hosp_inc_65_74 + delta_D_hosp_tot_65_74);
    state_next[52] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_D_hosp_tot_75_plus : D_hosp_inc_75_plus + delta_D_hosp_tot_75_plus);
    state_next[42] = D_hosp_tot + delta_D_hosp_tot;
    state_next[43] = D_hosp_tot_0_34 + delta_D_hosp_tot_0_34;
    state_next[45] = D_hosp_tot_35_54 + delta_D_hosp_tot_35_54;
    state_next[47] = D_hosp_tot_55_64 + delta_D_hosp_tot_55_64;
    state_next[49] = D_hosp_tot_65_74 + delta_D_hosp_tot_65_74;
    state_next[51] = D_hosp_tot_75_plus + delta_D_hosp_tot_75_plus;
    state_next[58] = D_tot + delta_D_hosp_tot + delta_D_comm_tot + delta_D_carehomes_tot;
    ...
    state_next[61] = cum_sympt_cases + new_sympt_cases;
    state_next[62] = cum_sympt_cases_non_variant + new_sympt_cases_non_variant;
    state_next[64] = cum_sympt_cases_non_variant_over25 + new_sympt_cases_non_variant_over25;
    state_next[63] = cum_sympt_cases_over25 + new_sympt_cases_over25;
    state_next[65] = ((fmodr<real_t>(step, shared->steps_per_day) == 0 ? new_sympt_cases : sympt_cases_inc + new_sympt_cases));
    state_next[66] = ((fmodr<real_t>(step, shared->steps_per_day) == 0 ? new_sympt_cases_non_variant : sympt_cases_non_variant_inc + new_sympt_cases_non_variant));
    state_next[68] = ((fmodr<real_t>(step, shared->steps_per_day) == 0 ? new_sympt_cases_non_variant_over25 : sympt_cases_non_variant_over25_inc + new_sympt_cases_non_variant_over25));
    state_next[67] = ((fmodr<real_t>(step, shared->steps_per_day) == 0 ? new_sympt_cases_over25 : sympt_cases_over25_inc + new_sympt_cases_over25));
      ...
      for (int j = 1; j <= shared->dim_n_ICU_W_R_unconf_to_conf_2; ++j) {
        for (int k = 1; k <= shared->dim_n_ICU_W_R_unconf_to_conf_3; ++k) {
          for (int l = 1; l <= shared->dim_n_ICU_W_R_unconf_to_conf_4; ++l) {
            internal.n_ICU_W_R_unconf_to_conf[i - 1 + shared->dim_n_ICU_W_R_unconf_to_conf_1 * (j - 1) + shared->dim_n_ICU_W_R_unconf_to_conf_12 * (k - 1) + shared->dim_n_ICU_W_R_unconf_to_conf_123 * (l - 1)] = dust::distr::rbinom<real_t>(rng_state, internal.aux_ICU_W_R_unconf[shared->dim_aux_ICU_W_R_unconf_123 * (l - 1) + shared->dim_aux_ICU_W_R_unconf_12 * (k - 1) + shared->dim_aux_ICU_W_R_unconf_1 * (j - 1) + i - 1], shared->p_test);
          }
        }
      }
    }
    ...
    for (int i = 1; i <= shared->dim_n_I_C_2_to_ICU_pre_conf_1; ++i) {
      for (int j = 1; j <= shared->dim_n_I_C_2_to_ICU_pre_conf_2; ++j) {
        for (int k = 1; k <= shared->dim_n_I_C_2_to_ICU_pre_conf_3; ++k) {
          internal.n_I_C_2_to_ICU_pre_conf[i - 1 + shared->dim_n_I_C_2_to_ICU_pre_conf_1 * (j - 1) + shared->dim_n_I_C_2_to_ICU_pre_conf_12 * (k - 1)] = dust::distr::rbinom<real_t>(rng_state, internal.n_I_C_2_to_ICU_pre[shared->dim_n_I_C_2_to_ICU_pre_12 * (k - 1) + shared->dim_n_I_C_2_to_ICU_pre_1 * (j - 1) + i - 1], internal.p_star[i - 1]);
        }
      }
    }
    ...
    real_t delta_new_conf_0_34 = odin_sum4<real_t>(internal.n_H_D_unconf_to_conf.data(), 0, 7, 0, shared->dim_n_H_D_unconf_to_conf_2, 0, shared->dim_n_H_D_unconf_to_conf_3, 0, shared->dim_n_H_D_unconf_to_conf_4, shared->dim_n_H_D_unconf_to_conf_1, shared->dim_n_H_D_unconf_to_conf_12, shared->dim_n_H_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_H_D_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_H_D_unconf_to_conf_2, 0, shared->dim_n_H_D_unconf_to_conf_3, 0, shared->dim_n_H_D_unconf_to_conf_4, shared->dim_n_H_D_unconf_to_conf_1, shared->dim_n_H_D_unconf_to_conf_12, shared->dim_n_H_D_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_H_R_unconf_to_conf.data(), 0, 7, 0, shared->dim_n_H_R_unconf_to_conf_2, 0, shared->dim_n_H_R_unconf_to_conf_3, 0, shared->dim_n_H_R_unconf_to_conf_4, shared->dim_n_H_R_unconf_to_conf_1, shared->dim_n_H_R_unconf_to_conf_12, shared->dim_n_H_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_H_R_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_H_R_unconf_to_conf_2, 0, shared->dim_n_H_R_unconf_to_conf_3, 0, shared->dim_n_H_R_unconf_to_conf_4, shared->dim_n_H_R_unconf_to_conf_1, shared->dim_n_H_R_unconf_to_conf_12, shared->dim_n_H_R_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_ICU_pre_unconf_to_conf.data(), 0, 7, 0, shared->dim_n_ICU_pre_unconf_to_conf_2, 0, shared->dim_n_ICU_pre_unconf_to_conf_3, 0, shared->dim_n_ICU_pre_unconf_to_conf_4, shared->dim_n_ICU_pre_unconf_to_conf_1, shared->dim_n_ICU_pre_unconf_to_conf_12, shared->dim_n_ICU_pre_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_pre_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_ICU_pre_unconf_to_conf_2, 0, shared->dim_n_ICU_pre_unconf_to_conf_3, 0, shared->dim_n_ICU_pre_unconf_to_conf_4, shared->dim_n_ICU_pre_unconf_to_conf_1, shared->dim_n_ICU_pre_unconf_to_conf_12, shared->dim_n_ICU_pre_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_ICU_D_unconf_to_conf.data(), 0, 7, 0, shared->dim_n_ICU_D_unconf_to_conf_2, 0, shared->dim_n_ICU_D_unconf_to_conf_3, 0, shared->dim_n_ICU_D_unconf_to_conf_4, shared->dim_n_ICU_D_unconf_to_conf_1, shared->dim_n_ICU_D_unconf_to_conf_12, shared->dim_n_ICU_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_D_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_ICU_D_unconf_to_conf_2, 0, shared->dim_n_ICU_D_unconf_to_conf_3, 0, shared->dim_n_ICU_D_unconf_to_conf_4, shared->dim_n_ICU_D_unconf_to_conf_1, shared->dim_n_ICU_D_unconf_to_conf_12, shared->dim_n_ICU_D_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_ICU_W_R_unconf_to_conf.data(), 0, 7, 0, shared->dim_n_ICU_W_R_unconf_to_conf_2, 0, shared->dim_n_ICU_W_R_unconf_to_conf_3, 0, shared->dim_n_ICU_W_R_unconf_to_conf_4, shared->dim_n_ICU_W_R_unconf_to_conf_1, shared->dim_n_ICU_W_R_unconf_to_conf_12, shared->dim_n_ICU_W_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_W_R_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_ICU_W_R_unconf_to_conf_2, 0, shared->dim_n_ICU_W_R_unconf_to_conf_3, 0, shared->dim_n_ICU_W_R_unconf_to_conf_4, shared->dim_n_ICU_W_R_unconf_to_conf_1, shared->dim_n_ICU_W_R_unconf_to_conf_12, shared->dim_n_ICU_W_R_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_ICU_W_D_unconf_to_conf.data(), 0, 7, 0, shared->dim_n_ICU_W_D_unconf_to_conf_2, 0, shared->dim_n_ICU_W_D_unconf_to_conf_3, 0, shared->dim_n_ICU_W_D_unconf_to_conf_4, shared->dim_n_ICU_W_D_unconf_to_conf_1, shared->dim_n_ICU_W_D_unconf_to_conf_12, shared->dim_n_ICU_W_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_W_D_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_ICU_W_D_unconf_to_conf_2, 0, shared->dim_n_ICU_W_D_unconf_to_conf_3, 0, shared->dim_n_ICU_W_D_unconf_to_conf_4, shared->dim_n_ICU_W_D_unconf_to_conf_1, shared->dim_n_ICU_W_D_unconf_to_conf_12, shared->dim_n_ICU_W_D_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_W_R_unconf_to_conf.data(), 0, 7, 0, shared->dim_n_W_R_unconf_to_conf_2, 0, shared->dim_n_W_R_unconf_to_conf_3, 0, shared->dim_n_W_R_unconf_to_conf_4, shared->dim_n_W_R_unconf_to_conf_1, shared->dim_n_W_R_unconf_to_conf_12, shared->dim_n_W_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_W_R_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_W_R_unconf_to_conf_2, 0, shared->dim_n_W_R_unconf_to_conf_3, 0, shared->dim_n_W_R_unconf_to_conf_4, shared->dim_n_W_R_unconf_to_conf_1, shared->dim_n_W_R_unconf_to_conf_12, shared->dim_n_W_R_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_W_D_unconf_to_conf.data(), 0, 7, 0, shared->dim_n_W_D_unconf_to_conf_2, 0, shared->dim_n_W_D_unconf_to_conf_3, 0, shared->dim_n_W_D_unconf_to_conf_4, shared->dim_n_W_D_unconf_to_conf_1, shared->dim_n_W_D_unconf_to_conf_12, shared->dim_n_W_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_W_D_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_W_D_unconf_to_conf_2, 0, shared->dim_n_W_D_unconf_to_conf_3, 0, shared->dim_n_W_D_unconf_to_conf_4, shared->dim_n_W_D_unconf_to_conf_1, shared->dim_n_W_D_unconf_to_conf_12, shared->dim_n_W_D_unconf_to_conf_123) * 0.29999999999999999;
    real_t delta_new_conf_0_64 = odin_sum4<real_t>(internal.n_H_D_unconf_to_conf.data(), 0, 13, 0, shared->dim_n_H_D_unconf_to_conf_2, 0, shared->dim_n_H_D_unconf_to_conf_3, 0, shared->dim_n_H_D_unconf_to_conf_4, shared->dim_n_H_D_unconf_to_conf_1, shared->dim_n_H_D_unconf_to_conf_12, shared->dim_n_H_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_H_D_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_H_D_unconf_to_conf_2, 0, shared->dim_n_H_D_unconf_to_conf_3, 0, shared->dim_n_H_D_unconf_to_conf_4, shared->dim_n_H_D_unconf_to_conf_1, shared->dim_n_H_D_unconf_to_conf_12, shared->dim_n_H_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_H_R_unconf_to_conf.data(), 0, 13, 0, shared->dim_n_H_R_unconf_to_conf_2, 0, shared->dim_n_H_R_unconf_to_conf_3, 0, shared->dim_n_H_R_unconf_to_conf_4, shared->dim_n_H_R_unconf_to_conf_1, shared->dim_n_H_R_unconf_to_conf_12, shared->dim_n_H_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_H_R_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_H_R_unconf_to_conf_2, 0, shared->dim_n_H_R_unconf_to_conf_3, 0, shared->dim_n_H_R_unconf_to_conf_4, shared->dim_n_H_R_unconf_to_conf_1, shared->dim_n_H_R_unconf_to_conf_12, shared->dim_n_H_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_pre_unconf_to_conf.data(), 0, 13, 0, shared->dim_n_ICU_pre_unconf_to_conf_2, 0, shared->dim_n_ICU_pre_unconf_to_conf_3, 0, shared->dim_n_ICU_pre_unconf_to_conf_4, shared->dim_n_ICU_pre_unconf_to_conf_1, shared->dim_n_ICU_pre_unconf_to_conf_12, shared->dim_n_ICU_pre_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_pre_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_ICU_pre_unconf_to_conf_2, 0, shared->dim_n_ICU_pre_unconf_to_conf_3, 0, shared->dim_n_ICU_pre_unconf_to_conf_4, shared->dim_n_ICU_pre_unconf_to_conf_1, shared->dim_n_ICU_pre_unconf_to_conf_12, shared->dim_n_ICU_pre_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_D_unconf_to_conf.data(), 0, 13, 0, shared->dim_n_ICU_D_unconf_to_conf_2, 0, shared->dim_n_ICU_D_unconf_to_conf_3, 0, shared->dim_n_ICU_D_unconf_to_conf_4, shared->dim_n_ICU_D_unconf_to_conf_1, shared->dim_n_ICU_D_unconf_to_conf_12, shared->dim_n_ICU_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_D_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_ICU_D_unconf_to_conf_2, 0, shared->dim_n_ICU_D_unconf_to_conf_3, 0, shared->dim_n_ICU_D_unconf_to_conf_4, shared->dim_n_ICU_D_unconf_to_conf_1, shared->dim_n_ICU_D_unconf_to_conf_12, shared->dim_n_ICU_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_W_R_unconf_to_conf.data(), 0, 13, 0, shared->dim_n_ICU_W_R_unconf_to_conf_2, 0, shared->dim_n_ICU_W_R_unconf_to_conf_3, 0, shared->dim_n_ICU_W_R_unconf_to_conf_4, shared->dim_n_ICU_W_R_unconf_to_conf_1, shared->dim_n_ICU_W_R_unconf_to_conf_12, shared->dim_n_ICU_W_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_W_R_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_ICU_W_R_unconf_to_conf_2, 0, shared->dim_n_ICU_W_R_unconf_to_conf_3, 0, shared->dim_n_ICU_W_R_unconf_to_conf_4, shared->dim_n_ICU_W_R_unconf_to_conf_1, shared->dim_n_ICU_W_R_unconf_to_conf_12, shared->dim_n_ICU_W_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_W_D_unconf_to_conf.data(), 0, 13, 0, shared->dim_n_ICU_W_D_unconf_to_conf_2, 0, shared->dim_n_ICU_W_D_unconf_to_conf_3, 0, shared->dim_n_ICU_W_D_unconf_to_conf_4, shared->dim_n_ICU_W_D_unconf_to_conf_1, shared->dim_n_ICU_W_D_unconf_to_conf_12, shared->dim_n_ICU_W_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_W_D_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_ICU_W_D_unconf_to_conf_2, 0, shared->dim_n_ICU_W_D_unconf_to_conf_3, 0, shared->dim_n_ICU_W_D_unconf_to_conf_4, shared->dim_n_ICU_W_D_unconf_to_conf_1, shared->dim_n_ICU_W_D_unconf_to_conf_12, shared->dim_n_ICU_W_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_W_R_unconf_to_conf.data(), 0, 13, 0, shared->dim_n_W_R_unconf_to_conf_2, 0, shared->dim_n_W_R_unconf_to_conf_3, 0, shared->dim_n_W_R_unconf_to_conf_4, shared->dim_n_W_R_unconf_to_conf_1, shared->dim_n_W_R_unconf_to_conf_12, shared->dim_n_W_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_W_R_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_W_R_unconf_to_conf_2, 0, shared->dim_n_W_R_unconf_to_conf_3, 0, shared->dim_n_W_R_unconf_to_conf_4, shared->dim_n_W_R_unconf_to_conf_1, shared->dim_n_W_R_unconf_to_conf_12, shared->dim_n_W_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_W_D_unconf_to_conf.data(), 0, 13, 0, shared->dim_n_W_D_unconf_to_conf_2, 0, shared->dim_n_W_D_unconf_to_conf_3, 0, shared->dim_n_W_D_unconf_to_conf_4, shared->dim_n_W_D_unconf_to_conf_1, shared->dim_n_W_D_unconf_to_conf_12, shared->dim_n_W_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_W_D_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_W_D_unconf_to_conf_2, 0, shared->dim_n_W_D_unconf_to_conf_3, 0, shared->dim_n_W_D_unconf_to_conf_4, shared->dim_n_W_D_unconf_to_conf_1, shared->dim_n_W_D_unconf_to_conf_12, shared->dim_n_W_D_unconf_to_conf_123);
    real_t delta_new_conf_35_54 = odin_sum4<real_t>(internal.n_H_D_unconf_to_conf.data(), 7, 11, 0, shared->dim_n_H_D_unconf_to_conf_2, 0, shared->dim_n_H_D_unconf_to_conf_3, 0, shared->dim_n_H_D_unconf_to_conf_4, shared->dim_n_H_D_unconf_to_conf_1, shared->dim_n_H_D_unconf_to_conf_12, shared->dim_n_H_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_H_D_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_H_D_unconf_to_conf_2, 0, shared->dim_n_H_D_unconf_to_conf_3, 0, shared->dim_n_H_D_unconf_to_conf_4, shared->dim_n_H_D_unconf_to_conf_1, shared->dim_n_H_D_unconf_to_conf_12, shared->dim_n_H_D_unconf_to_conf_123) * 0.40000000000000002 + odin_sum4<real_t>(internal.n_H_R_unconf_to_conf.data(), 7, 11, 0, shared->dim_n_H_R_unconf_to_conf_2, 0, shared->dim_n_H_R_unconf_to_conf_3, 0, shared->dim_n_H_R_unconf_to_conf_4, shared->dim_n_H_R_unconf_to_conf_1, shared->dim_n_H_R_unconf_to_conf_12, shared->dim_n_H_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_H_R_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_H_R_unconf_to_conf_2, 0, shared->dim_n_H_R_unconf_to_conf_3, 0, shared->dim_n_H_R_unconf_to_conf_4, shared->dim_n_H_R_unconf_to_conf_1, shared->dim_n_H_R_unconf_to_conf_12, shared->dim_n_H_R_unconf_to_conf_123) * 0.40000000000000002 + odin_sum4<real_t>(internal.n_ICU_pre_unconf_to_conf.data(), 7, 11, 0, shared->dim_n_ICU_pre_unconf_to_conf_2, 0, shared->dim_n_ICU_pre_unconf_to_conf_3, 0, shared->dim_n_ICU_pre_unconf_to_conf_4, shared->dim_n_ICU_pre_unconf_to_conf_1, shared->dim_n_ICU_pre_unconf_to_conf_12, shared->dim_n_ICU_pre_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_pre_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_ICU_pre_unconf_to_conf_2, 0, shared->dim_n_ICU_pre_unconf_to_conf_3, 0, shared->dim_n_ICU_pre_unconf_to_conf_4, shared->dim_n_ICU_pre_unconf_to_conf_1, shared->dim_n_ICU_pre_unconf_to_conf_12, shared->dim_n_ICU_pre_unconf_to_conf_123) * 0.40000000000000002 + odin_sum4<real_t>(internal.n_ICU_D_unconf_to_conf.data(), 7, 11, 0, shared->dim_n_ICU_D_unconf_to_conf_2, 0, shared->dim_n_ICU_D_unconf_to_conf_3, 0, shared->dim_n_ICU_D_unconf_to_conf_4, shared->dim_n_ICU_D_unconf_to_conf_1, shared->dim_n_ICU_D_unconf_to_conf_12, shared->dim_n_ICU_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_D_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_ICU_D_unconf_to_conf_2, 0, shared->dim_n_ICU_D_unconf_to_conf_3, 0, shared->dim_n_ICU_D_unconf_to_conf_4, shared->dim_n_ICU_D_unconf_to_conf_1, shared->dim_n_ICU_D_unconf_to_conf_12, shared->dim_n_ICU_D_unconf_to_conf_123) * 0.40000000000000002 + odin_sum4<real_t>(internal.n_ICU_W_R_unconf_to_conf.data(), 7, 11, 0, shared->dim_n_ICU_W_R_unconf_to_conf_2, 0, shared->dim_n_ICU_W_R_unconf_to_conf_3, 0, shared->dim_n_ICU_W_R_unconf_to_conf_4, shared->dim_n_ICU_W_R_unconf_to_conf_1, shared->dim_n_ICU_W_R_unconf_to_conf_12, shared->dim_n_ICU_W_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_W_R_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_ICU_W_R_unconf_to_conf_2, 0, shared->dim_n_ICU_W_R_unconf_to_conf_3, 0, shared->dim_n_ICU_W_R_unconf_to_conf_4, shared->dim_n_ICU_W_R_unconf_to_conf_1, shared->dim_n_ICU_W_R_unconf_to_conf_12, shared->dim_n_ICU_W_R_unconf_to_conf_123) * 0.40000000000000002 + odin_sum4<real_t>(internal.n_ICU_W_D_unconf_to_conf.data(), 7, 11, 0, shared->dim_n_ICU_W_D_unconf_to_conf_2, 0, shared->dim_n_ICU_W_D_unconf_to_conf_3, 0, shared->dim_n_ICU_W_D_unconf_to_conf_4, shared->dim_n_ICU_W_D_unconf_to_conf_1, shared->dim_n_ICU_W_D_unconf_to_conf_12, shared->dim_n_ICU_W_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_W_D_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_ICU_W_D_unconf_to_conf_2, 0, shared->dim_n_ICU_W_D_unconf_to_conf_3, 0, shared->dim_n_ICU_W_D_unconf_to_conf_4, shared->dim_n_ICU_W_D_unconf_to_conf_1, shared->dim_n_ICU_W_D_unconf_to_conf_12, shared->dim_n_ICU_W_D_unconf_to_conf_123) * 0.40000000000000002 + odin_sum4<real_t>(internal.n_W_R_unconf_to_conf.data(), 7, 11, 0, shared->dim_n_W_R_unconf_to_conf_2, 0, shared->dim_n_W_R_unconf_to_conf_3, 0, shared->dim_n_W_R_unconf_to_conf_4, shared->dim_n_W_R_unconf_to_conf_1, shared->dim_n_W_R_unconf_to_conf_12, shared->dim_n_W_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_W_R_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_W_R_unconf_to_conf_2, 0, shared->dim_n_W_R_unconf_to_conf_3, 0, shared->dim_n_W_R_unconf_to_conf_4, shared->dim_n_W_R_unconf_to_conf_1, shared->dim_n_W_R_unconf_to_conf_12, shared->dim_n_W_R_unconf_to_conf_123) * 0.40000000000000002 + odin_sum4<real_t>(internal.n_W_D_unconf_to_conf.data(), 7, 11, 0, shared->dim_n_W_D_unconf_to_conf_2, 0, shared->dim_n_W_D_unconf_to_conf_3, 0, shared->dim_n_W_D_unconf_to_conf_4, shared->dim_n_W_D_unconf_to_conf_1, shared->dim_n_W_D_unconf_to_conf_12, shared->dim_n_W_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_W_D_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_W_D_unconf_to_conf_2, 0, shared->dim_n_W_D_unconf_to_conf_3, 0, shared->dim_n_W_D_unconf_to_conf_4, shared->dim_n_W_D_unconf_to_conf_1, shared->dim_n_W_D_unconf_to_conf_12, shared->dim_n_W_D_unconf_to_conf_123) * 0.40000000000000002;
    real_t delta_new_conf_55_64 = odin_sum4<real_t>(internal.n_H_D_unconf_to_conf.data(), 11, 13, 0, shared->dim_n_H_D_unconf_to_conf_2, 0, shared->dim_n_H_D_unconf_to_conf_3, 0, shared->dim_n_H_D_unconf_to_conf_4, shared->dim_n_H_D_unconf_to_conf_1, shared->dim_n_H_D_unconf_to_conf_12, shared->dim_n_H_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_H_D_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_H_D_unconf_to_conf_2, 0, shared->dim_n_H_D_unconf_to_conf_3, 0, shared->dim_n_H_D_unconf_to_conf_4, shared->dim_n_H_D_unconf_to_conf_1, shared->dim_n_H_D_unconf_to_conf_12, shared->dim_n_H_D_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_H_R_unconf_to_conf.data(), 11, 13, 0, shared->dim_n_H_R_unconf_to_conf_2, 0, shared->dim_n_H_R_unconf_to_conf_3, 0, shared->dim_n_H_R_unconf_to_conf_4, shared->dim_n_H_R_unconf_to_conf_1, shared->dim_n_H_R_unconf_to_conf_12, shared->dim_n_H_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_H_R_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_H_R_unconf_to_conf_2, 0, shared->dim_n_H_R_unconf_to_conf_3, 0, shared->dim_n_H_R_unconf_to_conf_4, shared->dim_n_H_R_unconf_to_conf_1, shared->dim_n_H_R_unconf_to_conf_12, shared->dim_n_H_R_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_ICU_pre_unconf_to_conf.data(), 11, 13, 0, shared->dim_n_ICU_pre_unconf_to_conf_2, 0, shared->dim_n_ICU_pre_unconf_to_conf_3, 0, shared->dim_n_ICU_pre_unconf_to_conf_4, shared->dim_n_ICU_pre_unconf_to_conf_1, shared->dim_n_ICU_pre_unconf_to_conf_12, shared->dim_n_ICU_pre_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_pre_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_ICU_pre_unconf_to_conf_2, 0, shared->dim_n_ICU_pre_unconf_to_conf_3, 0, shared->dim_n_ICU_pre_unconf_to_conf_4, shared->dim_n_ICU_pre_unconf_to_conf_1, shared->dim_n_ICU_pre_unconf_to_conf_12, shared->dim_n_ICU_pre_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_ICU_D_unconf_to_conf.data(), 11, 13, 0, shared->dim_n_ICU_D_unconf_to_conf_2, 0, shared->dim_n_ICU_D_unconf_to_conf_3, 0, shared->dim_n_ICU_D_unconf_to_conf_4, shared->dim_n_ICU_D_unconf_to_conf_1, shared->dim_n_ICU_D_unconf_to_conf_12, shared->dim_n_ICU_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_D_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_ICU_D_unconf_to_conf_2, 0, shared->dim_n_ICU_D_unconf_to_conf_3, 0, shared->dim_n_ICU_D_unconf_to_conf_4, shared->dim_n_ICU_D_unconf_to_conf_1, shared->dim_n_ICU_D_unconf_to_conf_12, shared->dim_n_ICU_D_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_ICU_W_R_unconf_to_conf.data(), 11, 13, 0, shared->dim_n_ICU_W_R_unconf_to_conf_2, 0, shared->dim_n_ICU_W_R_unconf_to_conf_3, 0, shared->dim_n_ICU_W_R_unconf_to_conf_4, shared->dim_n_ICU_W_R_unconf_to_conf_1, shared->dim_n_ICU_W_R_unconf_to_conf_12, shared->dim_n_ICU_W_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_W_R_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_ICU_W_R_unconf_to_conf_2, 0, shared->dim_n_ICU_W_R_unconf_to_conf_3, 0, shared->dim_n_ICU_W_R_unconf_to_conf_4, shared->dim_n_ICU_W_R_unconf_to_conf_1, shared->dim_n_ICU_W_R_unconf_to_conf_12, shared->dim_n_ICU_W_R_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_ICU_W_D_unconf_to_conf.data(), 11, 13, 0, shared->dim_n_ICU_W_D_unconf_to_conf_2, 0, shared->dim_n_ICU_W_D_unconf_to_conf_3, 0, shared->dim_n_ICU_W_D_unconf_to_conf_4, shared->dim_n_ICU_W_D_unconf_to_conf_1, shared->dim_n_ICU_W_D_unconf_to_conf_12, shared->dim_n_ICU_W_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_W_D_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_ICU_W_D_unconf_to_conf_2, 0, shared->dim_n_ICU_W_D_unconf_to_conf_3, 0, shared->dim_n_ICU_W_D_unconf_to_conf_4, shared->dim_n_ICU_W_D_unconf_to_conf_1, shared->dim_n_ICU_W_D_unconf_to_conf_12, shared->dim_n_ICU_W_D_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_W_R_unconf_to_conf.data(), 11, 13, 0, shared->dim_n_W_R_unconf_to_conf_2, 0, shared->dim_n_W_R_unconf_to_conf_3, 0, shared->dim_n_W_R_unconf_to_conf_4, shared->dim_n_W_R_unconf_to_conf_1, shared->dim_n_W_R_unconf_to_conf_12, shared->dim_n_W_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_W_R_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_W_R_unconf_to_conf_2, 0, shared->dim_n_W_R_unconf_to_conf_3, 0, shared->dim_n_W_R_unconf_to_conf_4, shared->dim_n_W_R_unconf_to_conf_1, shared->dim_n_W_R_unconf_to_conf_12, shared->dim_n_W_R_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_W_D_unconf_to_conf.data(), 11, 13, 0, shared->dim_n_W_D_unconf_to_conf_2, 0, shared->dim_n_W_D_unconf_to_conf_3, 0, shared->dim_n_W_D_unconf_to_conf_4, shared->dim_n_W_D_unconf_to_conf_1, shared->dim_n_W_D_unconf_to_conf_12, shared->dim_n_W_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_W_D_unconf_to_conf.data(), 17, 18, 0, shared->dim_n_W_D_unconf_to_conf_2, 0, shared->dim_n_W_D_unconf_to_conf_3, 0, shared->dim_n_W_D_unconf_to_conf_4, shared->dim_n_W_D_unconf_to_conf_1, shared->dim_n_W_D_unconf_to_conf_12, shared->dim_n_W_D_unconf_to_conf_123) * 0.29999999999999999;
    real_t delta_new_conf_65_74 = odin_sum4<real_t>(internal.n_H_D_unconf_to_conf.data(), 13, 15, 0, shared->dim_n_H_D_unconf_to_conf_2, 0, shared->dim_n_H_D_unconf_to_conf_3, 0, shared->dim_n_H_D_unconf_to_conf_4, shared->dim_n_H_D_unconf_to_conf_1, shared->dim_n_H_D_unconf_to_conf_12, shared->dim_n_H_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_H_D_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_H_D_unconf_to_conf_2, 0, shared->dim_n_H_D_unconf_to_conf_3, 0, shared->dim_n_H_D_unconf_to_conf_4, shared->dim_n_H_D_unconf_to_conf_1, shared->dim_n_H_D_unconf_to_conf_12, shared->dim_n_H_D_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_H_R_unconf_to_conf.data(), 13, 15, 0, shared->dim_n_H_R_unconf_to_conf_2, 0, shared->dim_n_H_R_unconf_to_conf_3, 0, shared->dim_n_H_R_unconf_to_conf_4, shared->dim_n_H_R_unconf_to_conf_1, shared->dim_n_H_R_unconf_to_conf_12, shared->dim_n_H_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_H_R_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_H_R_unconf_to_conf_2, 0, shared->dim_n_H_R_unconf_to_conf_3, 0, shared->dim_n_H_R_unconf_to_conf_4, shared->dim_n_H_R_unconf_to_conf_1, shared->dim_n_H_R_unconf_to_conf_12, shared->dim_n_H_R_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_ICU_pre_unconf_to_conf.data(), 13, 15, 0, shared->dim_n_ICU_pre_unconf_to_conf_2, 0, shared->dim_n_ICU_pre_unconf_to_conf_3, 0, shared->dim_n_ICU_pre_unconf_to_conf_4, shared->dim_n_ICU_pre_unconf_to_conf_1, shared->dim_n_ICU_pre_unconf_to_conf_12, shared->dim_n_ICU_pre_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_pre_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_ICU_pre_unconf_to_conf_2, 0, shared->dim_n_ICU_pre_unconf_to_conf_3, 0, shared->dim_n_ICU_pre_unconf_to_conf_4, shared->dim_n_ICU_pre_unconf_to_conf_1, shared->dim_n_ICU_pre_unconf_to_conf_12, shared->dim_n_ICU_pre_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_ICU_D_unconf_to_conf.data(), 13, 15, 0, shared->dim_n_ICU_D_unconf_to_conf_2, 0, shared->dim_n_ICU_D_unconf_to_conf_3, 0, shared->dim_n_ICU_D_unconf_to_conf_4, shared->dim_n_ICU_D_unconf_to_conf_1, shared->dim_n_ICU_D_unconf_to_conf_12, shared->dim_n_ICU_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_D_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_ICU_D_unconf_to_conf_2, 0, shared->dim_n_ICU_D_unconf_to_conf_3, 0, shared->dim_n_ICU_D_unconf_to_conf_4, shared->dim_n_ICU_D_unconf_to_conf_1, shared->dim_n_ICU_D_unconf_to_conf_12, shared->dim_n_ICU_D_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_ICU_W_R_unconf_to_conf.data(), 13, 15, 0, shared->dim_n_ICU_W_R_unconf_to_conf_2, 0, shared->dim_n_ICU_W_R_unconf_to_conf_3, 0, shared->dim_n_ICU_W_R_unconf_to_conf_4, shared->dim_n_ICU_W_R_unconf_to_conf_1, shared->dim_n_ICU_W_R_unconf_to_conf_12, shared->dim_n_ICU_W_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_W_R_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_ICU_W_R_unconf_to_conf_2, 0, shared->dim_n_ICU_W_R_unconf_to_conf_3, 0, shared->dim_n_ICU_W_R_unconf_to_conf_4, shared->dim_n_ICU_W_R_unconf_to_conf_1, shared->dim_n_ICU_W_R_unconf_to_conf_12, shared->dim_n_ICU_W_R_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_ICU_W_D_unconf_to_conf.data(), 13, 15, 0, shared->dim_n_ICU_W_D_unconf_to_conf_2, 0, shared->dim_n_ICU_W_D_unconf_to_conf_3, 0, shared->dim_n_ICU_W_D_unconf_to_conf_4, shared->dim_n_ICU_W_D_unconf_to_conf_1, shared->dim_n_ICU_W_D_unconf_to_conf_12, shared->dim_n_ICU_W_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_W_D_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_ICU_W_D_unconf_to_conf_2, 0, shared->dim_n_ICU_W_D_unconf_to_conf_3, 0, shared->dim_n_ICU_W_D_unconf_to_conf_4, shared->dim_n_ICU_W_D_unconf_to_conf_1, shared->dim_n_ICU_W_D_unconf_to_conf_12, shared->dim_n_ICU_W_D_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_W_R_unconf_to_conf.data(), 13, 15, 0, shared->dim_n_W_R_unconf_to_conf_2, 0, shared->dim_n_W_R_unconf_to_conf_3, 0, shared->dim_n_W_R_unconf_to_conf_4, shared->dim_n_W_R_unconf_to_conf_1, shared->dim_n_W_R_unconf_to_conf_12, shared->dim_n_W_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_W_R_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_W_R_unconf_to_conf_2, 0, shared->dim_n_W_R_unconf_to_conf_3, 0, shared->dim_n_W_R_unconf_to_conf_4, shared->dim_n_W_R_unconf_to_conf_1, shared->dim_n_W_R_unconf_to_conf_12, shared->dim_n_W_R_unconf_to_conf_123) * 0.29999999999999999 + odin_sum4<real_t>(internal.n_W_D_unconf_to_conf.data(), 13, 15, 0, shared->dim_n_W_D_unconf_to_conf_2, 0, shared->dim_n_W_D_unconf_to_conf_3, 0, shared->dim_n_W_D_unconf_to_conf_4, shared->dim_n_W_D_unconf_to_conf_1, shared->dim_n_W_D_unconf_to_conf_12, shared->dim_n_W_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_W_D_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_W_D_unconf_to_conf_2, 0, shared->dim_n_W_D_unconf_to_conf_3, 0, shared->dim_n_W_D_unconf_to_conf_4, shared->dim_n_W_D_unconf_to_conf_1, shared->dim_n_W_D_unconf_to_conf_12, shared->dim_n_W_D_unconf_to_conf_123) * 0.29999999999999999;
    real_t delta_new_conf_65_plus = odin_sum4<real_t>(internal.n_H_D_unconf_to_conf.data(), 13, 17, 0, shared->dim_n_H_D_unconf_to_conf_2, 0, shared->dim_n_H_D_unconf_to_conf_3, 0, shared->dim_n_H_D_unconf_to_conf_4, shared->dim_n_H_D_unconf_to_conf_1, shared->dim_n_H_D_unconf_to_conf_12, shared->dim_n_H_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_H_D_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_H_D_unconf_to_conf_2, 0, shared->dim_n_H_D_unconf_to_conf_3, 0, shared->dim_n_H_D_unconf_to_conf_4, shared->dim_n_H_D_unconf_to_conf_1, shared->dim_n_H_D_unconf_to_conf_12, shared->dim_n_H_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_H_R_unconf_to_conf.data(), 13, 17, 0, shared->dim_n_H_R_unconf_to_conf_2, 0, shared->dim_n_H_R_unconf_to_conf_3, 0, shared->dim_n_H_R_unconf_to_conf_4, shared->dim_n_H_R_unconf_to_conf_1, shared->dim_n_H_R_unconf_to_conf_12, shared->dim_n_H_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_H_R_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_H_R_unconf_to_conf_2, 0, shared->dim_n_H_R_unconf_to_conf_3, 0, shared->dim_n_H_R_unconf_to_conf_4, shared->dim_n_H_R_unconf_to_conf_1, shared->dim_n_H_R_unconf_to_conf_12, shared->dim_n_H_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_pre_unconf_to_conf.data(), 13, 17, 0, shared->dim_n_ICU_pre_unconf_to_conf_2, 0, shared->dim_n_ICU_pre_unconf_to_conf_3, 0, shared->dim_n_ICU_pre_unconf_to_conf_4, shared->dim_n_ICU_pre_unconf_to_conf_1, shared->dim_n_ICU_pre_unconf_to_conf_12, shared->dim_n_ICU_pre_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_pre_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_ICU_pre_unconf_to_conf_2, 0, shared->dim_n_ICU_pre_unconf_to_conf_3, 0, shared->dim_n_ICU_pre_unconf_to_conf_4, shared->dim_n_ICU_pre_unconf_to_conf_1, shared->dim_n_ICU_pre_unconf_to_conf_12, shared->dim_n_ICU_pre_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_D_unconf_to_conf.data(), 13, 17, 0, shared->dim_n_ICU_D_unconf_to_conf_2, 0, shared->dim_n_ICU_D_unconf_to_conf_3, 0, shared->dim_n_ICU_D_unconf_to_conf_4, shared->dim_n_ICU_D_unconf_to_conf_1, shared->dim_n_ICU_D_unconf_to_conf_12, shared->dim_n_ICU_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_D_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_ICU_D_unconf_to_conf_2, 0, shared->dim_n_ICU_D_unconf_to_conf_3, 0, shared->dim_n_ICU_D_unconf_to_conf_4, shared->dim_n_ICU_D_unconf_to_conf_1, shared->dim_n_ICU_D_unconf_to_conf_12, shared->dim_n_ICU_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_W_R_unconf_to_conf.data(), 13, 17, 0, shared->dim_n_ICU_W_R_unconf_to_conf_2, 0, shared->dim_n_ICU_W_R_unconf_to_conf_3, 0, shared->dim_n_ICU_W_R_unconf_to_conf_4, shared->dim_n_ICU_W_R_unconf_to_conf_1, shared->dim_n_ICU_W_R_unconf_to_conf_12, shared->dim_n_ICU_W_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_W_R_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_ICU_W_R_unconf_to_conf_2, 0, shared->dim_n_ICU_W_R_unconf_to_conf_3, 0, shared->dim_n_ICU_W_R_unconf_to_conf_4, shared->dim_n_ICU_W_R_unconf_to_conf_1, shared->dim_n_ICU_W_R_unconf_to_conf_12, shared->dim_n_ICU_W_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_W_D_unconf_to_conf.data(), 13, 17, 0, shared->dim_n_ICU_W_D_unconf_to_conf_2, 0, shared->dim_n_ICU_W_D_unconf_to_conf_3, 0, shared->dim_n_ICU_W_D_unconf_to_conf_4, shared->dim_n_ICU_W_D_unconf_to_conf_1, shared->dim_n_ICU_W_D_unconf_to_conf_12, shared->dim_n_ICU_W_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_W_D_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_ICU_W_D_unconf_to_conf_2, 0, shared->dim_n_ICU_W_D_unconf_to_conf_3, 0, shared->dim_n_ICU_W_D_unconf_to_conf_4, shared->dim_n_ICU_W_D_unconf_to_conf_1, shared->dim_n_ICU_W_D_unconf_to_conf_12, shared->dim_n_ICU_W_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_W_R_unconf_to_conf.data(), 13, 17, 0, shared->dim_n_W_R_unconf_to_conf_2, 0, shared->dim_n_W_R_unconf_to_conf_3, 0, shared->dim_n_W_R_unconf_to_conf_4, shared->dim_n_W_R_unconf_to_conf_1, shared->dim_n_W_R_unconf_to_conf_12, shared->dim_n_W_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_W_R_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_W_R_unconf_to_conf_2, 0, shared->dim_n_W_R_unconf_to_conf_3, 0, shared->dim_n_W_R_unconf_to_conf_4, shared->dim_n_W_R_unconf_to_conf_1, shared->dim_n_W_R_unconf_to_conf_12, shared->dim_n_W_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_W_D_unconf_to_conf.data(), 13, 17, 0, shared->dim_n_W_D_unconf_to_conf_2, 0, shared->dim_n_W_D_unconf_to_conf_3, 0, shared->dim_n_W_D_unconf_to_conf_4, shared->dim_n_W_D_unconf_to_conf_1, shared->dim_n_W_D_unconf_to_conf_12, shared->dim_n_W_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_W_D_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_W_D_unconf_to_conf_2, 0, shared->dim_n_W_D_unconf_to_conf_3, 0, shared->dim_n_W_D_unconf_to_conf_4, shared->dim_n_W_D_unconf_to_conf_1, shared->dim_n_W_D_unconf_to_conf_12, shared->dim_n_W_D_unconf_to_conf_123);
    real_t delta_new_conf_75_plus = odin_sum4<real_t>(internal.n_H_D_unconf_to_conf.data(), 15, 17, 0, shared->dim_n_H_D_unconf_to_conf_2, 0, shared->dim_n_H_D_unconf_to_conf_3, 0, shared->dim_n_H_D_unconf_to_conf_4, shared->dim_n_H_D_unconf_to_conf_1, shared->dim_n_H_D_unconf_to_conf_12, shared->dim_n_H_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_H_D_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_H_D_unconf_to_conf_2, 0, shared->dim_n_H_D_unconf_to_conf_3, 0, shared->dim_n_H_D_unconf_to_conf_4, shared->dim_n_H_D_unconf_to_conf_1, shared->dim_n_H_D_unconf_to_conf_12, shared->dim_n_H_D_unconf_to_conf_123) * 0.69999999999999996 + odin_sum4<real_t>(internal.n_H_R_unconf_to_conf.data(), 15, 17, 0, shared->dim_n_H_R_unconf_to_conf_2, 0, shared->dim_n_H_R_unconf_to_conf_3, 0, shared->dim_n_H_R_unconf_to_conf_4, shared->dim_n_H_R_unconf_to_conf_1, shared->dim_n_H_R_unconf_to_conf_12, shared->dim_n_H_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_H_R_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_H_R_unconf_to_conf_2, 0, shared->dim_n_H_R_unconf_to_conf_3, 0, shared->dim_n_H_R_unconf_to_conf_4, shared->dim_n_H_R_unconf_to_conf_1, shared->dim_n_H_R_unconf_to_conf_12, shared->dim_n_H_R_unconf_to_conf_123) * 0.69999999999999996 + odin_sum4<real_t>(internal.n_ICU_pre_unconf_to_conf.data(), 15, 17, 0, shared->dim_n_ICU_pre_unconf_to_conf_2, 0, shared->dim_n_ICU_pre_unconf_to_conf_3, 0, shared->dim_n_ICU_pre_unconf_to_conf_4, shared->dim_n_ICU_pre_unconf_to_conf_1, shared->dim_n_ICU_pre_unconf_to_conf_12, shared->dim_n_ICU_pre_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_pre_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_ICU_pre_unconf_to_conf_2, 0, shared->dim_n_ICU_pre_unconf_to_conf_3, 0, shared->dim_n_ICU_pre_unconf_to_conf_4, shared->dim_n_ICU_pre_unconf_to_conf_1, shared->dim_n_ICU_pre_unconf_to_conf_12, shared->dim_n_ICU_pre_unconf_to_conf_123) * 0.69999999999999996 + odin_sum4<real_t>(internal.n_ICU_D_unconf_to_conf.data(), 15, 17, 0, shared->dim_n_ICU_D_unconf_to_conf_2, 0, shared->dim_n_ICU_D_unconf_to_conf_3, 0, shared->dim_n_ICU_D_unconf_to_conf_4, shared->dim_n_ICU_D_unconf_to_conf_1, shared->dim_n_ICU_D_unconf_to_conf_12, shared->dim_n_ICU_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_D_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_ICU_D_unconf_to_conf_2, 0, shared->dim_n_ICU_D_unconf_to_conf_3, 0, shared->dim_n_ICU_D_unconf_to_conf_4, shared->dim_n_ICU_D_unconf_to_conf_1, shared->dim_n_ICU_D_unconf_to_conf_12, shared->dim_n_ICU_D_unconf_to_conf_123) * 0.69999999999999996 + odin_sum4<real_t>(internal.n_ICU_W_R_unconf_to_conf.data(), 15, 17, 0, shared->dim_n_ICU_W_R_unconf_to_conf_2, 0, shared->dim_n_ICU_W_R_unconf_to_conf_3, 0, shared->dim_n_ICU_W_R_unconf_to_conf_4, shared->dim_n_ICU_W_R_unconf_to_conf_1, shared->dim_n_ICU_W_R_unconf_to_conf_12, shared->dim_n_ICU_W_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_W_R_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_ICU_W_R_unconf_to_conf_2, 0, shared->dim_n_ICU_W_R_unconf_to_conf_3, 0, shared->dim_n_ICU_W_R_unconf_to_conf_4, shared->dim_n_ICU_W_R_unconf_to_conf_1, shared->dim_n_ICU_W_R_unconf_to_conf_12, shared->dim_n_ICU_W_R_unconf_to_conf_123) * 0.69999999999999996 + odin_sum4<real_t>(internal.n_ICU_W_D_unconf_to_conf.data(), 15, 17, 0, shared->dim_n_ICU_W_D_unconf_to_conf_2, 0, shared->dim_n_ICU_W_D_unconf_to_conf_3, 0, shared->dim_n_ICU_W_D_unconf_to_conf_4, shared->dim_n_ICU_W_D_unconf_to_conf_1, shared->dim_n_ICU_W_D_unconf_to_conf_12, shared->dim_n_ICU_W_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_W_D_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_ICU_W_D_unconf_to_conf_2, 0, shared->dim_n_ICU_W_D_unconf_to_conf_3, 0, shared->dim_n_ICU_W_D_unconf_to_conf_4, shared->dim_n_ICU_W_D_unconf_to_conf_1, shared->dim_n_ICU_W_D_unconf_to_conf_12, shared->dim_n_ICU_W_D_unconf_to_conf_123) * 0.69999999999999996 + odin_sum4<real_t>(internal.n_W_R_unconf_to_conf.data(), 15, 17, 0, shared->dim_n_W_R_unconf_to_conf_2, 0, shared->dim_n_W_R_unconf_to_conf_3, 0, shared->dim_n_W_R_unconf_to_conf_4, shared->dim_n_W_R_unconf_to_conf_1, shared->dim_n_W_R_unconf_to_conf_12, shared->dim_n_W_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_W_R_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_W_R_unconf_to_conf_2, 0, shared->dim_n_W_R_unconf_to_conf_3, 0, shared->dim_n_W_R_unconf_to_conf_4, shared->dim_n_W_R_unconf_to_conf_1, shared->dim_n_W_R_unconf_to_conf_12, shared->dim_n_W_R_unconf_to_conf_123) * 0.69999999999999996 + odin_sum4<real_t>(internal.n_W_D_unconf_to_conf.data(), 15, 17, 0, shared->dim_n_W_D_unconf_to_conf_2, 0, shared->dim_n_W_D_unconf_to_conf_3, 0, shared->dim_n_W_D_unconf_to_conf_4, shared->dim_n_W_D_unconf_to_conf_1, shared->dim_n_W_D_unconf_to_conf_12, shared->dim_n_W_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_W_D_unconf_to_conf.data(), 18, 19, 0, shared->dim_n_W_D_unconf_to_conf_2, 0, shared->dim_n_W_D_unconf_to_conf_3, 0, shared->dim_n_W_D_unconf_to_conf_4, shared->dim_n_W_D_unconf_to_conf_1, shared->dim_n_W_D_unconf_to_conf_12, shared->dim_n_W_D_unconf_to_conf_123) * 0.69999999999999996;
    ...
    for (int i = 1; i <= shared->dim_n_I_C_2_to_H_D_conf_1; ++i) {
      for (int j = 1; j <= shared->dim_n_I_C_2_to_H_D_conf_2; ++j) {
        for (int k = 1; k <= shared->dim_n_I_C_2_to_H_D_conf_3; ++k) {
          internal.n_I_C_2_to_H_D_conf[i - 1 + shared->dim_n_I_C_2_to_H_D_conf_1 * (j - 1) + shared->dim_n_I_C_2_to_H_D_conf_12 * (k - 1)] = dust::distr::rbinom<real_t>(rng_state, internal.n_I_C_2_to_H_D[shared->dim_n_I_C_2_to_H_D_12 * (k - 1) + shared->dim_n_I_C_2_to_H_D_1 * (j - 1) + i - 1], internal.p_star[i - 1]);
        }
      }
    }
    ...
    state_next[20] = cum_new_conf + delta_new_conf;
    state_next[30] = cum_new_conf_0_34 + delta_new_conf_0_34;
    state_next[23] = cum_new_conf_0_64 + delta_new_conf_0_64;
    state_next[31] = cum_new_conf_35_54 + delta_new_conf_35_54;
    state_next[32] = cum_new_conf_55_64 + delta_new_conf_55_64;
    state_next[33] = cum_new_conf_65_74 + delta_new_conf_65_74;
    state_next[24] = cum_new_conf_65_plus + delta_new_conf_65_plus;
    state_next[34] = cum_new_conf_75_plus + delta_new_conf_75_plus;
    state_next[9] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_new_conf : new_conf_inc + delta_new_conf);
    state_next[12] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_new_conf_0_34 : new_conf_inc_0_34 + delta_new_conf_0_34);
    state_next[10] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_new_conf_0_64 : new_conf_inc_0_64 + delta_new_conf_0_64);
    state_next[13] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_new_conf_35_54 : new_conf_inc_35_54 + delta_new_conf_35_54);
    state_next[14] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_new_conf_55_64 : new_conf_inc_55_64 + delta_new_conf_55_64);
    state_next[15] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_new_conf_65_74 : new_conf_inc_65_74 + delta_new_conf_65_74);
    state_next[11] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_new_conf_65_plus : new_conf_inc_65_plus + delta_new_conf_65_plus);
    state_next[16] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_new_conf_75_plus : new_conf_inc_75_plus + delta_new_conf_75_plus);
    ...
    for (int i = 1; i <= shared->dim_n_I_C_2_to_H_R_conf_1; ++i) {
      for (int j = 1; j <= shared->dim_n_I_C_2_to_H_R_conf_2; ++j) {
        for (int k = 1; k <= shared->dim_n_I_C_2_to_H_R_conf_3; ++k) {
          internal.n_I_C_2_to_H_R_conf[i - 1 + shared->dim_n_I_C_2_to_H_R_conf_1 * (j - 1) + shared->dim_n_I_C_2_to_H_R_conf_12 * (k - 1)] = dust::distr::rbinom<real_t>(rng_state, internal.n_I_C_2_to_H_R[shared->dim_n_I_C_2_to_H_R_12 * (k - 1) + shared->dim_n_I_C_2_to_H_R_1 * (j - 1) + i - 1], internal.p_star[i - 1]);
        }
      }
    }
    ...
    real_t delta_admit_conf_0_34 = odin_sum3<real_t>(internal.n_I_C_2_to_H_D_conf.data(), 0, 7, 0, shared->dim_n_I_C_2_to_H_D_conf_2, 0, shared->dim_n_I_C_2_to_H_D_conf_3, shared->dim_n_I_C_2_to_H_D_conf_1, shared->dim_n_I_C_2_to_H_D_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_H_D_conf.data(), 17, 18, 0, shared->dim_n_I_C_2_to_H_D_conf_2, 0, shared->dim_n_I_C_2_to_H_D_conf_3, shared->dim_n_I_C_2_to_H_D_conf_1, shared->dim_n_I_C_2_to_H_D_conf_12) * 0.29999999999999999 + odin_sum3<real_t>(internal.n_I_C_2_to_H_R_conf.data(), 0, 7, 0, shared->dim_n_I_C_2_to_H_R_conf_2, 0, shared->dim_n_I_C_2_to_H_R_conf_3, shared->dim_n_I_C_2_to_H_R_conf_1, shared->dim_n_I_C_2_to_H_R_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_H_R_conf.data(), 17, 18, 0, shared->dim_n_I_C_2_to_H_R_conf_2, 0, shared->dim_n_I_C_2_to_H_R_conf_3, shared->dim_n_I_C_2_to_H_R_conf_1, shared->dim_n_I_C_2_to_H_R_conf_12) * 0.29999999999999999 + odin_sum3<real_t>(internal.n_I_C_2_to_ICU_pre_conf.data(), 0, 7, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_2, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_3, shared->dim_n_I_C_2_to_ICU_pre_conf_1, shared->dim_n_I_C_2_to_ICU_pre_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_ICU_pre_conf.data(), 17, 18, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_2, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_3, shared->dim_n_I_C_2_to_ICU_pre_conf_1, shared->dim_n_I_C_2_to_ICU_pre_conf_12) * 0.29999999999999999;
    real_t delta_admit_conf_0_64 = odin_sum3<real_t>(internal.n_I_C_2_to_H_D_conf.data(), 0, 13, 0, shared->dim_n_I_C_2_to_H_D_conf_2, 0, shared->dim_n_I_C_2_to_H_D_conf_3, shared->dim_n_I_C_2_to_H_D_conf_1, shared->dim_n_I_C_2_to_H_D_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_H_D_conf.data(), 17, 18, 0, shared->dim_n_I_C_2_to_H_D_conf_2, 0, shared->dim_n_I_C_2_to_H_D_conf_3, shared->dim_n_I_C_2_to_H_D_conf_1, shared->dim_n_I_C_2_to_H_D_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_H_R_conf.data(), 0, 13, 0, shared->dim_n_I_C_2_to_H_R_conf_2, 0, shared->dim_n_I_C_2_to_H_R_conf_3, shared->dim_n_I_C_2_to_H_R_conf_1, shared->dim_n_I_C_2_to_H_R_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_H_R_conf.data(), 17, 18, 0, shared->dim_n_I_C_2_to_H_R_conf_2, 0, shared->dim_n_I_C_2_to_H_R_conf_3, shared->dim_n_I_C_2_to_H_R_conf_1, shared->dim_n_I_C_2_to_H_R_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_ICU_pre_conf.data(), 0, 13, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_2, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_3, shared->dim_n_I_C_2_to_ICU_pre_conf_1, shared->dim_n_I_C_2_to_ICU_pre_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_ICU_pre_conf.data(), 17, 18, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_2, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_3, shared->dim_n_I_C_2_to_ICU_pre_conf_1, shared->dim_n_I_C_2_to_ICU_pre_conf_12);
    real_t delta_admit_conf_35_54 = odin_sum3<real_t>(internal.n_I_C_2_to_H_D_conf.data(), 7, 11, 0, shared->dim_n_I_C_2_to_H_D_conf_2, 0, shared->dim_n_I_C_2_to_H_D_conf_3, shared->dim_n_I_C_2_to_H_D_conf_1, shared->dim_n_I_C_2_to_H_D_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_H_D_conf.data(), 17, 18, 0, shared->dim_n_I_C_2_to_H_D_conf_2, 0, shared->dim_n_I_C_2_to_H_D_conf_3, shared->dim_n_I_C_2_to_H_D_conf_1, shared->dim_n_I_C_2_to_H_D_conf_12) * 0.40000000000000002 + odin_sum3<real_t>(internal.n_I_C_2_to_H_R_conf.data(), 7, 11, 0, shared->dim_n_I_C_2_to_H_R_conf_2, 0, shared->dim_n_I_C_2_to_H_R_conf_3, shared->dim_n_I_C_2_to_H_R_conf_1, shared->dim_n_I_C_2_to_H_R_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_H_R_conf.data(), 17, 18, 0, shared->dim_n_I_C_2_to_H_R_conf_2, 0, shared->dim_n_I_C_2_to_H_R_conf_3, shared->dim_n_I_C_2_to_H_R_conf_1, shared->dim_n_I_C_2_to_H_R_conf_12) * 0.40000000000000002 + odin_sum3<real_t>(internal.n_I_C_2_to_ICU_pre_conf.data(), 7, 11, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_2, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_3, shared->dim_n_I_C_2_to_ICU_pre_conf_1, shared->dim_n_I_C_2_to_ICU_pre_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_ICU_pre_conf.data(), 17, 18, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_2, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_3, shared->dim_n_I_C_2_to_ICU_pre_conf_1, shared->dim_n_I_C_2_to_ICU_pre_conf_12) * 0.40000000000000002;
    real_t delta_admit_conf_55_64 = odin_sum3<real_t>(internal.n_I_C_2_to_H_D_conf.data(), 11, 13, 0, shared->dim_n_I_C_2_to_H_D_conf_2, 0, shared->dim_n_I_C_2_to_H_D_conf_3, shared->dim_n_I_C_2_to_H_D_conf_1, shared->dim_n_I_C_2_to_H_D_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_H_D_conf.data(), 17, 18, 0, shared->dim_n_I_C_2_to_H_D_conf_2, 0, shared->dim_n_I_C_2_to_H_D_conf_3, shared->dim_n_I_C_2_to_H_D_conf_1, shared->dim_n_I_C_2_to_H_D_conf_12) * 0.29999999999999999 + odin_sum3<real_t>(internal.n_I_C_2_to_H_R_conf.data(), 11, 13, 0, shared->dim_n_I_C_2_to_H_R_conf_2, 0, shared->dim_n_I_C_2_to_H_R_conf_3, shared->dim_n_I_C_2_to_H_R_conf_1, shared->dim_n_I_C_2_to_H_R_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_H_R_conf.data(), 17, 18, 0, shared->dim_n_I_C_2_to_H_R_conf_2, 0, shared->dim_n_I_C_2_to_H_R_conf_3, shared->dim_n_I_C_2_to_H_R_conf_1, shared->dim_n_I_C_2_to_H_R_conf_12) * 0.29999999999999999 + odin_sum3<real_t>(internal.n_I_C_2_to_ICU_pre_conf.data(), 11, 13, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_2, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_3, shared->dim_n_I_C_2_to_ICU_pre_conf_1, shared->dim_n_I_C_2_to_ICU_pre_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_ICU_pre_conf.data(), 17, 18, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_2, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_3, shared->dim_n_I_C_2_to_ICU_pre_conf_1, shared->dim_n_I_C_2_to_ICU_pre_conf_12) * 0.29999999999999999;
    real_t delta_admit_conf_65_74 = odin_sum3<real_t>(internal.n_I_C_2_to_H_D_conf.data(), 13, 15, 0, shared->dim_n_I_C_2_to_H_D_conf_2, 0, shared->dim_n_I_C_2_to_H_D_conf_3, shared->dim_n_I_C_2_to_H_D_conf_1, shared->dim_n_I_C_2_to_H_D_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_H_D_conf.data(), 18, 19, 0, shared->dim_n_I_C_2_to_H_D_conf_2, 0, shared->dim_n_I_C_2_to_H_D_conf_3, shared->dim_n_I_C_2_to_H_D_conf_1, shared->dim_n_I_C_2_to_H_D_conf_12) * 0.29999999999999999 + odin_sum3<real_t>(internal.n_I_C_2_to_H_R_conf.data(), 13, 15, 0, shared->dim_n_I_C_2_to_H_R_conf_2, 0, shared->dim_n_I_C_2_to_H_R_conf_3, shared->dim_n_I_C_2_to_H_R_conf_1, shared->dim_n_I_C_2_to_H_R_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_H_R_conf.data(), 18, 19, 0, shared->dim_n_I_C_2_to_H_R_conf_2, 0, shared->dim_n_I_C_2_to_H_R_conf_3, shared->dim_n_I_C_2_to_H_R_conf_1, shared->dim_n_I_C_2_to_H_R_conf_12) * 0.29999999999999999 + odin_sum3<real_t>(internal.n_I_C_2_to_ICU_pre_conf.data(), 13, 15, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_2, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_3, shared->dim_n_I_C_2_to_ICU_pre_conf_1, shared->dim_n_I_C_2_to_ICU_pre_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_ICU_pre_conf.data(), 18, 19, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_2, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_3, shared->dim_n_I_C_2_to_ICU_pre_conf_1, shared->dim_n_I_C_2_to_ICU_pre_conf_12) * 0.29999999999999999;
    real_t delta_admit_conf_65_plus = odin_sum3<real_t>(internal.n_I_C_2_to_H_D_conf.data(), 13, 17, 0, shared->dim_n_I_C_2_to_H_D_conf_2, 0, shared->dim_n_I_C_2_to_H_D_conf_3, shared->dim_n_I_C_2_to_H_D_conf_1, shared->dim_n_I_C_2_to_H_D_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_H_D_conf.data(), 18, 19, 0, shared->dim_n_I_C_2_to_H_D_conf_2, 0, shared->dim_n_I_C_2_to_H_D_conf_3, shared->dim_n_I_C_2_to_H_D_conf_1, shared->dim_n_I_C_2_to_H_D_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_H_R_conf.data(), 13, 17, 0, shared->dim_n_I_C_2_to_H_R_conf_2, 0, shared->dim_n_I_C_2_to_H_R_conf_3, shared->dim_n_I_C_2_to_H_R_conf_1, shared->dim_n_I_C_2_to_H_R_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_H_R_conf.data(), 18, 19, 0, shared->dim_n_I_C_2_to_H_R_conf_2, 0, shared->dim_n_I_C_2_to_H_R_conf_3, shared->dim_n_I_C_2_to_H_R_conf_1, shared->dim_n_I_C_2_to_H_R_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_ICU_pre_conf.data(), 13, 17, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_2, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_3, shared->dim_n_I_C_2_to_ICU_pre_conf_1, shared->dim_n_I_C_2_to_ICU_pre_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_ICU_pre_conf.data(), 18, 19, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_2, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_3, shared->dim_n_I_C_2_to_ICU_pre_conf_1, shared->dim_n_I_C_2_to_ICU_pre_conf_12);
    real_t delta_admit_conf_75_plus = odin_sum3<real_t>(internal.n_I_C_2_to_H_D_conf.data(), 15, 17, 0, shared->dim_n_I_C_2_to_H_D_conf_2, 0, shared->dim_n_I_C_2_to_H_D_conf_3, shared->dim_n_I_C_2_to_H_D_conf_1, shared->dim_n_I_C_2_to_H_D_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_H_D_conf.data(), 18, 19, 0, shared->dim_n_I_C_2_to_H_D_conf_2, 0, shared->dim_n_I_C_2_to_H_D_conf_3, shared->dim_n_I_C_2_to_H_D_conf_1, shared->dim_n_I_C_2_to_H_D_conf_12) * 0.69999999999999996 + odin_sum3<real_t>(internal.n_I_C_2_to_H_R_conf.data(), 15, 17, 0, shared->dim_n_I_C_2_to_H_R_conf_2, 0, shared->dim_n_I_C_2_to_H_R_conf_3, shared->dim_n_I_C_2_to_H_R_conf_1, shared->dim_n_I_C_2_to_H_R_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_H_R_conf.data(), 18, 19, 0, shared->dim_n_I_C_2_to_H_R_conf_2, 0, shared->dim_n_I_C_2_to_H_R_conf_3, shared->dim_n_I_C_2_to_H_R_conf_1, shared->dim_n_I_C_2_to_H_R_conf_12) * 0.69999999999999996 + odin_sum3<real_t>(internal.n_I_C_2_to_ICU_pre_conf.data(), 15, 17, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_2, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_3, shared->dim_n_I_C_2_to_ICU_pre_conf_1, shared->dim_n_I_C_2_to_ICU_pre_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_ICU_pre_conf.data(), 18, 19, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_2, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_3, shared->dim_n_I_C_2_to_ICU_pre_conf_1, shared->dim_n_I_C_2_to_ICU_pre_conf_12) * 0.69999999999999996;
    ...
    state_next[17] = cum_infections + delta_infections;
    ...
    for (int i = 1; i <= shared->dim_diagnoses_admitted_1; ++i) {
      for (int j = 1; j <= shared->dim_diagnoses_admitted_2; ++j) {
        state_next[shared->offset_variable_diagnoses_admitted + i - 1 + shared->dim_diagnoses_admitted_1 * (j - 1)] = diagnoses_admitted[shared->dim_diagnoses_admitted_1 * (j - 1) + i - 1] + odin_sum3<real_t>(internal.n_I_C_2_to_H_D_conf.data(), i - 1, i, 0, shared->dim_n_I_C_2_to_H_D_conf_2, j - 1, j, shared->dim_n_I_C_2_to_H_D_conf_1, shared->dim_n_I_C_2_to_H_D_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_H_R_conf.data(), i - 1, i, 0, shared->dim_n_I_C_2_to_H_R_conf_2, j - 1, j, shared->dim_n_I_C_2_to_H_R_conf_1, shared->dim_n_I_C_2_to_H_R_conf_12) + odin_sum3<real_t>(internal.n_I_C_2_to_ICU_pre_conf.data(), i - 1, i, 0, shared->dim_n_I_C_2_to_ICU_pre_conf_2, j - 1, j, shared->dim_n_I_C_2_to_ICU_pre_conf_1, shared->dim_n_I_C_2_to_ICU_pre_conf_12) + odin_sum4<real_t>(internal.n_H_D_unconf_to_conf.data(), i - 1, i, 0, shared->dim_n_H_D_unconf_to_conf_2, 0, shared->dim_n_H_D_unconf_to_conf_3, j - 1, j, shared->dim_n_H_D_unconf_to_conf_1, shared->dim_n_H_D_unconf_to_conf_12, shared->dim_n_H_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_H_R_unconf_to_conf.data(), i - 1, i, 0, shared->dim_n_H_R_unconf_to_conf_2, 0, shared->dim_n_H_R_unconf_to_conf_3, j - 1, j, shared->dim_n_H_R_unconf_to_conf_1, shared->dim_n_H_R_unconf_to_conf_12, shared->dim_n_H_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_pre_unconf_to_conf.data(), i - 1, i, 0, shared->dim_n_ICU_pre_unconf_to_conf_2, 0, shared->dim_n_ICU_pre_unconf_to_conf_3, j - 1, j, shared->dim_n_ICU_pre_unconf_to_conf_1, shared->dim_n_ICU_pre_unconf_to_conf_12, shared->dim_n_ICU_pre_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_D_unconf_to_conf.data(), i - 1, i, 0, shared->dim_n_ICU_D_unconf_to_conf_2, 0, shared->dim_n_ICU_D_unconf_to_conf_3, j - 1, j, shared->dim_n_ICU_D_unconf_to_conf_1, shared->dim_n_ICU_D_unconf_to_conf_12, shared->dim_n_ICU_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_W_R_unconf_to_conf.data(), i - 1, i, 0, shared->dim_n_ICU_W_R_unconf_to_conf_2, 0, shared->dim_n_ICU_W_R_unconf_to_conf_3, j - 1, j, shared->dim_n_ICU_W_R_unconf_to_conf_1, shared->dim_n_ICU_W_R_unconf_to_conf_12, shared->dim_n_ICU_W_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_ICU_W_D_unconf_to_conf.data(), i - 1, i, 0, shared->dim_n_ICU_W_D_unconf_to_conf_2, 0, shared->dim_n_ICU_W_D_unconf_to_conf_3, j - 1, j, shared->dim_n_ICU_W_D_unconf_to_conf_1, shared->dim_n_ICU_W_D_unconf_to_conf_12, shared->dim_n_ICU_W_D_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_W_R_unconf_to_conf.data(), i - 1, i, 0, shared->dim_n_W_R_unconf_to_conf_2, 0, shared->dim_n_W_R_unconf_to_conf_3, j - 1, j, shared->dim_n_W_R_unconf_to_conf_1, shared->dim_n_W_R_unconf_to_conf_12, shared->dim_n_W_R_unconf_to_conf_123) + odin_sum4<real_t>(internal.n_W_D_unconf_to_conf.data(), i - 1, i, 0, shared->dim_n_W_D_unconf_to_conf_2, 0, shared->dim_n_W_D_unconf_to_conf_3, j - 1, j, shared->dim_n_W_D_unconf_to_conf_1, shared->dim_n_W_D_unconf_to_conf_12, shared->dim_n_W_D_unconf_to_conf_123);
      }
    }
    state_next[18] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_infections : infections_inc + delta_infections);
    state_next[69] = odin_sum4<real_t>(internal.new_T_PCR_pos.data(), 1, 18, 0, shared->dim_new_T_PCR_pos_2, 0, shared->dim_new_T_PCR_pos_3, 0, shared->dim_new_T_PCR_pos_4, shared->dim_new_T_PCR_pos_1, shared->dim_new_T_PCR_pos_12, shared->dim_new_T_PCR_pos_123);
    ...
    state_next[4] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_admit_conf_0_34 : admit_conf_inc_0_34 + delta_admit_conf_0_34);
    state_next[2] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_admit_conf_0_64 : admit_conf_inc_0_64 + delta_admit_conf_0_64);
    state_next[5] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_admit_conf_35_54 : admit_conf_inc_35_54 + delta_admit_conf_35_54);
    state_next[6] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_admit_conf_55_64 : admit_conf_inc_55_64 + delta_admit_conf_55_64);
    state_next[7] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_admit_conf_65_74 : admit_conf_inc_65_74 + delta_admit_conf_65_74);
    state_next[3] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_admit_conf_65_plus : admit_conf_inc_65_plus + delta_admit_conf_65_plus);
    state_next[8] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_admit_conf_75_plus : admit_conf_inc_75_plus + delta_admit_conf_75_plus);
    state_next[19] = cum_admit_conf + delta_admit_conf;
    state_next[25] = cum_admit_conf_0_34 + delta_admit_conf_0_34;
    state_next[21] = cum_admit_conf_0_64 + delta_admit_conf_0_64;
    state_next[26] = cum_admit_conf_35_54 + delta_admit_conf_35_54;
    state_next[27] = cum_admit_conf_55_64 + delta_admit_conf_55_64;
    state_next[28] = cum_admit_conf_65_74 + delta_admit_conf_65_74;
    state_next[22] = cum_admit_conf_65_plus + delta_admit_conf_65_plus;
    state_next[29] = cum_admit_conf_75_plus + delta_admit_conf_75_plus;
    ...
    state_next[40] = new_general_tot;
    state_next[41] = new_ICU_tot + new_general_tot;
...
dust::pars_t<carehomes> dust_pars<carehomes>(cpp11::list user) {
  ...
  shared->initial_D_hosp_inc_0_34 = 0;
  shared->initial_D_hosp_inc_35_54 = 0;
  shared->initial_D_hosp_inc_55_64 = 0;
  shared->initial_D_hosp_inc_65_74 = 0;
  shared->initial_D_hosp_inc_75_plus = 0;
  shared->initial_D_hosp_tot = 0;
  shared->initial_D_hosp_tot_0_34 = 0;
  shared->initial_D_hosp_tot_35_54 = 0;
  shared->initial_D_hosp_tot_55_64 = 0;
  shared->initial_D_hosp_tot_65_74 = 0;
  shared->initial_D_hosp_tot_75_plus = 0;
  ...
  shared->initial_admit_conf_inc_0_34 = 0;
  shared->initial_admit_conf_inc_0_64 = 0;
  shared->initial_admit_conf_inc_35_54 = 0;
  shared->initial_admit_conf_inc_55_64 = 0;
  shared->initial_admit_conf_inc_65_74 = 0;
  shared->initial_admit_conf_inc_65_plus = 0;
  shared->initial_admit_conf_inc_75_plus = 0;
  shared->initial_cum_admit_conf = 0;
  shared->initial_cum_admit_conf_0_34 = 0;
  shared->initial_cum_admit_conf_0_64 = 0;
  shared->initial_cum_admit_conf_35_54 = 0;
  shared->initial_cum_admit_conf_55_64 = 0;
  shared->initial_cum_admit_conf_65_74 = 0;
  shared->initial_cum_admit_conf_65_plus = 0;
  shared->initial_cum_admit_conf_75_plus = 0;
  shared->initial_cum_infections = 0;
  shared->initial_cum_new_conf = 0;
  shared->initial_cum_new_conf_0_34 = 0;
  shared->initial_cum_new_conf_0_64 = 0;
  shared->initial_cum_new_conf_35_54 = 0;
  shared->initial_cum_new_conf_55_64 = 0;
  shared->initial_cum_new_conf_65_74 = 0;
  shared->initial_cum_new_conf_65_plus = 0;
  shared->initial_cum_new_conf_75_plus = 0;
  ...
  shared->initial_new_conf_inc_0_34 = 0;
  shared->initial_new_conf_inc_0_64 = 0;
  shared->initial_new_conf_inc_35_54 = 0;
  shared->initial_new_conf_inc_55_64 = 0;
  shared->initial_new_conf_inc_65_74 = 0;
  shared->initial_new_conf_inc_65_plus = 0;
  shared->initial_new_conf_inc_75_plus = 0;
  ...
  internal.p_star = std::vector<real_t>(shared->dim_p_star);
  ...
  shared->offset_variable_D_hosp = shared->dim_cum_infections_per_strain + 70;
  shared->offset_variable_D_non_hosp = shared->dim_D_hosp + shared->dim_cum_infections_per_strain + 70;
  shared->offset_variable_N_tot = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + 70;
  shared->offset_variable_cum_admit_by_age = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_cum_infections_per_strain + 70;
  shared->offset_variable_prob_strain = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + 70;
  ...
  shared->offset_variable_H_D_conf = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_H_D_unconf + shared->dim_H_R_conf + shared->dim_H_R_unconf + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  shared->offset_variable_H_D_unconf = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_H_R_conf + shared->dim_H_R_unconf + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  shared->offset_variable_H_R_conf = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_H_R_unconf + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  shared->offset_variable_H_R_unconf = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  shared->offset_variable_ICU_D_conf = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_H_D_conf + shared->dim_H_D_unconf + shared->dim_H_R_conf + shared->dim_H_R_unconf + shared->dim_ICU_D_unconf + shared->dim_ICU_W_D_conf + shared->dim_ICU_W_D_unconf + shared->dim_ICU_W_R_conf + shared->dim_ICU_W_R_unconf + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  shared->offset_variable_ICU_D_unconf = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_H_D_conf + shared->dim_H_D_unconf + shared->dim_H_R_conf + shared->dim_H_R_unconf + shared->dim_ICU_W_D_conf + shared->dim_ICU_W_D_unconf + shared->dim_ICU_W_R_conf + shared->dim_ICU_W_R_unconf + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  shared->offset_variable_ICU_W_D_conf = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_H_D_conf + shared->dim_H_D_unconf + shared->dim_H_R_conf + shared->dim_H_R_unconf + shared->dim_ICU_W_D_unconf + shared->dim_ICU_W_R_conf + shared->dim_ICU_W_R_unconf + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  shared->offset_variable_ICU_W_D_unconf = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_H_D_conf + shared->dim_H_D_unconf + shared->dim_H_R_conf + shared->dim_H_R_unconf + shared->dim_ICU_W_R_conf + shared->dim_ICU_W_R_unconf + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  shared->offset_variable_ICU_W_R_conf = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_H_D_conf + shared->dim_H_D_unconf + shared->dim_H_R_conf + shared->dim_H_R_unconf + shared->dim_ICU_W_R_unconf + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  shared->offset_variable_ICU_W_R_unconf = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_H_D_conf + shared->dim_H_D_unconf + shared->dim_H_R_conf + shared->dim_H_R_unconf + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  shared->offset_variable_ICU_pre_conf = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  shared->offset_variable_ICU_pre_unconf = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  ...
  shared->offset_variable_T_PCR_pos = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_H_D_conf + shared->dim_H_D_unconf + shared->dim_H_R_conf + shared->dim_H_R_unconf + shared->dim_ICU_D_conf + shared->dim_ICU_D_unconf + shared->dim_ICU_W_D_conf + shared->dim_ICU_W_D_unconf + shared->dim_ICU_W_R_conf + shared->dim_ICU_W_R_unconf + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_PCR_pre + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_T_sero_pos_1 + shared->dim_T_sero_pos_2 + shared->dim_T_sero_pre_1 + shared->dim_T_sero_pre_2 + shared->dim_W_D_conf + shared->dim_W_D_unconf + shared->dim_W_R_conf + shared->dim_W_R_unconf + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  shared->offset_variable_T_PCR_pre = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_H_D_conf + shared->dim_H_D_unconf + shared->dim_H_R_conf + shared->dim_H_R_unconf + shared->dim_ICU_D_conf + shared->dim_ICU_D_unconf + shared->dim_ICU_W_D_conf + shared->dim_ICU_W_D_unconf + shared->dim_ICU_W_R_conf + shared->dim_ICU_W_R_unconf + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_T_sero_pos_1 + shared->dim_T_sero_pos_2 + shared->dim_T_sero_pre_1 + shared->dim_T_sero_pre_2 + shared->dim_W_D_conf + shared->dim_W_D_unconf + shared->dim_W_R_conf + shared->dim_W_R_unconf + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  ...
  shared->offset_variable_T_sero_pos_1 = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_H_D_conf + shared->dim_H_D_unconf + shared->dim_H_R_conf + shared->dim_H_R_unconf + shared->dim_ICU_D_conf + shared->dim_ICU_D_unconf + shared->dim_ICU_W_D_conf + shared->dim_ICU_W_D_unconf + shared->dim_ICU_W_R_conf + shared->dim_ICU_W_R_unconf + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_T_sero_pre_1 + shared->dim_W_D_conf + shared->dim_W_D_unconf + shared->dim_W_R_conf + shared->dim_W_R_unconf + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  shared->offset_variable_T_sero_pos_2 = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_H_D_conf + shared->dim_H_D_unconf + shared->dim_H_R_conf + shared->dim_H_R_unconf + shared->dim_ICU_D_conf + shared->dim_ICU_D_unconf + shared->dim_ICU_W_D_conf + shared->dim_ICU_W_D_unconf + shared->dim_ICU_W_R_conf + shared->dim_ICU_W_R_unconf + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_T_sero_pos_1 + shared->dim_T_sero_pre_1 + shared->dim_T_sero_pre_2 + shared->dim_W_D_conf + shared->dim_W_D_unconf + shared->dim_W_R_conf + shared->dim_W_R_unconf + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  shared->offset_variable_T_sero_pre_1 = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_H_D_conf + shared->dim_H_D_unconf + shared->dim_H_R_conf + shared->dim_H_R_unconf + shared->dim_ICU_D_conf + shared->dim_ICU_D_unconf + shared->dim_ICU_W_D_conf + shared->dim_ICU_W_D_unconf + shared->dim_ICU_W_R_conf + shared->dim_ICU_W_R_unconf + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_W_D_conf + shared->dim_W_D_unconf + shared->dim_W_R_conf + shared->dim_W_R_unconf + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  shared->offset_variable_T_sero_pre_2 = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_H_D_conf + shared->dim_H_D_unconf + shared->dim_H_R_conf + shared->dim_H_R_unconf + shared->dim_ICU_D_conf + shared->dim_ICU_D_unconf + shared->dim_ICU_W_D_conf + shared->dim_ICU_W_D_unconf + shared->dim_ICU_W_R_conf + shared->dim_ICU_W_R_unconf + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_T_sero_pos_1 + shared->dim_T_sero_pre_1 + shared->dim_W_D_conf + shared->dim_W_D_unconf + shared->dim_W_R_conf + shared->dim_W_R_unconf + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  shared->offset_variable_W_D_conf = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_H_D_conf + shared->dim_H_D_unconf + shared->dim_H_R_conf + shared->dim_H_R_unconf + shared->dim_ICU_D_conf + shared->dim_ICU_D_unconf + shared->dim_ICU_W_D_conf + shared->dim_ICU_W_D_unconf + shared->dim_ICU_W_R_conf + shared->dim_ICU_W_R_unconf + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_W_D_unconf + shared->dim_W_R_conf + shared->dim_W_R_unconf + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  shared->offset_variable_W_D_unconf = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_H_D_conf + shared->dim_H_D_unconf + shared->dim_H_R_conf + shared->dim_H_R_unconf + shared->dim_ICU_D_conf + shared->dim_ICU_D_unconf + shared->dim_ICU_W_D_conf + shared->dim_ICU_W_D_unconf + shared->dim_ICU_W_R_conf + shared->dim_ICU_W_R_unconf + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_W_R_conf + shared->dim_W_R_unconf + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  shared->offset_variable_W_R_conf = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_E + shared->dim_G_D + shared->dim_H_D_conf + shared->dim_H_D_unconf + shared->dim_H_R_conf + shared->dim_H_R_unconf + shared->dim_ICU_D_conf + shared->dim_ICU_D_unconf + shared->dim_ICU_W_D_conf + shared->dim_ICU_W_D_unconf + shared->dim_ICU_W_R_conf + shared->dim_ICU_W_R_unconf + shared->dim_ICU_pre_conf + shared->dim_ICU_pre_unconf + shared->dim_I_A + shared->dim_I_C_1 + shared->dim_I_C_2 + shared->dim_I_P + shared->dim_I_weighted + shared->dim_N_tot + shared->dim_R + shared->dim_S + shared->dim_T_PCR_neg + shared->dim_T_sero_neg_1 + shared->dim_T_sero_neg_2 + shared->dim_W_R_unconf + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 70;
  ...
  shared->offset_variable_cum_n_E_vaccinated = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_cum_n_S_vaccinated + shared->dim_prob_strain + 70;
  shared->offset_variable_cum_n_I_A_vaccinated = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_prob_strain + 70;
  shared->offset_variable_cum_n_I_P_vaccinated = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_prob_strain + 70;
  shared->offset_variable_cum_n_R_vaccinated = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_prob_strain + 70;
  shared->offset_variable_cum_n_S_vaccinated = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_prob_strain + 70;
  shared->offset_variable_cum_n_vaccinated = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_prob_strain + 70;
  ...
  shared->p_star_step = user_get_array_fixed<real_t, 2>(user, "p_star_step", shared->p_star_step, {shared->dim_p_star_step_1, shared->dim_p_star_step_2}, NA_REAL, NA_REAL);
...
cpp11::sexp dust_info<carehomes>(const dust::pars_t<carehomes>& pars) {
  ...
  cpp11::writable::strings nms({"time", "admit_conf_inc", "admit_conf_inc_0_64", "admit_conf_inc_65_plus", "admit_conf_inc_0_34", "admit_conf_inc_35_54", "admit_conf_inc_55_64", "admit_conf_inc_65_74", "admit_conf_inc_75_plus", "new_conf_inc", "new_conf_inc_0_64", "new_conf_inc_65_plus", "new_conf_inc_0_34", "new_conf_inc_35_54", "new_conf_inc_55_64", "new_conf_inc_65_74", "new_conf_inc_75_plus", "cum_infections", "infections_inc", "cum_admit_conf", "cum_new_conf", "cum_admit_conf_0_64", "cum_admit_conf_65_plus", "cum_new_conf_0_64", "cum_new_conf_65_plus", "cum_admit_conf_0_34", "cum_admit_conf_35_54", "cum_admit_conf_55_64", "cum_admit_conf_65_74", "cum_admit_conf_75_plus", "cum_new_conf_0_34", "cum_new_conf_35_54", "cum_new_conf_55_64", "cum_new_conf_65_74", "cum_new_conf_75_plus", "beta_out", "N_tot_sero_1", "N_tot_sero_2", "N_tot_PCR", "ICU_tot", "general_tot", "hosp_tot", "D_hosp_tot", "D_hosp_tot_0_34", "D_hosp_inc_0_34", "D_hosp_tot_35_54", "D_hosp_inc_35_54", "D_hosp_tot_55_64", "D_hosp_inc_55_64", "D_hosp_tot_65_74", "D_hosp_inc_65_74", "D_hosp_tot_75_plus", "D_hosp_inc_75_plus", "D_comm_tot", "D_comm_inc", "D_carehomes_tot", "D_carehomes_inc", "D_hosp_inc", "D_tot", "sero_pos_1", "sero_pos_2", "cum_sympt_cases", "cum_sympt_cases_non_variant", "cum_sympt_cases_over25", "cum_sympt_cases_non_variant_over25", "sympt_cases_inc", "sympt_cases_non_variant_inc", "sympt_cases_over25_inc", "sympt_cases_non_variant_over25_inc", "react_pos", "cum_infections_per_strain", "D_hosp", "D_non_hosp", "cum_admit_by_age", "N_tot", "prob_strain", "cum_n_S_vaccinated", "cum_n_E_vaccinated", "cum_n_I_A_vaccinated", "cum_n_I_P_vaccinated", "cum_n_R_vaccinated", "cum_n_vaccinated", "diagnoses_admitted", "cum_infections_disag", "D", "S", "vaccine_missed_doses", "tmp_vaccine_n_candidates", "tmp_vaccine_probability", "T_sero_neg_1", "T_sero_neg_2", "R", "T_PCR_neg", "I_weighted", "E", "I_A", "I_P", "I_C_1", "I_C_2", "G_D", "ICU_pre_unconf", "ICU_pre_conf", "H_R_unconf", "H_R_conf", "H_D_unconf", "H_D_conf", "ICU_W_R_unconf", "ICU_W_R_conf", "ICU_W_D_unconf", "ICU_W_D_conf", "ICU_D_unconf", "ICU_D_conf", "W_R_unconf", "W_R_conf", "W_D_unconf", "W_D_conf", "T_sero_pre_1", "T_sero_pos_1", "T_sero_pre_2", "T_sero_pos_2", "T_PCR_pre", "T_PCR_pos"});
  cpp11::writable::list dim(122);
  ...
  dim[70] = cpp11::writable::integers({shared->dim_cum_infections_per_strain});
  dim[71] = cpp11::writable::integers({shared->dim_D_hosp});
  dim[72] = cpp11::writable::integers({shared->dim_D_non_hosp});
  dim[73] = cpp11::writable::integers({shared->dim_cum_admit_by_age});
  dim[74] = cpp11::writable::integers({shared->dim_N_tot});
  dim[75] = cpp11::writable::integers({shared->dim_prob_strain});
  dim[76] = cpp11::writable::integers({shared->dim_cum_n_S_vaccinated_1, shared->dim_cum_n_S_vaccinated_2});
  dim[77] = cpp11::writable::integers({shared->dim_cum_n_E_vaccinated_1, shared->dim_cum_n_E_vaccinated_2});
  dim[78] = cpp11::writable::integers({shared->dim_cum_n_I_A_vaccinated_1, shared->dim_cum_n_I_A_vaccinated_2});
  dim[79] = cpp11::writable::integers({shared->dim_cum_n_I_P_vaccinated_1, shared->dim_cum_n_I_P_vaccinated_2});
  dim[80] = cpp11::writable::integers({shared->dim_cum_n_R_vaccinated_1, shared->dim_cum_n_R_vaccinated_2});
  dim[81] = cpp11::writable::integers({shared->dim_cum_n_vaccinated_1, shared->dim_cum_n_vaccinated_2});
  dim[82] = cpp11::writable::integers({shared->dim_diagnoses_admitted_1, shared->dim_diagnoses_admitted_2});
  dim[83] = cpp11::writable::integers({shared->dim_cum_infections_disag_1, shared->dim_cum_infections_disag_2});
  dim[84] = cpp11::writable::integers({shared->dim_D_1, shared->dim_D_2});
  dim[85] = cpp11::writable::integers({shared->dim_S_1, shared->dim_S_2});
  dim[86] = cpp11::writable::integers({shared->dim_vaccine_missed_doses_1, shared->dim_vaccine_missed_doses_2});
  dim[87] = cpp11::writable::integers({shared->dim_tmp_vaccine_n_candidates_1, shared->dim_tmp_vaccine_n_candidates_2});
  dim[88] = cpp11::writable::integers({shared->dim_tmp_vaccine_probability_1, shared->dim_tmp_vaccine_probability_2});
  dim[89] = cpp11::writable::integers({shared->dim_T_sero_neg_1_1, shared->dim_T_sero_neg_1_2, shared->dim_T_sero_neg_1_3});
  dim[90] = cpp11::writable::integers({shared->dim_T_sero_neg_2_1, shared->dim_T_sero_neg_2_2, shared->dim_T_sero_neg_2_3});
  dim[91] = cpp11::writable::integers({shared->dim_R_1, shared->dim_R_2, shared->dim_R_3});
  dim[92] = cpp11::writable::integers({shared->dim_T_PCR_neg_1, shared->dim_T_PCR_neg_2, shared->dim_T_PCR_neg_3});
  dim[93] = cpp11::writable::integers({shared->dim_I_weighted_1, shared->dim_I_weighted_2, shared->dim_I_weighted_3});
  dim[94] = cpp11::writable::integers({shared->dim_E_1, shared->dim_E_2, shared->dim_E_3, shared->dim_E_4});
  dim[95] = cpp11::writable::integers({shared->dim_I_A_1, shared->dim_I_A_2, shared->dim_I_A_3, shared->dim_I_A_4});
  dim[96] = cpp11::writable::integers({shared->dim_I_P_1, shared->dim_I_P_2, shared->dim_I_P_3, shared->dim_I_P_4});
  dim[97] = cpp11::writable::integers({shared->dim_I_C_1_1, shared->dim_I_C_1_2, shared->dim_I_C_1_3, shared->dim_I_C_1_4});
  dim[98] = cpp11::writable::integers({shared->dim_I_C_2_1, shared->dim_I_C_2_2, shared->dim_I_C_2_3, shared->dim_I_C_2_4});
  dim[99] = cpp11::writable::integers({shared->dim_G_D_1, shared->dim_G_D_2, shared->dim_G_D_3, shared->dim_G_D_4});
  dim[100] = cpp11::writable::integers({shared->dim_ICU_pre_unconf_1, shared->dim_ICU_pre_unconf_2, shared->dim_ICU_pre_unconf_3, shared->dim_ICU_pre_unconf_4});
  dim[101] = cpp11::writable::integers({shared->dim_ICU_pre_conf_1, shared->dim_ICU_pre_conf_2, shared->dim_ICU_pre_conf_3, shared->dim_ICU_pre_conf_4});
  dim[102] = cpp11::writable::integers({shared->dim_H_R_unconf_1, shared->dim_H_R_unconf_2, shared->dim_H_R_unconf_3, shared->dim_H_R_unconf_4});
  dim[103] = cpp11::writable::integers({shared->dim_H_R_conf_1, shared->dim_H_R_conf_2, shared->dim_H_R_conf_3, shared->dim_H_R_conf_4});
  dim[104] = cpp11::writable::integers({shared->dim_H_D_unconf_1, shared->dim_H_D_unconf_2, shared->dim_H_D_unconf_3, shared->dim_H_D_unconf_4});
  dim[105] = cpp11::writable::integers({shared->dim_H_D_conf_1, shared->dim_H_D_conf_2, shared->dim_H_D_conf_3, shared->dim_H_D_conf_4});
  dim[106] = cpp11::writable::integers({shared->dim_ICU_W_R_unconf_1, shared->dim_ICU_W_R_unconf_2, shared->dim_ICU_W_R_unconf_3, shared->dim_ICU_W_R_unconf_4});
  dim[107] = cpp11::writable::integers({shared->dim_ICU_W_R_conf_1, shared->dim_ICU_W_R_conf_2, shared->dim_ICU_W_R_conf_3, shared->dim_ICU_W_R_conf_4});
  dim[108] = cpp11::writable::integers({shared->dim_ICU_W_D_unconf_1, shared->dim_ICU_W_D_unconf_2, shared->dim_ICU_W_D_unconf_3, shared->dim_ICU_W_D_unconf_4});
  dim[109] = cpp11::writable::integers({shared->dim_ICU_W_D_conf_1, shared->dim_ICU_W_D_conf_2, shared->dim_ICU_W_D_conf_3, shared->dim_ICU_W_D_conf_4});
  dim[110] = cpp11::writable::integers({shared->dim_ICU_D_unconf_1, shared->dim_ICU_D_unconf_2, shared->dim_ICU_D_unconf_3, shared->dim_ICU_D_unconf_4});
  dim[111] = cpp11::writable::integers({shared->dim_ICU_D_conf_1, shared->dim_ICU_D_conf_2, shared->dim_ICU_D_conf_3, shared->dim_ICU_D_conf_4});
  dim[112] = cpp11::writable::integers({shared->dim_W_R_unconf_1, shared->dim_W_R_unconf_2, shared->dim_W_R_unconf_3, shared->dim_W_R_unconf_4});
  dim[113] = cpp11::writable::integers({shared->dim_W_R_conf_1, shared->dim_W_R_conf_2, shared->dim_W_R_conf_3, shared->dim_W_R_conf_4});
  dim[114] = cpp11::writable::integers({shared->dim_W_D_unconf_1, shared->dim_W_D_unconf_2, shared->dim_W_D_unconf_3, shared->dim_W_D_unconf_4});
  dim[115] = cpp11::writable::integers({shared->dim_W_D_conf_1, shared->dim_W_D_conf_2, shared->dim_W_D_conf_3, shared->dim_W_D_conf_4});
  dim[116] = cpp11::writable::integers({shared->dim_T_sero_pre_1_1, shared->dim_T_sero_pre_1_2, shared->dim_T_sero_pre_1_3, shared->dim_T_sero_pre_1_4});
  dim[117] = cpp11::writable::integers({shared->dim_T_sero_pos_1_1, shared->dim_T_sero_pos_1_2, shared->dim_T_sero_pos_1_3, shared->dim_T_sero_pos_1_4});
  dim[118] = cpp11::writable::integers({shared->dim_T_sero_pre_2_1, shared->dim_T_sero_pre_2_2, shared->dim_T_sero_pre_2_3, shared->dim_T_sero_pre_2_4});
  dim[119] = cpp11::writable::integers({shared->dim_T_sero_pos_2_1, shared->dim_T_sero_pos_2_2, shared->dim_T_sero_pos_2_3, shared->dim_T_sero_pos_2_4});
  dim[120] = cpp11::writable::integers({shared->dim_T_PCR_pre_1, shared->dim_T_PCR_pre_2, shared->dim_T_PCR_pre_3, shared->dim_T_PCR_pre_4});
  dim[121] = cpp11::writable::integers({shared->dim_T_PCR_pos_1, shared->dim_T_PCR_pos_2, shared->dim_T_PCR_pos_3, shared->dim_T_PCR_pos_4});
  dim.names() = nms;
  cpp11::writable::list index(122);
  ...
  index[70] = integer_sequence(71, shared->dim_cum_infections_per_strain);
  index[71] = integer_sequence(shared->offset_variable_D_hosp + 1, shared->dim_D_hosp);
  index[72] = integer_sequence(shared->offset_variable_D_non_hosp + 1, shared->dim_D_non_hosp);
  index[73] = integer_sequence(shared->offset_variable_cum_admit_by_age + 1, shared->dim_cum_admit_by_age);
  index[74] = integer_sequence(shared->offset_variable_N_tot + 1, shared->dim_N_tot);
  index[75] = integer_sequence(shared->offset_variable_prob_strain + 1, shared->dim_prob_strain);
  index[76] = integer_sequence(shared->offset_variable_cum_n_S_vaccinated + 1, shared->dim_cum_n_S_vaccinated);
  index[77] = integer_sequence(shared->offset_variable_cum_n_E_vaccinated + 1, shared->dim_cum_n_E_vaccinated);
  index[78] = integer_sequence(shared->offset_variable_cum_n_I_A_vaccinated + 1, shared->dim_cum_n_I_A_vaccinated);
  index[79] = integer_sequence(shared->offset_variable_cum_n_I_P_vaccinated + 1, shared->dim_cum_n_I_P_vaccinated);
  index[80] = integer_sequence(shared->offset_variable_cum_n_R_vaccinated + 1, shared->dim_cum_n_R_vaccinated);
  index[81] = integer_sequence(shared->offset_variable_cum_n_vaccinated + 1, shared->dim_cum_n_vaccinated);
  index[82] = integer_sequence(shared->offset_variable_diagnoses_admitted + 1, shared->dim_diagnoses_admitted);
  index[83] = integer_sequence(shared->offset_variable_cum_infections_disag + 1, shared->dim_cum_infections_disag);
  index[84] = integer_sequence(shared->offset_variable_D + 1, shared->dim_D);
  index[85] = integer_sequence(shared->offset_variable_S + 1, shared->dim_S);
  index[86] = integer_sequence(shared->offset_variable_vaccine_missed_doses + 1, shared->dim_vaccine_missed_doses);
  index[87] = integer_sequence(shared->offset_variable_tmp_vaccine_n_candidates + 1, shared->dim_tmp_vaccine_n_candidates);
  index[88] = integer_sequence(shared->offset_variable_tmp_vaccine_probability + 1, shared->dim_tmp_vaccine_probability);
  index[89] = integer_sequence(shared->offset_variable_T_sero_neg_1 + 1, shared->dim_T_sero_neg_1);
  index[90] = integer_sequence(shared->offset_variable_T_sero_neg_2 + 1, shared->dim_T_sero_neg_2);
  index[91] = integer_sequence(shared->offset_variable_R + 1, shared->dim_R);
  index[92] = integer_sequence(shared->offset_variable_T_PCR_neg + 1, shared->dim_T_PCR_neg);
  index[93] = integer_sequence(shared->offset_variable_I_weighted + 1, shared->dim_I_weighted);
  index[94] = integer_sequence(shared->offset_variable_E + 1, shared->dim_E);
  index[95] = integer_sequence(shared->offset_variable_I_A + 1, shared->dim_I_A);
  index[96] = integer_sequence(shared->offset_variable_I_P + 1, shared->dim_I_P);
  index[97] = integer_sequence(shared->offset_variable_I_C_1 + 1, shared->dim_I_C_1);
  index[98] = integer_sequence(shared->offset_variable_I_C_2 + 1, shared->dim_I_C_2);
  index[99] = integer_sequence(shared->offset_variable_G_D + 1, shared->dim_G_D);
  index[100] = integer_sequence(shared->offset_variable_ICU_pre_unconf + 1, shared->dim_ICU_pre_unconf);
  index[101] = integer_sequence(shared->offset_variable_ICU_pre_conf + 1, shared->dim_ICU_pre_conf);
  index[102] = integer_sequence(shared->offset_variable_H_R_unconf + 1, shared->dim_H_R_unconf);
  index[103] = integer_sequence(shared->offset_variable_H_R_conf + 1, shared->dim_H_R_conf);
  index[104] = integer_sequence(shared->offset_variable_H_D_unconf + 1, shared->dim_H_D_unconf);
  index[105] = integer_sequence(shared->offset_variable_H_D_conf + 1, shared->dim_H_D_conf);
  index[106] = integer_sequence(shared->offset_variable_ICU_W_R_unconf + 1, shared->dim_ICU_W_R_unconf);
  index[107] = integer_sequence(shared->offset_variable_ICU_W_R_conf + 1, shared->dim_ICU_W_R_conf);
  index[108] = integer_sequence(shared->offset_variable_ICU_W_D_unconf + 1, shared->dim_ICU_W_D_unconf);
  index[109] = integer_sequence(shared->offset_variable_ICU_W_D_conf + 1, shared->dim_ICU_W_D_conf);
  index[110] = integer_sequence(shared->offset_variable_ICU_D_unconf + 1, shared->dim_ICU_D_unconf);
  index[111] = integer_sequence(shared->offset_variable_ICU_D_conf + 1, shared->dim_ICU_D_conf);
  index[112] = integer_sequence(shared->offset_variable_W_R_unconf + 1, shared->dim_W_R_unconf);
  index[113] = integer_sequence(shared->offset_variable_W_R_conf + 1, shared->dim_W_R_conf);
  index[114] = integer_sequence(shared->offset_variable_W_D_unconf + 1, shared->dim_W_D_unconf);
  index[115] = integer_sequence(shared->offset_variable_W_D_conf + 1, shared->dim_W_D_conf);
  index[116] = integer_sequence(shared->offset_variable_T_sero_pre_1 + 1, shared->dim_T_sero_pre_1);
  index[117] = integer_sequence(shared->offset_variable_T_sero_pos_1 + 1, shared->dim_T_sero_pos_1);
  index[118] = integer_sequence(shared->offset_variable_T_sero_pre_2 + 1, shared->dim_T_sero_pre_2);
  index[119] = integer_sequence(shared->offset_variable_T_sero_pos_2 + 1, shared->dim_T_sero_pos_2);
  index[120] = integer_sequence(shared->offset_variable_T_PCR_pre + 1, shared->dim_T_PCR_pre);
  index[121] = integer_sequence(shared->offset_variable_T_PCR_pos + 1, shared->dim_T_PCR_pos);
  index.names() = nms;
...
SEXP dust_carehomes_run(SEXP ptr, size_t step_end, bool device,
                       bool deterministic) {
  return dust::r::dust_run<carehomes>(ptr, step_end, device, deterministic);
}

SEXP dust_carehomes_simulate(SEXP ptr, cpp11::sexp step_end, bool device,
                            bool deterministic) {
  return dust::r::dust_simulate<carehomes>(ptr, step_end, device,
                                           deterministic);
}

SEXP dust_carehomes_set_index(SEXP ptr, cpp11::sexp r_index) {
  dust::r::dust_set_index<carehomes>(ptr, r_index);
  return R_NilValue;
}

SEXP dust_carehomes_set_state(SEXP ptr, SEXP r_state, SEXP r_step,
                             bool deterministic) {
  dust::r::dust_set_state<carehomes>(ptr, r_state, r_step, deterministic);
  return R_NilValue;
}

SEXP dust_carehomes_reset(SEXP ptr, cpp11::list r_pars, size_t step) {
  return dust::r::dust_reset<carehomes>(ptr, r_pars, step);
}

SEXP dust_carehomes_state(SEXP ptr, SEXP r_index) {
  return dust::r::dust_state<carehomes>(ptr, r_index);
}

size_t dust_carehomes_step(SEXP ptr) {
  return dust::r::dust_step<carehomes>(ptr);
}

void dust_carehomes_reorder(SEXP ptr, cpp11::sexp r_index) {
  return dust::r::dust_reorder<carehomes>(ptr, r_index);
}

SEXP dust_carehomes_resample(SEXP ptr, cpp11::doubles r_weights) {
  return dust::r::dust_resample<carehomes>(ptr, r_weights);
}
...
SEXP dust_carehomes_set_rng_state(SEXP ptr, cpp11::raws rng_state) {
  dust::r::dust_set_rng_state<carehomes>(ptr, rng_state);
  return R_NilValue;
}

SEXP dust_carehomes_set_data(SEXP ptr, cpp11::list data) {
  dust::r::dust_set_data<carehomes>(ptr, data);
  return R_NilValue;
}

SEXP dust_carehomes_compare_data(SEXP ptr, bool device) {
  return dust::r::dust_compare_data<carehomes>(ptr, device);
}

SEXP dust_carehomes_filter(SEXP ptr, bool save_trajectories,
                          cpp11::sexp step_snapshot,
                          bool device) {
  return dust::r::dust_filter<carehomes>(ptr, save_trajectories, step_snapshot, device);
}

cpp11::sexp dust_carehomes_capabilities() {
  return dust::r::dust_capabilities<carehomes>();
}

void dust_carehomes_set_n_threads(SEXP ptr, int n_threads) {
  return dust::r::dust_set_n_threads<carehomes>(ptr, n_threads);
}

int dust_carehomes_n_state(SEXP ptr) {
  return dust::r::dust_n_state<carehomes>(ptr);
}

cpp11::sexp dust_carehomes_device_info() {
  return dust::cuda::device_info<carehomes::real_t>();
}
