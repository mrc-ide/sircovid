...
// Generated by odin.dust (version 0.2.4) - do not edit
...
// [[dust::param(k_L, has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE)]]
...
// [[dust::param(gamma_L, has_default = TRUE, default_value = 0.1, rank = 0, min = -Inf, max = Inf, integer = FALSE)]]
...
public:
  ...
  struct shared_t {
    ...
    int dim_n_I_L_progress_123;
    int dim_n_I_L_progress_2;
    int dim_n_I_L_progress_3;
    int dim_n_I_L_progress_4;
    int dim_n_I_L_to_G_D;
    int dim_n_I_L_to_G_D_1;
    int dim_n_I_L_to_G_D_12;
    int dim_n_I_L_to_G_D_2;
    int dim_n_I_L_to_G_D_3;
    int dim_n_I_L_to_H_D;
    int dim_n_I_L_to_H_D_1;
    int dim_n_I_L_to_H_D_12;
    int dim_n_I_L_to_H_D_2;
    int dim_n_I_L_to_H_D_3;
    int dim_n_I_L_to_H_D_conf;
    int dim_n_I_L_to_H_D_conf_1;
    int dim_n_I_L_to_H_D_conf_12;
    int dim_n_I_L_to_H_D_conf_2;
    int dim_n_I_L_to_H_D_conf_3;
    int dim_n_I_L_to_H_R;
    int dim_n_I_L_to_H_R_1;
    int dim_n_I_L_to_H_R_12;
    int dim_n_I_L_to_H_R_2;
    int dim_n_I_L_to_H_R_3;
    int dim_n_I_L_to_H_R_conf;
    int dim_n_I_L_to_H_R_conf_1;
    int dim_n_I_L_to_H_R_conf_12;
    int dim_n_I_L_to_H_R_conf_2;
    int dim_n_I_L_to_H_R_conf_3;
    int dim_n_I_L_to_ICU_pre;
    int dim_n_I_L_to_ICU_pre_1;
    int dim_n_I_L_to_ICU_pre_12;
    int dim_n_I_L_to_ICU_pre_2;
    int dim_n_I_L_to_ICU_pre_3;
    int dim_n_I_L_to_ICU_pre_conf;
    int dim_n_I_L_to_ICU_pre_conf_1;
    int dim_n_I_L_to_ICU_pre_conf_12;
    int dim_n_I_L_to_ICU_pre_conf_2;
    int dim_n_I_L_to_ICU_pre_conf_3;
    int dim_n_I_L_to_R;
    int dim_n_I_L_to_R_1;
    int dim_n_I_L_to_R_12;
    int dim_n_I_L_to_R_2;
    int dim_n_I_L_to_R_3;
    int dim_n_I_L_to_hosp;
    int dim_n_I_L_to_hosp_1;
    int dim_n_I_L_to_hosp_12;
    int dim_n_I_L_to_hosp_2;
    int dim_n_I_L_to_hosp_3;
  ...
  struct internal_t {
    ...
    std::vector<real_t> n_I_L_to_H_D_conf;
    std::vector<real_t> n_I_L_to_H_R;
    std::vector<real_t> n_I_L_to_H_R_conf;
    std::vector<real_t> n_I_L_to_ICU_pre;
    std::vector<real_t> n_I_L_to_ICU_pre_conf;
    std::vector<real_t> n_I_L_to_R;
    std::vector<real_t> n_I_L_to_hosp;
  ...
  HOST void update(size_t step, const real_t * state, dust::rng_state_t<real_t>& rng_state, real_t * state_next) {
    ...
    for (int i = 1; i <= shared->dim_n_I_L_progress_1; ++i) {
      for (int j = 1; j <= shared->dim_n_I_L_progress_2; ++j) {
        for (int k = 1; k <= shared->dim_n_I_L_progress_3; ++k) {
          for (int l = 1; l <= shared->dim_n_I_L_progress_4; ++l) {
            internal.n_I_L_progress[i - 1 + shared->dim_n_I_L_progress_1 * (j - 1) + shared->dim_n_I_L_progress_12 * (k - 1) + shared->dim_n_I_L_progress_123 * (l - 1)] = dust::distr::rbinom(rng_state, std::round(I_L[shared->dim_I_L_123 * (l - 1) + shared->dim_I_L_12 * (k - 1) + shared->dim_I_L_1 * (j - 1) + i - 1]), shared->p_I_L_progress);
          }
        }
      }
    }
    ...
    for (int i = 1; i <= shared->dim_aux_I_L_1; ++i) {
    ...
    for (int i = 1; i <= shared->dim_n_I_L_to_R_1; ++i) {
      for (int j = 1; j <= shared->dim_n_I_L_to_R_2; ++j) {
        for (int k = 1; k <= shared->dim_n_I_L_to_R_3; ++k) {
          internal.n_I_L_to_R[i - 1 + shared->dim_n_I_L_to_R_1 * (j - 1) + shared->dim_n_I_L_to_R_12 * (k - 1)] = dust::distr::rbinom(rng_state, std::round(internal.n_I_L_progress[shared->dim_n_I_L_progress_123 * (k - 1) + shared->dim_n_I_L_progress_12 * (shared->k_L - 1) + shared->dim_n_I_L_progress_1 * (j - 1) + i - 1]), 1 - internal.p_H_by_age[i - 1] * shared->rel_p_hosp_if_sympt[shared->dim_rel_p_hosp_if_sympt_1 * (k - 1) + i - 1]);
        }
      }
    }
    ...
    for (int i = 1; i <= shared->dim_n_I_L_to_G_D_1; ++i) {
      for (int j = 1; j <= shared->dim_n_I_L_to_G_D_2; ++j) {
        for (int k = 1; k <= shared->dim_n_I_L_to_G_D_3; ++k) {
          internal.n_I_L_to_G_D[i - 1 + shared->dim_n_I_L_to_G_D_1 * (j - 1) + shared->dim_n_I_L_to_G_D_12 * (k - 1)] = dust::distr::rbinom(rng_state, std::round(internal.n_I_L_progress[shared->dim_n_I_L_progress_123 * (k - 1) + shared->dim_n_I_L_progress_12 * (shared->k_L - 1) + shared->dim_n_I_L_progress_1 * (j - 1) + i - 1] - internal.n_I_L_to_R[shared->dim_n_I_L_to_R_12 * (k - 1) + shared->dim_n_I_L_to_R_1 * (j - 1) + i - 1]), internal.p_G_D_by_age[i - 1]);
        }
      }
    }
    ...
    for (int i = 1; i <= shared->dim_new_I_L_1; ++i) {
      for (int j = 1; j <= shared->dim_new_I_L_2; ++j) {
        for (int k = 1; k <= shared->dim_new_I_L_3; ++k) {
          for (int l = 1; l <= shared->dim_new_I_L_4; ++l) {
            internal.new_I_L[i - 1 + shared->dim_new_I_L_1 * (j - 1) + shared->dim_new_I_L_12 * (k - 1) + shared->dim_new_I_L_123 * (l - 1)] = I_L[shared->dim_I_L_123 * (l - 1) + shared->dim_I_L_12 * (k - 1) + shared->dim_I_L_1 * (j - 1) + i - 1] + internal.aux_I_L[shared->dim_aux_I_L_123 * (l - 1) + shared->dim_aux_I_L_12 * (k - 1) + shared->dim_aux_I_L_1 * (j - 1) + i - 1];
          }
        }
      }
    }
      ...
      for (int j = 1; j <= shared->dim_aux_G_D_2; ++j) {
        for (int k = 1; k <= shared->dim_aux_G_D_3; ++k) {
          for (int l = 1; l <= shared->dim_aux_G_D_4; ++l) {
            internal.aux_G_D[i - 1 + shared->dim_aux_G_D_1 * (j - 1) + shared->dim_aux_G_D_12 * (k - 1) + shared->dim_aux_G_D_123 * (l - 1)] = ((k == 1 ? internal.n_I_L_to_G_D[shared->dim_n_I_L_to_G_D_12 * (l - 1) + shared->dim_n_I_L_to_G_D_1 * (j - 1) + i - 1] : internal.n_G_D_progress[shared->dim_n_G_D_progress_123 * (l - 1) + shared->dim_n_G_D_progress_12 * (k - 1 - 1) + shared->dim_n_G_D_progress_1 * (j - 1) + i - 1])) - internal.n_G_D_progress[shared->dim_n_G_D_progress_123 * (l - 1) + shared->dim_n_G_D_progress_12 * (k - 1) + shared->dim_n_G_D_progress_1 * (j - 1) + i - 1];
          }
        }
      }
    }
    ...
    for (int i = 1; i <= shared->dim_n_I_L_to_hosp_1; ++i) {
      for (int j = 1; j <= shared->dim_n_I_L_to_hosp_2; ++j) {
        for (int k = 1; k <= shared->dim_n_I_L_to_hosp_3; ++k) {
          internal.n_I_L_to_hosp[i - 1 + shared->dim_n_I_L_to_hosp_1 * (j - 1) + shared->dim_n_I_L_to_hosp_12 * (k - 1)] = internal.n_I_L_progress[shared->dim_n_I_L_progress_123 * (k - 1) + shared->dim_n_I_L_progress_12 * (shared->k_L - 1) + shared->dim_n_I_L_progress_1 * (j - 1) + i - 1] - internal.n_I_L_to_R[shared->dim_n_I_L_to_R_12 * (k - 1) + shared->dim_n_I_L_to_R_1 * (j - 1) + i - 1] - internal.n_I_L_to_G_D[shared->dim_n_I_L_to_G_D_12 * (k - 1) + shared->dim_n_I_L_to_G_D_1 * (j - 1) + i - 1];
        }
      }
    }
    ...
    for (int i = 1; i <= shared->dim_I_L_1; ++i) {
      for (int j = 1; j <= shared->dim_I_L_2; ++j) {
        for (int k = 1; k <= shared->dim_I_L_3; ++k) {
          for (int l = 1; l <= shared->dim_I_L_4; ++l) {
            state_next[shared->offset_variable_I_L + i - 1 + shared->dim_I_L_1 * (j - 1) + shared->dim_I_L_12 * (k - 1) + shared->dim_I_L_123 * (l - 1)] = internal.new_I_L[shared->dim_new_I_L_123 * (l - 1) + shared->dim_new_I_L_12 * (k - 1) + shared->dim_new_I_L_1 * (j - 1) + i - 1];
          }
        }
      }
    }
    ...
    for (int i = 1; i <= shared->dim_n_I_L_to_ICU_pre_1; ++i) {
      for (int j = 1; j <= shared->dim_n_I_L_to_ICU_pre_2; ++j) {
        for (int k = 1; k <= shared->dim_n_I_L_to_ICU_pre_3; ++k) {
          internal.n_I_L_to_ICU_pre[i - 1 + shared->dim_n_I_L_to_ICU_pre_1 * (j - 1) + shared->dim_n_I_L_to_ICU_pre_12 * (k - 1)] = dust::distr::rbinom(rng_state, std::round(internal.n_I_L_to_hosp[shared->dim_n_I_L_to_hosp_12 * (k - 1) + shared->dim_n_I_L_to_hosp_1 * (j - 1) + i - 1]), internal.p_ICU_by_age[i - 1]);
        }
      }
    }
    ...
    for (int i = 1; i <= shared->dim_cum_admit_by_age; ++i) {
      state_next[shared->offset_variable_cum_admit_by_age + i - 1] = cum_admit_by_age[i - 1] + odin_sum3<real_t>(internal.n_I_L_to_hosp.data(), i - 1, i, 0, shared->dim_n_I_L_to_hosp_2, 0, shared->dim_n_I_L_to_hosp_3, shared->dim_n_I_L_to_hosp_1, shared->dim_n_I_L_to_hosp_12);
    }
    ...
    for (int i = 1; i <= shared->dim_n_I_L_to_ICU_pre_conf_1; ++i) {
      for (int j = 1; j <= shared->dim_n_I_L_to_ICU_pre_conf_2; ++j) {
        for (int k = 1; k <= shared->dim_n_I_L_to_ICU_pre_conf_3; ++k) {
          internal.n_I_L_to_ICU_pre_conf[i - 1 + shared->dim_n_I_L_to_ICU_pre_conf_1 * (j - 1) + shared->dim_n_I_L_to_ICU_pre_conf_12 * (k - 1)] = dust::distr::rbinom(rng_state, std::round(internal.n_I_L_to_ICU_pre[shared->dim_n_I_L_to_ICU_pre_12 * (k - 1) + shared->dim_n_I_L_to_ICU_pre_1 * (j - 1) + i - 1]), internal.p_star_by_age[i - 1]);
        }
      }
    }
    ...
    for (int i = 1; i <= shared->dim_n_hosp_non_ICU_1; ++i) {
      for (int j = 1; j <= shared->dim_n_hosp_non_ICU_2; ++j) {
        for (int k = 1; k <= shared->dim_n_hosp_non_ICU_3; ++k) {
          internal.n_hosp_non_ICU[i - 1 + shared->dim_n_hosp_non_ICU_1 * (j - 1) + shared->dim_n_hosp_non_ICU_12 * (k - 1)] = internal.n_I_L_to_hosp[shared->dim_n_I_L_to_hosp_12 * (k - 1) + shared->dim_n_I_L_to_hosp_1 * (j - 1) + i - 1] - internal.n_I_L_to_ICU_pre[shared->dim_n_I_L_to_ICU_pre_12 * (k - 1) + shared->dim_n_I_L_to_ICU_pre_1 * (j - 1) + i - 1];
        }
      }
    }
    ...
    for (int i = 1; i <= shared->dim_n_I_L_to_H_D_1; ++i) {
      for (int j = 1; j <= shared->dim_n_I_L_to_H_D_2; ++j) {
        for (int k = 1; k <= shared->dim_n_I_L_to_H_D_3; ++k) {
          internal.n_I_L_to_H_D[i - 1 + shared->dim_n_I_L_to_H_D_1 * (j - 1) + shared->dim_n_I_L_to_H_D_12 * (k - 1)] = dust::distr::rbinom(rng_state, std::round(internal.n_hosp_non_ICU[shared->dim_n_hosp_non_ICU_12 * (k - 1) + shared->dim_n_hosp_non_ICU_1 * (j - 1) + i - 1]), internal.p_H_D_by_age[i - 1]);
        }
      }
    }
    ...
    for (int i = 1; i <= shared->dim_n_I_L_to_H_D_conf_1; ++i) {
      for (int j = 1; j <= shared->dim_n_I_L_to_H_D_conf_2; ++j) {
        for (int k = 1; k <= shared->dim_n_I_L_to_H_D_conf_3; ++k) {
          internal.n_I_L_to_H_D_conf[i - 1 + shared->dim_n_I_L_to_H_D_conf_1 * (j - 1) + shared->dim_n_I_L_to_H_D_conf_12 * (k - 1)] = dust::distr::rbinom(rng_state, std::round(internal.n_I_L_to_H_D[shared->dim_n_I_L_to_H_D_12 * (k - 1) + shared->dim_n_I_L_to_H_D_1 * (j - 1) + i - 1]), internal.p_star_by_age[i - 1]);
        }
      }
    }
    for (int i = 1; i <= shared->dim_n_I_L_to_H_R_1; ++i) {
      for (int j = 1; j <= shared->dim_n_I_L_to_H_R_2; ++j) {
        for (int k = 1; k <= shared->dim_n_I_L_to_H_R_3; ++k) {
          internal.n_I_L_to_H_R[i - 1 + shared->dim_n_I_L_to_H_R_1 * (j - 1) + shared->dim_n_I_L_to_H_R_12 * (k - 1)] = internal.n_hosp_non_ICU[shared->dim_n_hosp_non_ICU_12 * (k - 1) + shared->dim_n_hosp_non_ICU_1 * (j - 1) + i - 1] - internal.n_I_L_to_H_D[shared->dim_n_I_L_to_H_D_12 * (k - 1) + shared->dim_n_I_L_to_H_D_1 * (j - 1) + i - 1];
        }
      }
    }
    ...
    for (int i = 1; i <= shared->dim_n_I_L_to_H_R_conf_1; ++i) {
      for (int j = 1; j <= shared->dim_n_I_L_to_H_R_conf_2; ++j) {
        for (int k = 1; k <= shared->dim_n_I_L_to_H_R_conf_3; ++k) {
          internal.n_I_L_to_H_R_conf[i - 1 + shared->dim_n_I_L_to_H_R_conf_1 * (j - 1) + shared->dim_n_I_L_to_H_R_conf_12 * (k - 1)] = dust::distr::rbinom(rng_state, std::round(internal.n_I_L_to_H_R[shared->dim_n_I_L_to_H_R_12 * (k - 1) + shared->dim_n_I_L_to_H_R_1 * (j - 1) + i - 1]), internal.p_star_by_age[i - 1]);
        }
      }
    }
    ...
    real_t delta_admit_conf = odin_sum1<real_t>(internal.n_I_L_to_H_D_conf.data(), 0, shared->dim_n_I_L_to_H_D_conf) + odin_sum1<real_t>(internal.n_I_L_to_H_R_conf.data(), 0, shared->dim_n_I_L_to_H_R_conf) + odin_sum1<real_t>(internal.n_I_L_to_ICU_pre_conf.data(), 0, shared->dim_n_I_L_to_ICU_pre_conf);
      ...
      for (int j = 1; j <= shared->dim_new_H_R_conf_2; ++j) {
        for (int k = 1; k <= shared->dim_new_H_R_conf_3; ++k) {
          for (int l = 1; l <= shared->dim_new_H_R_conf_4; ++l) {
            internal.new_H_R_conf[i - 1 + shared->dim_new_H_R_conf_1 * (j - 1) + shared->dim_new_H_R_conf_12 * (k - 1) + shared->dim_new_H_R_conf_123 * (l - 1)] = internal.aux_H_R_conf[shared->dim_aux_H_R_conf_123 * (l - 1) + shared->dim_aux_H_R_conf_12 * (k - 1) + shared->dim_aux_H_R_conf_1 * (j - 1) + i - 1] + internal.n_H_R_unconf_to_conf[shared->dim_n_H_R_unconf_to_conf_123 * (l - 1) + shared->dim_n_H_R_unconf_to_conf_12 * (k - 1) + shared->dim_n_H_R_unconf_to_conf_1 * (j - 1) + i - 1] + ((k == 1 ? internal.n_I_L_to_H_R_conf[shared->dim_n_I_L_to_H_R_conf_12 * (l - 1) + shared->dim_n_I_L_to_H_R_conf_1 * (j - 1) + i - 1] : 0));
          }
        }
      }
    }
      ...
      for (int j = 1; j <= shared->dim_new_H_R_unconf_2; ++j) {
        for (int k = 1; k <= shared->dim_new_H_R_unconf_3; ++k) {
          for (int l = 1; l <= shared->dim_new_H_R_unconf_4; ++l) {
            internal.new_H_R_unconf[i - 1 + shared->dim_new_H_R_unconf_1 * (j - 1) + shared->dim_new_H_R_unconf_12 * (k - 1) + shared->dim_new_H_R_unconf_123 * (l - 1)] = internal.aux_H_R_unconf[shared->dim_aux_H_R_unconf_123 * (l - 1) + shared->dim_aux_H_R_unconf_12 * (k - 1) + shared->dim_aux_H_R_unconf_1 * (j - 1) + i - 1] - internal.n_H_R_unconf_to_conf[shared->dim_n_H_R_unconf_to_conf_123 * (l - 1) + shared->dim_n_H_R_unconf_to_conf_12 * (k - 1) + shared->dim_n_H_R_unconf_to_conf_1 * (j - 1) + i - 1] + ((k == 1 ? internal.n_I_L_to_H_R[shared->dim_n_I_L_to_H_R_12 * (l - 1) + shared->dim_n_I_L_to_H_R_1 * (j - 1) + i - 1] - internal.n_I_L_to_H_R_conf[shared->dim_n_I_L_to_H_R_conf_12 * (l - 1) + shared->dim_n_I_L_to_H_R_conf_1 * (j - 1) + i - 1] : 0));
          }
        }
      }
    }
...
dust::pars_t<carehomes> dust_pars<carehomes>(cpp11::list user) {
  ...
  shared->gamma_L = 0.10000000000000001;
  ...
  shared->gamma_L = user_get_scalar<real_t>(user, "gamma_L", shared->gamma_L, NA_REAL, NA_REAL);
  ...
  shared->k_L = user_get_scalar<int>(user, "k_L", shared->k_L, NA_REAL, NA_REAL);
  ...
  shared->dim_I_L_4 = shared->n_vacc_classes;
  ...
  shared->dim_aux_I_L_4 = shared->n_vacc_classes;
  ...
  shared->dim_n_I_L_progress_4 = shared->n_vacc_classes;
  shared->dim_n_I_L_to_G_D_1 = shared->n_groups;
  shared->dim_n_I_L_to_G_D_2 = shared->n_strains;
  shared->dim_n_I_L_to_G_D_3 = shared->n_vacc_classes;
  shared->dim_n_I_L_to_H_D_1 = shared->n_groups;
  shared->dim_n_I_L_to_H_D_2 = shared->n_strains;
  shared->dim_n_I_L_to_H_D_3 = shared->n_vacc_classes;
  shared->dim_n_I_L_to_H_D_conf_1 = shared->n_groups;
  shared->dim_n_I_L_to_H_D_conf_2 = shared->n_strains;
  shared->dim_n_I_L_to_H_D_conf_3 = shared->n_vacc_classes;
  shared->dim_n_I_L_to_H_R_1 = shared->n_groups;
  shared->dim_n_I_L_to_H_R_2 = shared->n_strains;
  shared->dim_n_I_L_to_H_R_3 = shared->n_vacc_classes;
  shared->dim_n_I_L_to_H_R_conf_1 = shared->n_groups;
  shared->dim_n_I_L_to_H_R_conf_2 = shared->n_strains;
  shared->dim_n_I_L_to_H_R_conf_3 = shared->n_vacc_classes;
  shared->dim_n_I_L_to_ICU_pre_1 = shared->n_groups;
  shared->dim_n_I_L_to_ICU_pre_2 = shared->n_strains;
  shared->dim_n_I_L_to_ICU_pre_3 = shared->n_vacc_classes;
  shared->dim_n_I_L_to_ICU_pre_conf_1 = shared->n_groups;
  shared->dim_n_I_L_to_ICU_pre_conf_2 = shared->n_strains;
  shared->dim_n_I_L_to_ICU_pre_conf_3 = shared->n_vacc_classes;
  shared->dim_n_I_L_to_R_1 = shared->n_groups;
  shared->dim_n_I_L_to_R_2 = shared->n_strains;
  shared->dim_n_I_L_to_R_3 = shared->n_vacc_classes;
  shared->dim_n_I_L_to_hosp_1 = shared->n_groups;
  shared->dim_n_I_L_to_hosp_2 = shared->n_strains;
  shared->dim_n_I_L_to_hosp_3 = shared->n_vacc_classes;
  ...
  shared->dim_new_I_L_4 = shared->n_vacc_classes;
  ...
  shared->dim_n_I_L_to_G_D = shared->dim_n_I_L_to_G_D_1 * shared->dim_n_I_L_to_G_D_2 * shared->dim_n_I_L_to_G_D_3;
  shared->dim_n_I_L_to_G_D_12 = shared->dim_n_I_L_to_G_D_1 * shared->dim_n_I_L_to_G_D_2;
  shared->dim_n_I_L_to_H_D = shared->dim_n_I_L_to_H_D_1 * shared->dim_n_I_L_to_H_D_2 * shared->dim_n_I_L_to_H_D_3;
  shared->dim_n_I_L_to_H_D_12 = shared->dim_n_I_L_to_H_D_1 * shared->dim_n_I_L_to_H_D_2;
  shared->dim_n_I_L_to_H_D_conf = shared->dim_n_I_L_to_H_D_conf_1 * shared->dim_n_I_L_to_H_D_conf_2 * shared->dim_n_I_L_to_H_D_conf_3;
  shared->dim_n_I_L_to_H_D_conf_12 = shared->dim_n_I_L_to_H_D_conf_1 * shared->dim_n_I_L_to_H_D_conf_2;
  shared->dim_n_I_L_to_H_R = shared->dim_n_I_L_to_H_R_1 * shared->dim_n_I_L_to_H_R_2 * shared->dim_n_I_L_to_H_R_3;
  shared->dim_n_I_L_to_H_R_12 = shared->dim_n_I_L_to_H_R_1 * shared->dim_n_I_L_to_H_R_2;
  shared->dim_n_I_L_to_H_R_conf = shared->dim_n_I_L_to_H_R_conf_1 * shared->dim_n_I_L_to_H_R_conf_2 * shared->dim_n_I_L_to_H_R_conf_3;
  shared->dim_n_I_L_to_H_R_conf_12 = shared->dim_n_I_L_to_H_R_conf_1 * shared->dim_n_I_L_to_H_R_conf_2;
  shared->dim_n_I_L_to_ICU_pre = shared->dim_n_I_L_to_ICU_pre_1 * shared->dim_n_I_L_to_ICU_pre_2 * shared->dim_n_I_L_to_ICU_pre_3;
  shared->dim_n_I_L_to_ICU_pre_12 = shared->dim_n_I_L_to_ICU_pre_1 * shared->dim_n_I_L_to_ICU_pre_2;
  shared->dim_n_I_L_to_ICU_pre_conf = shared->dim_n_I_L_to_ICU_pre_conf_1 * shared->dim_n_I_L_to_ICU_pre_conf_2 * shared->dim_n_I_L_to_ICU_pre_conf_3;
  shared->dim_n_I_L_to_ICU_pre_conf_12 = shared->dim_n_I_L_to_ICU_pre_conf_1 * shared->dim_n_I_L_to_ICU_pre_conf_2;
  shared->dim_n_I_L_to_R = shared->dim_n_I_L_to_R_1 * shared->dim_n_I_L_to_R_2 * shared->dim_n_I_L_to_R_3;
  shared->dim_n_I_L_to_R_12 = shared->dim_n_I_L_to_R_1 * shared->dim_n_I_L_to_R_2;
  shared->dim_n_I_L_to_hosp = shared->dim_n_I_L_to_hosp_1 * shared->dim_n_I_L_to_hosp_2 * shared->dim_n_I_L_to_hosp_3;
  shared->dim_n_I_L_to_hosp_12 = shared->dim_n_I_L_to_hosp_1 * shared->dim_n_I_L_to_hosp_2;
  ...
  internal.n_I_L_to_H_D_conf = std::vector<real_t>(shared->dim_n_I_L_to_H_D_conf);
  internal.n_I_L_to_H_R = std::vector<real_t>(shared->dim_n_I_L_to_H_R);
  internal.n_I_L_to_H_R_conf = std::vector<real_t>(shared->dim_n_I_L_to_H_R_conf);
  internal.n_I_L_to_ICU_pre = std::vector<real_t>(shared->dim_n_I_L_to_ICU_pre);
  internal.n_I_L_to_ICU_pre_conf = std::vector<real_t>(shared->dim_n_I_L_to_ICU_pre_conf);
  internal.n_I_L_to_R = std::vector<real_t>(shared->dim_n_I_L_to_R);
  internal.n_I_L_to_hosp = std::vector<real_t>(shared->dim_n_I_L_to_hosp);
  ...
  for (int i = 1; i <= shared->dim_I_L_1; ++i) {
    for (int j = 1; j <= shared->dim_I_L_2; ++j) {
      for (int k = 1; k <= shared->dim_I_L_3; ++k) {
        for (int l = 1; l <= shared->dim_I_L_4; ++l) {
          shared->initial_I_L[i - 1 + shared->dim_I_L_1 * (j - 1) + shared->dim_I_L_12 * (k - 1) + shared->dim_I_L_123 * (l - 1)] = 0;
        }
      }
    }
  }
