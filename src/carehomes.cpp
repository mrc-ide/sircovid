...
public:
  ...
  HOST void update(size_t step, const real_t * state, dust::rng_state_t<real_t>& rng_state, real_t * state_next) {
    ...
    real_t new_sympt_cases_25_50 = odin_sum3<real_t>(internal.n_EI_P.data(), 5, 10, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) + (odin_sum3<real_t>(internal.n_EI_P.data(), 17, 18, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) / (real_t) 7) * 5;
    real_t new_sympt_cases_50_65 = odin_sum3<real_t>(internal.n_EI_P.data(), 10, 13, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) + (odin_sum3<real_t>(internal.n_EI_P.data(), 17, 18, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) / (real_t) 7) * 2;
