...
[[cpp11::register]]
SEXP dust_cpu_carehomes_alloc(cpp11::list r_pars, bool pars_multi, size_t step,
...
[[cpp11::register]]
SEXP dust_cpu_carehomes_update_state(SEXP ptr, SEXP r_pars, SEXP r_state,
...
[[cpp11::register]]
SEXP dust_cpu_carehomes_filter(SEXP ptr, bool save_trajectories,
...
using model_cpu = dust::Dust<carehomes>;

SEXP dust_cpu_carehomes_alloc(cpp11::list r_pars, bool pars_multi, size_t step,
                             cpp11::sexp r_n_particles, size_t n_threads,
                             cpp11::sexp r_seed, bool deterministic,
                             cpp11::sexp device_config) {
  return dust::r::dust_cpu_alloc<carehomes>(r_pars, pars_multi, step, r_n_particles,
