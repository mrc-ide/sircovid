...
typename T::real_t compare(const typename T::real_t * state,
  ...
  const real_t model_deaths_carehomes = state[26];
  const real_t model_deaths_comm = state[24];
  const real_t model_deaths_hosp = state[27];
  ...
  const real_t model_sero_pos_1 = state[29];
  const real_t model_sero_pos_2 = state[30];
  const real_t model_sympt_cases = state[35];
  const real_t model_sympt_cases_non_variant =
    state[36];
  const real_t model_sympt_cases_over25 = state[37];
  const real_t model_sympt_cases_non_variant_over25 =
    state[38];
  const real_t model_react_pos = state[39];
...
public:
  ...
  struct shared_t {
    ...
    real_t initial_D_hosp_inc_0;
    real_t initial_D_hosp_inc_55;
    real_t initial_D_hosp_inc_65;
    real_t initial_D_hosp_inc_75;
    real_t initial_D_hosp_tot;
    real_t initial_D_hosp_tot_0;
    real_t initial_D_hosp_tot_55;
    real_t initial_D_hosp_tot_65;
    real_t initial_D_hosp_tot_75;
  ...
  std::vector<real_t> initial(size_t step) {
    ...
    state[15] = shared->initial_D_hosp_tot_0;
    state[16] = shared->initial_D_hosp_inc_0;
    state[17] = shared->initial_D_hosp_tot_55;
    state[18] = shared->initial_D_hosp_inc_55;
    state[19] = shared->initial_D_hosp_tot_65;
    state[20] = shared->initial_D_hosp_inc_65;
    state[21] = shared->initial_D_hosp_tot_75;
    state[22] = shared->initial_D_hosp_inc_75;
    state[23] = shared->initial_D_comm_tot;
    state[24] = shared->initial_D_comm_inc;
    state[25] = shared->initial_D_carehomes_tot;
    state[26] = shared->initial_D_carehomes_inc;
    state[27] = shared->initial_D_hosp_inc;
    state[28] = shared->initial_D_tot;
    state[29] = shared->initial_sero_pos_1;
    state[30] = shared->initial_sero_pos_2;
    state[31] = shared->initial_cum_sympt_cases;
    state[32] = shared->initial_cum_sympt_cases_non_variant;
    state[33] = shared->initial_cum_sympt_cases_over25;
    state[34] = shared->initial_cum_sympt_cases_non_variant_over25;
    state[35] = shared->initial_sympt_cases_inc;
    state[36] = shared->initial_sympt_cases_non_variant_inc;
    state[37] = shared->initial_sympt_cases_over25_inc;
    state[38] = shared->initial_sympt_cases_non_variant_over25_inc;
    state[39] = shared->initial_react_pos;
    std::copy(shared->initial_cum_infections_per_strain.begin(), shared->initial_cum_infections_per_strain.end(), state.begin() + 40);
  ...
  HOST void update(size_t step, const real_t * state, dust::rng_state_t<real_t>& rng_state, real_t * state_next) {
    ...
    const real_t * cum_infections_per_strain = state + 40;
    const real_t * D = state + shared->offset_variable_D;
    const real_t D_hosp_tot = state[14];
    const real_t D_hosp_tot_0 = state[15];
    const real_t D_hosp_inc_0 = state[16];
    const real_t D_hosp_tot_55 = state[17];
    const real_t D_hosp_inc_55 = state[18];
    const real_t D_hosp_tot_65 = state[19];
    const real_t D_hosp_inc_65 = state[20];
    const real_t D_hosp_tot_75 = state[21];
    const real_t D_hosp_inc_75 = state[22];
    const real_t D_comm_tot = state[23];
    const real_t D_comm_inc = state[24];
    const real_t D_carehomes_tot = state[25];
    const real_t D_carehomes_inc = state[26];
    const real_t D_hosp_inc = state[27];
    const real_t D_tot = state[28];
    const real_t cum_sympt_cases = state[31];
    const real_t cum_sympt_cases_non_variant = state[32];
    const real_t cum_sympt_cases_over25 = state[33];
    const real_t cum_sympt_cases_non_variant_over25 = state[34];
    const real_t sympt_cases_inc = state[35];
    const real_t sympt_cases_non_variant_inc = state[36];
    const real_t sympt_cases_over25_inc = state[37];
    const real_t sympt_cases_non_variant_over25_inc = state[38];
    ...
    state_next[29] = odin_sum4<real_t>(internal.new_T_sero_pos_1.data(), 3, 13, 0, shared->dim_new_T_sero_pos_1_2, 0, shared->dim_new_T_sero_pos_1_3, 0, shared->dim_new_T_sero_pos_1_4, shared->dim_new_T_sero_pos_1_1, shared->dim_new_T_sero_pos_1_12, shared->dim_new_T_sero_pos_1_123);
    state_next[30] = odin_sum4<real_t>(internal.new_T_sero_pos_2.data(), 3, 13, 0, shared->dim_new_T_sero_pos_2_2, 0, shared->dim_new_T_sero_pos_2_3, 0, shared->dim_new_T_sero_pos_2_4, shared->dim_new_T_sero_pos_2_1, shared->dim_new_T_sero_pos_2_12, shared->dim_new_T_sero_pos_2_123);
    ...
    real_t delta_D_hosp_tot_0 = odin_sum1<real_t>(internal.delta_D_hosp.data(), 0, 11) + internal.delta_D_hosp[17] * 0.75;
    real_t delta_D_hosp_tot_55 = odin_sum1<real_t>(internal.delta_D_hosp.data(), 11, 13) + internal.delta_D_hosp[17] * 0.25;
    real_t delta_D_hosp_tot_65 = odin_sum1<real_t>(internal.delta_D_hosp.data(), 13, 15) + internal.delta_D_hosp[18] * 0.10000000000000001;
    real_t delta_D_hosp_tot_75 = odin_sum1<real_t>(internal.delta_D_hosp.data(), 15, 17) + internal.delta_D_hosp[18] * 0.90000000000000002;
    ...
    state_next[26] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_D_carehomes_tot : D_carehomes_inc + delta_D_carehomes_tot);
    state_next[25] = D_carehomes_tot + delta_D_carehomes_tot;
    state_next[24] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_D_comm_tot : D_comm_inc + delta_D_comm_tot);
    state_next[23] = D_comm_tot + delta_D_comm_tot;
    state_next[27] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_D_hosp_tot : D_hosp_inc + delta_D_hosp_tot);
    state_next[16] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_D_hosp_tot_0 : D_hosp_inc_0 + delta_D_hosp_tot_0);
    state_next[18] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_D_hosp_tot_55 : D_hosp_inc_55 + delta_D_hosp_tot_55);
    state_next[20] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_D_hosp_tot_65 : D_hosp_inc_65 + delta_D_hosp_tot_65);
    state_next[22] = (fmodr<real_t>(step, shared->steps_per_day) == 0 ? delta_D_hosp_tot_75 : D_hosp_inc_75 + delta_D_hosp_tot_75);
    state_next[14] = D_hosp_tot + delta_D_hosp_tot;
    state_next[15] = D_hosp_tot_0 + delta_D_hosp_tot_0;
    state_next[17] = D_hosp_tot_55 + delta_D_hosp_tot_55;
    state_next[19] = D_hosp_tot_65 + delta_D_hosp_tot_65;
    state_next[21] = D_hosp_tot_75 + delta_D_hosp_tot_75;
    state_next[28] = D_tot + delta_D_hosp_tot_0 + delta_D_hosp_tot_55 + delta_D_hosp_tot_65 + delta_D_hosp_tot_75 + delta_D_comm_tot + delta_D_carehomes_tot;
    ...
    state_next[31] = cum_sympt_cases + new_sympt_cases;
    state_next[32] = cum_sympt_cases_non_variant + new_sympt_cases_non_variant;
    state_next[34] = cum_sympt_cases_non_variant_over25 + new_sympt_cases_non_variant_over25;
    state_next[33] = cum_sympt_cases_over25 + new_sympt_cases_over25;
    state_next[35] = ((fmodr<real_t>(step, shared->steps_per_day) == 0 ? new_sympt_cases : sympt_cases_inc + new_sympt_cases));
    state_next[36] = ((fmodr<real_t>(step, shared->steps_per_day) == 0 ? new_sympt_cases_non_variant : sympt_cases_non_variant_inc + new_sympt_cases_non_variant));
    state_next[38] = ((fmodr<real_t>(step, shared->steps_per_day) == 0 ? new_sympt_cases_non_variant_over25 : sympt_cases_non_variant_over25_inc + new_sympt_cases_non_variant_over25));
    state_next[37] = ((fmodr<real_t>(step, shared->steps_per_day) == 0 ? new_sympt_cases_over25 : sympt_cases_over25_inc + new_sympt_cases_over25));
    ...
    state_next[39] = odin_sum4<real_t>(internal.new_T_PCR_pos.data(), 1, 18, 0, shared->dim_new_T_PCR_pos_2, 0, shared->dim_new_T_PCR_pos_3, 0, shared->dim_new_T_PCR_pos_4, shared->dim_new_T_PCR_pos_1, shared->dim_new_T_PCR_pos_12, shared->dim_new_T_PCR_pos_123);
...
dust::pars_t<carehomes> dust_pars<carehomes>(cpp11::list user) {
  ...
  shared->initial_D_hosp_inc_0 = 0;
  shared->initial_D_hosp_inc_55 = 0;
  shared->initial_D_hosp_inc_65 = 0;
  shared->initial_D_hosp_inc_75 = 0;
  shared->initial_D_hosp_tot = 0;
  shared->initial_D_hosp_tot_0 = 0;
  shared->initial_D_hosp_tot_55 = 0;
  shared->initial_D_hosp_tot_65 = 0;
  shared->initial_D_hosp_tot_75 = 0;
  ...
  shared->offset_variable_D_hosp = shared->dim_cum_infections_per_strain + 40;
  shared->offset_variable_D_non_hosp = shared->dim_D_hosp + shared->dim_cum_infections_per_strain + 40;
  shared->offset_variable_N_tot = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + 40;
  shared->offset_variable_cum_admit_by_age = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_cum_infections_per_strain + 40;
  shared->offset_variable_prob_strain = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + 40;
  ...
  shared->offset_variable_cum_n_E_vaccinated = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_cum_n_S_vaccinated + shared->dim_prob_strain + 40;
  shared->offset_variable_cum_n_I_A_vaccinated = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_prob_strain + 40;
  shared->offset_variable_cum_n_I_P_vaccinated = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_prob_strain + 40;
  shared->offset_variable_cum_n_R_vaccinated = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_prob_strain + 40;
  shared->offset_variable_cum_n_S_vaccinated = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_prob_strain + 40;
  shared->offset_variable_cum_n_vaccinated = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_prob_strain + 40;
...
cpp11::sexp dust_info<carehomes>(const dust::pars_t<carehomes>& pars) {
  ...
  dim[40] = cpp11::writable::integers({shared->dim_cum_infections_per_strain});
  dim[41] = cpp11::writable::integers({shared->dim_D_hosp});
  dim[42] = cpp11::writable::integers({shared->dim_D_non_hosp});
  dim[43] = cpp11::writable::integers({shared->dim_cum_admit_by_age});
  dim[44] = cpp11::writable::integers({shared->dim_N_tot});
  dim[45] = cpp11::writable::integers({shared->dim_prob_strain});
  ...
  dim[51] = cpp11::writable::integers({shared->dim_cum_n_vaccinated_1, shared->dim_cum_n_vaccinated_2});
  dim[52] = cpp11::writable::integers({shared->dim_diagnoses_admitted_1, shared->dim_diagnoses_admitted_2});
  dim[53] = cpp11::writable::integers({shared->dim_cum_infections_disag_1, shared->dim_cum_infections_disag_2});
  dim[54] = cpp11::writable::integers({shared->dim_D_1, shared->dim_D_2});
  dim[55] = cpp11::writable::integers({shared->dim_S_1, shared->dim_S_2});
  dim[56] = cpp11::writable::integers({shared->dim_I_weighted_1, shared->dim_I_weighted_2});
  dim[57] = cpp11::writable::integers({shared->dim_vaccine_missed_doses_1, shared->dim_vaccine_missed_doses_2});
  dim[58] = cpp11::writable::integers({shared->dim_tmp_vaccine_n_candidates_1, shared->dim_tmp_vaccine_n_candidates_2});
  dim[59] = cpp11::writable::integers({shared->dim_tmp_vaccine_probability_1, shared->dim_tmp_vaccine_probability_2});
  dim[60] = cpp11::writable::integers({shared->dim_T_sero_neg_1_1, shared->dim_T_sero_neg_1_2, shared->dim_T_sero_neg_1_3});
  dim[61] = cpp11::writable::integers({shared->dim_T_sero_neg_2_1, shared->dim_T_sero_neg_2_2, shared->dim_T_sero_neg_2_3});
  dim[62] = cpp11::writable::integers({shared->dim_R_1, shared->dim_R_2, shared->dim_R_3});
  dim[63] = cpp11::writable::integers({shared->dim_T_PCR_neg_1, shared->dim_T_PCR_neg_2, shared->dim_T_PCR_neg_3});
  dim[64] = cpp11::writable::integers({shared->dim_E_1, shared->dim_E_2, shared->dim_E_3, shared->dim_E_4});
  dim[65] = cpp11::writable::integers({shared->dim_I_A_1, shared->dim_I_A_2, shared->dim_I_A_3, shared->dim_I_A_4});
  dim[66] = cpp11::writable::integers({shared->dim_I_P_1, shared->dim_I_P_2, shared->dim_I_P_3, shared->dim_I_P_4});
  dim[67] = cpp11::writable::integers({shared->dim_I_C_1_1, shared->dim_I_C_1_2, shared->dim_I_C_1_3, shared->dim_I_C_1_4});
  dim[68] = cpp11::writable::integers({shared->dim_I_C_2_1, shared->dim_I_C_2_2, shared->dim_I_C_2_3, shared->dim_I_C_2_4});
  dim[69] = cpp11::writable::integers({shared->dim_G_D_1, shared->dim_G_D_2, shared->dim_G_D_3, shared->dim_G_D_4});
  dim[70] = cpp11::writable::integers({shared->dim_ICU_pre_unconf_1, shared->dim_ICU_pre_unconf_2, shared->dim_ICU_pre_unconf_3, shared->dim_ICU_pre_unconf_4});
  dim[71] = cpp11::writable::integers({shared->dim_ICU_pre_conf_1, shared->dim_ICU_pre_conf_2, shared->dim_ICU_pre_conf_3, shared->dim_ICU_pre_conf_4});
  dim[72] = cpp11::writable::integers({shared->dim_H_R_unconf_1, shared->dim_H_R_unconf_2, shared->dim_H_R_unconf_3, shared->dim_H_R_unconf_4});
  dim[73] = cpp11::writable::integers({shared->dim_H_R_conf_1, shared->dim_H_R_conf_2, shared->dim_H_R_conf_3, shared->dim_H_R_conf_4});
  dim[74] = cpp11::writable::integers({shared->dim_H_D_unconf_1, shared->dim_H_D_unconf_2, shared->dim_H_D_unconf_3, shared->dim_H_D_unconf_4});
  dim[75] = cpp11::writable::integers({shared->dim_H_D_conf_1, shared->dim_H_D_conf_2, shared->dim_H_D_conf_3, shared->dim_H_D_conf_4});
  dim[76] = cpp11::writable::integers({shared->dim_ICU_W_R_unconf_1, shared->dim_ICU_W_R_unconf_2, shared->dim_ICU_W_R_unconf_3, shared->dim_ICU_W_R_unconf_4});
  dim[77] = cpp11::writable::integers({shared->dim_ICU_W_R_conf_1, shared->dim_ICU_W_R_conf_2, shared->dim_ICU_W_R_conf_3, shared->dim_ICU_W_R_conf_4});
  dim[78] = cpp11::writable::integers({shared->dim_ICU_W_D_unconf_1, shared->dim_ICU_W_D_unconf_2, shared->dim_ICU_W_D_unconf_3, shared->dim_ICU_W_D_unconf_4});
  dim[79] = cpp11::writable::integers({shared->dim_ICU_W_D_conf_1, shared->dim_ICU_W_D_conf_2, shared->dim_ICU_W_D_conf_3, shared->dim_ICU_W_D_conf_4});
  dim[80] = cpp11::writable::integers({shared->dim_ICU_D_unconf_1, shared->dim_ICU_D_unconf_2, shared->dim_ICU_D_unconf_3, shared->dim_ICU_D_unconf_4});
  dim[81] = cpp11::writable::integers({shared->dim_ICU_D_conf_1, shared->dim_ICU_D_conf_2, shared->dim_ICU_D_conf_3, shared->dim_ICU_D_conf_4});
  dim[82] = cpp11::writable::integers({shared->dim_W_R_unconf_1, shared->dim_W_R_unconf_2, shared->dim_W_R_unconf_3, shared->dim_W_R_unconf_4});
  dim[83] = cpp11::writable::integers({shared->dim_W_R_conf_1, shared->dim_W_R_conf_2, shared->dim_W_R_conf_3, shared->dim_W_R_conf_4});
  dim[84] = cpp11::writable::integers({shared->dim_W_D_unconf_1, shared->dim_W_D_unconf_2, shared->dim_W_D_unconf_3, shared->dim_W_D_unconf_4});
  dim[85] = cpp11::writable::integers({shared->dim_W_D_conf_1, shared->dim_W_D_conf_2, shared->dim_W_D_conf_3, shared->dim_W_D_conf_4});
  dim[86] = cpp11::writable::integers({shared->dim_T_sero_pre_1_1, shared->dim_T_sero_pre_1_2, shared->dim_T_sero_pre_1_3, shared->dim_T_sero_pre_1_4});
  dim[87] = cpp11::writable::integers({shared->dim_T_sero_pos_1_1, shared->dim_T_sero_pos_1_2, shared->dim_T_sero_pos_1_3, shared->dim_T_sero_pos_1_4});
  dim[88] = cpp11::writable::integers({shared->dim_T_sero_pre_2_1, shared->dim_T_sero_pre_2_2, shared->dim_T_sero_pre_2_3, shared->dim_T_sero_pre_2_4});
  dim[89] = cpp11::writable::integers({shared->dim_T_sero_pos_2_1, shared->dim_T_sero_pos_2_2, shared->dim_T_sero_pos_2_3, shared->dim_T_sero_pos_2_4});
  dim[90] = cpp11::writable::integers({shared->dim_T_PCR_pre_1, shared->dim_T_PCR_pre_2, shared->dim_T_PCR_pre_3, shared->dim_T_PCR_pre_4});
  dim[91] = cpp11::writable::integers({shared->dim_T_PCR_pos_1, shared->dim_T_PCR_pos_2, shared->dim_T_PCR_pos_3, shared->dim_T_PCR_pos_4});
  dim.names() = nms;
  cpp11::writable::list index(92);
  ...
  index[40] = integer_sequence(41, shared->dim_cum_infections_per_strain);
  ...
  index[43] = integer_sequence(shared->offset_variable_cum_admit_by_age + 1, shared->dim_cum_admit_by_age);
  index[44] = integer_sequence(shared->offset_variable_N_tot + 1, shared->dim_N_tot);
  index[45] = integer_sequence(shared->offset_variable_prob_strain + 1, shared->dim_prob_strain);
  ...
  index[51] = integer_sequence(shared->offset_variable_cum_n_vaccinated + 1, shared->dim_cum_n_vaccinated);
  index[52] = integer_sequence(shared->offset_variable_diagnoses_admitted + 1, shared->dim_diagnoses_admitted);
  index[53] = integer_sequence(shared->offset_variable_cum_infections_disag + 1, shared->dim_cum_infections_disag);
  index[54] = integer_sequence(shared->offset_variable_D + 1, shared->dim_D);
  index[55] = integer_sequence(shared->offset_variable_S + 1, shared->dim_S);
  index[56] = integer_sequence(shared->offset_variable_I_weighted + 1, shared->dim_I_weighted);
  index[57] = integer_sequence(shared->offset_variable_vaccine_missed_doses + 1, shared->dim_vaccine_missed_doses);
  index[58] = integer_sequence(shared->offset_variable_tmp_vaccine_n_candidates + 1, shared->dim_tmp_vaccine_n_candidates);
  index[59] = integer_sequence(shared->offset_variable_tmp_vaccine_probability + 1, shared->dim_tmp_vaccine_probability);
  index[60] = integer_sequence(shared->offset_variable_T_sero_neg_1 + 1, shared->dim_T_sero_neg_1);
  index[61] = integer_sequence(shared->offset_variable_T_sero_neg_2 + 1, shared->dim_T_sero_neg_2);
  index[62] = integer_sequence(shared->offset_variable_R + 1, shared->dim_R);
  index[63] = integer_sequence(shared->offset_variable_T_PCR_neg + 1, shared->dim_T_PCR_neg);
  index[64] = integer_sequence(shared->offset_variable_E + 1, shared->dim_E);
  index[65] = integer_sequence(shared->offset_variable_I_A + 1, shared->dim_I_A);
  index[66] = integer_sequence(shared->offset_variable_I_P + 1, shared->dim_I_P);
  index[67] = integer_sequence(shared->offset_variable_I_C_1 + 1, shared->dim_I_C_1);
  index[68] = integer_sequence(shared->offset_variable_I_C_2 + 1, shared->dim_I_C_2);
  index[69] = integer_sequence(shared->offset_variable_G_D + 1, shared->dim_G_D);
  index[70] = integer_sequence(shared->offset_variable_ICU_pre_unconf + 1, shared->dim_ICU_pre_unconf);
  index[71] = integer_sequence(shared->offset_variable_ICU_pre_conf + 1, shared->dim_ICU_pre_conf);
  index[72] = integer_sequence(shared->offset_variable_H_R_unconf + 1, shared->dim_H_R_unconf);
  index[73] = integer_sequence(shared->offset_variable_H_R_conf + 1, shared->dim_H_R_conf);
  index[74] = integer_sequence(shared->offset_variable_H_D_unconf + 1, shared->dim_H_D_unconf);
  index[75] = integer_sequence(shared->offset_variable_H_D_conf + 1, shared->dim_H_D_conf);
  index[76] = integer_sequence(shared->offset_variable_ICU_W_R_unconf + 1, shared->dim_ICU_W_R_unconf);
  index[77] = integer_sequence(shared->offset_variable_ICU_W_R_conf + 1, shared->dim_ICU_W_R_conf);
  index[78] = integer_sequence(shared->offset_variable_ICU_W_D_unconf + 1, shared->dim_ICU_W_D_unconf);
  index[79] = integer_sequence(shared->offset_variable_ICU_W_D_conf + 1, shared->dim_ICU_W_D_conf);
  index[80] = integer_sequence(shared->offset_variable_ICU_D_unconf + 1, shared->dim_ICU_D_unconf);
  index[81] = integer_sequence(shared->offset_variable_ICU_D_conf + 1, shared->dim_ICU_D_conf);
  index[82] = integer_sequence(shared->offset_variable_W_R_unconf + 1, shared->dim_W_R_unconf);
  index[83] = integer_sequence(shared->offset_variable_W_R_conf + 1, shared->dim_W_R_conf);
  index[84] = integer_sequence(shared->offset_variable_W_D_unconf + 1, shared->dim_W_D_unconf);
  index[85] = integer_sequence(shared->offset_variable_W_D_conf + 1, shared->dim_W_D_conf);
  index[86] = integer_sequence(shared->offset_variable_T_sero_pre_1 + 1, shared->dim_T_sero_pre_1);
  index[87] = integer_sequence(shared->offset_variable_T_sero_pos_1 + 1, shared->dim_T_sero_pos_1);
  index[88] = integer_sequence(shared->offset_variable_T_sero_pre_2 + 1, shared->dim_T_sero_pre_2);
  index[89] = integer_sequence(shared->offset_variable_T_sero_pos_2 + 1, shared->dim_T_sero_pos_2);
  index[90] = integer_sequence(shared->offset_variable_T_PCR_pre + 1, shared->dim_T_PCR_pre);
  index[91] = integer_sequence(shared->offset_variable_T_PCR_pos + 1, shared->dim_T_PCR_pos);
  index.names() = nms;
