...
public:
  ...
  void update(size_t step, const real_type * state, rng_state_type& rng_state, real_type * state_next) {
    ...
    state_next[79] = ((shared->has_carehomes ? odin_sum4<real_type>(internal.new_T_PCR_pos.data(), 1, 18, 0, shared->dim_new_T_PCR_pos_2, 0, shared->dim_new_T_PCR_pos_3, 0, shared->dim_new_T_PCR_pos_4, shared->dim_new_T_PCR_pos_1, shared->dim_new_T_PCR_pos_12, shared->dim_new_T_PCR_pos_123) : odin_sum4<real_type>(internal.new_T_PCR_pos.data(), 1, 17, 0, shared->dim_new_T_PCR_pos_2, 0, shared->dim_new_T_PCR_pos_3, 0, shared->dim_new_T_PCR_pos_4, shared->dim_new_T_PCR_pos_1, shared->dim_new_T_PCR_pos_12, shared->dim_new_T_PCR_pos_123)));
    ...
    real_type delta_D_carehomes_tot = (shared->has_carehomes ? internal.delta_D_non_hosp[18] : 0);
    real_type delta_D_comm_0_49 = odin_sum1<real_type>(internal.delta_D_non_hosp.data(), 0, 10) + ((shared->has_carehomes ? internal.delta_D_non_hosp[17] * 3 / (real_type) 8 : 0));
    real_type delta_D_comm_50_54 = internal.delta_D_non_hosp[10] + ((shared->has_carehomes ? internal.delta_D_non_hosp[17] * 1 / (real_type) 8 : 0));
    real_type delta_D_comm_55_59 = internal.delta_D_non_hosp[11] + ((shared->has_carehomes ? internal.delta_D_non_hosp[17] * 2 / (real_type) 8 : 0));
    real_type delta_D_comm_60_64 = internal.delta_D_non_hosp[12] + ((shared->has_carehomes ? internal.delta_D_non_hosp[17] * 2 / (real_type) 8 : 0));
    ...
    real_type delta_D_hosp_0_49_tot = odin_sum1<real_type>(internal.delta_D_hosp.data(), 0, 10) + ((shared->has_carehomes ? internal.delta_D_hosp[17] * 3 / (real_type) 8 : 0));
    real_type delta_D_hosp_50_54_tot = internal.delta_D_hosp[10] + ((shared->has_carehomes ? internal.delta_D_hosp[17] * 1 / (real_type) 8 : 0));
    real_type delta_D_hosp_55_59_tot = internal.delta_D_hosp[11] + ((shared->has_carehomes ? internal.delta_D_hosp[17] * 2 / (real_type) 8 : 0));
    real_type delta_D_hosp_60_64_tot = internal.delta_D_hosp[12] + ((shared->has_carehomes ? internal.delta_D_hosp[17] * 2 / (real_type) 8 : 0));
    real_type delta_D_hosp_65_69_tot = internal.delta_D_hosp[13] + ((shared->has_carehomes ? internal.delta_D_hosp[18] * static_cast<real_type>(0.050000000000000003) : 0));
    real_type delta_D_hosp_70_74_tot = internal.delta_D_hosp[14] + ((shared->has_carehomes ? internal.delta_D_hosp[18] * static_cast<real_type>(0.050000000000000003) : 0));
    real_type delta_D_hosp_75_79_tot = internal.delta_D_hosp[15] + ((shared->has_carehomes ? internal.delta_D_hosp[18] * static_cast<real_type>(0.14999999999999999) : 0));
    real_type delta_D_hosp_80_plus_tot = internal.delta_D_hosp[16] + ((shared->has_carehomes ? internal.delta_D_hosp[18] * static_cast<real_type>(0.75) : 0));
    ...
    real_type new_sympt_cases_25_49 = odin_sum3<real_type>(internal.n_EI_P.data(), 5, 10, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) + ((shared->has_carehomes ? (odin_sum3<real_type>(internal.n_EI_P.data(), 17, 18, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) / (real_type) 8) * 5 : 0));
    real_type new_sympt_cases_50_64 = odin_sum3<real_type>(internal.n_EI_P.data(), 10, 13, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) + ((shared->has_carehomes ? (odin_sum3<real_type>(internal.n_EI_P.data(), 17, 18, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) / (real_type) 8) * 3 : 0));
    real_type new_sympt_cases_65_79 = odin_sum3<real_type>(internal.n_EI_P.data(), 13, 16, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) + ((shared->has_carehomes ? (odin_sum3<real_type>(internal.n_EI_P.data(), 18, 19, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) * static_cast<real_type>(0.25)) : 0));
    real_type new_sympt_cases_80_plus = odin_sum3<real_type>(internal.n_EI_P.data(), 16, 17, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) + ((shared->has_carehomes ? (odin_sum3<real_type>(internal.n_EI_P.data(), 18, 19, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) * static_cast<real_type>(0.75)) : 0));
    ...
    real_type delta_all_admission_20_29_conf = odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 4, 6, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) + ((shared->has_carehomes ? odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 17, 18, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) * 1 / (real_type) 8 : 0));
    real_type delta_all_admission_30_39_conf = odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 6, 8, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) + ((shared->has_carehomes ? odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 17, 18, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) * 2 / (real_type) 8 : 0));
    real_type delta_all_admission_40_49_conf = odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 8, 10, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) + ((shared->has_carehomes ? odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 17, 18, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) * 2 / (real_type) 8 : 0));
    real_type delta_all_admission_50_59_conf = odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 10, 12, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) + ((shared->has_carehomes ? odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 17, 18, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) * 2 / (real_type) 8 : 0));
    real_type delta_all_admission_60_69_conf = odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 12, 14, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) + ((shared->has_carehomes ? odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 17, 18, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) * 1 / (real_type) 8 + odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 18, 19, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) * static_cast<real_type>(0.050000000000000003) : 0));
    real_type delta_all_admission_70_79_conf = odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 14, 16, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) + ((shared->has_carehomes ? odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 18, 19, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) * static_cast<real_type>(0.20000000000000001) : 0));
    real_type delta_all_admission_80_plus_conf = odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 16, 17, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) + ((shared->has_carehomes ? odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 18, 19, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) * static_cast<real_type>(0.75) : 0));
