...
// Generated by odin.dust (version 0.2.19) - do not edit
...
typename T::real_type
  compare(const typename T::real_type * state,
    ...
    const real_type model_sympt_cases_non_variant_over25 =
      state[70];
    const real_type model_ons_pos = state[77];
    const real_type model_react_pos = state[78];
    const real_type model_react_5_24_pos = state[79];
    const real_type model_react_25_34_pos = state[80];
    const real_type model_react_35_44_pos = state[81];
    const real_type model_react_45_54_pos = state[82];
    const real_type model_react_55_64_pos = state[83];
    const real_type model_react_65_plus_pos = state[84];
...
public:
  ...
  struct shared_type {
    ...
    int dim_HFR_disag_2;
    int dim_HFR_disag_3;
    int dim_HFR_disag_weighted;
    int dim_HFR_disag_weighted_1;
    int dim_HFR_disag_weighted_12;
    int dim_HFR_disag_weighted_2;
    int dim_HFR_disag_weighted_3;
    int dim_H_D_conf;
    int dim_H_D_conf_1;
    int dim_H_D_conf_12;
    ...
    int dim_IFR_disag_2;
    int dim_IFR_disag_3;
    int dim_IFR_disag_weighted;
    int dim_IFR_disag_weighted_1;
    int dim_IFR_disag_weighted_12;
    int dim_IFR_disag_weighted_2;
    int dim_IFR_disag_weighted_3;
    int dim_IHR_disag;
    int dim_IHR_disag_1;
    int dim_IHR_disag_12;
    int dim_IHR_disag_2;
    int dim_IHR_disag_3;
    int dim_IHR_disag_weighted;
    int dim_IHR_disag_weighted_1;
    int dim_IHR_disag_weighted_12;
    int dim_IHR_disag_weighted_2;
    int dim_IHR_disag_weighted_3;
    int dim_I_A;
    int dim_I_A_1;
    int dim_I_A_12;
    int dim_I_A_123;
    ...
    int dim_out_n_RS_2;
    int dim_out_n_RS_3;
    int dim_out_n_R_progress;
    int dim_out_n_R_progress_1;
    int dim_out_n_R_progress_12;
    int dim_out_n_R_progress_2;
    int dim_out_n_R_progress_3;
    int dim_p_C;
    int dim_p_C_1;
    int dim_p_C_12;
    int dim_p_C_2;
    ...
    std::vector<real_type> initial_hfr_disag;
    ...
    std::vector<real_type> initial_out_n_RE;
    std::vector<real_type> initial_out_n_RS;
    std::vector<real_type> initial_out_n_R_progress;
  ...
  struct internal_type {
    ...
    std::vector<real_type> HFR_disag_weighted;
    std::vector<real_type> IFR_disag;
    std::vector<real_type> IFR_disag_weighted;
    std::vector<real_type> IHR_disag;
    std::vector<real_type> IHR_disag_weighted;
  ...
  std::vector<real_type> initial(size_t step) {
    ...
    state[77] = shared->initial_ons_pos;
    state[78] = shared->initial_react_pos;
    state[79] = shared->initial_react_5_24_pos;
    state[80] = shared->initial_react_25_34_pos;
    state[81] = shared->initial_react_35_44_pos;
    state[82] = shared->initial_react_45_54_pos;
    state[83] = shared->initial_react_55_64_pos;
    state[84] = shared->initial_react_65_plus_pos;
    state[85] = shared->initial_ihr;
    state[86] = shared->initial_hfr;
    state[87] = shared->initial_ifr;
    std::copy(shared->initial_cum_infections_per_strain.begin(), shared->initial_cum_infections_per_strain.end(), state.begin() + 88);
    ...
    std::copy(shared->initial_ifr_disag.begin(), shared->initial_ifr_disag.end(), state.begin() + shared->offset_variable_ifr_disag);
    std::copy(shared->initial_ihr_disag.begin(), shared->initial_ihr_disag.end(), state.begin() + shared->offset_variable_ihr_disag);
    std::copy(shared->initial_hfr_disag.begin(), shared->initial_hfr_disag.end(), state.begin() + shared->offset_variable_hfr_disag);
    std::copy(shared->initial_out_n_R_progress.begin(), shared->initial_out_n_R_progress.end(), state.begin() + shared->offset_variable_out_n_R_progress);
    std::copy(shared->initial_out_n_RS.begin(), shared->initial_out_n_RS.end(), state.begin() + shared->offset_variable_out_n_RS);
    std::copy(shared->initial_out_n_RE.begin(), shared->initial_out_n_RE.end(), state.begin() + shared->offset_variable_out_n_RE);
  ...
  void update(size_t step, const real_type * state, rng_state_type& rng_state, real_type * state_next) {
    ...
    const real_type * cum_infections_per_strain = state + 88;
    ...
    for (int i = 1; i <= shared->dim_eff_S_1; ++i) {
      for (int j = 1; j <= shared->dim_eff_S_2; ++j) {
        for (int k = 1; k <= shared->dim_eff_S_3; ++k) {
          internal.eff_S[i - 1 + shared->dim_eff_S_1 * (j - 1) + shared->dim_eff_S_12 * (k - 1)] = (shared->n_real_strains == 1 ? S[shared->dim_S_1 * (k - 1) + i - 1] * shared->rel_susceptibility[shared->dim_rel_susceptibility_12 * (k - 1) + shared->dim_rel_susceptibility_1 * (j - 1) + i - 1] : (S[shared->dim_S_1 * (k - 1) + i - 1] + (1 - shared->cross_immunity[3 - j - 1]) * (R[shared->dim_R_12 * (k - 1) + shared->dim_R_1 * 4 + i - 1] + (j == 2 ? R[shared->dim_R_12 * (k - 1) + shared->dim_R_1 * 0 + i - 1] + R[shared->dim_R_12 * (k - 1) + shared->dim_R_1 * 3 + i - 1] : 0))) * shared->rel_susceptibility[shared->dim_rel_susceptibility_12 * (k - 1) + shared->dim_rel_susceptibility_1 * (j - 1) + i - 1]);
        }
      }
    }
    ...
    for (int i = 1; i <= shared->dim_p_R5_to_E3_1; ++i) {
      for (int j = 1; j <= shared->dim_p_R5_to_E3_2; ++j) {
        internal.p_R5_to_E3[i - 1 + shared->dim_p_R5_to_E3_1 * (j - 1)] = (shared->n_strains == 1 ? 1 : (internal.lambda_susc[shared->dim_lambda_susc_12 * (j - 1) + shared->dim_lambda_susc_1 * 1 + i - 1] * (1 - shared->cross_immunity[0]) == 0 ? 0 : (internal.lambda_susc[shared->dim_lambda_susc_12 * (j - 1) + shared->dim_lambda_susc_1 * 1 + i - 1] * (1 - shared->cross_immunity[0]) / (real_type) (internal.lambda_susc[shared->dim_lambda_susc_12 * (j - 1) + shared->dim_lambda_susc_1 * 1 + i - 1] * (1 - shared->cross_immunity[0]) + internal.lambda_susc[shared->dim_lambda_susc_12 * (j - 1) + shared->dim_lambda_susc_1 * 0 + i - 1] * (1 - shared->cross_immunity[1])))));
      }
    }
    for (int i = 1; i <= shared->dim_p_RS_1; ++i) {
      for (int j = 1; j <= shared->dim_p_RS_2; ++j) {
        for (int k = 1; k <= shared->dim_p_RS_3; ++k) {
          internal.p_RS[i - 1 + shared->dim_p_RS_1 * (j - 1) + shared->dim_p_RS_12 * (k - 1)] = (shared->n_strains == 1 ? 1 : ((shared->waning_rate[i - 1] == 0 ? 0 : (j == 1 || j == 4 ? (shared->waning_rate[i - 1] / (real_type) (shared->waning_rate[i - 1] + internal.lambda_susc[shared->dim_lambda_susc_12 * (k - 1) + shared->dim_lambda_susc_1 * 1 + i - 1] * (1 - shared->cross_immunity[0]))) : (j == 5 ? (shared->waning_rate[i - 1] / (real_type) (shared->waning_rate[i - 1] + internal.lambda_susc[shared->dim_lambda_susc_12 * (k - 1) + shared->dim_lambda_susc_1 * 1 + i - 1] * (1 - shared->cross_immunity[0]) + internal.lambda_susc[shared->dim_lambda_susc_12 * (k - 1) + shared->dim_lambda_susc_1 * 0 + i - 1] * (1 - shared->cross_immunity[1]))) : 1)))));
        }
      }
    }
    ...
    for (int i = 1; i <= shared->dim_rate_R_progress_1; ++i) {
      for (int j = 1; j <= shared->dim_rate_R_progress_2; ++j) {
        for (int k = 1; k <= shared->dim_rate_R_progress_3; ++k) {
          internal.rate_R_progress[i - 1 + shared->dim_rate_R_progress_1 * (j - 1) + shared->dim_rate_R_progress_12 * (k - 1)] = shared->waning_rate[i - 1] + (shared->n_strains == 1 ? 0 : (j == 1 || j == 4 ? internal.lambda_susc[shared->dim_lambda_susc_12 * (k - 1) + shared->dim_lambda_susc_1 * 1 + i - 1] * (1 - shared->cross_immunity[0]) : (j == 5 ? (internal.lambda_susc[shared->dim_lambda_susc_12 * (k - 1) + shared->dim_lambda_susc_1 * 1 + i - 1] * (1 - shared->cross_immunity[0]) + internal.lambda_susc[shared->dim_lambda_susc_12 * (k - 1) + shared->dim_lambda_susc_1 * 0 + i - 1] * (1 - shared->cross_immunity[1])) : 0)));
        }
      }
    }
    ...
    for (int i = 1; i <= shared->dim_HFR_disag_weighted_1; ++i) {
      for (int j = 1; j <= shared->dim_HFR_disag_weighted_2; ++j) {
        for (int k = 1; k <= shared->dim_HFR_disag_weighted_3; ++k) {
          internal.HFR_disag_weighted[i - 1 + shared->dim_HFR_disag_weighted_1 * (j - 1) + shared->dim_HFR_disag_weighted_12 * (k - 1)] = internal.HFR_disag[shared->dim_HFR_disag_12 * (k - 1) + shared->dim_HFR_disag_1 * (j - 1) + i - 1] * internal.n_I_C_2_to_hosp[shared->dim_n_I_C_2_to_hosp_12 * (k - 1) + shared->dim_n_I_C_2_to_hosp_1 * (j - 1) + i - 1];
        }
      }
    }
    ...
    state_next[86] = odin_sum1<real_type>(internal.HFR_disag_weighted.data(), 0, shared->dim_HFR_disag_weighted) / (real_type) odin_sum1<real_type>(internal.n_I_C_2_to_hosp.data(), 0, shared->dim_n_I_C_2_to_hosp);
    for (int i = 1; i <= shared->dim_hfr_age; ++i) {
      state_next[shared->offset_variable_hfr_age + i - 1] = odin_sum3<real_type>(internal.HFR_disag_weighted.data(), i - 1, i, 0, shared->dim_HFR_disag_weighted_2, 0, shared->dim_HFR_disag_weighted_3, shared->dim_HFR_disag_weighted_1, shared->dim_HFR_disag_weighted_12) / (real_type) odin_sum3<real_type>(internal.n_I_C_2_to_hosp.data(), i - 1, i, 0, shared->dim_n_I_C_2_to_hosp_2, 0, shared->dim_n_I_C_2_to_hosp_3, shared->dim_n_I_C_2_to_hosp_1, shared->dim_n_I_C_2_to_hosp_12);
    }
    for (int i = 1; i <= shared->dim_hfr_disag_1; ++i) {
      for (int j = 1; j <= shared->dim_hfr_disag_2; ++j) {
        state_next[shared->offset_variable_hfr_disag + i - 1 + shared->dim_hfr_disag_1 * (j - 1)] = odin_sum3<real_type>(internal.HFR_disag_weighted.data(), i - 1, i, 0, shared->dim_HFR_disag_weighted_2, j - 1, j, shared->dim_HFR_disag_weighted_1, shared->dim_HFR_disag_weighted_12) / (real_type) odin_sum3<real_type>(internal.n_I_C_2_to_hosp.data(), i - 1, i, 0, shared->dim_n_I_C_2_to_hosp_2, j - 1, j, shared->dim_n_I_C_2_to_hosp_1, shared->dim_n_I_C_2_to_hosp_12);
      }
    }
    ...
    for (int i = 1; i <= shared->dim_out_n_R_progress_1; ++i) {
      for (int j = 1; j <= shared->dim_out_n_R_progress_2; ++j) {
        for (int k = 1; k <= shared->dim_out_n_R_progress_3; ++k) {
          state_next[shared->offset_variable_out_n_R_progress + i - 1 + shared->dim_out_n_R_progress_1 * (j - 1) + shared->dim_out_n_R_progress_12 * (k - 1)] = internal.n_R_progress[shared->dim_n_R_progress_12 * (k - 1) + shared->dim_n_R_progress_1 * (j - 1) + i - 1];
        }
      }
    }
    ...
    for (int i = 1; i <= shared->dim_out_n_RS_1; ++i) {
      for (int j = 1; j <= shared->dim_out_n_RS_2; ++j) {
        for (int k = 1; k <= shared->dim_out_n_RS_3; ++k) {
          state_next[shared->offset_variable_out_n_RS + i - 1 + shared->dim_out_n_RS_1 * (j - 1) + shared->dim_out_n_RS_12 * (k - 1)] = internal.n_RS[shared->dim_n_RS_12 * (k - 1) + shared->dim_n_RS_1 * (j - 1) + i - 1];
        }
      }
    }
    ...
    for (int i = 1; i <= shared->dim_delta_infections_per_strain; ++i) {
      internal.delta_infections_per_strain[i - 1] = odin_sum3<real_type>(internal.n_S_progress.data(), 0, shared->dim_n_S_progress_1, i - 1, i, 0, shared->dim_n_S_progress_3, shared->dim_n_S_progress_1, shared->dim_n_S_progress_12) + ((i > 2 ? (odin_sum3<real_type>(internal.n_RE.data(), 0, shared->dim_n_RE_1, i - 1, i, 0, shared->dim_n_RE_3, shared->dim_n_RE_1, shared->dim_n_RE_12)) : 0));
    }
    ...
    for (int i = 1; i <= shared->dim_out_n_RE_1; ++i) {
      for (int j = 1; j <= shared->dim_out_n_RE_2; ++j) {
        for (int k = 1; k <= shared->dim_out_n_RE_3; ++k) {
          state_next[shared->offset_variable_out_n_RE + i - 1 + shared->dim_out_n_RE_1 * (j - 1) + shared->dim_out_n_RE_12 * (k - 1)] = internal.n_RE[shared->dim_n_RE_12 * (k - 1) + shared->dim_n_RE_1 * (j - 1) + i - 1];
        }
      }
    }
    for (int i = 1; i <= shared->dim_IFR_disag_weighted_1; ++i) {
      for (int j = 1; j <= shared->dim_IFR_disag_weighted_2; ++j) {
        for (int k = 1; k <= shared->dim_IFR_disag_weighted_3; ++k) {
          internal.IFR_disag_weighted[i - 1 + shared->dim_IFR_disag_weighted_1 * (j - 1) + shared->dim_IFR_disag_weighted_12 * (k - 1)] = internal.IFR_disag[shared->dim_IFR_disag_12 * (k - 1) + shared->dim_IFR_disag_1 * (j - 1) + i - 1] * internal.new_inf[shared->dim_new_inf_12 * (k - 1) + shared->dim_new_inf_1 * (j - 1) + i - 1];
        }
      }
    }
    for (int i = 1; i <= shared->dim_IHR_disag_weighted_1; ++i) {
      for (int j = 1; j <= shared->dim_IHR_disag_weighted_2; ++j) {
        for (int k = 1; k <= shared->dim_IHR_disag_weighted_3; ++k) {
          internal.IHR_disag_weighted[i - 1 + shared->dim_IHR_disag_weighted_1 * (j - 1) + shared->dim_IHR_disag_weighted_12 * (k - 1)] = internal.IHR_disag[shared->dim_IHR_disag_12 * (k - 1) + shared->dim_IHR_disag_1 * (j - 1) + i - 1] * internal.new_inf[shared->dim_new_inf_12 * (k - 1) + shared->dim_new_inf_1 * (j - 1) + i - 1];
        }
      }
    }
    ...
    for (int i = 1; i <= shared->dim_cum_infections_per_strain; ++i) {
      state_next[88 + i - 1] = cum_infections_per_strain[i - 1] + internal.delta_infections_per_strain[i - 1];
    }
    ...
    state_next[79] = odin_sum4<real_type>(internal.new_T_PCR_pos.data(), 1, 5, 0, shared->dim_new_T_PCR_pos_2, 0, shared->dim_new_T_PCR_pos_3, 0, shared->dim_new_T_PCR_pos_4, shared->dim_new_T_PCR_pos_1, shared->dim_new_T_PCR_pos_12, shared->dim_new_T_PCR_pos_123);
    state_next[84] = odin_sum4<real_type>(internal.new_T_PCR_pos.data(), 13, 17, 0, shared->dim_new_T_PCR_pos_2, 0, shared->dim_new_T_PCR_pos_3, 0, shared->dim_new_T_PCR_pos_4, shared->dim_new_T_PCR_pos_1, shared->dim_new_T_PCR_pos_12, shared->dim_new_T_PCR_pos_123);
    ...
    state_next[87] = odin_sum1<real_type>(internal.IFR_disag_weighted.data(), 0, shared->dim_IFR_disag_weighted) / (real_type) odin_sum1<real_type>(internal.new_inf.data(), 0, shared->dim_new_inf);
    ...
    for (int i = 1; i <= shared->dim_ifr_disag_1; ++i) {
      for (int j = 1; j <= shared->dim_ifr_disag_2; ++j) {
        state_next[shared->offset_variable_ifr_disag + i - 1 + shared->dim_ifr_disag_1 * (j - 1)] = odin_sum3<real_type>(internal.IFR_disag_weighted.data(), i - 1, i, 0, shared->dim_IFR_disag_weighted_2, j - 1, j, shared->dim_IFR_disag_weighted_1, shared->dim_IFR_disag_weighted_12) / (real_type) odin_sum3<real_type>(internal.new_inf.data(), i - 1, i, 0, shared->dim_new_inf_2, j - 1, j, shared->dim_new_inf_1, shared->dim_new_inf_12);
      }
    }
    for (int i = 1; i <= shared->dim_ifr_strain; ++i) {
      state_next[shared->offset_variable_ifr_strain + i - 1] = (shared->n_real_strains == 1 ? odin_sum3<real_type>(internal.IFR_disag_weighted.data(), 0, shared->dim_IFR_disag_weighted_1, 0, 1, 0, shared->dim_IFR_disag_weighted_3, shared->dim_IFR_disag_weighted_1, shared->dim_IFR_disag_weighted_12) / (real_type) odin_sum3<real_type>(internal.new_inf.data(), 0, shared->dim_new_inf_1, 0, 1, 0, shared->dim_new_inf_3, shared->dim_new_inf_1, shared->dim_new_inf_12) : (odin_sum3<real_type>(internal.IFR_disag_weighted.data(), 0, shared->dim_IFR_disag_weighted_1, i - 1, i, 0, shared->dim_IFR_disag_weighted_3, shared->dim_IFR_disag_weighted_1, shared->dim_IFR_disag_weighted_12) + odin_sum3<real_type>(internal.IFR_disag_weighted.data(), 0, shared->dim_IFR_disag_weighted_1, 5 - i - 1, 5 - i, 0, shared->dim_IFR_disag_weighted_3, shared->dim_IFR_disag_weighted_1, shared->dim_IFR_disag_weighted_12)) / (real_type) (odin_sum3<real_type>(internal.new_inf.data(), 0, shared->dim_new_inf_1, i - 1, i, 0, shared->dim_new_inf_3, shared->dim_new_inf_1, shared->dim_new_inf_12) + odin_sum3<real_type>(internal.new_inf.data(), 0, shared->dim_new_inf_1, 5 - i - 1, 5 - i, 0, shared->dim_new_inf_3, shared->dim_new_inf_1, shared->dim_new_inf_12)));
    }
    state_next[85] = odin_sum1<real_type>(internal.IHR_disag_weighted.data(), 0, shared->dim_IHR_disag_weighted) / (real_type) odin_sum1<real_type>(internal.new_inf.data(), 0, shared->dim_new_inf);
    for (int i = 1; i <= shared->dim_ihr_age; ++i) {
      state_next[shared->offset_variable_ihr_age + i - 1] = odin_sum3<real_type>(internal.IHR_disag_weighted.data(), i - 1, i, 0, shared->dim_IHR_disag_weighted_2, 0, shared->dim_IHR_disag_weighted_3, shared->dim_IHR_disag_weighted_1, shared->dim_IHR_disag_weighted_12) / (real_type) odin_sum3<real_type>(internal.new_inf.data(), i - 1, i, 0, shared->dim_new_inf_2, 0, shared->dim_new_inf_3, shared->dim_new_inf_1, shared->dim_new_inf_12);
    }
    for (int i = 1; i <= shared->dim_ihr_disag_1; ++i) {
      for (int j = 1; j <= shared->dim_ihr_disag_2; ++j) {
        state_next[shared->offset_variable_ihr_disag + i - 1 + shared->dim_ihr_disag_1 * (j - 1)] = odin_sum3<real_type>(internal.IHR_disag_weighted.data(), i - 1, i, 0, shared->dim_IHR_disag_weighted_2, j - 1, j, shared->dim_IHR_disag_weighted_1, shared->dim_IHR_disag_weighted_12) / (real_type) odin_sum3<real_type>(internal.new_inf.data(), i - 1, i, 0, shared->dim_new_inf_2, j - 1, j, shared->dim_new_inf_1, shared->dim_new_inf_12);
      }
    }
...
dust::pars_type<lancelot> dust_pars<lancelot>(cpp11::list user) {
  ...
  shared->initial_hfr = 0;
  shared->initial_hosp_tot = 0;
  shared->initial_ifr = 0;
  shared->initial_ihr = 0;
  ...
  shared->dim_HFR_disag_weighted_1 = shared->n_groups;
  shared->dim_HFR_disag_weighted_2 = shared->n_strains;
  shared->dim_HFR_disag_weighted_3 = shared->n_vacc_classes;
  ...
  shared->dim_IFR_disag_weighted_1 = shared->n_groups;
  shared->dim_IFR_disag_weighted_2 = shared->n_strains;
  shared->dim_IFR_disag_weighted_3 = shared->n_vacc_classes;
  ...
  shared->dim_IHR_disag_weighted_1 = shared->n_groups;
  shared->dim_IHR_disag_weighted_2 = shared->n_strains;
  shared->dim_IHR_disag_weighted_3 = shared->n_vacc_classes;
  ...
  shared->dim_out_n_RE_1 = shared->n_groups;
  shared->dim_out_n_RE_2 = shared->n_strains;
  shared->dim_out_n_RE_3 = shared->n_vacc_classes;
  shared->dim_out_n_RS_1 = shared->n_groups;
  shared->dim_out_n_RS_2 = shared->n_strains_R;
  shared->dim_out_n_RS_3 = shared->n_vacc_classes;
  shared->dim_out_n_R_progress_1 = shared->n_groups;
  shared->dim_out_n_R_progress_2 = shared->n_strains_R;
  shared->dim_out_n_R_progress_3 = shared->n_vacc_classes;
  ...
  shared->dim_HFR_disag_weighted = shared->dim_HFR_disag_weighted_1 * shared->dim_HFR_disag_weighted_2 * shared->dim_HFR_disag_weighted_3;
  shared->dim_HFR_disag_weighted_12 = shared->dim_HFR_disag_weighted_1 * shared->dim_HFR_disag_weighted_2;
  ...
  shared->dim_IFR_disag_weighted = shared->dim_IFR_disag_weighted_1 * shared->dim_IFR_disag_weighted_2 * shared->dim_IFR_disag_weighted_3;
  shared->dim_IFR_disag_weighted_12 = shared->dim_IFR_disag_weighted_1 * shared->dim_IFR_disag_weighted_2;
  ...
  shared->dim_IHR_disag_weighted = shared->dim_IHR_disag_weighted_1 * shared->dim_IHR_disag_weighted_2 * shared->dim_IHR_disag_weighted_3;
  shared->dim_IHR_disag_weighted_12 = shared->dim_IHR_disag_weighted_1 * shared->dim_IHR_disag_weighted_2;
  ...
  shared->dim_hfr_disag = shared->dim_hfr_disag_1 * shared->dim_hfr_disag_2;
  ...
  shared->dim_ihr_disag = shared->dim_ihr_disag_1 * shared->dim_ihr_disag_2;
  ...
  shared->dim_new_inf = shared->dim_new_inf_1 * shared->dim_new_inf_2 * shared->dim_new_inf_3;
  shared->dim_new_inf_12 = shared->dim_new_inf_1 * shared->dim_new_inf_2;
  shared->dim_out_n_RE = shared->dim_out_n_RE_1 * shared->dim_out_n_RE_2 * shared->dim_out_n_RE_3;
  shared->dim_out_n_RE_12 = shared->dim_out_n_RE_1 * shared->dim_out_n_RE_2;
  shared->dim_out_n_RS = shared->dim_out_n_RS_1 * shared->dim_out_n_RS_2 * shared->dim_out_n_RS_3;
  shared->dim_out_n_RS_12 = shared->dim_out_n_RS_1 * shared->dim_out_n_RS_2;
  shared->dim_out_n_R_progress = shared->dim_out_n_R_progress_1 * shared->dim_out_n_R_progress_2 * shared->dim_out_n_R_progress_3;
  shared->dim_out_n_R_progress_12 = shared->dim_out_n_R_progress_1 * shared->dim_out_n_R_progress_2;
  ...
  for (int i = 1; i <= shared->dim_hfr_age; ++i) {
    shared->initial_hfr_age[i - 1] = 0;
  }
  for (int i = 1; i <= shared->dim_ifr_age; ++i) {
    shared->initial_ifr_age[i - 1] = 0;
  }
  for (int i = 1; i <= shared->dim_ihr_age; ++i) {
    shared->initial_ihr_age[i - 1] = 0;
  }
  for (int i = 1; i <= shared->dim_infections_inc_per_strain; ++i) {
    shared->initial_infections_inc_per_strain[i - 1] = 0;
  }
  shared->offset_variable_D_hosp = shared->dim_cum_infections_per_strain + shared->dim_infections_inc_per_strain + 88;
  shared->offset_variable_D_non_hosp = shared->dim_D_hosp + shared->dim_cum_infections_per_strain + shared->dim_infections_inc_per_strain + 88;
  shared->offset_variable_N_tot = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_infections_inc_per_strain + 88;
  shared->offset_variable_cum_admit_by_age = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_cum_infections_per_strain + shared->dim_infections_inc_per_strain + 88;
  shared->offset_variable_infections_inc_per_strain = shared->dim_cum_infections_per_strain + 88;
  shared->offset_variable_prob_strain = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_infections_inc_per_strain + 88;
  ...
  internal.HFR_disag_weighted = std::vector<real_type>(shared->dim_HFR_disag_weighted);
  internal.IFR_disag = std::vector<real_type>(shared->dim_IFR_disag);
  internal.IFR_disag_weighted = std::vector<real_type>(shared->dim_IFR_disag_weighted);
  internal.IHR_disag = std::vector<real_type>(shared->dim_IHR_disag);
  internal.IHR_disag_weighted = std::vector<real_type>(shared->dim_IHR_disag_weighted);
  ...
  shared->initial_hfr_disag = std::vector<real_type>(shared->dim_hfr_disag);
  shared->initial_hfr_strain = std::vector<real_type>(shared->dim_hfr_strain);
  shared->initial_ifr_disag = std::vector<real_type>(shared->dim_ifr_disag);
  shared->initial_ifr_strain = std::vector<real_type>(shared->dim_ifr_strain);
  shared->initial_ihr_disag = std::vector<real_type>(shared->dim_ihr_disag);
  shared->initial_ihr_strain = std::vector<real_type>(shared->dim_ihr_strain);
  shared->initial_out_n_RE = std::vector<real_type>(shared->dim_out_n_RE);
  shared->initial_out_n_RS = std::vector<real_type>(shared->dim_out_n_RS);
  shared->initial_out_n_R_progress = std::vector<real_type>(shared->dim_out_n_R_progress);
  ...
  internal.new_inf = std::vector<real_type>(shared->dim_new_inf);
  ...
  for (int i = 1; i <= shared->dim_hfr_disag_1; ++i) {
    for (int j = 1; j <= shared->dim_hfr_disag_2; ++j) {
      shared->initial_hfr_disag[i - 1 + shared->dim_hfr_disag_1 * (j - 1)] = 0;
    }
  }
  for (int i = 1; i <= shared->dim_hfr_strain; ++i) {
    shared->initial_hfr_strain[i - 1] = 0;
  }
  for (int i = 1; i <= shared->dim_ifr_disag_1; ++i) {
    for (int j = 1; j <= shared->dim_ifr_disag_2; ++j) {
      shared->initial_ifr_disag[i - 1 + shared->dim_ifr_disag_1 * (j - 1)] = 0;
    }
  }
  for (int i = 1; i <= shared->dim_ifr_strain; ++i) {
    shared->initial_ifr_strain[i - 1] = 0;
  }
  for (int i = 1; i <= shared->dim_ihr_disag_1; ++i) {
    for (int j = 1; j <= shared->dim_ihr_disag_2; ++j) {
      shared->initial_ihr_disag[i - 1 + shared->dim_ihr_disag_1 * (j - 1)] = 0;
    }
  }
  for (int i = 1; i <= shared->dim_ihr_strain; ++i) {
    shared->initial_ihr_strain[i - 1] = 0;
  }
  for (int i = 1; i <= shared->dim_out_n_RE_1; ++i) {
    for (int j = 1; j <= shared->dim_out_n_RE_2; ++j) {
      for (int k = 1; k <= shared->dim_out_n_RE_3; ++k) {
        shared->initial_out_n_RE[i - 1 + shared->dim_out_n_RE_1 * (j - 1) + shared->dim_out_n_RE_12 * (k - 1)] = 0;
      }
    }
  }
  for (int i = 1; i <= shared->dim_out_n_RS_1; ++i) {
    for (int j = 1; j <= shared->dim_out_n_RS_2; ++j) {
      for (int k = 1; k <= shared->dim_out_n_RS_3; ++k) {
        shared->initial_out_n_RS[i - 1 + shared->dim_out_n_RS_1 * (j - 1) + shared->dim_out_n_RS_12 * (k - 1)] = 0;
      }
    }
  }
  for (int i = 1; i <= shared->dim_out_n_R_progress_1; ++i) {
    for (int j = 1; j <= shared->dim_out_n_R_progress_2; ++j) {
      for (int k = 1; k <= shared->dim_out_n_R_progress_3; ++k) {
        shared->initial_out_n_R_progress[i - 1 + shared->dim_out_n_R_progress_1 * (j - 1) + shared->dim_out_n_R_progress_12 * (k - 1)] = 0;
      }
    }
  }
  ...
  shared->offset_variable_D = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vacc_skip + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_effective_susceptible + shared->dim_hfr_age + shared->dim_hfr_strain + shared->dim_ifr_age + shared->dim_ifr_strain + shared->dim_ihr_age + shared->dim_ihr_strain + shared->dim_infections_inc_per_strain + shared->dim_prob_strain + 88;
  ...
  shared->offset_variable_cum_n_I_A_vacc_skip = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vaccinated + shared->dim_effective_susceptible + shared->dim_hfr_age + shared->dim_hfr_strain + shared->dim_ifr_age + shared->dim_ifr_strain + shared->dim_ihr_age + shared->dim_ihr_strain + shared->dim_infections_inc_per_strain + shared->dim_prob_strain + 88;
  shared->offset_variable_cum_n_I_A_vaccinated = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_S_vaccinated + shared->dim_effective_susceptible + shared->dim_hfr_age + shared->dim_hfr_strain + shared->dim_ifr_age + shared->dim_ifr_strain + shared->dim_ihr_age + shared->dim_ihr_strain + shared->dim_infections_inc_per_strain + shared->dim_prob_strain + 88;
  ...
  shared->offset_variable_effective_susceptible = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_infections_inc_per_strain + shared->dim_prob_strain + 88;
  shared->offset_variable_hfr_age = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_effective_susceptible + shared->dim_hfr_strain + shared->dim_ifr_age + shared->dim_ifr_strain + shared->dim_ihr_age + shared->dim_ihr_strain + shared->dim_infections_inc_per_strain + shared->dim_prob_strain + 88;
  shared->offset_variable_hfr_disag = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_S + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vacc_skip + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_effective_susceptible + shared->dim_hfr_age + shared->dim_hfr_strain + shared->dim_ifr_age + shared->dim_ifr_disag + shared->dim_ifr_strain + shared->dim_ihr_age + shared->dim_ihr_disag + shared->dim_ihr_strain + shared->dim_infections_inc_per_strain + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 88;
  shared->offset_variable_hfr_strain = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_effective_susceptible + shared->dim_ifr_strain + shared->dim_ihr_strain + shared->dim_infections_inc_per_strain + shared->dim_prob_strain + 88;
  shared->offset_variable_ifr_age = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_effective_susceptible + shared->dim_hfr_strain + shared->dim_ifr_strain + shared->dim_ihr_strain + shared->dim_infections_inc_per_strain + shared->dim_prob_strain + 88;
  shared->offset_variable_ifr_disag = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_S + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vacc_skip + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_effective_susceptible + shared->dim_hfr_age + shared->dim_hfr_strain + shared->dim_ifr_age + shared->dim_ifr_strain + shared->dim_ihr_age + shared->dim_ihr_strain + shared->dim_infections_inc_per_strain + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 88;
  shared->offset_variable_ifr_strain = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_effective_susceptible + shared->dim_infections_inc_per_strain + shared->dim_prob_strain + 88;
  shared->offset_variable_ihr_age = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_effective_susceptible + shared->dim_hfr_strain + shared->dim_ifr_age + shared->dim_ifr_strain + shared->dim_ihr_strain + shared->dim_infections_inc_per_strain + shared->dim_prob_strain + 88;
  shared->offset_variable_ihr_disag = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_S + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vacc_skip + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_effective_susceptible + shared->dim_hfr_age + shared->dim_hfr_strain + shared->dim_ifr_age + shared->dim_ifr_disag + shared->dim_ifr_strain + shared->dim_ihr_age + shared->dim_ihr_strain + shared->dim_infections_inc_per_strain + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 88;
  shared->offset_variable_ihr_strain = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_effective_susceptible + shared->dim_ifr_strain + shared->dim_infections_inc_per_strain + shared->dim_prob_strain + 88;
  shared->offset_variable_out_n_RE = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_S + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vacc_skip + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_effective_susceptible + shared->dim_hfr_age + shared->dim_hfr_disag + shared->dim_hfr_strain + shared->dim_ifr_age + shared->dim_ifr_disag + shared->dim_ifr_strain + shared->dim_ihr_age + shared->dim_ihr_disag + shared->dim_ihr_strain + shared->dim_infections_inc_per_strain + shared->dim_out_n_RS + shared->dim_out_n_R_progress + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 88;
  shared->offset_variable_out_n_RS = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_S + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vacc_skip + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_effective_susceptible + shared->dim_hfr_age + shared->dim_hfr_disag + shared->dim_hfr_strain + shared->dim_ifr_age + shared->dim_ifr_disag + shared->dim_ifr_strain + shared->dim_ihr_age + shared->dim_ihr_disag + shared->dim_ihr_strain + shared->dim_infections_inc_per_strain + shared->dim_out_n_R_progress + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 88;
  shared->offset_variable_out_n_R_progress = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_S + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vacc_skip + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_effective_susceptible + shared->dim_hfr_age + shared->dim_hfr_disag + shared->dim_hfr_strain + shared->dim_ifr_age + shared->dim_ifr_disag + shared->dim_ifr_strain + shared->dim_ihr_age + shared->dim_ihr_disag + shared->dim_ihr_strain + shared->dim_infections_inc_per_strain + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_tmp_vaccine_probability + shared->dim_vaccine_missed_doses + 88;
  shared->offset_variable_tmp_vaccine_n_candidates = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_S + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vacc_skip + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_effective_susceptible + shared->dim_hfr_age + shared->dim_hfr_strain + shared->dim_ifr_age + shared->dim_ifr_strain + shared->dim_ihr_age + shared->dim_ihr_strain + shared->dim_infections_inc_per_strain + shared->dim_prob_strain + shared->dim_vaccine_missed_doses + 88;
  shared->offset_variable_tmp_vaccine_probability = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_S + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vacc_skip + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_effective_susceptible + shared->dim_hfr_age + shared->dim_hfr_strain + shared->dim_ifr_age + shared->dim_ifr_strain + shared->dim_ihr_age + shared->dim_ihr_strain + shared->dim_infections_inc_per_strain + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_vaccine_missed_doses + 88;
...
cpp11::sexp dust_info<lancelot>(const dust::pars_type<lancelot>& pars) {
  ...
  dim[88] = cpp11::writable::integers({shared->dim_cum_infections_per_strain});
  dim[89] = cpp11::writable::integers({shared->dim_infections_inc_per_strain});
  dim[90] = cpp11::writable::integers({shared->dim_D_hosp});
  dim[91] = cpp11::writable::integers({shared->dim_D_non_hosp});
  dim[92] = cpp11::writable::integers({shared->dim_cum_admit_by_age});
  dim[93] = cpp11::writable::integers({shared->dim_N_tot});
  dim[94] = cpp11::writable::integers({shared->dim_prob_strain});
  dim[95] = cpp11::writable::integers({shared->dim_effective_susceptible});
  dim[96] = cpp11::writable::integers({shared->dim_ifr_strain});
  dim[97] = cpp11::writable::integers({shared->dim_ihr_strain});
  dim[98] = cpp11::writable::integers({shared->dim_hfr_strain});
  dim[99] = cpp11::writable::integers({shared->dim_ifr_age});
  dim[100] = cpp11::writable::integers({shared->dim_ihr_age});
  dim[101] = cpp11::writable::integers({shared->dim_hfr_age});
  dim[102] = cpp11::writable::integers({shared->dim_cum_n_S_vaccinated_1, shared->dim_cum_n_S_vaccinated_2});
  dim[103] = cpp11::writable::integers({shared->dim_cum_n_E_vaccinated_1, shared->dim_cum_n_E_vaccinated_2});
  dim[104] = cpp11::writable::integers({shared->dim_cum_n_I_A_vaccinated_1, shared->dim_cum_n_I_A_vaccinated_2});
  dim[105] = cpp11::writable::integers({shared->dim_cum_n_I_P_vaccinated_1, shared->dim_cum_n_I_P_vaccinated_2});
  dim[106] = cpp11::writable::integers({shared->dim_cum_n_R_vaccinated_1, shared->dim_cum_n_R_vaccinated_2});
  dim[107] = cpp11::writable::integers({shared->dim_cum_n_vaccinated_1, shared->dim_cum_n_vaccinated_2});
  dim[108] = cpp11::writable::integers({shared->dim_cum_n_S_vacc_skip_1, shared->dim_cum_n_S_vacc_skip_2});
  dim[109] = cpp11::writable::integers({shared->dim_cum_n_E_vacc_skip_1, shared->dim_cum_n_E_vacc_skip_2});
  dim[110] = cpp11::writable::integers({shared->dim_cum_n_I_A_vacc_skip_1, shared->dim_cum_n_I_A_vacc_skip_2});
  dim[111] = cpp11::writable::integers({shared->dim_cum_n_I_P_vacc_skip_1, shared->dim_cum_n_I_P_vacc_skip_2});
  dim[112] = cpp11::writable::integers({shared->dim_cum_n_R_vacc_skip_1, shared->dim_cum_n_R_vacc_skip_2});
  dim[113] = cpp11::writable::integers({shared->dim_cum_n_vacc_skip_1, shared->dim_cum_n_vacc_skip_2});
  dim[114] = cpp11::writable::integers({shared->dim_diagnoses_admitted_1, shared->dim_diagnoses_admitted_2});
  dim[115] = cpp11::writable::integers({shared->dim_cum_infections_disag_1, shared->dim_cum_infections_disag_2});
  dim[116] = cpp11::writable::integers({shared->dim_D_1, shared->dim_D_2});
  dim[117] = cpp11::writable::integers({shared->dim_S_1, shared->dim_S_2});
  dim[118] = cpp11::writable::integers({shared->dim_vaccine_missed_doses_1, shared->dim_vaccine_missed_doses_2});
  dim[119] = cpp11::writable::integers({shared->dim_tmp_vaccine_n_candidates_1, shared->dim_tmp_vaccine_n_candidates_2});
  dim[120] = cpp11::writable::integers({shared->dim_tmp_vaccine_probability_1, shared->dim_tmp_vaccine_probability_2});
  dim[121] = cpp11::writable::integers({shared->dim_ifr_disag_1, shared->dim_ifr_disag_2});
  dim[122] = cpp11::writable::integers({shared->dim_ihr_disag_1, shared->dim_ihr_disag_2});
  dim[123] = cpp11::writable::integers({shared->dim_hfr_disag_1, shared->dim_hfr_disag_2});
  dim[124] = cpp11::writable::integers({shared->dim_out_n_R_progress_1, shared->dim_out_n_R_progress_2, shared->dim_out_n_R_progress_3});
  dim[125] = cpp11::writable::integers({shared->dim_out_n_RS_1, shared->dim_out_n_RS_2, shared->dim_out_n_RS_3});
  dim[126] = cpp11::writable::integers({shared->dim_out_n_RE_1, shared->dim_out_n_RE_2, shared->dim_out_n_RE_3});
  dim[127] = cpp11::writable::integers({shared->dim_T_sero_neg_1_1, shared->dim_T_sero_neg_1_2, shared->dim_T_sero_neg_1_3});
  dim[128] = cpp11::writable::integers({shared->dim_T_sero_neg_2_1, shared->dim_T_sero_neg_2_2, shared->dim_T_sero_neg_2_3});
  dim[129] = cpp11::writable::integers({shared->dim_R_1, shared->dim_R_2, shared->dim_R_3});
  dim[130] = cpp11::writable::integers({shared->dim_T_PCR_neg_1, shared->dim_T_PCR_neg_2, shared->dim_T_PCR_neg_3});
  dim[131] = cpp11::writable::integers({shared->dim_I_weighted_1, shared->dim_I_weighted_2, shared->dim_I_weighted_3});
  dim[132] = cpp11::writable::integers({shared->dim_E_1, shared->dim_E_2, shared->dim_E_3, shared->dim_E_4});
  dim[133] = cpp11::writable::integers({shared->dim_I_A_1, shared->dim_I_A_2, shared->dim_I_A_3, shared->dim_I_A_4});
  dim[134] = cpp11::writable::integers({shared->dim_I_P_1, shared->dim_I_P_2, shared->dim_I_P_3, shared->dim_I_P_4});
  dim[135] = cpp11::writable::integers({shared->dim_I_C_1_1, shared->dim_I_C_1_2, shared->dim_I_C_1_3, shared->dim_I_C_1_4});
  dim[136] = cpp11::writable::integers({shared->dim_I_C_2_1, shared->dim_I_C_2_2, shared->dim_I_C_2_3, shared->dim_I_C_2_4});
  dim[137] = cpp11::writable::integers({shared->dim_G_D_1, shared->dim_G_D_2, shared->dim_G_D_3, shared->dim_G_D_4});
  dim[138] = cpp11::writable::integers({shared->dim_ICU_pre_unconf_1, shared->dim_ICU_pre_unconf_2, shared->dim_ICU_pre_unconf_3, shared->dim_ICU_pre_unconf_4});
  dim[139] = cpp11::writable::integers({shared->dim_ICU_pre_conf_1, shared->dim_ICU_pre_conf_2, shared->dim_ICU_pre_conf_3, shared->dim_ICU_pre_conf_4});
  dim[140] = cpp11::writable::integers({shared->dim_H_R_unconf_1, shared->dim_H_R_unconf_2, shared->dim_H_R_unconf_3, shared->dim_H_R_unconf_4});
  dim[141] = cpp11::writable::integers({shared->dim_H_R_conf_1, shared->dim_H_R_conf_2, shared->dim_H_R_conf_3, shared->dim_H_R_conf_4});
  dim[142] = cpp11::writable::integers({shared->dim_H_D_unconf_1, shared->dim_H_D_unconf_2, shared->dim_H_D_unconf_3, shared->dim_H_D_unconf_4});
  dim[143] = cpp11::writable::integers({shared->dim_H_D_conf_1, shared->dim_H_D_conf_2, shared->dim_H_D_conf_3, shared->dim_H_D_conf_4});
  dim[144] = cpp11::writable::integers({shared->dim_ICU_W_R_unconf_1, shared->dim_ICU_W_R_unconf_2, shared->dim_ICU_W_R_unconf_3, shared->dim_ICU_W_R_unconf_4});
  dim[145] = cpp11::writable::integers({shared->dim_ICU_W_R_conf_1, shared->dim_ICU_W_R_conf_2, shared->dim_ICU_W_R_conf_3, shared->dim_ICU_W_R_conf_4});
  dim[146] = cpp11::writable::integers({shared->dim_ICU_W_D_unconf_1, shared->dim_ICU_W_D_unconf_2, shared->dim_ICU_W_D_unconf_3, shared->dim_ICU_W_D_unconf_4});
  dim[147] = cpp11::writable::integers({shared->dim_ICU_W_D_conf_1, shared->dim_ICU_W_D_conf_2, shared->dim_ICU_W_D_conf_3, shared->dim_ICU_W_D_conf_4});
  dim[148] = cpp11::writable::integers({shared->dim_ICU_D_unconf_1, shared->dim_ICU_D_unconf_2, shared->dim_ICU_D_unconf_3, shared->dim_ICU_D_unconf_4});
  dim[149] = cpp11::writable::integers({shared->dim_ICU_D_conf_1, shared->dim_ICU_D_conf_2, shared->dim_ICU_D_conf_3, shared->dim_ICU_D_conf_4});
  dim[150] = cpp11::writable::integers({shared->dim_W_R_unconf_1, shared->dim_W_R_unconf_2, shared->dim_W_R_unconf_3, shared->dim_W_R_unconf_4});
  dim[151] = cpp11::writable::integers({shared->dim_W_R_conf_1, shared->dim_W_R_conf_2, shared->dim_W_R_conf_3, shared->dim_W_R_conf_4});
  dim[152] = cpp11::writable::integers({shared->dim_W_D_unconf_1, shared->dim_W_D_unconf_2, shared->dim_W_D_unconf_3, shared->dim_W_D_unconf_4});
  dim[153] = cpp11::writable::integers({shared->dim_W_D_conf_1, shared->dim_W_D_conf_2, shared->dim_W_D_conf_3, shared->dim_W_D_conf_4});
  dim[154] = cpp11::writable::integers({shared->dim_T_sero_pre_1_1, shared->dim_T_sero_pre_1_2, shared->dim_T_sero_pre_1_3, shared->dim_T_sero_pre_1_4});
  dim[155] = cpp11::writable::integers({shared->dim_T_sero_pos_1_1, shared->dim_T_sero_pos_1_2, shared->dim_T_sero_pos_1_3, shared->dim_T_sero_pos_1_4});
  dim[156] = cpp11::writable::integers({shared->dim_T_sero_pre_2_1, shared->dim_T_sero_pre_2_2, shared->dim_T_sero_pre_2_3, shared->dim_T_sero_pre_2_4});
  dim[157] = cpp11::writable::integers({shared->dim_T_sero_pos_2_1, shared->dim_T_sero_pos_2_2, shared->dim_T_sero_pos_2_3, shared->dim_T_sero_pos_2_4});
  dim[158] = cpp11::writable::integers({shared->dim_T_PCR_pre_1, shared->dim_T_PCR_pre_2, shared->dim_T_PCR_pre_3, shared->dim_T_PCR_pre_4});
  dim[159] = cpp11::writable::integers({shared->dim_T_PCR_pos_1, shared->dim_T_PCR_pos_2, shared->dim_T_PCR_pos_3, shared->dim_T_PCR_pos_4});
  dim.names() = nms;
  cpp11::writable::list index(160);
  ...
  index[88] = integer_sequence(89, shared->dim_cum_infections_per_strain);
  index[89] = integer_sequence(shared->offset_variable_infections_inc_per_strain + 1, shared->dim_infections_inc_per_strain);
  index[90] = integer_sequence(shared->offset_variable_D_hosp + 1, shared->dim_D_hosp);
  index[91] = integer_sequence(shared->offset_variable_D_non_hosp + 1, shared->dim_D_non_hosp);
  index[92] = integer_sequence(shared->offset_variable_cum_admit_by_age + 1, shared->dim_cum_admit_by_age);
  index[93] = integer_sequence(shared->offset_variable_N_tot + 1, shared->dim_N_tot);
  index[94] = integer_sequence(shared->offset_variable_prob_strain + 1, shared->dim_prob_strain);
  index[95] = integer_sequence(shared->offset_variable_effective_susceptible + 1, shared->dim_effective_susceptible);
  index[96] = integer_sequence(shared->offset_variable_ifr_strain + 1, shared->dim_ifr_strain);
  index[97] = integer_sequence(shared->offset_variable_ihr_strain + 1, shared->dim_ihr_strain);
  index[98] = integer_sequence(shared->offset_variable_hfr_strain + 1, shared->dim_hfr_strain);
  index[99] = integer_sequence(shared->offset_variable_ifr_age + 1, shared->dim_ifr_age);
  index[100] = integer_sequence(shared->offset_variable_ihr_age + 1, shared->dim_ihr_age);
  index[101] = integer_sequence(shared->offset_variable_hfr_age + 1, shared->dim_hfr_age);
  index[102] = integer_sequence(shared->offset_variable_cum_n_S_vaccinated + 1, shared->dim_cum_n_S_vaccinated);
  index[103] = integer_sequence(shared->offset_variable_cum_n_E_vaccinated + 1, shared->dim_cum_n_E_vaccinated);
  index[104] = integer_sequence(shared->offset_variable_cum_n_I_A_vaccinated + 1, shared->dim_cum_n_I_A_vaccinated);
  index[105] = integer_sequence(shared->offset_variable_cum_n_I_P_vaccinated + 1, shared->dim_cum_n_I_P_vaccinated);
  index[106] = integer_sequence(shared->offset_variable_cum_n_R_vaccinated + 1, shared->dim_cum_n_R_vaccinated);
  index[107] = integer_sequence(shared->offset_variable_cum_n_vaccinated + 1, shared->dim_cum_n_vaccinated);
  index[108] = integer_sequence(shared->offset_variable_cum_n_S_vacc_skip + 1, shared->dim_cum_n_S_vacc_skip);
  index[109] = integer_sequence(shared->offset_variable_cum_n_E_vacc_skip + 1, shared->dim_cum_n_E_vacc_skip);
  index[110] = integer_sequence(shared->offset_variable_cum_n_I_A_vacc_skip + 1, shared->dim_cum_n_I_A_vacc_skip);
  index[111] = integer_sequence(shared->offset_variable_cum_n_I_P_vacc_skip + 1, shared->dim_cum_n_I_P_vacc_skip);
  index[112] = integer_sequence(shared->offset_variable_cum_n_R_vacc_skip + 1, shared->dim_cum_n_R_vacc_skip);
  index[113] = integer_sequence(shared->offset_variable_cum_n_vacc_skip + 1, shared->dim_cum_n_vacc_skip);
  index[114] = integer_sequence(shared->offset_variable_diagnoses_admitted + 1, shared->dim_diagnoses_admitted);
  index[115] = integer_sequence(shared->offset_variable_cum_infections_disag + 1, shared->dim_cum_infections_disag);
  index[116] = integer_sequence(shared->offset_variable_D + 1, shared->dim_D);
  index[117] = integer_sequence(shared->offset_variable_S + 1, shared->dim_S);
  index[118] = integer_sequence(shared->offset_variable_vaccine_missed_doses + 1, shared->dim_vaccine_missed_doses);
  index[119] = integer_sequence(shared->offset_variable_tmp_vaccine_n_candidates + 1, shared->dim_tmp_vaccine_n_candidates);
  index[120] = integer_sequence(shared->offset_variable_tmp_vaccine_probability + 1, shared->dim_tmp_vaccine_probability);
  index[121] = integer_sequence(shared->offset_variable_ifr_disag + 1, shared->dim_ifr_disag);
  index[122] = integer_sequence(shared->offset_variable_ihr_disag + 1, shared->dim_ihr_disag);
  index[123] = integer_sequence(shared->offset_variable_hfr_disag + 1, shared->dim_hfr_disag);
  index[124] = integer_sequence(shared->offset_variable_out_n_R_progress + 1, shared->dim_out_n_R_progress);
  index[125] = integer_sequence(shared->offset_variable_out_n_RS + 1, shared->dim_out_n_RS);
  index[126] = integer_sequence(shared->offset_variable_out_n_RE + 1, shared->dim_out_n_RE);
  index[127] = integer_sequence(shared->offset_variable_T_sero_neg_1 + 1, shared->dim_T_sero_neg_1);
  index[128] = integer_sequence(shared->offset_variable_T_sero_neg_2 + 1, shared->dim_T_sero_neg_2);
  index[129] = integer_sequence(shared->offset_variable_R + 1, shared->dim_R);
  index[130] = integer_sequence(shared->offset_variable_T_PCR_neg + 1, shared->dim_T_PCR_neg);
  index[131] = integer_sequence(shared->offset_variable_I_weighted + 1, shared->dim_I_weighted);
  index[132] = integer_sequence(shared->offset_variable_E + 1, shared->dim_E);
  index[133] = integer_sequence(shared->offset_variable_I_A + 1, shared->dim_I_A);
  index[134] = integer_sequence(shared->offset_variable_I_P + 1, shared->dim_I_P);
  index[135] = integer_sequence(shared->offset_variable_I_C_1 + 1, shared->dim_I_C_1);
  index[136] = integer_sequence(shared->offset_variable_I_C_2 + 1, shared->dim_I_C_2);
  index[137] = integer_sequence(shared->offset_variable_G_D + 1, shared->dim_G_D);
  index[138] = integer_sequence(shared->offset_variable_ICU_pre_unconf + 1, shared->dim_ICU_pre_unconf);
  index[139] = integer_sequence(shared->offset_variable_ICU_pre_conf + 1, shared->dim_ICU_pre_conf);
  index[140] = integer_sequence(shared->offset_variable_H_R_unconf + 1, shared->dim_H_R_unconf);
  index[141] = integer_sequence(shared->offset_variable_H_R_conf + 1, shared->dim_H_R_conf);
  index[142] = integer_sequence(shared->offset_variable_H_D_unconf + 1, shared->dim_H_D_unconf);
  index[143] = integer_sequence(shared->offset_variable_H_D_conf + 1, shared->dim_H_D_conf);
  index[144] = integer_sequence(shared->offset_variable_ICU_W_R_unconf + 1, shared->dim_ICU_W_R_unconf);
  index[145] = integer_sequence(shared->offset_variable_ICU_W_R_conf + 1, shared->dim_ICU_W_R_conf);
  index[146] = integer_sequence(shared->offset_variable_ICU_W_D_unconf + 1, shared->dim_ICU_W_D_unconf);
  index[147] = integer_sequence(shared->offset_variable_ICU_W_D_conf + 1, shared->dim_ICU_W_D_conf);
  index[148] = integer_sequence(shared->offset_variable_ICU_D_unconf + 1, shared->dim_ICU_D_unconf);
  index[149] = integer_sequence(shared->offset_variable_ICU_D_conf + 1, shared->dim_ICU_D_conf);
  index[150] = integer_sequence(shared->offset_variable_W_R_unconf + 1, shared->dim_W_R_unconf);
  index[151] = integer_sequence(shared->offset_variable_W_R_conf + 1, shared->dim_W_R_conf);
  index[152] = integer_sequence(shared->offset_variable_W_D_unconf + 1, shared->dim_W_D_unconf);
  index[153] = integer_sequence(shared->offset_variable_W_D_conf + 1, shared->dim_W_D_conf);
  index[154] = integer_sequence(shared->offset_variable_T_sero_pre_1 + 1, shared->dim_T_sero_pre_1);
  index[155] = integer_sequence(shared->offset_variable_T_sero_pos_1 + 1, shared->dim_T_sero_pos_1);
  index[156] = integer_sequence(shared->offset_variable_T_sero_pre_2 + 1, shared->dim_T_sero_pre_2);
  index[157] = integer_sequence(shared->offset_variable_T_sero_pos_2 + 1, shared->dim_T_sero_pos_2);
  index[158] = integer_sequence(shared->offset_variable_T_PCR_pre + 1, shared->dim_T_PCR_pre);
  index[159] = integer_sequence(shared->offset_variable_T_PCR_pos + 1, shared->dim_T_PCR_pos);
  index.names() = nms;
