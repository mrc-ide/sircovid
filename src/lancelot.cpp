...
public:
  ...
  std::vector<real_type> initial(size_t step) {
    ...
    std::copy(shared->initial_cum_infections_strain.begin(), shared->initial_cum_infections_strain.end(), state.begin() + 89);
  ...
  void update(size_t step, const real_type * state, rng_state_type& rng_state, real_type * state_next) {
    ...
    const real_type * cum_infections_strain = state + 89;
    ...
    for (int i = 1; i <= shared->dim_cum_infections_strain; ++i) {
      state_next[89 + i - 1] = cum_infections_strain[i - 1] + internal.delta_infections_strain[i - 1];
    }
...
dust::pars_type<lancelot> dust_pars<lancelot>(cpp11::list user) {
  ...
  shared->offset_variable_D_non_hosp = shared->dim_cum_infections_strain + shared->dim_hospitalisations_inc_age + shared->dim_hospitalisations_inc_strain + shared->dim_infections_inc_age + shared->dim_infections_inc_strain + 89;
  shared->offset_variable_N_tot = shared->dim_D_non_hosp + shared->dim_cum_admit_by_age + shared->dim_cum_infections_strain + shared->dim_hospitalisations_inc_age + shared->dim_hospitalisations_inc_strain + shared->dim_infections_inc_age + shared->dim_infections_inc_strain + 89;
  shared->offset_variable_cum_admit_by_age = shared->dim_D_non_hosp + shared->dim_cum_infections_strain + shared->dim_hospitalisations_inc_age + shared->dim_hospitalisations_inc_strain + shared->dim_infections_inc_age + shared->dim_infections_inc_strain + 89;
  shared->offset_variable_hospitalisations_inc_age = shared->dim_cum_infections_strain + shared->dim_hospitalisations_inc_strain + shared->dim_infections_inc_age + shared->dim_infections_inc_strain + 89;
  shared->offset_variable_hospitalisations_inc_strain = shared->dim_cum_infections_strain + shared->dim_infections_inc_age + shared->dim_infections_inc_strain + 89;
  shared->offset_variable_infections_inc_age = shared->dim_cum_infections_strain + shared->dim_infections_inc_strain + 89;
  shared->offset_variable_infections_inc_strain = shared->dim_cum_infections_strain + 89;
  shared->offset_variable_prob_strain = shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_strain + shared->dim_hospitalisations_inc_age + shared->dim_hospitalisations_inc_strain + shared->dim_infections_inc_age + shared->dim_infections_inc_strain + 89;
...
cpp11::sexp dust_info<lancelot>(const dust::pars_type<lancelot>& pars) {
  ...
  dim[89] = cpp11::writable::integers({shared->dim_cum_infections_strain});
  dim[90] = cpp11::writable::integers({shared->dim_infections_inc_strain});
  dim[91] = cpp11::writable::integers({shared->dim_infections_inc_age});
  dim[92] = cpp11::writable::integers({shared->dim_hospitalisations_inc_strain});
  dim[93] = cpp11::writable::integers({shared->dim_hospitalisations_inc_age});
  ...
  index[89] = integer_sequence(90, shared->dim_cum_infections_strain);
  index[90] = integer_sequence(shared->offset_variable_infections_inc_strain + 1, shared->dim_infections_inc_strain);
  index[91] = integer_sequence(shared->offset_variable_infections_inc_age + 1, shared->dim_infections_inc_age);
  index[92] = integer_sequence(shared->offset_variable_hospitalisations_inc_strain + 1, shared->dim_hospitalisations_inc_strain);
  index[93] = integer_sequence(shared->offset_variable_hospitalisations_inc_age + 1, shared->dim_hospitalisations_inc_age);
