...
typename T::real_type
  compare(const typename T::real_type * state,
    ...
    const real_type model_icu = state[20];
    const real_type model_general = state[21];
    const real_type model_hosp = model_icu + model_general;
    const real_type model_deaths_carehomes = state[43];
    const real_type model_deaths_comm = state[33];
    const real_type model_deaths_comm_0_49 = state[34];
    const real_type model_deaths_comm_50_54 = state[35];
    const real_type model_deaths_comm_55_59 = state[36];
    const real_type model_deaths_comm_60_64 = state[37];
    const real_type model_deaths_comm_65_69 = state[38];
    const real_type model_deaths_comm_70_74 = state[39];
    const real_type model_deaths_comm_75_79 = state[40];
    const real_type model_deaths_comm_80_plus = state[41];
    const real_type model_deaths_hosp = state[46];
    const real_type model_deaths_hosp_0_49 = state[47];
    const real_type model_deaths_hosp_50_54 = state[48];
    const real_type model_deaths_hosp_55_59 = state[49];
    const real_type model_deaths_hosp_60_64 = state[50];
    const real_type model_deaths_hosp_65_69 = state[51];
    const real_type model_deaths_hosp_70_74 = state[52];
    const real_type model_deaths_hosp_75_79 = state[53];
    const real_type model_deaths_hosp_80_plus = state[54];
    ...
    const real_type model_sero_pos_1 = state[55];
    const real_type model_sero_pos_2 = state[56];
    const real_type model_sympt_cases = state[67];
    const real_type model_sympt_cases_over25 = state[69];
    const real_type model_sympt_cases_under15 = state[71];
    const real_type model_sympt_cases_15_24 = state[72];
    const real_type model_sympt_cases_25_49 = state[73];
    const real_type model_sympt_cases_50_64 = state[74];
    const real_type model_sympt_cases_65_79 = state[75];
    const real_type model_sympt_cases_80_plus = state[76];
    const real_type model_sympt_cases_non_variant =
      state[68];
    const real_type model_sympt_cases_non_variant_over25 =
      state[70];
    const real_type model_react_pos = state[86];
    const real_type model_react_5_24_pos = state[87];
    const real_type model_react_25_34_pos = state[88];
    const real_type model_react_35_44_pos = state[89];
    const real_type model_react_45_54_pos = state[90];
    const real_type model_react_55_64_pos = state[91];
    const real_type model_react_65_plus_pos = state[92];
...
public:
  ...
  struct shared_type {
    ...
    int dim_delta_infections_per_strain;
    ...
    int dim_infections_inc_per_strain;
    int dim_lambda;
    int dim_lambda_1;
    int dim_lambda_2;
    int dim_lambda_susc;
    ...
    real_type initial_all_cases_0_9_inc;
    real_type initial_all_cases_10_19_inc;
    real_type initial_all_cases_20_29_inc;
    real_type initial_all_cases_30_39_inc;
    real_type initial_all_cases_40_49_inc;
    real_type initial_all_cases_50_59_inc;
    real_type initial_all_cases_60_69_inc;
    real_type initial_all_cases_70_79_inc;
    real_type initial_all_cases_80_plus_inc;
    ...
    std::vector<real_type> initial_infections_inc_per_strain;
    ...
    int offset_variable_infections_inc_per_strain;
  ...
  struct internal_type {
    ...
    std::vector<real_type> delta_infections_per_strain;
    std::vector<real_type> eff_S;
  ...
  std::vector<real_type> initial(size_t step) {
    ...
    state[16] = shared->initial_beta_out;
    state[17] = shared->initial_N_tot_sero_1;
    state[18] = shared->initial_N_tot_sero_2;
    state[19] = shared->initial_N_tot_PCR;
    state[20] = shared->initial_ICU_tot;
    state[21] = shared->initial_general_tot;
    state[22] = shared->initial_hosp_tot;
    state[23] = shared->initial_D_hosp_tot;
    state[24] = shared->initial_D_hosp_0_49_tot;
    state[25] = shared->initial_D_hosp_50_54_tot;
    state[26] = shared->initial_D_hosp_55_59_tot;
    state[27] = shared->initial_D_hosp_60_64_tot;
    state[28] = shared->initial_D_hosp_65_69_tot;
    state[29] = shared->initial_D_hosp_70_74_tot;
    state[30] = shared->initial_D_hosp_75_79_tot;
    state[31] = shared->initial_D_hosp_80_plus_tot;
    state[32] = shared->initial_D_comm_tot;
    state[33] = shared->initial_D_comm_inc;
    state[34] = shared->initial_D_comm_0_49_inc;
    state[35] = shared->initial_D_comm_50_54_inc;
    state[36] = shared->initial_D_comm_55_59_inc;
    state[37] = shared->initial_D_comm_60_64_inc;
    state[38] = shared->initial_D_comm_65_69_inc;
    state[39] = shared->initial_D_comm_70_74_inc;
    state[40] = shared->initial_D_comm_75_79_inc;
    state[41] = shared->initial_D_comm_80_plus_inc;
    state[42] = shared->initial_D_carehomes_tot;
    state[43] = shared->initial_D_carehomes_inc;
    state[44] = shared->initial_D_tot;
    state[45] = shared->initial_D_inc;
    state[46] = shared->initial_D_hosp_inc;
    state[47] = shared->initial_D_hosp_0_49_inc;
    state[48] = shared->initial_D_hosp_50_54_inc;
    state[49] = shared->initial_D_hosp_55_59_inc;
    state[50] = shared->initial_D_hosp_60_64_inc;
    state[51] = shared->initial_D_hosp_65_69_inc;
    state[52] = shared->initial_D_hosp_70_74_inc;
    state[53] = shared->initial_D_hosp_75_79_inc;
    state[54] = shared->initial_D_hosp_80_plus_inc;
    state[55] = shared->initial_sero_pos_1;
    state[56] = shared->initial_sero_pos_2;
    state[57] = shared->initial_cum_sympt_cases;
    state[58] = shared->initial_cum_sympt_cases_non_variant;
    state[59] = shared->initial_cum_sympt_cases_over25;
    state[60] = shared->initial_cum_sympt_cases_non_variant_over25;
    state[61] = shared->initial_cum_sympt_cases_under15;
    state[62] = shared->initial_cum_sympt_cases_15_24;
    state[63] = shared->initial_cum_sympt_cases_25_49;
    state[64] = shared->initial_cum_sympt_cases_50_64;
    state[65] = shared->initial_cum_sympt_cases_65_79;
    state[66] = shared->initial_cum_sympt_cases_80_plus;
    state[67] = shared->initial_sympt_cases_inc;
    state[68] = shared->initial_sympt_cases_non_variant_inc;
    state[69] = shared->initial_sympt_cases_over25_inc;
    state[70] = shared->initial_sympt_cases_non_variant_over25_inc;
    state[71] = shared->initial_sympt_cases_under15_inc;
    state[72] = shared->initial_sympt_cases_15_24_inc;
    state[73] = shared->initial_sympt_cases_25_49_inc;
    state[74] = shared->initial_sympt_cases_50_64_inc;
    state[75] = shared->initial_sympt_cases_65_79_inc;
    state[76] = shared->initial_sympt_cases_80_plus_inc;
    state[77] = shared->initial_all_cases_0_9_inc;
    state[78] = shared->initial_all_cases_10_19_inc;
    state[79] = shared->initial_all_cases_20_29_inc;
    state[80] = shared->initial_all_cases_30_39_inc;
    state[81] = shared->initial_all_cases_40_49_inc;
    state[82] = shared->initial_all_cases_50_59_inc;
    state[83] = shared->initial_all_cases_60_69_inc;
    state[84] = shared->initial_all_cases_70_79_inc;
    state[85] = shared->initial_all_cases_80_plus_inc;
    state[86] = shared->initial_react_pos;
    state[87] = shared->initial_react_5_24_pos;
    state[88] = shared->initial_react_25_34_pos;
    state[89] = shared->initial_react_35_44_pos;
    state[90] = shared->initial_react_45_54_pos;
    state[91] = shared->initial_react_55_64_pos;
    state[92] = shared->initial_react_65_plus_pos;
    std::copy(shared->initial_cum_n_S_vacc_skip.begin(), shared->initial_cum_n_S_vacc_skip.end(), state.begin() + 93);
    ...
    std::copy(shared->initial_infections_inc_per_strain.begin(), shared->initial_infections_inc_per_strain.end(), state.begin() + shared->offset_variable_infections_inc_per_strain);
  ...
  void update(size_t step, const real_type * state, rng_state_type& rng_state, real_type * state_next) {
    ...
    const real_type * cum_n_S_vacc_skip = state + 93;
    ...
    const real_type * infections_inc_per_strain = state + shared->offset_variable_infections_inc_per_strain;
    const real_type * D = state + shared->offset_variable_D;
    const real_type D_hosp_tot = state[23];
    const real_type D_hosp_0_49_tot = state[24];
    const real_type D_hosp_50_54_tot = state[25];
    const real_type D_hosp_55_59_tot = state[26];
    const real_type D_hosp_60_64_tot = state[27];
    const real_type D_hosp_65_69_tot = state[28];
    const real_type D_hosp_70_74_tot = state[29];
    const real_type D_hosp_75_79_tot = state[30];
    const real_type D_hosp_80_plus_tot = state[31];
    const real_type D_comm_tot = state[32];
    const real_type D_comm_inc = state[33];
    const real_type D_comm_0_49_inc = state[34];
    const real_type D_comm_50_54_inc = state[35];
    const real_type D_comm_55_59_inc = state[36];
    const real_type D_comm_60_64_inc = state[37];
    const real_type D_comm_65_69_inc = state[38];
    const real_type D_comm_70_74_inc = state[39];
    const real_type D_comm_75_79_inc = state[40];
    const real_type D_comm_80_plus_inc = state[41];
    const real_type D_carehomes_tot = state[42];
    const real_type D_carehomes_inc = state[43];
    const real_type D_tot = state[44];
    const real_type D_inc = state[45];
    const real_type D_hosp_inc = state[46];
    const real_type D_hosp_0_49_inc = state[47];
    const real_type D_hosp_50_54_inc = state[48];
    const real_type D_hosp_55_59_inc = state[49];
    const real_type D_hosp_60_64_inc = state[50];
    const real_type D_hosp_65_69_inc = state[51];
    const real_type D_hosp_70_74_inc = state[52];
    const real_type D_hosp_75_79_inc = state[53];
    const real_type D_hosp_80_plus_inc = state[54];
    const real_type cum_sympt_cases = state[57];
    const real_type cum_sympt_cases_non_variant = state[58];
    const real_type cum_sympt_cases_over25 = state[59];
    const real_type cum_sympt_cases_non_variant_over25 = state[60];
    const real_type cum_sympt_cases_under15 = state[61];
    const real_type cum_sympt_cases_15_24 = state[62];
    const real_type cum_sympt_cases_25_49 = state[63];
    const real_type cum_sympt_cases_50_64 = state[64];
    const real_type cum_sympt_cases_65_79 = state[65];
    const real_type cum_sympt_cases_80_plus = state[66];
    const real_type sympt_cases_inc = state[67];
    const real_type sympt_cases_non_variant_inc = state[68];
    const real_type sympt_cases_over25_inc = state[69];
    const real_type sympt_cases_non_variant_over25_inc = state[70];
    const real_type sympt_cases_under15_inc = state[71];
    const real_type sympt_cases_15_24_inc = state[72];
    const real_type sympt_cases_25_49_inc = state[73];
    const real_type sympt_cases_50_64_inc = state[74];
    const real_type sympt_cases_65_79_inc = state[75];
    const real_type sympt_cases_80_plus_inc = state[76];
    const real_type all_cases_0_9_inc = state[77];
    const real_type all_cases_10_19_inc = state[78];
    const real_type all_cases_20_29_inc = state[79];
    const real_type all_cases_30_39_inc = state[80];
    const real_type all_cases_40_49_inc = state[81];
    const real_type all_cases_50_59_inc = state[82];
    const real_type all_cases_60_69_inc = state[83];
    const real_type all_cases_70_79_inc = state[84];
    const real_type all_cases_80_plus_inc = state[85];
    const real_type * vaccine_missed_doses = state + shared->offset_variable_vaccine_missed_doses;
    state_next[19] = odin_sum1<real_type>(S, 0, shared->dim_S) + odin_sum1<real_type>(T_PCR_pre, 0, shared->dim_T_PCR_pre) + odin_sum1<real_type>(T_PCR_pos, 0, shared->dim_T_PCR_pos) + odin_sum1<real_type>(T_PCR_neg, 0, shared->dim_T_PCR_neg);
    state_next[17] = odin_sum1<real_type>(S, 0, shared->dim_S) + odin_sum1<real_type>(T_sero_pre_1, 0, shared->dim_T_sero_pre_1) + odin_sum1<real_type>(T_sero_pos_1, 0, shared->dim_T_sero_pos_1) + odin_sum1<real_type>(T_sero_neg_1, 0, shared->dim_T_sero_neg_1) + odin_sum1<real_type>(E, 0, shared->dim_E);
    state_next[18] = odin_sum1<real_type>(S, 0, shared->dim_S) + odin_sum1<real_type>(T_sero_pre_2, 0, shared->dim_T_sero_pre_2) + odin_sum1<real_type>(T_sero_pos_2, 0, shared->dim_T_sero_pos_2) + odin_sum1<real_type>(T_sero_neg_2, 0, shared->dim_T_sero_neg_2) + odin_sum1<real_type>(E, 0, shared->dim_E);
    ...
    for (int i = 1; i <= shared->dim_eff_S_1; ++i) {
      for (int j = 1; j <= shared->dim_eff_S_2; ++j) {
        for (int k = 1; k <= shared->dim_eff_S_3; ++k) {
          internal.eff_S[i - 1 + shared->dim_eff_S_1 * (j - 1) + shared->dim_eff_S_12 * (k - 1)] = (shared->n_real_strains == 1 ? S[shared->dim_S_1 * (k - 1) + i - 1] * shared->rel_susceptibility[shared->dim_rel_susceptibility_12 * (k - 1) + shared->dim_rel_susceptibility_1 * (j - 1) + i - 1] : (S[shared->dim_S_1 * (k - 1) + i - 1] + (1 - shared->cross_immunity[3 - j - 1]) * R[shared->dim_R_12 * (k - 1) + shared->dim_R_1 * (3 - j - 1) + i - 1]) * shared->rel_susceptibility[shared->dim_rel_susceptibility_12 * (k - 1) + shared->dim_rel_susceptibility_1 * (j - 1) + i - 1]);
        }
      }
    }
    ...
    for (int i = 1; i <= shared->dim_effective_susceptible; ++i) {
      state_next[shared->offset_variable_effective_susceptible + i - 1] = odin_sum3<real_type>(internal.eff_S.data(), 0, shared->dim_eff_S_1, i - 1, i, 0, shared->dim_eff_S_3, shared->dim_eff_S_1, shared->dim_eff_S_12);
    }
    ...
    state_next[55] = odin_sum4<real_type>(internal.new_T_sero_pos_1.data(), 3, 13, 0, shared->dim_new_T_sero_pos_1_2, 0, shared->dim_new_T_sero_pos_1_3, 0, shared->dim_new_T_sero_pos_1_4, shared->dim_new_T_sero_pos_1_1, shared->dim_new_T_sero_pos_1_12, shared->dim_new_T_sero_pos_1_123);
    ...
    real_type new_all_cases_0_9 = odin_sum3<real_type>(internal.n_EI_P.data(), 0, 2, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) + odin_sum3<real_type>(internal.n_EI_A.data(), 0, 2, 0, shared->dim_n_EI_A_2, 0, shared->dim_n_EI_A_3, shared->dim_n_EI_A_1, shared->dim_n_EI_A_12);
    real_type new_all_cases_10_19 = odin_sum3<real_type>(internal.n_EI_P.data(), 2, 4, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) + odin_sum3<real_type>(internal.n_EI_A.data(), 2, 4, 0, shared->dim_n_EI_A_2, 0, shared->dim_n_EI_A_3, shared->dim_n_EI_A_1, shared->dim_n_EI_A_12);
    real_type new_all_cases_20_29 = odin_sum3<real_type>(internal.n_EI_P.data(), 4, 6, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) + odin_sum3<real_type>(internal.n_EI_A.data(), 4, 6, 0, shared->dim_n_EI_A_2, 0, shared->dim_n_EI_A_3, shared->dim_n_EI_A_1, shared->dim_n_EI_A_12) + odin_sum3<real_type>(internal.n_EI_P.data(), 17, 18, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) * 1 / (real_type) 8 + odin_sum3<real_type>(internal.n_EI_A.data(), 17, 18, 0, shared->dim_n_EI_A_2, 0, shared->dim_n_EI_A_3, shared->dim_n_EI_A_1, shared->dim_n_EI_A_12) * 1 / (real_type) 8;
    real_type new_all_cases_30_39 = odin_sum3<real_type>(internal.n_EI_P.data(), 6, 8, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) + odin_sum3<real_type>(internal.n_EI_A.data(), 6, 8, 0, shared->dim_n_EI_A_2, 0, shared->dim_n_EI_A_3, shared->dim_n_EI_A_1, shared->dim_n_EI_A_12) + odin_sum3<real_type>(internal.n_EI_P.data(), 17, 18, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) * 2 / (real_type) 8 + odin_sum3<real_type>(internal.n_EI_A.data(), 17, 18, 0, shared->dim_n_EI_A_2, 0, shared->dim_n_EI_A_3, shared->dim_n_EI_A_1, shared->dim_n_EI_A_12) * 2 / (real_type) 8;
    real_type new_all_cases_40_49 = odin_sum3<real_type>(internal.n_EI_P.data(), 8, 10, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) + odin_sum3<real_type>(internal.n_EI_A.data(), 8, 10, 0, shared->dim_n_EI_A_2, 0, shared->dim_n_EI_A_3, shared->dim_n_EI_A_1, shared->dim_n_EI_A_12) + odin_sum3<real_type>(internal.n_EI_P.data(), 17, 18, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) * 2 / (real_type) 8 + odin_sum3<real_type>(internal.n_EI_A.data(), 17, 18, 0, shared->dim_n_EI_A_2, 0, shared->dim_n_EI_A_3, shared->dim_n_EI_A_1, shared->dim_n_EI_A_12) * 2 / (real_type) 8;
    real_type new_all_cases_50_59 = odin_sum3<real_type>(internal.n_EI_P.data(), 10, 12, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) + odin_sum3<real_type>(internal.n_EI_A.data(), 10, 12, 0, shared->dim_n_EI_A_2, 0, shared->dim_n_EI_A_3, shared->dim_n_EI_A_1, shared->dim_n_EI_A_12) + odin_sum3<real_type>(internal.n_EI_P.data(), 17, 18, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) * 2 / (real_type) 8 + odin_sum3<real_type>(internal.n_EI_A.data(), 17, 18, 0, shared->dim_n_EI_A_2, 0, shared->dim_n_EI_A_3, shared->dim_n_EI_A_1, shared->dim_n_EI_A_12) * 2 / (real_type) 8;
    real_type new_all_cases_60_69 = odin_sum3<real_type>(internal.n_EI_P.data(), 12, 14, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) + odin_sum3<real_type>(internal.n_EI_A.data(), 12, 14, 0, shared->dim_n_EI_A_2, 0, shared->dim_n_EI_A_3, shared->dim_n_EI_A_1, shared->dim_n_EI_A_12) + odin_sum3<real_type>(internal.n_EI_P.data(), 17, 18, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) * 1 / (real_type) 8 + odin_sum3<real_type>(internal.n_EI_A.data(), 17, 18, 0, shared->dim_n_EI_A_2, 0, shared->dim_n_EI_A_3, shared->dim_n_EI_A_1, shared->dim_n_EI_A_12) * 1 / (real_type) 8 + odin_sum3<real_type>(internal.n_EI_P.data(), 18, 19, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) * 0.050000000000000003 + odin_sum3<real_type>(internal.n_EI_A.data(), 18, 19, 0, shared->dim_n_EI_A_2, 0, shared->dim_n_EI_A_3, shared->dim_n_EI_A_1, shared->dim_n_EI_A_12) * 0.050000000000000003;
    real_type new_all_cases_70_79 = odin_sum3<real_type>(internal.n_EI_P.data(), 14, 16, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) + odin_sum3<real_type>(internal.n_EI_A.data(), 14, 16, 0, shared->dim_n_EI_A_2, 0, shared->dim_n_EI_A_3, shared->dim_n_EI_A_1, shared->dim_n_EI_A_12) + odin_sum3<real_type>(internal.n_EI_P.data(), 18, 19, 0, shared->dim_n_EI_P_2, 0, shared->dim_n_EI_P_3, shared->dim_n_EI_P_1, shared->dim_n_EI_P_12) * 0.20000000000000001 + odin_sum3<real_type>(internal.n_EI_A.data(), 18, 19, 0, shared->dim_n_EI_A_2, 0, shared->dim_n_EI_A_3, shared->dim_n_EI_A_1, shared->dim_n_EI_A_12) * 0.20000000000000001;
    ...
    real_type new_all_cases_80_plus = new_sympt_cases_80_plus + odin_sum3<real_type>(internal.n_EI_A.data(), 16, 17, 0, shared->dim_n_EI_A_2, 0, shared->dim_n_EI_A_3, shared->dim_n_EI_A_1, shared->dim_n_EI_A_12) + (odin_sum3<real_type>(internal.n_EI_A.data(), 18, 19, 0, shared->dim_n_EI_A_2, 0, shared->dim_n_EI_A_3, shared->dim_n_EI_A_1, shared->dim_n_EI_A_12) * 0.75);
    ...
    state_next[43] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_D_carehomes_tot : D_carehomes_inc + delta_D_carehomes_tot);
    state_next[42] = D_carehomes_tot + delta_D_carehomes_tot;
    state_next[34] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_D_comm_0_49 : D_comm_0_49_inc + delta_D_comm_0_49);
    state_next[35] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_D_comm_50_54 : D_comm_50_54_inc + delta_D_comm_50_54);
    state_next[36] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_D_comm_55_59 : D_comm_55_59_inc + delta_D_comm_55_59);
    state_next[37] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_D_comm_60_64 : D_comm_60_64_inc + delta_D_comm_60_64);
    state_next[38] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_D_comm_65_69 : D_comm_65_69_inc + delta_D_comm_65_69);
    state_next[39] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_D_comm_70_74 : D_comm_70_74_inc + delta_D_comm_70_74);
    state_next[40] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_D_comm_75_79 : D_comm_75_79_inc + delta_D_comm_75_79);
    state_next[41] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_D_comm_80_plus : D_comm_80_plus_inc + delta_D_comm_80_plus);
    state_next[33] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_D_comm_tot : D_comm_inc + delta_D_comm_tot);
    state_next[32] = D_comm_tot + delta_D_comm_tot;
    state_next[47] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_D_hosp_0_49_tot : D_hosp_0_49_inc + delta_D_hosp_0_49_tot);
    state_next[24] = D_hosp_0_49_tot + delta_D_hosp_0_49_tot;
    state_next[48] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_D_hosp_50_54_tot : D_hosp_50_54_inc + delta_D_hosp_50_54_tot);
    state_next[25] = D_hosp_50_54_tot + delta_D_hosp_50_54_tot;
    state_next[49] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_D_hosp_55_59_tot : D_hosp_55_59_inc + delta_D_hosp_55_59_tot);
    state_next[26] = D_hosp_55_59_tot + delta_D_hosp_55_59_tot;
    state_next[50] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_D_hosp_60_64_tot : D_hosp_60_64_inc + delta_D_hosp_60_64_tot);
    state_next[27] = D_hosp_60_64_tot + delta_D_hosp_60_64_tot;
    state_next[51] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_D_hosp_65_69_tot : D_hosp_65_69_inc + delta_D_hosp_65_69_tot);
    state_next[28] = D_hosp_65_69_tot + delta_D_hosp_65_69_tot;
    state_next[52] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_D_hosp_70_74_tot : D_hosp_70_74_inc + delta_D_hosp_70_74_tot);
    state_next[29] = D_hosp_70_74_tot + delta_D_hosp_70_74_tot;
    state_next[53] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_D_hosp_75_79_tot : D_hosp_75_79_inc + delta_D_hosp_75_79_tot);
    state_next[30] = D_hosp_75_79_tot + delta_D_hosp_75_79_tot;
    state_next[54] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_D_hosp_80_plus_tot : D_hosp_80_plus_inc + delta_D_hosp_80_plus_tot);
    state_next[31] = D_hosp_80_plus_tot + delta_D_hosp_80_plus_tot;
    state_next[46] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_D_hosp_tot : D_hosp_inc + delta_D_hosp_tot);
    ...
    state_next[77] = ((fmodr<real_type>(step, shared->steps_per_day) == 0 ? new_all_cases_0_9 : all_cases_0_9_inc + new_all_cases_0_9));
    state_next[78] = ((fmodr<real_type>(step, shared->steps_per_day) == 0 ? new_all_cases_10_19 : all_cases_10_19_inc + new_all_cases_10_19));
    state_next[79] = ((fmodr<real_type>(step, shared->steps_per_day) == 0 ? new_all_cases_20_29 : all_cases_20_29_inc + new_all_cases_20_29));
    state_next[80] = ((fmodr<real_type>(step, shared->steps_per_day) == 0 ? new_all_cases_30_39 : all_cases_30_39_inc + new_all_cases_30_39));
    state_next[81] = ((fmodr<real_type>(step, shared->steps_per_day) == 0 ? new_all_cases_40_49 : all_cases_40_49_inc + new_all_cases_40_49));
    state_next[82] = ((fmodr<real_type>(step, shared->steps_per_day) == 0 ? new_all_cases_50_59 : all_cases_50_59_inc + new_all_cases_50_59));
    state_next[83] = ((fmodr<real_type>(step, shared->steps_per_day) == 0 ? new_all_cases_60_69 : all_cases_60_69_inc + new_all_cases_60_69));
    state_next[84] = ((fmodr<real_type>(step, shared->steps_per_day) == 0 ? new_all_cases_70_79 : all_cases_70_79_inc + new_all_cases_70_79));
    ...
    state_next[72] = ((fmodr<real_type>(step, shared->steps_per_day) == 0 ? new_sympt_cases_15_24 : sympt_cases_15_24_inc + new_sympt_cases_15_24));
    state_next[73] = ((fmodr<real_type>(step, shared->steps_per_day) == 0 ? new_sympt_cases_25_49 : sympt_cases_25_49_inc + new_sympt_cases_25_49));
    state_next[74] = ((fmodr<real_type>(step, shared->steps_per_day) == 0 ? new_sympt_cases_50_64 : sympt_cases_50_64_inc + new_sympt_cases_50_64));
    state_next[75] = ((fmodr<real_type>(step, shared->steps_per_day) == 0 ? new_sympt_cases_65_79 : sympt_cases_65_79_inc + new_sympt_cases_65_79));
    state_next[76] = ((fmodr<real_type>(step, shared->steps_per_day) == 0 ? new_sympt_cases_80_plus : sympt_cases_80_plus_inc + new_sympt_cases_80_plus));
    state_next[67] = ((fmodr<real_type>(step, shared->steps_per_day) == 0 ? new_sympt_cases : sympt_cases_inc + new_sympt_cases));
    state_next[68] = ((fmodr<real_type>(step, shared->steps_per_day) == 0 ? new_sympt_cases_non_variant : sympt_cases_non_variant_inc + new_sympt_cases_non_variant));
    state_next[70] = ((fmodr<real_type>(step, shared->steps_per_day) == 0 ? new_sympt_cases_non_variant_over25 : sympt_cases_non_variant_over25_inc + new_sympt_cases_non_variant_over25));
    state_next[69] = ((fmodr<real_type>(step, shared->steps_per_day) == 0 ? new_sympt_cases_over25 : sympt_cases_over25_inc + new_sympt_cases_over25));
    state_next[71] = ((fmodr<real_type>(step, shared->steps_per_day) == 0 ? new_sympt_cases_under15 : sympt_cases_under15_inc + new_sympt_cases_under15));
    ...
    state_next[45] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_D_tot : D_inc + delta_D_tot);
    ...
    state_next[85] = ((fmodr<real_type>(step, shared->steps_per_day) == 0 ? new_all_cases_80_plus : all_cases_80_plus_inc + new_all_cases_80_plus));
    ...
    for (int i = 1; i <= shared->dim_cum_n_S_vacc_skip; ++i) {
      state_next[93 + i - 1] = cum_n_S_vacc_skip[i - 1] + internal.n_S_vacc_skip[i - 1];
    }
    ...
    for (int i = 1; i <= shared->dim_cum_infections_per_strain; ++i) {
      state_next[shared->offset_variable_cum_infections_per_strain + i - 1] = cum_infections_per_strain[i - 1] + internal.delta_infections_per_strain[i - 1];
    }
    ...
    state_next[88] = odin_sum4<real_type>(internal.new_T_PCR_pos.data(), 5, 7, 0, shared->dim_new_T_PCR_pos_2, 0, shared->dim_new_T_PCR_pos_3, 0, shared->dim_new_T_PCR_pos_4, shared->dim_new_T_PCR_pos_1, shared->dim_new_T_PCR_pos_12, shared->dim_new_T_PCR_pos_123) + odin_sum4<real_type>(internal.new_T_PCR_pos.data(), 17, 18, 0, shared->dim_new_T_PCR_pos_2, 0, shared->dim_new_T_PCR_pos_3, 0, shared->dim_new_T_PCR_pos_4, shared->dim_new_T_PCR_pos_1, shared->dim_new_T_PCR_pos_12, shared->dim_new_T_PCR_pos_123) * 2 / (real_type) 8;
    state_next[89] = odin_sum4<real_type>(internal.new_T_PCR_pos.data(), 7, 9, 0, shared->dim_new_T_PCR_pos_2, 0, shared->dim_new_T_PCR_pos_3, 0, shared->dim_new_T_PCR_pos_4, shared->dim_new_T_PCR_pos_1, shared->dim_new_T_PCR_pos_12, shared->dim_new_T_PCR_pos_123) + odin_sum4<real_type>(internal.new_T_PCR_pos.data(), 17, 18, 0, shared->dim_new_T_PCR_pos_2, 0, shared->dim_new_T_PCR_pos_3, 0, shared->dim_new_T_PCR_pos_4, shared->dim_new_T_PCR_pos_1, shared->dim_new_T_PCR_pos_12, shared->dim_new_T_PCR_pos_123) * 2 / (real_type) 8;
    state_next[90] = odin_sum4<real_type>(internal.new_T_PCR_pos.data(), 9, 11, 0, shared->dim_new_T_PCR_pos_2, 0, shared->dim_new_T_PCR_pos_3, 0, shared->dim_new_T_PCR_pos_4, shared->dim_new_T_PCR_pos_1, shared->dim_new_T_PCR_pos_12, shared->dim_new_T_PCR_pos_123) + odin_sum4<real_type>(internal.new_T_PCR_pos.data(), 17, 18, 0, shared->dim_new_T_PCR_pos_2, 0, shared->dim_new_T_PCR_pos_3, 0, shared->dim_new_T_PCR_pos_4, shared->dim_new_T_PCR_pos_1, shared->dim_new_T_PCR_pos_12, shared->dim_new_T_PCR_pos_123) * 2 / (real_type) 8;
    state_next[91] = odin_sum4<real_type>(internal.new_T_PCR_pos.data(), 11, 13, 0, shared->dim_new_T_PCR_pos_2, 0, shared->dim_new_T_PCR_pos_3, 0, shared->dim_new_T_PCR_pos_4, shared->dim_new_T_PCR_pos_1, shared->dim_new_T_PCR_pos_12, shared->dim_new_T_PCR_pos_123) + odin_sum4<real_type>(internal.new_T_PCR_pos.data(), 17, 18, 0, shared->dim_new_T_PCR_pos_2, 0, shared->dim_new_T_PCR_pos_3, 0, shared->dim_new_T_PCR_pos_4, shared->dim_new_T_PCR_pos_1, shared->dim_new_T_PCR_pos_12, shared->dim_new_T_PCR_pos_123) * 2 / (real_type) 8;
    state_next[87] = odin_sum4<real_type>(internal.new_T_PCR_pos.data(), 1, 5, 0, shared->dim_new_T_PCR_pos_2, 0, shared->dim_new_T_PCR_pos_3, 0, shared->dim_new_T_PCR_pos_4, shared->dim_new_T_PCR_pos_1, shared->dim_new_T_PCR_pos_12, shared->dim_new_T_PCR_pos_123);
    state_next[92] = odin_sum4<real_type>(internal.new_T_PCR_pos.data(), 13, 17, 0, shared->dim_new_T_PCR_pos_2, 0, shared->dim_new_T_PCR_pos_3, 0, shared->dim_new_T_PCR_pos_4, shared->dim_new_T_PCR_pos_1, shared->dim_new_T_PCR_pos_12, shared->dim_new_T_PCR_pos_123);
    state_next[86] = odin_sum4<real_type>(internal.new_T_PCR_pos.data(), 1, 18, 0, shared->dim_new_T_PCR_pos_2, 0, shared->dim_new_T_PCR_pos_3, 0, shared->dim_new_T_PCR_pos_4, shared->dim_new_T_PCR_pos_1, shared->dim_new_T_PCR_pos_12, shared->dim_new_T_PCR_pos_123);
    ...
    real_type delta_all_admission_60_69_conf = odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 12, 14, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) + odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 17, 18, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) * 1 / (real_type) 8 + odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 18, 19, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) * 0.050000000000000003;
    real_type delta_all_admission_70_79_conf = odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 14, 16, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) + odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 18, 19, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) * 0.20000000000000001;
    real_type delta_all_admission_80_plus_conf = odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 16, 17, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) + odin_sum2<real_type>(internal.delta_diagnoses_admitted.data(), 18, 19, 0, shared->dim_delta_diagnoses_admitted_2, shared->dim_delta_diagnoses_admitted_1) * 0.75;
...
dust::pars_type<lancelot> dust_pars<lancelot>(cpp11::list user) {
  ...
  shared->initial_all_cases_0_9_inc = 0;
  shared->initial_all_cases_10_19_inc = 0;
  shared->initial_all_cases_20_29_inc = 0;
  shared->initial_all_cases_30_39_inc = 0;
  shared->initial_all_cases_40_49_inc = 0;
  shared->initial_all_cases_50_59_inc = 0;
  shared->initial_all_cases_60_69_inc = 0;
  shared->initial_all_cases_70_79_inc = 0;
  shared->initial_all_cases_80_plus_inc = 0;
  ...
  shared->vacc_skip_dose = user_get_scalar<int>(user, "vacc_skip_dose", shared->vacc_skip_dose, NA_INTEGER, NA_INTEGER);
  shared->vacc_skip_from = user_get_scalar<int>(user, "vacc_skip_from", shared->vacc_skip_from, NA_INTEGER, NA_INTEGER);
  shared->vacc_skip_to = user_get_scalar<int>(user, "vacc_skip_to", shared->vacc_skip_to, NA_INTEGER, NA_INTEGER);
  ...
  shared->dim_delta_infections_per_strain = shared->n_strains;
  ...
  shared->dim_infections_inc_per_strain = shared->n_strains;
  ...
  internal.delta_infections_per_strain = std::vector<real_type>(shared->dim_delta_infections_per_strain);
  ...
  shared->dim_eff_S_1 = shared->n_groups;
  shared->dim_eff_S_2 = shared->n_real_strains;
  shared->dim_eff_S_3 = shared->n_vacc_classes;
  ...
  for (int i = 1; i <= shared->dim_infections_inc_per_strain; ++i) {
    shared->initial_infections_inc_per_strain[i - 1] = 0;
  }
  shared->offset_variable_D_hosp = shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_vacc_skip + shared->dim_infections_inc_per_strain + 93;
  shared->offset_variable_D_non_hosp = shared->dim_D_hosp + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_vacc_skip + shared->dim_infections_inc_per_strain + 93;
  ...
  shared->offset_variable_cum_admit_by_age = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_vacc_skip + shared->dim_infections_inc_per_strain + 93;
  shared->offset_variable_cum_infections_per_strain = shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_vacc_skip + 93;
  shared->offset_variable_cum_n_E_vacc_skip = shared->dim_cum_n_S_vacc_skip + 93;
  shared->offset_variable_cum_n_I_A_vacc_skip = shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_S_vacc_skip + 93;
  shared->offset_variable_cum_n_I_P_vacc_skip = shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_S_vacc_skip + 93;
  shared->offset_variable_cum_n_R_vacc_skip = shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_S_vacc_skip + 93;
  shared->offset_variable_cum_n_vacc_skip = shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_S_vacc_skip + 93;
  shared->offset_variable_infections_inc_per_strain = shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_vacc_skip + 93;
  ...
  shared->dim_eff_S = shared->dim_eff_S_1 * shared->dim_eff_S_2 * shared->dim_eff_S_3;
  shared->dim_eff_S_12 = shared->dim_eff_S_1 * shared->dim_eff_S_2;
  ...
  shared->offset_variable_effective_susceptible = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_cum_admit_by_age + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_vacc_skip + shared->dim_infections_inc_per_strain + shared->dim_prob_strain + 93;
  shared->offset_variable_tmp_vaccine_n_candidates = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_S + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vacc_skip + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_effective_susceptible + shared->dim_infections_inc_per_strain + shared->dim_prob_strain + shared->dim_vaccine_missed_doses + 93;
  shared->offset_variable_tmp_vaccine_probability = shared->dim_D + shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_N_tot + shared->dim_S + shared->dim_cum_admit_by_age + shared->dim_cum_infections_disag + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_E_vaccinated + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_A_vaccinated + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_I_P_vaccinated + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_R_vaccinated + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_S_vaccinated + shared->dim_cum_n_vacc_skip + shared->dim_cum_n_vaccinated + shared->dim_diagnoses_admitted + shared->dim_effective_susceptible + shared->dim_infections_inc_per_strain + shared->dim_prob_strain + shared->dim_tmp_vaccine_n_candidates + shared->dim_vaccine_missed_doses + 93;
...
cpp11::sexp dust_info<lancelot>(const dust::pars_type<lancelot>& pars) {
  ...
  dim[93] = cpp11::writable::integers({shared->dim_cum_n_S_vacc_skip});
  dim[94] = cpp11::writable::integers({shared->dim_cum_n_E_vacc_skip});
  dim[95] = cpp11::writable::integers({shared->dim_cum_n_I_A_vacc_skip});
  dim[96] = cpp11::writable::integers({shared->dim_cum_n_I_P_vacc_skip});
  dim[97] = cpp11::writable::integers({shared->dim_cum_n_R_vacc_skip});
  dim[98] = cpp11::writable::integers({shared->dim_cum_n_vacc_skip});
  dim[99] = cpp11::writable::integers({shared->dim_cum_infections_per_strain});
  dim[100] = cpp11::writable::integers({shared->dim_infections_inc_per_strain});
  dim[101] = cpp11::writable::integers({shared->dim_D_hosp});
  dim[102] = cpp11::writable::integers({shared->dim_D_non_hosp});
  dim[103] = cpp11::writable::integers({shared->dim_cum_admit_by_age});
  dim[104] = cpp11::writable::integers({shared->dim_N_tot});
  dim[105] = cpp11::writable::integers({shared->dim_prob_strain});
  dim[106] = cpp11::writable::integers({shared->dim_effective_susceptible});
  dim[107] = cpp11::writable::integers({shared->dim_cum_n_S_vaccinated_1, shared->dim_cum_n_S_vaccinated_2});
  dim[108] = cpp11::writable::integers({shared->dim_cum_n_E_vaccinated_1, shared->dim_cum_n_E_vaccinated_2});
  dim[109] = cpp11::writable::integers({shared->dim_cum_n_I_A_vaccinated_1, shared->dim_cum_n_I_A_vaccinated_2});
  dim[110] = cpp11::writable::integers({shared->dim_cum_n_I_P_vaccinated_1, shared->dim_cum_n_I_P_vaccinated_2});
  dim[111] = cpp11::writable::integers({shared->dim_cum_n_R_vaccinated_1, shared->dim_cum_n_R_vaccinated_2});
  dim[112] = cpp11::writable::integers({shared->dim_cum_n_vaccinated_1, shared->dim_cum_n_vaccinated_2});
  dim[113] = cpp11::writable::integers({shared->dim_diagnoses_admitted_1, shared->dim_diagnoses_admitted_2});
  dim[114] = cpp11::writable::integers({shared->dim_cum_infections_disag_1, shared->dim_cum_infections_disag_2});
  dim[115] = cpp11::writable::integers({shared->dim_D_1, shared->dim_D_2});
  dim[116] = cpp11::writable::integers({shared->dim_S_1, shared->dim_S_2});
  dim[117] = cpp11::writable::integers({shared->dim_vaccine_missed_doses_1, shared->dim_vaccine_missed_doses_2});
  dim[118] = cpp11::writable::integers({shared->dim_tmp_vaccine_n_candidates_1, shared->dim_tmp_vaccine_n_candidates_2});
  dim[119] = cpp11::writable::integers({shared->dim_tmp_vaccine_probability_1, shared->dim_tmp_vaccine_probability_2});
  dim[120] = cpp11::writable::integers({shared->dim_T_sero_neg_1_1, shared->dim_T_sero_neg_1_2, shared->dim_T_sero_neg_1_3});
  dim[121] = cpp11::writable::integers({shared->dim_T_sero_neg_2_1, shared->dim_T_sero_neg_2_2, shared->dim_T_sero_neg_2_3});
  dim[122] = cpp11::writable::integers({shared->dim_R_1, shared->dim_R_2, shared->dim_R_3});
  dim[123] = cpp11::writable::integers({shared->dim_T_PCR_neg_1, shared->dim_T_PCR_neg_2, shared->dim_T_PCR_neg_3});
  dim[124] = cpp11::writable::integers({shared->dim_I_weighted_1, shared->dim_I_weighted_2, shared->dim_I_weighted_3});
  dim[125] = cpp11::writable::integers({shared->dim_E_1, shared->dim_E_2, shared->dim_E_3, shared->dim_E_4});
  dim[126] = cpp11::writable::integers({shared->dim_I_A_1, shared->dim_I_A_2, shared->dim_I_A_3, shared->dim_I_A_4});
  dim[127] = cpp11::writable::integers({shared->dim_I_P_1, shared->dim_I_P_2, shared->dim_I_P_3, shared->dim_I_P_4});
  dim[128] = cpp11::writable::integers({shared->dim_I_C_1_1, shared->dim_I_C_1_2, shared->dim_I_C_1_3, shared->dim_I_C_1_4});
  dim[129] = cpp11::writable::integers({shared->dim_I_C_2_1, shared->dim_I_C_2_2, shared->dim_I_C_2_3, shared->dim_I_C_2_4});
  dim[130] = cpp11::writable::integers({shared->dim_G_D_1, shared->dim_G_D_2, shared->dim_G_D_3, shared->dim_G_D_4});
  dim[131] = cpp11::writable::integers({shared->dim_ICU_pre_unconf_1, shared->dim_ICU_pre_unconf_2, shared->dim_ICU_pre_unconf_3, shared->dim_ICU_pre_unconf_4});
  dim[132] = cpp11::writable::integers({shared->dim_ICU_pre_conf_1, shared->dim_ICU_pre_conf_2, shared->dim_ICU_pre_conf_3, shared->dim_ICU_pre_conf_4});
  dim[133] = cpp11::writable::integers({shared->dim_H_R_unconf_1, shared->dim_H_R_unconf_2, shared->dim_H_R_unconf_3, shared->dim_H_R_unconf_4});
  dim[134] = cpp11::writable::integers({shared->dim_H_R_conf_1, shared->dim_H_R_conf_2, shared->dim_H_R_conf_3, shared->dim_H_R_conf_4});
  dim[135] = cpp11::writable::integers({shared->dim_H_D_unconf_1, shared->dim_H_D_unconf_2, shared->dim_H_D_unconf_3, shared->dim_H_D_unconf_4});
  dim[136] = cpp11::writable::integers({shared->dim_H_D_conf_1, shared->dim_H_D_conf_2, shared->dim_H_D_conf_3, shared->dim_H_D_conf_4});
  dim[137] = cpp11::writable::integers({shared->dim_ICU_W_R_unconf_1, shared->dim_ICU_W_R_unconf_2, shared->dim_ICU_W_R_unconf_3, shared->dim_ICU_W_R_unconf_4});
  dim[138] = cpp11::writable::integers({shared->dim_ICU_W_R_conf_1, shared->dim_ICU_W_R_conf_2, shared->dim_ICU_W_R_conf_3, shared->dim_ICU_W_R_conf_4});
  dim[139] = cpp11::writable::integers({shared->dim_ICU_W_D_unconf_1, shared->dim_ICU_W_D_unconf_2, shared->dim_ICU_W_D_unconf_3, shared->dim_ICU_W_D_unconf_4});
  dim[140] = cpp11::writable::integers({shared->dim_ICU_W_D_conf_1, shared->dim_ICU_W_D_conf_2, shared->dim_ICU_W_D_conf_3, shared->dim_ICU_W_D_conf_4});
  dim[141] = cpp11::writable::integers({shared->dim_ICU_D_unconf_1, shared->dim_ICU_D_unconf_2, shared->dim_ICU_D_unconf_3, shared->dim_ICU_D_unconf_4});
  dim[142] = cpp11::writable::integers({shared->dim_ICU_D_conf_1, shared->dim_ICU_D_conf_2, shared->dim_ICU_D_conf_3, shared->dim_ICU_D_conf_4});
  dim[143] = cpp11::writable::integers({shared->dim_W_R_unconf_1, shared->dim_W_R_unconf_2, shared->dim_W_R_unconf_3, shared->dim_W_R_unconf_4});
  dim[144] = cpp11::writable::integers({shared->dim_W_R_conf_1, shared->dim_W_R_conf_2, shared->dim_W_R_conf_3, shared->dim_W_R_conf_4});
  dim[145] = cpp11::writable::integers({shared->dim_W_D_unconf_1, shared->dim_W_D_unconf_2, shared->dim_W_D_unconf_3, shared->dim_W_D_unconf_4});
  dim[146] = cpp11::writable::integers({shared->dim_W_D_conf_1, shared->dim_W_D_conf_2, shared->dim_W_D_conf_3, shared->dim_W_D_conf_4});
  dim[147] = cpp11::writable::integers({shared->dim_T_sero_pre_1_1, shared->dim_T_sero_pre_1_2, shared->dim_T_sero_pre_1_3, shared->dim_T_sero_pre_1_4});
  dim[148] = cpp11::writable::integers({shared->dim_T_sero_pos_1_1, shared->dim_T_sero_pos_1_2, shared->dim_T_sero_pos_1_3, shared->dim_T_sero_pos_1_4});
  dim[149] = cpp11::writable::integers({shared->dim_T_sero_pre_2_1, shared->dim_T_sero_pre_2_2, shared->dim_T_sero_pre_2_3, shared->dim_T_sero_pre_2_4});
  dim[150] = cpp11::writable::integers({shared->dim_T_sero_pos_2_1, shared->dim_T_sero_pos_2_2, shared->dim_T_sero_pos_2_3, shared->dim_T_sero_pos_2_4});
  dim[151] = cpp11::writable::integers({shared->dim_T_PCR_pre_1, shared->dim_T_PCR_pre_2, shared->dim_T_PCR_pre_3, shared->dim_T_PCR_pre_4});
  dim[152] = cpp11::writable::integers({shared->dim_T_PCR_pos_1, shared->dim_T_PCR_pos_2, shared->dim_T_PCR_pos_3, shared->dim_T_PCR_pos_4});
  dim.names() = nms;
  cpp11::writable::list index(153);
  ...
  index[93] = integer_sequence(94, shared->dim_cum_n_S_vacc_skip);
  index[94] = integer_sequence(shared->offset_variable_cum_n_E_vacc_skip + 1, shared->dim_cum_n_E_vacc_skip);
  index[95] = integer_sequence(shared->offset_variable_cum_n_I_A_vacc_skip + 1, shared->dim_cum_n_I_A_vacc_skip);
  index[96] = integer_sequence(shared->offset_variable_cum_n_I_P_vacc_skip + 1, shared->dim_cum_n_I_P_vacc_skip);
  index[97] = integer_sequence(shared->offset_variable_cum_n_R_vacc_skip + 1, shared->dim_cum_n_R_vacc_skip);
  index[98] = integer_sequence(shared->offset_variable_cum_n_vacc_skip + 1, shared->dim_cum_n_vacc_skip);
  index[99] = integer_sequence(shared->offset_variable_cum_infections_per_strain + 1, shared->dim_cum_infections_per_strain);
  index[100] = integer_sequence(shared->offset_variable_infections_inc_per_strain + 1, shared->dim_infections_inc_per_strain);
  index[101] = integer_sequence(shared->offset_variable_D_hosp + 1, shared->dim_D_hosp);
  index[102] = integer_sequence(shared->offset_variable_D_non_hosp + 1, shared->dim_D_non_hosp);
  index[103] = integer_sequence(shared->offset_variable_cum_admit_by_age + 1, shared->dim_cum_admit_by_age);
  index[104] = integer_sequence(shared->offset_variable_N_tot + 1, shared->dim_N_tot);
  index[105] = integer_sequence(shared->offset_variable_prob_strain + 1, shared->dim_prob_strain);
  index[106] = integer_sequence(shared->offset_variable_effective_susceptible + 1, shared->dim_effective_susceptible);
  index[107] = integer_sequence(shared->offset_variable_cum_n_S_vaccinated + 1, shared->dim_cum_n_S_vaccinated);
  index[108] = integer_sequence(shared->offset_variable_cum_n_E_vaccinated + 1, shared->dim_cum_n_E_vaccinated);
  index[109] = integer_sequence(shared->offset_variable_cum_n_I_A_vaccinated + 1, shared->dim_cum_n_I_A_vaccinated);
  index[110] = integer_sequence(shared->offset_variable_cum_n_I_P_vaccinated + 1, shared->dim_cum_n_I_P_vaccinated);
  index[111] = integer_sequence(shared->offset_variable_cum_n_R_vaccinated + 1, shared->dim_cum_n_R_vaccinated);
  index[112] = integer_sequence(shared->offset_variable_cum_n_vaccinated + 1, shared->dim_cum_n_vaccinated);
  index[113] = integer_sequence(shared->offset_variable_diagnoses_admitted + 1, shared->dim_diagnoses_admitted);
  index[114] = integer_sequence(shared->offset_variable_cum_infections_disag + 1, shared->dim_cum_infections_disag);
  index[115] = integer_sequence(shared->offset_variable_D + 1, shared->dim_D);
  index[116] = integer_sequence(shared->offset_variable_S + 1, shared->dim_S);
  index[117] = integer_sequence(shared->offset_variable_vaccine_missed_doses + 1, shared->dim_vaccine_missed_doses);
  index[118] = integer_sequence(shared->offset_variable_tmp_vaccine_n_candidates + 1, shared->dim_tmp_vaccine_n_candidates);
  index[119] = integer_sequence(shared->offset_variable_tmp_vaccine_probability + 1, shared->dim_tmp_vaccine_probability);
  index[120] = integer_sequence(shared->offset_variable_T_sero_neg_1 + 1, shared->dim_T_sero_neg_1);
  index[121] = integer_sequence(shared->offset_variable_T_sero_neg_2 + 1, shared->dim_T_sero_neg_2);
  index[122] = integer_sequence(shared->offset_variable_R + 1, shared->dim_R);
  index[123] = integer_sequence(shared->offset_variable_T_PCR_neg + 1, shared->dim_T_PCR_neg);
  index[124] = integer_sequence(shared->offset_variable_I_weighted + 1, shared->dim_I_weighted);
  index[125] = integer_sequence(shared->offset_variable_E + 1, shared->dim_E);
  index[126] = integer_sequence(shared->offset_variable_I_A + 1, shared->dim_I_A);
  index[127] = integer_sequence(shared->offset_variable_I_P + 1, shared->dim_I_P);
  index[128] = integer_sequence(shared->offset_variable_I_C_1 + 1, shared->dim_I_C_1);
  index[129] = integer_sequence(shared->offset_variable_I_C_2 + 1, shared->dim_I_C_2);
  index[130] = integer_sequence(shared->offset_variable_G_D + 1, shared->dim_G_D);
  index[131] = integer_sequence(shared->offset_variable_ICU_pre_unconf + 1, shared->dim_ICU_pre_unconf);
  index[132] = integer_sequence(shared->offset_variable_ICU_pre_conf + 1, shared->dim_ICU_pre_conf);
  index[133] = integer_sequence(shared->offset_variable_H_R_unconf + 1, shared->dim_H_R_unconf);
  index[134] = integer_sequence(shared->offset_variable_H_R_conf + 1, shared->dim_H_R_conf);
  index[135] = integer_sequence(shared->offset_variable_H_D_unconf + 1, shared->dim_H_D_unconf);
  index[136] = integer_sequence(shared->offset_variable_H_D_conf + 1, shared->dim_H_D_conf);
  index[137] = integer_sequence(shared->offset_variable_ICU_W_R_unconf + 1, shared->dim_ICU_W_R_unconf);
  index[138] = integer_sequence(shared->offset_variable_ICU_W_R_conf + 1, shared->dim_ICU_W_R_conf);
  index[139] = integer_sequence(shared->offset_variable_ICU_W_D_unconf + 1, shared->dim_ICU_W_D_unconf);
  index[140] = integer_sequence(shared->offset_variable_ICU_W_D_conf + 1, shared->dim_ICU_W_D_conf);
  index[141] = integer_sequence(shared->offset_variable_ICU_D_unconf + 1, shared->dim_ICU_D_unconf);
  index[142] = integer_sequence(shared->offset_variable_ICU_D_conf + 1, shared->dim_ICU_D_conf);
  index[143] = integer_sequence(shared->offset_variable_W_R_unconf + 1, shared->dim_W_R_unconf);
  index[144] = integer_sequence(shared->offset_variable_W_R_conf + 1, shared->dim_W_R_conf);
  index[145] = integer_sequence(shared->offset_variable_W_D_unconf + 1, shared->dim_W_D_unconf);
  index[146] = integer_sequence(shared->offset_variable_W_D_conf + 1, shared->dim_W_D_conf);
  index[147] = integer_sequence(shared->offset_variable_T_sero_pre_1 + 1, shared->dim_T_sero_pre_1);
  index[148] = integer_sequence(shared->offset_variable_T_sero_pos_1 + 1, shared->dim_T_sero_pos_1);
  index[149] = integer_sequence(shared->offset_variable_T_sero_pre_2 + 1, shared->dim_T_sero_pre_2);
  index[150] = integer_sequence(shared->offset_variable_T_sero_pos_2 + 1, shared->dim_T_sero_pos_2);
  index[151] = integer_sequence(shared->offset_variable_T_PCR_pre + 1, shared->dim_T_PCR_pre);
  index[152] = integer_sequence(shared->offset_variable_T_PCR_pos + 1, shared->dim_T_PCR_pos);
  index.names() = nms;
