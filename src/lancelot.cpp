...
#include <cpp11.hpp>
[[cpp11::register]]
SEXP dust_lancelot_alloc(cpp11::list r_pars, bool pars_multi, size_t step,
                         cpp11::sexp r_n_particles, size_t n_threads,
                         cpp11::sexp r_seed, cpp11::sexp device_config);

[[cpp11::register]]
SEXP dust_lancelot_run(SEXP ptr, size_t step_end, bool device,
                       bool deterministic);

[[cpp11::register]]
SEXP dust_lancelot_simulate(SEXP ptr, cpp11::sexp step_end, bool device,
                            bool deterministic);

[[cpp11::register]]
SEXP dust_lancelot_set_index(SEXP ptr, cpp11::sexp r_index);

[[cpp11::register]]
SEXP dust_lancelot_set_state(SEXP ptr, SEXP r_state, SEXP r_step,
                             bool deterministic);

[[cpp11::register]]
SEXP dust_lancelot_reset(SEXP ptr, cpp11::list r_pars, size_t step);

[[cpp11::register]]
SEXP dust_lancelot_state(SEXP ptr, SEXP r_index);

[[cpp11::register]]
size_t dust_lancelot_step(SEXP ptr);

[[cpp11::register]]
void dust_lancelot_reorder(SEXP ptr, cpp11::sexp r_index);

[[cpp11::register]]
SEXP dust_lancelot_resample(SEXP ptr, cpp11::doubles r_weights);

[[cpp11::register]]
SEXP dust_lancelot_set_pars(SEXP ptr, cpp11::list r_pars);

[[cpp11::register]]
SEXP dust_lancelot_rng_state(SEXP ptr, bool first_only, bool last_only);

[[cpp11::register]]
SEXP dust_lancelot_set_rng_state(SEXP ptr, cpp11::raws rng_state);

[[cpp11::register]]
SEXP dust_lancelot_set_data(SEXP ptr, cpp11::list data);

[[cpp11::register]]
SEXP dust_lancelot_compare_data(SEXP ptr, bool device);

[[cpp11::register]]
SEXP dust_lancelot_filter(SEXP ptr, bool save_trajectories,
...
[[cpp11::register]]
void dust_lancelot_set_n_threads(SEXP ptr, int n_threads);

[[cpp11::register]]
int dust_lancelot_n_state(SEXP ptr);
...
SEXP dust_lancelot_alloc(cpp11::list r_pars, bool pars_multi, size_t step,
                         cpp11::sexp r_n_particles, size_t n_threads,
                         cpp11::sexp r_seed, cpp11::sexp device_config) {
  return dust::r::dust_alloc<lancelot>(r_pars, pars_multi, step, r_n_particles,
                                        n_threads, r_seed, device_config);
}

SEXP dust_lancelot_run(SEXP ptr, size_t step_end, bool device,
                       bool deterministic) {
  return dust::r::dust_run<lancelot>(ptr, step_end, device, deterministic);
}

SEXP dust_lancelot_simulate(SEXP ptr, cpp11::sexp step_end, bool device,
                            bool deterministic) {
  return dust::r::dust_simulate<lancelot>(ptr, step_end, device,
                                           deterministic);
}

SEXP dust_lancelot_set_index(SEXP ptr, cpp11::sexp r_index) {
  dust::r::dust_set_index<lancelot>(ptr, r_index);
  return R_NilValue;
}

SEXP dust_lancelot_set_state(SEXP ptr, SEXP r_state, SEXP r_step,
                             bool deterministic) {
  dust::r::dust_set_state<lancelot>(ptr, r_state, r_step, deterministic);
  return R_NilValue;
}

SEXP dust_lancelot_reset(SEXP ptr, cpp11::list r_pars, size_t step) {
  return dust::r::dust_reset<lancelot>(ptr, r_pars, step);
}

SEXP dust_lancelot_state(SEXP ptr, SEXP r_index) {
  return dust::r::dust_state<lancelot>(ptr, r_index);
}

size_t dust_lancelot_step(SEXP ptr) {
  return dust::r::dust_step<lancelot>(ptr);
}

void dust_lancelot_reorder(SEXP ptr, cpp11::sexp r_index) {
  return dust::r::dust_reorder<lancelot>(ptr, r_index);
}

SEXP dust_lancelot_resample(SEXP ptr, cpp11::doubles r_weights) {
  return dust::r::dust_resample<lancelot>(ptr, r_weights);
}

SEXP dust_lancelot_set_pars(SEXP ptr, cpp11::list r_pars) {
  return dust::r::dust_set_pars<lancelot>(ptr, r_pars);
}

SEXP dust_lancelot_rng_state(SEXP ptr, bool first_only, bool last_only) {
  return dust::r::dust_rng_state<lancelot>(ptr, first_only, last_only);
}

SEXP dust_lancelot_set_rng_state(SEXP ptr, cpp11::raws rng_state) {
  dust::r::dust_set_rng_state<lancelot>(ptr, rng_state);
  return R_NilValue;
}

SEXP dust_lancelot_set_data(SEXP ptr, cpp11::list data) {
  dust::r::dust_set_data<lancelot>(ptr, data);
  return R_NilValue;
}

SEXP dust_lancelot_compare_data(SEXP ptr, bool device) {
  return dust::r::dust_compare_data<lancelot>(ptr, device);
}

SEXP dust_lancelot_filter(SEXP ptr, bool save_trajectories,
                          cpp11::sexp step_snapshot,
                          bool device) {
  return dust::r::dust_filter<lancelot>(ptr, save_trajectories, step_snapshot, device);
}

cpp11::sexp dust_lancelot_capabilities() {
  return dust::r::dust_capabilities<lancelot>();
}

void dust_lancelot_set_n_threads(SEXP ptr, int n_threads) {
  return dust::r::dust_set_n_threads<lancelot>(ptr, n_threads);
}

int dust_lancelot_n_state(SEXP ptr) {
  return dust::r::dust_n_state<lancelot>(ptr);
}

cpp11::sexp dust_lancelot_device_info() {
  return dust::cuda::device_info<lancelot::real_t>();
}
