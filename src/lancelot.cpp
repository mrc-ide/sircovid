...
[[cpp11::register]]
SEXP dust_lancelot_update_state(SEXP ptr, SEXP r_pars, SEXP r_state,
...
SEXP dust_lancelot_run(SEXP ptr, size_t step_end, bool device) {
  return dust::r::dust_run<lancelot>(ptr, step_end, device);
}
...
SEXP dust_lancelot_update_state(SEXP ptr, SEXP r_pars, SEXP r_state,
                                SEXP r_step, SEXP r_set_initial_state) {
  return dust::r::dust_update_state<lancelot>(ptr, r_pars, r_state, r_step,
                                               r_set_initial_state);
}
