...
typename T::real_type
  compare(const typename T::real_type * state,
    ...
    const real_type model_icu = state[29];
    const real_type model_general = state[30];
    const real_type model_hosp = model_icu + model_general;
    const real_type model_deaths_carehomes = state[44];
    const real_type model_deaths_comm = state[42];
    ...
    const real_type model_sympt_cases_non_variant_over25 =
      state[71];
    const real_type model_react_pos = state[78];
...
public:
  ...
  struct shared_type {
    ...
    real_type initial_cum_all_admission_0_9_conf;
    real_type initial_cum_all_admission_10_19_conf;
    real_type initial_cum_all_admission_20_29_conf;
    real_type initial_cum_all_admission_30_39_conf;
    real_type initial_cum_all_admission_40_49_conf;
    real_type initial_cum_all_admission_50_59_conf;
    real_type initial_cum_all_admission_60_69_conf;
    real_type initial_cum_all_admission_70_79_conf;
    real_type initial_cum_all_admission_80_plus_conf;
  ...
  std::vector<real_type> initial(size_t step) {
    ...
    state[15] = shared->initial_cum_new_conf;
    state[16] = shared->initial_cum_all_admission_0_9_conf;
    state[17] = shared->initial_cum_all_admission_10_19_conf;
    state[18] = shared->initial_cum_all_admission_20_29_conf;
    state[19] = shared->initial_cum_all_admission_30_39_conf;
    state[20] = shared->initial_cum_all_admission_40_49_conf;
    state[21] = shared->initial_cum_all_admission_50_59_conf;
    state[22] = shared->initial_cum_all_admission_60_69_conf;
    state[23] = shared->initial_cum_all_admission_70_79_conf;
    state[24] = shared->initial_cum_all_admission_80_plus_conf;
    state[25] = shared->initial_beta_out;
    state[26] = shared->initial_N_tot_sero_1;
    state[27] = shared->initial_N_tot_sero_2;
    state[28] = shared->initial_N_tot_PCR;
    state[29] = shared->initial_ICU_tot;
    state[30] = shared->initial_general_tot;
    state[31] = shared->initial_hosp_tot;
    state[32] = shared->initial_D_hosp_tot;
    state[33] = shared->initial_D_hosp_0_49_tot;
    state[34] = shared->initial_D_hosp_50_54_tot;
    state[35] = shared->initial_D_hosp_55_59_tot;
    state[36] = shared->initial_D_hosp_60_64_tot;
    state[37] = shared->initial_D_hosp_65_69_tot;
    state[38] = shared->initial_D_hosp_70_74_tot;
    state[39] = shared->initial_D_hosp_75_79_tot;
    state[40] = shared->initial_D_hosp_80_plus_tot;
    state[41] = shared->initial_D_comm_tot;
    state[42] = shared->initial_D_comm_inc;
    ...
    state[78] = shared->initial_react_pos;
    std::copy(shared->initial_cum_n_S_vacc_skip.begin(), shared->initial_cum_n_S_vacc_skip.end(), state.begin() + 79);
  ...
  void update(size_t step, const real_type * state, rng_state_type& rng_state, real_type * state_next) {
    ...
    const real_type * cum_n_S_vacc_skip = state + 79;
    ...
    const real_type cum_new_conf = state[15];
    const real_type cum_all_admission_0_9_conf = state[16];
    const real_type cum_all_admission_10_19_conf = state[17];
    const real_type cum_all_admission_20_29_conf = state[18];
    const real_type cum_all_admission_30_39_conf = state[19];
    const real_type cum_all_admission_40_49_conf = state[20];
    const real_type cum_all_admission_50_59_conf = state[21];
    const real_type cum_all_admission_60_69_conf = state[22];
    const real_type cum_all_admission_70_79_conf = state[23];
    const real_type cum_all_admission_80_plus_conf = state[24];
    ...
    const real_type D_hosp_tot = state[32];
    const real_type D_hosp_0_49_tot = state[33];
    const real_type D_hosp_50_54_tot = state[34];
    const real_type D_hosp_55_59_tot = state[35];
    const real_type D_hosp_60_64_tot = state[36];
    const real_type D_hosp_65_69_tot = state[37];
    const real_type D_hosp_70_74_tot = state[38];
    const real_type D_hosp_75_79_tot = state[39];
    const real_type D_hosp_80_plus_tot = state[40];
    const real_type D_comm_tot = state[41];
    const real_type D_comm_inc = state[42];
    ...
    state_next[28] = odin_sum1<real_type>(S, 0, shared->dim_S) + odin_sum1<real_type>(T_PCR_pre, 0, shared->dim_T_PCR_pre) + odin_sum1<real_type>(T_PCR_pos, 0, shared->dim_T_PCR_pos) + odin_sum1<real_type>(T_PCR_neg, 0, shared->dim_T_PCR_neg);
    state_next[26] = odin_sum1<real_type>(S, 0, shared->dim_S) + odin_sum1<real_type>(T_sero_pre_1, 0, shared->dim_T_sero_pre_1) + odin_sum1<real_type>(T_sero_pos_1, 0, shared->dim_T_sero_pos_1) + odin_sum1<real_type>(T_sero_neg_1, 0, shared->dim_T_sero_neg_1) + odin_sum1<real_type>(E, 0, shared->dim_E);
    state_next[27] = odin_sum1<real_type>(S, 0, shared->dim_S) + odin_sum1<real_type>(T_sero_pre_2, 0, shared->dim_T_sero_pre_2) + odin_sum1<real_type>(T_sero_pos_2, 0, shared->dim_T_sero_pos_2) + odin_sum1<real_type>(T_sero_neg_2, 0, shared->dim_T_sero_neg_2) + odin_sum1<real_type>(E, 0, shared->dim_E);
    ...
    for (int i = 1; i <= shared->dim_cum_n_S_vacc_skip; ++i) {
      state_next[79 + i - 1] = cum_n_S_vacc_skip[i - 1] + internal.n_S_vacc_skip[i - 1];
    }
    ...
    state_next[12] = cum_infections + delta_infections;
    ...
    state_next[13] = (fmodr<real_type>(step, shared->steps_per_day) == 0 ? delta_infections : infections_inc + delta_infections);
    state_next[78] = odin_sum4<real_type>(internal.new_T_PCR_pos.data(), 1, 18, 0, shared->dim_new_T_PCR_pos_2, 0, shared->dim_new_T_PCR_pos_3, 0, shared->dim_new_T_PCR_pos_4, shared->dim_new_T_PCR_pos_1, shared->dim_new_T_PCR_pos_12, shared->dim_new_T_PCR_pos_123);
    ...
    state_next[16] = cum_all_admission_0_9_conf + delta_all_admission_0_9_conf;
    state_next[17] = cum_all_admission_10_19_conf + delta_all_admission_10_19_conf;
    state_next[18] = cum_all_admission_20_29_conf + delta_all_admission_20_29_conf;
    state_next[19] = cum_all_admission_30_39_conf + delta_all_admission_30_39_conf;
    state_next[20] = cum_all_admission_40_49_conf + delta_all_admission_40_49_conf;
    state_next[21] = cum_all_admission_50_59_conf + delta_all_admission_50_59_conf;
    state_next[22] = cum_all_admission_60_69_conf + delta_all_admission_60_69_conf;
    state_next[23] = cum_all_admission_70_79_conf + delta_all_admission_70_79_conf;
    state_next[24] = cum_all_admission_80_plus_conf + delta_all_admission_80_plus_conf;
    ...
    state_next[30] = new_general_tot;
    state_next[31] = new_ICU_tot + new_general_tot;
...
dust::pars_type<lancelot> dust_pars<lancelot>(cpp11::list user) {
  ...
  shared->initial_cum_all_admission_0_9_conf = 0;
  shared->initial_cum_all_admission_10_19_conf = 0;
  shared->initial_cum_all_admission_20_29_conf = 0;
  shared->initial_cum_all_admission_30_39_conf = 0;
  shared->initial_cum_all_admission_40_49_conf = 0;
  shared->initial_cum_all_admission_50_59_conf = 0;
  shared->initial_cum_all_admission_60_69_conf = 0;
  shared->initial_cum_all_admission_70_79_conf = 0;
  shared->initial_cum_all_admission_80_plus_conf = 0;
  ...
  shared->offset_variable_D_hosp = shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_vacc_skip + 79;
  shared->offset_variable_D_non_hosp = shared->dim_D_hosp + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_vacc_skip + 79;
  ...
  shared->offset_variable_cum_admit_by_age = shared->dim_D_hosp + shared->dim_D_non_hosp + shared->dim_cum_infections_per_strain + shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_vacc_skip + 79;
  shared->offset_variable_cum_infections_per_strain = shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_S_vacc_skip + shared->dim_cum_n_vacc_skip + 79;
  shared->offset_variable_cum_n_E_vacc_skip = shared->dim_cum_n_S_vacc_skip + 79;
  shared->offset_variable_cum_n_I_A_vacc_skip = shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_S_vacc_skip + 79;
  shared->offset_variable_cum_n_I_P_vacc_skip = shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_S_vacc_skip + 79;
  shared->offset_variable_cum_n_R_vacc_skip = shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_S_vacc_skip + 79;
  shared->offset_variable_cum_n_vacc_skip = shared->dim_cum_n_E_vacc_skip + shared->dim_cum_n_I_A_vacc_skip + shared->dim_cum_n_I_P_vacc_skip + shared->dim_cum_n_R_vacc_skip + shared->dim_cum_n_S_vacc_skip + 79;
...
cpp11::sexp dust_info<lancelot>(const dust::pars_type<lancelot>& pars) {
  ...
  dim[79] = cpp11::writable::integers({shared->dim_cum_n_S_vacc_skip});
  dim[80] = cpp11::writable::integers({shared->dim_cum_n_E_vacc_skip});
  dim[81] = cpp11::writable::integers({shared->dim_cum_n_I_A_vacc_skip});
  dim[82] = cpp11::writable::integers({shared->dim_cum_n_I_P_vacc_skip});
  dim[83] = cpp11::writable::integers({shared->dim_cum_n_R_vacc_skip});
  dim[84] = cpp11::writable::integers({shared->dim_cum_n_vacc_skip});
  dim[85] = cpp11::writable::integers({shared->dim_cum_infections_per_strain});
  dim[86] = cpp11::writable::integers({shared->dim_D_hosp});
  dim[87] = cpp11::writable::integers({shared->dim_D_non_hosp});
  dim[88] = cpp11::writable::integers({shared->dim_cum_admit_by_age});
  dim[89] = cpp11::writable::integers({shared->dim_N_tot});
  dim[90] = cpp11::writable::integers({shared->dim_prob_strain});
  dim[91] = cpp11::writable::integers({shared->dim_cum_n_S_vaccinated_1, shared->dim_cum_n_S_vaccinated_2});
  dim[92] = cpp11::writable::integers({shared->dim_cum_n_E_vaccinated_1, shared->dim_cum_n_E_vaccinated_2});
  dim[93] = cpp11::writable::integers({shared->dim_cum_n_I_A_vaccinated_1, shared->dim_cum_n_I_A_vaccinated_2});
  dim[94] = cpp11::writable::integers({shared->dim_cum_n_I_P_vaccinated_1, shared->dim_cum_n_I_P_vaccinated_2});
  dim[95] = cpp11::writable::integers({shared->dim_cum_n_R_vaccinated_1, shared->dim_cum_n_R_vaccinated_2});
  dim[96] = cpp11::writable::integers({shared->dim_cum_n_vaccinated_1, shared->dim_cum_n_vaccinated_2});
  dim[97] = cpp11::writable::integers({shared->dim_diagnoses_admitted_1, shared->dim_diagnoses_admitted_2});
  dim[98] = cpp11::writable::integers({shared->dim_cum_infections_disag_1, shared->dim_cum_infections_disag_2});
  dim[99] = cpp11::writable::integers({shared->dim_D_1, shared->dim_D_2});
  dim[100] = cpp11::writable::integers({shared->dim_S_1, shared->dim_S_2});
  dim[101] = cpp11::writable::integers({shared->dim_vaccine_missed_doses_1, shared->dim_vaccine_missed_doses_2});
  dim[102] = cpp11::writable::integers({shared->dim_tmp_vaccine_n_candidates_1, shared->dim_tmp_vaccine_n_candidates_2});
  dim[103] = cpp11::writable::integers({shared->dim_tmp_vaccine_probability_1, shared->dim_tmp_vaccine_probability_2});
  dim[104] = cpp11::writable::integers({shared->dim_T_sero_neg_1_1, shared->dim_T_sero_neg_1_2, shared->dim_T_sero_neg_1_3});
  dim[105] = cpp11::writable::integers({shared->dim_T_sero_neg_2_1, shared->dim_T_sero_neg_2_2, shared->dim_T_sero_neg_2_3});
  dim[106] = cpp11::writable::integers({shared->dim_R_1, shared->dim_R_2, shared->dim_R_3});
  dim[107] = cpp11::writable::integers({shared->dim_T_PCR_neg_1, shared->dim_T_PCR_neg_2, shared->dim_T_PCR_neg_3});
  dim[108] = cpp11::writable::integers({shared->dim_I_weighted_1, shared->dim_I_weighted_2, shared->dim_I_weighted_3});
  dim[109] = cpp11::writable::integers({shared->dim_E_1, shared->dim_E_2, shared->dim_E_3, shared->dim_E_4});
  dim[110] = cpp11::writable::integers({shared->dim_I_A_1, shared->dim_I_A_2, shared->dim_I_A_3, shared->dim_I_A_4});
  dim[111] = cpp11::writable::integers({shared->dim_I_P_1, shared->dim_I_P_2, shared->dim_I_P_3, shared->dim_I_P_4});
  dim[112] = cpp11::writable::integers({shared->dim_I_C_1_1, shared->dim_I_C_1_2, shared->dim_I_C_1_3, shared->dim_I_C_1_4});
  dim[113] = cpp11::writable::integers({shared->dim_I_C_2_1, shared->dim_I_C_2_2, shared->dim_I_C_2_3, shared->dim_I_C_2_4});
  dim[114] = cpp11::writable::integers({shared->dim_G_D_1, shared->dim_G_D_2, shared->dim_G_D_3, shared->dim_G_D_4});
  dim[115] = cpp11::writable::integers({shared->dim_ICU_pre_unconf_1, shared->dim_ICU_pre_unconf_2, shared->dim_ICU_pre_unconf_3, shared->dim_ICU_pre_unconf_4});
  dim[116] = cpp11::writable::integers({shared->dim_ICU_pre_conf_1, shared->dim_ICU_pre_conf_2, shared->dim_ICU_pre_conf_3, shared->dim_ICU_pre_conf_4});
  dim[117] = cpp11::writable::integers({shared->dim_H_R_unconf_1, shared->dim_H_R_unconf_2, shared->dim_H_R_unconf_3, shared->dim_H_R_unconf_4});
  dim[118] = cpp11::writable::integers({shared->dim_H_R_conf_1, shared->dim_H_R_conf_2, shared->dim_H_R_conf_3, shared->dim_H_R_conf_4});
  dim[119] = cpp11::writable::integers({shared->dim_H_D_unconf_1, shared->dim_H_D_unconf_2, shared->dim_H_D_unconf_3, shared->dim_H_D_unconf_4});
  dim[120] = cpp11::writable::integers({shared->dim_H_D_conf_1, shared->dim_H_D_conf_2, shared->dim_H_D_conf_3, shared->dim_H_D_conf_4});
  dim[121] = cpp11::writable::integers({shared->dim_ICU_W_R_unconf_1, shared->dim_ICU_W_R_unconf_2, shared->dim_ICU_W_R_unconf_3, shared->dim_ICU_W_R_unconf_4});
  dim[122] = cpp11::writable::integers({shared->dim_ICU_W_R_conf_1, shared->dim_ICU_W_R_conf_2, shared->dim_ICU_W_R_conf_3, shared->dim_ICU_W_R_conf_4});
  dim[123] = cpp11::writable::integers({shared->dim_ICU_W_D_unconf_1, shared->dim_ICU_W_D_unconf_2, shared->dim_ICU_W_D_unconf_3, shared->dim_ICU_W_D_unconf_4});
  dim[124] = cpp11::writable::integers({shared->dim_ICU_W_D_conf_1, shared->dim_ICU_W_D_conf_2, shared->dim_ICU_W_D_conf_3, shared->dim_ICU_W_D_conf_4});
  dim[125] = cpp11::writable::integers({shared->dim_ICU_D_unconf_1, shared->dim_ICU_D_unconf_2, shared->dim_ICU_D_unconf_3, shared->dim_ICU_D_unconf_4});
  dim[126] = cpp11::writable::integers({shared->dim_ICU_D_conf_1, shared->dim_ICU_D_conf_2, shared->dim_ICU_D_conf_3, shared->dim_ICU_D_conf_4});
  dim[127] = cpp11::writable::integers({shared->dim_W_R_unconf_1, shared->dim_W_R_unconf_2, shared->dim_W_R_unconf_3, shared->dim_W_R_unconf_4});
  dim[128] = cpp11::writable::integers({shared->dim_W_R_conf_1, shared->dim_W_R_conf_2, shared->dim_W_R_conf_3, shared->dim_W_R_conf_4});
  dim[129] = cpp11::writable::integers({shared->dim_W_D_unconf_1, shared->dim_W_D_unconf_2, shared->dim_W_D_unconf_3, shared->dim_W_D_unconf_4});
  dim[130] = cpp11::writable::integers({shared->dim_W_D_conf_1, shared->dim_W_D_conf_2, shared->dim_W_D_conf_3, shared->dim_W_D_conf_4});
  dim[131] = cpp11::writable::integers({shared->dim_T_sero_pre_1_1, shared->dim_T_sero_pre_1_2, shared->dim_T_sero_pre_1_3, shared->dim_T_sero_pre_1_4});
  dim[132] = cpp11::writable::integers({shared->dim_T_sero_pos_1_1, shared->dim_T_sero_pos_1_2, shared->dim_T_sero_pos_1_3, shared->dim_T_sero_pos_1_4});
  dim[133] = cpp11::writable::integers({shared->dim_T_sero_pre_2_1, shared->dim_T_sero_pre_2_2, shared->dim_T_sero_pre_2_3, shared->dim_T_sero_pre_2_4});
  dim[134] = cpp11::writable::integers({shared->dim_T_sero_pos_2_1, shared->dim_T_sero_pos_2_2, shared->dim_T_sero_pos_2_3, shared->dim_T_sero_pos_2_4});
  dim[135] = cpp11::writable::integers({shared->dim_T_PCR_pre_1, shared->dim_T_PCR_pre_2, shared->dim_T_PCR_pre_3, shared->dim_T_PCR_pre_4});
  dim[136] = cpp11::writable::integers({shared->dim_T_PCR_pos_1, shared->dim_T_PCR_pos_2, shared->dim_T_PCR_pos_3, shared->dim_T_PCR_pos_4});
  dim.names() = nms;
  cpp11::writable::list index(137);
  ...
  index[79] = integer_sequence(80, shared->dim_cum_n_S_vacc_skip);
  index[80] = integer_sequence(shared->offset_variable_cum_n_E_vacc_skip + 1, shared->dim_cum_n_E_vacc_skip);
  index[81] = integer_sequence(shared->offset_variable_cum_n_I_A_vacc_skip + 1, shared->dim_cum_n_I_A_vacc_skip);
  index[82] = integer_sequence(shared->offset_variable_cum_n_I_P_vacc_skip + 1, shared->dim_cum_n_I_P_vacc_skip);
  index[83] = integer_sequence(shared->offset_variable_cum_n_R_vacc_skip + 1, shared->dim_cum_n_R_vacc_skip);
  index[84] = integer_sequence(shared->offset_variable_cum_n_vacc_skip + 1, shared->dim_cum_n_vacc_skip);
  index[85] = integer_sequence(shared->offset_variable_cum_infections_per_strain + 1, shared->dim_cum_infections_per_strain);
  index[86] = integer_sequence(shared->offset_variable_D_hosp + 1, shared->dim_D_hosp);
  index[87] = integer_sequence(shared->offset_variable_D_non_hosp + 1, shared->dim_D_non_hosp);
  index[88] = integer_sequence(shared->offset_variable_cum_admit_by_age + 1, shared->dim_cum_admit_by_age);
  index[89] = integer_sequence(shared->offset_variable_N_tot + 1, shared->dim_N_tot);
  index[90] = integer_sequence(shared->offset_variable_prob_strain + 1, shared->dim_prob_strain);
  index[91] = integer_sequence(shared->offset_variable_cum_n_S_vaccinated + 1, shared->dim_cum_n_S_vaccinated);
  index[92] = integer_sequence(shared->offset_variable_cum_n_E_vaccinated + 1, shared->dim_cum_n_E_vaccinated);
  index[93] = integer_sequence(shared->offset_variable_cum_n_I_A_vaccinated + 1, shared->dim_cum_n_I_A_vaccinated);
  index[94] = integer_sequence(shared->offset_variable_cum_n_I_P_vaccinated + 1, shared->dim_cum_n_I_P_vaccinated);
  index[95] = integer_sequence(shared->offset_variable_cum_n_R_vaccinated + 1, shared->dim_cum_n_R_vaccinated);
  index[96] = integer_sequence(shared->offset_variable_cum_n_vaccinated + 1, shared->dim_cum_n_vaccinated);
  index[97] = integer_sequence(shared->offset_variable_diagnoses_admitted + 1, shared->dim_diagnoses_admitted);
  index[98] = integer_sequence(shared->offset_variable_cum_infections_disag + 1, shared->dim_cum_infections_disag);
  index[99] = integer_sequence(shared->offset_variable_D + 1, shared->dim_D);
  index[100] = integer_sequence(shared->offset_variable_S + 1, shared->dim_S);
  index[101] = integer_sequence(shared->offset_variable_vaccine_missed_doses + 1, shared->dim_vaccine_missed_doses);
  index[102] = integer_sequence(shared->offset_variable_tmp_vaccine_n_candidates + 1, shared->dim_tmp_vaccine_n_candidates);
  index[103] = integer_sequence(shared->offset_variable_tmp_vaccine_probability + 1, shared->dim_tmp_vaccine_probability);
  index[104] = integer_sequence(shared->offset_variable_T_sero_neg_1 + 1, shared->dim_T_sero_neg_1);
  index[105] = integer_sequence(shared->offset_variable_T_sero_neg_2 + 1, shared->dim_T_sero_neg_2);
  index[106] = integer_sequence(shared->offset_variable_R + 1, shared->dim_R);
  index[107] = integer_sequence(shared->offset_variable_T_PCR_neg + 1, shared->dim_T_PCR_neg);
  index[108] = integer_sequence(shared->offset_variable_I_weighted + 1, shared->dim_I_weighted);
  index[109] = integer_sequence(shared->offset_variable_E + 1, shared->dim_E);
  index[110] = integer_sequence(shared->offset_variable_I_A + 1, shared->dim_I_A);
  index[111] = integer_sequence(shared->offset_variable_I_P + 1, shared->dim_I_P);
  index[112] = integer_sequence(shared->offset_variable_I_C_1 + 1, shared->dim_I_C_1);
  index[113] = integer_sequence(shared->offset_variable_I_C_2 + 1, shared->dim_I_C_2);
  index[114] = integer_sequence(shared->offset_variable_G_D + 1, shared->dim_G_D);
  index[115] = integer_sequence(shared->offset_variable_ICU_pre_unconf + 1, shared->dim_ICU_pre_unconf);
  index[116] = integer_sequence(shared->offset_variable_ICU_pre_conf + 1, shared->dim_ICU_pre_conf);
  index[117] = integer_sequence(shared->offset_variable_H_R_unconf + 1, shared->dim_H_R_unconf);
  index[118] = integer_sequence(shared->offset_variable_H_R_conf + 1, shared->dim_H_R_conf);
  index[119] = integer_sequence(shared->offset_variable_H_D_unconf + 1, shared->dim_H_D_unconf);
  index[120] = integer_sequence(shared->offset_variable_H_D_conf + 1, shared->dim_H_D_conf);
  index[121] = integer_sequence(shared->offset_variable_ICU_W_R_unconf + 1, shared->dim_ICU_W_R_unconf);
  index[122] = integer_sequence(shared->offset_variable_ICU_W_R_conf + 1, shared->dim_ICU_W_R_conf);
  index[123] = integer_sequence(shared->offset_variable_ICU_W_D_unconf + 1, shared->dim_ICU_W_D_unconf);
  index[124] = integer_sequence(shared->offset_variable_ICU_W_D_conf + 1, shared->dim_ICU_W_D_conf);
  index[125] = integer_sequence(shared->offset_variable_ICU_D_unconf + 1, shared->dim_ICU_D_unconf);
  index[126] = integer_sequence(shared->offset_variable_ICU_D_conf + 1, shared->dim_ICU_D_conf);
  index[127] = integer_sequence(shared->offset_variable_W_R_unconf + 1, shared->dim_W_R_unconf);
  index[128] = integer_sequence(shared->offset_variable_W_R_conf + 1, shared->dim_W_R_conf);
  index[129] = integer_sequence(shared->offset_variable_W_D_unconf + 1, shared->dim_W_D_unconf);
  index[130] = integer_sequence(shared->offset_variable_W_D_conf + 1, shared->dim_W_D_conf);
  index[131] = integer_sequence(shared->offset_variable_T_sero_pre_1 + 1, shared->dim_T_sero_pre_1);
  index[132] = integer_sequence(shared->offset_variable_T_sero_pos_1 + 1, shared->dim_T_sero_pos_1);
  index[133] = integer_sequence(shared->offset_variable_T_sero_pre_2 + 1, shared->dim_T_sero_pre_2);
  index[134] = integer_sequence(shared->offset_variable_T_sero_pos_2 + 1, shared->dim_T_sero_pos_2);
  index[135] = integer_sequence(shared->offset_variable_T_PCR_pre + 1, shared->dim_T_PCR_pre);
  index[136] = integer_sequence(shared->offset_variable_T_PCR_pos + 1, shared->dim_T_PCR_pos);
  index.names() = nms;
