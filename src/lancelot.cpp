...
cpp11::sexp dust_info<lancelot>(const dust::pars_type<lancelot>& pars) {
  ...
  dim[99] = cpp11::writable::integers({shared->dim_protected_S_vaccinated});
  dim[100] = cpp11::writable::integers({shared->dim_protected_R_unvaccinated});
  dim[101] = cpp11::writable::integers({shared->dim_protected_R_vaccinated});
  ...
  dim[133] = cpp11::writable::integers({shared->dim_IHR_disag_weighted_inc_1, shared->dim_IHR_disag_weighted_inc_2, shared->dim_IHR_disag_weighted_inc_3});
  dim[134] = cpp11::writable::integers({shared->dim_HFR_disag_weighted_inc_1, shared->dim_HFR_disag_weighted_inc_2, shared->dim_HFR_disag_weighted_inc_3});
  dim[135] = cpp11::writable::integers({shared->dim_IFR_disag_weighted_inc_1, shared->dim_IFR_disag_weighted_inc_2, shared->dim_IFR_disag_weighted_inc_3});
  ...
  index[99] = integer_sequence(shared->offset_variable_protected_S_vaccinated + 1, shared->dim_protected_S_vaccinated);
  index[100] = integer_sequence(shared->offset_variable_protected_R_unvaccinated + 1, shared->dim_protected_R_unvaccinated);
  index[101] = integer_sequence(shared->offset_variable_protected_R_vaccinated + 1, shared->dim_protected_R_vaccinated);
  ...
  index[133] = integer_sequence(shared->offset_variable_IHR_disag_weighted_inc + 1, shared->dim_IHR_disag_weighted_inc);
  index[134] = integer_sequence(shared->offset_variable_HFR_disag_weighted_inc + 1, shared->dim_HFR_disag_weighted_inc);
  index[135] = integer_sequence(shared->offset_variable_IFR_disag_weighted_inc + 1, shared->dim_IFR_disag_weighted_inc);
