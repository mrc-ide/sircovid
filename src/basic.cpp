...
SEXP dust_basic_rng_state(SEXP ptr, bool first_only) {
  return dust::r::dust_rng_state<basic>(ptr, first_only);
}
...
SEXP dust_basic_compare_data(SEXP ptr) {
  return dust::r::dust_compare_data<basic>(ptr);
}

SEXP dust_basic_filter(SEXP ptr, bool save_trajectories,
                          cpp11::sexp step_snapshot) {
  return dust::r::dust_filter<basic>(ptr, save_trajectories, step_snapshot);
}
