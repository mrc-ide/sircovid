...
SEXP basic_contents(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(contents, 249, ScalarInteger(internal->dim_tt));
  SET_VECTOR_ELT(contents, 250, ScalarInteger(internal->dim_y));
  SET_VECTOR_ELT(contents, 251, ScalarReal(internal->dt));
  ...
  SET_VECTOR_ELT(contents, 252, E0);
  SET_VECTOR_ELT(contents, 253, ScalarReal(internal->gamma_asympt));
  SET_VECTOR_ELT(contents, 254, ScalarReal(internal->gamma_E));
  SET_VECTOR_ELT(contents, 255, ScalarReal(internal->gamma_hosp));
  SET_VECTOR_ELT(contents, 256, ScalarReal(internal->gamma_ICU));
  SET_VECTOR_ELT(contents, 257, ScalarReal(internal->gamma_ILI));
  SET_VECTOR_ELT(contents, 258, ScalarReal(internal->gamma_mild));
  SET_VECTOR_ELT(contents, 259, ScalarReal(internal->gamma_rec));
  SET_VECTOR_ELT(contents, 260, ScalarReal(internal->hosp_transmission));
  ...
  SET_VECTOR_ELT(contents, 261, I_with_diff_trans);
  ...
  SET_VECTOR_ELT(contents, 262, I0_asympt);
  ...
  SET_VECTOR_ELT(contents, 263, I0_hosp);
  ...
  SET_VECTOR_ELT(contents, 264, I0_ICU);
  ...
  SET_VECTOR_ELT(contents, 265, I0_ILI);
  ...
  SET_VECTOR_ELT(contents, 269, initial_E);
  ...
  SET_VECTOR_ELT(contents, 270, initial_I_asympt);
  ...
  SET_VECTOR_ELT(contents, 271, initial_I_hosp);
  ...
  SET_VECTOR_ELT(contents, 272, initial_I_ICU);
  ...
  SET_VECTOR_ELT(contents, 273, initial_I_ILI);
  ...
  SET_VECTOR_ELT(contents, 274, initial_I_mild);
  ...
  SET_VECTOR_ELT(contents, 275, initial_R);
  ...
  SET_VECTOR_ELT(contents, 276, initial_R_hosp);
  ...
  SET_VECTOR_ELT(contents, 277, initial_S);
  ...
  SET_VECTOR_ELT(contents, 279, lambda);
  ...
  SET_VECTOR_ELT(contents, 280, m);
  SET_VECTOR_ELT(contents, 281, ScalarInteger(internal->N_age));
  ...
  SET_VECTOR_ELT(contents, 282, n_death_hosp);
  ...
  SET_VECTOR_ELT(contents, 283, n_EE);
  ...
  SET_VECTOR_ELT(contents, 284, n_EI_asympt);
  ...
  SET_VECTOR_ELT(contents, 285, n_EI_ILI);
  ...
  SET_VECTOR_ELT(contents, 286, n_EI_mild);
  ...
  SET_VECTOR_ELT(contents, 287, n_hosp_to_ICU);
  ...
  SET_VECTOR_ELT(contents, 288, n_ICU_to_R_hosp);
  ...
  SET_VECTOR_ELT(contents, 289, n_II_asympt);
  ...
  SET_VECTOR_ELT(contents, 290, n_II_hosp);
  ...
  SET_VECTOR_ELT(contents, 291, n_II_ICU);
  ...
  SET_VECTOR_ELT(contents, 292, n_II_ILI);
  ...
  SET_VECTOR_ELT(contents, 293, n_II_mild);
  ...
  SET_VECTOR_ELT(contents, 294, n_ILI_to_hosp);
  ...
  SET_VECTOR_ELT(contents, 295, n_R_hosp);
  SEXP n_SE = PROTECT(allocVector(REALSXP, internal->dim_n_SE));
  memcpy(REAL(n_SE), internal->n_SE, internal->dim_n_SE * sizeof(double));
  SET_VECTOR_ELT(contents, 296, n_SE);
  SET_VECTOR_ELT(contents, 297, ScalarInteger(internal->offset_output_n_EI_ILI));
  SET_VECTOR_ELT(contents, 298, ScalarInteger(internal->offset_output_n_EI_mild));
  SET_VECTOR_ELT(contents, 299, ScalarInteger(internal->offset_output_n_hosp_to_ICU));
  SET_VECTOR_ELT(contents, 300, ScalarInteger(internal->offset_output_n_ILI_to_hosp));
  SET_VECTOR_ELT(contents, 301, ScalarInteger(internal->offset_variable_D));
  SET_VECTOR_ELT(contents, 302, ScalarInteger(internal->offset_variable_E));
  SET_VECTOR_ELT(contents, 303, ScalarInteger(internal->offset_variable_I_asympt));
  SET_VECTOR_ELT(contents, 304, ScalarInteger(internal->offset_variable_I_hosp));
  SET_VECTOR_ELT(contents, 305, ScalarInteger(internal->offset_variable_I_ICU));
  SET_VECTOR_ELT(contents, 306, ScalarInteger(internal->offset_variable_I_ILI));
  SET_VECTOR_ELT(contents, 307, ScalarInteger(internal->offset_variable_I_mild));
  SET_VECTOR_ELT(contents, 308, ScalarInteger(internal->offset_variable_R_hosp));
  ...
  SET_VECTOR_ELT(contents, 309, p_asympt);
  ...
  SET_VECTOR_ELT(contents, 310, p_death_hosp);
  SET_VECTOR_ELT(contents, 311, ScalarReal(internal->p_EE));
  SET_VECTOR_ELT(contents, 312, ScalarReal(internal->p_II_asympt));
  SET_VECTOR_ELT(contents, 313, ScalarReal(internal->p_II_hosp));
  SET_VECTOR_ELT(contents, 314, ScalarReal(internal->p_II_ICU));
  SET_VECTOR_ELT(contents, 315, ScalarReal(internal->p_II_ILI));
  SET_VECTOR_ELT(contents, 316, ScalarReal(internal->p_II_mild));
  SET_VECTOR_ELT(contents, 317, ScalarReal(internal->p_R_hosp));
  ...
  SET_VECTOR_ELT(contents, 318, p_recov_hosp);
  ...
  SET_VECTOR_ELT(contents, 319, p_recov_ICU);
  ...
  SET_VECTOR_ELT(contents, 324, R0_hosp);
  SET_VECTOR_ELT(contents, 325, ScalarInteger(internal->s_asympt));
  SET_VECTOR_ELT(contents, 326, ScalarInteger(internal->s_E));
  SET_VECTOR_ELT(contents, 327, ScalarInteger(internal->s_hosp));
  SET_VECTOR_ELT(contents, 328, ScalarInteger(internal->s_ICU));
  ...
  SET_VECTOR_ELT(contents, 329, s_ij);
  SET_VECTOR_ELT(contents, 330, ScalarInteger(internal->s_ILI));
  SET_VECTOR_ELT(contents, 331, ScalarInteger(internal->s_mild));
  SET_VECTOR_ELT(contents, 332, ScalarInteger(internal->s_rec));
  SEXP S0 = PROTECT(allocVector(REALSXP, internal->dim_S0));
  memcpy(REAL(S0), internal->S0, internal->dim_S0 * sizeof(double));
  SET_VECTOR_ELT(contents, 333, S0);
  ...
  SET_STRING_ELT(nms, 249, mkChar("dim_tt"));
  SET_STRING_ELT(nms, 250, mkChar("dim_y"));
  SET_STRING_ELT(nms, 251, mkChar("dt"));
  SET_STRING_ELT(nms, 252, mkChar("E0"));
  SET_STRING_ELT(nms, 253, mkChar("gamma_asympt"));
  SET_STRING_ELT(nms, 254, mkChar("gamma_E"));
  SET_STRING_ELT(nms, 255, mkChar("gamma_hosp"));
  SET_STRING_ELT(nms, 256, mkChar("gamma_ICU"));
  SET_STRING_ELT(nms, 257, mkChar("gamma_ILI"));
  SET_STRING_ELT(nms, 258, mkChar("gamma_mild"));
  SET_STRING_ELT(nms, 259, mkChar("gamma_rec"));
  SET_STRING_ELT(nms, 260, mkChar("hosp_transmission"));
  SET_STRING_ELT(nms, 261, mkChar("I_with_diff_trans"));
  SET_STRING_ELT(nms, 262, mkChar("I0_asympt"));
  SET_STRING_ELT(nms, 263, mkChar("I0_hosp"));
  SET_STRING_ELT(nms, 264, mkChar("I0_ICU"));
  ...
  SET_STRING_ELT(nms, 269, mkChar("initial_E"));
  SET_STRING_ELT(nms, 270, mkChar("initial_I_asympt"));
  SET_STRING_ELT(nms, 271, mkChar("initial_I_hosp"));
  SET_STRING_ELT(nms, 272, mkChar("initial_I_ICU"));
  SET_STRING_ELT(nms, 273, mkChar("initial_I_ILI"));
  SET_STRING_ELT(nms, 274, mkChar("initial_I_mild"));
  SET_STRING_ELT(nms, 275, mkChar("initial_R"));
  SET_STRING_ELT(nms, 276, mkChar("initial_R_hosp"));
  SET_STRING_ELT(nms, 277, mkChar("initial_S"));
  SET_STRING_ELT(nms, 278, mkChar("interpolate_beta"));
  SET_STRING_ELT(nms, 279, mkChar("lambda"));
  SET_STRING_ELT(nms, 280, mkChar("m"));
  SET_STRING_ELT(nms, 281, mkChar("N_age"));
  SET_STRING_ELT(nms, 282, mkChar("n_death_hosp"));
  SET_STRING_ELT(nms, 283, mkChar("n_EE"));
  SET_STRING_ELT(nms, 284, mkChar("n_EI_asympt"));
  SET_STRING_ELT(nms, 285, mkChar("n_EI_ILI"));
  SET_STRING_ELT(nms, 286, mkChar("n_EI_mild"));
  SET_STRING_ELT(nms, 287, mkChar("n_hosp_to_ICU"));
  SET_STRING_ELT(nms, 288, mkChar("n_ICU_to_R_hosp"));
  SET_STRING_ELT(nms, 289, mkChar("n_II_asympt"));
  SET_STRING_ELT(nms, 290, mkChar("n_II_hosp"));
  SET_STRING_ELT(nms, 291, mkChar("n_II_ICU"));
  SET_STRING_ELT(nms, 292, mkChar("n_II_ILI"));
  SET_STRING_ELT(nms, 293, mkChar("n_II_mild"));
  SET_STRING_ELT(nms, 294, mkChar("n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 295, mkChar("n_R_hosp"));
  SET_STRING_ELT(nms, 296, mkChar("n_SE"));
  SET_STRING_ELT(nms, 297, mkChar("offset_output_n_EI_ILI"));
  SET_STRING_ELT(nms, 298, mkChar("offset_output_n_EI_mild"));
  SET_STRING_ELT(nms, 299, mkChar("offset_output_n_hosp_to_ICU"));
  SET_STRING_ELT(nms, 300, mkChar("offset_output_n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 301, mkChar("offset_variable_D"));
  SET_STRING_ELT(nms, 302, mkChar("offset_variable_E"));
  SET_STRING_ELT(nms, 303, mkChar("offset_variable_I_asympt"));
  SET_STRING_ELT(nms, 304, mkChar("offset_variable_I_hosp"));
  SET_STRING_ELT(nms, 305, mkChar("offset_variable_I_ICU"));
  SET_STRING_ELT(nms, 306, mkChar("offset_variable_I_ILI"));
  SET_STRING_ELT(nms, 307, mkChar("offset_variable_I_mild"));
  SET_STRING_ELT(nms, 308, mkChar("offset_variable_R_hosp"));
  SET_STRING_ELT(nms, 309, mkChar("p_asympt"));
  SET_STRING_ELT(nms, 310, mkChar("p_death_hosp"));
  SET_STRING_ELT(nms, 311, mkChar("p_EE"));
  SET_STRING_ELT(nms, 312, mkChar("p_II_asympt"));
  SET_STRING_ELT(nms, 313, mkChar("p_II_hosp"));
  SET_STRING_ELT(nms, 314, mkChar("p_II_ICU"));
  SET_STRING_ELT(nms, 315, mkChar("p_II_ILI"));
  SET_STRING_ELT(nms, 316, mkChar("p_II_mild"));
  SET_STRING_ELT(nms, 317, mkChar("p_R_hosp"));
  SET_STRING_ELT(nms, 318, mkChar("p_recov_hosp"));
  SET_STRING_ELT(nms, 319, mkChar("p_recov_ICU"));
  SET_STRING_ELT(nms, 320, mkChar("p_recov_ILI"));
  SET_STRING_ELT(nms, 321, mkChar("p_SE"));
  SET_STRING_ELT(nms, 322, mkChar("p_sympt_ILI"));
  SET_STRING_ELT(nms, 323, mkChar("R0"));
  SET_STRING_ELT(nms, 324, mkChar("R0_hosp"));
  SET_STRING_ELT(nms, 325, mkChar("s_asympt"));
  SET_STRING_ELT(nms, 326, mkChar("s_E"));
  SET_STRING_ELT(nms, 327, mkChar("s_hosp"));
  SET_STRING_ELT(nms, 328, mkChar("s_ICU"));
  SET_STRING_ELT(nms, 329, mkChar("s_ij"));
  SET_STRING_ELT(nms, 330, mkChar("s_ILI"));
  SET_STRING_ELT(nms, 331, mkChar("s_mild"));
  SET_STRING_ELT(nms, 332, mkChar("s_rec"));
  SET_STRING_ELT(nms, 333, mkChar("S0"));
  ...
  SET_STRING_ELT(nms, 337, mkChar("tt"));
  SET_STRING_ELT(nms, 338, mkChar("y"));
...
SEXP basic_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->y = (double*) user_get_array_dim(user, false, internal->y, "y", 1, NA_REAL, NA_REAL, &internal->dim_y);
  ...
  interpolate_check_y(internal->dim_tt, internal->dim_y, 0, "y", "beta");
  cinterpolate_free(internal->interpolate_beta);
  internal->interpolate_beta = cinterpolate_alloc("constant", internal->dim_tt, 1, internal->tt, internal->y, true, false);
...
SEXP basic_metadata(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(interpolate_t, 0, ScalarReal(internal->tt[0]));
