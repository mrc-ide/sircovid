...
SEXP hospital_with_serology_testing_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 647));
  SEXP aux_EE = PROTECT(allocVector(REALSXP, internal->dim_aux_EE));
  memcpy(REAL(aux_EE), internal->aux_EE, internal->dim_aux_EE * sizeof(double));
  odin_set_dim(aux_EE, 3, internal->dim_aux_EE_1, internal->dim_aux_EE_2, internal->dim_aux_EE_3);
  SET_VECTOR_ELT(contents, 0, aux_EE);
  ...
  SET_VECTOR_ELT(contents, 520, ScalarReal(internal->initial_cum_admit_conf));
  SET_VECTOR_ELT(contents, 521, ScalarReal(internal->initial_cum_new_conf));
  SEXP initial_D_comm = PROTECT(allocVector(REALSXP, internal->dim_D_comm));
  memcpy(REAL(initial_D_comm), internal->initial_D_comm, internal->dim_D_comm * sizeof(double));
  SET_VECTOR_ELT(contents, 522, initial_D_comm);
  SEXP initial_D_hosp = PROTECT(allocVector(REALSXP, internal->dim_D_hosp));
  memcpy(REAL(initial_D_hosp), internal->initial_D_hosp, internal->dim_D_hosp * sizeof(double));
  SET_VECTOR_ELT(contents, 523, initial_D_hosp);
  SEXP initial_E = PROTECT(allocVector(REALSXP, internal->dim_E));
  memcpy(REAL(initial_E), internal->initial_E, internal->dim_E * sizeof(double));
  odin_set_dim(initial_E, 3, internal->dim_E_1, internal->dim_E_2, internal->dim_E_3);
  SET_VECTOR_ELT(contents, 524, initial_E);
  SEXP initial_I_asympt = PROTECT(allocVector(REALSXP, internal->dim_I_asympt));
  memcpy(REAL(initial_I_asympt), internal->initial_I_asympt, internal->dim_I_asympt * sizeof(double));
  odin_set_dim(initial_I_asympt, 3, internal->dim_I_asympt_1, internal->dim_I_asympt_2, internal->dim_I_asympt_3);
  SET_VECTOR_ELT(contents, 525, initial_I_asympt);
  SEXP initial_I_comm_D = PROTECT(allocVector(REALSXP, internal->dim_I_comm_D));
  memcpy(REAL(initial_I_comm_D), internal->initial_I_comm_D, internal->dim_I_comm_D * sizeof(double));
  odin_set_dim(initial_I_comm_D, 3, internal->dim_I_comm_D_1, internal->dim_I_comm_D_2, internal->dim_I_comm_D_3);
  SET_VECTOR_ELT(contents, 526, initial_I_comm_D);
  ...
  SET_VECTOR_ELT(contents, 527, initial_I_hosp_D_conf);
  ...
  SET_VECTOR_ELT(contents, 528, initial_I_hosp_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 529, initial_I_hosp_R_conf);
  ...
  SET_VECTOR_ELT(contents, 530, initial_I_hosp_R_unconf);
  SEXP initial_I_ICU_D = PROTECT(allocVector(REALSXP, internal->dim_I_ICU_D));
  memcpy(REAL(initial_I_ICU_D), internal->initial_I_ICU_D, internal->dim_I_ICU_D * sizeof(double));
  odin_set_dim(initial_I_ICU_D, 3, internal->dim_I_ICU_D_1, internal->dim_I_ICU_D_2, internal->dim_I_ICU_D_3);
  SET_VECTOR_ELT(contents, 531, initial_I_ICU_D);
  SEXP initial_I_ICU_R = PROTECT(allocVector(REALSXP, internal->dim_I_ICU_R));
  memcpy(REAL(initial_I_ICU_R), internal->initial_I_ICU_R, internal->dim_I_ICU_R * sizeof(double));
  odin_set_dim(initial_I_ICU_R, 3, internal->dim_I_ICU_R_1, internal->dim_I_ICU_R_2, internal->dim_I_ICU_R_3);
  SET_VECTOR_ELT(contents, 532, initial_I_ICU_R);
  SEXP initial_I_ILI = PROTECT(allocVector(REALSXP, internal->dim_I_ILI));
  memcpy(REAL(initial_I_ILI), internal->initial_I_ILI, internal->dim_I_ILI * sizeof(double));
  odin_set_dim(initial_I_ILI, 3, internal->dim_I_ILI_1, internal->dim_I_ILI_2, internal->dim_I_ILI_3);
  SET_VECTOR_ELT(contents, 533, initial_I_ILI);
  SEXP initial_I_mild = PROTECT(allocVector(REALSXP, internal->dim_I_mild));
  memcpy(REAL(initial_I_mild), internal->initial_I_mild, internal->dim_I_mild * sizeof(double));
  odin_set_dim(initial_I_mild, 3, internal->dim_I_mild_1, internal->dim_I_mild_2, internal->dim_I_mild_3);
  SET_VECTOR_ELT(contents, 534, initial_I_mild);
  SEXP initial_I_triage_D = PROTECT(allocVector(REALSXP, internal->dim_I_triage_D));
  memcpy(REAL(initial_I_triage_D), internal->initial_I_triage_D, internal->dim_I_triage_D * sizeof(double));
  odin_set_dim(initial_I_triage_D, 3, internal->dim_I_triage_D_1, internal->dim_I_triage_D_2, internal->dim_I_triage_D_3);
  SET_VECTOR_ELT(contents, 535, initial_I_triage_D);
  SEXP initial_I_triage_R = PROTECT(allocVector(REALSXP, internal->dim_I_triage_R));
  memcpy(REAL(initial_I_triage_R), internal->initial_I_triage_R, internal->dim_I_triage_R * sizeof(double));
  odin_set_dim(initial_I_triage_R, 3, internal->dim_I_triage_R_1, internal->dim_I_triage_R_2, internal->dim_I_triage_R_3);
  SET_VECTOR_ELT(contents, 536, initial_I_triage_R);
  SEXP initial_R_neg = PROTECT(allocVector(REALSXP, internal->dim_R_neg));
  memcpy(REAL(initial_R_neg), internal->initial_R_neg, internal->dim_R_neg * sizeof(double));
  SET_VECTOR_ELT(contents, 537, initial_R_neg);
  SEXP initial_R_pos = PROTECT(allocVector(REALSXP, internal->dim_R_pos));
  memcpy(REAL(initial_R_pos), internal->initial_R_pos, internal->dim_R_pos * sizeof(double));
  SET_VECTOR_ELT(contents, 538, initial_R_pos);
  SEXP initial_R_pre = PROTECT(allocVector(REALSXP, internal->dim_R_pre));
  memcpy(REAL(initial_R_pre), internal->initial_R_pre, internal->dim_R_pre * sizeof(double));
  odin_set_dim(initial_R_pre, 2, internal->dim_R_pre_1, internal->dim_R_pre_2);
  SET_VECTOR_ELT(contents, 539, initial_R_pre);
  SEXP initial_R_stepdown = PROTECT(allocVector(REALSXP, internal->dim_R_stepdown));
  memcpy(REAL(initial_R_stepdown), internal->initial_R_stepdown, internal->dim_R_stepdown * sizeof(double));
  odin_set_dim(initial_R_stepdown, 2, internal->dim_R_stepdown_1, internal->dim_R_stepdown_2);
  SET_VECTOR_ELT(contents, 540, initial_R_stepdown);
  SEXP initial_S = PROTECT(allocVector(REALSXP, internal->dim_S));
  memcpy(REAL(initial_S), internal->initial_S, internal->dim_S * sizeof(double));
  SET_VECTOR_ELT(contents, 541, initial_S);
  SEXP lambda = PROTECT(allocVector(REALSXP, internal->dim_lambda));
  memcpy(REAL(lambda), internal->lambda, internal->dim_lambda * sizeof(double));
  SET_VECTOR_ELT(contents, 543, lambda);
  SEXP m = PROTECT(allocVector(REALSXP, internal->dim_m));
  memcpy(REAL(m), internal->m, internal->dim_m * sizeof(double));
  odin_set_dim(m, 2, internal->dim_m_1, internal->dim_m_2);
  SET_VECTOR_ELT(contents, 544, m);
  SET_VECTOR_ELT(contents, 545, ScalarInteger(internal->N_age));
  SEXP n_com_to_R_pre = PROTECT(allocVector(REALSXP, internal->dim_n_com_to_R_pre));
  memcpy(REAL(n_com_to_R_pre), internal->n_com_to_R_pre, internal->dim_n_com_to_R_pre * sizeof(double));
  SET_VECTOR_ELT(contents, 546, n_com_to_R_pre);
  SEXP n_com_to_R_total = PROTECT(allocVector(REALSXP, internal->dim_n_com_to_R_total));
  memcpy(REAL(n_com_to_R_total), internal->n_com_to_R_total, internal->dim_n_com_to_R_total * sizeof(double));
  SET_VECTOR_ELT(contents, 547, n_com_to_R_total);
  SEXP n_EE = PROTECT(allocVector(REALSXP, internal->dim_n_EE));
  memcpy(REAL(n_EE), internal->n_EE, internal->dim_n_EE * sizeof(double));
  odin_set_dim(n_EE, 3, internal->dim_n_EE_1, internal->dim_n_EE_2, internal->dim_n_EE_3);
  SET_VECTOR_ELT(contents, 548, n_EE);
  SEXP n_EI_asympt = PROTECT(allocVector(REALSXP, internal->dim_n_EI_asympt));
  memcpy(REAL(n_EI_asympt), internal->n_EI_asympt, internal->dim_n_EI_asympt * sizeof(double));
  odin_set_dim(n_EI_asympt, 2, internal->dim_n_EI_asympt_1, internal->dim_n_EI_asympt_2);
  SET_VECTOR_ELT(contents, 549, n_EI_asympt);
  SEXP n_EI_ILI = PROTECT(allocVector(REALSXP, internal->dim_n_EI_ILI));
  memcpy(REAL(n_EI_ILI), internal->n_EI_ILI, internal->dim_n_EI_ILI * sizeof(double));
  odin_set_dim(n_EI_ILI, 2, internal->dim_n_EI_ILI_1, internal->dim_n_EI_ILI_2);
  SET_VECTOR_ELT(contents, 550, n_EI_ILI);
  SEXP n_EI_mild = PROTECT(allocVector(REALSXP, internal->dim_n_EI_mild));
  memcpy(REAL(n_EI_mild), internal->n_EI_mild, internal->dim_n_EI_mild * sizeof(double));
  odin_set_dim(n_EI_mild, 2, internal->dim_n_EI_mild_1, internal->dim_n_EI_mild_2);
  SET_VECTOR_ELT(contents, 551, n_EI_mild);
  SEXP n_hosp_non_ICU = PROTECT(allocVector(REALSXP, internal->dim_n_hosp_non_ICU));
  memcpy(REAL(n_hosp_non_ICU), internal->n_hosp_non_ICU, internal->dim_n_hosp_non_ICU * sizeof(double));
  odin_set_dim(n_hosp_non_ICU, 2, internal->dim_n_hosp_non_ICU_1, internal->dim_n_hosp_non_ICU_2);
  SET_VECTOR_ELT(contents, 552, n_hosp_non_ICU);
  ...
  SET_VECTOR_ELT(contents, 553, n_I_hosp_D_unconf_to_conf);
  ...
  SET_VECTOR_ELT(contents, 554, n_I_hosp_R_unconf_to_conf);
  SEXP n_ICU_to_R_stepdown = PROTECT(allocVector(REALSXP, internal->dim_n_ICU_to_R_stepdown));
  memcpy(REAL(n_ICU_to_R_stepdown), internal->n_ICU_to_R_stepdown, internal->dim_n_ICU_to_R_stepdown * sizeof(double));
  SET_VECTOR_ELT(contents, 555, n_ICU_to_R_stepdown);
  SEXP n_II_asympt = PROTECT(allocVector(REALSXP, internal->dim_n_II_asympt));
  memcpy(REAL(n_II_asympt), internal->n_II_asympt, internal->dim_n_II_asympt * sizeof(double));
  odin_set_dim(n_II_asympt, 3, internal->dim_n_II_asympt_1, internal->dim_n_II_asympt_2, internal->dim_n_II_asympt_3);
  SET_VECTOR_ELT(contents, 556, n_II_asympt);
  SEXP n_II_comm_D = PROTECT(allocVector(REALSXP, internal->dim_n_II_comm_D));
  memcpy(REAL(n_II_comm_D), internal->n_II_comm_D, internal->dim_n_II_comm_D * sizeof(double));
  odin_set_dim(n_II_comm_D, 3, internal->dim_n_II_comm_D_1, internal->dim_n_II_comm_D_2, internal->dim_n_II_comm_D_3);
  SET_VECTOR_ELT(contents, 557, n_II_comm_D);
  ...
  SET_VECTOR_ELT(contents, 558, n_II_hosp_D_conf);
  ...
  SET_VECTOR_ELT(contents, 559, n_II_hosp_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 560, n_II_hosp_R_conf);
  ...
  SET_VECTOR_ELT(contents, 561, n_II_hosp_R_unconf);
  SEXP n_II_ICU_D = PROTECT(allocVector(REALSXP, internal->dim_n_II_ICU_D));
  memcpy(REAL(n_II_ICU_D), internal->n_II_ICU_D, internal->dim_n_II_ICU_D * sizeof(double));
  odin_set_dim(n_II_ICU_D, 3, internal->dim_n_II_ICU_D_1, internal->dim_n_II_ICU_D_2, internal->dim_n_II_ICU_D_3);
  SET_VECTOR_ELT(contents, 562, n_II_ICU_D);
  SEXP n_II_ICU_R = PROTECT(allocVector(REALSXP, internal->dim_n_II_ICU_R));
  memcpy(REAL(n_II_ICU_R), internal->n_II_ICU_R, internal->dim_n_II_ICU_R * sizeof(double));
  odin_set_dim(n_II_ICU_R, 3, internal->dim_n_II_ICU_R_1, internal->dim_n_II_ICU_R_2, internal->dim_n_II_ICU_R_3);
  SET_VECTOR_ELT(contents, 563, n_II_ICU_R);
  SEXP n_II_ILI = PROTECT(allocVector(REALSXP, internal->dim_n_II_ILI));
  memcpy(REAL(n_II_ILI), internal->n_II_ILI, internal->dim_n_II_ILI * sizeof(double));
  odin_set_dim(n_II_ILI, 3, internal->dim_n_II_ILI_1, internal->dim_n_II_ILI_2, internal->dim_n_II_ILI_3);
  SET_VECTOR_ELT(contents, 564, n_II_ILI);
  SEXP n_II_mild = PROTECT(allocVector(REALSXP, internal->dim_n_II_mild));
  memcpy(REAL(n_II_mild), internal->n_II_mild, internal->dim_n_II_mild * sizeof(double));
  odin_set_dim(n_II_mild, 3, internal->dim_n_II_mild_1, internal->dim_n_II_mild_2, internal->dim_n_II_mild_3);
  SET_VECTOR_ELT(contents, 565, n_II_mild);
  SEXP n_II_triage_D = PROTECT(allocVector(REALSXP, internal->dim_n_II_triage_D));
  memcpy(REAL(n_II_triage_D), internal->n_II_triage_D, internal->dim_n_II_triage_D * sizeof(double));
  odin_set_dim(n_II_triage_D, 3, internal->dim_n_II_triage_D_1, internal->dim_n_II_triage_D_2, internal->dim_n_II_triage_D_3);
  SET_VECTOR_ELT(contents, 566, n_II_triage_D);
  SEXP n_II_triage_R = PROTECT(allocVector(REALSXP, internal->dim_n_II_triage_R));
  memcpy(REAL(n_II_triage_R), internal->n_II_triage_R, internal->dim_n_II_triage_R * sizeof(double));
  odin_set_dim(n_II_triage_R, 3, internal->dim_n_II_triage_R_1, internal->dim_n_II_triage_R_2, internal->dim_n_II_triage_R_3);
  SET_VECTOR_ELT(contents, 567, n_II_triage_R);
  SEXP n_ILI_to_comm_D = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_comm_D));
  memcpy(REAL(n_ILI_to_comm_D), internal->n_ILI_to_comm_D, internal->dim_n_ILI_to_comm_D * sizeof(double));
  odin_set_dim(n_ILI_to_comm_D, 2, internal->dim_n_ILI_to_comm_D_1, internal->dim_n_ILI_to_comm_D_2);
  SET_VECTOR_ELT(contents, 568, n_ILI_to_comm_D);
  SEXP n_ILI_to_hosp = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_hosp));
  memcpy(REAL(n_ILI_to_hosp), internal->n_ILI_to_hosp, internal->dim_n_ILI_to_hosp * sizeof(double));
  odin_set_dim(n_ILI_to_hosp, 2, internal->dim_n_ILI_to_hosp_1, internal->dim_n_ILI_to_hosp_2);
  SET_VECTOR_ELT(contents, 569, n_ILI_to_hosp);
  SEXP n_ILI_to_hosp_D = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_hosp_D));
  memcpy(REAL(n_ILI_to_hosp_D), internal->n_ILI_to_hosp_D, internal->dim_n_ILI_to_hosp_D * sizeof(double));
  odin_set_dim(n_ILI_to_hosp_D, 2, internal->dim_n_ILI_to_hosp_D_1, internal->dim_n_ILI_to_hosp_D_2);
  SET_VECTOR_ELT(contents, 570, n_ILI_to_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 571, n_ILI_to_hosp_D_conf);
  SEXP n_ILI_to_hosp_R = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_hosp_R));
  memcpy(REAL(n_ILI_to_hosp_R), internal->n_ILI_to_hosp_R, internal->dim_n_ILI_to_hosp_R * sizeof(double));
  odin_set_dim(n_ILI_to_hosp_R, 2, internal->dim_n_ILI_to_hosp_R_1, internal->dim_n_ILI_to_hosp_R_2);
  SET_VECTOR_ELT(contents, 572, n_ILI_to_hosp_R);
  ...
  SET_VECTOR_ELT(contents, 573, n_ILI_to_hosp_R_conf);
  SEXP n_ILI_to_triage = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_triage));
  memcpy(REAL(n_ILI_to_triage), internal->n_ILI_to_triage, internal->dim_n_ILI_to_triage * sizeof(double));
  odin_set_dim(n_ILI_to_triage, 2, internal->dim_n_ILI_to_triage_1, internal->dim_n_ILI_to_triage_2);
  SET_VECTOR_ELT(contents, 574, n_ILI_to_triage);
  SEXP n_ILI_to_triage_D = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_triage_D));
  memcpy(REAL(n_ILI_to_triage_D), internal->n_ILI_to_triage_D, internal->dim_n_ILI_to_triage_D * sizeof(double));
  odin_set_dim(n_ILI_to_triage_D, 2, internal->dim_n_ILI_to_triage_D_1, internal->dim_n_ILI_to_triage_D_2);
  SET_VECTOR_ELT(contents, 575, n_ILI_to_triage_D);
  SEXP n_ILI_to_triage_R = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_triage_R));
  memcpy(REAL(n_ILI_to_triage_R), internal->n_ILI_to_triage_R, internal->dim_n_ILI_to_triage_R * sizeof(double));
  odin_set_dim(n_ILI_to_triage_R, 2, internal->dim_n_ILI_to_triage_R_1, internal->dim_n_ILI_to_triage_R_2);
  SET_VECTOR_ELT(contents, 576, n_ILI_to_triage_R);
  SEXP n_R_pre = PROTECT(allocVector(REALSXP, internal->dim_n_R_pre));
  memcpy(REAL(n_R_pre), internal->n_R_pre, internal->dim_n_R_pre * sizeof(double));
  odin_set_dim(n_R_pre, 2, internal->dim_n_R_pre_1, internal->dim_n_R_pre_2);
  SET_VECTOR_ELT(contents, 577, n_R_pre);
  SEXP n_R_stepdown = PROTECT(allocVector(REALSXP, internal->dim_n_R_stepdown));
  memcpy(REAL(n_R_stepdown), internal->n_R_stepdown, internal->dim_n_R_stepdown * sizeof(double));
  odin_set_dim(n_R_stepdown, 2, internal->dim_n_R_stepdown_1, internal->dim_n_R_stepdown_2);
  SET_VECTOR_ELT(contents, 578, n_R_stepdown);
  SEXP n_SE = PROTECT(allocVector(REALSXP, internal->dim_n_SE));
  memcpy(REAL(n_SE), internal->n_SE, internal->dim_n_SE * sizeof(double));
  SET_VECTOR_ELT(contents, 579, n_SE);
  ...
  SET_VECTOR_ELT(contents, 580, new_I_hosp_D_conf);
  ...
  SET_VECTOR_ELT(contents, 581, new_I_hosp_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 582, new_I_hosp_R_conf);
  ...
  SET_VECTOR_ELT(contents, 583, new_I_hosp_R_unconf);
  SET_VECTOR_ELT(contents, 584, ScalarInteger(internal->offset_variable_D_comm));
  SET_VECTOR_ELT(contents, 585, ScalarInteger(internal->offset_variable_D_hosp));
  SET_VECTOR_ELT(contents, 586, ScalarInteger(internal->offset_variable_E));
  SET_VECTOR_ELT(contents, 587, ScalarInteger(internal->offset_variable_I_asympt));
  SET_VECTOR_ELT(contents, 588, ScalarInteger(internal->offset_variable_I_comm_D));
  SET_VECTOR_ELT(contents, 589, ScalarInteger(internal->offset_variable_I_hosp_D_conf));
  SET_VECTOR_ELT(contents, 590, ScalarInteger(internal->offset_variable_I_hosp_D_unconf));
  SET_VECTOR_ELT(contents, 591, ScalarInteger(internal->offset_variable_I_hosp_R_conf));
  SET_VECTOR_ELT(contents, 592, ScalarInteger(internal->offset_variable_I_hosp_R_unconf));
  SET_VECTOR_ELT(contents, 593, ScalarInteger(internal->offset_variable_I_ICU_D));
  SET_VECTOR_ELT(contents, 594, ScalarInteger(internal->offset_variable_I_ICU_R));
  SET_VECTOR_ELT(contents, 595, ScalarInteger(internal->offset_variable_I_ILI));
  SET_VECTOR_ELT(contents, 596, ScalarInteger(internal->offset_variable_I_mild));
  SET_VECTOR_ELT(contents, 597, ScalarInteger(internal->offset_variable_I_triage_D));
  SET_VECTOR_ELT(contents, 598, ScalarInteger(internal->offset_variable_I_triage_R));
  SET_VECTOR_ELT(contents, 599, ScalarInteger(internal->offset_variable_R_neg));
  SET_VECTOR_ELT(contents, 600, ScalarInteger(internal->offset_variable_R_pos));
  SET_VECTOR_ELT(contents, 601, ScalarInteger(internal->offset_variable_R_pre));
  SET_VECTOR_ELT(contents, 602, ScalarInteger(internal->offset_variable_R_stepdown));
  ...
  SET_VECTOR_ELT(contents, 603, p_admit_conf);
  SEXP p_asympt = PROTECT(allocVector(REALSXP, internal->dim_p_asympt));
  memcpy(REAL(p_asympt), internal->p_asympt, internal->dim_p_asympt * sizeof(double));
  SET_VECTOR_ELT(contents, 604, p_asympt);
  SEXP p_death_comm = PROTECT(allocVector(REALSXP, internal->dim_p_death_comm));
  memcpy(REAL(p_death_comm), internal->p_death_comm, internal->dim_p_death_comm * sizeof(double));
  SET_VECTOR_ELT(contents, 605, p_death_comm);
  SEXP p_death_hosp_D = PROTECT(allocVector(REALSXP, internal->dim_p_death_hosp_D));
  memcpy(REAL(p_death_hosp_D), internal->p_death_hosp_D, internal->dim_p_death_hosp_D * sizeof(double));
  SET_VECTOR_ELT(contents, 606, p_death_hosp_D);
  SEXP p_death_ICU = PROTECT(allocVector(REALSXP, internal->dim_p_death_ICU));
  memcpy(REAL(p_death_ICU), internal->p_death_ICU, internal->dim_p_death_ICU * sizeof(double));
  SET_VECTOR_ELT(contents, 607, p_death_ICU);
  SET_VECTOR_ELT(contents, 608, ScalarReal(internal->p_EE));
  SEXP p_ICU_hosp = PROTECT(allocVector(REALSXP, internal->dim_p_ICU_hosp));
  memcpy(REAL(p_ICU_hosp), internal->p_ICU_hosp, internal->dim_p_ICU_hosp * sizeof(double));
  SET_VECTOR_ELT(contents, 609, p_ICU_hosp);
  SET_VECTOR_ELT(contents, 610, ScalarReal(internal->p_II_asympt));
  SET_VECTOR_ELT(contents, 611, ScalarReal(internal->p_II_comm_D));
  SET_VECTOR_ELT(contents, 612, ScalarReal(internal->p_II_hosp_D));
  SET_VECTOR_ELT(contents, 613, ScalarReal(internal->p_II_hosp_R));
  SET_VECTOR_ELT(contents, 614, ScalarReal(internal->p_II_ICU_D));
  SET_VECTOR_ELT(contents, 615, ScalarReal(internal->p_II_ICU_R));
  SET_VECTOR_ELT(contents, 616, ScalarReal(internal->p_II_ILI));
  SET_VECTOR_ELT(contents, 617, ScalarReal(internal->p_II_mild));
  SET_VECTOR_ELT(contents, 618, ScalarReal(internal->p_II_triage));
  SEXP p_R_pre = PROTECT(allocVector(REALSXP, internal->dim_p_R_pre));
  memcpy(REAL(p_R_pre), internal->p_R_pre, internal->dim_p_R_pre * sizeof(double));
  SET_VECTOR_ELT(contents, 619, p_R_pre);
  SET_VECTOR_ELT(contents, 620, ScalarReal(internal->p_R_stepdown));
  SEXP p_recov_ILI = PROTECT(allocVector(REALSXP, internal->dim_p_recov_ILI));
  memcpy(REAL(p_recov_ILI), internal->p_recov_ILI, internal->dim_p_recov_ILI * sizeof(double));
  SET_VECTOR_ELT(contents, 621, p_recov_ILI);
  SEXP p_SE = PROTECT(allocVector(REALSXP, internal->dim_p_SE));
  memcpy(REAL(p_SE), internal->p_SE, internal->dim_p_SE * sizeof(double));
  SET_VECTOR_ELT(contents, 622, p_SE);
  SEXP p_seroconversion = PROTECT(allocVector(REALSXP, internal->dim_p_seroconversion));
  memcpy(REAL(p_seroconversion), internal->p_seroconversion, internal->dim_p_seroconversion * sizeof(double));
  SET_VECTOR_ELT(contents, 623, p_seroconversion);
  SEXP p_sympt_ILI = PROTECT(allocVector(REALSXP, internal->dim_p_sympt_ILI));
  memcpy(REAL(p_sympt_ILI), internal->p_sympt_ILI, internal->dim_p_sympt_ILI * sizeof(double));
  SET_VECTOR_ELT(contents, 624, p_sympt_ILI);
  SET_VECTOR_ELT(contents, 625, ScalarReal(internal->p_test));
  SEXP R0_neg = PROTECT(allocVector(REALSXP, internal->dim_R0_neg));
  memcpy(REAL(R0_neg), internal->R0_neg, internal->dim_R0_neg * sizeof(double));
  SET_VECTOR_ELT(contents, 626, R0_neg);
  SEXP R0_pos = PROTECT(allocVector(REALSXP, internal->dim_R0_pos));
  memcpy(REAL(R0_pos), internal->R0_pos, internal->dim_R0_pos * sizeof(double));
  SET_VECTOR_ELT(contents, 627, R0_pos);
  SEXP R0_pre = PROTECT(allocVector(REALSXP, internal->dim_R0_pre));
  memcpy(REAL(R0_pre), internal->R0_pre, internal->dim_R0_pre * sizeof(double));
  odin_set_dim(R0_pre, 2, internal->dim_R0_pre_1, internal->dim_R0_pre_2);
  SET_VECTOR_ELT(contents, 628, R0_pre);
  SEXP R0_stepdown = PROTECT(allocVector(REALSXP, internal->dim_R0_stepdown));
  memcpy(REAL(R0_stepdown), internal->R0_stepdown, internal->dim_R0_stepdown * sizeof(double));
  odin_set_dim(R0_stepdown, 2, internal->dim_R0_stepdown_1, internal->dim_R0_stepdown_2);
  SET_VECTOR_ELT(contents, 629, R0_stepdown);
  SET_VECTOR_ELT(contents, 630, ScalarInteger(internal->s_asympt));
  SET_VECTOR_ELT(contents, 631, ScalarInteger(internal->s_comm_D));
  SET_VECTOR_ELT(contents, 632, ScalarInteger(internal->s_E));
  SET_VECTOR_ELT(contents, 633, ScalarInteger(internal->s_hosp_D));
  SET_VECTOR_ELT(contents, 634, ScalarInteger(internal->s_hosp_R));
  SET_VECTOR_ELT(contents, 635, ScalarInteger(internal->s_ICU_D));
  SET_VECTOR_ELT(contents, 636, ScalarInteger(internal->s_ICU_R));
  SEXP s_ij = PROTECT(allocVector(REALSXP, internal->dim_s_ij));
  memcpy(REAL(s_ij), internal->s_ij, internal->dim_s_ij * sizeof(double));
  odin_set_dim(s_ij, 2, internal->dim_s_ij_1, internal->dim_s_ij_2);
  SET_VECTOR_ELT(contents, 637, s_ij);
  SET_VECTOR_ELT(contents, 638, ScalarInteger(internal->s_ILI));
  SET_VECTOR_ELT(contents, 639, ScalarInteger(internal->s_mild));
  SET_VECTOR_ELT(contents, 640, ScalarInteger(internal->s_R_pre));
  SET_VECTOR_ELT(contents, 641, ScalarInteger(internal->s_stepdown));
  SET_VECTOR_ELT(contents, 642, ScalarInteger(internal->s_triage));
  SEXP S0 = PROTECT(allocVector(REALSXP, internal->dim_S0));
  memcpy(REAL(S0), internal->S0, internal->dim_S0 * sizeof(double));
  SET_VECTOR_ELT(contents, 643, S0);
  SET_VECTOR_ELT(contents, 644, ScalarInteger(internal->trans_classes));
  SEXP trans_increase = PROTECT(allocVector(REALSXP, internal->dim_trans_increase));
  memcpy(REAL(trans_increase), internal->trans_increase, internal->dim_trans_increase * sizeof(double));
  odin_set_dim(trans_increase, 2, internal->dim_trans_increase_1, internal->dim_trans_increase_2);
  SET_VECTOR_ELT(contents, 645, trans_increase);
  SEXP trans_profile = PROTECT(allocVector(REALSXP, internal->dim_trans_profile));
  memcpy(REAL(trans_profile), internal->trans_profile, internal->dim_trans_profile * sizeof(double));
  odin_set_dim(trans_profile, 2, internal->dim_trans_profile_1, internal->dim_trans_profile_2);
  SET_VECTOR_ELT(contents, 646, trans_profile);
  SEXP nms = PROTECT(allocVector(STRSXP, 647));
  SET_STRING_ELT(nms, 0, mkChar("aux_EE"));
  SET_STRING_ELT(nms, 1, mkChar("aux_II_asympt"));
  SET_STRING_ELT(nms, 2, mkChar("aux_II_comm_D"));
  ...
  SET_STRING_ELT(nms, 520, mkChar("initial_cum_admit_conf"));
  SET_STRING_ELT(nms, 521, mkChar("initial_cum_new_conf"));
  SET_STRING_ELT(nms, 522, mkChar("initial_D_comm"));
  SET_STRING_ELT(nms, 523, mkChar("initial_D_hosp"));
  SET_STRING_ELT(nms, 524, mkChar("initial_E"));
  SET_STRING_ELT(nms, 525, mkChar("initial_I_asympt"));
  SET_STRING_ELT(nms, 526, mkChar("initial_I_comm_D"));
  SET_STRING_ELT(nms, 527, mkChar("initial_I_hosp_D_conf"));
  SET_STRING_ELT(nms, 528, mkChar("initial_I_hosp_D_unconf"));
  SET_STRING_ELT(nms, 529, mkChar("initial_I_hosp_R_conf"));
  SET_STRING_ELT(nms, 530, mkChar("initial_I_hosp_R_unconf"));
  SET_STRING_ELT(nms, 531, mkChar("initial_I_ICU_D"));
  SET_STRING_ELT(nms, 532, mkChar("initial_I_ICU_R"));
  SET_STRING_ELT(nms, 533, mkChar("initial_I_ILI"));
  SET_STRING_ELT(nms, 534, mkChar("initial_I_mild"));
  SET_STRING_ELT(nms, 535, mkChar("initial_I_triage_D"));
  SET_STRING_ELT(nms, 536, mkChar("initial_I_triage_R"));
  SET_STRING_ELT(nms, 537, mkChar("initial_R_neg"));
  SET_STRING_ELT(nms, 538, mkChar("initial_R_pos"));
  SET_STRING_ELT(nms, 539, mkChar("initial_R_pre"));
  SET_STRING_ELT(nms, 540, mkChar("initial_R_stepdown"));
  SET_STRING_ELT(nms, 541, mkChar("initial_S"));
  SET_STRING_ELT(nms, 542, mkChar("interpolate_beta"));
  SET_STRING_ELT(nms, 543, mkChar("lambda"));
  SET_STRING_ELT(nms, 544, mkChar("m"));
  SET_STRING_ELT(nms, 545, mkChar("N_age"));
  SET_STRING_ELT(nms, 546, mkChar("n_com_to_R_pre"));
  SET_STRING_ELT(nms, 547, mkChar("n_com_to_R_total"));
  SET_STRING_ELT(nms, 548, mkChar("n_EE"));
  SET_STRING_ELT(nms, 549, mkChar("n_EI_asympt"));
  SET_STRING_ELT(nms, 550, mkChar("n_EI_ILI"));
  SET_STRING_ELT(nms, 551, mkChar("n_EI_mild"));
  SET_STRING_ELT(nms, 552, mkChar("n_hosp_non_ICU"));
  SET_STRING_ELT(nms, 553, mkChar("n_I_hosp_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 554, mkChar("n_I_hosp_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 555, mkChar("n_ICU_to_R_stepdown"));
  SET_STRING_ELT(nms, 556, mkChar("n_II_asympt"));
  SET_STRING_ELT(nms, 557, mkChar("n_II_comm_D"));
  SET_STRING_ELT(nms, 558, mkChar("n_II_hosp_D_conf"));
  SET_STRING_ELT(nms, 559, mkChar("n_II_hosp_D_unconf"));
  SET_STRING_ELT(nms, 560, mkChar("n_II_hosp_R_conf"));
  SET_STRING_ELT(nms, 561, mkChar("n_II_hosp_R_unconf"));
  SET_STRING_ELT(nms, 562, mkChar("n_II_ICU_D"));
  SET_STRING_ELT(nms, 563, mkChar("n_II_ICU_R"));
  SET_STRING_ELT(nms, 564, mkChar("n_II_ILI"));
  SET_STRING_ELT(nms, 565, mkChar("n_II_mild"));
  SET_STRING_ELT(nms, 566, mkChar("n_II_triage_D"));
  SET_STRING_ELT(nms, 567, mkChar("n_II_triage_R"));
  SET_STRING_ELT(nms, 568, mkChar("n_ILI_to_comm_D"));
  SET_STRING_ELT(nms, 569, mkChar("n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 570, mkChar("n_ILI_to_hosp_D"));
  SET_STRING_ELT(nms, 571, mkChar("n_ILI_to_hosp_D_conf"));
  SET_STRING_ELT(nms, 572, mkChar("n_ILI_to_hosp_R"));
  SET_STRING_ELT(nms, 573, mkChar("n_ILI_to_hosp_R_conf"));
  SET_STRING_ELT(nms, 574, mkChar("n_ILI_to_triage"));
  SET_STRING_ELT(nms, 575, mkChar("n_ILI_to_triage_D"));
  SET_STRING_ELT(nms, 576, mkChar("n_ILI_to_triage_R"));
  SET_STRING_ELT(nms, 577, mkChar("n_R_pre"));
  SET_STRING_ELT(nms, 578, mkChar("n_R_stepdown"));
  SET_STRING_ELT(nms, 579, mkChar("n_SE"));
  SET_STRING_ELT(nms, 580, mkChar("new_I_hosp_D_conf"));
  SET_STRING_ELT(nms, 581, mkChar("new_I_hosp_D_unconf"));
  SET_STRING_ELT(nms, 582, mkChar("new_I_hosp_R_conf"));
  SET_STRING_ELT(nms, 583, mkChar("new_I_hosp_R_unconf"));
  SET_STRING_ELT(nms, 584, mkChar("offset_variable_D_comm"));
  SET_STRING_ELT(nms, 585, mkChar("offset_variable_D_hosp"));
  SET_STRING_ELT(nms, 586, mkChar("offset_variable_E"));
  SET_STRING_ELT(nms, 587, mkChar("offset_variable_I_asympt"));
  SET_STRING_ELT(nms, 588, mkChar("offset_variable_I_comm_D"));
  SET_STRING_ELT(nms, 589, mkChar("offset_variable_I_hosp_D_conf"));
  SET_STRING_ELT(nms, 590, mkChar("offset_variable_I_hosp_D_unconf"));
  SET_STRING_ELT(nms, 591, mkChar("offset_variable_I_hosp_R_conf"));
  SET_STRING_ELT(nms, 592, mkChar("offset_variable_I_hosp_R_unconf"));
  SET_STRING_ELT(nms, 593, mkChar("offset_variable_I_ICU_D"));
  SET_STRING_ELT(nms, 594, mkChar("offset_variable_I_ICU_R"));
  SET_STRING_ELT(nms, 595, mkChar("offset_variable_I_ILI"));
  SET_STRING_ELT(nms, 596, mkChar("offset_variable_I_mild"));
  SET_STRING_ELT(nms, 597, mkChar("offset_variable_I_triage_D"));
  SET_STRING_ELT(nms, 598, mkChar("offset_variable_I_triage_R"));
  SET_STRING_ELT(nms, 599, mkChar("offset_variable_R_neg"));
  SET_STRING_ELT(nms, 600, mkChar("offset_variable_R_pos"));
  SET_STRING_ELT(nms, 601, mkChar("offset_variable_R_pre"));
  SET_STRING_ELT(nms, 602, mkChar("offset_variable_R_stepdown"));
  SET_STRING_ELT(nms, 603, mkChar("p_admit_conf"));
  SET_STRING_ELT(nms, 604, mkChar("p_asympt"));
  SET_STRING_ELT(nms, 605, mkChar("p_death_comm"));
  SET_STRING_ELT(nms, 606, mkChar("p_death_hosp_D"));
  SET_STRING_ELT(nms, 607, mkChar("p_death_ICU"));
  SET_STRING_ELT(nms, 608, mkChar("p_EE"));
  SET_STRING_ELT(nms, 609, mkChar("p_ICU_hosp"));
  SET_STRING_ELT(nms, 610, mkChar("p_II_asympt"));
  SET_STRING_ELT(nms, 611, mkChar("p_II_comm_D"));
  SET_STRING_ELT(nms, 612, mkChar("p_II_hosp_D"));
  SET_STRING_ELT(nms, 613, mkChar("p_II_hosp_R"));
  SET_STRING_ELT(nms, 614, mkChar("p_II_ICU_D"));
  SET_STRING_ELT(nms, 615, mkChar("p_II_ICU_R"));
  SET_STRING_ELT(nms, 616, mkChar("p_II_ILI"));
  SET_STRING_ELT(nms, 617, mkChar("p_II_mild"));
  SET_STRING_ELT(nms, 618, mkChar("p_II_triage"));
  SET_STRING_ELT(nms, 619, mkChar("p_R_pre"));
  SET_STRING_ELT(nms, 620, mkChar("p_R_stepdown"));
  SET_STRING_ELT(nms, 621, mkChar("p_recov_ILI"));
  SET_STRING_ELT(nms, 622, mkChar("p_SE"));
  SET_STRING_ELT(nms, 623, mkChar("p_seroconversion"));
  SET_STRING_ELT(nms, 624, mkChar("p_sympt_ILI"));
  SET_STRING_ELT(nms, 625, mkChar("p_test"));
  SET_STRING_ELT(nms, 626, mkChar("R0_neg"));
  SET_STRING_ELT(nms, 627, mkChar("R0_pos"));
  SET_STRING_ELT(nms, 628, mkChar("R0_pre"));
  SET_STRING_ELT(nms, 629, mkChar("R0_stepdown"));
  SET_STRING_ELT(nms, 630, mkChar("s_asympt"));
  SET_STRING_ELT(nms, 631, mkChar("s_comm_D"));
  SET_STRING_ELT(nms, 632, mkChar("s_E"));
  SET_STRING_ELT(nms, 633, mkChar("s_hosp_D"));
  SET_STRING_ELT(nms, 634, mkChar("s_hosp_R"));
  SET_STRING_ELT(nms, 635, mkChar("s_ICU_D"));
  SET_STRING_ELT(nms, 636, mkChar("s_ICU_R"));
  SET_STRING_ELT(nms, 637, mkChar("s_ij"));
  SET_STRING_ELT(nms, 638, mkChar("s_ILI"));
  SET_STRING_ELT(nms, 639, mkChar("s_mild"));
  SET_STRING_ELT(nms, 640, mkChar("s_R_pre"));
  SET_STRING_ELT(nms, 641, mkChar("s_stepdown"));
  SET_STRING_ELT(nms, 642, mkChar("s_triage"));
  SET_STRING_ELT(nms, 643, mkChar("S0"));
  SET_STRING_ELT(nms, 644, mkChar("trans_classes"));
  SET_STRING_ELT(nms, 645, mkChar("trans_increase"));
  SET_STRING_ELT(nms, 646, mkChar("trans_profile"));
  setAttrib(contents, R_NamesSymbol, nms);
  UNPROTECT(130);
  return contents;
}
SEXP hospital_with_serology_testing_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->dim_trans_increase = internal->dim_trans_increase_1 * internal->dim_trans_increase_2;
  internal->dim_trans_profile = internal->dim_trans_profile_1 * internal->dim_trans_profile_2;
  internal->offset_variable_D_comm = 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg + internal->dim_D_hosp;
  internal->offset_variable_D_hosp = 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg;
  internal->offset_variable_R_neg = 2 + internal->dim_S + internal->dim_R_pos;
  internal->offset_variable_R_pos = 2 + internal->dim_S;
  internal->offset_variable_R_stepdown = 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg + internal->dim_D_hosp + internal->dim_D_comm;
  ...
  internal->m = (double*) user_get_array(user, false, internal->m, "m", NA_REAL, NA_REAL, 2, internal->dim_m_1, internal->dim_m_2);
  internal->offset_variable_E = 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg + internal->dim_D_hosp + internal->dim_D_comm + internal->dim_R_stepdown + internal->dim_R_pre;
  internal->offset_variable_I_asympt = 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg + internal->dim_D_hosp + internal->dim_D_comm + internal->dim_R_stepdown + internal->dim_R_pre + internal->dim_E;
  internal->offset_variable_I_comm_D = 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg + internal->dim_D_hosp + internal->dim_D_comm + internal->dim_R_stepdown + internal->dim_R_pre + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI;
  internal->offset_variable_I_hosp_D_conf = 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg + internal->dim_D_hosp + internal->dim_D_comm + internal->dim_R_stepdown + internal->dim_R_pre + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_comm_D + internal->dim_I_triage_R + internal->dim_I_triage_D + internal->dim_I_hosp_R_unconf + internal->dim_I_hosp_R_conf + internal->dim_I_hosp_D_unconf;
  internal->offset_variable_I_hosp_D_unconf = 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg + internal->dim_D_hosp + internal->dim_D_comm + internal->dim_R_stepdown + internal->dim_R_pre + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_comm_D + internal->dim_I_triage_R + internal->dim_I_triage_D + internal->dim_I_hosp_R_unconf + internal->dim_I_hosp_R_conf;
  internal->offset_variable_I_hosp_R_conf = 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg + internal->dim_D_hosp + internal->dim_D_comm + internal->dim_R_stepdown + internal->dim_R_pre + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_comm_D + internal->dim_I_triage_R + internal->dim_I_triage_D + internal->dim_I_hosp_R_unconf;
  internal->offset_variable_I_hosp_R_unconf = 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg + internal->dim_D_hosp + internal->dim_D_comm + internal->dim_R_stepdown + internal->dim_R_pre + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_comm_D + internal->dim_I_triage_R + internal->dim_I_triage_D;
  internal->offset_variable_I_ICU_D = 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg + internal->dim_D_hosp + internal->dim_D_comm + internal->dim_R_stepdown + internal->dim_R_pre + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_comm_D + internal->dim_I_triage_R + internal->dim_I_triage_D + internal->dim_I_hosp_R_unconf + internal->dim_I_hosp_R_conf + internal->dim_I_hosp_D_unconf + internal->dim_I_hosp_D_conf + internal->dim_I_ICU_R;
  internal->offset_variable_I_ICU_R = 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg + internal->dim_D_hosp + internal->dim_D_comm + internal->dim_R_stepdown + internal->dim_R_pre + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_comm_D + internal->dim_I_triage_R + internal->dim_I_triage_D + internal->dim_I_hosp_R_unconf + internal->dim_I_hosp_R_conf + internal->dim_I_hosp_D_unconf + internal->dim_I_hosp_D_conf;
  internal->offset_variable_I_ILI = 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg + internal->dim_D_hosp + internal->dim_D_comm + internal->dim_R_stepdown + internal->dim_R_pre + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild;
  internal->offset_variable_I_mild = 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg + internal->dim_D_hosp + internal->dim_D_comm + internal->dim_R_stepdown + internal->dim_R_pre + internal->dim_E + internal->dim_I_asympt;
  internal->offset_variable_I_triage_D = 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg + internal->dim_D_hosp + internal->dim_D_comm + internal->dim_R_stepdown + internal->dim_R_pre + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_comm_D + internal->dim_I_triage_R;
  internal->offset_variable_I_triage_R = 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg + internal->dim_D_hosp + internal->dim_D_comm + internal->dim_R_stepdown + internal->dim_R_pre + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_comm_D;
  internal->offset_variable_R_pre = 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg + internal->dim_D_hosp + internal->dim_D_comm + internal->dim_R_stepdown;
  for (int i = 1; i <= internal->dim_p_R_pre; ++i) {
    internal->p_R_pre[i - 1] = 1 - exp(-(internal->gamma_R_pre) * internal->dt);
  }
  internal->R0_pre = (double*) user_get_array(user, false, internal->R0_pre, "R0_pre", NA_REAL, NA_REAL, 2, internal->dim_R0_pre_1, internal->dim_R0_pre_2);
...
SEXP hospital_with_serology_testing_metadata(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(variable_length, 5, ScalarInteger(internal->dim_D_hosp));
  SET_VECTOR_ELT(variable_length, 6, ScalarInteger(internal->dim_D_comm));
  SET_VECTOR_ELT(variable_length, 7, allocVector(INTSXP, 2));
  int * dim_R_stepdown = INTEGER(VECTOR_ELT(variable_length, 7));
  dim_R_stepdown[0] = internal->dim_R_stepdown_1;
  dim_R_stepdown[1] = internal->dim_R_stepdown_2;
  ...
  dim_I_comm_D[2] = internal->dim_I_comm_D_3;
  SET_VECTOR_ELT(variable_length, 14, allocVector(INTSXP, 3));
  int * dim_I_triage_R = INTEGER(VECTOR_ELT(variable_length, 14));
  dim_I_triage_R[0] = internal->dim_I_triage_R_1;
  dim_I_triage_R[1] = internal->dim_I_triage_R_2;
  dim_I_triage_R[2] = internal->dim_I_triage_R_3;
  SET_VECTOR_ELT(variable_length, 15, allocVector(INTSXP, 3));
  int * dim_I_triage_D = INTEGER(VECTOR_ELT(variable_length, 15));
  dim_I_triage_D[0] = internal->dim_I_triage_D_1;
  dim_I_triage_D[1] = internal->dim_I_triage_D_2;
  dim_I_triage_D[2] = internal->dim_I_triage_D_3;
  SET_VECTOR_ELT(variable_length, 16, allocVector(INTSXP, 3));
  int * dim_I_hosp_R_unconf = INTEGER(VECTOR_ELT(variable_length, 16));
  ...
  SET_VECTOR_ELT(variable_length, 17, allocVector(INTSXP, 3));
  int * dim_I_hosp_R_conf = INTEGER(VECTOR_ELT(variable_length, 17));
  ...
  int * dim_I_hosp_D_unconf = INTEGER(VECTOR_ELT(variable_length, 18));
  ...
  int * dim_I_hosp_D_conf = INTEGER(VECTOR_ELT(variable_length, 19));
  ...
  SET_STRING_ELT(variable_names, 5, mkChar("D_hosp"));
  SET_STRING_ELT(variable_names, 6, mkChar("D_comm"));
  SET_STRING_ELT(variable_names, 7, mkChar("R_stepdown"));
  ...
  SET_STRING_ELT(variable_names, 14, mkChar("I_triage_R"));
  SET_STRING_ELT(variable_names, 15, mkChar("I_triage_D"));
  SET_STRING_ELT(variable_names, 16, mkChar("I_hosp_R_unconf"));
  SET_STRING_ELT(variable_names, 17, mkChar("I_hosp_R_conf"));
  SET_STRING_ELT(variable_names, 18, mkChar("I_hosp_D_unconf"));
  SET_STRING_ELT(variable_names, 19, mkChar("I_hosp_D_conf"));
