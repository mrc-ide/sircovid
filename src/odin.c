...
SEXP hospital_with_serology_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 518));
  SEXP aux_EE = PROTECT(allocVector(REALSXP, internal->dim_aux_EE));
  memcpy(REAL(aux_EE), internal->aux_EE, internal->dim_aux_EE * sizeof(double));
  odin_set_dim(aux_EE, 3, internal->dim_aux_EE_1, internal->dim_aux_EE_2, internal->dim_aux_EE_3);
  SET_VECTOR_ELT(contents, 0, aux_EE);
  ...
  SET_VECTOR_ELT(contents, 163, ScalarInteger(internal->dim_gamma_R_pre));
  SET_VECTOR_ELT(contents, 164, ScalarInteger(internal->dim_I_asympt));
  SET_VECTOR_ELT(contents, 165, ScalarInteger(internal->dim_I_asympt_1));
  SET_VECTOR_ELT(contents, 166, ScalarInteger(internal->dim_I_asympt_12));
  SET_VECTOR_ELT(contents, 167, ScalarInteger(internal->dim_I_asympt_2));
  SET_VECTOR_ELT(contents, 168, ScalarInteger(internal->dim_I_asympt_3));
  ...
  SET_VECTOR_ELT(contents, 172, ScalarInteger(internal->dim_I_hosp_D_2));
  SET_VECTOR_ELT(contents, 173, ScalarInteger(internal->dim_I_hosp_D_3));
  SET_VECTOR_ELT(contents, 174, ScalarInteger(internal->dim_I_hosp_R));
  SET_VECTOR_ELT(contents, 175, ScalarInteger(internal->dim_I_hosp_R_1));
  SET_VECTOR_ELT(contents, 176, ScalarInteger(internal->dim_I_hosp_R_12));
  SET_VECTOR_ELT(contents, 177, ScalarInteger(internal->dim_I_hosp_R_2));
  SET_VECTOR_ELT(contents, 178, ScalarInteger(internal->dim_I_hosp_R_3));
  SET_VECTOR_ELT(contents, 179, ScalarInteger(internal->dim_I_ICU_D));
  SET_VECTOR_ELT(contents, 180, ScalarInteger(internal->dim_I_ICU_D_1));
  SET_VECTOR_ELT(contents, 181, ScalarInteger(internal->dim_I_ICU_D_12));
  SET_VECTOR_ELT(contents, 182, ScalarInteger(internal->dim_I_ICU_D_2));
  SET_VECTOR_ELT(contents, 183, ScalarInteger(internal->dim_I_ICU_D_3));
  SET_VECTOR_ELT(contents, 184, ScalarInteger(internal->dim_I_ICU_R));
  SET_VECTOR_ELT(contents, 185, ScalarInteger(internal->dim_I_ICU_R_1));
  SET_VECTOR_ELT(contents, 186, ScalarInteger(internal->dim_I_ICU_R_12));
  SET_VECTOR_ELT(contents, 187, ScalarInteger(internal->dim_I_ICU_R_2));
  SET_VECTOR_ELT(contents, 188, ScalarInteger(internal->dim_I_ICU_R_3));
  SET_VECTOR_ELT(contents, 189, ScalarInteger(internal->dim_I_ILI));
  SET_VECTOR_ELT(contents, 190, ScalarInteger(internal->dim_I_ILI_1));
  SET_VECTOR_ELT(contents, 191, ScalarInteger(internal->dim_I_ILI_12));
  SET_VECTOR_ELT(contents, 192, ScalarInteger(internal->dim_I_ILI_2));
  SET_VECTOR_ELT(contents, 193, ScalarInteger(internal->dim_I_ILI_3));
  SET_VECTOR_ELT(contents, 194, ScalarInteger(internal->dim_I_mild));
  SET_VECTOR_ELT(contents, 195, ScalarInteger(internal->dim_I_mild_1));
  SET_VECTOR_ELT(contents, 196, ScalarInteger(internal->dim_I_mild_12));
  SET_VECTOR_ELT(contents, 197, ScalarInteger(internal->dim_I_mild_2));
  SET_VECTOR_ELT(contents, 198, ScalarInteger(internal->dim_I_mild_3));
  SET_VECTOR_ELT(contents, 199, ScalarInteger(internal->dim_I_triage_D));
  SET_VECTOR_ELT(contents, 200, ScalarInteger(internal->dim_I_triage_D_1));
  SET_VECTOR_ELT(contents, 201, ScalarInteger(internal->dim_I_triage_D_12));
  SET_VECTOR_ELT(contents, 202, ScalarInteger(internal->dim_I_triage_D_2));
  SET_VECTOR_ELT(contents, 203, ScalarInteger(internal->dim_I_triage_D_3));
  SET_VECTOR_ELT(contents, 204, ScalarInteger(internal->dim_I_triage_R));
  SET_VECTOR_ELT(contents, 205, ScalarInteger(internal->dim_I_triage_R_1));
  SET_VECTOR_ELT(contents, 206, ScalarInteger(internal->dim_I_triage_R_12));
  SET_VECTOR_ELT(contents, 207, ScalarInteger(internal->dim_I_triage_R_2));
  SET_VECTOR_ELT(contents, 208, ScalarInteger(internal->dim_I_triage_R_3));
  SET_VECTOR_ELT(contents, 209, ScalarInteger(internal->dim_I_with_diff_trans));
  SET_VECTOR_ELT(contents, 210, ScalarInteger(internal->dim_I_with_diff_trans_1));
  SET_VECTOR_ELT(contents, 211, ScalarInteger(internal->dim_I_with_diff_trans_2));
  SET_VECTOR_ELT(contents, 212, ScalarInteger(internal->dim_I0_asympt));
  SET_VECTOR_ELT(contents, 213, ScalarInteger(internal->dim_I0_asympt_1));
  SET_VECTOR_ELT(contents, 214, ScalarInteger(internal->dim_I0_asympt_12));
  SET_VECTOR_ELT(contents, 215, ScalarInteger(internal->dim_I0_asympt_2));
  SET_VECTOR_ELT(contents, 216, ScalarInteger(internal->dim_I0_asympt_3));
  SET_VECTOR_ELT(contents, 217, ScalarInteger(internal->dim_I0_hosp_D));
  SET_VECTOR_ELT(contents, 218, ScalarInteger(internal->dim_I0_hosp_D_1));
  SET_VECTOR_ELT(contents, 219, ScalarInteger(internal->dim_I0_hosp_D_12));
  SET_VECTOR_ELT(contents, 220, ScalarInteger(internal->dim_I0_hosp_D_2));
  SET_VECTOR_ELT(contents, 221, ScalarInteger(internal->dim_I0_hosp_D_3));
  SET_VECTOR_ELT(contents, 222, ScalarInteger(internal->dim_I0_hosp_R));
  SET_VECTOR_ELT(contents, 223, ScalarInteger(internal->dim_I0_hosp_R_1));
  SET_VECTOR_ELT(contents, 224, ScalarInteger(internal->dim_I0_hosp_R_12));
  SET_VECTOR_ELT(contents, 225, ScalarInteger(internal->dim_I0_hosp_R_2));
  SET_VECTOR_ELT(contents, 226, ScalarInteger(internal->dim_I0_hosp_R_3));
  SET_VECTOR_ELT(contents, 227, ScalarInteger(internal->dim_I0_ICU_D));
  SET_VECTOR_ELT(contents, 228, ScalarInteger(internal->dim_I0_ICU_D_1));
  SET_VECTOR_ELT(contents, 229, ScalarInteger(internal->dim_I0_ICU_D_12));
  SET_VECTOR_ELT(contents, 230, ScalarInteger(internal->dim_I0_ICU_D_2));
  SET_VECTOR_ELT(contents, 231, ScalarInteger(internal->dim_I0_ICU_D_3));
  SET_VECTOR_ELT(contents, 232, ScalarInteger(internal->dim_I0_ICU_R));
  SET_VECTOR_ELT(contents, 233, ScalarInteger(internal->dim_I0_ICU_R_1));
  SET_VECTOR_ELT(contents, 234, ScalarInteger(internal->dim_I0_ICU_R_12));
  SET_VECTOR_ELT(contents, 235, ScalarInteger(internal->dim_I0_ICU_R_2));
  SET_VECTOR_ELT(contents, 236, ScalarInteger(internal->dim_I0_ICU_R_3));
  SET_VECTOR_ELT(contents, 237, ScalarInteger(internal->dim_I0_ILI));
  SET_VECTOR_ELT(contents, 238, ScalarInteger(internal->dim_I0_ILI_1));
  SET_VECTOR_ELT(contents, 239, ScalarInteger(internal->dim_I0_ILI_12));
  SET_VECTOR_ELT(contents, 240, ScalarInteger(internal->dim_I0_ILI_2));
  SET_VECTOR_ELT(contents, 241, ScalarInteger(internal->dim_I0_ILI_3));
  SET_VECTOR_ELT(contents, 242, ScalarInteger(internal->dim_I0_mild));
  SET_VECTOR_ELT(contents, 243, ScalarInteger(internal->dim_I0_mild_1));
  SET_VECTOR_ELT(contents, 244, ScalarInteger(internal->dim_I0_mild_12));
  SET_VECTOR_ELT(contents, 245, ScalarInteger(internal->dim_I0_mild_2));
  SET_VECTOR_ELT(contents, 246, ScalarInteger(internal->dim_I0_mild_3));
  SET_VECTOR_ELT(contents, 247, ScalarInteger(internal->dim_I0_triage_D));
  SET_VECTOR_ELT(contents, 248, ScalarInteger(internal->dim_I0_triage_D_1));
  SET_VECTOR_ELT(contents, 249, ScalarInteger(internal->dim_I0_triage_D_12));
  SET_VECTOR_ELT(contents, 250, ScalarInteger(internal->dim_I0_triage_D_2));
  SET_VECTOR_ELT(contents, 251, ScalarInteger(internal->dim_I0_triage_D_3));
  SET_VECTOR_ELT(contents, 252, ScalarInteger(internal->dim_I0_triage_R));
  SET_VECTOR_ELT(contents, 253, ScalarInteger(internal->dim_I0_triage_R_1));
  SET_VECTOR_ELT(contents, 254, ScalarInteger(internal->dim_I0_triage_R_12));
  SET_VECTOR_ELT(contents, 255, ScalarInteger(internal->dim_I0_triage_R_2));
  SET_VECTOR_ELT(contents, 256, ScalarInteger(internal->dim_I0_triage_R_3));
  SET_VECTOR_ELT(contents, 257, ScalarInteger(internal->dim_lambda));
  SET_VECTOR_ELT(contents, 258, ScalarInteger(internal->dim_m));
  SET_VECTOR_ELT(contents, 259, ScalarInteger(internal->dim_m_1));
  SET_VECTOR_ELT(contents, 260, ScalarInteger(internal->dim_m_2));
  SET_VECTOR_ELT(contents, 261, ScalarInteger(internal->dim_n_com_to_R_pre));
  SET_VECTOR_ELT(contents, 262, ScalarInteger(internal->dim_n_com_to_R_total));
  SET_VECTOR_ELT(contents, 263, ScalarInteger(internal->dim_n_EE));
  SET_VECTOR_ELT(contents, 264, ScalarInteger(internal->dim_n_EE_1));
  SET_VECTOR_ELT(contents, 265, ScalarInteger(internal->dim_n_EE_12));
  SET_VECTOR_ELT(contents, 266, ScalarInteger(internal->dim_n_EE_2));
  SET_VECTOR_ELT(contents, 267, ScalarInteger(internal->dim_n_EE_3));
  SET_VECTOR_ELT(contents, 268, ScalarInteger(internal->dim_n_EI_asympt));
  SET_VECTOR_ELT(contents, 269, ScalarInteger(internal->dim_n_EI_asympt_1));
  SET_VECTOR_ELT(contents, 270, ScalarInteger(internal->dim_n_EI_asympt_2));
  SET_VECTOR_ELT(contents, 271, ScalarInteger(internal->dim_n_EI_ILI));
  SET_VECTOR_ELT(contents, 272, ScalarInteger(internal->dim_n_EI_ILI_1));
  SET_VECTOR_ELT(contents, 273, ScalarInteger(internal->dim_n_EI_ILI_2));
  SET_VECTOR_ELT(contents, 274, ScalarInteger(internal->dim_n_EI_mild));
  SET_VECTOR_ELT(contents, 275, ScalarInteger(internal->dim_n_EI_mild_1));
  SET_VECTOR_ELT(contents, 276, ScalarInteger(internal->dim_n_EI_mild_2));
  SET_VECTOR_ELT(contents, 277, ScalarInteger(internal->dim_n_hosp_non_ICU));
  SET_VECTOR_ELT(contents, 278, ScalarInteger(internal->dim_n_hosp_non_ICU_1));
  SET_VECTOR_ELT(contents, 279, ScalarInteger(internal->dim_n_hosp_non_ICU_2));
  SET_VECTOR_ELT(contents, 280, ScalarInteger(internal->dim_n_ICU_to_R_stepdown));
  SET_VECTOR_ELT(contents, 281, ScalarInteger(internal->dim_n_II_asympt));
  SET_VECTOR_ELT(contents, 282, ScalarInteger(internal->dim_n_II_asympt_1));
  SET_VECTOR_ELT(contents, 283, ScalarInteger(internal->dim_n_II_asympt_12));
  SET_VECTOR_ELT(contents, 284, ScalarInteger(internal->dim_n_II_asympt_2));
  SET_VECTOR_ELT(contents, 285, ScalarInteger(internal->dim_n_II_asympt_3));
  SET_VECTOR_ELT(contents, 286, ScalarInteger(internal->dim_n_II_hosp_D));
  SET_VECTOR_ELT(contents, 287, ScalarInteger(internal->dim_n_II_hosp_D_1));
  SET_VECTOR_ELT(contents, 288, ScalarInteger(internal->dim_n_II_hosp_D_12));
  SET_VECTOR_ELT(contents, 289, ScalarInteger(internal->dim_n_II_hosp_D_2));
  SET_VECTOR_ELT(contents, 290, ScalarInteger(internal->dim_n_II_hosp_D_3));
  SET_VECTOR_ELT(contents, 291, ScalarInteger(internal->dim_n_II_hosp_R));
  SET_VECTOR_ELT(contents, 292, ScalarInteger(internal->dim_n_II_hosp_R_1));
  SET_VECTOR_ELT(contents, 293, ScalarInteger(internal->dim_n_II_hosp_R_12));
  SET_VECTOR_ELT(contents, 294, ScalarInteger(internal->dim_n_II_hosp_R_2));
  SET_VECTOR_ELT(contents, 295, ScalarInteger(internal->dim_n_II_hosp_R_3));
  SET_VECTOR_ELT(contents, 296, ScalarInteger(internal->dim_n_II_ICU_D));
  SET_VECTOR_ELT(contents, 297, ScalarInteger(internal->dim_n_II_ICU_D_1));
  SET_VECTOR_ELT(contents, 298, ScalarInteger(internal->dim_n_II_ICU_D_12));
  SET_VECTOR_ELT(contents, 299, ScalarInteger(internal->dim_n_II_ICU_D_2));
  SET_VECTOR_ELT(contents, 300, ScalarInteger(internal->dim_n_II_ICU_D_3));
  SET_VECTOR_ELT(contents, 301, ScalarInteger(internal->dim_n_II_ICU_R));
  SET_VECTOR_ELT(contents, 302, ScalarInteger(internal->dim_n_II_ICU_R_1));
  SET_VECTOR_ELT(contents, 303, ScalarInteger(internal->dim_n_II_ICU_R_12));
  SET_VECTOR_ELT(contents, 304, ScalarInteger(internal->dim_n_II_ICU_R_2));
  SET_VECTOR_ELT(contents, 305, ScalarInteger(internal->dim_n_II_ICU_R_3));
  SET_VECTOR_ELT(contents, 306, ScalarInteger(internal->dim_n_II_ILI));
  SET_VECTOR_ELT(contents, 307, ScalarInteger(internal->dim_n_II_ILI_1));
  SET_VECTOR_ELT(contents, 308, ScalarInteger(internal->dim_n_II_ILI_12));
  SET_VECTOR_ELT(contents, 309, ScalarInteger(internal->dim_n_II_ILI_2));
  SET_VECTOR_ELT(contents, 310, ScalarInteger(internal->dim_n_II_ILI_3));
  SET_VECTOR_ELT(contents, 311, ScalarInteger(internal->dim_n_II_mild));
  SET_VECTOR_ELT(contents, 312, ScalarInteger(internal->dim_n_II_mild_1));
  SET_VECTOR_ELT(contents, 313, ScalarInteger(internal->dim_n_II_mild_12));
  SET_VECTOR_ELT(contents, 314, ScalarInteger(internal->dim_n_II_mild_2));
  SET_VECTOR_ELT(contents, 315, ScalarInteger(internal->dim_n_II_mild_3));
  SET_VECTOR_ELT(contents, 316, ScalarInteger(internal->dim_n_II_triage_D));
  SET_VECTOR_ELT(contents, 317, ScalarInteger(internal->dim_n_II_triage_D_1));
  SET_VECTOR_ELT(contents, 318, ScalarInteger(internal->dim_n_II_triage_D_12));
  SET_VECTOR_ELT(contents, 319, ScalarInteger(internal->dim_n_II_triage_D_2));
  SET_VECTOR_ELT(contents, 320, ScalarInteger(internal->dim_n_II_triage_D_3));
  SET_VECTOR_ELT(contents, 321, ScalarInteger(internal->dim_n_II_triage_R));
  SET_VECTOR_ELT(contents, 322, ScalarInteger(internal->dim_n_II_triage_R_1));
  SET_VECTOR_ELT(contents, 323, ScalarInteger(internal->dim_n_II_triage_R_12));
  SET_VECTOR_ELT(contents, 324, ScalarInteger(internal->dim_n_II_triage_R_2));
  SET_VECTOR_ELT(contents, 325, ScalarInteger(internal->dim_n_II_triage_R_3));
  SET_VECTOR_ELT(contents, 326, ScalarInteger(internal->dim_n_ILI_to_hosp));
  SET_VECTOR_ELT(contents, 327, ScalarInteger(internal->dim_n_ILI_to_hosp_1));
  SET_VECTOR_ELT(contents, 328, ScalarInteger(internal->dim_n_ILI_to_hosp_2));
  SET_VECTOR_ELT(contents, 329, ScalarInteger(internal->dim_n_ILI_to_hosp_D));
  SET_VECTOR_ELT(contents, 330, ScalarInteger(internal->dim_n_ILI_to_hosp_D_1));
  SET_VECTOR_ELT(contents, 331, ScalarInteger(internal->dim_n_ILI_to_hosp_D_2));
  SET_VECTOR_ELT(contents, 332, ScalarInteger(internal->dim_n_ILI_to_hosp_R));
  SET_VECTOR_ELT(contents, 333, ScalarInteger(internal->dim_n_ILI_to_hosp_R_1));
  SET_VECTOR_ELT(contents, 334, ScalarInteger(internal->dim_n_ILI_to_hosp_R_2));
  SET_VECTOR_ELT(contents, 335, ScalarInteger(internal->dim_n_ILI_to_triage));
  SET_VECTOR_ELT(contents, 336, ScalarInteger(internal->dim_n_ILI_to_triage_1));
  SET_VECTOR_ELT(contents, 337, ScalarInteger(internal->dim_n_ILI_to_triage_2));
  SET_VECTOR_ELT(contents, 338, ScalarInteger(internal->dim_n_ILI_to_triage_D));
  SET_VECTOR_ELT(contents, 339, ScalarInteger(internal->dim_n_ILI_to_triage_D_1));
  SET_VECTOR_ELT(contents, 340, ScalarInteger(internal->dim_n_ILI_to_triage_D_2));
  SET_VECTOR_ELT(contents, 341, ScalarInteger(internal->dim_n_ILI_to_triage_R));
  SET_VECTOR_ELT(contents, 342, ScalarInteger(internal->dim_n_ILI_to_triage_R_1));
  SET_VECTOR_ELT(contents, 343, ScalarInteger(internal->dim_n_ILI_to_triage_R_2));
  SET_VECTOR_ELT(contents, 344, ScalarInteger(internal->dim_n_R_pre));
  SET_VECTOR_ELT(contents, 345, ScalarInteger(internal->dim_n_R_pre_1));
  SET_VECTOR_ELT(contents, 346, ScalarInteger(internal->dim_n_R_pre_2));
  SET_VECTOR_ELT(contents, 347, ScalarInteger(internal->dim_n_R_stepdown));
  SET_VECTOR_ELT(contents, 348, ScalarInteger(internal->dim_n_R_stepdown_1));
  SET_VECTOR_ELT(contents, 349, ScalarInteger(internal->dim_n_R_stepdown_2));
  SET_VECTOR_ELT(contents, 350, ScalarInteger(internal->dim_n_SE));
  SET_VECTOR_ELT(contents, 351, ScalarInteger(internal->dim_p_asympt));
  SET_VECTOR_ELT(contents, 352, ScalarInteger(internal->dim_p_death_hosp_D));
  SET_VECTOR_ELT(contents, 353, ScalarInteger(internal->dim_p_death_ICU));
  SET_VECTOR_ELT(contents, 354, ScalarInteger(internal->dim_p_ICU_hosp));
  SET_VECTOR_ELT(contents, 355, ScalarInteger(internal->dim_p_R_pre));
  SET_VECTOR_ELT(contents, 356, ScalarInteger(internal->dim_p_recov_ILI));
  SET_VECTOR_ELT(contents, 357, ScalarInteger(internal->dim_p_SE));
  SET_VECTOR_ELT(contents, 358, ScalarInteger(internal->dim_p_seroconversion));
  SET_VECTOR_ELT(contents, 359, ScalarInteger(internal->dim_p_sympt_ILI));
  SET_VECTOR_ELT(contents, 360, ScalarInteger(internal->dim_R_neg));
  SET_VECTOR_ELT(contents, 361, ScalarInteger(internal->dim_R_pos));
  SET_VECTOR_ELT(contents, 362, ScalarInteger(internal->dim_R_pre));
  SET_VECTOR_ELT(contents, 363, ScalarInteger(internal->dim_R_pre_1));
  SET_VECTOR_ELT(contents, 364, ScalarInteger(internal->dim_R_pre_2));
  SET_VECTOR_ELT(contents, 365, ScalarInteger(internal->dim_R_stepdown));
  SET_VECTOR_ELT(contents, 366, ScalarInteger(internal->dim_R_stepdown_1));
  SET_VECTOR_ELT(contents, 367, ScalarInteger(internal->dim_R_stepdown_2));
  SET_VECTOR_ELT(contents, 368, ScalarInteger(internal->dim_R0_neg));
  SET_VECTOR_ELT(contents, 369, ScalarInteger(internal->dim_R0_pos));
  SET_VECTOR_ELT(contents, 370, ScalarInteger(internal->dim_R0_pre));
  SET_VECTOR_ELT(contents, 371, ScalarInteger(internal->dim_R0_pre_1));
  SET_VECTOR_ELT(contents, 372, ScalarInteger(internal->dim_R0_pre_2));
  SET_VECTOR_ELT(contents, 373, ScalarInteger(internal->dim_R0_stepdown));
  SET_VECTOR_ELT(contents, 374, ScalarInteger(internal->dim_R0_stepdown_1));
  SET_VECTOR_ELT(contents, 375, ScalarInteger(internal->dim_R0_stepdown_2));
  SET_VECTOR_ELT(contents, 376, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 377, ScalarInteger(internal->dim_s_ij));
  SET_VECTOR_ELT(contents, 378, ScalarInteger(internal->dim_s_ij_1));
  SET_VECTOR_ELT(contents, 379, ScalarInteger(internal->dim_s_ij_2));
  SET_VECTOR_ELT(contents, 380, ScalarInteger(internal->dim_S0));
  SET_VECTOR_ELT(contents, 381, ScalarInteger(internal->dim_trans_increase));
  SET_VECTOR_ELT(contents, 382, ScalarInteger(internal->dim_trans_increase_1));
  SET_VECTOR_ELT(contents, 383, ScalarInteger(internal->dim_trans_increase_2));
  SET_VECTOR_ELT(contents, 384, ScalarInteger(internal->dim_trans_profile));
  SET_VECTOR_ELT(contents, 385, ScalarInteger(internal->dim_trans_profile_1));
  SET_VECTOR_ELT(contents, 386, ScalarInteger(internal->dim_trans_profile_2));
  SET_VECTOR_ELT(contents, 387, ScalarReal(internal->dt));
  SEXP E0 = PROTECT(allocVector(REALSXP, internal->dim_E0));
  memcpy(REAL(E0), internal->E0, internal->dim_E0 * sizeof(double));
  odin_set_dim(E0, 3, internal->dim_E0_1, internal->dim_E0_2, internal->dim_E0_3);
  SET_VECTOR_ELT(contents, 388, E0);
  SET_VECTOR_ELT(contents, 389, ScalarReal(internal->gamma_asympt));
  SET_VECTOR_ELT(contents, 390, ScalarReal(internal->gamma_E));
  SET_VECTOR_ELT(contents, 391, ScalarReal(internal->gamma_hosp_D));
  SET_VECTOR_ELT(contents, 392, ScalarReal(internal->gamma_hosp_R));
  SET_VECTOR_ELT(contents, 393, ScalarReal(internal->gamma_ICU_D));
  SET_VECTOR_ELT(contents, 394, ScalarReal(internal->gamma_ICU_R));
  SET_VECTOR_ELT(contents, 395, ScalarReal(internal->gamma_ILI));
  SET_VECTOR_ELT(contents, 396, ScalarReal(internal->gamma_mild));
  SEXP gamma_R_pre = PROTECT(allocVector(REALSXP, internal->dim_gamma_R_pre));
  memcpy(REAL(gamma_R_pre), internal->gamma_R_pre, internal->dim_gamma_R_pre * sizeof(double));
  SET_VECTOR_ELT(contents, 397, gamma_R_pre);
  SET_VECTOR_ELT(contents, 398, ScalarReal(internal->gamma_stepdown));
  SET_VECTOR_ELT(contents, 399, ScalarReal(internal->gamma_triage));
  SET_VECTOR_ELT(contents, 400, ScalarReal(internal->hosp_transmission));
  SEXP I_with_diff_trans = PROTECT(allocVector(REALSXP, internal->dim_I_with_diff_trans));
  memcpy(REAL(I_with_diff_trans), internal->I_with_diff_trans, internal->dim_I_with_diff_trans * sizeof(double));
  odin_set_dim(I_with_diff_trans, 2, internal->dim_I_with_diff_trans_1, internal->dim_I_with_diff_trans_2);
  SET_VECTOR_ELT(contents, 401, I_with_diff_trans);
  SEXP I0_asympt = PROTECT(allocVector(REALSXP, internal->dim_I0_asympt));
  memcpy(REAL(I0_asympt), internal->I0_asympt, internal->dim_I0_asympt * sizeof(double));
  odin_set_dim(I0_asympt, 3, internal->dim_I0_asympt_1, internal->dim_I0_asympt_2, internal->dim_I0_asympt_3);
  SET_VECTOR_ELT(contents, 402, I0_asympt);
  ...
  SET_VECTOR_ELT(contents, 403, I0_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 404, I0_hosp_R);
  ...
  SET_VECTOR_ELT(contents, 405, I0_ICU_D);
  ...
  SET_VECTOR_ELT(contents, 406, I0_ICU_R);
  SEXP I0_ILI = PROTECT(allocVector(REALSXP, internal->dim_I0_ILI));
  memcpy(REAL(I0_ILI), internal->I0_ILI, internal->dim_I0_ILI * sizeof(double));
  odin_set_dim(I0_ILI, 3, internal->dim_I0_ILI_1, internal->dim_I0_ILI_2, internal->dim_I0_ILI_3);
  SET_VECTOR_ELT(contents, 407, I0_ILI);
  SEXP I0_mild = PROTECT(allocVector(REALSXP, internal->dim_I0_mild));
  memcpy(REAL(I0_mild), internal->I0_mild, internal->dim_I0_mild * sizeof(double));
  odin_set_dim(I0_mild, 3, internal->dim_I0_mild_1, internal->dim_I0_mild_2, internal->dim_I0_mild_3);
  SET_VECTOR_ELT(contents, 408, I0_mild);
  ...
  SET_VECTOR_ELT(contents, 409, I0_triage_D);
  ...
  SET_VECTOR_ELT(contents, 410, I0_triage_R);
  SET_VECTOR_ELT(contents, 411, ScalarReal(internal->ICU_transmission));
  SEXP initial_D = PROTECT(allocVector(REALSXP, internal->dim_D));
  memcpy(REAL(initial_D), internal->initial_D, internal->dim_D * sizeof(double));
  SET_VECTOR_ELT(contents, 412, initial_D);
  SEXP initial_E = PROTECT(allocVector(REALSXP, internal->dim_E));
  memcpy(REAL(initial_E), internal->initial_E, internal->dim_E * sizeof(double));
  odin_set_dim(initial_E, 3, internal->dim_E_1, internal->dim_E_2, internal->dim_E_3);
  SET_VECTOR_ELT(contents, 413, initial_E);
  SEXP initial_I_asympt = PROTECT(allocVector(REALSXP, internal->dim_I_asympt));
  memcpy(REAL(initial_I_asympt), internal->initial_I_asympt, internal->dim_I_asympt * sizeof(double));
  odin_set_dim(initial_I_asympt, 3, internal->dim_I_asympt_1, internal->dim_I_asympt_2, internal->dim_I_asympt_3);
  SET_VECTOR_ELT(contents, 414, initial_I_asympt);
  ...
  SET_VECTOR_ELT(contents, 415, initial_I_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 416, initial_I_hosp_R);
  ...
  SET_VECTOR_ELT(contents, 417, initial_I_ICU_D);
  ...
  SET_VECTOR_ELT(contents, 418, initial_I_ICU_R);
  SEXP initial_I_ILI = PROTECT(allocVector(REALSXP, internal->dim_I_ILI));
  memcpy(REAL(initial_I_ILI), internal->initial_I_ILI, internal->dim_I_ILI * sizeof(double));
  odin_set_dim(initial_I_ILI, 3, internal->dim_I_ILI_1, internal->dim_I_ILI_2, internal->dim_I_ILI_3);
  SET_VECTOR_ELT(contents, 419, initial_I_ILI);
  SEXP initial_I_mild = PROTECT(allocVector(REALSXP, internal->dim_I_mild));
  memcpy(REAL(initial_I_mild), internal->initial_I_mild, internal->dim_I_mild * sizeof(double));
  odin_set_dim(initial_I_mild, 3, internal->dim_I_mild_1, internal->dim_I_mild_2, internal->dim_I_mild_3);
  SET_VECTOR_ELT(contents, 420, initial_I_mild);
  ...
  SET_VECTOR_ELT(contents, 421, initial_I_triage_D);
  ...
  SET_VECTOR_ELT(contents, 422, initial_I_triage_R);
  ...
  SET_VECTOR_ELT(contents, 423, initial_R_neg);
  ...
  SET_VECTOR_ELT(contents, 424, initial_R_pos);
  ...
  SET_VECTOR_ELT(contents, 425, initial_R_pre);
  ...
  SET_VECTOR_ELT(contents, 426, initial_R_stepdown);
  SEXP initial_S = PROTECT(allocVector(REALSXP, internal->dim_S));
  memcpy(REAL(initial_S), internal->initial_S, internal->dim_S * sizeof(double));
  SET_VECTOR_ELT(contents, 427, initial_S);
  SEXP lambda = PROTECT(allocVector(REALSXP, internal->dim_lambda));
  memcpy(REAL(lambda), internal->lambda, internal->dim_lambda * sizeof(double));
  ...
  SET_VECTOR_ELT(contents, 431, ScalarInteger(internal->N_age));
  ...
  SET_VECTOR_ELT(contents, 432, n_com_to_R_pre);
  ...
  SET_VECTOR_ELT(contents, 433, n_com_to_R_total);
  SEXP n_EE = PROTECT(allocVector(REALSXP, internal->dim_n_EE));
  memcpy(REAL(n_EE), internal->n_EE, internal->dim_n_EE * sizeof(double));
  odin_set_dim(n_EE, 3, internal->dim_n_EE_1, internal->dim_n_EE_2, internal->dim_n_EE_3);
  SET_VECTOR_ELT(contents, 434, n_EE);
  SEXP n_EI_asympt = PROTECT(allocVector(REALSXP, internal->dim_n_EI_asympt));
  memcpy(REAL(n_EI_asympt), internal->n_EI_asympt, internal->dim_n_EI_asympt * sizeof(double));
  odin_set_dim(n_EI_asympt, 2, internal->dim_n_EI_asympt_1, internal->dim_n_EI_asympt_2);
  SET_VECTOR_ELT(contents, 435, n_EI_asympt);
  SEXP n_EI_ILI = PROTECT(allocVector(REALSXP, internal->dim_n_EI_ILI));
  memcpy(REAL(n_EI_ILI), internal->n_EI_ILI, internal->dim_n_EI_ILI * sizeof(double));
  odin_set_dim(n_EI_ILI, 2, internal->dim_n_EI_ILI_1, internal->dim_n_EI_ILI_2);
  SET_VECTOR_ELT(contents, 436, n_EI_ILI);
  SEXP n_EI_mild = PROTECT(allocVector(REALSXP, internal->dim_n_EI_mild));
  memcpy(REAL(n_EI_mild), internal->n_EI_mild, internal->dim_n_EI_mild * sizeof(double));
  odin_set_dim(n_EI_mild, 2, internal->dim_n_EI_mild_1, internal->dim_n_EI_mild_2);
  SET_VECTOR_ELT(contents, 437, n_EI_mild);
  ...
  SET_VECTOR_ELT(contents, 438, n_hosp_non_ICU);
  ...
  SET_VECTOR_ELT(contents, 439, n_ICU_to_R_stepdown);
  SEXP n_II_asympt = PROTECT(allocVector(REALSXP, internal->dim_n_II_asympt));
  memcpy(REAL(n_II_asympt), internal->n_II_asympt, internal->dim_n_II_asympt * sizeof(double));
  odin_set_dim(n_II_asympt, 3, internal->dim_n_II_asympt_1, internal->dim_n_II_asympt_2, internal->dim_n_II_asympt_3);
  SET_VECTOR_ELT(contents, 440, n_II_asympt);
  ...
  SET_VECTOR_ELT(contents, 441, n_II_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 442, n_II_hosp_R);
  ...
  SET_VECTOR_ELT(contents, 443, n_II_ICU_D);
  ...
  SET_VECTOR_ELT(contents, 444, n_II_ICU_R);
  SEXP n_II_ILI = PROTECT(allocVector(REALSXP, internal->dim_n_II_ILI));
  memcpy(REAL(n_II_ILI), internal->n_II_ILI, internal->dim_n_II_ILI * sizeof(double));
  odin_set_dim(n_II_ILI, 3, internal->dim_n_II_ILI_1, internal->dim_n_II_ILI_2, internal->dim_n_II_ILI_3);
  SET_VECTOR_ELT(contents, 445, n_II_ILI);
  SEXP n_II_mild = PROTECT(allocVector(REALSXP, internal->dim_n_II_mild));
  memcpy(REAL(n_II_mild), internal->n_II_mild, internal->dim_n_II_mild * sizeof(double));
  odin_set_dim(n_II_mild, 3, internal->dim_n_II_mild_1, internal->dim_n_II_mild_2, internal->dim_n_II_mild_3);
  SET_VECTOR_ELT(contents, 446, n_II_mild);
  ...
  SET_VECTOR_ELT(contents, 447, n_II_triage_D);
  ...
  SET_VECTOR_ELT(contents, 448, n_II_triage_R);
  SEXP n_ILI_to_hosp = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_hosp));
  memcpy(REAL(n_ILI_to_hosp), internal->n_ILI_to_hosp, internal->dim_n_ILI_to_hosp * sizeof(double));
  odin_set_dim(n_ILI_to_hosp, 2, internal->dim_n_ILI_to_hosp_1, internal->dim_n_ILI_to_hosp_2);
  SET_VECTOR_ELT(contents, 449, n_ILI_to_hosp);
  ...
  SET_VECTOR_ELT(contents, 450, n_ILI_to_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 451, n_ILI_to_hosp_R);
  ...
  SET_VECTOR_ELT(contents, 452, n_ILI_to_triage);
  ...
  SET_VECTOR_ELT(contents, 453, n_ILI_to_triage_D);
  ...
  SET_VECTOR_ELT(contents, 454, n_ILI_to_triage_R);
  ...
  SET_VECTOR_ELT(contents, 455, n_R_pre);
  ...
  SET_VECTOR_ELT(contents, 456, n_R_stepdown);
  SEXP n_SE = PROTECT(allocVector(REALSXP, internal->dim_n_SE));
  memcpy(REAL(n_SE), internal->n_SE, internal->dim_n_SE * sizeof(double));
  SET_VECTOR_ELT(contents, 457, n_SE);
  SET_VECTOR_ELT(contents, 458, ScalarInteger(internal->offset_output_n_EI_ILI));
  SET_VECTOR_ELT(contents, 459, ScalarInteger(internal->offset_output_n_EI_mild));
  SET_VECTOR_ELT(contents, 460, ScalarInteger(internal->offset_output_n_ILI_to_hosp));
  SET_VECTOR_ELT(contents, 461, ScalarInteger(internal->offset_output_n_ILI_to_hosp_D));
  SET_VECTOR_ELT(contents, 462, ScalarInteger(internal->offset_output_n_ILI_to_hosp_R));
  SET_VECTOR_ELT(contents, 463, ScalarInteger(internal->offset_output_n_ILI_to_triage_D));
  SET_VECTOR_ELT(contents, 464, ScalarInteger(internal->offset_output_n_ILI_to_triage_R));
  SET_VECTOR_ELT(contents, 465, ScalarInteger(internal->offset_variable_D));
  SET_VECTOR_ELT(contents, 466, ScalarInteger(internal->offset_variable_E));
  SET_VECTOR_ELT(contents, 467, ScalarInteger(internal->offset_variable_I_asympt));
  SET_VECTOR_ELT(contents, 468, ScalarInteger(internal->offset_variable_I_hosp_D));
  SET_VECTOR_ELT(contents, 469, ScalarInteger(internal->offset_variable_I_hosp_R));
  SET_VECTOR_ELT(contents, 470, ScalarInteger(internal->offset_variable_I_ICU_D));
  SET_VECTOR_ELT(contents, 471, ScalarInteger(internal->offset_variable_I_ICU_R));
  SET_VECTOR_ELT(contents, 472, ScalarInteger(internal->offset_variable_I_ILI));
  SET_VECTOR_ELT(contents, 473, ScalarInteger(internal->offset_variable_I_mild));
  SET_VECTOR_ELT(contents, 474, ScalarInteger(internal->offset_variable_I_triage_D));
  SET_VECTOR_ELT(contents, 475, ScalarInteger(internal->offset_variable_I_triage_R));
  SET_VECTOR_ELT(contents, 476, ScalarInteger(internal->offset_variable_R_neg));
  SET_VECTOR_ELT(contents, 477, ScalarInteger(internal->offset_variable_R_pre));
  SET_VECTOR_ELT(contents, 478, ScalarInteger(internal->offset_variable_R_stepdown));
  SEXP p_asympt = PROTECT(allocVector(REALSXP, internal->dim_p_asympt));
  memcpy(REAL(p_asympt), internal->p_asympt, internal->dim_p_asympt * sizeof(double));
  SET_VECTOR_ELT(contents, 479, p_asympt);
  ...
  SET_VECTOR_ELT(contents, 480, p_death_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 481, p_death_ICU);
  SET_VECTOR_ELT(contents, 482, ScalarReal(internal->p_EE));
  ...
  SET_VECTOR_ELT(contents, 483, p_ICU_hosp);
  SET_VECTOR_ELT(contents, 484, ScalarReal(internal->p_II_asympt));
  SET_VECTOR_ELT(contents, 485, ScalarReal(internal->p_II_hosp_D));
  SET_VECTOR_ELT(contents, 486, ScalarReal(internal->p_II_hosp_R));
  SET_VECTOR_ELT(contents, 487, ScalarReal(internal->p_II_ICU_D));
  SET_VECTOR_ELT(contents, 488, ScalarReal(internal->p_II_ICU_R));
  SET_VECTOR_ELT(contents, 489, ScalarReal(internal->p_II_ILI));
  SET_VECTOR_ELT(contents, 490, ScalarReal(internal->p_II_mild));
  SET_VECTOR_ELT(contents, 491, ScalarReal(internal->p_II_triage));
  ...
  SET_VECTOR_ELT(contents, 492, p_R_pre);
  SET_VECTOR_ELT(contents, 493, ScalarReal(internal->p_R_stepdown));
  SEXP p_recov_ILI = PROTECT(allocVector(REALSXP, internal->dim_p_recov_ILI));
  memcpy(REAL(p_recov_ILI), internal->p_recov_ILI, internal->dim_p_recov_ILI * sizeof(double));
  SET_VECTOR_ELT(contents, 494, p_recov_ILI);
  SEXP p_SE = PROTECT(allocVector(REALSXP, internal->dim_p_SE));
  memcpy(REAL(p_SE), internal->p_SE, internal->dim_p_SE * sizeof(double));
  SET_VECTOR_ELT(contents, 495, p_SE);
  ...
  SET_VECTOR_ELT(contents, 496, p_seroconversion);
  SEXP p_sympt_ILI = PROTECT(allocVector(REALSXP, internal->dim_p_sympt_ILI));
  memcpy(REAL(p_sympt_ILI), internal->p_sympt_ILI, internal->dim_p_sympt_ILI * sizeof(double));
  SET_VECTOR_ELT(contents, 497, p_sympt_ILI);
  ...
  SET_VECTOR_ELT(contents, 498, R0_neg);
  ...
  SET_VECTOR_ELT(contents, 499, R0_pos);
  ...
  SET_VECTOR_ELT(contents, 500, R0_pre);
  ...
  SET_VECTOR_ELT(contents, 501, R0_stepdown);
  SET_VECTOR_ELT(contents, 502, ScalarInteger(internal->s_asympt));
  SET_VECTOR_ELT(contents, 503, ScalarInteger(internal->s_E));
  SET_VECTOR_ELT(contents, 504, ScalarInteger(internal->s_hosp_D));
  SET_VECTOR_ELT(contents, 505, ScalarInteger(internal->s_hosp_R));
  SET_VECTOR_ELT(contents, 506, ScalarInteger(internal->s_ICU_D));
  SET_VECTOR_ELT(contents, 507, ScalarInteger(internal->s_ICU_R));
  SEXP s_ij = PROTECT(allocVector(REALSXP, internal->dim_s_ij));
  memcpy(REAL(s_ij), internal->s_ij, internal->dim_s_ij * sizeof(double));
  odin_set_dim(s_ij, 2, internal->dim_s_ij_1, internal->dim_s_ij_2);
  SET_VECTOR_ELT(contents, 508, s_ij);
  SET_VECTOR_ELT(contents, 509, ScalarInteger(internal->s_ILI));
  SET_VECTOR_ELT(contents, 510, ScalarInteger(internal->s_mild));
  SET_VECTOR_ELT(contents, 511, ScalarInteger(internal->s_R_pre));
  SET_VECTOR_ELT(contents, 512, ScalarInteger(internal->s_stepdown));
  SET_VECTOR_ELT(contents, 513, ScalarInteger(internal->s_triage));
  SEXP S0 = PROTECT(allocVector(REALSXP, internal->dim_S0));
  memcpy(REAL(S0), internal->S0, internal->dim_S0 * sizeof(double));
  SET_VECTOR_ELT(contents, 514, S0);
  SET_VECTOR_ELT(contents, 515, ScalarInteger(internal->trans_classes));
  SEXP trans_increase = PROTECT(allocVector(REALSXP, internal->dim_trans_increase));
  memcpy(REAL(trans_increase), internal->trans_increase, internal->dim_trans_increase * sizeof(double));
  odin_set_dim(trans_increase, 2, internal->dim_trans_increase_1, internal->dim_trans_increase_2);
  SET_VECTOR_ELT(contents, 516, trans_increase);
  SEXP trans_profile = PROTECT(allocVector(REALSXP, internal->dim_trans_profile));
  memcpy(REAL(trans_profile), internal->trans_profile, internal->dim_trans_profile * sizeof(double));
  odin_set_dim(trans_profile, 2, internal->dim_trans_profile_1, internal->dim_trans_profile_2);
  SET_VECTOR_ELT(contents, 517, trans_profile);
  SEXP nms = PROTECT(allocVector(STRSXP, 518));
  SET_STRING_ELT(nms, 0, mkChar("aux_EE"));
  SET_STRING_ELT(nms, 1, mkChar("aux_II_asympt"));
  ...
  SET_STRING_ELT(nms, 163, mkChar("dim_gamma_R_pre"));
  SET_STRING_ELT(nms, 164, mkChar("dim_I_asympt"));
  SET_STRING_ELT(nms, 165, mkChar("dim_I_asympt_1"));
  SET_STRING_ELT(nms, 166, mkChar("dim_I_asympt_12"));
  SET_STRING_ELT(nms, 167, mkChar("dim_I_asympt_2"));
  SET_STRING_ELT(nms, 168, mkChar("dim_I_asympt_3"));
  ...
  SET_STRING_ELT(nms, 172, mkChar("dim_I_hosp_D_2"));
  SET_STRING_ELT(nms, 173, mkChar("dim_I_hosp_D_3"));
  SET_STRING_ELT(nms, 174, mkChar("dim_I_hosp_R"));
  SET_STRING_ELT(nms, 175, mkChar("dim_I_hosp_R_1"));
  SET_STRING_ELT(nms, 176, mkChar("dim_I_hosp_R_12"));
  SET_STRING_ELT(nms, 177, mkChar("dim_I_hosp_R_2"));
  SET_STRING_ELT(nms, 178, mkChar("dim_I_hosp_R_3"));
  SET_STRING_ELT(nms, 179, mkChar("dim_I_ICU_D"));
  SET_STRING_ELT(nms, 180, mkChar("dim_I_ICU_D_1"));
  SET_STRING_ELT(nms, 181, mkChar("dim_I_ICU_D_12"));
  SET_STRING_ELT(nms, 182, mkChar("dim_I_ICU_D_2"));
  SET_STRING_ELT(nms, 183, mkChar("dim_I_ICU_D_3"));
  SET_STRING_ELT(nms, 184, mkChar("dim_I_ICU_R"));
  SET_STRING_ELT(nms, 185, mkChar("dim_I_ICU_R_1"));
  SET_STRING_ELT(nms, 186, mkChar("dim_I_ICU_R_12"));
  SET_STRING_ELT(nms, 187, mkChar("dim_I_ICU_R_2"));
  SET_STRING_ELT(nms, 188, mkChar("dim_I_ICU_R_3"));
  SET_STRING_ELT(nms, 189, mkChar("dim_I_ILI"));
  SET_STRING_ELT(nms, 190, mkChar("dim_I_ILI_1"));
  SET_STRING_ELT(nms, 191, mkChar("dim_I_ILI_12"));
  SET_STRING_ELT(nms, 192, mkChar("dim_I_ILI_2"));
  SET_STRING_ELT(nms, 193, mkChar("dim_I_ILI_3"));
  SET_STRING_ELT(nms, 194, mkChar("dim_I_mild"));
  SET_STRING_ELT(nms, 195, mkChar("dim_I_mild_1"));
  SET_STRING_ELT(nms, 196, mkChar("dim_I_mild_12"));
  SET_STRING_ELT(nms, 197, mkChar("dim_I_mild_2"));
  SET_STRING_ELT(nms, 198, mkChar("dim_I_mild_3"));
  SET_STRING_ELT(nms, 199, mkChar("dim_I_triage_D"));
  SET_STRING_ELT(nms, 200, mkChar("dim_I_triage_D_1"));
  SET_STRING_ELT(nms, 201, mkChar("dim_I_triage_D_12"));
  SET_STRING_ELT(nms, 202, mkChar("dim_I_triage_D_2"));
  SET_STRING_ELT(nms, 203, mkChar("dim_I_triage_D_3"));
  SET_STRING_ELT(nms, 204, mkChar("dim_I_triage_R"));
  SET_STRING_ELT(nms, 205, mkChar("dim_I_triage_R_1"));
  SET_STRING_ELT(nms, 206, mkChar("dim_I_triage_R_12"));
  SET_STRING_ELT(nms, 207, mkChar("dim_I_triage_R_2"));
  SET_STRING_ELT(nms, 208, mkChar("dim_I_triage_R_3"));
  SET_STRING_ELT(nms, 209, mkChar("dim_I_with_diff_trans"));
  SET_STRING_ELT(nms, 210, mkChar("dim_I_with_diff_trans_1"));
  SET_STRING_ELT(nms, 211, mkChar("dim_I_with_diff_trans_2"));
  SET_STRING_ELT(nms, 212, mkChar("dim_I0_asympt"));
  SET_STRING_ELT(nms, 213, mkChar("dim_I0_asympt_1"));
  SET_STRING_ELT(nms, 214, mkChar("dim_I0_asympt_12"));
  SET_STRING_ELT(nms, 215, mkChar("dim_I0_asympt_2"));
  SET_STRING_ELT(nms, 216, mkChar("dim_I0_asympt_3"));
  SET_STRING_ELT(nms, 217, mkChar("dim_I0_hosp_D"));
  SET_STRING_ELT(nms, 218, mkChar("dim_I0_hosp_D_1"));
  SET_STRING_ELT(nms, 219, mkChar("dim_I0_hosp_D_12"));
  SET_STRING_ELT(nms, 220, mkChar("dim_I0_hosp_D_2"));
  SET_STRING_ELT(nms, 221, mkChar("dim_I0_hosp_D_3"));
  SET_STRING_ELT(nms, 222, mkChar("dim_I0_hosp_R"));
  SET_STRING_ELT(nms, 223, mkChar("dim_I0_hosp_R_1"));
  SET_STRING_ELT(nms, 224, mkChar("dim_I0_hosp_R_12"));
  SET_STRING_ELT(nms, 225, mkChar("dim_I0_hosp_R_2"));
  SET_STRING_ELT(nms, 226, mkChar("dim_I0_hosp_R_3"));
  SET_STRING_ELT(nms, 227, mkChar("dim_I0_ICU_D"));
  SET_STRING_ELT(nms, 228, mkChar("dim_I0_ICU_D_1"));
  SET_STRING_ELT(nms, 229, mkChar("dim_I0_ICU_D_12"));
  SET_STRING_ELT(nms, 230, mkChar("dim_I0_ICU_D_2"));
  SET_STRING_ELT(nms, 231, mkChar("dim_I0_ICU_D_3"));
  SET_STRING_ELT(nms, 232, mkChar("dim_I0_ICU_R"));
  SET_STRING_ELT(nms, 233, mkChar("dim_I0_ICU_R_1"));
  SET_STRING_ELT(nms, 234, mkChar("dim_I0_ICU_R_12"));
  SET_STRING_ELT(nms, 235, mkChar("dim_I0_ICU_R_2"));
  SET_STRING_ELT(nms, 236, mkChar("dim_I0_ICU_R_3"));
  SET_STRING_ELT(nms, 237, mkChar("dim_I0_ILI"));
  SET_STRING_ELT(nms, 238, mkChar("dim_I0_ILI_1"));
  SET_STRING_ELT(nms, 239, mkChar("dim_I0_ILI_12"));
  SET_STRING_ELT(nms, 240, mkChar("dim_I0_ILI_2"));
  SET_STRING_ELT(nms, 241, mkChar("dim_I0_ILI_3"));
  SET_STRING_ELT(nms, 242, mkChar("dim_I0_mild"));
  SET_STRING_ELT(nms, 243, mkChar("dim_I0_mild_1"));
  SET_STRING_ELT(nms, 244, mkChar("dim_I0_mild_12"));
  SET_STRING_ELT(nms, 245, mkChar("dim_I0_mild_2"));
  SET_STRING_ELT(nms, 246, mkChar("dim_I0_mild_3"));
  SET_STRING_ELT(nms, 247, mkChar("dim_I0_triage_D"));
  SET_STRING_ELT(nms, 248, mkChar("dim_I0_triage_D_1"));
  SET_STRING_ELT(nms, 249, mkChar("dim_I0_triage_D_12"));
  SET_STRING_ELT(nms, 250, mkChar("dim_I0_triage_D_2"));
  SET_STRING_ELT(nms, 251, mkChar("dim_I0_triage_D_3"));
  SET_STRING_ELT(nms, 252, mkChar("dim_I0_triage_R"));
  SET_STRING_ELT(nms, 253, mkChar("dim_I0_triage_R_1"));
  SET_STRING_ELT(nms, 254, mkChar("dim_I0_triage_R_12"));
  SET_STRING_ELT(nms, 255, mkChar("dim_I0_triage_R_2"));
  SET_STRING_ELT(nms, 256, mkChar("dim_I0_triage_R_3"));
  SET_STRING_ELT(nms, 257, mkChar("dim_lambda"));
  SET_STRING_ELT(nms, 258, mkChar("dim_m"));
  SET_STRING_ELT(nms, 259, mkChar("dim_m_1"));
  SET_STRING_ELT(nms, 260, mkChar("dim_m_2"));
  SET_STRING_ELT(nms, 261, mkChar("dim_n_com_to_R_pre"));
  SET_STRING_ELT(nms, 262, mkChar("dim_n_com_to_R_total"));
  SET_STRING_ELT(nms, 263, mkChar("dim_n_EE"));
  SET_STRING_ELT(nms, 264, mkChar("dim_n_EE_1"));
  SET_STRING_ELT(nms, 265, mkChar("dim_n_EE_12"));
  SET_STRING_ELT(nms, 266, mkChar("dim_n_EE_2"));
  SET_STRING_ELT(nms, 267, mkChar("dim_n_EE_3"));
  SET_STRING_ELT(nms, 268, mkChar("dim_n_EI_asympt"));
  SET_STRING_ELT(nms, 269, mkChar("dim_n_EI_asympt_1"));
  SET_STRING_ELT(nms, 270, mkChar("dim_n_EI_asympt_2"));
  SET_STRING_ELT(nms, 271, mkChar("dim_n_EI_ILI"));
  SET_STRING_ELT(nms, 272, mkChar("dim_n_EI_ILI_1"));
  SET_STRING_ELT(nms, 273, mkChar("dim_n_EI_ILI_2"));
  SET_STRING_ELT(nms, 274, mkChar("dim_n_EI_mild"));
  SET_STRING_ELT(nms, 275, mkChar("dim_n_EI_mild_1"));
  SET_STRING_ELT(nms, 276, mkChar("dim_n_EI_mild_2"));
  SET_STRING_ELT(nms, 277, mkChar("dim_n_hosp_non_ICU"));
  SET_STRING_ELT(nms, 278, mkChar("dim_n_hosp_non_ICU_1"));
  SET_STRING_ELT(nms, 279, mkChar("dim_n_hosp_non_ICU_2"));
  SET_STRING_ELT(nms, 280, mkChar("dim_n_ICU_to_R_stepdown"));
  SET_STRING_ELT(nms, 281, mkChar("dim_n_II_asympt"));
  SET_STRING_ELT(nms, 282, mkChar("dim_n_II_asympt_1"));
  SET_STRING_ELT(nms, 283, mkChar("dim_n_II_asympt_12"));
  SET_STRING_ELT(nms, 284, mkChar("dim_n_II_asympt_2"));
  SET_STRING_ELT(nms, 285, mkChar("dim_n_II_asympt_3"));
  SET_STRING_ELT(nms, 286, mkChar("dim_n_II_hosp_D"));
  SET_STRING_ELT(nms, 287, mkChar("dim_n_II_hosp_D_1"));
  SET_STRING_ELT(nms, 288, mkChar("dim_n_II_hosp_D_12"));
  SET_STRING_ELT(nms, 289, mkChar("dim_n_II_hosp_D_2"));
  SET_STRING_ELT(nms, 290, mkChar("dim_n_II_hosp_D_3"));
  SET_STRING_ELT(nms, 291, mkChar("dim_n_II_hosp_R"));
  SET_STRING_ELT(nms, 292, mkChar("dim_n_II_hosp_R_1"));
  SET_STRING_ELT(nms, 293, mkChar("dim_n_II_hosp_R_12"));
  SET_STRING_ELT(nms, 294, mkChar("dim_n_II_hosp_R_2"));
  SET_STRING_ELT(nms, 295, mkChar("dim_n_II_hosp_R_3"));
  SET_STRING_ELT(nms, 296, mkChar("dim_n_II_ICU_D"));
  SET_STRING_ELT(nms, 297, mkChar("dim_n_II_ICU_D_1"));
  SET_STRING_ELT(nms, 298, mkChar("dim_n_II_ICU_D_12"));
  SET_STRING_ELT(nms, 299, mkChar("dim_n_II_ICU_D_2"));
  SET_STRING_ELT(nms, 300, mkChar("dim_n_II_ICU_D_3"));
  SET_STRING_ELT(nms, 301, mkChar("dim_n_II_ICU_R"));
  SET_STRING_ELT(nms, 302, mkChar("dim_n_II_ICU_R_1"));
  SET_STRING_ELT(nms, 303, mkChar("dim_n_II_ICU_R_12"));
  SET_STRING_ELT(nms, 304, mkChar("dim_n_II_ICU_R_2"));
  SET_STRING_ELT(nms, 305, mkChar("dim_n_II_ICU_R_3"));
  SET_STRING_ELT(nms, 306, mkChar("dim_n_II_ILI"));
  SET_STRING_ELT(nms, 307, mkChar("dim_n_II_ILI_1"));
  SET_STRING_ELT(nms, 308, mkChar("dim_n_II_ILI_12"));
  SET_STRING_ELT(nms, 309, mkChar("dim_n_II_ILI_2"));
  SET_STRING_ELT(nms, 310, mkChar("dim_n_II_ILI_3"));
  SET_STRING_ELT(nms, 311, mkChar("dim_n_II_mild"));
  SET_STRING_ELT(nms, 312, mkChar("dim_n_II_mild_1"));
  SET_STRING_ELT(nms, 313, mkChar("dim_n_II_mild_12"));
  SET_STRING_ELT(nms, 314, mkChar("dim_n_II_mild_2"));
  SET_STRING_ELT(nms, 315, mkChar("dim_n_II_mild_3"));
  SET_STRING_ELT(nms, 316, mkChar("dim_n_II_triage_D"));
  SET_STRING_ELT(nms, 317, mkChar("dim_n_II_triage_D_1"));
  SET_STRING_ELT(nms, 318, mkChar("dim_n_II_triage_D_12"));
  SET_STRING_ELT(nms, 319, mkChar("dim_n_II_triage_D_2"));
  SET_STRING_ELT(nms, 320, mkChar("dim_n_II_triage_D_3"));
  SET_STRING_ELT(nms, 321, mkChar("dim_n_II_triage_R"));
  SET_STRING_ELT(nms, 322, mkChar("dim_n_II_triage_R_1"));
  SET_STRING_ELT(nms, 323, mkChar("dim_n_II_triage_R_12"));
  SET_STRING_ELT(nms, 324, mkChar("dim_n_II_triage_R_2"));
  SET_STRING_ELT(nms, 325, mkChar("dim_n_II_triage_R_3"));
  SET_STRING_ELT(nms, 326, mkChar("dim_n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 327, mkChar("dim_n_ILI_to_hosp_1"));
  SET_STRING_ELT(nms, 328, mkChar("dim_n_ILI_to_hosp_2"));
  SET_STRING_ELT(nms, 329, mkChar("dim_n_ILI_to_hosp_D"));
  SET_STRING_ELT(nms, 330, mkChar("dim_n_ILI_to_hosp_D_1"));
  SET_STRING_ELT(nms, 331, mkChar("dim_n_ILI_to_hosp_D_2"));
  SET_STRING_ELT(nms, 332, mkChar("dim_n_ILI_to_hosp_R"));
  SET_STRING_ELT(nms, 333, mkChar("dim_n_ILI_to_hosp_R_1"));
  SET_STRING_ELT(nms, 334, mkChar("dim_n_ILI_to_hosp_R_2"));
  SET_STRING_ELT(nms, 335, mkChar("dim_n_ILI_to_triage"));
  SET_STRING_ELT(nms, 336, mkChar("dim_n_ILI_to_triage_1"));
  SET_STRING_ELT(nms, 337, mkChar("dim_n_ILI_to_triage_2"));
  SET_STRING_ELT(nms, 338, mkChar("dim_n_ILI_to_triage_D"));
  SET_STRING_ELT(nms, 339, mkChar("dim_n_ILI_to_triage_D_1"));
  SET_STRING_ELT(nms, 340, mkChar("dim_n_ILI_to_triage_D_2"));
  SET_STRING_ELT(nms, 341, mkChar("dim_n_ILI_to_triage_R"));
  SET_STRING_ELT(nms, 342, mkChar("dim_n_ILI_to_triage_R_1"));
  SET_STRING_ELT(nms, 343, mkChar("dim_n_ILI_to_triage_R_2"));
  SET_STRING_ELT(nms, 344, mkChar("dim_n_R_pre"));
  SET_STRING_ELT(nms, 345, mkChar("dim_n_R_pre_1"));
  SET_STRING_ELT(nms, 346, mkChar("dim_n_R_pre_2"));
  SET_STRING_ELT(nms, 347, mkChar("dim_n_R_stepdown"));
  SET_STRING_ELT(nms, 348, mkChar("dim_n_R_stepdown_1"));
  SET_STRING_ELT(nms, 349, mkChar("dim_n_R_stepdown_2"));
  SET_STRING_ELT(nms, 350, mkChar("dim_n_SE"));
  SET_STRING_ELT(nms, 351, mkChar("dim_p_asympt"));
  SET_STRING_ELT(nms, 352, mkChar("dim_p_death_hosp_D"));
  SET_STRING_ELT(nms, 353, mkChar("dim_p_death_ICU"));
  SET_STRING_ELT(nms, 354, mkChar("dim_p_ICU_hosp"));
  SET_STRING_ELT(nms, 355, mkChar("dim_p_R_pre"));
  SET_STRING_ELT(nms, 356, mkChar("dim_p_recov_ILI"));
  SET_STRING_ELT(nms, 357, mkChar("dim_p_SE"));
  SET_STRING_ELT(nms, 358, mkChar("dim_p_seroconversion"));
  SET_STRING_ELT(nms, 359, mkChar("dim_p_sympt_ILI"));
  SET_STRING_ELT(nms, 360, mkChar("dim_R_neg"));
  SET_STRING_ELT(nms, 361, mkChar("dim_R_pos"));
  SET_STRING_ELT(nms, 362, mkChar("dim_R_pre"));
  SET_STRING_ELT(nms, 363, mkChar("dim_R_pre_1"));
  SET_STRING_ELT(nms, 364, mkChar("dim_R_pre_2"));
  SET_STRING_ELT(nms, 365, mkChar("dim_R_stepdown"));
  SET_STRING_ELT(nms, 366, mkChar("dim_R_stepdown_1"));
  SET_STRING_ELT(nms, 367, mkChar("dim_R_stepdown_2"));
  SET_STRING_ELT(nms, 368, mkChar("dim_R0_neg"));
  SET_STRING_ELT(nms, 369, mkChar("dim_R0_pos"));
  SET_STRING_ELT(nms, 370, mkChar("dim_R0_pre"));
  SET_STRING_ELT(nms, 371, mkChar("dim_R0_pre_1"));
  SET_STRING_ELT(nms, 372, mkChar("dim_R0_pre_2"));
  SET_STRING_ELT(nms, 373, mkChar("dim_R0_stepdown"));
  SET_STRING_ELT(nms, 374, mkChar("dim_R0_stepdown_1"));
  SET_STRING_ELT(nms, 375, mkChar("dim_R0_stepdown_2"));
  SET_STRING_ELT(nms, 376, mkChar("dim_S"));
  SET_STRING_ELT(nms, 377, mkChar("dim_s_ij"));
  SET_STRING_ELT(nms, 378, mkChar("dim_s_ij_1"));
  SET_STRING_ELT(nms, 379, mkChar("dim_s_ij_2"));
  SET_STRING_ELT(nms, 380, mkChar("dim_S0"));
  SET_STRING_ELT(nms, 381, mkChar("dim_trans_increase"));
  SET_STRING_ELT(nms, 382, mkChar("dim_trans_increase_1"));
  SET_STRING_ELT(nms, 383, mkChar("dim_trans_increase_2"));
  SET_STRING_ELT(nms, 384, mkChar("dim_trans_profile"));
  SET_STRING_ELT(nms, 385, mkChar("dim_trans_profile_1"));
  SET_STRING_ELT(nms, 386, mkChar("dim_trans_profile_2"));
  SET_STRING_ELT(nms, 387, mkChar("dt"));
  SET_STRING_ELT(nms, 388, mkChar("E0"));
  SET_STRING_ELT(nms, 389, mkChar("gamma_asympt"));
  SET_STRING_ELT(nms, 390, mkChar("gamma_E"));
  SET_STRING_ELT(nms, 391, mkChar("gamma_hosp_D"));
  SET_STRING_ELT(nms, 392, mkChar("gamma_hosp_R"));
  SET_STRING_ELT(nms, 393, mkChar("gamma_ICU_D"));
  SET_STRING_ELT(nms, 394, mkChar("gamma_ICU_R"));
  SET_STRING_ELT(nms, 395, mkChar("gamma_ILI"));
  SET_STRING_ELT(nms, 396, mkChar("gamma_mild"));
  SET_STRING_ELT(nms, 397, mkChar("gamma_R_pre"));
  SET_STRING_ELT(nms, 398, mkChar("gamma_stepdown"));
  SET_STRING_ELT(nms, 399, mkChar("gamma_triage"));
  SET_STRING_ELT(nms, 400, mkChar("hosp_transmission"));
  SET_STRING_ELT(nms, 401, mkChar("I_with_diff_trans"));
  SET_STRING_ELT(nms, 402, mkChar("I0_asympt"));
  SET_STRING_ELT(nms, 403, mkChar("I0_hosp_D"));
  SET_STRING_ELT(nms, 404, mkChar("I0_hosp_R"));
  SET_STRING_ELT(nms, 405, mkChar("I0_ICU_D"));
  SET_STRING_ELT(nms, 406, mkChar("I0_ICU_R"));
  SET_STRING_ELT(nms, 407, mkChar("I0_ILI"));
  SET_STRING_ELT(nms, 408, mkChar("I0_mild"));
  SET_STRING_ELT(nms, 409, mkChar("I0_triage_D"));
  SET_STRING_ELT(nms, 410, mkChar("I0_triage_R"));
  SET_STRING_ELT(nms, 411, mkChar("ICU_transmission"));
  SET_STRING_ELT(nms, 412, mkChar("initial_D"));
  SET_STRING_ELT(nms, 413, mkChar("initial_E"));
  SET_STRING_ELT(nms, 414, mkChar("initial_I_asympt"));
  SET_STRING_ELT(nms, 415, mkChar("initial_I_hosp_D"));
  SET_STRING_ELT(nms, 416, mkChar("initial_I_hosp_R"));
  SET_STRING_ELT(nms, 417, mkChar("initial_I_ICU_D"));
  SET_STRING_ELT(nms, 418, mkChar("initial_I_ICU_R"));
  SET_STRING_ELT(nms, 419, mkChar("initial_I_ILI"));
  SET_STRING_ELT(nms, 420, mkChar("initial_I_mild"));
  SET_STRING_ELT(nms, 421, mkChar("initial_I_triage_D"));
  SET_STRING_ELT(nms, 422, mkChar("initial_I_triage_R"));
  SET_STRING_ELT(nms, 423, mkChar("initial_R_neg"));
  SET_STRING_ELT(nms, 424, mkChar("initial_R_pos"));
  SET_STRING_ELT(nms, 425, mkChar("initial_R_pre"));
  SET_STRING_ELT(nms, 426, mkChar("initial_R_stepdown"));
  SET_STRING_ELT(nms, 427, mkChar("initial_S"));
  SET_STRING_ELT(nms, 428, mkChar("interpolate_beta"));
  SET_STRING_ELT(nms, 429, mkChar("lambda"));
  SET_STRING_ELT(nms, 430, mkChar("m"));
  SET_STRING_ELT(nms, 431, mkChar("N_age"));
  SET_STRING_ELT(nms, 432, mkChar("n_com_to_R_pre"));
  SET_STRING_ELT(nms, 433, mkChar("n_com_to_R_total"));
  SET_STRING_ELT(nms, 434, mkChar("n_EE"));
  SET_STRING_ELT(nms, 435, mkChar("n_EI_asympt"));
  SET_STRING_ELT(nms, 436, mkChar("n_EI_ILI"));
  SET_STRING_ELT(nms, 437, mkChar("n_EI_mild"));
  SET_STRING_ELT(nms, 438, mkChar("n_hosp_non_ICU"));
  SET_STRING_ELT(nms, 439, mkChar("n_ICU_to_R_stepdown"));
  SET_STRING_ELT(nms, 440, mkChar("n_II_asympt"));
  SET_STRING_ELT(nms, 441, mkChar("n_II_hosp_D"));
  SET_STRING_ELT(nms, 442, mkChar("n_II_hosp_R"));
  SET_STRING_ELT(nms, 443, mkChar("n_II_ICU_D"));
  SET_STRING_ELT(nms, 444, mkChar("n_II_ICU_R"));
  SET_STRING_ELT(nms, 445, mkChar("n_II_ILI"));
  SET_STRING_ELT(nms, 446, mkChar("n_II_mild"));
  SET_STRING_ELT(nms, 447, mkChar("n_II_triage_D"));
  SET_STRING_ELT(nms, 448, mkChar("n_II_triage_R"));
  SET_STRING_ELT(nms, 449, mkChar("n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 450, mkChar("n_ILI_to_hosp_D"));
  SET_STRING_ELT(nms, 451, mkChar("n_ILI_to_hosp_R"));
  SET_STRING_ELT(nms, 452, mkChar("n_ILI_to_triage"));
  SET_STRING_ELT(nms, 453, mkChar("n_ILI_to_triage_D"));
  SET_STRING_ELT(nms, 454, mkChar("n_ILI_to_triage_R"));
  SET_STRING_ELT(nms, 455, mkChar("n_R_pre"));
  SET_STRING_ELT(nms, 456, mkChar("n_R_stepdown"));
  SET_STRING_ELT(nms, 457, mkChar("n_SE"));
  SET_STRING_ELT(nms, 458, mkChar("offset_output_n_EI_ILI"));
  SET_STRING_ELT(nms, 459, mkChar("offset_output_n_EI_mild"));
  SET_STRING_ELT(nms, 460, mkChar("offset_output_n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 461, mkChar("offset_output_n_ILI_to_hosp_D"));
  SET_STRING_ELT(nms, 462, mkChar("offset_output_n_ILI_to_hosp_R"));
  SET_STRING_ELT(nms, 463, mkChar("offset_output_n_ILI_to_triage_D"));
  SET_STRING_ELT(nms, 464, mkChar("offset_output_n_ILI_to_triage_R"));
  SET_STRING_ELT(nms, 465, mkChar("offset_variable_D"));
  SET_STRING_ELT(nms, 466, mkChar("offset_variable_E"));
  SET_STRING_ELT(nms, 467, mkChar("offset_variable_I_asympt"));
  SET_STRING_ELT(nms, 468, mkChar("offset_variable_I_hosp_D"));
  SET_STRING_ELT(nms, 469, mkChar("offset_variable_I_hosp_R"));
  SET_STRING_ELT(nms, 470, mkChar("offset_variable_I_ICU_D"));
  SET_STRING_ELT(nms, 471, mkChar("offset_variable_I_ICU_R"));
  SET_STRING_ELT(nms, 472, mkChar("offset_variable_I_ILI"));
  SET_STRING_ELT(nms, 473, mkChar("offset_variable_I_mild"));
  SET_STRING_ELT(nms, 474, mkChar("offset_variable_I_triage_D"));
  SET_STRING_ELT(nms, 475, mkChar("offset_variable_I_triage_R"));
  SET_STRING_ELT(nms, 476, mkChar("offset_variable_R_neg"));
  SET_STRING_ELT(nms, 477, mkChar("offset_variable_R_pre"));
  SET_STRING_ELT(nms, 478, mkChar("offset_variable_R_stepdown"));
  SET_STRING_ELT(nms, 479, mkChar("p_asympt"));
  SET_STRING_ELT(nms, 480, mkChar("p_death_hosp_D"));
  SET_STRING_ELT(nms, 481, mkChar("p_death_ICU"));
  SET_STRING_ELT(nms, 482, mkChar("p_EE"));
  SET_STRING_ELT(nms, 483, mkChar("p_ICU_hosp"));
  SET_STRING_ELT(nms, 484, mkChar("p_II_asympt"));
  SET_STRING_ELT(nms, 485, mkChar("p_II_hosp_D"));
  SET_STRING_ELT(nms, 486, mkChar("p_II_hosp_R"));
  SET_STRING_ELT(nms, 487, mkChar("p_II_ICU_D"));
  SET_STRING_ELT(nms, 488, mkChar("p_II_ICU_R"));
  SET_STRING_ELT(nms, 489, mkChar("p_II_ILI"));
  SET_STRING_ELT(nms, 490, mkChar("p_II_mild"));
  SET_STRING_ELT(nms, 491, mkChar("p_II_triage"));
  SET_STRING_ELT(nms, 492, mkChar("p_R_pre"));
  SET_STRING_ELT(nms, 493, mkChar("p_R_stepdown"));
  SET_STRING_ELT(nms, 494, mkChar("p_recov_ILI"));
  SET_STRING_ELT(nms, 495, mkChar("p_SE"));
  SET_STRING_ELT(nms, 496, mkChar("p_seroconversion"));
  SET_STRING_ELT(nms, 497, mkChar("p_sympt_ILI"));
  SET_STRING_ELT(nms, 498, mkChar("R0_neg"));
  SET_STRING_ELT(nms, 499, mkChar("R0_pos"));
  SET_STRING_ELT(nms, 500, mkChar("R0_pre"));
  SET_STRING_ELT(nms, 501, mkChar("R0_stepdown"));
  SET_STRING_ELT(nms, 502, mkChar("s_asympt"));
  SET_STRING_ELT(nms, 503, mkChar("s_E"));
  SET_STRING_ELT(nms, 504, mkChar("s_hosp_D"));
  SET_STRING_ELT(nms, 505, mkChar("s_hosp_R"));
  SET_STRING_ELT(nms, 506, mkChar("s_ICU_D"));
  SET_STRING_ELT(nms, 507, mkChar("s_ICU_R"));
  SET_STRING_ELT(nms, 508, mkChar("s_ij"));
  SET_STRING_ELT(nms, 509, mkChar("s_ILI"));
  SET_STRING_ELT(nms, 510, mkChar("s_mild"));
  SET_STRING_ELT(nms, 511, mkChar("s_R_pre"));
  SET_STRING_ELT(nms, 512, mkChar("s_stepdown"));
  SET_STRING_ELT(nms, 513, mkChar("s_triage"));
  SET_STRING_ELT(nms, 514, mkChar("S0"));
  SET_STRING_ELT(nms, 515, mkChar("trans_classes"));
  SET_STRING_ELT(nms, 516, mkChar("trans_increase"));
  SET_STRING_ELT(nms, 517, mkChar("trans_profile"));
  setAttrib(contents, R_NamesSymbol, nms);
  UNPROTECT(106);
  return contents;
}
SEXP hospital_with_serology_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->dim_E0_2 = internal->s_E;
  internal->dim_E0_3 = internal->trans_classes;
  internal->dim_gamma_R_pre = internal->N_age;
  internal->dim_I_asympt_1 = internal->N_age;
  internal->dim_I_asympt_2 = internal->s_asympt;
  internal->dim_I_asympt_3 = internal->trans_classes;
  ...
  internal->dim_trans_increase = internal->dim_trans_increase_1 * internal->dim_trans_increase_2;
  internal->dim_trans_profile = internal->dim_trans_profile_1 * internal->dim_trans_profile_2;
  internal->gamma_R_pre = (double*) user_get_array(user, false, internal->gamma_R_pre, "gamma_R_pre", NA_REAL, NA_REAL, 1, internal->dim_gamma_R_pre);
  ...
  for (int i = 1; i <= internal->dim_p_R_pre; ++i) {
    internal->p_R_pre[i - 1] = 1 - exp(-(internal->gamma_R_pre[i - 1]) * internal->dt);
  }
