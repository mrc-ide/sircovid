...
SEXP basic_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 334));
  ...
  SET_VECTOR_ELT(contents, 10, delta_D);
  ...
  SET_VECTOR_ELT(contents, 11, delta_E);
  ...
  SET_VECTOR_ELT(contents, 12, delta_I_asympt);
  ...
  SET_VECTOR_ELT(contents, 13, delta_I_hosp);
  ...
  SET_VECTOR_ELT(contents, 14, delta_I_ICU);
  ...
  SET_VECTOR_ELT(contents, 15, delta_I_ILI);
  ...
  SET_VECTOR_ELT(contents, 16, delta_I_mild);
  ...
  SET_VECTOR_ELT(contents, 17, delta_R);
  ...
  SET_VECTOR_ELT(contents, 18, delta_R_hosp);
  SET_VECTOR_ELT(contents, 19, ScalarInteger(internal->dim_aux_EE));
  SET_VECTOR_ELT(contents, 20, ScalarInteger(internal->dim_aux_EE_1));
  SET_VECTOR_ELT(contents, 21, ScalarInteger(internal->dim_aux_EE_12));
  SET_VECTOR_ELT(contents, 22, ScalarInteger(internal->dim_aux_EE_2));
  SET_VECTOR_ELT(contents, 23, ScalarInteger(internal->dim_aux_EE_3));
  SET_VECTOR_ELT(contents, 24, ScalarInteger(internal->dim_aux_II_asympt));
  SET_VECTOR_ELT(contents, 25, ScalarInteger(internal->dim_aux_II_asympt_1));
  SET_VECTOR_ELT(contents, 26, ScalarInteger(internal->dim_aux_II_asympt_12));
  SET_VECTOR_ELT(contents, 27, ScalarInteger(internal->dim_aux_II_asympt_2));
  SET_VECTOR_ELT(contents, 28, ScalarInteger(internal->dim_aux_II_asympt_3));
  SET_VECTOR_ELT(contents, 29, ScalarInteger(internal->dim_aux_II_hosp));
  SET_VECTOR_ELT(contents, 30, ScalarInteger(internal->dim_aux_II_hosp_1));
  SET_VECTOR_ELT(contents, 31, ScalarInteger(internal->dim_aux_II_hosp_12));
  SET_VECTOR_ELT(contents, 32, ScalarInteger(internal->dim_aux_II_hosp_2));
  SET_VECTOR_ELT(contents, 33, ScalarInteger(internal->dim_aux_II_hosp_3));
  SET_VECTOR_ELT(contents, 34, ScalarInteger(internal->dim_aux_II_ICU));
  SET_VECTOR_ELT(contents, 35, ScalarInteger(internal->dim_aux_II_ICU_1));
  SET_VECTOR_ELT(contents, 36, ScalarInteger(internal->dim_aux_II_ICU_12));
  SET_VECTOR_ELT(contents, 37, ScalarInteger(internal->dim_aux_II_ICU_2));
  SET_VECTOR_ELT(contents, 38, ScalarInteger(internal->dim_aux_II_ICU_3));
  SET_VECTOR_ELT(contents, 39, ScalarInteger(internal->dim_aux_II_ILI));
  SET_VECTOR_ELT(contents, 40, ScalarInteger(internal->dim_aux_II_ILI_1));
  SET_VECTOR_ELT(contents, 41, ScalarInteger(internal->dim_aux_II_ILI_12));
  SET_VECTOR_ELT(contents, 42, ScalarInteger(internal->dim_aux_II_ILI_2));
  SET_VECTOR_ELT(contents, 43, ScalarInteger(internal->dim_aux_II_ILI_3));
  SET_VECTOR_ELT(contents, 44, ScalarInteger(internal->dim_aux_II_mild));
  SET_VECTOR_ELT(contents, 45, ScalarInteger(internal->dim_aux_II_mild_1));
  SET_VECTOR_ELT(contents, 46, ScalarInteger(internal->dim_aux_II_mild_12));
  SET_VECTOR_ELT(contents, 47, ScalarInteger(internal->dim_aux_II_mild_2));
  SET_VECTOR_ELT(contents, 48, ScalarInteger(internal->dim_aux_II_mild_3));
  SET_VECTOR_ELT(contents, 49, ScalarInteger(internal->dim_aux_p_bin));
  SET_VECTOR_ELT(contents, 50, ScalarInteger(internal->dim_aux_p_bin_1));
  SET_VECTOR_ELT(contents, 51, ScalarInteger(internal->dim_aux_p_bin_2));
  SET_VECTOR_ELT(contents, 52, ScalarInteger(internal->dim_aux_R_hosp));
  SET_VECTOR_ELT(contents, 53, ScalarInteger(internal->dim_aux_R_hosp_1));
  SET_VECTOR_ELT(contents, 54, ScalarInteger(internal->dim_aux_R_hosp_12));
  SET_VECTOR_ELT(contents, 55, ScalarInteger(internal->dim_aux_R_hosp_2));
  SET_VECTOR_ELT(contents, 56, ScalarInteger(internal->dim_aux_R_hosp_3));
  SET_VECTOR_ELT(contents, 57, ScalarInteger(internal->dim_D));
  SET_VECTOR_ELT(contents, 58, ScalarInteger(internal->dim_D0));
  SET_VECTOR_ELT(contents, 59, ScalarInteger(internal->dim_delta_D));
  SET_VECTOR_ELT(contents, 60, ScalarInteger(internal->dim_delta_E));
  SET_VECTOR_ELT(contents, 61, ScalarInteger(internal->dim_delta_E_1));
  SET_VECTOR_ELT(contents, 62, ScalarInteger(internal->dim_delta_E_12));
  SET_VECTOR_ELT(contents, 63, ScalarInteger(internal->dim_delta_E_2));
  SET_VECTOR_ELT(contents, 64, ScalarInteger(internal->dim_delta_E_3));
  SET_VECTOR_ELT(contents, 65, ScalarInteger(internal->dim_delta_I_asympt));
  SET_VECTOR_ELT(contents, 66, ScalarInteger(internal->dim_delta_I_asympt_1));
  SET_VECTOR_ELT(contents, 67, ScalarInteger(internal->dim_delta_I_asympt_12));
  SET_VECTOR_ELT(contents, 68, ScalarInteger(internal->dim_delta_I_asympt_2));
  SET_VECTOR_ELT(contents, 69, ScalarInteger(internal->dim_delta_I_asympt_3));
  SET_VECTOR_ELT(contents, 70, ScalarInteger(internal->dim_delta_I_hosp));
  SET_VECTOR_ELT(contents, 71, ScalarInteger(internal->dim_delta_I_hosp_1));
  SET_VECTOR_ELT(contents, 72, ScalarInteger(internal->dim_delta_I_hosp_12));
  SET_VECTOR_ELT(contents, 73, ScalarInteger(internal->dim_delta_I_hosp_2));
  SET_VECTOR_ELT(contents, 74, ScalarInteger(internal->dim_delta_I_hosp_3));
  SET_VECTOR_ELT(contents, 75, ScalarInteger(internal->dim_delta_I_ICU));
  SET_VECTOR_ELT(contents, 76, ScalarInteger(internal->dim_delta_I_ICU_1));
  SET_VECTOR_ELT(contents, 77, ScalarInteger(internal->dim_delta_I_ICU_12));
  SET_VECTOR_ELT(contents, 78, ScalarInteger(internal->dim_delta_I_ICU_2));
  SET_VECTOR_ELT(contents, 79, ScalarInteger(internal->dim_delta_I_ICU_3));
  SET_VECTOR_ELT(contents, 80, ScalarInteger(internal->dim_delta_I_ILI));
  SET_VECTOR_ELT(contents, 81, ScalarInteger(internal->dim_delta_I_ILI_1));
  SET_VECTOR_ELT(contents, 82, ScalarInteger(internal->dim_delta_I_ILI_12));
  SET_VECTOR_ELT(contents, 83, ScalarInteger(internal->dim_delta_I_ILI_2));
  SET_VECTOR_ELT(contents, 84, ScalarInteger(internal->dim_delta_I_ILI_3));
  SET_VECTOR_ELT(contents, 85, ScalarInteger(internal->dim_delta_I_mild));
  SET_VECTOR_ELT(contents, 86, ScalarInteger(internal->dim_delta_I_mild_1));
  SET_VECTOR_ELT(contents, 87, ScalarInteger(internal->dim_delta_I_mild_12));
  SET_VECTOR_ELT(contents, 88, ScalarInteger(internal->dim_delta_I_mild_2));
  SET_VECTOR_ELT(contents, 89, ScalarInteger(internal->dim_delta_I_mild_3));
  SET_VECTOR_ELT(contents, 90, ScalarInteger(internal->dim_delta_R));
  SET_VECTOR_ELT(contents, 91, ScalarInteger(internal->dim_delta_R_hosp));
  SET_VECTOR_ELT(contents, 92, ScalarInteger(internal->dim_delta_R_hosp_1));
  SET_VECTOR_ELT(contents, 93, ScalarInteger(internal->dim_delta_R_hosp_12));
  SET_VECTOR_ELT(contents, 94, ScalarInteger(internal->dim_delta_R_hosp_2));
  SET_VECTOR_ELT(contents, 95, ScalarInteger(internal->dim_delta_R_hosp_3));
  SET_VECTOR_ELT(contents, 96, ScalarInteger(internal->dim_E));
  SET_VECTOR_ELT(contents, 97, ScalarInteger(internal->dim_E_1));
  SET_VECTOR_ELT(contents, 98, ScalarInteger(internal->dim_E_12));
  SET_VECTOR_ELT(contents, 99, ScalarInteger(internal->dim_E_2));
  SET_VECTOR_ELT(contents, 100, ScalarInteger(internal->dim_E_3));
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_E0));
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_E0_1));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_E0_12));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_E0_2));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_E0_3));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_I_asympt));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_I_asympt_1));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_I_asympt_12));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_I_asympt_2));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_I_asympt_3));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_I_hosp));
  SET_VECTOR_ELT(contents, 112, ScalarInteger(internal->dim_I_hosp_1));
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_I_hosp_12));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_I_hosp_2));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_I_hosp_3));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_I_ICU));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_I_ICU_1));
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_I_ICU_12));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_I_ICU_2));
  SET_VECTOR_ELT(contents, 120, ScalarInteger(internal->dim_I_ICU_3));
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->dim_I_ILI));
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_I_ILI_1));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_I_ILI_12));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_I_ILI_2));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_I_ILI_3));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_I_mild));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_I_mild_1));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_I_mild_12));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_I_mild_2));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_I_mild_3));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_I_with_diff_trans));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_I_with_diff_trans_1));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_I_with_diff_trans_2));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_I0_asympt));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_I0_asympt_1));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_I0_asympt_12));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_I0_asympt_2));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_I0_asympt_3));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->dim_I0_hosp));
  SET_VECTOR_ELT(contents, 140, ScalarInteger(internal->dim_I0_hosp_1));
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_I0_hosp_12));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_I0_hosp_2));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_I0_hosp_3));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_I0_ICU));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->dim_I0_ICU_1));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->dim_I0_ICU_12));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->dim_I0_ICU_2));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->dim_I0_ICU_3));
  SET_VECTOR_ELT(contents, 149, ScalarInteger(internal->dim_I0_ILI));
  SET_VECTOR_ELT(contents, 150, ScalarInteger(internal->dim_I0_ILI_1));
  SET_VECTOR_ELT(contents, 151, ScalarInteger(internal->dim_I0_ILI_12));
  SET_VECTOR_ELT(contents, 152, ScalarInteger(internal->dim_I0_ILI_2));
  SET_VECTOR_ELT(contents, 153, ScalarInteger(internal->dim_I0_ILI_3));
  SET_VECTOR_ELT(contents, 154, ScalarInteger(internal->dim_I0_mild));
  SET_VECTOR_ELT(contents, 155, ScalarInteger(internal->dim_I0_mild_1));
  SET_VECTOR_ELT(contents, 156, ScalarInteger(internal->dim_I0_mild_12));
  SET_VECTOR_ELT(contents, 157, ScalarInteger(internal->dim_I0_mild_2));
  SET_VECTOR_ELT(contents, 158, ScalarInteger(internal->dim_I0_mild_3));
  SET_VECTOR_ELT(contents, 159, ScalarInteger(internal->dim_lambda));
  SET_VECTOR_ELT(contents, 160, ScalarInteger(internal->dim_m));
  SET_VECTOR_ELT(contents, 161, ScalarInteger(internal->dim_m_1));
  SET_VECTOR_ELT(contents, 162, ScalarInteger(internal->dim_m_2));
  SET_VECTOR_ELT(contents, 163, ScalarInteger(internal->dim_n_death_hosp));
  SET_VECTOR_ELT(contents, 164, ScalarInteger(internal->dim_n_death_hosp_1));
  SET_VECTOR_ELT(contents, 165, ScalarInteger(internal->dim_n_death_hosp_2));
  SET_VECTOR_ELT(contents, 166, ScalarInteger(internal->dim_n_EE));
  SET_VECTOR_ELT(contents, 167, ScalarInteger(internal->dim_n_EE_1));
  SET_VECTOR_ELT(contents, 168, ScalarInteger(internal->dim_n_EE_12));
  SET_VECTOR_ELT(contents, 169, ScalarInteger(internal->dim_n_EE_2));
  SET_VECTOR_ELT(contents, 170, ScalarInteger(internal->dim_n_EE_3));
  SET_VECTOR_ELT(contents, 171, ScalarInteger(internal->dim_n_EI_asympt));
  SET_VECTOR_ELT(contents, 172, ScalarInteger(internal->dim_n_EI_asympt_1));
  SET_VECTOR_ELT(contents, 173, ScalarInteger(internal->dim_n_EI_asympt_2));
  SET_VECTOR_ELT(contents, 174, ScalarInteger(internal->dim_n_EI_ILI));
  SET_VECTOR_ELT(contents, 175, ScalarInteger(internal->dim_n_EI_ILI_1));
  SET_VECTOR_ELT(contents, 176, ScalarInteger(internal->dim_n_EI_ILI_2));
  SET_VECTOR_ELT(contents, 177, ScalarInteger(internal->dim_n_EI_mild));
  SET_VECTOR_ELT(contents, 178, ScalarInteger(internal->dim_n_EI_mild_1));
  SET_VECTOR_ELT(contents, 179, ScalarInteger(internal->dim_n_EI_mild_2));
  SET_VECTOR_ELT(contents, 180, ScalarInteger(internal->dim_n_hosp_to_ICU));
  SET_VECTOR_ELT(contents, 181, ScalarInteger(internal->dim_n_hosp_to_ICU_1));
  SET_VECTOR_ELT(contents, 182, ScalarInteger(internal->dim_n_hosp_to_ICU_2));
  SET_VECTOR_ELT(contents, 183, ScalarInteger(internal->dim_n_ICU_to_R_hosp));
  SET_VECTOR_ELT(contents, 184, ScalarInteger(internal->dim_n_ICU_to_R_hosp_1));
  SET_VECTOR_ELT(contents, 185, ScalarInteger(internal->dim_n_ICU_to_R_hosp_2));
  SET_VECTOR_ELT(contents, 186, ScalarInteger(internal->dim_n_II_asympt));
  SET_VECTOR_ELT(contents, 187, ScalarInteger(internal->dim_n_II_asympt_1));
  SET_VECTOR_ELT(contents, 188, ScalarInteger(internal->dim_n_II_asympt_12));
  SET_VECTOR_ELT(contents, 189, ScalarInteger(internal->dim_n_II_asympt_2));
  SET_VECTOR_ELT(contents, 190, ScalarInteger(internal->dim_n_II_asympt_3));
  SET_VECTOR_ELT(contents, 191, ScalarInteger(internal->dim_n_II_hosp));
  SET_VECTOR_ELT(contents, 192, ScalarInteger(internal->dim_n_II_hosp_1));
  SET_VECTOR_ELT(contents, 193, ScalarInteger(internal->dim_n_II_hosp_12));
  SET_VECTOR_ELT(contents, 194, ScalarInteger(internal->dim_n_II_hosp_2));
  SET_VECTOR_ELT(contents, 195, ScalarInteger(internal->dim_n_II_hosp_3));
  SET_VECTOR_ELT(contents, 196, ScalarInteger(internal->dim_n_II_ICU));
  SET_VECTOR_ELT(contents, 197, ScalarInteger(internal->dim_n_II_ICU_1));
  SET_VECTOR_ELT(contents, 198, ScalarInteger(internal->dim_n_II_ICU_12));
  SET_VECTOR_ELT(contents, 199, ScalarInteger(internal->dim_n_II_ICU_2));
  SET_VECTOR_ELT(contents, 200, ScalarInteger(internal->dim_n_II_ICU_3));
  SET_VECTOR_ELT(contents, 201, ScalarInteger(internal->dim_n_II_ILI));
  SET_VECTOR_ELT(contents, 202, ScalarInteger(internal->dim_n_II_ILI_1));
  SET_VECTOR_ELT(contents, 203, ScalarInteger(internal->dim_n_II_ILI_12));
  SET_VECTOR_ELT(contents, 204, ScalarInteger(internal->dim_n_II_ILI_2));
  SET_VECTOR_ELT(contents, 205, ScalarInteger(internal->dim_n_II_ILI_3));
  SET_VECTOR_ELT(contents, 206, ScalarInteger(internal->dim_n_II_mild));
  SET_VECTOR_ELT(contents, 207, ScalarInteger(internal->dim_n_II_mild_1));
  SET_VECTOR_ELT(contents, 208, ScalarInteger(internal->dim_n_II_mild_12));
  SET_VECTOR_ELT(contents, 209, ScalarInteger(internal->dim_n_II_mild_2));
  SET_VECTOR_ELT(contents, 210, ScalarInteger(internal->dim_n_II_mild_3));
  SET_VECTOR_ELT(contents, 211, ScalarInteger(internal->dim_n_ILI_to_hosp));
  SET_VECTOR_ELT(contents, 212, ScalarInteger(internal->dim_n_ILI_to_hosp_1));
  SET_VECTOR_ELT(contents, 213, ScalarInteger(internal->dim_n_ILI_to_hosp_2));
  SET_VECTOR_ELT(contents, 214, ScalarInteger(internal->dim_n_R_hosp));
  SET_VECTOR_ELT(contents, 215, ScalarInteger(internal->dim_n_R_hosp_1));
  SET_VECTOR_ELT(contents, 216, ScalarInteger(internal->dim_n_R_hosp_12));
  SET_VECTOR_ELT(contents, 217, ScalarInteger(internal->dim_n_R_hosp_2));
  SET_VECTOR_ELT(contents, 218, ScalarInteger(internal->dim_n_R_hosp_3));
  SET_VECTOR_ELT(contents, 219, ScalarInteger(internal->dim_n_SE));
  SET_VECTOR_ELT(contents, 220, ScalarInteger(internal->dim_p_asympt));
  SET_VECTOR_ELT(contents, 221, ScalarInteger(internal->dim_p_death_hosp));
  SET_VECTOR_ELT(contents, 222, ScalarInteger(internal->dim_p_recov_hosp));
  SET_VECTOR_ELT(contents, 223, ScalarInteger(internal->dim_p_recov_ICU));
  SET_VECTOR_ELT(contents, 224, ScalarInteger(internal->dim_p_recov_ILI));
  SET_VECTOR_ELT(contents, 225, ScalarInteger(internal->dim_p_SE));
  SET_VECTOR_ELT(contents, 226, ScalarInteger(internal->dim_p_sympt_ILI));
  SET_VECTOR_ELT(contents, 227, ScalarInteger(internal->dim_R));
  SET_VECTOR_ELT(contents, 228, ScalarInteger(internal->dim_R_hosp));
  SET_VECTOR_ELT(contents, 229, ScalarInteger(internal->dim_R_hosp_1));
  SET_VECTOR_ELT(contents, 230, ScalarInteger(internal->dim_R_hosp_12));
  SET_VECTOR_ELT(contents, 231, ScalarInteger(internal->dim_R_hosp_2));
  SET_VECTOR_ELT(contents, 232, ScalarInteger(internal->dim_R_hosp_3));
  SET_VECTOR_ELT(contents, 233, ScalarInteger(internal->dim_R0));
  SET_VECTOR_ELT(contents, 234, ScalarInteger(internal->dim_R0_hosp));
  SET_VECTOR_ELT(contents, 235, ScalarInteger(internal->dim_R0_hosp_1));
  SET_VECTOR_ELT(contents, 236, ScalarInteger(internal->dim_R0_hosp_12));
  SET_VECTOR_ELT(contents, 237, ScalarInteger(internal->dim_R0_hosp_2));
  SET_VECTOR_ELT(contents, 238, ScalarInteger(internal->dim_R0_hosp_3));
  ...
  SET_VECTOR_ELT(contents, 243, ScalarInteger(internal->dim_S0));
  SET_VECTOR_ELT(contents, 244, ScalarInteger(internal->dim_trans_increase));
  SET_VECTOR_ELT(contents, 245, ScalarInteger(internal->dim_trans_increase_1));
  SET_VECTOR_ELT(contents, 246, ScalarInteger(internal->dim_trans_increase_2));
  SET_VECTOR_ELT(contents, 247, ScalarInteger(internal->dim_trans_profile));
  SET_VECTOR_ELT(contents, 248, ScalarInteger(internal->dim_trans_profile_1));
  SET_VECTOR_ELT(contents, 249, ScalarInteger(internal->dim_trans_profile_2));
  ...
  SET_VECTOR_ELT(contents, 276, lambda);
  ...
  SET_VECTOR_ELT(contents, 279, n_death_hosp);
  ...
  SET_VECTOR_ELT(contents, 280, n_EE);
  ...
  SET_VECTOR_ELT(contents, 281, n_EI_asympt);
  ...
  SET_VECTOR_ELT(contents, 282, n_EI_ILI);
  ...
  SET_VECTOR_ELT(contents, 283, n_EI_mild);
  ...
  SET_VECTOR_ELT(contents, 284, n_hosp_to_ICU);
  ...
  SET_VECTOR_ELT(contents, 285, n_ICU_to_R_hosp);
  ...
  SET_VECTOR_ELT(contents, 286, n_II_asympt);
  ...
  SET_VECTOR_ELT(contents, 287, n_II_hosp);
  ...
  SET_VECTOR_ELT(contents, 288, n_II_ICU);
  ...
  SET_VECTOR_ELT(contents, 289, n_II_ILI);
  ...
  SET_VECTOR_ELT(contents, 290, n_II_mild);
  ...
  SET_VECTOR_ELT(contents, 291, n_ILI_to_hosp);
  ...
  SET_VECTOR_ELT(contents, 292, n_R_hosp);
  SEXP n_SE = PROTECT(allocVector(REALSXP, internal->dim_n_SE));
  memcpy(REAL(n_SE), internal->n_SE, internal->dim_n_SE * sizeof(double));
  SET_VECTOR_ELT(contents, 293, n_SE);
  SET_VECTOR_ELT(contents, 294, ScalarInteger(internal->offset_output_n_EI_ILI));
  SET_VECTOR_ELT(contents, 295, ScalarInteger(internal->offset_output_n_EI_mild));
  SET_VECTOR_ELT(contents, 296, ScalarInteger(internal->offset_output_n_hosp_to_ICU));
  SET_VECTOR_ELT(contents, 297, ScalarInteger(internal->offset_output_n_ILI_to_hosp));
  SET_VECTOR_ELT(contents, 298, ScalarInteger(internal->offset_variable_D));
  SET_VECTOR_ELT(contents, 299, ScalarInteger(internal->offset_variable_E));
  SET_VECTOR_ELT(contents, 300, ScalarInteger(internal->offset_variable_I_asympt));
  SET_VECTOR_ELT(contents, 301, ScalarInteger(internal->offset_variable_I_hosp));
  SET_VECTOR_ELT(contents, 302, ScalarInteger(internal->offset_variable_I_ICU));
  SET_VECTOR_ELT(contents, 303, ScalarInteger(internal->offset_variable_I_ILI));
  SET_VECTOR_ELT(contents, 304, ScalarInteger(internal->offset_variable_I_mild));
  SET_VECTOR_ELT(contents, 305, ScalarInteger(internal->offset_variable_R_hosp));
  ...
  SET_VECTOR_ELT(contents, 306, p_asympt);
  ...
  SET_VECTOR_ELT(contents, 307, p_death_hosp);
  SET_VECTOR_ELT(contents, 308, ScalarReal(internal->p_EE));
  SET_VECTOR_ELT(contents, 309, ScalarReal(internal->p_II_asympt));
  SET_VECTOR_ELT(contents, 310, ScalarReal(internal->p_II_hosp));
  SET_VECTOR_ELT(contents, 311, ScalarReal(internal->p_II_ICU));
  SET_VECTOR_ELT(contents, 312, ScalarReal(internal->p_II_ILI));
  SET_VECTOR_ELT(contents, 313, ScalarReal(internal->p_II_mild));
  SET_VECTOR_ELT(contents, 314, ScalarReal(internal->p_R_hosp));
  ...
  SET_VECTOR_ELT(contents, 315, p_recov_hosp);
  ...
  SET_VECTOR_ELT(contents, 316, p_recov_ICU);
  ...
  SET_VECTOR_ELT(contents, 321, R0_hosp);
  SET_VECTOR_ELT(contents, 322, ScalarInteger(internal->s_asympt));
  SET_VECTOR_ELT(contents, 323, ScalarInteger(internal->s_E));
  SET_VECTOR_ELT(contents, 324, ScalarInteger(internal->s_hosp));
  SET_VECTOR_ELT(contents, 325, ScalarInteger(internal->s_ICU));
  ...
  SET_VECTOR_ELT(contents, 326, s_ij);
  SET_VECTOR_ELT(contents, 327, ScalarInteger(internal->s_ILI));
  SET_VECTOR_ELT(contents, 328, ScalarInteger(internal->s_mild));
  SET_VECTOR_ELT(contents, 329, ScalarInteger(internal->s_rec));
  SEXP S0 = PROTECT(allocVector(REALSXP, internal->dim_S0));
  memcpy(REAL(S0), internal->S0, internal->dim_S0 * sizeof(double));
  SET_VECTOR_ELT(contents, 330, S0);
  SET_VECTOR_ELT(contents, 331, ScalarInteger(internal->trans_classes));
  ...
  SET_VECTOR_ELT(contents, 332, trans_increase);
  ...
  SET_VECTOR_ELT(contents, 333, trans_profile);
  SEXP nms = PROTECT(allocVector(STRSXP, 334));
  ...
  SET_STRING_ELT(nms, 8, mkChar("beta"));
  SET_STRING_ELT(nms, 9, mkChar("D0"));
  SET_STRING_ELT(nms, 10, mkChar("delta_D"));
  SET_STRING_ELT(nms, 11, mkChar("delta_E"));
  SET_STRING_ELT(nms, 12, mkChar("delta_I_asympt"));
  SET_STRING_ELT(nms, 13, mkChar("delta_I_hosp"));
  SET_STRING_ELT(nms, 14, mkChar("delta_I_ICU"));
  SET_STRING_ELT(nms, 15, mkChar("delta_I_ILI"));
  SET_STRING_ELT(nms, 16, mkChar("delta_I_mild"));
  SET_STRING_ELT(nms, 17, mkChar("delta_R"));
  SET_STRING_ELT(nms, 18, mkChar("delta_R_hosp"));
  SET_STRING_ELT(nms, 19, mkChar("dim_aux_EE"));
  SET_STRING_ELT(nms, 20, mkChar("dim_aux_EE_1"));
  SET_STRING_ELT(nms, 21, mkChar("dim_aux_EE_12"));
  SET_STRING_ELT(nms, 22, mkChar("dim_aux_EE_2"));
  SET_STRING_ELT(nms, 23, mkChar("dim_aux_EE_3"));
  SET_STRING_ELT(nms, 24, mkChar("dim_aux_II_asympt"));
  SET_STRING_ELT(nms, 25, mkChar("dim_aux_II_asympt_1"));
  SET_STRING_ELT(nms, 26, mkChar("dim_aux_II_asympt_12"));
  SET_STRING_ELT(nms, 27, mkChar("dim_aux_II_asympt_2"));
  SET_STRING_ELT(nms, 28, mkChar("dim_aux_II_asympt_3"));
  SET_STRING_ELT(nms, 29, mkChar("dim_aux_II_hosp"));
  SET_STRING_ELT(nms, 30, mkChar("dim_aux_II_hosp_1"));
  SET_STRING_ELT(nms, 31, mkChar("dim_aux_II_hosp_12"));
  SET_STRING_ELT(nms, 32, mkChar("dim_aux_II_hosp_2"));
  SET_STRING_ELT(nms, 33, mkChar("dim_aux_II_hosp_3"));
  SET_STRING_ELT(nms, 34, mkChar("dim_aux_II_ICU"));
  SET_STRING_ELT(nms, 35, mkChar("dim_aux_II_ICU_1"));
  SET_STRING_ELT(nms, 36, mkChar("dim_aux_II_ICU_12"));
  SET_STRING_ELT(nms, 37, mkChar("dim_aux_II_ICU_2"));
  SET_STRING_ELT(nms, 38, mkChar("dim_aux_II_ICU_3"));
  SET_STRING_ELT(nms, 39, mkChar("dim_aux_II_ILI"));
  SET_STRING_ELT(nms, 40, mkChar("dim_aux_II_ILI_1"));
  SET_STRING_ELT(nms, 41, mkChar("dim_aux_II_ILI_12"));
  SET_STRING_ELT(nms, 42, mkChar("dim_aux_II_ILI_2"));
  SET_STRING_ELT(nms, 43, mkChar("dim_aux_II_ILI_3"));
  SET_STRING_ELT(nms, 44, mkChar("dim_aux_II_mild"));
  SET_STRING_ELT(nms, 45, mkChar("dim_aux_II_mild_1"));
  SET_STRING_ELT(nms, 46, mkChar("dim_aux_II_mild_12"));
  SET_STRING_ELT(nms, 47, mkChar("dim_aux_II_mild_2"));
  SET_STRING_ELT(nms, 48, mkChar("dim_aux_II_mild_3"));
  SET_STRING_ELT(nms, 49, mkChar("dim_aux_p_bin"));
  SET_STRING_ELT(nms, 50, mkChar("dim_aux_p_bin_1"));
  SET_STRING_ELT(nms, 51, mkChar("dim_aux_p_bin_2"));
  SET_STRING_ELT(nms, 52, mkChar("dim_aux_R_hosp"));
  SET_STRING_ELT(nms, 53, mkChar("dim_aux_R_hosp_1"));
  SET_STRING_ELT(nms, 54, mkChar("dim_aux_R_hosp_12"));
  SET_STRING_ELT(nms, 55, mkChar("dim_aux_R_hosp_2"));
  SET_STRING_ELT(nms, 56, mkChar("dim_aux_R_hosp_3"));
  SET_STRING_ELT(nms, 57, mkChar("dim_D"));
  SET_STRING_ELT(nms, 58, mkChar("dim_D0"));
  SET_STRING_ELT(nms, 59, mkChar("dim_delta_D"));
  SET_STRING_ELT(nms, 60, mkChar("dim_delta_E"));
  SET_STRING_ELT(nms, 61, mkChar("dim_delta_E_1"));
  SET_STRING_ELT(nms, 62, mkChar("dim_delta_E_12"));
  SET_STRING_ELT(nms, 63, mkChar("dim_delta_E_2"));
  SET_STRING_ELT(nms, 64, mkChar("dim_delta_E_3"));
  SET_STRING_ELT(nms, 65, mkChar("dim_delta_I_asympt"));
  SET_STRING_ELT(nms, 66, mkChar("dim_delta_I_asympt_1"));
  SET_STRING_ELT(nms, 67, mkChar("dim_delta_I_asympt_12"));
  SET_STRING_ELT(nms, 68, mkChar("dim_delta_I_asympt_2"));
  SET_STRING_ELT(nms, 69, mkChar("dim_delta_I_asympt_3"));
  SET_STRING_ELT(nms, 70, mkChar("dim_delta_I_hosp"));
  SET_STRING_ELT(nms, 71, mkChar("dim_delta_I_hosp_1"));
  SET_STRING_ELT(nms, 72, mkChar("dim_delta_I_hosp_12"));
  SET_STRING_ELT(nms, 73, mkChar("dim_delta_I_hosp_2"));
  SET_STRING_ELT(nms, 74, mkChar("dim_delta_I_hosp_3"));
  SET_STRING_ELT(nms, 75, mkChar("dim_delta_I_ICU"));
  SET_STRING_ELT(nms, 76, mkChar("dim_delta_I_ICU_1"));
  SET_STRING_ELT(nms, 77, mkChar("dim_delta_I_ICU_12"));
  SET_STRING_ELT(nms, 78, mkChar("dim_delta_I_ICU_2"));
  SET_STRING_ELT(nms, 79, mkChar("dim_delta_I_ICU_3"));
  SET_STRING_ELT(nms, 80, mkChar("dim_delta_I_ILI"));
  SET_STRING_ELT(nms, 81, mkChar("dim_delta_I_ILI_1"));
  SET_STRING_ELT(nms, 82, mkChar("dim_delta_I_ILI_12"));
  SET_STRING_ELT(nms, 83, mkChar("dim_delta_I_ILI_2"));
  SET_STRING_ELT(nms, 84, mkChar("dim_delta_I_ILI_3"));
  SET_STRING_ELT(nms, 85, mkChar("dim_delta_I_mild"));
  SET_STRING_ELT(nms, 86, mkChar("dim_delta_I_mild_1"));
  SET_STRING_ELT(nms, 87, mkChar("dim_delta_I_mild_12"));
  SET_STRING_ELT(nms, 88, mkChar("dim_delta_I_mild_2"));
  SET_STRING_ELT(nms, 89, mkChar("dim_delta_I_mild_3"));
  SET_STRING_ELT(nms, 90, mkChar("dim_delta_R"));
  SET_STRING_ELT(nms, 91, mkChar("dim_delta_R_hosp"));
  SET_STRING_ELT(nms, 92, mkChar("dim_delta_R_hosp_1"));
  SET_STRING_ELT(nms, 93, mkChar("dim_delta_R_hosp_12"));
  SET_STRING_ELT(nms, 94, mkChar("dim_delta_R_hosp_2"));
  SET_STRING_ELT(nms, 95, mkChar("dim_delta_R_hosp_3"));
  SET_STRING_ELT(nms, 96, mkChar("dim_E"));
  SET_STRING_ELT(nms, 97, mkChar("dim_E_1"));
  SET_STRING_ELT(nms, 98, mkChar("dim_E_12"));
  SET_STRING_ELT(nms, 99, mkChar("dim_E_2"));
  SET_STRING_ELT(nms, 100, mkChar("dim_E_3"));
  SET_STRING_ELT(nms, 101, mkChar("dim_E0"));
  SET_STRING_ELT(nms, 102, mkChar("dim_E0_1"));
  SET_STRING_ELT(nms, 103, mkChar("dim_E0_12"));
  SET_STRING_ELT(nms, 104, mkChar("dim_E0_2"));
  SET_STRING_ELT(nms, 105, mkChar("dim_E0_3"));
  SET_STRING_ELT(nms, 106, mkChar("dim_I_asympt"));
  SET_STRING_ELT(nms, 107, mkChar("dim_I_asympt_1"));
  SET_STRING_ELT(nms, 108, mkChar("dim_I_asympt_12"));
  SET_STRING_ELT(nms, 109, mkChar("dim_I_asympt_2"));
  SET_STRING_ELT(nms, 110, mkChar("dim_I_asympt_3"));
  SET_STRING_ELT(nms, 111, mkChar("dim_I_hosp"));
  SET_STRING_ELT(nms, 112, mkChar("dim_I_hosp_1"));
  SET_STRING_ELT(nms, 113, mkChar("dim_I_hosp_12"));
  SET_STRING_ELT(nms, 114, mkChar("dim_I_hosp_2"));
  SET_STRING_ELT(nms, 115, mkChar("dim_I_hosp_3"));
  SET_STRING_ELT(nms, 116, mkChar("dim_I_ICU"));
  SET_STRING_ELT(nms, 117, mkChar("dim_I_ICU_1"));
  SET_STRING_ELT(nms, 118, mkChar("dim_I_ICU_12"));
  SET_STRING_ELT(nms, 119, mkChar("dim_I_ICU_2"));
  SET_STRING_ELT(nms, 120, mkChar("dim_I_ICU_3"));
  SET_STRING_ELT(nms, 121, mkChar("dim_I_ILI"));
  SET_STRING_ELT(nms, 122, mkChar("dim_I_ILI_1"));
  SET_STRING_ELT(nms, 123, mkChar("dim_I_ILI_12"));
  SET_STRING_ELT(nms, 124, mkChar("dim_I_ILI_2"));
  SET_STRING_ELT(nms, 125, mkChar("dim_I_ILI_3"));
  SET_STRING_ELT(nms, 126, mkChar("dim_I_mild"));
  SET_STRING_ELT(nms, 127, mkChar("dim_I_mild_1"));
  SET_STRING_ELT(nms, 128, mkChar("dim_I_mild_12"));
  SET_STRING_ELT(nms, 129, mkChar("dim_I_mild_2"));
  SET_STRING_ELT(nms, 130, mkChar("dim_I_mild_3"));
  SET_STRING_ELT(nms, 131, mkChar("dim_I_with_diff_trans"));
  SET_STRING_ELT(nms, 132, mkChar("dim_I_with_diff_trans_1"));
  SET_STRING_ELT(nms, 133, mkChar("dim_I_with_diff_trans_2"));
  SET_STRING_ELT(nms, 134, mkChar("dim_I0_asympt"));
  SET_STRING_ELT(nms, 135, mkChar("dim_I0_asympt_1"));
  SET_STRING_ELT(nms, 136, mkChar("dim_I0_asympt_12"));
  SET_STRING_ELT(nms, 137, mkChar("dim_I0_asympt_2"));
  SET_STRING_ELT(nms, 138, mkChar("dim_I0_asympt_3"));
  SET_STRING_ELT(nms, 139, mkChar("dim_I0_hosp"));
  SET_STRING_ELT(nms, 140, mkChar("dim_I0_hosp_1"));
  SET_STRING_ELT(nms, 141, mkChar("dim_I0_hosp_12"));
  SET_STRING_ELT(nms, 142, mkChar("dim_I0_hosp_2"));
  SET_STRING_ELT(nms, 143, mkChar("dim_I0_hosp_3"));
  SET_STRING_ELT(nms, 144, mkChar("dim_I0_ICU"));
  SET_STRING_ELT(nms, 145, mkChar("dim_I0_ICU_1"));
  SET_STRING_ELT(nms, 146, mkChar("dim_I0_ICU_12"));
  SET_STRING_ELT(nms, 147, mkChar("dim_I0_ICU_2"));
  SET_STRING_ELT(nms, 148, mkChar("dim_I0_ICU_3"));
  SET_STRING_ELT(nms, 149, mkChar("dim_I0_ILI"));
  SET_STRING_ELT(nms, 150, mkChar("dim_I0_ILI_1"));
  SET_STRING_ELT(nms, 151, mkChar("dim_I0_ILI_12"));
  SET_STRING_ELT(nms, 152, mkChar("dim_I0_ILI_2"));
  SET_STRING_ELT(nms, 153, mkChar("dim_I0_ILI_3"));
  SET_STRING_ELT(nms, 154, mkChar("dim_I0_mild"));
  SET_STRING_ELT(nms, 155, mkChar("dim_I0_mild_1"));
  SET_STRING_ELT(nms, 156, mkChar("dim_I0_mild_12"));
  SET_STRING_ELT(nms, 157, mkChar("dim_I0_mild_2"));
  SET_STRING_ELT(nms, 158, mkChar("dim_I0_mild_3"));
  SET_STRING_ELT(nms, 159, mkChar("dim_lambda"));
  SET_STRING_ELT(nms, 160, mkChar("dim_m"));
  SET_STRING_ELT(nms, 161, mkChar("dim_m_1"));
  SET_STRING_ELT(nms, 162, mkChar("dim_m_2"));
  SET_STRING_ELT(nms, 163, mkChar("dim_n_death_hosp"));
  SET_STRING_ELT(nms, 164, mkChar("dim_n_death_hosp_1"));
  SET_STRING_ELT(nms, 165, mkChar("dim_n_death_hosp_2"));
  SET_STRING_ELT(nms, 166, mkChar("dim_n_EE"));
  SET_STRING_ELT(nms, 167, mkChar("dim_n_EE_1"));
  SET_STRING_ELT(nms, 168, mkChar("dim_n_EE_12"));
  SET_STRING_ELT(nms, 169, mkChar("dim_n_EE_2"));
  SET_STRING_ELT(nms, 170, mkChar("dim_n_EE_3"));
  SET_STRING_ELT(nms, 171, mkChar("dim_n_EI_asympt"));
  SET_STRING_ELT(nms, 172, mkChar("dim_n_EI_asympt_1"));
  SET_STRING_ELT(nms, 173, mkChar("dim_n_EI_asympt_2"));
  SET_STRING_ELT(nms, 174, mkChar("dim_n_EI_ILI"));
  SET_STRING_ELT(nms, 175, mkChar("dim_n_EI_ILI_1"));
  SET_STRING_ELT(nms, 176, mkChar("dim_n_EI_ILI_2"));
  SET_STRING_ELT(nms, 177, mkChar("dim_n_EI_mild"));
  SET_STRING_ELT(nms, 178, mkChar("dim_n_EI_mild_1"));
  SET_STRING_ELT(nms, 179, mkChar("dim_n_EI_mild_2"));
  SET_STRING_ELT(nms, 180, mkChar("dim_n_hosp_to_ICU"));
  SET_STRING_ELT(nms, 181, mkChar("dim_n_hosp_to_ICU_1"));
  SET_STRING_ELT(nms, 182, mkChar("dim_n_hosp_to_ICU_2"));
  SET_STRING_ELT(nms, 183, mkChar("dim_n_ICU_to_R_hosp"));
  SET_STRING_ELT(nms, 184, mkChar("dim_n_ICU_to_R_hosp_1"));
  SET_STRING_ELT(nms, 185, mkChar("dim_n_ICU_to_R_hosp_2"));
  SET_STRING_ELT(nms, 186, mkChar("dim_n_II_asympt"));
  SET_STRING_ELT(nms, 187, mkChar("dim_n_II_asympt_1"));
  SET_STRING_ELT(nms, 188, mkChar("dim_n_II_asympt_12"));
  SET_STRING_ELT(nms, 189, mkChar("dim_n_II_asympt_2"));
  SET_STRING_ELT(nms, 190, mkChar("dim_n_II_asympt_3"));
  SET_STRING_ELT(nms, 191, mkChar("dim_n_II_hosp"));
  SET_STRING_ELT(nms, 192, mkChar("dim_n_II_hosp_1"));
  SET_STRING_ELT(nms, 193, mkChar("dim_n_II_hosp_12"));
  SET_STRING_ELT(nms, 194, mkChar("dim_n_II_hosp_2"));
  SET_STRING_ELT(nms, 195, mkChar("dim_n_II_hosp_3"));
  SET_STRING_ELT(nms, 196, mkChar("dim_n_II_ICU"));
  SET_STRING_ELT(nms, 197, mkChar("dim_n_II_ICU_1"));
  SET_STRING_ELT(nms, 198, mkChar("dim_n_II_ICU_12"));
  SET_STRING_ELT(nms, 199, mkChar("dim_n_II_ICU_2"));
  SET_STRING_ELT(nms, 200, mkChar("dim_n_II_ICU_3"));
  SET_STRING_ELT(nms, 201, mkChar("dim_n_II_ILI"));
  SET_STRING_ELT(nms, 202, mkChar("dim_n_II_ILI_1"));
  SET_STRING_ELT(nms, 203, mkChar("dim_n_II_ILI_12"));
  SET_STRING_ELT(nms, 204, mkChar("dim_n_II_ILI_2"));
  SET_STRING_ELT(nms, 205, mkChar("dim_n_II_ILI_3"));
  SET_STRING_ELT(nms, 206, mkChar("dim_n_II_mild"));
  SET_STRING_ELT(nms, 207, mkChar("dim_n_II_mild_1"));
  SET_STRING_ELT(nms, 208, mkChar("dim_n_II_mild_12"));
  SET_STRING_ELT(nms, 209, mkChar("dim_n_II_mild_2"));
  SET_STRING_ELT(nms, 210, mkChar("dim_n_II_mild_3"));
  SET_STRING_ELT(nms, 211, mkChar("dim_n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 212, mkChar("dim_n_ILI_to_hosp_1"));
  SET_STRING_ELT(nms, 213, mkChar("dim_n_ILI_to_hosp_2"));
  SET_STRING_ELT(nms, 214, mkChar("dim_n_R_hosp"));
  SET_STRING_ELT(nms, 215, mkChar("dim_n_R_hosp_1"));
  SET_STRING_ELT(nms, 216, mkChar("dim_n_R_hosp_12"));
  SET_STRING_ELT(nms, 217, mkChar("dim_n_R_hosp_2"));
  SET_STRING_ELT(nms, 218, mkChar("dim_n_R_hosp_3"));
  SET_STRING_ELT(nms, 219, mkChar("dim_n_SE"));
  SET_STRING_ELT(nms, 220, mkChar("dim_p_asympt"));
  SET_STRING_ELT(nms, 221, mkChar("dim_p_death_hosp"));
  SET_STRING_ELT(nms, 222, mkChar("dim_p_recov_hosp"));
  SET_STRING_ELT(nms, 223, mkChar("dim_p_recov_ICU"));
  SET_STRING_ELT(nms, 224, mkChar("dim_p_recov_ILI"));
  SET_STRING_ELT(nms, 225, mkChar("dim_p_SE"));
  SET_STRING_ELT(nms, 226, mkChar("dim_p_sympt_ILI"));
  SET_STRING_ELT(nms, 227, mkChar("dim_R"));
  SET_STRING_ELT(nms, 228, mkChar("dim_R_hosp"));
  SET_STRING_ELT(nms, 229, mkChar("dim_R_hosp_1"));
  SET_STRING_ELT(nms, 230, mkChar("dim_R_hosp_12"));
  SET_STRING_ELT(nms, 231, mkChar("dim_R_hosp_2"));
  SET_STRING_ELT(nms, 232, mkChar("dim_R_hosp_3"));
  SET_STRING_ELT(nms, 233, mkChar("dim_R0"));
  SET_STRING_ELT(nms, 234, mkChar("dim_R0_hosp"));
  SET_STRING_ELT(nms, 235, mkChar("dim_R0_hosp_1"));
  SET_STRING_ELT(nms, 236, mkChar("dim_R0_hosp_12"));
  SET_STRING_ELT(nms, 237, mkChar("dim_R0_hosp_2"));
  SET_STRING_ELT(nms, 238, mkChar("dim_R0_hosp_3"));
  ...
  SET_STRING_ELT(nms, 243, mkChar("dim_S0"));
  SET_STRING_ELT(nms, 244, mkChar("dim_trans_increase"));
  SET_STRING_ELT(nms, 245, mkChar("dim_trans_increase_1"));
  SET_STRING_ELT(nms, 246, mkChar("dim_trans_increase_2"));
  SET_STRING_ELT(nms, 247, mkChar("dim_trans_profile"));
  SET_STRING_ELT(nms, 248, mkChar("dim_trans_profile_1"));
  SET_STRING_ELT(nms, 249, mkChar("dim_trans_profile_2"));
  ...
  SET_STRING_ELT(nms, 276, mkChar("lambda"));
  SET_STRING_ELT(nms, 277, mkChar("m"));
  SET_STRING_ELT(nms, 278, mkChar("N_age"));
  SET_STRING_ELT(nms, 279, mkChar("n_death_hosp"));
  SET_STRING_ELT(nms, 280, mkChar("n_EE"));
  SET_STRING_ELT(nms, 281, mkChar("n_EI_asympt"));
  SET_STRING_ELT(nms, 282, mkChar("n_EI_ILI"));
  SET_STRING_ELT(nms, 283, mkChar("n_EI_mild"));
  SET_STRING_ELT(nms, 284, mkChar("n_hosp_to_ICU"));
  SET_STRING_ELT(nms, 285, mkChar("n_ICU_to_R_hosp"));
  SET_STRING_ELT(nms, 286, mkChar("n_II_asympt"));
  SET_STRING_ELT(nms, 287, mkChar("n_II_hosp"));
  SET_STRING_ELT(nms, 288, mkChar("n_II_ICU"));
  SET_STRING_ELT(nms, 289, mkChar("n_II_ILI"));
  SET_STRING_ELT(nms, 290, mkChar("n_II_mild"));
  SET_STRING_ELT(nms, 291, mkChar("n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 292, mkChar("n_R_hosp"));
  SET_STRING_ELT(nms, 293, mkChar("n_SE"));
  SET_STRING_ELT(nms, 294, mkChar("offset_output_n_EI_ILI"));
  SET_STRING_ELT(nms, 295, mkChar("offset_output_n_EI_mild"));
  SET_STRING_ELT(nms, 296, mkChar("offset_output_n_hosp_to_ICU"));
  SET_STRING_ELT(nms, 297, mkChar("offset_output_n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 298, mkChar("offset_variable_D"));
  SET_STRING_ELT(nms, 299, mkChar("offset_variable_E"));
  SET_STRING_ELT(nms, 300, mkChar("offset_variable_I_asympt"));
  SET_STRING_ELT(nms, 301, mkChar("offset_variable_I_hosp"));
  SET_STRING_ELT(nms, 302, mkChar("offset_variable_I_ICU"));
  SET_STRING_ELT(nms, 303, mkChar("offset_variable_I_ILI"));
  SET_STRING_ELT(nms, 304, mkChar("offset_variable_I_mild"));
  SET_STRING_ELT(nms, 305, mkChar("offset_variable_R_hosp"));
  SET_STRING_ELT(nms, 306, mkChar("p_asympt"));
  SET_STRING_ELT(nms, 307, mkChar("p_death_hosp"));
  SET_STRING_ELT(nms, 308, mkChar("p_EE"));
  SET_STRING_ELT(nms, 309, mkChar("p_II_asympt"));
  SET_STRING_ELT(nms, 310, mkChar("p_II_hosp"));
  SET_STRING_ELT(nms, 311, mkChar("p_II_ICU"));
  SET_STRING_ELT(nms, 312, mkChar("p_II_ILI"));
  SET_STRING_ELT(nms, 313, mkChar("p_II_mild"));
  SET_STRING_ELT(nms, 314, mkChar("p_R_hosp"));
  SET_STRING_ELT(nms, 315, mkChar("p_recov_hosp"));
  SET_STRING_ELT(nms, 316, mkChar("p_recov_ICU"));
  SET_STRING_ELT(nms, 317, mkChar("p_recov_ILI"));
  SET_STRING_ELT(nms, 318, mkChar("p_SE"));
  SET_STRING_ELT(nms, 319, mkChar("p_sympt_ILI"));
  SET_STRING_ELT(nms, 320, mkChar("R0"));
  SET_STRING_ELT(nms, 321, mkChar("R0_hosp"));
  SET_STRING_ELT(nms, 322, mkChar("s_asympt"));
  SET_STRING_ELT(nms, 323, mkChar("s_E"));
  SET_STRING_ELT(nms, 324, mkChar("s_hosp"));
  SET_STRING_ELT(nms, 325, mkChar("s_ICU"));
  SET_STRING_ELT(nms, 326, mkChar("s_ij"));
  SET_STRING_ELT(nms, 327, mkChar("s_ILI"));
  SET_STRING_ELT(nms, 328, mkChar("s_mild"));
  SET_STRING_ELT(nms, 329, mkChar("s_rec"));
  SET_STRING_ELT(nms, 330, mkChar("S0"));
  SET_STRING_ELT(nms, 331, mkChar("trans_classes"));
  SET_STRING_ELT(nms, 332, mkChar("trans_increase"));
  SET_STRING_ELT(nms, 333, mkChar("trans_profile"));
...
SEXP basic_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->p_EE = 1 - exp(-(internal->gamma_E));
  internal->p_II_asympt = 1 - exp(-(internal->gamma_asympt));
  internal->p_II_hosp = 1 - exp(-(internal->gamma_hosp));
  internal->p_II_ICU = 1 - exp(-(internal->gamma_ICU));
  internal->p_II_ILI = 1 - exp(-(internal->gamma_ILI));
  internal->p_II_mild = 1 - exp(-(internal->gamma_mild));
  internal->p_R_hosp = 1 - exp(-(internal->gamma_rec));
  Free(internal->delta_D);
  ...
  internal->offset_output_n_EI_ILI = 1 + internal->dim_n_EI_asympt + internal->dim_n_EI_mild;
  internal->offset_output_n_EI_mild = 1 + internal->dim_n_EI_asympt;
  internal->offset_output_n_hosp_to_ICU = 1 + internal->dim_n_EI_asympt + internal->dim_n_EI_mild + internal->dim_n_EI_ILI + internal->dim_n_ILI_to_hosp;
  internal->offset_output_n_ILI_to_hosp = 1 + internal->dim_n_EI_asympt + internal->dim_n_EI_mild + internal->dim_n_EI_ILI;
...
SEXP basic_metadata(SEXP internal_p) {
  ...
  int * dim_n_EI_asympt = INTEGER(VECTOR_ELT(output_length, 1));
  ...
  int * dim_n_EI_mild = INTEGER(VECTOR_ELT(output_length, 2));
  ...
  int * dim_n_EI_ILI = INTEGER(VECTOR_ELT(output_length, 3));
  ...
  int * dim_n_ILI_to_hosp = INTEGER(VECTOR_ELT(output_length, 4));
  ...
  int * dim_n_hosp_to_ICU = INTEGER(VECTOR_ELT(output_length, 5));
  ...
  SET_STRING_ELT(output_names, 1, mkChar("n_EI_asympt"));
  SET_STRING_ELT(output_names, 2, mkChar("n_EI_mild"));
  SET_STRING_ELT(output_names, 3, mkChar("n_EI_ILI"));
  SET_STRING_ELT(output_names, 4, mkChar("n_ILI_to_hosp"));
  SET_STRING_ELT(output_names, 5, mkChar("n_hosp_to_ICU"));
  SET_VECTOR_ELT(ret, 1, output_length);
  UNPROTECT(2);
  SET_VECTOR_ELT(ret, 2, ScalarInteger(1 + internal->dim_n_EI_asympt + internal->dim_n_EI_mild + internal->dim_n_EI_ILI + internal->dim_n_ILI_to_hosp + internal->dim_n_hosp_to_ICU));
  UNPROTECT(2);
  return ret;
}
SEXP basic_initial_conditions(SEXP internal_p, SEXP step_ptr) {
...
void basic_rhs(basic_internal* internal, size_t step, double * state, double * state_next, double * output) {
  ...
  for (int i = 1; i <= internal->dim_lambda; ++i) {
    internal->lambda[i - 1] = internal->beta * odin_sum2(internal->s_ij, i - 1, i, 0, internal->dim_s_ij_2, internal->dim_s_ij_1);
  }
  ...
  for (int i = 1; i <= internal->dim_p_SE; ++i) {
    internal->p_SE[i - 1] = 1 - exp(-(internal->lambda[i - 1]));
  }
  for (int i = 1; i <= internal->dim_D; ++i) {
  ...
  output[0] = N_tot;
  memcpy(output + 1, internal->n_EI_asympt, internal->dim_n_EI_asympt * sizeof(double));
...
SEXP basic_rhs_r(SEXP internal_p, SEXP step, SEXP state) {
  ...
  basic_internal *internal = basic_get_internal(internal_p, 1);
  SEXP output_ptr = PROTECT(allocVector(REALSXP, 1 + internal->dim_n_EI_asympt + internal->dim_n_EI_mild + internal->dim_n_EI_ILI + internal->dim_n_ILI_to_hosp + internal->dim_n_hosp_to_ICU));
