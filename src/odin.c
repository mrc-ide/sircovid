...
SEXP hospital_with_serology_testing_contents(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(contents, 100, ScalarInteger(internal->dim_aux_II_triage_R_2));
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_aux_II_triage_R_3));
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_aux_p_bin));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_aux_p_bin_1));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_aux_p_bin_2));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_aux_R_pre));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_aux_R_pre_1));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_aux_R_pre_2));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_aux_R_stepdown));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_aux_R_stepdown_1));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_aux_R_stepdown_2));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_beta_t));
  SET_VECTOR_ELT(contents, 112, ScalarInteger(internal->dim_beta_y));
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_D_comm));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_D_hosp));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_D0_comm));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_D0_hosp));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_delta_D_comm));
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_delta_D_hosp));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_delta_E));
  SET_VECTOR_ELT(contents, 120, ScalarInteger(internal->dim_delta_E_1));
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->dim_delta_E_12));
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_delta_E_2));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_delta_E_3));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_delta_I_asympt));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_delta_I_asympt_1));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_delta_I_asympt_12));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_delta_I_asympt_2));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_delta_I_asympt_3));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_delta_I_comm_D));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_delta_I_comm_D_1));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_delta_I_comm_D_12));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_delta_I_comm_D_2));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_delta_I_comm_D_3));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_delta_I_ICU_D));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_delta_I_ICU_D_1));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_delta_I_ICU_D_12));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_delta_I_ICU_D_2));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_delta_I_ICU_D_3));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->dim_delta_I_ICU_R));
  SET_VECTOR_ELT(contents, 140, ScalarInteger(internal->dim_delta_I_ICU_R_1));
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_delta_I_ICU_R_12));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_delta_I_ICU_R_2));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_delta_I_ICU_R_3));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_delta_I_ILI));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->dim_delta_I_ILI_1));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->dim_delta_I_ILI_12));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->dim_delta_I_ILI_2));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->dim_delta_I_ILI_3));
  SET_VECTOR_ELT(contents, 149, ScalarInteger(internal->dim_delta_I_mild));
  SET_VECTOR_ELT(contents, 150, ScalarInteger(internal->dim_delta_I_mild_1));
  SET_VECTOR_ELT(contents, 151, ScalarInteger(internal->dim_delta_I_mild_12));
  SET_VECTOR_ELT(contents, 152, ScalarInteger(internal->dim_delta_I_mild_2));
  SET_VECTOR_ELT(contents, 153, ScalarInteger(internal->dim_delta_I_mild_3));
  SET_VECTOR_ELT(contents, 154, ScalarInteger(internal->dim_delta_I_triage_D));
  SET_VECTOR_ELT(contents, 155, ScalarInteger(internal->dim_delta_I_triage_D_1));
  SET_VECTOR_ELT(contents, 156, ScalarInteger(internal->dim_delta_I_triage_D_12));
  SET_VECTOR_ELT(contents, 157, ScalarInteger(internal->dim_delta_I_triage_D_2));
  SET_VECTOR_ELT(contents, 158, ScalarInteger(internal->dim_delta_I_triage_D_3));
  SET_VECTOR_ELT(contents, 159, ScalarInteger(internal->dim_delta_I_triage_R));
  SET_VECTOR_ELT(contents, 160, ScalarInteger(internal->dim_delta_I_triage_R_1));
  SET_VECTOR_ELT(contents, 161, ScalarInteger(internal->dim_delta_I_triage_R_12));
  SET_VECTOR_ELT(contents, 162, ScalarInteger(internal->dim_delta_I_triage_R_2));
  SET_VECTOR_ELT(contents, 163, ScalarInteger(internal->dim_delta_I_triage_R_3));
  ...
  SET_VECTOR_ELT(contents, 238, ScalarInteger(internal->dim_I_triage_R));
  SET_VECTOR_ELT(contents, 239, ScalarInteger(internal->dim_I_triage_R_1));
  SET_VECTOR_ELT(contents, 240, ScalarInteger(internal->dim_I_triage_R_12));
  ...
  SET_VECTOR_ELT(contents, 243, ScalarInteger(internal->dim_I_with_diff_trans));
  SET_VECTOR_ELT(contents, 244, ScalarInteger(internal->dim_I_with_diff_trans_1));
  SET_VECTOR_ELT(contents, 245, ScalarInteger(internal->dim_I_with_diff_trans_2));
  SET_VECTOR_ELT(contents, 246, ScalarInteger(internal->dim_I0_asympt));
  SET_VECTOR_ELT(contents, 247, ScalarInteger(internal->dim_I0_asympt_1));
  SET_VECTOR_ELT(contents, 248, ScalarInteger(internal->dim_I0_asympt_12));
  SET_VECTOR_ELT(contents, 249, ScalarInteger(internal->dim_I0_asympt_2));
  SET_VECTOR_ELT(contents, 250, ScalarInteger(internal->dim_I0_asympt_3));
  SET_VECTOR_ELT(contents, 251, ScalarInteger(internal->dim_I0_comm_D));
  SET_VECTOR_ELT(contents, 252, ScalarInteger(internal->dim_I0_comm_D_1));
  SET_VECTOR_ELT(contents, 253, ScalarInteger(internal->dim_I0_comm_D_12));
  SET_VECTOR_ELT(contents, 254, ScalarInteger(internal->dim_I0_comm_D_2));
  SET_VECTOR_ELT(contents, 255, ScalarInteger(internal->dim_I0_comm_D_3));
  SET_VECTOR_ELT(contents, 256, ScalarInteger(internal->dim_I0_hosp_D_conf));
  SET_VECTOR_ELT(contents, 257, ScalarInteger(internal->dim_I0_hosp_D_conf_1));
  SET_VECTOR_ELT(contents, 258, ScalarInteger(internal->dim_I0_hosp_D_conf_12));
  SET_VECTOR_ELT(contents, 259, ScalarInteger(internal->dim_I0_hosp_D_conf_2));
  SET_VECTOR_ELT(contents, 260, ScalarInteger(internal->dim_I0_hosp_D_conf_3));
  SET_VECTOR_ELT(contents, 261, ScalarInteger(internal->dim_I0_hosp_D_unconf));
  SET_VECTOR_ELT(contents, 262, ScalarInteger(internal->dim_I0_hosp_D_unconf_1));
  SET_VECTOR_ELT(contents, 263, ScalarInteger(internal->dim_I0_hosp_D_unconf_12));
  SET_VECTOR_ELT(contents, 264, ScalarInteger(internal->dim_I0_hosp_D_unconf_2));
  SET_VECTOR_ELT(contents, 265, ScalarInteger(internal->dim_I0_hosp_D_unconf_3));
  SET_VECTOR_ELT(contents, 266, ScalarInteger(internal->dim_I0_hosp_R_conf));
  SET_VECTOR_ELT(contents, 267, ScalarInteger(internal->dim_I0_hosp_R_conf_1));
  SET_VECTOR_ELT(contents, 268, ScalarInteger(internal->dim_I0_hosp_R_conf_12));
  SET_VECTOR_ELT(contents, 269, ScalarInteger(internal->dim_I0_hosp_R_conf_2));
  SET_VECTOR_ELT(contents, 270, ScalarInteger(internal->dim_I0_hosp_R_conf_3));
  SET_VECTOR_ELT(contents, 271, ScalarInteger(internal->dim_I0_hosp_R_unconf));
  SET_VECTOR_ELT(contents, 272, ScalarInteger(internal->dim_I0_hosp_R_unconf_1));
  SET_VECTOR_ELT(contents, 273, ScalarInteger(internal->dim_I0_hosp_R_unconf_12));
  SET_VECTOR_ELT(contents, 274, ScalarInteger(internal->dim_I0_hosp_R_unconf_2));
  SET_VECTOR_ELT(contents, 275, ScalarInteger(internal->dim_I0_hosp_R_unconf_3));
  SET_VECTOR_ELT(contents, 276, ScalarInteger(internal->dim_I0_ICU_D));
  SET_VECTOR_ELT(contents, 277, ScalarInteger(internal->dim_I0_ICU_D_1));
  SET_VECTOR_ELT(contents, 278, ScalarInteger(internal->dim_I0_ICU_D_12));
  SET_VECTOR_ELT(contents, 279, ScalarInteger(internal->dim_I0_ICU_D_2));
  SET_VECTOR_ELT(contents, 280, ScalarInteger(internal->dim_I0_ICU_D_3));
  SET_VECTOR_ELT(contents, 281, ScalarInteger(internal->dim_I0_ICU_R));
  SET_VECTOR_ELT(contents, 282, ScalarInteger(internal->dim_I0_ICU_R_1));
  SET_VECTOR_ELT(contents, 283, ScalarInteger(internal->dim_I0_ICU_R_12));
  SET_VECTOR_ELT(contents, 284, ScalarInteger(internal->dim_I0_ICU_R_2));
  SET_VECTOR_ELT(contents, 285, ScalarInteger(internal->dim_I0_ICU_R_3));
  SET_VECTOR_ELT(contents, 286, ScalarInteger(internal->dim_I0_ILI));
  SET_VECTOR_ELT(contents, 287, ScalarInteger(internal->dim_I0_ILI_1));
  SET_VECTOR_ELT(contents, 288, ScalarInteger(internal->dim_I0_ILI_12));
  SET_VECTOR_ELT(contents, 289, ScalarInteger(internal->dim_I0_ILI_2));
  SET_VECTOR_ELT(contents, 290, ScalarInteger(internal->dim_I0_ILI_3));
  SET_VECTOR_ELT(contents, 291, ScalarInteger(internal->dim_I0_mild));
  SET_VECTOR_ELT(contents, 292, ScalarInteger(internal->dim_I0_mild_1));
  SET_VECTOR_ELT(contents, 293, ScalarInteger(internal->dim_I0_mild_12));
  SET_VECTOR_ELT(contents, 294, ScalarInteger(internal->dim_I0_mild_2));
  SET_VECTOR_ELT(contents, 295, ScalarInteger(internal->dim_I0_mild_3));
  SET_VECTOR_ELT(contents, 296, ScalarInteger(internal->dim_I0_triage_D));
  SET_VECTOR_ELT(contents, 297, ScalarInteger(internal->dim_I0_triage_D_1));
  SET_VECTOR_ELT(contents, 298, ScalarInteger(internal->dim_I0_triage_D_12));
  SET_VECTOR_ELT(contents, 299, ScalarInteger(internal->dim_I0_triage_D_2));
  SET_VECTOR_ELT(contents, 300, ScalarInteger(internal->dim_I0_triage_D_3));
  ...
  SET_VECTOR_ELT(contents, 304, ScalarInteger(internal->dim_I0_triage_R_2));
  SET_VECTOR_ELT(contents, 305, ScalarInteger(internal->dim_I0_triage_R_3));
  SET_VECTOR_ELT(contents, 306, ScalarInteger(internal->dim_lambda));
  SET_VECTOR_ELT(contents, 307, ScalarInteger(internal->dim_m));
  SET_VECTOR_ELT(contents, 308, ScalarInteger(internal->dim_m_1));
  SET_VECTOR_ELT(contents, 309, ScalarInteger(internal->dim_m_2));
  SET_VECTOR_ELT(contents, 310, ScalarInteger(internal->dim_n_com_to_R_pre));
  SET_VECTOR_ELT(contents, 311, ScalarInteger(internal->dim_n_com_to_R_total));
  SET_VECTOR_ELT(contents, 312, ScalarInteger(internal->dim_n_EE));
  SET_VECTOR_ELT(contents, 313, ScalarInteger(internal->dim_n_EE_1));
  SET_VECTOR_ELT(contents, 314, ScalarInteger(internal->dim_n_EE_12));
  SET_VECTOR_ELT(contents, 315, ScalarInteger(internal->dim_n_EE_2));
  SET_VECTOR_ELT(contents, 316, ScalarInteger(internal->dim_n_EE_3));
  SET_VECTOR_ELT(contents, 317, ScalarInteger(internal->dim_n_EI_asympt));
  SET_VECTOR_ELT(contents, 318, ScalarInteger(internal->dim_n_EI_asympt_1));
  SET_VECTOR_ELT(contents, 319, ScalarInteger(internal->dim_n_EI_asympt_2));
  SET_VECTOR_ELT(contents, 320, ScalarInteger(internal->dim_n_EI_ILI));
  SET_VECTOR_ELT(contents, 321, ScalarInteger(internal->dim_n_EI_ILI_1));
  SET_VECTOR_ELT(contents, 322, ScalarInteger(internal->dim_n_EI_ILI_2));
  SET_VECTOR_ELT(contents, 323, ScalarInteger(internal->dim_n_EI_mild));
  SET_VECTOR_ELT(contents, 324, ScalarInteger(internal->dim_n_EI_mild_1));
  SET_VECTOR_ELT(contents, 325, ScalarInteger(internal->dim_n_EI_mild_2));
  SET_VECTOR_ELT(contents, 326, ScalarInteger(internal->dim_n_hosp_non_ICU));
  SET_VECTOR_ELT(contents, 327, ScalarInteger(internal->dim_n_hosp_non_ICU_1));
  SET_VECTOR_ELT(contents, 328, ScalarInteger(internal->dim_n_hosp_non_ICU_2));
  SET_VECTOR_ELT(contents, 329, ScalarInteger(internal->dim_n_I_hosp_D_unconf_to_conf));
  SET_VECTOR_ELT(contents, 330, ScalarInteger(internal->dim_n_I_hosp_D_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 331, ScalarInteger(internal->dim_n_I_hosp_D_unconf_to_conf_12));
  SET_VECTOR_ELT(contents, 332, ScalarInteger(internal->dim_n_I_hosp_D_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 333, ScalarInteger(internal->dim_n_I_hosp_D_unconf_to_conf_3));
  SET_VECTOR_ELT(contents, 334, ScalarInteger(internal->dim_n_I_hosp_R_unconf_to_conf));
  SET_VECTOR_ELT(contents, 335, ScalarInteger(internal->dim_n_I_hosp_R_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 336, ScalarInteger(internal->dim_n_I_hosp_R_unconf_to_conf_12));
  SET_VECTOR_ELT(contents, 337, ScalarInteger(internal->dim_n_I_hosp_R_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 338, ScalarInteger(internal->dim_n_I_hosp_R_unconf_to_conf_3));
  SET_VECTOR_ELT(contents, 339, ScalarInteger(internal->dim_n_ICU_to_R_stepdown));
  SET_VECTOR_ELT(contents, 340, ScalarInteger(internal->dim_n_II_asympt));
  SET_VECTOR_ELT(contents, 341, ScalarInteger(internal->dim_n_II_asympt_1));
  SET_VECTOR_ELT(contents, 342, ScalarInteger(internal->dim_n_II_asympt_12));
  SET_VECTOR_ELT(contents, 343, ScalarInteger(internal->dim_n_II_asympt_2));
  SET_VECTOR_ELT(contents, 344, ScalarInteger(internal->dim_n_II_asympt_3));
  SET_VECTOR_ELT(contents, 345, ScalarInteger(internal->dim_n_II_comm_D));
  SET_VECTOR_ELT(contents, 346, ScalarInteger(internal->dim_n_II_comm_D_1));
  SET_VECTOR_ELT(contents, 347, ScalarInteger(internal->dim_n_II_comm_D_12));
  SET_VECTOR_ELT(contents, 348, ScalarInteger(internal->dim_n_II_comm_D_2));
  SET_VECTOR_ELT(contents, 349, ScalarInteger(internal->dim_n_II_comm_D_3));
  SET_VECTOR_ELT(contents, 350, ScalarInteger(internal->dim_n_II_hosp_D_conf));
  SET_VECTOR_ELT(contents, 351, ScalarInteger(internal->dim_n_II_hosp_D_conf_1));
  SET_VECTOR_ELT(contents, 352, ScalarInteger(internal->dim_n_II_hosp_D_conf_12));
  SET_VECTOR_ELT(contents, 353, ScalarInteger(internal->dim_n_II_hosp_D_conf_2));
  SET_VECTOR_ELT(contents, 354, ScalarInteger(internal->dim_n_II_hosp_D_conf_3));
  SET_VECTOR_ELT(contents, 355, ScalarInteger(internal->dim_n_II_hosp_D_unconf));
  SET_VECTOR_ELT(contents, 356, ScalarInteger(internal->dim_n_II_hosp_D_unconf_1));
  SET_VECTOR_ELT(contents, 357, ScalarInteger(internal->dim_n_II_hosp_D_unconf_12));
  SET_VECTOR_ELT(contents, 358, ScalarInteger(internal->dim_n_II_hosp_D_unconf_2));
  SET_VECTOR_ELT(contents, 359, ScalarInteger(internal->dim_n_II_hosp_D_unconf_3));
  SET_VECTOR_ELT(contents, 360, ScalarInteger(internal->dim_n_II_hosp_R_conf));
  SET_VECTOR_ELT(contents, 361, ScalarInteger(internal->dim_n_II_hosp_R_conf_1));
  SET_VECTOR_ELT(contents, 362, ScalarInteger(internal->dim_n_II_hosp_R_conf_12));
  SET_VECTOR_ELT(contents, 363, ScalarInteger(internal->dim_n_II_hosp_R_conf_2));
  SET_VECTOR_ELT(contents, 364, ScalarInteger(internal->dim_n_II_hosp_R_conf_3));
  SET_VECTOR_ELT(contents, 365, ScalarInteger(internal->dim_n_II_hosp_R_unconf));
  SET_VECTOR_ELT(contents, 366, ScalarInteger(internal->dim_n_II_hosp_R_unconf_1));
  SET_VECTOR_ELT(contents, 367, ScalarInteger(internal->dim_n_II_hosp_R_unconf_12));
  SET_VECTOR_ELT(contents, 368, ScalarInteger(internal->dim_n_II_hosp_R_unconf_2));
  SET_VECTOR_ELT(contents, 369, ScalarInteger(internal->dim_n_II_hosp_R_unconf_3));
  SET_VECTOR_ELT(contents, 370, ScalarInteger(internal->dim_n_II_ICU_D));
  SET_VECTOR_ELT(contents, 371, ScalarInteger(internal->dim_n_II_ICU_D_1));
  SET_VECTOR_ELT(contents, 372, ScalarInteger(internal->dim_n_II_ICU_D_12));
  SET_VECTOR_ELT(contents, 373, ScalarInteger(internal->dim_n_II_ICU_D_2));
  SET_VECTOR_ELT(contents, 374, ScalarInteger(internal->dim_n_II_ICU_D_3));
  SET_VECTOR_ELT(contents, 375, ScalarInteger(internal->dim_n_II_ICU_R));
  SET_VECTOR_ELT(contents, 376, ScalarInteger(internal->dim_n_II_ICU_R_1));
  SET_VECTOR_ELT(contents, 377, ScalarInteger(internal->dim_n_II_ICU_R_12));
  SET_VECTOR_ELT(contents, 378, ScalarInteger(internal->dim_n_II_ICU_R_2));
  SET_VECTOR_ELT(contents, 379, ScalarInteger(internal->dim_n_II_ICU_R_3));
  SET_VECTOR_ELT(contents, 380, ScalarInteger(internal->dim_n_II_ILI));
  SET_VECTOR_ELT(contents, 381, ScalarInteger(internal->dim_n_II_ILI_1));
  SET_VECTOR_ELT(contents, 382, ScalarInteger(internal->dim_n_II_ILI_12));
  SET_VECTOR_ELT(contents, 383, ScalarInteger(internal->dim_n_II_ILI_2));
  SET_VECTOR_ELT(contents, 384, ScalarInteger(internal->dim_n_II_ILI_3));
  SET_VECTOR_ELT(contents, 385, ScalarInteger(internal->dim_n_II_mild));
  SET_VECTOR_ELT(contents, 386, ScalarInteger(internal->dim_n_II_mild_1));
  SET_VECTOR_ELT(contents, 387, ScalarInteger(internal->dim_n_II_mild_12));
  SET_VECTOR_ELT(contents, 388, ScalarInteger(internal->dim_n_II_mild_2));
  SET_VECTOR_ELT(contents, 389, ScalarInteger(internal->dim_n_II_mild_3));
  SET_VECTOR_ELT(contents, 390, ScalarInteger(internal->dim_n_II_triage_D));
  SET_VECTOR_ELT(contents, 391, ScalarInteger(internal->dim_n_II_triage_D_1));
  SET_VECTOR_ELT(contents, 392, ScalarInteger(internal->dim_n_II_triage_D_12));
  ...
  SET_VECTOR_ELT(contents, 395, ScalarInteger(internal->dim_n_II_triage_R));
  SET_VECTOR_ELT(contents, 396, ScalarInteger(internal->dim_n_II_triage_R_1));
  SET_VECTOR_ELT(contents, 397, ScalarInteger(internal->dim_n_II_triage_R_12));
  ...
  SET_VECTOR_ELT(contents, 400, ScalarInteger(internal->dim_n_ILI_to_comm_D));
  SET_VECTOR_ELT(contents, 401, ScalarInteger(internal->dim_n_ILI_to_comm_D_1));
  SET_VECTOR_ELT(contents, 402, ScalarInteger(internal->dim_n_ILI_to_comm_D_2));
  SET_VECTOR_ELT(contents, 403, ScalarInteger(internal->dim_n_ILI_to_hosp));
  SET_VECTOR_ELT(contents, 404, ScalarInteger(internal->dim_n_ILI_to_hosp_1));
  SET_VECTOR_ELT(contents, 405, ScalarInteger(internal->dim_n_ILI_to_hosp_2));
  SET_VECTOR_ELT(contents, 406, ScalarInteger(internal->dim_n_ILI_to_hosp_D));
  SET_VECTOR_ELT(contents, 407, ScalarInteger(internal->dim_n_ILI_to_hosp_D_1));
  SET_VECTOR_ELT(contents, 408, ScalarInteger(internal->dim_n_ILI_to_hosp_D_2));
  SET_VECTOR_ELT(contents, 409, ScalarInteger(internal->dim_n_ILI_to_hosp_D_conf));
  SET_VECTOR_ELT(contents, 410, ScalarInteger(internal->dim_n_ILI_to_hosp_D_conf_1));
  SET_VECTOR_ELT(contents, 411, ScalarInteger(internal->dim_n_ILI_to_hosp_D_conf_2));
  SET_VECTOR_ELT(contents, 412, ScalarInteger(internal->dim_n_ILI_to_hosp_R));
  SET_VECTOR_ELT(contents, 413, ScalarInteger(internal->dim_n_ILI_to_hosp_R_1));
  SET_VECTOR_ELT(contents, 414, ScalarInteger(internal->dim_n_ILI_to_hosp_R_2));
  SET_VECTOR_ELT(contents, 415, ScalarInteger(internal->dim_n_ILI_to_hosp_R_conf));
  SET_VECTOR_ELT(contents, 416, ScalarInteger(internal->dim_n_ILI_to_hosp_R_conf_1));
  SET_VECTOR_ELT(contents, 417, ScalarInteger(internal->dim_n_ILI_to_hosp_R_conf_2));
  SET_VECTOR_ELT(contents, 418, ScalarInteger(internal->dim_n_ILI_to_triage));
  SET_VECTOR_ELT(contents, 419, ScalarInteger(internal->dim_n_ILI_to_triage_1));
  SET_VECTOR_ELT(contents, 420, ScalarInteger(internal->dim_n_ILI_to_triage_2));
  SET_VECTOR_ELT(contents, 421, ScalarInteger(internal->dim_n_ILI_to_triage_D));
  SET_VECTOR_ELT(contents, 422, ScalarInteger(internal->dim_n_ILI_to_triage_D_1));
  SET_VECTOR_ELT(contents, 423, ScalarInteger(internal->dim_n_ILI_to_triage_D_2));
  SET_VECTOR_ELT(contents, 424, ScalarInteger(internal->dim_n_ILI_to_triage_R));
  SET_VECTOR_ELT(contents, 425, ScalarInteger(internal->dim_n_ILI_to_triage_R_1));
  SET_VECTOR_ELT(contents, 426, ScalarInteger(internal->dim_n_ILI_to_triage_R_2));
  SET_VECTOR_ELT(contents, 427, ScalarInteger(internal->dim_n_R_pre));
  SET_VECTOR_ELT(contents, 428, ScalarInteger(internal->dim_n_R_pre_1));
  SET_VECTOR_ELT(contents, 429, ScalarInteger(internal->dim_n_R_pre_2));
  SET_VECTOR_ELT(contents, 430, ScalarInteger(internal->dim_n_R_stepdown));
  SET_VECTOR_ELT(contents, 431, ScalarInteger(internal->dim_n_R_stepdown_1));
  SET_VECTOR_ELT(contents, 432, ScalarInteger(internal->dim_n_R_stepdown_2));
  SET_VECTOR_ELT(contents, 433, ScalarInteger(internal->dim_n_SE));
  SET_VECTOR_ELT(contents, 434, ScalarInteger(internal->dim_new_I_hosp_D_conf));
  SET_VECTOR_ELT(contents, 435, ScalarInteger(internal->dim_new_I_hosp_D_conf_1));
  SET_VECTOR_ELT(contents, 436, ScalarInteger(internal->dim_new_I_hosp_D_conf_12));
  SET_VECTOR_ELT(contents, 437, ScalarInteger(internal->dim_new_I_hosp_D_conf_2));
  SET_VECTOR_ELT(contents, 438, ScalarInteger(internal->dim_new_I_hosp_D_conf_3));
  SET_VECTOR_ELT(contents, 439, ScalarInteger(internal->dim_new_I_hosp_D_unconf));
  SET_VECTOR_ELT(contents, 440, ScalarInteger(internal->dim_new_I_hosp_D_unconf_1));
  SET_VECTOR_ELT(contents, 441, ScalarInteger(internal->dim_new_I_hosp_D_unconf_12));
  SET_VECTOR_ELT(contents, 442, ScalarInteger(internal->dim_new_I_hosp_D_unconf_2));
  SET_VECTOR_ELT(contents, 443, ScalarInteger(internal->dim_new_I_hosp_D_unconf_3));
  SET_VECTOR_ELT(contents, 444, ScalarInteger(internal->dim_new_I_hosp_R_conf));
  SET_VECTOR_ELT(contents, 445, ScalarInteger(internal->dim_new_I_hosp_R_conf_1));
  SET_VECTOR_ELT(contents, 446, ScalarInteger(internal->dim_new_I_hosp_R_conf_12));
  SET_VECTOR_ELT(contents, 447, ScalarInteger(internal->dim_new_I_hosp_R_conf_2));
  SET_VECTOR_ELT(contents, 448, ScalarInteger(internal->dim_new_I_hosp_R_conf_3));
  SET_VECTOR_ELT(contents, 449, ScalarInteger(internal->dim_new_I_hosp_R_unconf));
  SET_VECTOR_ELT(contents, 450, ScalarInteger(internal->dim_new_I_hosp_R_unconf_1));
  SET_VECTOR_ELT(contents, 451, ScalarInteger(internal->dim_new_I_hosp_R_unconf_12));
  SET_VECTOR_ELT(contents, 452, ScalarInteger(internal->dim_new_I_hosp_R_unconf_2));
  SET_VECTOR_ELT(contents, 453, ScalarInteger(internal->dim_new_I_hosp_R_unconf_3));
  SET_VECTOR_ELT(contents, 454, ScalarInteger(internal->dim_p_admit_conf));
  SET_VECTOR_ELT(contents, 455, ScalarInteger(internal->dim_p_asympt));
  SET_VECTOR_ELT(contents, 456, ScalarInteger(internal->dim_p_death_comm));
  SET_VECTOR_ELT(contents, 457, ScalarInteger(internal->dim_p_death_hosp_D));
  SET_VECTOR_ELT(contents, 458, ScalarInteger(internal->dim_p_death_ICU));
  SET_VECTOR_ELT(contents, 459, ScalarInteger(internal->dim_p_ICU_hosp));
  SET_VECTOR_ELT(contents, 460, ScalarInteger(internal->dim_p_R_pre));
  SET_VECTOR_ELT(contents, 461, ScalarInteger(internal->dim_p_recov_ILI));
  SET_VECTOR_ELT(contents, 462, ScalarInteger(internal->dim_p_SE));
  SET_VECTOR_ELT(contents, 463, ScalarInteger(internal->dim_p_seroconversion));
  SET_VECTOR_ELT(contents, 464, ScalarInteger(internal->dim_p_sympt_ILI));
  SET_VECTOR_ELT(contents, 465, ScalarInteger(internal->dim_R));
  SET_VECTOR_ELT(contents, 466, ScalarInteger(internal->dim_R_neg));
  SET_VECTOR_ELT(contents, 467, ScalarInteger(internal->dim_R_pos));
  SET_VECTOR_ELT(contents, 468, ScalarInteger(internal->dim_R_pre));
  SET_VECTOR_ELT(contents, 469, ScalarInteger(internal->dim_R_pre_1));
  SET_VECTOR_ELT(contents, 470, ScalarInteger(internal->dim_R_pre_2));
  SET_VECTOR_ELT(contents, 471, ScalarInteger(internal->dim_R_stepdown));
  SET_VECTOR_ELT(contents, 472, ScalarInteger(internal->dim_R_stepdown_1));
  SET_VECTOR_ELT(contents, 473, ScalarInteger(internal->dim_R_stepdown_2));
  SET_VECTOR_ELT(contents, 474, ScalarInteger(internal->dim_R0));
  SET_VECTOR_ELT(contents, 475, ScalarInteger(internal->dim_R0_neg));
  SET_VECTOR_ELT(contents, 476, ScalarInteger(internal->dim_R0_pos));
  SET_VECTOR_ELT(contents, 477, ScalarInteger(internal->dim_R0_pre));
  SET_VECTOR_ELT(contents, 478, ScalarInteger(internal->dim_R0_pre_1));
  SET_VECTOR_ELT(contents, 479, ScalarInteger(internal->dim_R0_pre_2));
  SET_VECTOR_ELT(contents, 480, ScalarInteger(internal->dim_R0_stepdown));
  SET_VECTOR_ELT(contents, 481, ScalarInteger(internal->dim_R0_stepdown_1));
  SET_VECTOR_ELT(contents, 482, ScalarInteger(internal->dim_R0_stepdown_2));
  SET_VECTOR_ELT(contents, 483, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 484, ScalarInteger(internal->dim_s_ij));
  SET_VECTOR_ELT(contents, 485, ScalarInteger(internal->dim_s_ij_1));
  SET_VECTOR_ELT(contents, 486, ScalarInteger(internal->dim_s_ij_2));
  SET_VECTOR_ELT(contents, 487, ScalarInteger(internal->dim_S0));
  SET_VECTOR_ELT(contents, 488, ScalarInteger(internal->dim_trans_increase));
  SET_VECTOR_ELT(contents, 489, ScalarInteger(internal->dim_trans_increase_1));
  SET_VECTOR_ELT(contents, 490, ScalarInteger(internal->dim_trans_increase_2));
  SET_VECTOR_ELT(contents, 491, ScalarInteger(internal->dim_trans_profile));
  SET_VECTOR_ELT(contents, 492, ScalarInteger(internal->dim_trans_profile_1));
  SET_VECTOR_ELT(contents, 493, ScalarInteger(internal->dim_trans_profile_2));
  SET_VECTOR_ELT(contents, 494, ScalarReal(internal->dt));
  SEXP E0 = PROTECT(allocVector(REALSXP, internal->dim_E0));
  memcpy(REAL(E0), internal->E0, internal->dim_E0 * sizeof(double));
  odin_set_dim(E0, 3, internal->dim_E0_1, internal->dim_E0_2, internal->dim_E0_3);
  SET_VECTOR_ELT(contents, 495, E0);
  SET_VECTOR_ELT(contents, 496, ScalarReal(internal->gamma_asympt));
  SET_VECTOR_ELT(contents, 497, ScalarReal(internal->gamma_comm_D));
  SET_VECTOR_ELT(contents, 498, ScalarReal(internal->gamma_E));
  SET_VECTOR_ELT(contents, 499, ScalarReal(internal->gamma_hosp_D));
  SET_VECTOR_ELT(contents, 500, ScalarReal(internal->gamma_hosp_R));
  SET_VECTOR_ELT(contents, 501, ScalarReal(internal->gamma_ICU_D));
  SET_VECTOR_ELT(contents, 502, ScalarReal(internal->gamma_ICU_R));
  SET_VECTOR_ELT(contents, 503, ScalarReal(internal->gamma_ILI));
  SET_VECTOR_ELT(contents, 504, ScalarReal(internal->gamma_mild));
  SET_VECTOR_ELT(contents, 505, ScalarReal(internal->gamma_R_pre));
  SET_VECTOR_ELT(contents, 506, ScalarReal(internal->gamma_stepdown));
  SET_VECTOR_ELT(contents, 507, ScalarReal(internal->gamma_test));
  SET_VECTOR_ELT(contents, 508, ScalarReal(internal->gamma_triage));
  SET_VECTOR_ELT(contents, 509, ScalarReal(internal->hosp_transmission));
  SEXP I_with_diff_trans = PROTECT(allocVector(REALSXP, internal->dim_I_with_diff_trans));
  memcpy(REAL(I_with_diff_trans), internal->I_with_diff_trans, internal->dim_I_with_diff_trans * sizeof(double));
  odin_set_dim(I_with_diff_trans, 2, internal->dim_I_with_diff_trans_1, internal->dim_I_with_diff_trans_2);
  SET_VECTOR_ELT(contents, 510, I_with_diff_trans);
  SEXP I0_asympt = PROTECT(allocVector(REALSXP, internal->dim_I0_asympt));
  memcpy(REAL(I0_asympt), internal->I0_asympt, internal->dim_I0_asympt * sizeof(double));
  odin_set_dim(I0_asympt, 3, internal->dim_I0_asympt_1, internal->dim_I0_asympt_2, internal->dim_I0_asympt_3);
  SET_VECTOR_ELT(contents, 511, I0_asympt);
  SEXP I0_comm_D = PROTECT(allocVector(REALSXP, internal->dim_I0_comm_D));
  memcpy(REAL(I0_comm_D), internal->I0_comm_D, internal->dim_I0_comm_D * sizeof(double));
  odin_set_dim(I0_comm_D, 3, internal->dim_I0_comm_D_1, internal->dim_I0_comm_D_2, internal->dim_I0_comm_D_3);
  SET_VECTOR_ELT(contents, 512, I0_comm_D);
  ...
  SET_VECTOR_ELT(contents, 513, I0_hosp_D_conf);
  ...
  SET_VECTOR_ELT(contents, 514, I0_hosp_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 515, I0_hosp_R_conf);
  ...
  SET_VECTOR_ELT(contents, 516, I0_hosp_R_unconf);
  SEXP I0_ICU_D = PROTECT(allocVector(REALSXP, internal->dim_I0_ICU_D));
  memcpy(REAL(I0_ICU_D), internal->I0_ICU_D, internal->dim_I0_ICU_D * sizeof(double));
  odin_set_dim(I0_ICU_D, 3, internal->dim_I0_ICU_D_1, internal->dim_I0_ICU_D_2, internal->dim_I0_ICU_D_3);
  SET_VECTOR_ELT(contents, 517, I0_ICU_D);
  SEXP I0_ICU_R = PROTECT(allocVector(REALSXP, internal->dim_I0_ICU_R));
  memcpy(REAL(I0_ICU_R), internal->I0_ICU_R, internal->dim_I0_ICU_R * sizeof(double));
  odin_set_dim(I0_ICU_R, 3, internal->dim_I0_ICU_R_1, internal->dim_I0_ICU_R_2, internal->dim_I0_ICU_R_3);
  SET_VECTOR_ELT(contents, 518, I0_ICU_R);
  SEXP I0_ILI = PROTECT(allocVector(REALSXP, internal->dim_I0_ILI));
  memcpy(REAL(I0_ILI), internal->I0_ILI, internal->dim_I0_ILI * sizeof(double));
  odin_set_dim(I0_ILI, 3, internal->dim_I0_ILI_1, internal->dim_I0_ILI_2, internal->dim_I0_ILI_3);
  SET_VECTOR_ELT(contents, 519, I0_ILI);
  SEXP I0_mild = PROTECT(allocVector(REALSXP, internal->dim_I0_mild));
  memcpy(REAL(I0_mild), internal->I0_mild, internal->dim_I0_mild * sizeof(double));
  odin_set_dim(I0_mild, 3, internal->dim_I0_mild_1, internal->dim_I0_mild_2, internal->dim_I0_mild_3);
  SET_VECTOR_ELT(contents, 520, I0_mild);
  SEXP I0_triage_D = PROTECT(allocVector(REALSXP, internal->dim_I0_triage_D));
  memcpy(REAL(I0_triage_D), internal->I0_triage_D, internal->dim_I0_triage_D * sizeof(double));
  odin_set_dim(I0_triage_D, 3, internal->dim_I0_triage_D_1, internal->dim_I0_triage_D_2, internal->dim_I0_triage_D_3);
  SET_VECTOR_ELT(contents, 521, I0_triage_D);
  SEXP I0_triage_R = PROTECT(allocVector(REALSXP, internal->dim_I0_triage_R));
  memcpy(REAL(I0_triage_R), internal->I0_triage_R, internal->dim_I0_triage_R * sizeof(double));
  odin_set_dim(I0_triage_R, 3, internal->dim_I0_triage_R_1, internal->dim_I0_triage_R_2, internal->dim_I0_triage_R_3);
  SET_VECTOR_ELT(contents, 522, I0_triage_R);
  SET_VECTOR_ELT(contents, 523, ScalarReal(internal->ICU_transmission));
  SET_VECTOR_ELT(contents, 524, ScalarReal(internal->initial_cum_admit_conf));
  SET_VECTOR_ELT(contents, 525, ScalarReal(internal->initial_cum_new_conf));
  SEXP initial_D_comm = PROTECT(allocVector(REALSXP, internal->dim_D_comm));
  memcpy(REAL(initial_D_comm), internal->initial_D_comm, internal->dim_D_comm * sizeof(double));
  SET_VECTOR_ELT(contents, 526, initial_D_comm);
  SEXP initial_D_hosp = PROTECT(allocVector(REALSXP, internal->dim_D_hosp));
  memcpy(REAL(initial_D_hosp), internal->initial_D_hosp, internal->dim_D_hosp * sizeof(double));
  SET_VECTOR_ELT(contents, 527, initial_D_hosp);
  SEXP initial_E = PROTECT(allocVector(REALSXP, internal->dim_E));
  memcpy(REAL(initial_E), internal->initial_E, internal->dim_E * sizeof(double));
  odin_set_dim(initial_E, 3, internal->dim_E_1, internal->dim_E_2, internal->dim_E_3);
  SET_VECTOR_ELT(contents, 528, initial_E);
  SEXP initial_I_asympt = PROTECT(allocVector(REALSXP, internal->dim_I_asympt));
  memcpy(REAL(initial_I_asympt), internal->initial_I_asympt, internal->dim_I_asympt * sizeof(double));
  odin_set_dim(initial_I_asympt, 3, internal->dim_I_asympt_1, internal->dim_I_asympt_2, internal->dim_I_asympt_3);
  SET_VECTOR_ELT(contents, 529, initial_I_asympt);
  SEXP initial_I_comm_D = PROTECT(allocVector(REALSXP, internal->dim_I_comm_D));
  memcpy(REAL(initial_I_comm_D), internal->initial_I_comm_D, internal->dim_I_comm_D * sizeof(double));
  odin_set_dim(initial_I_comm_D, 3, internal->dim_I_comm_D_1, internal->dim_I_comm_D_2, internal->dim_I_comm_D_3);
  SET_VECTOR_ELT(contents, 530, initial_I_comm_D);
  ...
  SET_VECTOR_ELT(contents, 531, initial_I_hosp_D_conf);
  ...
  SET_VECTOR_ELT(contents, 532, initial_I_hosp_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 533, initial_I_hosp_R_conf);
  ...
  SET_VECTOR_ELT(contents, 534, initial_I_hosp_R_unconf);
  SEXP initial_I_ICU_D = PROTECT(allocVector(REALSXP, internal->dim_I_ICU_D));
  memcpy(REAL(initial_I_ICU_D), internal->initial_I_ICU_D, internal->dim_I_ICU_D * sizeof(double));
  odin_set_dim(initial_I_ICU_D, 3, internal->dim_I_ICU_D_1, internal->dim_I_ICU_D_2, internal->dim_I_ICU_D_3);
  SET_VECTOR_ELT(contents, 535, initial_I_ICU_D);
  SEXP initial_I_ICU_R = PROTECT(allocVector(REALSXP, internal->dim_I_ICU_R));
  memcpy(REAL(initial_I_ICU_R), internal->initial_I_ICU_R, internal->dim_I_ICU_R * sizeof(double));
  odin_set_dim(initial_I_ICU_R, 3, internal->dim_I_ICU_R_1, internal->dim_I_ICU_R_2, internal->dim_I_ICU_R_3);
  SET_VECTOR_ELT(contents, 536, initial_I_ICU_R);
  SEXP initial_I_ILI = PROTECT(allocVector(REALSXP, internal->dim_I_ILI));
  memcpy(REAL(initial_I_ILI), internal->initial_I_ILI, internal->dim_I_ILI * sizeof(double));
  odin_set_dim(initial_I_ILI, 3, internal->dim_I_ILI_1, internal->dim_I_ILI_2, internal->dim_I_ILI_3);
  SET_VECTOR_ELT(contents, 537, initial_I_ILI);
  SEXP initial_I_mild = PROTECT(allocVector(REALSXP, internal->dim_I_mild));
  memcpy(REAL(initial_I_mild), internal->initial_I_mild, internal->dim_I_mild * sizeof(double));
  odin_set_dim(initial_I_mild, 3, internal->dim_I_mild_1, internal->dim_I_mild_2, internal->dim_I_mild_3);
  SET_VECTOR_ELT(contents, 538, initial_I_mild);
  SEXP initial_I_triage_D = PROTECT(allocVector(REALSXP, internal->dim_I_triage_D));
  memcpy(REAL(initial_I_triage_D), internal->initial_I_triage_D, internal->dim_I_triage_D * sizeof(double));
  odin_set_dim(initial_I_triage_D, 3, internal->dim_I_triage_D_1, internal->dim_I_triage_D_2, internal->dim_I_triage_D_3);
  SET_VECTOR_ELT(contents, 539, initial_I_triage_D);
  SEXP initial_I_triage_R = PROTECT(allocVector(REALSXP, internal->dim_I_triage_R));
  memcpy(REAL(initial_I_triage_R), internal->initial_I_triage_R, internal->dim_I_triage_R * sizeof(double));
  odin_set_dim(initial_I_triage_R, 3, internal->dim_I_triage_R_1, internal->dim_I_triage_R_2, internal->dim_I_triage_R_3);
  SET_VECTOR_ELT(contents, 540, initial_I_triage_R);
  SEXP initial_R = PROTECT(allocVector(REALSXP, internal->dim_R));
  memcpy(REAL(initial_R), internal->initial_R, internal->dim_R * sizeof(double));
  SET_VECTOR_ELT(contents, 541, initial_R);
  SEXP initial_R_neg = PROTECT(allocVector(REALSXP, internal->dim_R_neg));
  memcpy(REAL(initial_R_neg), internal->initial_R_neg, internal->dim_R_neg * sizeof(double));
  SET_VECTOR_ELT(contents, 542, initial_R_neg);
  SEXP initial_R_pos = PROTECT(allocVector(REALSXP, internal->dim_R_pos));
  memcpy(REAL(initial_R_pos), internal->initial_R_pos, internal->dim_R_pos * sizeof(double));
  SET_VECTOR_ELT(contents, 543, initial_R_pos);
  SEXP initial_R_pre = PROTECT(allocVector(REALSXP, internal->dim_R_pre));
  memcpy(REAL(initial_R_pre), internal->initial_R_pre, internal->dim_R_pre * sizeof(double));
  odin_set_dim(initial_R_pre, 2, internal->dim_R_pre_1, internal->dim_R_pre_2);
  SET_VECTOR_ELT(contents, 544, initial_R_pre);
  SEXP initial_R_stepdown = PROTECT(allocVector(REALSXP, internal->dim_R_stepdown));
  memcpy(REAL(initial_R_stepdown), internal->initial_R_stepdown, internal->dim_R_stepdown * sizeof(double));
  odin_set_dim(initial_R_stepdown, 2, internal->dim_R_stepdown_1, internal->dim_R_stepdown_2);
  SET_VECTOR_ELT(contents, 545, initial_R_stepdown);
  SEXP initial_S = PROTECT(allocVector(REALSXP, internal->dim_S));
  memcpy(REAL(initial_S), internal->initial_S, internal->dim_S * sizeof(double));
  SET_VECTOR_ELT(contents, 546, initial_S);
  SEXP lambda = PROTECT(allocVector(REALSXP, internal->dim_lambda));
  memcpy(REAL(lambda), internal->lambda, internal->dim_lambda * sizeof(double));
  SET_VECTOR_ELT(contents, 548, lambda);
  SEXP m = PROTECT(allocVector(REALSXP, internal->dim_m));
  memcpy(REAL(m), internal->m, internal->dim_m * sizeof(double));
  odin_set_dim(m, 2, internal->dim_m_1, internal->dim_m_2);
  SET_VECTOR_ELT(contents, 549, m);
  SET_VECTOR_ELT(contents, 550, ScalarInteger(internal->N_age));
  SEXP n_com_to_R_pre = PROTECT(allocVector(REALSXP, internal->dim_n_com_to_R_pre));
  memcpy(REAL(n_com_to_R_pre), internal->n_com_to_R_pre, internal->dim_n_com_to_R_pre * sizeof(double));
  SET_VECTOR_ELT(contents, 551, n_com_to_R_pre);
  SEXP n_com_to_R_total = PROTECT(allocVector(REALSXP, internal->dim_n_com_to_R_total));
  memcpy(REAL(n_com_to_R_total), internal->n_com_to_R_total, internal->dim_n_com_to_R_total * sizeof(double));
  SET_VECTOR_ELT(contents, 552, n_com_to_R_total);
  SEXP n_EE = PROTECT(allocVector(REALSXP, internal->dim_n_EE));
  memcpy(REAL(n_EE), internal->n_EE, internal->dim_n_EE * sizeof(double));
  odin_set_dim(n_EE, 3, internal->dim_n_EE_1, internal->dim_n_EE_2, internal->dim_n_EE_3);
  SET_VECTOR_ELT(contents, 553, n_EE);
  SEXP n_EI_asympt = PROTECT(allocVector(REALSXP, internal->dim_n_EI_asympt));
  memcpy(REAL(n_EI_asympt), internal->n_EI_asympt, internal->dim_n_EI_asympt * sizeof(double));
  odin_set_dim(n_EI_asympt, 2, internal->dim_n_EI_asympt_1, internal->dim_n_EI_asympt_2);
  SET_VECTOR_ELT(contents, 554, n_EI_asympt);
  SEXP n_EI_ILI = PROTECT(allocVector(REALSXP, internal->dim_n_EI_ILI));
  memcpy(REAL(n_EI_ILI), internal->n_EI_ILI, internal->dim_n_EI_ILI * sizeof(double));
  odin_set_dim(n_EI_ILI, 2, internal->dim_n_EI_ILI_1, internal->dim_n_EI_ILI_2);
  SET_VECTOR_ELT(contents, 555, n_EI_ILI);
  SEXP n_EI_mild = PROTECT(allocVector(REALSXP, internal->dim_n_EI_mild));
  memcpy(REAL(n_EI_mild), internal->n_EI_mild, internal->dim_n_EI_mild * sizeof(double));
  odin_set_dim(n_EI_mild, 2, internal->dim_n_EI_mild_1, internal->dim_n_EI_mild_2);
  SET_VECTOR_ELT(contents, 556, n_EI_mild);
  SEXP n_hosp_non_ICU = PROTECT(allocVector(REALSXP, internal->dim_n_hosp_non_ICU));
  memcpy(REAL(n_hosp_non_ICU), internal->n_hosp_non_ICU, internal->dim_n_hosp_non_ICU * sizeof(double));
  odin_set_dim(n_hosp_non_ICU, 2, internal->dim_n_hosp_non_ICU_1, internal->dim_n_hosp_non_ICU_2);
  SET_VECTOR_ELT(contents, 557, n_hosp_non_ICU);
  ...
  SET_VECTOR_ELT(contents, 558, n_I_hosp_D_unconf_to_conf);
  ...
  SET_VECTOR_ELT(contents, 559, n_I_hosp_R_unconf_to_conf);
  SEXP n_ICU_to_R_stepdown = PROTECT(allocVector(REALSXP, internal->dim_n_ICU_to_R_stepdown));
  memcpy(REAL(n_ICU_to_R_stepdown), internal->n_ICU_to_R_stepdown, internal->dim_n_ICU_to_R_stepdown * sizeof(double));
  SET_VECTOR_ELT(contents, 560, n_ICU_to_R_stepdown);
  SEXP n_II_asympt = PROTECT(allocVector(REALSXP, internal->dim_n_II_asympt));
  memcpy(REAL(n_II_asympt), internal->n_II_asympt, internal->dim_n_II_asympt * sizeof(double));
  odin_set_dim(n_II_asympt, 3, internal->dim_n_II_asympt_1, internal->dim_n_II_asympt_2, internal->dim_n_II_asympt_3);
  SET_VECTOR_ELT(contents, 561, n_II_asympt);
  SEXP n_II_comm_D = PROTECT(allocVector(REALSXP, internal->dim_n_II_comm_D));
  memcpy(REAL(n_II_comm_D), internal->n_II_comm_D, internal->dim_n_II_comm_D * sizeof(double));
  odin_set_dim(n_II_comm_D, 3, internal->dim_n_II_comm_D_1, internal->dim_n_II_comm_D_2, internal->dim_n_II_comm_D_3);
  SET_VECTOR_ELT(contents, 562, n_II_comm_D);
  ...
  SET_VECTOR_ELT(contents, 563, n_II_hosp_D_conf);
  ...
  SET_VECTOR_ELT(contents, 564, n_II_hosp_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 565, n_II_hosp_R_conf);
  ...
  SET_VECTOR_ELT(contents, 566, n_II_hosp_R_unconf);
  SEXP n_II_ICU_D = PROTECT(allocVector(REALSXP, internal->dim_n_II_ICU_D));
  memcpy(REAL(n_II_ICU_D), internal->n_II_ICU_D, internal->dim_n_II_ICU_D * sizeof(double));
  odin_set_dim(n_II_ICU_D, 3, internal->dim_n_II_ICU_D_1, internal->dim_n_II_ICU_D_2, internal->dim_n_II_ICU_D_3);
  SET_VECTOR_ELT(contents, 567, n_II_ICU_D);
  SEXP n_II_ICU_R = PROTECT(allocVector(REALSXP, internal->dim_n_II_ICU_R));
  memcpy(REAL(n_II_ICU_R), internal->n_II_ICU_R, internal->dim_n_II_ICU_R * sizeof(double));
  odin_set_dim(n_II_ICU_R, 3, internal->dim_n_II_ICU_R_1, internal->dim_n_II_ICU_R_2, internal->dim_n_II_ICU_R_3);
  SET_VECTOR_ELT(contents, 568, n_II_ICU_R);
  SEXP n_II_ILI = PROTECT(allocVector(REALSXP, internal->dim_n_II_ILI));
  memcpy(REAL(n_II_ILI), internal->n_II_ILI, internal->dim_n_II_ILI * sizeof(double));
  odin_set_dim(n_II_ILI, 3, internal->dim_n_II_ILI_1, internal->dim_n_II_ILI_2, internal->dim_n_II_ILI_3);
  SET_VECTOR_ELT(contents, 569, n_II_ILI);
  SEXP n_II_mild = PROTECT(allocVector(REALSXP, internal->dim_n_II_mild));
  memcpy(REAL(n_II_mild), internal->n_II_mild, internal->dim_n_II_mild * sizeof(double));
  odin_set_dim(n_II_mild, 3, internal->dim_n_II_mild_1, internal->dim_n_II_mild_2, internal->dim_n_II_mild_3);
  SET_VECTOR_ELT(contents, 570, n_II_mild);
  SEXP n_II_triage_D = PROTECT(allocVector(REALSXP, internal->dim_n_II_triage_D));
  memcpy(REAL(n_II_triage_D), internal->n_II_triage_D, internal->dim_n_II_triage_D * sizeof(double));
  odin_set_dim(n_II_triage_D, 3, internal->dim_n_II_triage_D_1, internal->dim_n_II_triage_D_2, internal->dim_n_II_triage_D_3);
  SET_VECTOR_ELT(contents, 571, n_II_triage_D);
  SEXP n_II_triage_R = PROTECT(allocVector(REALSXP, internal->dim_n_II_triage_R));
  memcpy(REAL(n_II_triage_R), internal->n_II_triage_R, internal->dim_n_II_triage_R * sizeof(double));
  odin_set_dim(n_II_triage_R, 3, internal->dim_n_II_triage_R_1, internal->dim_n_II_triage_R_2, internal->dim_n_II_triage_R_3);
  SET_VECTOR_ELT(contents, 572, n_II_triage_R);
  SEXP n_ILI_to_comm_D = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_comm_D));
  memcpy(REAL(n_ILI_to_comm_D), internal->n_ILI_to_comm_D, internal->dim_n_ILI_to_comm_D * sizeof(double));
  odin_set_dim(n_ILI_to_comm_D, 2, internal->dim_n_ILI_to_comm_D_1, internal->dim_n_ILI_to_comm_D_2);
  SET_VECTOR_ELT(contents, 573, n_ILI_to_comm_D);
  SEXP n_ILI_to_hosp = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_hosp));
  memcpy(REAL(n_ILI_to_hosp), internal->n_ILI_to_hosp, internal->dim_n_ILI_to_hosp * sizeof(double));
  odin_set_dim(n_ILI_to_hosp, 2, internal->dim_n_ILI_to_hosp_1, internal->dim_n_ILI_to_hosp_2);
  SET_VECTOR_ELT(contents, 574, n_ILI_to_hosp);
  SEXP n_ILI_to_hosp_D = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_hosp_D));
  memcpy(REAL(n_ILI_to_hosp_D), internal->n_ILI_to_hosp_D, internal->dim_n_ILI_to_hosp_D * sizeof(double));
  odin_set_dim(n_ILI_to_hosp_D, 2, internal->dim_n_ILI_to_hosp_D_1, internal->dim_n_ILI_to_hosp_D_2);
  SET_VECTOR_ELT(contents, 575, n_ILI_to_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 576, n_ILI_to_hosp_D_conf);
  SEXP n_ILI_to_hosp_R = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_hosp_R));
  memcpy(REAL(n_ILI_to_hosp_R), internal->n_ILI_to_hosp_R, internal->dim_n_ILI_to_hosp_R * sizeof(double));
  odin_set_dim(n_ILI_to_hosp_R, 2, internal->dim_n_ILI_to_hosp_R_1, internal->dim_n_ILI_to_hosp_R_2);
  SET_VECTOR_ELT(contents, 577, n_ILI_to_hosp_R);
  ...
  SET_VECTOR_ELT(contents, 578, n_ILI_to_hosp_R_conf);
  SEXP n_ILI_to_triage = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_triage));
  memcpy(REAL(n_ILI_to_triage), internal->n_ILI_to_triage, internal->dim_n_ILI_to_triage * sizeof(double));
  odin_set_dim(n_ILI_to_triage, 2, internal->dim_n_ILI_to_triage_1, internal->dim_n_ILI_to_triage_2);
  SET_VECTOR_ELT(contents, 579, n_ILI_to_triage);
  SEXP n_ILI_to_triage_D = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_triage_D));
  memcpy(REAL(n_ILI_to_triage_D), internal->n_ILI_to_triage_D, internal->dim_n_ILI_to_triage_D * sizeof(double));
  odin_set_dim(n_ILI_to_triage_D, 2, internal->dim_n_ILI_to_triage_D_1, internal->dim_n_ILI_to_triage_D_2);
  SET_VECTOR_ELT(contents, 580, n_ILI_to_triage_D);
  SEXP n_ILI_to_triage_R = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_triage_R));
  memcpy(REAL(n_ILI_to_triage_R), internal->n_ILI_to_triage_R, internal->dim_n_ILI_to_triage_R * sizeof(double));
  odin_set_dim(n_ILI_to_triage_R, 2, internal->dim_n_ILI_to_triage_R_1, internal->dim_n_ILI_to_triage_R_2);
  SET_VECTOR_ELT(contents, 581, n_ILI_to_triage_R);
  SEXP n_R_pre = PROTECT(allocVector(REALSXP, internal->dim_n_R_pre));
  memcpy(REAL(n_R_pre), internal->n_R_pre, internal->dim_n_R_pre * sizeof(double));
  odin_set_dim(n_R_pre, 2, internal->dim_n_R_pre_1, internal->dim_n_R_pre_2);
  SET_VECTOR_ELT(contents, 582, n_R_pre);
  SEXP n_R_stepdown = PROTECT(allocVector(REALSXP, internal->dim_n_R_stepdown));
  memcpy(REAL(n_R_stepdown), internal->n_R_stepdown, internal->dim_n_R_stepdown * sizeof(double));
  odin_set_dim(n_R_stepdown, 2, internal->dim_n_R_stepdown_1, internal->dim_n_R_stepdown_2);
  SET_VECTOR_ELT(contents, 583, n_R_stepdown);
  SEXP n_SE = PROTECT(allocVector(REALSXP, internal->dim_n_SE));
  memcpy(REAL(n_SE), internal->n_SE, internal->dim_n_SE * sizeof(double));
  SET_VECTOR_ELT(contents, 584, n_SE);
  ...
  SET_VECTOR_ELT(contents, 585, new_I_hosp_D_conf);
  ...
  SET_VECTOR_ELT(contents, 586, new_I_hosp_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 587, new_I_hosp_R_conf);
  ...
  SET_VECTOR_ELT(contents, 588, new_I_hosp_R_unconf);
  SET_VECTOR_ELT(contents, 589, ScalarInteger(internal->offset_variable_D_comm));
  SET_VECTOR_ELT(contents, 590, ScalarInteger(internal->offset_variable_D_hosp));
  SET_VECTOR_ELT(contents, 591, ScalarInteger(internal->offset_variable_E));
  SET_VECTOR_ELT(contents, 592, ScalarInteger(internal->offset_variable_I_asympt));
  SET_VECTOR_ELT(contents, 593, ScalarInteger(internal->offset_variable_I_comm_D));
  SET_VECTOR_ELT(contents, 594, ScalarInteger(internal->offset_variable_I_hosp_D_conf));
  SET_VECTOR_ELT(contents, 595, ScalarInteger(internal->offset_variable_I_hosp_D_unconf));
  SET_VECTOR_ELT(contents, 596, ScalarInteger(internal->offset_variable_I_hosp_R_conf));
  SET_VECTOR_ELT(contents, 597, ScalarInteger(internal->offset_variable_I_hosp_R_unconf));
  SET_VECTOR_ELT(contents, 598, ScalarInteger(internal->offset_variable_I_ICU_D));
  SET_VECTOR_ELT(contents, 599, ScalarInteger(internal->offset_variable_I_ICU_R));
  SET_VECTOR_ELT(contents, 600, ScalarInteger(internal->offset_variable_I_ILI));
  SET_VECTOR_ELT(contents, 601, ScalarInteger(internal->offset_variable_I_mild));
  SET_VECTOR_ELT(contents, 602, ScalarInteger(internal->offset_variable_I_triage_D));
  SET_VECTOR_ELT(contents, 603, ScalarInteger(internal->offset_variable_I_triage_R));
  SET_VECTOR_ELT(contents, 604, ScalarInteger(internal->offset_variable_R));
  SET_VECTOR_ELT(contents, 605, ScalarInteger(internal->offset_variable_R_neg));
  SET_VECTOR_ELT(contents, 606, ScalarInteger(internal->offset_variable_R_pos));
  SET_VECTOR_ELT(contents, 607, ScalarInteger(internal->offset_variable_R_pre));
  SET_VECTOR_ELT(contents, 608, ScalarInteger(internal->offset_variable_R_stepdown));
  ...
  SET_VECTOR_ELT(contents, 609, p_admit_conf);
  SEXP p_asympt = PROTECT(allocVector(REALSXP, internal->dim_p_asympt));
  memcpy(REAL(p_asympt), internal->p_asympt, internal->dim_p_asympt * sizeof(double));
  SET_VECTOR_ELT(contents, 610, p_asympt);
  SEXP p_death_comm = PROTECT(allocVector(REALSXP, internal->dim_p_death_comm));
  memcpy(REAL(p_death_comm), internal->p_death_comm, internal->dim_p_death_comm * sizeof(double));
  SET_VECTOR_ELT(contents, 611, p_death_comm);
  SEXP p_death_hosp_D = PROTECT(allocVector(REALSXP, internal->dim_p_death_hosp_D));
  memcpy(REAL(p_death_hosp_D), internal->p_death_hosp_D, internal->dim_p_death_hosp_D * sizeof(double));
  SET_VECTOR_ELT(contents, 612, p_death_hosp_D);
  SEXP p_death_ICU = PROTECT(allocVector(REALSXP, internal->dim_p_death_ICU));
  memcpy(REAL(p_death_ICU), internal->p_death_ICU, internal->dim_p_death_ICU * sizeof(double));
  SET_VECTOR_ELT(contents, 613, p_death_ICU);
  SET_VECTOR_ELT(contents, 614, ScalarReal(internal->p_EE));
  SEXP p_ICU_hosp = PROTECT(allocVector(REALSXP, internal->dim_p_ICU_hosp));
  memcpy(REAL(p_ICU_hosp), internal->p_ICU_hosp, internal->dim_p_ICU_hosp * sizeof(double));
  SET_VECTOR_ELT(contents, 615, p_ICU_hosp);
  SET_VECTOR_ELT(contents, 616, ScalarReal(internal->p_II_asympt));
  SET_VECTOR_ELT(contents, 617, ScalarReal(internal->p_II_comm_D));
  SET_VECTOR_ELT(contents, 618, ScalarReal(internal->p_II_hosp_D));
  SET_VECTOR_ELT(contents, 619, ScalarReal(internal->p_II_hosp_R));
  SET_VECTOR_ELT(contents, 620, ScalarReal(internal->p_II_ICU_D));
  SET_VECTOR_ELT(contents, 621, ScalarReal(internal->p_II_ICU_R));
  SET_VECTOR_ELT(contents, 622, ScalarReal(internal->p_II_ILI));
  SET_VECTOR_ELT(contents, 623, ScalarReal(internal->p_II_mild));
  SET_VECTOR_ELT(contents, 624, ScalarReal(internal->p_II_triage));
  SEXP p_R_pre = PROTECT(allocVector(REALSXP, internal->dim_p_R_pre));
  memcpy(REAL(p_R_pre), internal->p_R_pre, internal->dim_p_R_pre * sizeof(double));
  SET_VECTOR_ELT(contents, 625, p_R_pre);
  SET_VECTOR_ELT(contents, 626, ScalarReal(internal->p_R_stepdown));
  SEXP p_recov_ILI = PROTECT(allocVector(REALSXP, internal->dim_p_recov_ILI));
  memcpy(REAL(p_recov_ILI), internal->p_recov_ILI, internal->dim_p_recov_ILI * sizeof(double));
  SET_VECTOR_ELT(contents, 627, p_recov_ILI);
  SEXP p_SE = PROTECT(allocVector(REALSXP, internal->dim_p_SE));
  memcpy(REAL(p_SE), internal->p_SE, internal->dim_p_SE * sizeof(double));
  SET_VECTOR_ELT(contents, 628, p_SE);
  SEXP p_seroconversion = PROTECT(allocVector(REALSXP, internal->dim_p_seroconversion));
  memcpy(REAL(p_seroconversion), internal->p_seroconversion, internal->dim_p_seroconversion * sizeof(double));
  SET_VECTOR_ELT(contents, 629, p_seroconversion);
  SEXP p_sympt_ILI = PROTECT(allocVector(REALSXP, internal->dim_p_sympt_ILI));
  memcpy(REAL(p_sympt_ILI), internal->p_sympt_ILI, internal->dim_p_sympt_ILI * sizeof(double));
  SET_VECTOR_ELT(contents, 630, p_sympt_ILI);
  SET_VECTOR_ELT(contents, 631, ScalarReal(internal->p_test));
  SEXP R0 = PROTECT(allocVector(REALSXP, internal->dim_R0));
  memcpy(REAL(R0), internal->R0, internal->dim_R0 * sizeof(double));
  SET_VECTOR_ELT(contents, 632, R0);
  SEXP R0_neg = PROTECT(allocVector(REALSXP, internal->dim_R0_neg));
  memcpy(REAL(R0_neg), internal->R0_neg, internal->dim_R0_neg * sizeof(double));
  SET_VECTOR_ELT(contents, 633, R0_neg);
  SEXP R0_pos = PROTECT(allocVector(REALSXP, internal->dim_R0_pos));
  memcpy(REAL(R0_pos), internal->R0_pos, internal->dim_R0_pos * sizeof(double));
  SET_VECTOR_ELT(contents, 634, R0_pos);
  SEXP R0_pre = PROTECT(allocVector(REALSXP, internal->dim_R0_pre));
  memcpy(REAL(R0_pre), internal->R0_pre, internal->dim_R0_pre * sizeof(double));
  odin_set_dim(R0_pre, 2, internal->dim_R0_pre_1, internal->dim_R0_pre_2);
  SET_VECTOR_ELT(contents, 635, R0_pre);
  SEXP R0_stepdown = PROTECT(allocVector(REALSXP, internal->dim_R0_stepdown));
  memcpy(REAL(R0_stepdown), internal->R0_stepdown, internal->dim_R0_stepdown * sizeof(double));
  odin_set_dim(R0_stepdown, 2, internal->dim_R0_stepdown_1, internal->dim_R0_stepdown_2);
  SET_VECTOR_ELT(contents, 636, R0_stepdown);
  SET_VECTOR_ELT(contents, 637, ScalarInteger(internal->s_asympt));
  SET_VECTOR_ELT(contents, 638, ScalarInteger(internal->s_comm_D));
  SET_VECTOR_ELT(contents, 639, ScalarInteger(internal->s_E));
  SET_VECTOR_ELT(contents, 640, ScalarInteger(internal->s_hosp_D));
  SET_VECTOR_ELT(contents, 641, ScalarInteger(internal->s_hosp_R));
  SET_VECTOR_ELT(contents, 642, ScalarInteger(internal->s_ICU_D));
  SET_VECTOR_ELT(contents, 643, ScalarInteger(internal->s_ICU_R));
  SEXP s_ij = PROTECT(allocVector(REALSXP, internal->dim_s_ij));
  memcpy(REAL(s_ij), internal->s_ij, internal->dim_s_ij * sizeof(double));
  odin_set_dim(s_ij, 2, internal->dim_s_ij_1, internal->dim_s_ij_2);
  SET_VECTOR_ELT(contents, 644, s_ij);
  SET_VECTOR_ELT(contents, 645, ScalarInteger(internal->s_ILI));
  SET_VECTOR_ELT(contents, 646, ScalarInteger(internal->s_mild));
  SET_VECTOR_ELT(contents, 647, ScalarInteger(internal->s_R_pre));
  SET_VECTOR_ELT(contents, 648, ScalarInteger(internal->s_stepdown));
  SET_VECTOR_ELT(contents, 649, ScalarInteger(internal->s_triage));
  SEXP S0 = PROTECT(allocVector(REALSXP, internal->dim_S0));
  memcpy(REAL(S0), internal->S0, internal->dim_S0 * sizeof(double));
  SET_VECTOR_ELT(contents, 650, S0);
  SET_VECTOR_ELT(contents, 651, ScalarInteger(internal->trans_classes));
  SEXP trans_increase = PROTECT(allocVector(REALSXP, internal->dim_trans_increase));
  memcpy(REAL(trans_increase), internal->trans_increase, internal->dim_trans_increase * sizeof(double));
  odin_set_dim(trans_increase, 2, internal->dim_trans_increase_1, internal->dim_trans_increase_2);
  SET_VECTOR_ELT(contents, 652, trans_increase);
  SEXP trans_profile = PROTECT(allocVector(REALSXP, internal->dim_trans_profile));
  memcpy(REAL(trans_profile), internal->trans_profile, internal->dim_trans_profile * sizeof(double));
  odin_set_dim(trans_profile, 2, internal->dim_trans_profile_1, internal->dim_trans_profile_2);
  SET_VECTOR_ELT(contents, 653, trans_profile);
  ...
  SET_STRING_ELT(nms, 100, mkChar("dim_aux_II_triage_R_2"));
  SET_STRING_ELT(nms, 101, mkChar("dim_aux_II_triage_R_3"));
  SET_STRING_ELT(nms, 102, mkChar("dim_aux_p_bin"));
  SET_STRING_ELT(nms, 103, mkChar("dim_aux_p_bin_1"));
  SET_STRING_ELT(nms, 104, mkChar("dim_aux_p_bin_2"));
  SET_STRING_ELT(nms, 105, mkChar("dim_aux_R_pre"));
  SET_STRING_ELT(nms, 106, mkChar("dim_aux_R_pre_1"));
  SET_STRING_ELT(nms, 107, mkChar("dim_aux_R_pre_2"));
  SET_STRING_ELT(nms, 108, mkChar("dim_aux_R_stepdown"));
  SET_STRING_ELT(nms, 109, mkChar("dim_aux_R_stepdown_1"));
  SET_STRING_ELT(nms, 110, mkChar("dim_aux_R_stepdown_2"));
  SET_STRING_ELT(nms, 111, mkChar("dim_beta_t"));
  SET_STRING_ELT(nms, 112, mkChar("dim_beta_y"));
  SET_STRING_ELT(nms, 113, mkChar("dim_D_comm"));
  SET_STRING_ELT(nms, 114, mkChar("dim_D_hosp"));
  SET_STRING_ELT(nms, 115, mkChar("dim_D0_comm"));
  SET_STRING_ELT(nms, 116, mkChar("dim_D0_hosp"));
  SET_STRING_ELT(nms, 117, mkChar("dim_delta_D_comm"));
  SET_STRING_ELT(nms, 118, mkChar("dim_delta_D_hosp"));
  SET_STRING_ELT(nms, 119, mkChar("dim_delta_E"));
  SET_STRING_ELT(nms, 120, mkChar("dim_delta_E_1"));
  SET_STRING_ELT(nms, 121, mkChar("dim_delta_E_12"));
  SET_STRING_ELT(nms, 122, mkChar("dim_delta_E_2"));
  SET_STRING_ELT(nms, 123, mkChar("dim_delta_E_3"));
  SET_STRING_ELT(nms, 124, mkChar("dim_delta_I_asympt"));
  SET_STRING_ELT(nms, 125, mkChar("dim_delta_I_asympt_1"));
  SET_STRING_ELT(nms, 126, mkChar("dim_delta_I_asympt_12"));
  SET_STRING_ELT(nms, 127, mkChar("dim_delta_I_asympt_2"));
  SET_STRING_ELT(nms, 128, mkChar("dim_delta_I_asympt_3"));
  SET_STRING_ELT(nms, 129, mkChar("dim_delta_I_comm_D"));
  SET_STRING_ELT(nms, 130, mkChar("dim_delta_I_comm_D_1"));
  SET_STRING_ELT(nms, 131, mkChar("dim_delta_I_comm_D_12"));
  SET_STRING_ELT(nms, 132, mkChar("dim_delta_I_comm_D_2"));
  SET_STRING_ELT(nms, 133, mkChar("dim_delta_I_comm_D_3"));
  SET_STRING_ELT(nms, 134, mkChar("dim_delta_I_ICU_D"));
  SET_STRING_ELT(nms, 135, mkChar("dim_delta_I_ICU_D_1"));
  SET_STRING_ELT(nms, 136, mkChar("dim_delta_I_ICU_D_12"));
  SET_STRING_ELT(nms, 137, mkChar("dim_delta_I_ICU_D_2"));
  SET_STRING_ELT(nms, 138, mkChar("dim_delta_I_ICU_D_3"));
  SET_STRING_ELT(nms, 139, mkChar("dim_delta_I_ICU_R"));
  SET_STRING_ELT(nms, 140, mkChar("dim_delta_I_ICU_R_1"));
  SET_STRING_ELT(nms, 141, mkChar("dim_delta_I_ICU_R_12"));
  SET_STRING_ELT(nms, 142, mkChar("dim_delta_I_ICU_R_2"));
  SET_STRING_ELT(nms, 143, mkChar("dim_delta_I_ICU_R_3"));
  SET_STRING_ELT(nms, 144, mkChar("dim_delta_I_ILI"));
  SET_STRING_ELT(nms, 145, mkChar("dim_delta_I_ILI_1"));
  SET_STRING_ELT(nms, 146, mkChar("dim_delta_I_ILI_12"));
  SET_STRING_ELT(nms, 147, mkChar("dim_delta_I_ILI_2"));
  SET_STRING_ELT(nms, 148, mkChar("dim_delta_I_ILI_3"));
  SET_STRING_ELT(nms, 149, mkChar("dim_delta_I_mild"));
  SET_STRING_ELT(nms, 150, mkChar("dim_delta_I_mild_1"));
  SET_STRING_ELT(nms, 151, mkChar("dim_delta_I_mild_12"));
  SET_STRING_ELT(nms, 152, mkChar("dim_delta_I_mild_2"));
  SET_STRING_ELT(nms, 153, mkChar("dim_delta_I_mild_3"));
  SET_STRING_ELT(nms, 154, mkChar("dim_delta_I_triage_D"));
  SET_STRING_ELT(nms, 155, mkChar("dim_delta_I_triage_D_1"));
  SET_STRING_ELT(nms, 156, mkChar("dim_delta_I_triage_D_12"));
  SET_STRING_ELT(nms, 157, mkChar("dim_delta_I_triage_D_2"));
  SET_STRING_ELT(nms, 158, mkChar("dim_delta_I_triage_D_3"));
  SET_STRING_ELT(nms, 159, mkChar("dim_delta_I_triage_R"));
  SET_STRING_ELT(nms, 160, mkChar("dim_delta_I_triage_R_1"));
  SET_STRING_ELT(nms, 161, mkChar("dim_delta_I_triage_R_12"));
  SET_STRING_ELT(nms, 162, mkChar("dim_delta_I_triage_R_2"));
  SET_STRING_ELT(nms, 163, mkChar("dim_delta_I_triage_R_3"));
  ...
  SET_STRING_ELT(nms, 238, mkChar("dim_I_triage_R"));
  SET_STRING_ELT(nms, 239, mkChar("dim_I_triage_R_1"));
  SET_STRING_ELT(nms, 240, mkChar("dim_I_triage_R_12"));
  SET_STRING_ELT(nms, 241, mkChar("dim_I_triage_R_2"));
  SET_STRING_ELT(nms, 242, mkChar("dim_I_triage_R_3"));
  SET_STRING_ELT(nms, 243, mkChar("dim_I_with_diff_trans"));
  SET_STRING_ELT(nms, 244, mkChar("dim_I_with_diff_trans_1"));
  SET_STRING_ELT(nms, 245, mkChar("dim_I_with_diff_trans_2"));
  SET_STRING_ELT(nms, 246, mkChar("dim_I0_asympt"));
  SET_STRING_ELT(nms, 247, mkChar("dim_I0_asympt_1"));
  SET_STRING_ELT(nms, 248, mkChar("dim_I0_asympt_12"));
  SET_STRING_ELT(nms, 249, mkChar("dim_I0_asympt_2"));
  SET_STRING_ELT(nms, 250, mkChar("dim_I0_asympt_3"));
  SET_STRING_ELT(nms, 251, mkChar("dim_I0_comm_D"));
  SET_STRING_ELT(nms, 252, mkChar("dim_I0_comm_D_1"));
  SET_STRING_ELT(nms, 253, mkChar("dim_I0_comm_D_12"));
  SET_STRING_ELT(nms, 254, mkChar("dim_I0_comm_D_2"));
  SET_STRING_ELT(nms, 255, mkChar("dim_I0_comm_D_3"));
  SET_STRING_ELT(nms, 256, mkChar("dim_I0_hosp_D_conf"));
  SET_STRING_ELT(nms, 257, mkChar("dim_I0_hosp_D_conf_1"));
  SET_STRING_ELT(nms, 258, mkChar("dim_I0_hosp_D_conf_12"));
  SET_STRING_ELT(nms, 259, mkChar("dim_I0_hosp_D_conf_2"));
  SET_STRING_ELT(nms, 260, mkChar("dim_I0_hosp_D_conf_3"));
  SET_STRING_ELT(nms, 261, mkChar("dim_I0_hosp_D_unconf"));
  SET_STRING_ELT(nms, 262, mkChar("dim_I0_hosp_D_unconf_1"));
  SET_STRING_ELT(nms, 263, mkChar("dim_I0_hosp_D_unconf_12"));
  SET_STRING_ELT(nms, 264, mkChar("dim_I0_hosp_D_unconf_2"));
  SET_STRING_ELT(nms, 265, mkChar("dim_I0_hosp_D_unconf_3"));
  SET_STRING_ELT(nms, 266, mkChar("dim_I0_hosp_R_conf"));
  SET_STRING_ELT(nms, 267, mkChar("dim_I0_hosp_R_conf_1"));
  SET_STRING_ELT(nms, 268, mkChar("dim_I0_hosp_R_conf_12"));
  SET_STRING_ELT(nms, 269, mkChar("dim_I0_hosp_R_conf_2"));
  SET_STRING_ELT(nms, 270, mkChar("dim_I0_hosp_R_conf_3"));
  SET_STRING_ELT(nms, 271, mkChar("dim_I0_hosp_R_unconf"));
  SET_STRING_ELT(nms, 272, mkChar("dim_I0_hosp_R_unconf_1"));
  SET_STRING_ELT(nms, 273, mkChar("dim_I0_hosp_R_unconf_12"));
  SET_STRING_ELT(nms, 274, mkChar("dim_I0_hosp_R_unconf_2"));
  SET_STRING_ELT(nms, 275, mkChar("dim_I0_hosp_R_unconf_3"));
  SET_STRING_ELT(nms, 276, mkChar("dim_I0_ICU_D"));
  SET_STRING_ELT(nms, 277, mkChar("dim_I0_ICU_D_1"));
  SET_STRING_ELT(nms, 278, mkChar("dim_I0_ICU_D_12"));
  SET_STRING_ELT(nms, 279, mkChar("dim_I0_ICU_D_2"));
  SET_STRING_ELT(nms, 280, mkChar("dim_I0_ICU_D_3"));
  SET_STRING_ELT(nms, 281, mkChar("dim_I0_ICU_R"));
  SET_STRING_ELT(nms, 282, mkChar("dim_I0_ICU_R_1"));
  SET_STRING_ELT(nms, 283, mkChar("dim_I0_ICU_R_12"));
  SET_STRING_ELT(nms, 284, mkChar("dim_I0_ICU_R_2"));
  SET_STRING_ELT(nms, 285, mkChar("dim_I0_ICU_R_3"));
  SET_STRING_ELT(nms, 286, mkChar("dim_I0_ILI"));
  SET_STRING_ELT(nms, 287, mkChar("dim_I0_ILI_1"));
  SET_STRING_ELT(nms, 288, mkChar("dim_I0_ILI_12"));
  SET_STRING_ELT(nms, 289, mkChar("dim_I0_ILI_2"));
  SET_STRING_ELT(nms, 290, mkChar("dim_I0_ILI_3"));
  SET_STRING_ELT(nms, 291, mkChar("dim_I0_mild"));
  SET_STRING_ELT(nms, 292, mkChar("dim_I0_mild_1"));
  SET_STRING_ELT(nms, 293, mkChar("dim_I0_mild_12"));
  SET_STRING_ELT(nms, 294, mkChar("dim_I0_mild_2"));
  SET_STRING_ELT(nms, 295, mkChar("dim_I0_mild_3"));
  SET_STRING_ELT(nms, 296, mkChar("dim_I0_triage_D"));
  SET_STRING_ELT(nms, 297, mkChar("dim_I0_triage_D_1"));
  SET_STRING_ELT(nms, 298, mkChar("dim_I0_triage_D_12"));
  SET_STRING_ELT(nms, 299, mkChar("dim_I0_triage_D_2"));
  SET_STRING_ELT(nms, 300, mkChar("dim_I0_triage_D_3"));
  ...
  SET_STRING_ELT(nms, 304, mkChar("dim_I0_triage_R_2"));
  SET_STRING_ELT(nms, 305, mkChar("dim_I0_triage_R_3"));
  SET_STRING_ELT(nms, 306, mkChar("dim_lambda"));
  SET_STRING_ELT(nms, 307, mkChar("dim_m"));
  SET_STRING_ELT(nms, 308, mkChar("dim_m_1"));
  SET_STRING_ELT(nms, 309, mkChar("dim_m_2"));
  SET_STRING_ELT(nms, 310, mkChar("dim_n_com_to_R_pre"));
  SET_STRING_ELT(nms, 311, mkChar("dim_n_com_to_R_total"));
  SET_STRING_ELT(nms, 312, mkChar("dim_n_EE"));
  SET_STRING_ELT(nms, 313, mkChar("dim_n_EE_1"));
  SET_STRING_ELT(nms, 314, mkChar("dim_n_EE_12"));
  SET_STRING_ELT(nms, 315, mkChar("dim_n_EE_2"));
  SET_STRING_ELT(nms, 316, mkChar("dim_n_EE_3"));
  SET_STRING_ELT(nms, 317, mkChar("dim_n_EI_asympt"));
  SET_STRING_ELT(nms, 318, mkChar("dim_n_EI_asympt_1"));
  SET_STRING_ELT(nms, 319, mkChar("dim_n_EI_asympt_2"));
  SET_STRING_ELT(nms, 320, mkChar("dim_n_EI_ILI"));
  SET_STRING_ELT(nms, 321, mkChar("dim_n_EI_ILI_1"));
  SET_STRING_ELT(nms, 322, mkChar("dim_n_EI_ILI_2"));
  SET_STRING_ELT(nms, 323, mkChar("dim_n_EI_mild"));
  SET_STRING_ELT(nms, 324, mkChar("dim_n_EI_mild_1"));
  SET_STRING_ELT(nms, 325, mkChar("dim_n_EI_mild_2"));
  SET_STRING_ELT(nms, 326, mkChar("dim_n_hosp_non_ICU"));
  SET_STRING_ELT(nms, 327, mkChar("dim_n_hosp_non_ICU_1"));
  SET_STRING_ELT(nms, 328, mkChar("dim_n_hosp_non_ICU_2"));
  SET_STRING_ELT(nms, 329, mkChar("dim_n_I_hosp_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 330, mkChar("dim_n_I_hosp_D_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 331, mkChar("dim_n_I_hosp_D_unconf_to_conf_12"));
  SET_STRING_ELT(nms, 332, mkChar("dim_n_I_hosp_D_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 333, mkChar("dim_n_I_hosp_D_unconf_to_conf_3"));
  SET_STRING_ELT(nms, 334, mkChar("dim_n_I_hosp_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 335, mkChar("dim_n_I_hosp_R_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 336, mkChar("dim_n_I_hosp_R_unconf_to_conf_12"));
  SET_STRING_ELT(nms, 337, mkChar("dim_n_I_hosp_R_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 338, mkChar("dim_n_I_hosp_R_unconf_to_conf_3"));
  SET_STRING_ELT(nms, 339, mkChar("dim_n_ICU_to_R_stepdown"));
  SET_STRING_ELT(nms, 340, mkChar("dim_n_II_asympt"));
  SET_STRING_ELT(nms, 341, mkChar("dim_n_II_asympt_1"));
  SET_STRING_ELT(nms, 342, mkChar("dim_n_II_asympt_12"));
  SET_STRING_ELT(nms, 343, mkChar("dim_n_II_asympt_2"));
  SET_STRING_ELT(nms, 344, mkChar("dim_n_II_asympt_3"));
  SET_STRING_ELT(nms, 345, mkChar("dim_n_II_comm_D"));
  SET_STRING_ELT(nms, 346, mkChar("dim_n_II_comm_D_1"));
  SET_STRING_ELT(nms, 347, mkChar("dim_n_II_comm_D_12"));
  SET_STRING_ELT(nms, 348, mkChar("dim_n_II_comm_D_2"));
  SET_STRING_ELT(nms, 349, mkChar("dim_n_II_comm_D_3"));
  SET_STRING_ELT(nms, 350, mkChar("dim_n_II_hosp_D_conf"));
  SET_STRING_ELT(nms, 351, mkChar("dim_n_II_hosp_D_conf_1"));
  SET_STRING_ELT(nms, 352, mkChar("dim_n_II_hosp_D_conf_12"));
  SET_STRING_ELT(nms, 353, mkChar("dim_n_II_hosp_D_conf_2"));
  SET_STRING_ELT(nms, 354, mkChar("dim_n_II_hosp_D_conf_3"));
  SET_STRING_ELT(nms, 355, mkChar("dim_n_II_hosp_D_unconf"));
  SET_STRING_ELT(nms, 356, mkChar("dim_n_II_hosp_D_unconf_1"));
  SET_STRING_ELT(nms, 357, mkChar("dim_n_II_hosp_D_unconf_12"));
  SET_STRING_ELT(nms, 358, mkChar("dim_n_II_hosp_D_unconf_2"));
  SET_STRING_ELT(nms, 359, mkChar("dim_n_II_hosp_D_unconf_3"));
  SET_STRING_ELT(nms, 360, mkChar("dim_n_II_hosp_R_conf"));
  SET_STRING_ELT(nms, 361, mkChar("dim_n_II_hosp_R_conf_1"));
  SET_STRING_ELT(nms, 362, mkChar("dim_n_II_hosp_R_conf_12"));
  SET_STRING_ELT(nms, 363, mkChar("dim_n_II_hosp_R_conf_2"));
  SET_STRING_ELT(nms, 364, mkChar("dim_n_II_hosp_R_conf_3"));
  SET_STRING_ELT(nms, 365, mkChar("dim_n_II_hosp_R_unconf"));
  SET_STRING_ELT(nms, 366, mkChar("dim_n_II_hosp_R_unconf_1"));
  SET_STRING_ELT(nms, 367, mkChar("dim_n_II_hosp_R_unconf_12"));
  SET_STRING_ELT(nms, 368, mkChar("dim_n_II_hosp_R_unconf_2"));
  SET_STRING_ELT(nms, 369, mkChar("dim_n_II_hosp_R_unconf_3"));
  SET_STRING_ELT(nms, 370, mkChar("dim_n_II_ICU_D"));
  SET_STRING_ELT(nms, 371, mkChar("dim_n_II_ICU_D_1"));
  SET_STRING_ELT(nms, 372, mkChar("dim_n_II_ICU_D_12"));
  SET_STRING_ELT(nms, 373, mkChar("dim_n_II_ICU_D_2"));
  SET_STRING_ELT(nms, 374, mkChar("dim_n_II_ICU_D_3"));
  SET_STRING_ELT(nms, 375, mkChar("dim_n_II_ICU_R"));
  SET_STRING_ELT(nms, 376, mkChar("dim_n_II_ICU_R_1"));
  SET_STRING_ELT(nms, 377, mkChar("dim_n_II_ICU_R_12"));
  SET_STRING_ELT(nms, 378, mkChar("dim_n_II_ICU_R_2"));
  SET_STRING_ELT(nms, 379, mkChar("dim_n_II_ICU_R_3"));
  SET_STRING_ELT(nms, 380, mkChar("dim_n_II_ILI"));
  SET_STRING_ELT(nms, 381, mkChar("dim_n_II_ILI_1"));
  SET_STRING_ELT(nms, 382, mkChar("dim_n_II_ILI_12"));
  SET_STRING_ELT(nms, 383, mkChar("dim_n_II_ILI_2"));
  SET_STRING_ELT(nms, 384, mkChar("dim_n_II_ILI_3"));
  SET_STRING_ELT(nms, 385, mkChar("dim_n_II_mild"));
  SET_STRING_ELT(nms, 386, mkChar("dim_n_II_mild_1"));
  SET_STRING_ELT(nms, 387, mkChar("dim_n_II_mild_12"));
  SET_STRING_ELT(nms, 388, mkChar("dim_n_II_mild_2"));
  SET_STRING_ELT(nms, 389, mkChar("dim_n_II_mild_3"));
  SET_STRING_ELT(nms, 390, mkChar("dim_n_II_triage_D"));
  SET_STRING_ELT(nms, 391, mkChar("dim_n_II_triage_D_1"));
  SET_STRING_ELT(nms, 392, mkChar("dim_n_II_triage_D_12"));
  SET_STRING_ELT(nms, 393, mkChar("dim_n_II_triage_D_2"));
  SET_STRING_ELT(nms, 394, mkChar("dim_n_II_triage_D_3"));
  SET_STRING_ELT(nms, 395, mkChar("dim_n_II_triage_R"));
  SET_STRING_ELT(nms, 396, mkChar("dim_n_II_triage_R_1"));
  SET_STRING_ELT(nms, 397, mkChar("dim_n_II_triage_R_12"));
  SET_STRING_ELT(nms, 398, mkChar("dim_n_II_triage_R_2"));
  SET_STRING_ELT(nms, 399, mkChar("dim_n_II_triage_R_3"));
  SET_STRING_ELT(nms, 400, mkChar("dim_n_ILI_to_comm_D"));
  SET_STRING_ELT(nms, 401, mkChar("dim_n_ILI_to_comm_D_1"));
  SET_STRING_ELT(nms, 402, mkChar("dim_n_ILI_to_comm_D_2"));
  SET_STRING_ELT(nms, 403, mkChar("dim_n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 404, mkChar("dim_n_ILI_to_hosp_1"));
  SET_STRING_ELT(nms, 405, mkChar("dim_n_ILI_to_hosp_2"));
  SET_STRING_ELT(nms, 406, mkChar("dim_n_ILI_to_hosp_D"));
  SET_STRING_ELT(nms, 407, mkChar("dim_n_ILI_to_hosp_D_1"));
  SET_STRING_ELT(nms, 408, mkChar("dim_n_ILI_to_hosp_D_2"));
  SET_STRING_ELT(nms, 409, mkChar("dim_n_ILI_to_hosp_D_conf"));
  SET_STRING_ELT(nms, 410, mkChar("dim_n_ILI_to_hosp_D_conf_1"));
  SET_STRING_ELT(nms, 411, mkChar("dim_n_ILI_to_hosp_D_conf_2"));
  SET_STRING_ELT(nms, 412, mkChar("dim_n_ILI_to_hosp_R"));
  SET_STRING_ELT(nms, 413, mkChar("dim_n_ILI_to_hosp_R_1"));
  SET_STRING_ELT(nms, 414, mkChar("dim_n_ILI_to_hosp_R_2"));
  SET_STRING_ELT(nms, 415, mkChar("dim_n_ILI_to_hosp_R_conf"));
  SET_STRING_ELT(nms, 416, mkChar("dim_n_ILI_to_hosp_R_conf_1"));
  SET_STRING_ELT(nms, 417, mkChar("dim_n_ILI_to_hosp_R_conf_2"));
  SET_STRING_ELT(nms, 418, mkChar("dim_n_ILI_to_triage"));
  SET_STRING_ELT(nms, 419, mkChar("dim_n_ILI_to_triage_1"));
  SET_STRING_ELT(nms, 420, mkChar("dim_n_ILI_to_triage_2"));
  SET_STRING_ELT(nms, 421, mkChar("dim_n_ILI_to_triage_D"));
  SET_STRING_ELT(nms, 422, mkChar("dim_n_ILI_to_triage_D_1"));
  SET_STRING_ELT(nms, 423, mkChar("dim_n_ILI_to_triage_D_2"));
  SET_STRING_ELT(nms, 424, mkChar("dim_n_ILI_to_triage_R"));
  SET_STRING_ELT(nms, 425, mkChar("dim_n_ILI_to_triage_R_1"));
  SET_STRING_ELT(nms, 426, mkChar("dim_n_ILI_to_triage_R_2"));
  SET_STRING_ELT(nms, 427, mkChar("dim_n_R_pre"));
  SET_STRING_ELT(nms, 428, mkChar("dim_n_R_pre_1"));
  SET_STRING_ELT(nms, 429, mkChar("dim_n_R_pre_2"));
  SET_STRING_ELT(nms, 430, mkChar("dim_n_R_stepdown"));
  SET_STRING_ELT(nms, 431, mkChar("dim_n_R_stepdown_1"));
  SET_STRING_ELT(nms, 432, mkChar("dim_n_R_stepdown_2"));
  SET_STRING_ELT(nms, 433, mkChar("dim_n_SE"));
  SET_STRING_ELT(nms, 434, mkChar("dim_new_I_hosp_D_conf"));
  SET_STRING_ELT(nms, 435, mkChar("dim_new_I_hosp_D_conf_1"));
  SET_STRING_ELT(nms, 436, mkChar("dim_new_I_hosp_D_conf_12"));
  SET_STRING_ELT(nms, 437, mkChar("dim_new_I_hosp_D_conf_2"));
  SET_STRING_ELT(nms, 438, mkChar("dim_new_I_hosp_D_conf_3"));
  SET_STRING_ELT(nms, 439, mkChar("dim_new_I_hosp_D_unconf"));
  SET_STRING_ELT(nms, 440, mkChar("dim_new_I_hosp_D_unconf_1"));
  SET_STRING_ELT(nms, 441, mkChar("dim_new_I_hosp_D_unconf_12"));
  SET_STRING_ELT(nms, 442, mkChar("dim_new_I_hosp_D_unconf_2"));
  SET_STRING_ELT(nms, 443, mkChar("dim_new_I_hosp_D_unconf_3"));
  SET_STRING_ELT(nms, 444, mkChar("dim_new_I_hosp_R_conf"));
  SET_STRING_ELT(nms, 445, mkChar("dim_new_I_hosp_R_conf_1"));
  SET_STRING_ELT(nms, 446, mkChar("dim_new_I_hosp_R_conf_12"));
  SET_STRING_ELT(nms, 447, mkChar("dim_new_I_hosp_R_conf_2"));
  SET_STRING_ELT(nms, 448, mkChar("dim_new_I_hosp_R_conf_3"));
  SET_STRING_ELT(nms, 449, mkChar("dim_new_I_hosp_R_unconf"));
  SET_STRING_ELT(nms, 450, mkChar("dim_new_I_hosp_R_unconf_1"));
  SET_STRING_ELT(nms, 451, mkChar("dim_new_I_hosp_R_unconf_12"));
  SET_STRING_ELT(nms, 452, mkChar("dim_new_I_hosp_R_unconf_2"));
  SET_STRING_ELT(nms, 453, mkChar("dim_new_I_hosp_R_unconf_3"));
  SET_STRING_ELT(nms, 454, mkChar("dim_p_admit_conf"));
  SET_STRING_ELT(nms, 455, mkChar("dim_p_asympt"));
  SET_STRING_ELT(nms, 456, mkChar("dim_p_death_comm"));
  SET_STRING_ELT(nms, 457, mkChar("dim_p_death_hosp_D"));
  SET_STRING_ELT(nms, 458, mkChar("dim_p_death_ICU"));
  SET_STRING_ELT(nms, 459, mkChar("dim_p_ICU_hosp"));
  SET_STRING_ELT(nms, 460, mkChar("dim_p_R_pre"));
  SET_STRING_ELT(nms, 461, mkChar("dim_p_recov_ILI"));
  SET_STRING_ELT(nms, 462, mkChar("dim_p_SE"));
  SET_STRING_ELT(nms, 463, mkChar("dim_p_seroconversion"));
  SET_STRING_ELT(nms, 464, mkChar("dim_p_sympt_ILI"));
  SET_STRING_ELT(nms, 465, mkChar("dim_R"));
  SET_STRING_ELT(nms, 466, mkChar("dim_R_neg"));
  SET_STRING_ELT(nms, 467, mkChar("dim_R_pos"));
  SET_STRING_ELT(nms, 468, mkChar("dim_R_pre"));
  SET_STRING_ELT(nms, 469, mkChar("dim_R_pre_1"));
  SET_STRING_ELT(nms, 470, mkChar("dim_R_pre_2"));
  SET_STRING_ELT(nms, 471, mkChar("dim_R_stepdown"));
  SET_STRING_ELT(nms, 472, mkChar("dim_R_stepdown_1"));
  SET_STRING_ELT(nms, 473, mkChar("dim_R_stepdown_2"));
  SET_STRING_ELT(nms, 474, mkChar("dim_R0"));
  SET_STRING_ELT(nms, 475, mkChar("dim_R0_neg"));
  SET_STRING_ELT(nms, 476, mkChar("dim_R0_pos"));
  SET_STRING_ELT(nms, 477, mkChar("dim_R0_pre"));
  SET_STRING_ELT(nms, 478, mkChar("dim_R0_pre_1"));
  SET_STRING_ELT(nms, 479, mkChar("dim_R0_pre_2"));
  SET_STRING_ELT(nms, 480, mkChar("dim_R0_stepdown"));
  SET_STRING_ELT(nms, 481, mkChar("dim_R0_stepdown_1"));
  SET_STRING_ELT(nms, 482, mkChar("dim_R0_stepdown_2"));
  SET_STRING_ELT(nms, 483, mkChar("dim_S"));
  SET_STRING_ELT(nms, 484, mkChar("dim_s_ij"));
  SET_STRING_ELT(nms, 485, mkChar("dim_s_ij_1"));
  SET_STRING_ELT(nms, 486, mkChar("dim_s_ij_2"));
  SET_STRING_ELT(nms, 487, mkChar("dim_S0"));
  SET_STRING_ELT(nms, 488, mkChar("dim_trans_increase"));
  SET_STRING_ELT(nms, 489, mkChar("dim_trans_increase_1"));
  SET_STRING_ELT(nms, 490, mkChar("dim_trans_increase_2"));
  SET_STRING_ELT(nms, 491, mkChar("dim_trans_profile"));
  SET_STRING_ELT(nms, 492, mkChar("dim_trans_profile_1"));
  SET_STRING_ELT(nms, 493, mkChar("dim_trans_profile_2"));
  SET_STRING_ELT(nms, 494, mkChar("dt"));
  SET_STRING_ELT(nms, 495, mkChar("E0"));
  SET_STRING_ELT(nms, 496, mkChar("gamma_asympt"));
  SET_STRING_ELT(nms, 497, mkChar("gamma_comm_D"));
  SET_STRING_ELT(nms, 498, mkChar("gamma_E"));
  SET_STRING_ELT(nms, 499, mkChar("gamma_hosp_D"));
  SET_STRING_ELT(nms, 500, mkChar("gamma_hosp_R"));
  SET_STRING_ELT(nms, 501, mkChar("gamma_ICU_D"));
  SET_STRING_ELT(nms, 502, mkChar("gamma_ICU_R"));
  SET_STRING_ELT(nms, 503, mkChar("gamma_ILI"));
  SET_STRING_ELT(nms, 504, mkChar("gamma_mild"));
  SET_STRING_ELT(nms, 505, mkChar("gamma_R_pre"));
  SET_STRING_ELT(nms, 506, mkChar("gamma_stepdown"));
  SET_STRING_ELT(nms, 507, mkChar("gamma_test"));
  SET_STRING_ELT(nms, 508, mkChar("gamma_triage"));
  SET_STRING_ELT(nms, 509, mkChar("hosp_transmission"));
  SET_STRING_ELT(nms, 510, mkChar("I_with_diff_trans"));
  SET_STRING_ELT(nms, 511, mkChar("I0_asympt"));
  SET_STRING_ELT(nms, 512, mkChar("I0_comm_D"));
  SET_STRING_ELT(nms, 513, mkChar("I0_hosp_D_conf"));
  SET_STRING_ELT(nms, 514, mkChar("I0_hosp_D_unconf"));
  SET_STRING_ELT(nms, 515, mkChar("I0_hosp_R_conf"));
  SET_STRING_ELT(nms, 516, mkChar("I0_hosp_R_unconf"));
  SET_STRING_ELT(nms, 517, mkChar("I0_ICU_D"));
  SET_STRING_ELT(nms, 518, mkChar("I0_ICU_R"));
  SET_STRING_ELT(nms, 519, mkChar("I0_ILI"));
  SET_STRING_ELT(nms, 520, mkChar("I0_mild"));
  SET_STRING_ELT(nms, 521, mkChar("I0_triage_D"));
  SET_STRING_ELT(nms, 522, mkChar("I0_triage_R"));
  SET_STRING_ELT(nms, 523, mkChar("ICU_transmission"));
  SET_STRING_ELT(nms, 524, mkChar("initial_cum_admit_conf"));
  SET_STRING_ELT(nms, 525, mkChar("initial_cum_new_conf"));
  SET_STRING_ELT(nms, 526, mkChar("initial_D_comm"));
  SET_STRING_ELT(nms, 527, mkChar("initial_D_hosp"));
  SET_STRING_ELT(nms, 528, mkChar("initial_E"));
  SET_STRING_ELT(nms, 529, mkChar("initial_I_asympt"));
  SET_STRING_ELT(nms, 530, mkChar("initial_I_comm_D"));
  SET_STRING_ELT(nms, 531, mkChar("initial_I_hosp_D_conf"));
  SET_STRING_ELT(nms, 532, mkChar("initial_I_hosp_D_unconf"));
  SET_STRING_ELT(nms, 533, mkChar("initial_I_hosp_R_conf"));
  SET_STRING_ELT(nms, 534, mkChar("initial_I_hosp_R_unconf"));
  SET_STRING_ELT(nms, 535, mkChar("initial_I_ICU_D"));
  SET_STRING_ELT(nms, 536, mkChar("initial_I_ICU_R"));
  SET_STRING_ELT(nms, 537, mkChar("initial_I_ILI"));
  SET_STRING_ELT(nms, 538, mkChar("initial_I_mild"));
  SET_STRING_ELT(nms, 539, mkChar("initial_I_triage_D"));
  SET_STRING_ELT(nms, 540, mkChar("initial_I_triage_R"));
  SET_STRING_ELT(nms, 541, mkChar("initial_R"));
  SET_STRING_ELT(nms, 542, mkChar("initial_R_neg"));
  SET_STRING_ELT(nms, 543, mkChar("initial_R_pos"));
  SET_STRING_ELT(nms, 544, mkChar("initial_R_pre"));
  SET_STRING_ELT(nms, 545, mkChar("initial_R_stepdown"));
  SET_STRING_ELT(nms, 546, mkChar("initial_S"));
  SET_STRING_ELT(nms, 547, mkChar("interpolate_beta"));
  SET_STRING_ELT(nms, 548, mkChar("lambda"));
  SET_STRING_ELT(nms, 549, mkChar("m"));
  SET_STRING_ELT(nms, 550, mkChar("N_age"));
  SET_STRING_ELT(nms, 551, mkChar("n_com_to_R_pre"));
  SET_STRING_ELT(nms, 552, mkChar("n_com_to_R_total"));
  SET_STRING_ELT(nms, 553, mkChar("n_EE"));
  SET_STRING_ELT(nms, 554, mkChar("n_EI_asympt"));
  SET_STRING_ELT(nms, 555, mkChar("n_EI_ILI"));
  SET_STRING_ELT(nms, 556, mkChar("n_EI_mild"));
  SET_STRING_ELT(nms, 557, mkChar("n_hosp_non_ICU"));
  SET_STRING_ELT(nms, 558, mkChar("n_I_hosp_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 559, mkChar("n_I_hosp_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 560, mkChar("n_ICU_to_R_stepdown"));
  SET_STRING_ELT(nms, 561, mkChar("n_II_asympt"));
  SET_STRING_ELT(nms, 562, mkChar("n_II_comm_D"));
  SET_STRING_ELT(nms, 563, mkChar("n_II_hosp_D_conf"));
  SET_STRING_ELT(nms, 564, mkChar("n_II_hosp_D_unconf"));
  SET_STRING_ELT(nms, 565, mkChar("n_II_hosp_R_conf"));
  SET_STRING_ELT(nms, 566, mkChar("n_II_hosp_R_unconf"));
  SET_STRING_ELT(nms, 567, mkChar("n_II_ICU_D"));
  SET_STRING_ELT(nms, 568, mkChar("n_II_ICU_R"));
  SET_STRING_ELT(nms, 569, mkChar("n_II_ILI"));
  SET_STRING_ELT(nms, 570, mkChar("n_II_mild"));
  SET_STRING_ELT(nms, 571, mkChar("n_II_triage_D"));
  SET_STRING_ELT(nms, 572, mkChar("n_II_triage_R"));
  SET_STRING_ELT(nms, 573, mkChar("n_ILI_to_comm_D"));
  SET_STRING_ELT(nms, 574, mkChar("n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 575, mkChar("n_ILI_to_hosp_D"));
  SET_STRING_ELT(nms, 576, mkChar("n_ILI_to_hosp_D_conf"));
  SET_STRING_ELT(nms, 577, mkChar("n_ILI_to_hosp_R"));
  SET_STRING_ELT(nms, 578, mkChar("n_ILI_to_hosp_R_conf"));
  SET_STRING_ELT(nms, 579, mkChar("n_ILI_to_triage"));
  SET_STRING_ELT(nms, 580, mkChar("n_ILI_to_triage_D"));
  SET_STRING_ELT(nms, 581, mkChar("n_ILI_to_triage_R"));
  SET_STRING_ELT(nms, 582, mkChar("n_R_pre"));
  SET_STRING_ELT(nms, 583, mkChar("n_R_stepdown"));
  SET_STRING_ELT(nms, 584, mkChar("n_SE"));
  SET_STRING_ELT(nms, 585, mkChar("new_I_hosp_D_conf"));
  SET_STRING_ELT(nms, 586, mkChar("new_I_hosp_D_unconf"));
  SET_STRING_ELT(nms, 587, mkChar("new_I_hosp_R_conf"));
  SET_STRING_ELT(nms, 588, mkChar("new_I_hosp_R_unconf"));
  SET_STRING_ELT(nms, 589, mkChar("offset_variable_D_comm"));
  SET_STRING_ELT(nms, 590, mkChar("offset_variable_D_hosp"));
  SET_STRING_ELT(nms, 591, mkChar("offset_variable_E"));
  SET_STRING_ELT(nms, 592, mkChar("offset_variable_I_asympt"));
  SET_STRING_ELT(nms, 593, mkChar("offset_variable_I_comm_D"));
  SET_STRING_ELT(nms, 594, mkChar("offset_variable_I_hosp_D_conf"));
  SET_STRING_ELT(nms, 595, mkChar("offset_variable_I_hosp_D_unconf"));
  SET_STRING_ELT(nms, 596, mkChar("offset_variable_I_hosp_R_conf"));
  SET_STRING_ELT(nms, 597, mkChar("offset_variable_I_hosp_R_unconf"));
  SET_STRING_ELT(nms, 598, mkChar("offset_variable_I_ICU_D"));
  SET_STRING_ELT(nms, 599, mkChar("offset_variable_I_ICU_R"));
  SET_STRING_ELT(nms, 600, mkChar("offset_variable_I_ILI"));
  SET_STRING_ELT(nms, 601, mkChar("offset_variable_I_mild"));
  SET_STRING_ELT(nms, 602, mkChar("offset_variable_I_triage_D"));
  SET_STRING_ELT(nms, 603, mkChar("offset_variable_I_triage_R"));
  SET_STRING_ELT(nms, 604, mkChar("offset_variable_R"));
  SET_STRING_ELT(nms, 605, mkChar("offset_variable_R_neg"));
  SET_STRING_ELT(nms, 606, mkChar("offset_variable_R_pos"));
  SET_STRING_ELT(nms, 607, mkChar("offset_variable_R_pre"));
  SET_STRING_ELT(nms, 608, mkChar("offset_variable_R_stepdown"));
  SET_STRING_ELT(nms, 609, mkChar("p_admit_conf"));
  SET_STRING_ELT(nms, 610, mkChar("p_asympt"));
  SET_STRING_ELT(nms, 611, mkChar("p_death_comm"));
  SET_STRING_ELT(nms, 612, mkChar("p_death_hosp_D"));
  SET_STRING_ELT(nms, 613, mkChar("p_death_ICU"));
  SET_STRING_ELT(nms, 614, mkChar("p_EE"));
  SET_STRING_ELT(nms, 615, mkChar("p_ICU_hosp"));
  SET_STRING_ELT(nms, 616, mkChar("p_II_asympt"));
  SET_STRING_ELT(nms, 617, mkChar("p_II_comm_D"));
  SET_STRING_ELT(nms, 618, mkChar("p_II_hosp_D"));
  SET_STRING_ELT(nms, 619, mkChar("p_II_hosp_R"));
  SET_STRING_ELT(nms, 620, mkChar("p_II_ICU_D"));
  SET_STRING_ELT(nms, 621, mkChar("p_II_ICU_R"));
  SET_STRING_ELT(nms, 622, mkChar("p_II_ILI"));
  SET_STRING_ELT(nms, 623, mkChar("p_II_mild"));
  SET_STRING_ELT(nms, 624, mkChar("p_II_triage"));
  SET_STRING_ELT(nms, 625, mkChar("p_R_pre"));
  SET_STRING_ELT(nms, 626, mkChar("p_R_stepdown"));
  SET_STRING_ELT(nms, 627, mkChar("p_recov_ILI"));
  SET_STRING_ELT(nms, 628, mkChar("p_SE"));
  SET_STRING_ELT(nms, 629, mkChar("p_seroconversion"));
  SET_STRING_ELT(nms, 630, mkChar("p_sympt_ILI"));
  SET_STRING_ELT(nms, 631, mkChar("p_test"));
  SET_STRING_ELT(nms, 632, mkChar("R0"));
  SET_STRING_ELT(nms, 633, mkChar("R0_neg"));
  SET_STRING_ELT(nms, 634, mkChar("R0_pos"));
  SET_STRING_ELT(nms, 635, mkChar("R0_pre"));
  SET_STRING_ELT(nms, 636, mkChar("R0_stepdown"));
  SET_STRING_ELT(nms, 637, mkChar("s_asympt"));
  SET_STRING_ELT(nms, 638, mkChar("s_comm_D"));
  SET_STRING_ELT(nms, 639, mkChar("s_E"));
  SET_STRING_ELT(nms, 640, mkChar("s_hosp_D"));
  SET_STRING_ELT(nms, 641, mkChar("s_hosp_R"));
  SET_STRING_ELT(nms, 642, mkChar("s_ICU_D"));
  SET_STRING_ELT(nms, 643, mkChar("s_ICU_R"));
  SET_STRING_ELT(nms, 644, mkChar("s_ij"));
  SET_STRING_ELT(nms, 645, mkChar("s_ILI"));
  SET_STRING_ELT(nms, 646, mkChar("s_mild"));
  SET_STRING_ELT(nms, 647, mkChar("s_R_pre"));
  SET_STRING_ELT(nms, 648, mkChar("s_stepdown"));
  SET_STRING_ELT(nms, 649, mkChar("s_triage"));
  SET_STRING_ELT(nms, 650, mkChar("S0"));
  SET_STRING_ELT(nms, 651, mkChar("trans_classes"));
  SET_STRING_ELT(nms, 652, mkChar("trans_increase"));
  SET_STRING_ELT(nms, 653, mkChar("trans_profile"));
  setAttrib(contents, R_NamesSymbol, nms);
  UNPROTECT(133);
  return contents;
}
SEXP hospital_with_serology_testing_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->offset_variable_I_triage_R = 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg + internal->dim_R + internal->dim_D_hosp + internal->dim_D_comm + internal->dim_R_stepdown + internal->dim_R_pre + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_comm_D;
...
SEXP hospital_with_serology_testing_metadata(SEXP internal_p) {
  ...
  dim_I_triage_D[2] = internal->dim_I_triage_D_3;
  SET_VECTOR_ELT(variable_length, 17, allocVector(INTSXP, 3));
  int * dim_I_hosp_R_unconf = INTEGER(VECTOR_ELT(variable_length, 17));
  ...
  int * dim_I_hosp_R_conf = INTEGER(VECTOR_ELT(variable_length, 18));
  ...
  int * dim_I_hosp_D_unconf = INTEGER(VECTOR_ELT(variable_length, 19));
  ...
  int * dim_I_hosp_D_conf = INTEGER(VECTOR_ELT(variable_length, 20));
  ...
  int * dim_I_ICU_R = INTEGER(VECTOR_ELT(variable_length, 21));
  dim_I_ICU_R[0] = internal->dim_I_ICU_R_1;
  dim_I_ICU_R[1] = internal->dim_I_ICU_R_2;
  dim_I_ICU_R[2] = internal->dim_I_ICU_R_3;
  SET_VECTOR_ELT(variable_length, 22, allocVector(INTSXP, 3));
  int * dim_I_ICU_D = INTEGER(VECTOR_ELT(variable_length, 22));
  dim_I_ICU_D[0] = internal->dim_I_ICU_D_1;
  dim_I_ICU_D[1] = internal->dim_I_ICU_D_2;
  dim_I_ICU_D[2] = internal->dim_I_ICU_D_3;
  ...
  SET_STRING_ELT(variable_names, 17, mkChar("I_hosp_R_unconf"));
  SET_STRING_ELT(variable_names, 18, mkChar("I_hosp_R_conf"));
  SET_STRING_ELT(variable_names, 19, mkChar("I_hosp_D_unconf"));
  SET_STRING_ELT(variable_names, 20, mkChar("I_hosp_D_conf"));
  SET_STRING_ELT(variable_names, 21, mkChar("I_ICU_R"));
  SET_STRING_ELT(variable_names, 22, mkChar("I_ICU_D"));
  SET_VECTOR_ELT(ret, 0, variable_length);
  UNPROTECT(2);
