...
typedef struct hospital_with_serology_testing_internal {
  ...
  int dim_I_triage_R_123;
  int dim_I_triage_R_2;
  int dim_I_triage_R_3;
  int dim_I_triage_R_4;
  ...
  int dim_I0_triage_R_123;
  int dim_I0_triage_R_2;
  int dim_I0_triage_R_3;
  int dim_I0_triage_R_4;
...
SEXP hospital_with_serology_testing_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 855));
  SEXP aux_EE = PROTECT(allocVector(REALSXP, internal->dim_aux_EE));
  memcpy(REAL(aux_EE), internal->aux_EE, internal->dim_aux_EE * sizeof(double));
  odin_set_dim(aux_EE, 3, internal->dim_aux_EE_1, internal->dim_aux_EE_2, internal->dim_aux_EE_3);
  SET_VECTOR_ELT(contents, 0, aux_EE);
  ...
  SET_VECTOR_ELT(contents, 255, ScalarInteger(internal->dim_I_triage_R));
  SET_VECTOR_ELT(contents, 256, ScalarInteger(internal->dim_I_triage_R_1));
  SET_VECTOR_ELT(contents, 257, ScalarInteger(internal->dim_I_triage_R_12));
  SET_VECTOR_ELT(contents, 258, ScalarInteger(internal->dim_I_triage_R_123));
  SET_VECTOR_ELT(contents, 259, ScalarInteger(internal->dim_I_triage_R_2));
  SET_VECTOR_ELT(contents, 260, ScalarInteger(internal->dim_I_triage_R_3));
  SET_VECTOR_ELT(contents, 261, ScalarInteger(internal->dim_I_triage_R_4));
  SET_VECTOR_ELT(contents, 262, ScalarInteger(internal->dim_I_triage_R_conf));
  SET_VECTOR_ELT(contents, 263, ScalarInteger(internal->dim_I_triage_R_conf_1));
  SET_VECTOR_ELT(contents, 264, ScalarInteger(internal->dim_I_triage_R_conf_12));
  SET_VECTOR_ELT(contents, 265, ScalarInteger(internal->dim_I_triage_R_conf_2));
  SET_VECTOR_ELT(contents, 266, ScalarInteger(internal->dim_I_triage_R_conf_3));
  SET_VECTOR_ELT(contents, 267, ScalarInteger(internal->dim_I_triage_R_unconf));
  SET_VECTOR_ELT(contents, 268, ScalarInteger(internal->dim_I_triage_R_unconf_1));
  SET_VECTOR_ELT(contents, 269, ScalarInteger(internal->dim_I_triage_R_unconf_12));
  SET_VECTOR_ELT(contents, 270, ScalarInteger(internal->dim_I_triage_R_unconf_2));
  SET_VECTOR_ELT(contents, 271, ScalarInteger(internal->dim_I_triage_R_unconf_3));
  SET_VECTOR_ELT(contents, 272, ScalarInteger(internal->dim_I_with_diff_trans));
  SET_VECTOR_ELT(contents, 273, ScalarInteger(internal->dim_I_with_diff_trans_1));
  SET_VECTOR_ELT(contents, 274, ScalarInteger(internal->dim_I_with_diff_trans_2));
  SET_VECTOR_ELT(contents, 275, ScalarInteger(internal->dim_I0_asympt));
  SET_VECTOR_ELT(contents, 276, ScalarInteger(internal->dim_I0_asympt_1));
  SET_VECTOR_ELT(contents, 277, ScalarInteger(internal->dim_I0_asympt_12));
  SET_VECTOR_ELT(contents, 278, ScalarInteger(internal->dim_I0_asympt_2));
  SET_VECTOR_ELT(contents, 279, ScalarInteger(internal->dim_I0_asympt_3));
  SET_VECTOR_ELT(contents, 280, ScalarInteger(internal->dim_I0_comm_D));
  SET_VECTOR_ELT(contents, 281, ScalarInteger(internal->dim_I0_comm_D_1));
  SET_VECTOR_ELT(contents, 282, ScalarInteger(internal->dim_I0_comm_D_12));
  SET_VECTOR_ELT(contents, 283, ScalarInteger(internal->dim_I0_comm_D_2));
  SET_VECTOR_ELT(contents, 284, ScalarInteger(internal->dim_I0_comm_D_3));
  SET_VECTOR_ELT(contents, 285, ScalarInteger(internal->dim_I0_hosp_D_conf));
  SET_VECTOR_ELT(contents, 286, ScalarInteger(internal->dim_I0_hosp_D_conf_1));
  SET_VECTOR_ELT(contents, 287, ScalarInteger(internal->dim_I0_hosp_D_conf_12));
  SET_VECTOR_ELT(contents, 288, ScalarInteger(internal->dim_I0_hosp_D_conf_2));
  SET_VECTOR_ELT(contents, 289, ScalarInteger(internal->dim_I0_hosp_D_conf_3));
  SET_VECTOR_ELT(contents, 290, ScalarInteger(internal->dim_I0_hosp_D_unconf));
  SET_VECTOR_ELT(contents, 291, ScalarInteger(internal->dim_I0_hosp_D_unconf_1));
  SET_VECTOR_ELT(contents, 292, ScalarInteger(internal->dim_I0_hosp_D_unconf_12));
  SET_VECTOR_ELT(contents, 293, ScalarInteger(internal->dim_I0_hosp_D_unconf_2));
  SET_VECTOR_ELT(contents, 294, ScalarInteger(internal->dim_I0_hosp_D_unconf_3));
  SET_VECTOR_ELT(contents, 295, ScalarInteger(internal->dim_I0_hosp_R_conf));
  SET_VECTOR_ELT(contents, 296, ScalarInteger(internal->dim_I0_hosp_R_conf_1));
  SET_VECTOR_ELT(contents, 297, ScalarInteger(internal->dim_I0_hosp_R_conf_12));
  SET_VECTOR_ELT(contents, 298, ScalarInteger(internal->dim_I0_hosp_R_conf_2));
  SET_VECTOR_ELT(contents, 299, ScalarInteger(internal->dim_I0_hosp_R_conf_3));
  SET_VECTOR_ELT(contents, 300, ScalarInteger(internal->dim_I0_hosp_R_unconf));
  SET_VECTOR_ELT(contents, 301, ScalarInteger(internal->dim_I0_hosp_R_unconf_1));
  SET_VECTOR_ELT(contents, 302, ScalarInteger(internal->dim_I0_hosp_R_unconf_12));
  SET_VECTOR_ELT(contents, 303, ScalarInteger(internal->dim_I0_hosp_R_unconf_2));
  SET_VECTOR_ELT(contents, 304, ScalarInteger(internal->dim_I0_hosp_R_unconf_3));
  SET_VECTOR_ELT(contents, 305, ScalarInteger(internal->dim_I0_ICU_D_conf));
  SET_VECTOR_ELT(contents, 306, ScalarInteger(internal->dim_I0_ICU_D_conf_1));
  SET_VECTOR_ELT(contents, 307, ScalarInteger(internal->dim_I0_ICU_D_conf_12));
  SET_VECTOR_ELT(contents, 308, ScalarInteger(internal->dim_I0_ICU_D_conf_2));
  SET_VECTOR_ELT(contents, 309, ScalarInteger(internal->dim_I0_ICU_D_conf_3));
  SET_VECTOR_ELT(contents, 310, ScalarInteger(internal->dim_I0_ICU_D_unconf));
  SET_VECTOR_ELT(contents, 311, ScalarInteger(internal->dim_I0_ICU_D_unconf_1));
  SET_VECTOR_ELT(contents, 312, ScalarInteger(internal->dim_I0_ICU_D_unconf_12));
  SET_VECTOR_ELT(contents, 313, ScalarInteger(internal->dim_I0_ICU_D_unconf_2));
  SET_VECTOR_ELT(contents, 314, ScalarInteger(internal->dim_I0_ICU_D_unconf_3));
  SET_VECTOR_ELT(contents, 315, ScalarInteger(internal->dim_I0_ICU_R_conf));
  SET_VECTOR_ELT(contents, 316, ScalarInteger(internal->dim_I0_ICU_R_conf_1));
  SET_VECTOR_ELT(contents, 317, ScalarInteger(internal->dim_I0_ICU_R_conf_12));
  SET_VECTOR_ELT(contents, 318, ScalarInteger(internal->dim_I0_ICU_R_conf_2));
  SET_VECTOR_ELT(contents, 319, ScalarInteger(internal->dim_I0_ICU_R_conf_3));
  SET_VECTOR_ELT(contents, 320, ScalarInteger(internal->dim_I0_ICU_R_unconf));
  SET_VECTOR_ELT(contents, 321, ScalarInteger(internal->dim_I0_ICU_R_unconf_1));
  SET_VECTOR_ELT(contents, 322, ScalarInteger(internal->dim_I0_ICU_R_unconf_12));
  SET_VECTOR_ELT(contents, 323, ScalarInteger(internal->dim_I0_ICU_R_unconf_2));
  SET_VECTOR_ELT(contents, 324, ScalarInteger(internal->dim_I0_ICU_R_unconf_3));
  SET_VECTOR_ELT(contents, 325, ScalarInteger(internal->dim_I0_ILI));
  SET_VECTOR_ELT(contents, 326, ScalarInteger(internal->dim_I0_ILI_1));
  SET_VECTOR_ELT(contents, 327, ScalarInteger(internal->dim_I0_ILI_12));
  SET_VECTOR_ELT(contents, 328, ScalarInteger(internal->dim_I0_ILI_2));
  SET_VECTOR_ELT(contents, 329, ScalarInteger(internal->dim_I0_ILI_3));
  SET_VECTOR_ELT(contents, 330, ScalarInteger(internal->dim_I0_mild));
  SET_VECTOR_ELT(contents, 331, ScalarInteger(internal->dim_I0_mild_1));
  SET_VECTOR_ELT(contents, 332, ScalarInteger(internal->dim_I0_mild_12));
  SET_VECTOR_ELT(contents, 333, ScalarInteger(internal->dim_I0_mild_2));
  SET_VECTOR_ELT(contents, 334, ScalarInteger(internal->dim_I0_mild_3));
  SET_VECTOR_ELT(contents, 335, ScalarInteger(internal->dim_I0_triage_D_conf));
  SET_VECTOR_ELT(contents, 336, ScalarInteger(internal->dim_I0_triage_D_conf_1));
  SET_VECTOR_ELT(contents, 337, ScalarInteger(internal->dim_I0_triage_D_conf_12));
  SET_VECTOR_ELT(contents, 338, ScalarInteger(internal->dim_I0_triage_D_conf_2));
  SET_VECTOR_ELT(contents, 339, ScalarInteger(internal->dim_I0_triage_D_conf_3));
  SET_VECTOR_ELT(contents, 340, ScalarInteger(internal->dim_I0_triage_D_unconf));
  SET_VECTOR_ELT(contents, 341, ScalarInteger(internal->dim_I0_triage_D_unconf_1));
  SET_VECTOR_ELT(contents, 342, ScalarInteger(internal->dim_I0_triage_D_unconf_12));
  SET_VECTOR_ELT(contents, 343, ScalarInteger(internal->dim_I0_triage_D_unconf_2));
  SET_VECTOR_ELT(contents, 344, ScalarInteger(internal->dim_I0_triage_D_unconf_3));
  SET_VECTOR_ELT(contents, 345, ScalarInteger(internal->dim_I0_triage_R));
  SET_VECTOR_ELT(contents, 346, ScalarInteger(internal->dim_I0_triage_R_1));
  SET_VECTOR_ELT(contents, 347, ScalarInteger(internal->dim_I0_triage_R_12));
  SET_VECTOR_ELT(contents, 348, ScalarInteger(internal->dim_I0_triage_R_123));
  SET_VECTOR_ELT(contents, 349, ScalarInteger(internal->dim_I0_triage_R_2));
  SET_VECTOR_ELT(contents, 350, ScalarInteger(internal->dim_I0_triage_R_3));
  SET_VECTOR_ELT(contents, 351, ScalarInteger(internal->dim_I0_triage_R_4));
  SET_VECTOR_ELT(contents, 352, ScalarInteger(internal->dim_I0_triage_R_conf));
  SET_VECTOR_ELT(contents, 353, ScalarInteger(internal->dim_I0_triage_R_conf_1));
  SET_VECTOR_ELT(contents, 354, ScalarInteger(internal->dim_I0_triage_R_conf_12));
  SET_VECTOR_ELT(contents, 355, ScalarInteger(internal->dim_I0_triage_R_conf_2));
  SET_VECTOR_ELT(contents, 356, ScalarInteger(internal->dim_I0_triage_R_conf_3));
  SET_VECTOR_ELT(contents, 357, ScalarInteger(internal->dim_I0_triage_R_unconf));
  SET_VECTOR_ELT(contents, 358, ScalarInteger(internal->dim_I0_triage_R_unconf_1));
  SET_VECTOR_ELT(contents, 359, ScalarInteger(internal->dim_I0_triage_R_unconf_12));
  SET_VECTOR_ELT(contents, 360, ScalarInteger(internal->dim_I0_triage_R_unconf_2));
  SET_VECTOR_ELT(contents, 361, ScalarInteger(internal->dim_I0_triage_R_unconf_3));
  SET_VECTOR_ELT(contents, 362, ScalarInteger(internal->dim_lambda));
  SET_VECTOR_ELT(contents, 363, ScalarInteger(internal->dim_m));
  SET_VECTOR_ELT(contents, 364, ScalarInteger(internal->dim_m_1));
  SET_VECTOR_ELT(contents, 365, ScalarInteger(internal->dim_m_2));
  SET_VECTOR_ELT(contents, 366, ScalarInteger(internal->dim_n_com_to_R_pre));
  SET_VECTOR_ELT(contents, 367, ScalarInteger(internal->dim_n_com_to_R_total));
  SET_VECTOR_ELT(contents, 368, ScalarInteger(internal->dim_n_EE));
  SET_VECTOR_ELT(contents, 369, ScalarInteger(internal->dim_n_EE_1));
  SET_VECTOR_ELT(contents, 370, ScalarInteger(internal->dim_n_EE_12));
  SET_VECTOR_ELT(contents, 371, ScalarInteger(internal->dim_n_EE_2));
  SET_VECTOR_ELT(contents, 372, ScalarInteger(internal->dim_n_EE_3));
  SET_VECTOR_ELT(contents, 373, ScalarInteger(internal->dim_n_EI_asympt));
  SET_VECTOR_ELT(contents, 374, ScalarInteger(internal->dim_n_EI_asympt_1));
  SET_VECTOR_ELT(contents, 375, ScalarInteger(internal->dim_n_EI_asympt_2));
  SET_VECTOR_ELT(contents, 376, ScalarInteger(internal->dim_n_EI_ILI));
  SET_VECTOR_ELT(contents, 377, ScalarInteger(internal->dim_n_EI_ILI_1));
  SET_VECTOR_ELT(contents, 378, ScalarInteger(internal->dim_n_EI_ILI_2));
  SET_VECTOR_ELT(contents, 379, ScalarInteger(internal->dim_n_EI_mild));
  SET_VECTOR_ELT(contents, 380, ScalarInteger(internal->dim_n_EI_mild_1));
  SET_VECTOR_ELT(contents, 381, ScalarInteger(internal->dim_n_EI_mild_2));
  SET_VECTOR_ELT(contents, 382, ScalarInteger(internal->dim_n_hosp_non_ICU));
  SET_VECTOR_ELT(contents, 383, ScalarInteger(internal->dim_n_hosp_non_ICU_1));
  SET_VECTOR_ELT(contents, 384, ScalarInteger(internal->dim_n_hosp_non_ICU_2));
  SET_VECTOR_ELT(contents, 385, ScalarInteger(internal->dim_n_I_hosp_D_unconf_to_conf));
  SET_VECTOR_ELT(contents, 386, ScalarInteger(internal->dim_n_I_hosp_D_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 387, ScalarInteger(internal->dim_n_I_hosp_D_unconf_to_conf_12));
  SET_VECTOR_ELT(contents, 388, ScalarInteger(internal->dim_n_I_hosp_D_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 389, ScalarInteger(internal->dim_n_I_hosp_D_unconf_to_conf_3));
  SET_VECTOR_ELT(contents, 390, ScalarInteger(internal->dim_n_I_hosp_R_unconf_to_conf));
  SET_VECTOR_ELT(contents, 391, ScalarInteger(internal->dim_n_I_hosp_R_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 392, ScalarInteger(internal->dim_n_I_hosp_R_unconf_to_conf_12));
  SET_VECTOR_ELT(contents, 393, ScalarInteger(internal->dim_n_I_hosp_R_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 394, ScalarInteger(internal->dim_n_I_hosp_R_unconf_to_conf_3));
  SET_VECTOR_ELT(contents, 395, ScalarInteger(internal->dim_n_I_ICU_D_unconf_to_conf));
  SET_VECTOR_ELT(contents, 396, ScalarInteger(internal->dim_n_I_ICU_D_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 397, ScalarInteger(internal->dim_n_I_ICU_D_unconf_to_conf_12));
  SET_VECTOR_ELT(contents, 398, ScalarInteger(internal->dim_n_I_ICU_D_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 399, ScalarInteger(internal->dim_n_I_ICU_D_unconf_to_conf_3));
  SET_VECTOR_ELT(contents, 400, ScalarInteger(internal->dim_n_I_ICU_R_unconf_to_conf));
  SET_VECTOR_ELT(contents, 401, ScalarInteger(internal->dim_n_I_ICU_R_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 402, ScalarInteger(internal->dim_n_I_ICU_R_unconf_to_conf_12));
  SET_VECTOR_ELT(contents, 403, ScalarInteger(internal->dim_n_I_ICU_R_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 404, ScalarInteger(internal->dim_n_I_ICU_R_unconf_to_conf_3));
  SET_VECTOR_ELT(contents, 405, ScalarInteger(internal->dim_n_I_triage_D_unconf_to_conf));
  SET_VECTOR_ELT(contents, 406, ScalarInteger(internal->dim_n_I_triage_D_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 407, ScalarInteger(internal->dim_n_I_triage_D_unconf_to_conf_12));
  SET_VECTOR_ELT(contents, 408, ScalarInteger(internal->dim_n_I_triage_D_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 409, ScalarInteger(internal->dim_n_I_triage_D_unconf_to_conf_3));
  SET_VECTOR_ELT(contents, 410, ScalarInteger(internal->dim_n_I_triage_R_unconf_to_conf));
  SET_VECTOR_ELT(contents, 411, ScalarInteger(internal->dim_n_I_triage_R_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 412, ScalarInteger(internal->dim_n_I_triage_R_unconf_to_conf_12));
  SET_VECTOR_ELT(contents, 413, ScalarInteger(internal->dim_n_I_triage_R_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 414, ScalarInteger(internal->dim_n_I_triage_R_unconf_to_conf_3));
  SET_VECTOR_ELT(contents, 415, ScalarInteger(internal->dim_n_II_asympt));
  SET_VECTOR_ELT(contents, 416, ScalarInteger(internal->dim_n_II_asympt_1));
  SET_VECTOR_ELT(contents, 417, ScalarInteger(internal->dim_n_II_asympt_12));
  SET_VECTOR_ELT(contents, 418, ScalarInteger(internal->dim_n_II_asympt_2));
  SET_VECTOR_ELT(contents, 419, ScalarInteger(internal->dim_n_II_asympt_3));
  SET_VECTOR_ELT(contents, 420, ScalarInteger(internal->dim_n_II_comm_D));
  SET_VECTOR_ELT(contents, 421, ScalarInteger(internal->dim_n_II_comm_D_1));
  SET_VECTOR_ELT(contents, 422, ScalarInteger(internal->dim_n_II_comm_D_12));
  SET_VECTOR_ELT(contents, 423, ScalarInteger(internal->dim_n_II_comm_D_2));
  SET_VECTOR_ELT(contents, 424, ScalarInteger(internal->dim_n_II_comm_D_3));
  SET_VECTOR_ELT(contents, 425, ScalarInteger(internal->dim_n_II_hosp_D_conf));
  SET_VECTOR_ELT(contents, 426, ScalarInteger(internal->dim_n_II_hosp_D_conf_1));
  SET_VECTOR_ELT(contents, 427, ScalarInteger(internal->dim_n_II_hosp_D_conf_12));
  SET_VECTOR_ELT(contents, 428, ScalarInteger(internal->dim_n_II_hosp_D_conf_2));
  SET_VECTOR_ELT(contents, 429, ScalarInteger(internal->dim_n_II_hosp_D_conf_3));
  SET_VECTOR_ELT(contents, 430, ScalarInteger(internal->dim_n_II_hosp_D_unconf));
  SET_VECTOR_ELT(contents, 431, ScalarInteger(internal->dim_n_II_hosp_D_unconf_1));
  SET_VECTOR_ELT(contents, 432, ScalarInteger(internal->dim_n_II_hosp_D_unconf_12));
  SET_VECTOR_ELT(contents, 433, ScalarInteger(internal->dim_n_II_hosp_D_unconf_2));
  SET_VECTOR_ELT(contents, 434, ScalarInteger(internal->dim_n_II_hosp_D_unconf_3));
  SET_VECTOR_ELT(contents, 435, ScalarInteger(internal->dim_n_II_hosp_R_conf));
  SET_VECTOR_ELT(contents, 436, ScalarInteger(internal->dim_n_II_hosp_R_conf_1));
  SET_VECTOR_ELT(contents, 437, ScalarInteger(internal->dim_n_II_hosp_R_conf_12));
  SET_VECTOR_ELT(contents, 438, ScalarInteger(internal->dim_n_II_hosp_R_conf_2));
  SET_VECTOR_ELT(contents, 439, ScalarInteger(internal->dim_n_II_hosp_R_conf_3));
  SET_VECTOR_ELT(contents, 440, ScalarInteger(internal->dim_n_II_hosp_R_unconf));
  SET_VECTOR_ELT(contents, 441, ScalarInteger(internal->dim_n_II_hosp_R_unconf_1));
  SET_VECTOR_ELT(contents, 442, ScalarInteger(internal->dim_n_II_hosp_R_unconf_12));
  SET_VECTOR_ELT(contents, 443, ScalarInteger(internal->dim_n_II_hosp_R_unconf_2));
  SET_VECTOR_ELT(contents, 444, ScalarInteger(internal->dim_n_II_hosp_R_unconf_3));
  SET_VECTOR_ELT(contents, 445, ScalarInteger(internal->dim_n_II_ICU_D_conf));
  SET_VECTOR_ELT(contents, 446, ScalarInteger(internal->dim_n_II_ICU_D_conf_1));
  SET_VECTOR_ELT(contents, 447, ScalarInteger(internal->dim_n_II_ICU_D_conf_12));
  SET_VECTOR_ELT(contents, 448, ScalarInteger(internal->dim_n_II_ICU_D_conf_2));
  SET_VECTOR_ELT(contents, 449, ScalarInteger(internal->dim_n_II_ICU_D_conf_3));
  SET_VECTOR_ELT(contents, 450, ScalarInteger(internal->dim_n_II_ICU_D_unconf));
  SET_VECTOR_ELT(contents, 451, ScalarInteger(internal->dim_n_II_ICU_D_unconf_1));
  SET_VECTOR_ELT(contents, 452, ScalarInteger(internal->dim_n_II_ICU_D_unconf_12));
  SET_VECTOR_ELT(contents, 453, ScalarInteger(internal->dim_n_II_ICU_D_unconf_2));
  SET_VECTOR_ELT(contents, 454, ScalarInteger(internal->dim_n_II_ICU_D_unconf_3));
  SET_VECTOR_ELT(contents, 455, ScalarInteger(internal->dim_n_II_ICU_R_conf));
  SET_VECTOR_ELT(contents, 456, ScalarInteger(internal->dim_n_II_ICU_R_conf_1));
  SET_VECTOR_ELT(contents, 457, ScalarInteger(internal->dim_n_II_ICU_R_conf_12));
  SET_VECTOR_ELT(contents, 458, ScalarInteger(internal->dim_n_II_ICU_R_conf_2));
  SET_VECTOR_ELT(contents, 459, ScalarInteger(internal->dim_n_II_ICU_R_conf_3));
  SET_VECTOR_ELT(contents, 460, ScalarInteger(internal->dim_n_II_ICU_R_unconf));
  SET_VECTOR_ELT(contents, 461, ScalarInteger(internal->dim_n_II_ICU_R_unconf_1));
  SET_VECTOR_ELT(contents, 462, ScalarInteger(internal->dim_n_II_ICU_R_unconf_12));
  SET_VECTOR_ELT(contents, 463, ScalarInteger(internal->dim_n_II_ICU_R_unconf_2));
  SET_VECTOR_ELT(contents, 464, ScalarInteger(internal->dim_n_II_ICU_R_unconf_3));
  SET_VECTOR_ELT(contents, 465, ScalarInteger(internal->dim_n_II_ILI));
  SET_VECTOR_ELT(contents, 466, ScalarInteger(internal->dim_n_II_ILI_1));
  SET_VECTOR_ELT(contents, 467, ScalarInteger(internal->dim_n_II_ILI_12));
  SET_VECTOR_ELT(contents, 468, ScalarInteger(internal->dim_n_II_ILI_2));
  SET_VECTOR_ELT(contents, 469, ScalarInteger(internal->dim_n_II_ILI_3));
  SET_VECTOR_ELT(contents, 470, ScalarInteger(internal->dim_n_II_mild));
  SET_VECTOR_ELT(contents, 471, ScalarInteger(internal->dim_n_II_mild_1));
  SET_VECTOR_ELT(contents, 472, ScalarInteger(internal->dim_n_II_mild_12));
  SET_VECTOR_ELT(contents, 473, ScalarInteger(internal->dim_n_II_mild_2));
  SET_VECTOR_ELT(contents, 474, ScalarInteger(internal->dim_n_II_mild_3));
  SET_VECTOR_ELT(contents, 475, ScalarInteger(internal->dim_n_II_triage_D_conf));
  SET_VECTOR_ELT(contents, 476, ScalarInteger(internal->dim_n_II_triage_D_conf_1));
  SET_VECTOR_ELT(contents, 477, ScalarInteger(internal->dim_n_II_triage_D_conf_12));
  SET_VECTOR_ELT(contents, 478, ScalarInteger(internal->dim_n_II_triage_D_conf_2));
  SET_VECTOR_ELT(contents, 479, ScalarInteger(internal->dim_n_II_triage_D_conf_3));
  SET_VECTOR_ELT(contents, 480, ScalarInteger(internal->dim_n_II_triage_D_unconf));
  SET_VECTOR_ELT(contents, 481, ScalarInteger(internal->dim_n_II_triage_D_unconf_1));
  SET_VECTOR_ELT(contents, 482, ScalarInteger(internal->dim_n_II_triage_D_unconf_12));
  SET_VECTOR_ELT(contents, 483, ScalarInteger(internal->dim_n_II_triage_D_unconf_2));
  SET_VECTOR_ELT(contents, 484, ScalarInteger(internal->dim_n_II_triage_D_unconf_3));
  SET_VECTOR_ELT(contents, 485, ScalarInteger(internal->dim_n_II_triage_R_conf));
  SET_VECTOR_ELT(contents, 486, ScalarInteger(internal->dim_n_II_triage_R_conf_1));
  SET_VECTOR_ELT(contents, 487, ScalarInteger(internal->dim_n_II_triage_R_conf_12));
  SET_VECTOR_ELT(contents, 488, ScalarInteger(internal->dim_n_II_triage_R_conf_2));
  SET_VECTOR_ELT(contents, 489, ScalarInteger(internal->dim_n_II_triage_R_conf_3));
  SET_VECTOR_ELT(contents, 490, ScalarInteger(internal->dim_n_II_triage_R_unconf));
  SET_VECTOR_ELT(contents, 491, ScalarInteger(internal->dim_n_II_triage_R_unconf_1));
  SET_VECTOR_ELT(contents, 492, ScalarInteger(internal->dim_n_II_triage_R_unconf_12));
  SET_VECTOR_ELT(contents, 493, ScalarInteger(internal->dim_n_II_triage_R_unconf_2));
  SET_VECTOR_ELT(contents, 494, ScalarInteger(internal->dim_n_II_triage_R_unconf_3));
  SET_VECTOR_ELT(contents, 495, ScalarInteger(internal->dim_n_ILI_to_comm_D));
  SET_VECTOR_ELT(contents, 496, ScalarInteger(internal->dim_n_ILI_to_comm_D_1));
  SET_VECTOR_ELT(contents, 497, ScalarInteger(internal->dim_n_ILI_to_comm_D_2));
  SET_VECTOR_ELT(contents, 498, ScalarInteger(internal->dim_n_ILI_to_hosp));
  SET_VECTOR_ELT(contents, 499, ScalarInteger(internal->dim_n_ILI_to_hosp_1));
  SET_VECTOR_ELT(contents, 500, ScalarInteger(internal->dim_n_ILI_to_hosp_2));
  SET_VECTOR_ELT(contents, 501, ScalarInteger(internal->dim_n_ILI_to_hosp_D));
  SET_VECTOR_ELT(contents, 502, ScalarInteger(internal->dim_n_ILI_to_hosp_D_1));
  SET_VECTOR_ELT(contents, 503, ScalarInteger(internal->dim_n_ILI_to_hosp_D_2));
  SET_VECTOR_ELT(contents, 504, ScalarInteger(internal->dim_n_ILI_to_hosp_D_conf));
  SET_VECTOR_ELT(contents, 505, ScalarInteger(internal->dim_n_ILI_to_hosp_D_conf_1));
  SET_VECTOR_ELT(contents, 506, ScalarInteger(internal->dim_n_ILI_to_hosp_D_conf_2));
  SET_VECTOR_ELT(contents, 507, ScalarInteger(internal->dim_n_ILI_to_hosp_R));
  SET_VECTOR_ELT(contents, 508, ScalarInteger(internal->dim_n_ILI_to_hosp_R_1));
  SET_VECTOR_ELT(contents, 509, ScalarInteger(internal->dim_n_ILI_to_hosp_R_2));
  SET_VECTOR_ELT(contents, 510, ScalarInteger(internal->dim_n_ILI_to_hosp_R_conf));
  SET_VECTOR_ELT(contents, 511, ScalarInteger(internal->dim_n_ILI_to_hosp_R_conf_1));
  SET_VECTOR_ELT(contents, 512, ScalarInteger(internal->dim_n_ILI_to_hosp_R_conf_2));
  SET_VECTOR_ELT(contents, 513, ScalarInteger(internal->dim_n_ILI_to_triage));
  SET_VECTOR_ELT(contents, 514, ScalarInteger(internal->dim_n_ILI_to_triage_1));
  SET_VECTOR_ELT(contents, 515, ScalarInteger(internal->dim_n_ILI_to_triage_2));
  SET_VECTOR_ELT(contents, 516, ScalarInteger(internal->dim_n_ILI_to_triage_D));
  SET_VECTOR_ELT(contents, 517, ScalarInteger(internal->dim_n_ILI_to_triage_D_1));
  SET_VECTOR_ELT(contents, 518, ScalarInteger(internal->dim_n_ILI_to_triage_D_2));
  SET_VECTOR_ELT(contents, 519, ScalarInteger(internal->dim_n_ILI_to_triage_D_conf));
  SET_VECTOR_ELT(contents, 520, ScalarInteger(internal->dim_n_ILI_to_triage_D_conf_1));
  SET_VECTOR_ELT(contents, 521, ScalarInteger(internal->dim_n_ILI_to_triage_D_conf_2));
  SET_VECTOR_ELT(contents, 522, ScalarInteger(internal->dim_n_ILI_to_triage_R));
  SET_VECTOR_ELT(contents, 523, ScalarInteger(internal->dim_n_ILI_to_triage_R_1));
  SET_VECTOR_ELT(contents, 524, ScalarInteger(internal->dim_n_ILI_to_triage_R_2));
  SET_VECTOR_ELT(contents, 525, ScalarInteger(internal->dim_n_ILI_to_triage_R_conf));
  SET_VECTOR_ELT(contents, 526, ScalarInteger(internal->dim_n_ILI_to_triage_R_conf_1));
  SET_VECTOR_ELT(contents, 527, ScalarInteger(internal->dim_n_ILI_to_triage_R_conf_2));
  SET_VECTOR_ELT(contents, 528, ScalarInteger(internal->dim_n_R_pre));
  SET_VECTOR_ELT(contents, 529, ScalarInteger(internal->dim_n_R_pre_1));
  SET_VECTOR_ELT(contents, 530, ScalarInteger(internal->dim_n_R_pre_2));
  SET_VECTOR_ELT(contents, 531, ScalarInteger(internal->dim_n_R_stepdown_conf));
  SET_VECTOR_ELT(contents, 532, ScalarInteger(internal->dim_n_R_stepdown_conf_1));
  SET_VECTOR_ELT(contents, 533, ScalarInteger(internal->dim_n_R_stepdown_conf_2));
  SET_VECTOR_ELT(contents, 534, ScalarInteger(internal->dim_n_R_stepdown_unconf));
  SET_VECTOR_ELT(contents, 535, ScalarInteger(internal->dim_n_R_stepdown_unconf_1));
  SET_VECTOR_ELT(contents, 536, ScalarInteger(internal->dim_n_R_stepdown_unconf_2));
  SET_VECTOR_ELT(contents, 537, ScalarInteger(internal->dim_n_R_stepdown_unconf_to_conf));
  SET_VECTOR_ELT(contents, 538, ScalarInteger(internal->dim_n_R_stepdown_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 539, ScalarInteger(internal->dim_n_R_stepdown_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 540, ScalarInteger(internal->dim_n_SE));
  SET_VECTOR_ELT(contents, 541, ScalarInteger(internal->dim_N_tot));
  SET_VECTOR_ELT(contents, 542, ScalarInteger(internal->dim_new_I_hosp_D_conf));
  SET_VECTOR_ELT(contents, 543, ScalarInteger(internal->dim_new_I_hosp_D_conf_1));
  SET_VECTOR_ELT(contents, 544, ScalarInteger(internal->dim_new_I_hosp_D_conf_12));
  SET_VECTOR_ELT(contents, 545, ScalarInteger(internal->dim_new_I_hosp_D_conf_2));
  SET_VECTOR_ELT(contents, 546, ScalarInteger(internal->dim_new_I_hosp_D_conf_3));
  SET_VECTOR_ELT(contents, 547, ScalarInteger(internal->dim_new_I_hosp_D_unconf));
  SET_VECTOR_ELT(contents, 548, ScalarInteger(internal->dim_new_I_hosp_D_unconf_1));
  SET_VECTOR_ELT(contents, 549, ScalarInteger(internal->dim_new_I_hosp_D_unconf_12));
  SET_VECTOR_ELT(contents, 550, ScalarInteger(internal->dim_new_I_hosp_D_unconf_2));
  SET_VECTOR_ELT(contents, 551, ScalarInteger(internal->dim_new_I_hosp_D_unconf_3));
  SET_VECTOR_ELT(contents, 552, ScalarInteger(internal->dim_new_I_hosp_R_conf));
  SET_VECTOR_ELT(contents, 553, ScalarInteger(internal->dim_new_I_hosp_R_conf_1));
  SET_VECTOR_ELT(contents, 554, ScalarInteger(internal->dim_new_I_hosp_R_conf_12));
  SET_VECTOR_ELT(contents, 555, ScalarInteger(internal->dim_new_I_hosp_R_conf_2));
  SET_VECTOR_ELT(contents, 556, ScalarInteger(internal->dim_new_I_hosp_R_conf_3));
  SET_VECTOR_ELT(contents, 557, ScalarInteger(internal->dim_new_I_hosp_R_unconf));
  SET_VECTOR_ELT(contents, 558, ScalarInteger(internal->dim_new_I_hosp_R_unconf_1));
  SET_VECTOR_ELT(contents, 559, ScalarInteger(internal->dim_new_I_hosp_R_unconf_12));
  SET_VECTOR_ELT(contents, 560, ScalarInteger(internal->dim_new_I_hosp_R_unconf_2));
  SET_VECTOR_ELT(contents, 561, ScalarInteger(internal->dim_new_I_hosp_R_unconf_3));
  SET_VECTOR_ELT(contents, 562, ScalarInteger(internal->dim_new_I_ICU_D_conf));
  SET_VECTOR_ELT(contents, 563, ScalarInteger(internal->dim_new_I_ICU_D_conf_1));
  SET_VECTOR_ELT(contents, 564, ScalarInteger(internal->dim_new_I_ICU_D_conf_12));
  SET_VECTOR_ELT(contents, 565, ScalarInteger(internal->dim_new_I_ICU_D_conf_2));
  SET_VECTOR_ELT(contents, 566, ScalarInteger(internal->dim_new_I_ICU_D_conf_3));
  SET_VECTOR_ELT(contents, 567, ScalarInteger(internal->dim_new_I_ICU_D_unconf));
  SET_VECTOR_ELT(contents, 568, ScalarInteger(internal->dim_new_I_ICU_D_unconf_1));
  SET_VECTOR_ELT(contents, 569, ScalarInteger(internal->dim_new_I_ICU_D_unconf_12));
  SET_VECTOR_ELT(contents, 570, ScalarInteger(internal->dim_new_I_ICU_D_unconf_2));
  SET_VECTOR_ELT(contents, 571, ScalarInteger(internal->dim_new_I_ICU_D_unconf_3));
  SET_VECTOR_ELT(contents, 572, ScalarInteger(internal->dim_new_I_ICU_R_conf));
  SET_VECTOR_ELT(contents, 573, ScalarInteger(internal->dim_new_I_ICU_R_conf_1));
  SET_VECTOR_ELT(contents, 574, ScalarInteger(internal->dim_new_I_ICU_R_conf_12));
  SET_VECTOR_ELT(contents, 575, ScalarInteger(internal->dim_new_I_ICU_R_conf_2));
  SET_VECTOR_ELT(contents, 576, ScalarInteger(internal->dim_new_I_ICU_R_conf_3));
  SET_VECTOR_ELT(contents, 577, ScalarInteger(internal->dim_new_I_ICU_R_unconf));
  SET_VECTOR_ELT(contents, 578, ScalarInteger(internal->dim_new_I_ICU_R_unconf_1));
  SET_VECTOR_ELT(contents, 579, ScalarInteger(internal->dim_new_I_ICU_R_unconf_12));
  SET_VECTOR_ELT(contents, 580, ScalarInteger(internal->dim_new_I_ICU_R_unconf_2));
  SET_VECTOR_ELT(contents, 581, ScalarInteger(internal->dim_new_I_ICU_R_unconf_3));
  SET_VECTOR_ELT(contents, 582, ScalarInteger(internal->dim_new_I_triage_D_conf));
  SET_VECTOR_ELT(contents, 583, ScalarInteger(internal->dim_new_I_triage_D_conf_1));
  SET_VECTOR_ELT(contents, 584, ScalarInteger(internal->dim_new_I_triage_D_conf_12));
  SET_VECTOR_ELT(contents, 585, ScalarInteger(internal->dim_new_I_triage_D_conf_2));
  SET_VECTOR_ELT(contents, 586, ScalarInteger(internal->dim_new_I_triage_D_conf_3));
  SET_VECTOR_ELT(contents, 587, ScalarInteger(internal->dim_new_I_triage_D_unconf));
  SET_VECTOR_ELT(contents, 588, ScalarInteger(internal->dim_new_I_triage_D_unconf_1));
  SET_VECTOR_ELT(contents, 589, ScalarInteger(internal->dim_new_I_triage_D_unconf_12));
  SET_VECTOR_ELT(contents, 590, ScalarInteger(internal->dim_new_I_triage_D_unconf_2));
  SET_VECTOR_ELT(contents, 591, ScalarInteger(internal->dim_new_I_triage_D_unconf_3));
  SET_VECTOR_ELT(contents, 592, ScalarInteger(internal->dim_new_I_triage_R_conf));
  SET_VECTOR_ELT(contents, 593, ScalarInteger(internal->dim_new_I_triage_R_conf_1));
  SET_VECTOR_ELT(contents, 594, ScalarInteger(internal->dim_new_I_triage_R_conf_12));
  SET_VECTOR_ELT(contents, 595, ScalarInteger(internal->dim_new_I_triage_R_conf_2));
  SET_VECTOR_ELT(contents, 596, ScalarInteger(internal->dim_new_I_triage_R_conf_3));
  SET_VECTOR_ELT(contents, 597, ScalarInteger(internal->dim_new_I_triage_R_unconf));
  SET_VECTOR_ELT(contents, 598, ScalarInteger(internal->dim_new_I_triage_R_unconf_1));
  SET_VECTOR_ELT(contents, 599, ScalarInteger(internal->dim_new_I_triage_R_unconf_12));
  SET_VECTOR_ELT(contents, 600, ScalarInteger(internal->dim_new_I_triage_R_unconf_2));
  SET_VECTOR_ELT(contents, 601, ScalarInteger(internal->dim_new_I_triage_R_unconf_3));
  SET_VECTOR_ELT(contents, 602, ScalarInteger(internal->dim_new_R_stepdown_conf));
  SET_VECTOR_ELT(contents, 603, ScalarInteger(internal->dim_new_R_stepdown_conf_1));
  SET_VECTOR_ELT(contents, 604, ScalarInteger(internal->dim_new_R_stepdown_conf_2));
  SET_VECTOR_ELT(contents, 605, ScalarInteger(internal->dim_new_R_stepdown_unconf));
  SET_VECTOR_ELT(contents, 606, ScalarInteger(internal->dim_new_R_stepdown_unconf_1));
  SET_VECTOR_ELT(contents, 607, ScalarInteger(internal->dim_new_R_stepdown_unconf_2));
  SET_VECTOR_ELT(contents, 608, ScalarInteger(internal->dim_p_admit_conf));
  SET_VECTOR_ELT(contents, 609, ScalarInteger(internal->dim_p_asympt));
  SET_VECTOR_ELT(contents, 610, ScalarInteger(internal->dim_p_death_comm));
  SET_VECTOR_ELT(contents, 611, ScalarInteger(internal->dim_p_death_hosp_D));
  SET_VECTOR_ELT(contents, 612, ScalarInteger(internal->dim_p_death_ICU));
  SET_VECTOR_ELT(contents, 613, ScalarInteger(internal->dim_p_ICU_hosp));
  SET_VECTOR_ELT(contents, 614, ScalarInteger(internal->dim_p_R_pre));
  SET_VECTOR_ELT(contents, 615, ScalarInteger(internal->dim_p_recov_ILI));
  SET_VECTOR_ELT(contents, 616, ScalarInteger(internal->dim_p_SE));
  SET_VECTOR_ELT(contents, 617, ScalarInteger(internal->dim_p_seroconversion));
  SET_VECTOR_ELT(contents, 618, ScalarInteger(internal->dim_p_sympt_ILI));
  SET_VECTOR_ELT(contents, 619, ScalarInteger(internal->dim_R));
  SET_VECTOR_ELT(contents, 620, ScalarInteger(internal->dim_R_neg));
  SET_VECTOR_ELT(contents, 621, ScalarInteger(internal->dim_R_pos));
  SET_VECTOR_ELT(contents, 622, ScalarInteger(internal->dim_R_pre));
  SET_VECTOR_ELT(contents, 623, ScalarInteger(internal->dim_R_pre_1));
  SET_VECTOR_ELT(contents, 624, ScalarInteger(internal->dim_R_pre_2));
  SET_VECTOR_ELT(contents, 625, ScalarInteger(internal->dim_R_stepdown_conf));
  SET_VECTOR_ELT(contents, 626, ScalarInteger(internal->dim_R_stepdown_conf_1));
  SET_VECTOR_ELT(contents, 627, ScalarInteger(internal->dim_R_stepdown_conf_2));
  SET_VECTOR_ELT(contents, 628, ScalarInteger(internal->dim_R_stepdown_unconf));
  SET_VECTOR_ELT(contents, 629, ScalarInteger(internal->dim_R_stepdown_unconf_1));
  SET_VECTOR_ELT(contents, 630, ScalarInteger(internal->dim_R_stepdown_unconf_2));
  SET_VECTOR_ELT(contents, 631, ScalarInteger(internal->dim_R0));
  SET_VECTOR_ELT(contents, 632, ScalarInteger(internal->dim_R0_neg));
  SET_VECTOR_ELT(contents, 633, ScalarInteger(internal->dim_R0_pos));
  SET_VECTOR_ELT(contents, 634, ScalarInteger(internal->dim_R0_pre));
  SET_VECTOR_ELT(contents, 635, ScalarInteger(internal->dim_R0_pre_1));
  SET_VECTOR_ELT(contents, 636, ScalarInteger(internal->dim_R0_pre_2));
  SET_VECTOR_ELT(contents, 637, ScalarInteger(internal->dim_R0_stepdown_conf));
  SET_VECTOR_ELT(contents, 638, ScalarInteger(internal->dim_R0_stepdown_conf_1));
  SET_VECTOR_ELT(contents, 639, ScalarInteger(internal->dim_R0_stepdown_conf_2));
  SET_VECTOR_ELT(contents, 640, ScalarInteger(internal->dim_R0_stepdown_unconf));
  SET_VECTOR_ELT(contents, 641, ScalarInteger(internal->dim_R0_stepdown_unconf_1));
  SET_VECTOR_ELT(contents, 642, ScalarInteger(internal->dim_R0_stepdown_unconf_2));
  SET_VECTOR_ELT(contents, 643, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 644, ScalarInteger(internal->dim_s_ij));
  SET_VECTOR_ELT(contents, 645, ScalarInteger(internal->dim_s_ij_1));
  SET_VECTOR_ELT(contents, 646, ScalarInteger(internal->dim_s_ij_2));
  SET_VECTOR_ELT(contents, 647, ScalarInteger(internal->dim_S0));
  SET_VECTOR_ELT(contents, 648, ScalarInteger(internal->dim_trans_increase));
  SET_VECTOR_ELT(contents, 649, ScalarInteger(internal->dim_trans_increase_1));
  SET_VECTOR_ELT(contents, 650, ScalarInteger(internal->dim_trans_increase_2));
  SET_VECTOR_ELT(contents, 651, ScalarInteger(internal->dim_trans_profile));
  SET_VECTOR_ELT(contents, 652, ScalarInteger(internal->dim_trans_profile_1));
  SET_VECTOR_ELT(contents, 653, ScalarInteger(internal->dim_trans_profile_2));
  SET_VECTOR_ELT(contents, 654, ScalarReal(internal->dt));
  SEXP E0 = PROTECT(allocVector(REALSXP, internal->dim_E0));
  memcpy(REAL(E0), internal->E0, internal->dim_E0 * sizeof(double));
  odin_set_dim(E0, 3, internal->dim_E0_1, internal->dim_E0_2, internal->dim_E0_3);
  SET_VECTOR_ELT(contents, 655, E0);
  SET_VECTOR_ELT(contents, 656, ScalarReal(internal->gamma_asympt));
  SET_VECTOR_ELT(contents, 657, ScalarReal(internal->gamma_comm_D));
  SET_VECTOR_ELT(contents, 658, ScalarReal(internal->gamma_E));
  SET_VECTOR_ELT(contents, 659, ScalarReal(internal->gamma_hosp_D));
  SET_VECTOR_ELT(contents, 660, ScalarReal(internal->gamma_hosp_R));
  SET_VECTOR_ELT(contents, 661, ScalarReal(internal->gamma_ICU_D));
  SET_VECTOR_ELT(contents, 662, ScalarReal(internal->gamma_ICU_R));
  SET_VECTOR_ELT(contents, 663, ScalarReal(internal->gamma_ILI));
  SET_VECTOR_ELT(contents, 664, ScalarReal(internal->gamma_mild));
  SET_VECTOR_ELT(contents, 665, ScalarReal(internal->gamma_R_pre));
  SET_VECTOR_ELT(contents, 666, ScalarReal(internal->gamma_stepdown));
  SET_VECTOR_ELT(contents, 667, ScalarReal(internal->gamma_test));
  SET_VECTOR_ELT(contents, 668, ScalarReal(internal->gamma_triage));
  SET_VECTOR_ELT(contents, 669, ScalarReal(internal->hosp_transmission));
  SEXP I_with_diff_trans = PROTECT(allocVector(REALSXP, internal->dim_I_with_diff_trans));
  memcpy(REAL(I_with_diff_trans), internal->I_with_diff_trans, internal->dim_I_with_diff_trans * sizeof(double));
  odin_set_dim(I_with_diff_trans, 2, internal->dim_I_with_diff_trans_1, internal->dim_I_with_diff_trans_2);
  SET_VECTOR_ELT(contents, 670, I_with_diff_trans);
  SEXP I0_asympt = PROTECT(allocVector(REALSXP, internal->dim_I0_asympt));
  memcpy(REAL(I0_asympt), internal->I0_asympt, internal->dim_I0_asympt * sizeof(double));
  odin_set_dim(I0_asympt, 3, internal->dim_I0_asympt_1, internal->dim_I0_asympt_2, internal->dim_I0_asympt_3);
  SET_VECTOR_ELT(contents, 671, I0_asympt);
  ...
  SET_VECTOR_ELT(contents, 672, I0_comm_D);
  ...
  SET_VECTOR_ELT(contents, 673, I0_hosp_D_conf);
  ...
  SET_VECTOR_ELT(contents, 674, I0_hosp_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 675, I0_hosp_R_conf);
  ...
  SET_VECTOR_ELT(contents, 676, I0_hosp_R_unconf);
  ...
  SET_VECTOR_ELT(contents, 677, I0_ICU_D_conf);
  ...
  SET_VECTOR_ELT(contents, 678, I0_ICU_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 679, I0_ICU_R_conf);
  ...
  SET_VECTOR_ELT(contents, 680, I0_ICU_R_unconf);
  SEXP I0_ILI = PROTECT(allocVector(REALSXP, internal->dim_I0_ILI));
  memcpy(REAL(I0_ILI), internal->I0_ILI, internal->dim_I0_ILI * sizeof(double));
  odin_set_dim(I0_ILI, 3, internal->dim_I0_ILI_1, internal->dim_I0_ILI_2, internal->dim_I0_ILI_3);
  SET_VECTOR_ELT(contents, 681, I0_ILI);
  SEXP I0_mild = PROTECT(allocVector(REALSXP, internal->dim_I0_mild));
  memcpy(REAL(I0_mild), internal->I0_mild, internal->dim_I0_mild * sizeof(double));
  odin_set_dim(I0_mild, 3, internal->dim_I0_mild_1, internal->dim_I0_mild_2, internal->dim_I0_mild_3);
  SET_VECTOR_ELT(contents, 682, I0_mild);
  ...
  SET_VECTOR_ELT(contents, 683, I0_triage_D_conf);
  ...
  SET_VECTOR_ELT(contents, 684, I0_triage_D_unconf);
  ...
  odin_set_dim(I0_triage_R, 4, internal->dim_I0_triage_R_1, internal->dim_I0_triage_R_2, internal->dim_I0_triage_R_3, internal->dim_I0_triage_R_4);
  SET_VECTOR_ELT(contents, 685, I0_triage_R);
  ...
  SET_VECTOR_ELT(contents, 686, I0_triage_R_conf);
  ...
  SET_VECTOR_ELT(contents, 687, I0_triage_R_unconf);
  SET_VECTOR_ELT(contents, 688, ScalarReal(internal->ICU_transmission));
  SET_VECTOR_ELT(contents, 689, ScalarReal(internal->initial_cum_admit_conf));
  SET_VECTOR_ELT(contents, 690, ScalarReal(internal->initial_cum_new_conf));
  ...
  SET_VECTOR_ELT(contents, 691, initial_D_comm);
  ...
  SET_VECTOR_ELT(contents, 692, initial_D_hosp);
  SEXP initial_E = PROTECT(allocVector(REALSXP, internal->dim_E));
  memcpy(REAL(initial_E), internal->initial_E, internal->dim_E * sizeof(double));
  odin_set_dim(initial_E, 3, internal->dim_E_1, internal->dim_E_2, internal->dim_E_3);
  SET_VECTOR_ELT(contents, 693, initial_E);
  SEXP initial_I_asympt = PROTECT(allocVector(REALSXP, internal->dim_I_asympt));
  memcpy(REAL(initial_I_asympt), internal->initial_I_asympt, internal->dim_I_asympt * sizeof(double));
  odin_set_dim(initial_I_asympt, 3, internal->dim_I_asympt_1, internal->dim_I_asympt_2, internal->dim_I_asympt_3);
  SET_VECTOR_ELT(contents, 694, initial_I_asympt);
  ...
  SET_VECTOR_ELT(contents, 695, initial_I_comm_D);
  ...
  SET_VECTOR_ELT(contents, 696, initial_I_hosp_D_conf);
  ...
  SET_VECTOR_ELT(contents, 697, initial_I_hosp_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 698, initial_I_hosp_R_conf);
  ...
  SET_VECTOR_ELT(contents, 699, initial_I_hosp_R_unconf);
  ...
  SET_VECTOR_ELT(contents, 700, initial_I_ICU_D_conf);
  ...
  SET_VECTOR_ELT(contents, 701, initial_I_ICU_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 702, initial_I_ICU_R_conf);
  ...
  SET_VECTOR_ELT(contents, 703, initial_I_ICU_R_unconf);
  SEXP initial_I_ILI = PROTECT(allocVector(REALSXP, internal->dim_I_ILI));
  memcpy(REAL(initial_I_ILI), internal->initial_I_ILI, internal->dim_I_ILI * sizeof(double));
  odin_set_dim(initial_I_ILI, 3, internal->dim_I_ILI_1, internal->dim_I_ILI_2, internal->dim_I_ILI_3);
  SET_VECTOR_ELT(contents, 704, initial_I_ILI);
  SEXP initial_I_mild = PROTECT(allocVector(REALSXP, internal->dim_I_mild));
  memcpy(REAL(initial_I_mild), internal->initial_I_mild, internal->dim_I_mild * sizeof(double));
  odin_set_dim(initial_I_mild, 3, internal->dim_I_mild_1, internal->dim_I_mild_2, internal->dim_I_mild_3);
  SET_VECTOR_ELT(contents, 705, initial_I_mild);
  ...
  SET_VECTOR_ELT(contents, 706, initial_I_triage_D_conf);
  ...
  SET_VECTOR_ELT(contents, 707, initial_I_triage_D_unconf);
  ...
  odin_set_dim(initial_I_triage_R, 4, internal->dim_I_triage_R_1, internal->dim_I_triage_R_2, internal->dim_I_triage_R_3, internal->dim_I_triage_R_4);
  SET_VECTOR_ELT(contents, 708, initial_I_triage_R);
  ...
  SET_VECTOR_ELT(contents, 709, initial_I_triage_R_conf);
  ...
  SET_VECTOR_ELT(contents, 710, initial_I_triage_R_unconf);
  SEXP initial_R = PROTECT(allocVector(REALSXP, internal->dim_R));
  memcpy(REAL(initial_R), internal->initial_R, internal->dim_R * sizeof(double));
  SET_VECTOR_ELT(contents, 711, initial_R);
  ...
  SET_VECTOR_ELT(contents, 712, initial_R_neg);
  ...
  SET_VECTOR_ELT(contents, 713, initial_R_pos);
  ...
  SET_VECTOR_ELT(contents, 714, initial_R_pre);
  ...
  SET_VECTOR_ELT(contents, 715, initial_R_stepdown_conf);
  ...
  SET_VECTOR_ELT(contents, 716, initial_R_stepdown_unconf);
  SEXP initial_S = PROTECT(allocVector(REALSXP, internal->dim_S));
  memcpy(REAL(initial_S), internal->initial_S, internal->dim_S * sizeof(double));
  SET_VECTOR_ELT(contents, 717, initial_S);
  SEXP lambda = PROTECT(allocVector(REALSXP, internal->dim_lambda));
  memcpy(REAL(lambda), internal->lambda, internal->dim_lambda * sizeof(double));
  SET_VECTOR_ELT(contents, 719, lambda);
  SEXP m = PROTECT(allocVector(REALSXP, internal->dim_m));
  memcpy(REAL(m), internal->m, internal->dim_m * sizeof(double));
  odin_set_dim(m, 2, internal->dim_m_1, internal->dim_m_2);
  SET_VECTOR_ELT(contents, 720, m);
  SET_VECTOR_ELT(contents, 721, ScalarInteger(internal->N_age));
  ...
  SET_VECTOR_ELT(contents, 722, n_com_to_R_pre);
  ...
  SET_VECTOR_ELT(contents, 723, n_com_to_R_total);
  SEXP n_EE = PROTECT(allocVector(REALSXP, internal->dim_n_EE));
  memcpy(REAL(n_EE), internal->n_EE, internal->dim_n_EE * sizeof(double));
  odin_set_dim(n_EE, 3, internal->dim_n_EE_1, internal->dim_n_EE_2, internal->dim_n_EE_3);
  SET_VECTOR_ELT(contents, 724, n_EE);
  SEXP n_EI_asympt = PROTECT(allocVector(REALSXP, internal->dim_n_EI_asympt));
  memcpy(REAL(n_EI_asympt), internal->n_EI_asympt, internal->dim_n_EI_asympt * sizeof(double));
  odin_set_dim(n_EI_asympt, 2, internal->dim_n_EI_asympt_1, internal->dim_n_EI_asympt_2);
  SET_VECTOR_ELT(contents, 725, n_EI_asympt);
  SEXP n_EI_ILI = PROTECT(allocVector(REALSXP, internal->dim_n_EI_ILI));
  memcpy(REAL(n_EI_ILI), internal->n_EI_ILI, internal->dim_n_EI_ILI * sizeof(double));
  odin_set_dim(n_EI_ILI, 2, internal->dim_n_EI_ILI_1, internal->dim_n_EI_ILI_2);
  SET_VECTOR_ELT(contents, 726, n_EI_ILI);
  SEXP n_EI_mild = PROTECT(allocVector(REALSXP, internal->dim_n_EI_mild));
  memcpy(REAL(n_EI_mild), internal->n_EI_mild, internal->dim_n_EI_mild * sizeof(double));
  odin_set_dim(n_EI_mild, 2, internal->dim_n_EI_mild_1, internal->dim_n_EI_mild_2);
  SET_VECTOR_ELT(contents, 727, n_EI_mild);
  ...
  SET_VECTOR_ELT(contents, 728, n_hosp_non_ICU);
  ...
  SET_VECTOR_ELT(contents, 729, n_I_hosp_D_unconf_to_conf);
  ...
  SET_VECTOR_ELT(contents, 730, n_I_hosp_R_unconf_to_conf);
  ...
  SET_VECTOR_ELT(contents, 731, n_I_ICU_D_unconf_to_conf);
  ...
  SET_VECTOR_ELT(contents, 732, n_I_ICU_R_unconf_to_conf);
  ...
  SET_VECTOR_ELT(contents, 733, n_I_triage_D_unconf_to_conf);
  ...
  SET_VECTOR_ELT(contents, 734, n_I_triage_R_unconf_to_conf);
  SEXP n_II_asympt = PROTECT(allocVector(REALSXP, internal->dim_n_II_asympt));
  memcpy(REAL(n_II_asympt), internal->n_II_asympt, internal->dim_n_II_asympt * sizeof(double));
  odin_set_dim(n_II_asympt, 3, internal->dim_n_II_asympt_1, internal->dim_n_II_asympt_2, internal->dim_n_II_asympt_3);
  SET_VECTOR_ELT(contents, 735, n_II_asympt);
  ...
  SET_VECTOR_ELT(contents, 736, n_II_comm_D);
  ...
  SET_VECTOR_ELT(contents, 737, n_II_hosp_D_conf);
  ...
  SET_VECTOR_ELT(contents, 738, n_II_hosp_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 739, n_II_hosp_R_conf);
  ...
  SET_VECTOR_ELT(contents, 740, n_II_hosp_R_unconf);
  ...
  SET_VECTOR_ELT(contents, 741, n_II_ICU_D_conf);
  ...
  SET_VECTOR_ELT(contents, 742, n_II_ICU_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 743, n_II_ICU_R_conf);
  ...
  SET_VECTOR_ELT(contents, 744, n_II_ICU_R_unconf);
  SEXP n_II_ILI = PROTECT(allocVector(REALSXP, internal->dim_n_II_ILI));
  memcpy(REAL(n_II_ILI), internal->n_II_ILI, internal->dim_n_II_ILI * sizeof(double));
  odin_set_dim(n_II_ILI, 3, internal->dim_n_II_ILI_1, internal->dim_n_II_ILI_2, internal->dim_n_II_ILI_3);
  SET_VECTOR_ELT(contents, 745, n_II_ILI);
  SEXP n_II_mild = PROTECT(allocVector(REALSXP, internal->dim_n_II_mild));
  memcpy(REAL(n_II_mild), internal->n_II_mild, internal->dim_n_II_mild * sizeof(double));
  odin_set_dim(n_II_mild, 3, internal->dim_n_II_mild_1, internal->dim_n_II_mild_2, internal->dim_n_II_mild_3);
  SET_VECTOR_ELT(contents, 746, n_II_mild);
  ...
  SET_VECTOR_ELT(contents, 747, n_II_triage_D_conf);
  ...
  SET_VECTOR_ELT(contents, 748, n_II_triage_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 749, n_II_triage_R_conf);
  ...
  SET_VECTOR_ELT(contents, 750, n_II_triage_R_unconf);
  ...
  SET_VECTOR_ELT(contents, 751, n_ILI_to_comm_D);
  SEXP n_ILI_to_hosp = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_hosp));
  memcpy(REAL(n_ILI_to_hosp), internal->n_ILI_to_hosp, internal->dim_n_ILI_to_hosp * sizeof(double));
  odin_set_dim(n_ILI_to_hosp, 2, internal->dim_n_ILI_to_hosp_1, internal->dim_n_ILI_to_hosp_2);
  SET_VECTOR_ELT(contents, 752, n_ILI_to_hosp);
  ...
  SET_VECTOR_ELT(contents, 753, n_ILI_to_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 754, n_ILI_to_hosp_D_conf);
  ...
  SET_VECTOR_ELT(contents, 755, n_ILI_to_hosp_R);
  ...
  SET_VECTOR_ELT(contents, 756, n_ILI_to_hosp_R_conf);
  ...
  SET_VECTOR_ELT(contents, 757, n_ILI_to_triage);
  ...
  SET_VECTOR_ELT(contents, 758, n_ILI_to_triage_D);
  ...
  SET_VECTOR_ELT(contents, 759, n_ILI_to_triage_D_conf);
  ...
  SET_VECTOR_ELT(contents, 760, n_ILI_to_triage_R);
  ...
  SET_VECTOR_ELT(contents, 761, n_ILI_to_triage_R_conf);
  ...
  SET_VECTOR_ELT(contents, 762, n_R_pre);
  ...
  SET_VECTOR_ELT(contents, 763, n_R_stepdown_conf);
  ...
  SET_VECTOR_ELT(contents, 764, n_R_stepdown_unconf);
  ...
  SET_VECTOR_ELT(contents, 765, n_R_stepdown_unconf_to_conf);
  SEXP n_SE = PROTECT(allocVector(REALSXP, internal->dim_n_SE));
  memcpy(REAL(n_SE), internal->n_SE, internal->dim_n_SE * sizeof(double));
  SET_VECTOR_ELT(contents, 766, n_SE);
  ...
  SET_VECTOR_ELT(contents, 767, N_tot);
  ...
  SET_VECTOR_ELT(contents, 768, new_I_hosp_D_conf);
  ...
  SET_VECTOR_ELT(contents, 769, new_I_hosp_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 770, new_I_hosp_R_conf);
  ...
  SET_VECTOR_ELT(contents, 771, new_I_hosp_R_unconf);
  ...
  SET_VECTOR_ELT(contents, 772, new_I_ICU_D_conf);
  ...
  SET_VECTOR_ELT(contents, 773, new_I_ICU_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 774, new_I_ICU_R_conf);
  ...
  SET_VECTOR_ELT(contents, 775, new_I_ICU_R_unconf);
  ...
  SET_VECTOR_ELT(contents, 776, new_I_triage_D_conf);
  ...
  SET_VECTOR_ELT(contents, 777, new_I_triage_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 778, new_I_triage_R_conf);
  ...
  SET_VECTOR_ELT(contents, 779, new_I_triage_R_unconf);
  ...
  SET_VECTOR_ELT(contents, 780, new_R_stepdown_conf);
  ...
  SET_VECTOR_ELT(contents, 781, new_R_stepdown_unconf);
  SET_VECTOR_ELT(contents, 782, ScalarInteger(internal->offset_variable_D_comm));
  SET_VECTOR_ELT(contents, 783, ScalarInteger(internal->offset_variable_D_hosp));
  SET_VECTOR_ELT(contents, 784, ScalarInteger(internal->offset_variable_E));
  SET_VECTOR_ELT(contents, 785, ScalarInteger(internal->offset_variable_I_asympt));
  SET_VECTOR_ELT(contents, 786, ScalarInteger(internal->offset_variable_I_comm_D));
  SET_VECTOR_ELT(contents, 787, ScalarInteger(internal->offset_variable_I_hosp_D_conf));
  SET_VECTOR_ELT(contents, 788, ScalarInteger(internal->offset_variable_I_hosp_D_unconf));
  SET_VECTOR_ELT(contents, 789, ScalarInteger(internal->offset_variable_I_hosp_R_conf));
  SET_VECTOR_ELT(contents, 790, ScalarInteger(internal->offset_variable_I_hosp_R_unconf));
  SET_VECTOR_ELT(contents, 791, ScalarInteger(internal->offset_variable_I_ICU_D_conf));
  SET_VECTOR_ELT(contents, 792, ScalarInteger(internal->offset_variable_I_ICU_D_unconf));
  SET_VECTOR_ELT(contents, 793, ScalarInteger(internal->offset_variable_I_ICU_R_conf));
  SET_VECTOR_ELT(contents, 794, ScalarInteger(internal->offset_variable_I_ICU_R_unconf));
  SET_VECTOR_ELT(contents, 795, ScalarInteger(internal->offset_variable_I_ILI));
  SET_VECTOR_ELT(contents, 796, ScalarInteger(internal->offset_variable_I_mild));
  SET_VECTOR_ELT(contents, 797, ScalarInteger(internal->offset_variable_I_triage_D_conf));
  SET_VECTOR_ELT(contents, 798, ScalarInteger(internal->offset_variable_I_triage_D_unconf));
  SET_VECTOR_ELT(contents, 799, ScalarInteger(internal->offset_variable_I_triage_R));
  SET_VECTOR_ELT(contents, 800, ScalarInteger(internal->offset_variable_I_triage_R_conf));
  SET_VECTOR_ELT(contents, 801, ScalarInteger(internal->offset_variable_I_triage_R_unconf));
  SET_VECTOR_ELT(contents, 802, ScalarInteger(internal->offset_variable_R));
  SET_VECTOR_ELT(contents, 803, ScalarInteger(internal->offset_variable_R_neg));
  SET_VECTOR_ELT(contents, 804, ScalarInteger(internal->offset_variable_R_pos));
  SET_VECTOR_ELT(contents, 805, ScalarInteger(internal->offset_variable_R_pre));
  SET_VECTOR_ELT(contents, 806, ScalarInteger(internal->offset_variable_R_stepdown_conf));
  SET_VECTOR_ELT(contents, 807, ScalarInteger(internal->offset_variable_R_stepdown_unconf));
  ...
  SET_VECTOR_ELT(contents, 808, p_admit_conf);
  SEXP p_asympt = PROTECT(allocVector(REALSXP, internal->dim_p_asympt));
  memcpy(REAL(p_asympt), internal->p_asympt, internal->dim_p_asympt * sizeof(double));
  SET_VECTOR_ELT(contents, 809, p_asympt);
  ...
  SET_VECTOR_ELT(contents, 810, p_death_comm);
  ...
  SET_VECTOR_ELT(contents, 811, p_death_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 812, p_death_ICU);
  SET_VECTOR_ELT(contents, 813, ScalarReal(internal->p_EE));
  ...
  SET_VECTOR_ELT(contents, 814, p_ICU_hosp);
  SET_VECTOR_ELT(contents, 815, ScalarReal(internal->p_II_asympt));
  SET_VECTOR_ELT(contents, 816, ScalarReal(internal->p_II_comm_D));
  SET_VECTOR_ELT(contents, 817, ScalarReal(internal->p_II_hosp_D));
  SET_VECTOR_ELT(contents, 818, ScalarReal(internal->p_II_hosp_R));
  SET_VECTOR_ELT(contents, 819, ScalarReal(internal->p_II_ICU_D));
  SET_VECTOR_ELT(contents, 820, ScalarReal(internal->p_II_ICU_R));
  SET_VECTOR_ELT(contents, 821, ScalarReal(internal->p_II_ILI));
  SET_VECTOR_ELT(contents, 822, ScalarReal(internal->p_II_mild));
  SET_VECTOR_ELT(contents, 823, ScalarReal(internal->p_II_triage));
  ...
  SET_VECTOR_ELT(contents, 824, p_R_pre);
  SET_VECTOR_ELT(contents, 825, ScalarReal(internal->p_R_stepdown));
  SEXP p_recov_ILI = PROTECT(allocVector(REALSXP, internal->dim_p_recov_ILI));
  memcpy(REAL(p_recov_ILI), internal->p_recov_ILI, internal->dim_p_recov_ILI * sizeof(double));
  SET_VECTOR_ELT(contents, 826, p_recov_ILI);
  SEXP p_SE = PROTECT(allocVector(REALSXP, internal->dim_p_SE));
  memcpy(REAL(p_SE), internal->p_SE, internal->dim_p_SE * sizeof(double));
  SET_VECTOR_ELT(contents, 827, p_SE);
  ...
  SET_VECTOR_ELT(contents, 828, p_seroconversion);
  SEXP p_sympt_ILI = PROTECT(allocVector(REALSXP, internal->dim_p_sympt_ILI));
  memcpy(REAL(p_sympt_ILI), internal->p_sympt_ILI, internal->dim_p_sympt_ILI * sizeof(double));
  SET_VECTOR_ELT(contents, 829, p_sympt_ILI);
  SET_VECTOR_ELT(contents, 830, ScalarReal(internal->p_test));
  SEXP R0 = PROTECT(allocVector(REALSXP, internal->dim_R0));
  memcpy(REAL(R0), internal->R0, internal->dim_R0 * sizeof(double));
  SET_VECTOR_ELT(contents, 831, R0);
  ...
  SET_VECTOR_ELT(contents, 832, R0_neg);
  ...
  SET_VECTOR_ELT(contents, 833, R0_pos);
  ...
  SET_VECTOR_ELT(contents, 834, R0_pre);
  ...
  SET_VECTOR_ELT(contents, 835, R0_stepdown_conf);
  ...
  SET_VECTOR_ELT(contents, 836, R0_stepdown_unconf);
  SET_VECTOR_ELT(contents, 837, ScalarInteger(internal->s_asympt));
  SET_VECTOR_ELT(contents, 838, ScalarInteger(internal->s_comm_D));
  SET_VECTOR_ELT(contents, 839, ScalarInteger(internal->s_E));
  SET_VECTOR_ELT(contents, 840, ScalarInteger(internal->s_hosp_D));
  SET_VECTOR_ELT(contents, 841, ScalarInteger(internal->s_hosp_R));
  SET_VECTOR_ELT(contents, 842, ScalarInteger(internal->s_ICU_D));
  SET_VECTOR_ELT(contents, 843, ScalarInteger(internal->s_ICU_R));
  SEXP s_ij = PROTECT(allocVector(REALSXP, internal->dim_s_ij));
  memcpy(REAL(s_ij), internal->s_ij, internal->dim_s_ij * sizeof(double));
  odin_set_dim(s_ij, 2, internal->dim_s_ij_1, internal->dim_s_ij_2);
  SET_VECTOR_ELT(contents, 844, s_ij);
  SET_VECTOR_ELT(contents, 845, ScalarInteger(internal->s_ILI));
  SET_VECTOR_ELT(contents, 846, ScalarInteger(internal->s_mild));
  SET_VECTOR_ELT(contents, 847, ScalarInteger(internal->s_R_pre));
  SET_VECTOR_ELT(contents, 848, ScalarInteger(internal->s_stepdown));
  SET_VECTOR_ELT(contents, 849, ScalarInteger(internal->s_triage));
  SEXP S0 = PROTECT(allocVector(REALSXP, internal->dim_S0));
  memcpy(REAL(S0), internal->S0, internal->dim_S0 * sizeof(double));
  SET_VECTOR_ELT(contents, 850, S0);
  SET_VECTOR_ELT(contents, 851, ScalarInteger(internal->test_classes));
  SET_VECTOR_ELT(contents, 852, ScalarInteger(internal->trans_classes));
  SEXP trans_increase = PROTECT(allocVector(REALSXP, internal->dim_trans_increase));
  memcpy(REAL(trans_increase), internal->trans_increase, internal->dim_trans_increase * sizeof(double));
  odin_set_dim(trans_increase, 2, internal->dim_trans_increase_1, internal->dim_trans_increase_2);
  SET_VECTOR_ELT(contents, 853, trans_increase);
  SEXP trans_profile = PROTECT(allocVector(REALSXP, internal->dim_trans_profile));
  memcpy(REAL(trans_profile), internal->trans_profile, internal->dim_trans_profile * sizeof(double));
  odin_set_dim(trans_profile, 2, internal->dim_trans_profile_1, internal->dim_trans_profile_2);
  SET_VECTOR_ELT(contents, 854, trans_profile);
  SEXP nms = PROTECT(allocVector(STRSXP, 855));
  SET_STRING_ELT(nms, 0, mkChar("aux_EE"));
  SET_STRING_ELT(nms, 1, mkChar("aux_II_asympt"));
  ...
  SET_STRING_ELT(nms, 255, mkChar("dim_I_triage_R"));
  SET_STRING_ELT(nms, 256, mkChar("dim_I_triage_R_1"));
  SET_STRING_ELT(nms, 257, mkChar("dim_I_triage_R_12"));
  SET_STRING_ELT(nms, 258, mkChar("dim_I_triage_R_123"));
  SET_STRING_ELT(nms, 259, mkChar("dim_I_triage_R_2"));
  SET_STRING_ELT(nms, 260, mkChar("dim_I_triage_R_3"));
  SET_STRING_ELT(nms, 261, mkChar("dim_I_triage_R_4"));
  SET_STRING_ELT(nms, 262, mkChar("dim_I_triage_R_conf"));
  SET_STRING_ELT(nms, 263, mkChar("dim_I_triage_R_conf_1"));
  SET_STRING_ELT(nms, 264, mkChar("dim_I_triage_R_conf_12"));
  SET_STRING_ELT(nms, 265, mkChar("dim_I_triage_R_conf_2"));
  SET_STRING_ELT(nms, 266, mkChar("dim_I_triage_R_conf_3"));
  SET_STRING_ELT(nms, 267, mkChar("dim_I_triage_R_unconf"));
  SET_STRING_ELT(nms, 268, mkChar("dim_I_triage_R_unconf_1"));
  SET_STRING_ELT(nms, 269, mkChar("dim_I_triage_R_unconf_12"));
  SET_STRING_ELT(nms, 270, mkChar("dim_I_triage_R_unconf_2"));
  SET_STRING_ELT(nms, 271, mkChar("dim_I_triage_R_unconf_3"));
  SET_STRING_ELT(nms, 272, mkChar("dim_I_with_diff_trans"));
  SET_STRING_ELT(nms, 273, mkChar("dim_I_with_diff_trans_1"));
  SET_STRING_ELT(nms, 274, mkChar("dim_I_with_diff_trans_2"));
  SET_STRING_ELT(nms, 275, mkChar("dim_I0_asympt"));
  SET_STRING_ELT(nms, 276, mkChar("dim_I0_asympt_1"));
  SET_STRING_ELT(nms, 277, mkChar("dim_I0_asympt_12"));
  SET_STRING_ELT(nms, 278, mkChar("dim_I0_asympt_2"));
  SET_STRING_ELT(nms, 279, mkChar("dim_I0_asympt_3"));
  SET_STRING_ELT(nms, 280, mkChar("dim_I0_comm_D"));
  SET_STRING_ELT(nms, 281, mkChar("dim_I0_comm_D_1"));
  SET_STRING_ELT(nms, 282, mkChar("dim_I0_comm_D_12"));
  SET_STRING_ELT(nms, 283, mkChar("dim_I0_comm_D_2"));
  SET_STRING_ELT(nms, 284, mkChar("dim_I0_comm_D_3"));
  SET_STRING_ELT(nms, 285, mkChar("dim_I0_hosp_D_conf"));
  SET_STRING_ELT(nms, 286, mkChar("dim_I0_hosp_D_conf_1"));
  SET_STRING_ELT(nms, 287, mkChar("dim_I0_hosp_D_conf_12"));
  SET_STRING_ELT(nms, 288, mkChar("dim_I0_hosp_D_conf_2"));
  SET_STRING_ELT(nms, 289, mkChar("dim_I0_hosp_D_conf_3"));
  SET_STRING_ELT(nms, 290, mkChar("dim_I0_hosp_D_unconf"));
  SET_STRING_ELT(nms, 291, mkChar("dim_I0_hosp_D_unconf_1"));
  SET_STRING_ELT(nms, 292, mkChar("dim_I0_hosp_D_unconf_12"));
  SET_STRING_ELT(nms, 293, mkChar("dim_I0_hosp_D_unconf_2"));
  SET_STRING_ELT(nms, 294, mkChar("dim_I0_hosp_D_unconf_3"));
  SET_STRING_ELT(nms, 295, mkChar("dim_I0_hosp_R_conf"));
  SET_STRING_ELT(nms, 296, mkChar("dim_I0_hosp_R_conf_1"));
  SET_STRING_ELT(nms, 297, mkChar("dim_I0_hosp_R_conf_12"));
  SET_STRING_ELT(nms, 298, mkChar("dim_I0_hosp_R_conf_2"));
  SET_STRING_ELT(nms, 299, mkChar("dim_I0_hosp_R_conf_3"));
  SET_STRING_ELT(nms, 300, mkChar("dim_I0_hosp_R_unconf"));
  SET_STRING_ELT(nms, 301, mkChar("dim_I0_hosp_R_unconf_1"));
  SET_STRING_ELT(nms, 302, mkChar("dim_I0_hosp_R_unconf_12"));
  SET_STRING_ELT(nms, 303, mkChar("dim_I0_hosp_R_unconf_2"));
  SET_STRING_ELT(nms, 304, mkChar("dim_I0_hosp_R_unconf_3"));
  SET_STRING_ELT(nms, 305, mkChar("dim_I0_ICU_D_conf"));
  SET_STRING_ELT(nms, 306, mkChar("dim_I0_ICU_D_conf_1"));
  SET_STRING_ELT(nms, 307, mkChar("dim_I0_ICU_D_conf_12"));
  SET_STRING_ELT(nms, 308, mkChar("dim_I0_ICU_D_conf_2"));
  SET_STRING_ELT(nms, 309, mkChar("dim_I0_ICU_D_conf_3"));
  SET_STRING_ELT(nms, 310, mkChar("dim_I0_ICU_D_unconf"));
  SET_STRING_ELT(nms, 311, mkChar("dim_I0_ICU_D_unconf_1"));
  SET_STRING_ELT(nms, 312, mkChar("dim_I0_ICU_D_unconf_12"));
  SET_STRING_ELT(nms, 313, mkChar("dim_I0_ICU_D_unconf_2"));
  SET_STRING_ELT(nms, 314, mkChar("dim_I0_ICU_D_unconf_3"));
  SET_STRING_ELT(nms, 315, mkChar("dim_I0_ICU_R_conf"));
  SET_STRING_ELT(nms, 316, mkChar("dim_I0_ICU_R_conf_1"));
  SET_STRING_ELT(nms, 317, mkChar("dim_I0_ICU_R_conf_12"));
  SET_STRING_ELT(nms, 318, mkChar("dim_I0_ICU_R_conf_2"));
  SET_STRING_ELT(nms, 319, mkChar("dim_I0_ICU_R_conf_3"));
  SET_STRING_ELT(nms, 320, mkChar("dim_I0_ICU_R_unconf"));
  SET_STRING_ELT(nms, 321, mkChar("dim_I0_ICU_R_unconf_1"));
  SET_STRING_ELT(nms, 322, mkChar("dim_I0_ICU_R_unconf_12"));
  SET_STRING_ELT(nms, 323, mkChar("dim_I0_ICU_R_unconf_2"));
  SET_STRING_ELT(nms, 324, mkChar("dim_I0_ICU_R_unconf_3"));
  SET_STRING_ELT(nms, 325, mkChar("dim_I0_ILI"));
  SET_STRING_ELT(nms, 326, mkChar("dim_I0_ILI_1"));
  SET_STRING_ELT(nms, 327, mkChar("dim_I0_ILI_12"));
  SET_STRING_ELT(nms, 328, mkChar("dim_I0_ILI_2"));
  SET_STRING_ELT(nms, 329, mkChar("dim_I0_ILI_3"));
  SET_STRING_ELT(nms, 330, mkChar("dim_I0_mild"));
  SET_STRING_ELT(nms, 331, mkChar("dim_I0_mild_1"));
  SET_STRING_ELT(nms, 332, mkChar("dim_I0_mild_12"));
  SET_STRING_ELT(nms, 333, mkChar("dim_I0_mild_2"));
  SET_STRING_ELT(nms, 334, mkChar("dim_I0_mild_3"));
  SET_STRING_ELT(nms, 335, mkChar("dim_I0_triage_D_conf"));
  SET_STRING_ELT(nms, 336, mkChar("dim_I0_triage_D_conf_1"));
  SET_STRING_ELT(nms, 337, mkChar("dim_I0_triage_D_conf_12"));
  SET_STRING_ELT(nms, 338, mkChar("dim_I0_triage_D_conf_2"));
  SET_STRING_ELT(nms, 339, mkChar("dim_I0_triage_D_conf_3"));
  SET_STRING_ELT(nms, 340, mkChar("dim_I0_triage_D_unconf"));
  SET_STRING_ELT(nms, 341, mkChar("dim_I0_triage_D_unconf_1"));
  SET_STRING_ELT(nms, 342, mkChar("dim_I0_triage_D_unconf_12"));
  SET_STRING_ELT(nms, 343, mkChar("dim_I0_triage_D_unconf_2"));
  SET_STRING_ELT(nms, 344, mkChar("dim_I0_triage_D_unconf_3"));
  SET_STRING_ELT(nms, 345, mkChar("dim_I0_triage_R"));
  SET_STRING_ELT(nms, 346, mkChar("dim_I0_triage_R_1"));
  SET_STRING_ELT(nms, 347, mkChar("dim_I0_triage_R_12"));
  SET_STRING_ELT(nms, 348, mkChar("dim_I0_triage_R_123"));
  SET_STRING_ELT(nms, 349, mkChar("dim_I0_triage_R_2"));
  SET_STRING_ELT(nms, 350, mkChar("dim_I0_triage_R_3"));
  SET_STRING_ELT(nms, 351, mkChar("dim_I0_triage_R_4"));
  SET_STRING_ELT(nms, 352, mkChar("dim_I0_triage_R_conf"));
  SET_STRING_ELT(nms, 353, mkChar("dim_I0_triage_R_conf_1"));
  SET_STRING_ELT(nms, 354, mkChar("dim_I0_triage_R_conf_12"));
  SET_STRING_ELT(nms, 355, mkChar("dim_I0_triage_R_conf_2"));
  SET_STRING_ELT(nms, 356, mkChar("dim_I0_triage_R_conf_3"));
  SET_STRING_ELT(nms, 357, mkChar("dim_I0_triage_R_unconf"));
  SET_STRING_ELT(nms, 358, mkChar("dim_I0_triage_R_unconf_1"));
  SET_STRING_ELT(nms, 359, mkChar("dim_I0_triage_R_unconf_12"));
  SET_STRING_ELT(nms, 360, mkChar("dim_I0_triage_R_unconf_2"));
  SET_STRING_ELT(nms, 361, mkChar("dim_I0_triage_R_unconf_3"));
  SET_STRING_ELT(nms, 362, mkChar("dim_lambda"));
  SET_STRING_ELT(nms, 363, mkChar("dim_m"));
  SET_STRING_ELT(nms, 364, mkChar("dim_m_1"));
  SET_STRING_ELT(nms, 365, mkChar("dim_m_2"));
  SET_STRING_ELT(nms, 366, mkChar("dim_n_com_to_R_pre"));
  SET_STRING_ELT(nms, 367, mkChar("dim_n_com_to_R_total"));
  SET_STRING_ELT(nms, 368, mkChar("dim_n_EE"));
  SET_STRING_ELT(nms, 369, mkChar("dim_n_EE_1"));
  SET_STRING_ELT(nms, 370, mkChar("dim_n_EE_12"));
  SET_STRING_ELT(nms, 371, mkChar("dim_n_EE_2"));
  SET_STRING_ELT(nms, 372, mkChar("dim_n_EE_3"));
  SET_STRING_ELT(nms, 373, mkChar("dim_n_EI_asympt"));
  SET_STRING_ELT(nms, 374, mkChar("dim_n_EI_asympt_1"));
  SET_STRING_ELT(nms, 375, mkChar("dim_n_EI_asympt_2"));
  SET_STRING_ELT(nms, 376, mkChar("dim_n_EI_ILI"));
  SET_STRING_ELT(nms, 377, mkChar("dim_n_EI_ILI_1"));
  SET_STRING_ELT(nms, 378, mkChar("dim_n_EI_ILI_2"));
  SET_STRING_ELT(nms, 379, mkChar("dim_n_EI_mild"));
  SET_STRING_ELT(nms, 380, mkChar("dim_n_EI_mild_1"));
  SET_STRING_ELT(nms, 381, mkChar("dim_n_EI_mild_2"));
  SET_STRING_ELT(nms, 382, mkChar("dim_n_hosp_non_ICU"));
  SET_STRING_ELT(nms, 383, mkChar("dim_n_hosp_non_ICU_1"));
  SET_STRING_ELT(nms, 384, mkChar("dim_n_hosp_non_ICU_2"));
  SET_STRING_ELT(nms, 385, mkChar("dim_n_I_hosp_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 386, mkChar("dim_n_I_hosp_D_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 387, mkChar("dim_n_I_hosp_D_unconf_to_conf_12"));
  SET_STRING_ELT(nms, 388, mkChar("dim_n_I_hosp_D_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 389, mkChar("dim_n_I_hosp_D_unconf_to_conf_3"));
  SET_STRING_ELT(nms, 390, mkChar("dim_n_I_hosp_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 391, mkChar("dim_n_I_hosp_R_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 392, mkChar("dim_n_I_hosp_R_unconf_to_conf_12"));
  SET_STRING_ELT(nms, 393, mkChar("dim_n_I_hosp_R_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 394, mkChar("dim_n_I_hosp_R_unconf_to_conf_3"));
  SET_STRING_ELT(nms, 395, mkChar("dim_n_I_ICU_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 396, mkChar("dim_n_I_ICU_D_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 397, mkChar("dim_n_I_ICU_D_unconf_to_conf_12"));
  SET_STRING_ELT(nms, 398, mkChar("dim_n_I_ICU_D_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 399, mkChar("dim_n_I_ICU_D_unconf_to_conf_3"));
  SET_STRING_ELT(nms, 400, mkChar("dim_n_I_ICU_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 401, mkChar("dim_n_I_ICU_R_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 402, mkChar("dim_n_I_ICU_R_unconf_to_conf_12"));
  SET_STRING_ELT(nms, 403, mkChar("dim_n_I_ICU_R_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 404, mkChar("dim_n_I_ICU_R_unconf_to_conf_3"));
  SET_STRING_ELT(nms, 405, mkChar("dim_n_I_triage_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 406, mkChar("dim_n_I_triage_D_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 407, mkChar("dim_n_I_triage_D_unconf_to_conf_12"));
  SET_STRING_ELT(nms, 408, mkChar("dim_n_I_triage_D_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 409, mkChar("dim_n_I_triage_D_unconf_to_conf_3"));
  SET_STRING_ELT(nms, 410, mkChar("dim_n_I_triage_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 411, mkChar("dim_n_I_triage_R_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 412, mkChar("dim_n_I_triage_R_unconf_to_conf_12"));
  SET_STRING_ELT(nms, 413, mkChar("dim_n_I_triage_R_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 414, mkChar("dim_n_I_triage_R_unconf_to_conf_3"));
  SET_STRING_ELT(nms, 415, mkChar("dim_n_II_asympt"));
  SET_STRING_ELT(nms, 416, mkChar("dim_n_II_asympt_1"));
  SET_STRING_ELT(nms, 417, mkChar("dim_n_II_asympt_12"));
  SET_STRING_ELT(nms, 418, mkChar("dim_n_II_asympt_2"));
  SET_STRING_ELT(nms, 419, mkChar("dim_n_II_asympt_3"));
  SET_STRING_ELT(nms, 420, mkChar("dim_n_II_comm_D"));
  SET_STRING_ELT(nms, 421, mkChar("dim_n_II_comm_D_1"));
  SET_STRING_ELT(nms, 422, mkChar("dim_n_II_comm_D_12"));
  SET_STRING_ELT(nms, 423, mkChar("dim_n_II_comm_D_2"));
  SET_STRING_ELT(nms, 424, mkChar("dim_n_II_comm_D_3"));
  SET_STRING_ELT(nms, 425, mkChar("dim_n_II_hosp_D_conf"));
  SET_STRING_ELT(nms, 426, mkChar("dim_n_II_hosp_D_conf_1"));
  SET_STRING_ELT(nms, 427, mkChar("dim_n_II_hosp_D_conf_12"));
  SET_STRING_ELT(nms, 428, mkChar("dim_n_II_hosp_D_conf_2"));
  SET_STRING_ELT(nms, 429, mkChar("dim_n_II_hosp_D_conf_3"));
  SET_STRING_ELT(nms, 430, mkChar("dim_n_II_hosp_D_unconf"));
  SET_STRING_ELT(nms, 431, mkChar("dim_n_II_hosp_D_unconf_1"));
  SET_STRING_ELT(nms, 432, mkChar("dim_n_II_hosp_D_unconf_12"));
  SET_STRING_ELT(nms, 433, mkChar("dim_n_II_hosp_D_unconf_2"));
  SET_STRING_ELT(nms, 434, mkChar("dim_n_II_hosp_D_unconf_3"));
  SET_STRING_ELT(nms, 435, mkChar("dim_n_II_hosp_R_conf"));
  SET_STRING_ELT(nms, 436, mkChar("dim_n_II_hosp_R_conf_1"));
  SET_STRING_ELT(nms, 437, mkChar("dim_n_II_hosp_R_conf_12"));
  SET_STRING_ELT(nms, 438, mkChar("dim_n_II_hosp_R_conf_2"));
  SET_STRING_ELT(nms, 439, mkChar("dim_n_II_hosp_R_conf_3"));
  SET_STRING_ELT(nms, 440, mkChar("dim_n_II_hosp_R_unconf"));
  SET_STRING_ELT(nms, 441, mkChar("dim_n_II_hosp_R_unconf_1"));
  SET_STRING_ELT(nms, 442, mkChar("dim_n_II_hosp_R_unconf_12"));
  SET_STRING_ELT(nms, 443, mkChar("dim_n_II_hosp_R_unconf_2"));
  SET_STRING_ELT(nms, 444, mkChar("dim_n_II_hosp_R_unconf_3"));
  SET_STRING_ELT(nms, 445, mkChar("dim_n_II_ICU_D_conf"));
  SET_STRING_ELT(nms, 446, mkChar("dim_n_II_ICU_D_conf_1"));
  SET_STRING_ELT(nms, 447, mkChar("dim_n_II_ICU_D_conf_12"));
  SET_STRING_ELT(nms, 448, mkChar("dim_n_II_ICU_D_conf_2"));
  SET_STRING_ELT(nms, 449, mkChar("dim_n_II_ICU_D_conf_3"));
  SET_STRING_ELT(nms, 450, mkChar("dim_n_II_ICU_D_unconf"));
  SET_STRING_ELT(nms, 451, mkChar("dim_n_II_ICU_D_unconf_1"));
  SET_STRING_ELT(nms, 452, mkChar("dim_n_II_ICU_D_unconf_12"));
  SET_STRING_ELT(nms, 453, mkChar("dim_n_II_ICU_D_unconf_2"));
  SET_STRING_ELT(nms, 454, mkChar("dim_n_II_ICU_D_unconf_3"));
  SET_STRING_ELT(nms, 455, mkChar("dim_n_II_ICU_R_conf"));
  SET_STRING_ELT(nms, 456, mkChar("dim_n_II_ICU_R_conf_1"));
  SET_STRING_ELT(nms, 457, mkChar("dim_n_II_ICU_R_conf_12"));
  SET_STRING_ELT(nms, 458, mkChar("dim_n_II_ICU_R_conf_2"));
  SET_STRING_ELT(nms, 459, mkChar("dim_n_II_ICU_R_conf_3"));
  SET_STRING_ELT(nms, 460, mkChar("dim_n_II_ICU_R_unconf"));
  SET_STRING_ELT(nms, 461, mkChar("dim_n_II_ICU_R_unconf_1"));
  SET_STRING_ELT(nms, 462, mkChar("dim_n_II_ICU_R_unconf_12"));
  SET_STRING_ELT(nms, 463, mkChar("dim_n_II_ICU_R_unconf_2"));
  SET_STRING_ELT(nms, 464, mkChar("dim_n_II_ICU_R_unconf_3"));
  SET_STRING_ELT(nms, 465, mkChar("dim_n_II_ILI"));
  SET_STRING_ELT(nms, 466, mkChar("dim_n_II_ILI_1"));
  SET_STRING_ELT(nms, 467, mkChar("dim_n_II_ILI_12"));
  SET_STRING_ELT(nms, 468, mkChar("dim_n_II_ILI_2"));
  SET_STRING_ELT(nms, 469, mkChar("dim_n_II_ILI_3"));
  SET_STRING_ELT(nms, 470, mkChar("dim_n_II_mild"));
  SET_STRING_ELT(nms, 471, mkChar("dim_n_II_mild_1"));
  SET_STRING_ELT(nms, 472, mkChar("dim_n_II_mild_12"));
  SET_STRING_ELT(nms, 473, mkChar("dim_n_II_mild_2"));
  SET_STRING_ELT(nms, 474, mkChar("dim_n_II_mild_3"));
  SET_STRING_ELT(nms, 475, mkChar("dim_n_II_triage_D_conf"));
  SET_STRING_ELT(nms, 476, mkChar("dim_n_II_triage_D_conf_1"));
  SET_STRING_ELT(nms, 477, mkChar("dim_n_II_triage_D_conf_12"));
  SET_STRING_ELT(nms, 478, mkChar("dim_n_II_triage_D_conf_2"));
  SET_STRING_ELT(nms, 479, mkChar("dim_n_II_triage_D_conf_3"));
  SET_STRING_ELT(nms, 480, mkChar("dim_n_II_triage_D_unconf"));
  SET_STRING_ELT(nms, 481, mkChar("dim_n_II_triage_D_unconf_1"));
  SET_STRING_ELT(nms, 482, mkChar("dim_n_II_triage_D_unconf_12"));
  SET_STRING_ELT(nms, 483, mkChar("dim_n_II_triage_D_unconf_2"));
  SET_STRING_ELT(nms, 484, mkChar("dim_n_II_triage_D_unconf_3"));
  SET_STRING_ELT(nms, 485, mkChar("dim_n_II_triage_R_conf"));
  SET_STRING_ELT(nms, 486, mkChar("dim_n_II_triage_R_conf_1"));
  SET_STRING_ELT(nms, 487, mkChar("dim_n_II_triage_R_conf_12"));
  SET_STRING_ELT(nms, 488, mkChar("dim_n_II_triage_R_conf_2"));
  SET_STRING_ELT(nms, 489, mkChar("dim_n_II_triage_R_conf_3"));
  SET_STRING_ELT(nms, 490, mkChar("dim_n_II_triage_R_unconf"));
  SET_STRING_ELT(nms, 491, mkChar("dim_n_II_triage_R_unconf_1"));
  SET_STRING_ELT(nms, 492, mkChar("dim_n_II_triage_R_unconf_12"));
  SET_STRING_ELT(nms, 493, mkChar("dim_n_II_triage_R_unconf_2"));
  SET_STRING_ELT(nms, 494, mkChar("dim_n_II_triage_R_unconf_3"));
  SET_STRING_ELT(nms, 495, mkChar("dim_n_ILI_to_comm_D"));
  SET_STRING_ELT(nms, 496, mkChar("dim_n_ILI_to_comm_D_1"));
  SET_STRING_ELT(nms, 497, mkChar("dim_n_ILI_to_comm_D_2"));
  SET_STRING_ELT(nms, 498, mkChar("dim_n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 499, mkChar("dim_n_ILI_to_hosp_1"));
  SET_STRING_ELT(nms, 500, mkChar("dim_n_ILI_to_hosp_2"));
  SET_STRING_ELT(nms, 501, mkChar("dim_n_ILI_to_hosp_D"));
  SET_STRING_ELT(nms, 502, mkChar("dim_n_ILI_to_hosp_D_1"));
  SET_STRING_ELT(nms, 503, mkChar("dim_n_ILI_to_hosp_D_2"));
  SET_STRING_ELT(nms, 504, mkChar("dim_n_ILI_to_hosp_D_conf"));
  SET_STRING_ELT(nms, 505, mkChar("dim_n_ILI_to_hosp_D_conf_1"));
  SET_STRING_ELT(nms, 506, mkChar("dim_n_ILI_to_hosp_D_conf_2"));
  SET_STRING_ELT(nms, 507, mkChar("dim_n_ILI_to_hosp_R"));
  SET_STRING_ELT(nms, 508, mkChar("dim_n_ILI_to_hosp_R_1"));
  SET_STRING_ELT(nms, 509, mkChar("dim_n_ILI_to_hosp_R_2"));
  SET_STRING_ELT(nms, 510, mkChar("dim_n_ILI_to_hosp_R_conf"));
  SET_STRING_ELT(nms, 511, mkChar("dim_n_ILI_to_hosp_R_conf_1"));
  SET_STRING_ELT(nms, 512, mkChar("dim_n_ILI_to_hosp_R_conf_2"));
  SET_STRING_ELT(nms, 513, mkChar("dim_n_ILI_to_triage"));
  SET_STRING_ELT(nms, 514, mkChar("dim_n_ILI_to_triage_1"));
  SET_STRING_ELT(nms, 515, mkChar("dim_n_ILI_to_triage_2"));
  SET_STRING_ELT(nms, 516, mkChar("dim_n_ILI_to_triage_D"));
  SET_STRING_ELT(nms, 517, mkChar("dim_n_ILI_to_triage_D_1"));
  SET_STRING_ELT(nms, 518, mkChar("dim_n_ILI_to_triage_D_2"));
  SET_STRING_ELT(nms, 519, mkChar("dim_n_ILI_to_triage_D_conf"));
  SET_STRING_ELT(nms, 520, mkChar("dim_n_ILI_to_triage_D_conf_1"));
  SET_STRING_ELT(nms, 521, mkChar("dim_n_ILI_to_triage_D_conf_2"));
  SET_STRING_ELT(nms, 522, mkChar("dim_n_ILI_to_triage_R"));
  SET_STRING_ELT(nms, 523, mkChar("dim_n_ILI_to_triage_R_1"));
  SET_STRING_ELT(nms, 524, mkChar("dim_n_ILI_to_triage_R_2"));
  SET_STRING_ELT(nms, 525, mkChar("dim_n_ILI_to_triage_R_conf"));
  SET_STRING_ELT(nms, 526, mkChar("dim_n_ILI_to_triage_R_conf_1"));
  SET_STRING_ELT(nms, 527, mkChar("dim_n_ILI_to_triage_R_conf_2"));
  SET_STRING_ELT(nms, 528, mkChar("dim_n_R_pre"));
  SET_STRING_ELT(nms, 529, mkChar("dim_n_R_pre_1"));
  SET_STRING_ELT(nms, 530, mkChar("dim_n_R_pre_2"));
  SET_STRING_ELT(nms, 531, mkChar("dim_n_R_stepdown_conf"));
  SET_STRING_ELT(nms, 532, mkChar("dim_n_R_stepdown_conf_1"));
  SET_STRING_ELT(nms, 533, mkChar("dim_n_R_stepdown_conf_2"));
  SET_STRING_ELT(nms, 534, mkChar("dim_n_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 535, mkChar("dim_n_R_stepdown_unconf_1"));
  SET_STRING_ELT(nms, 536, mkChar("dim_n_R_stepdown_unconf_2"));
  SET_STRING_ELT(nms, 537, mkChar("dim_n_R_stepdown_unconf_to_conf"));
  SET_STRING_ELT(nms, 538, mkChar("dim_n_R_stepdown_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 539, mkChar("dim_n_R_stepdown_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 540, mkChar("dim_n_SE"));
  SET_STRING_ELT(nms, 541, mkChar("dim_N_tot"));
  SET_STRING_ELT(nms, 542, mkChar("dim_new_I_hosp_D_conf"));
  SET_STRING_ELT(nms, 543, mkChar("dim_new_I_hosp_D_conf_1"));
  SET_STRING_ELT(nms, 544, mkChar("dim_new_I_hosp_D_conf_12"));
  SET_STRING_ELT(nms, 545, mkChar("dim_new_I_hosp_D_conf_2"));
  SET_STRING_ELT(nms, 546, mkChar("dim_new_I_hosp_D_conf_3"));
  SET_STRING_ELT(nms, 547, mkChar("dim_new_I_hosp_D_unconf"));
  SET_STRING_ELT(nms, 548, mkChar("dim_new_I_hosp_D_unconf_1"));
  SET_STRING_ELT(nms, 549, mkChar("dim_new_I_hosp_D_unconf_12"));
  SET_STRING_ELT(nms, 550, mkChar("dim_new_I_hosp_D_unconf_2"));
  SET_STRING_ELT(nms, 551, mkChar("dim_new_I_hosp_D_unconf_3"));
  SET_STRING_ELT(nms, 552, mkChar("dim_new_I_hosp_R_conf"));
  SET_STRING_ELT(nms, 553, mkChar("dim_new_I_hosp_R_conf_1"));
  SET_STRING_ELT(nms, 554, mkChar("dim_new_I_hosp_R_conf_12"));
  SET_STRING_ELT(nms, 555, mkChar("dim_new_I_hosp_R_conf_2"));
  SET_STRING_ELT(nms, 556, mkChar("dim_new_I_hosp_R_conf_3"));
  SET_STRING_ELT(nms, 557, mkChar("dim_new_I_hosp_R_unconf"));
  SET_STRING_ELT(nms, 558, mkChar("dim_new_I_hosp_R_unconf_1"));
  SET_STRING_ELT(nms, 559, mkChar("dim_new_I_hosp_R_unconf_12"));
  SET_STRING_ELT(nms, 560, mkChar("dim_new_I_hosp_R_unconf_2"));
  SET_STRING_ELT(nms, 561, mkChar("dim_new_I_hosp_R_unconf_3"));
  SET_STRING_ELT(nms, 562, mkChar("dim_new_I_ICU_D_conf"));
  SET_STRING_ELT(nms, 563, mkChar("dim_new_I_ICU_D_conf_1"));
  SET_STRING_ELT(nms, 564, mkChar("dim_new_I_ICU_D_conf_12"));
  SET_STRING_ELT(nms, 565, mkChar("dim_new_I_ICU_D_conf_2"));
  SET_STRING_ELT(nms, 566, mkChar("dim_new_I_ICU_D_conf_3"));
  SET_STRING_ELT(nms, 567, mkChar("dim_new_I_ICU_D_unconf"));
  SET_STRING_ELT(nms, 568, mkChar("dim_new_I_ICU_D_unconf_1"));
  SET_STRING_ELT(nms, 569, mkChar("dim_new_I_ICU_D_unconf_12"));
  SET_STRING_ELT(nms, 570, mkChar("dim_new_I_ICU_D_unconf_2"));
  SET_STRING_ELT(nms, 571, mkChar("dim_new_I_ICU_D_unconf_3"));
  SET_STRING_ELT(nms, 572, mkChar("dim_new_I_ICU_R_conf"));
  SET_STRING_ELT(nms, 573, mkChar("dim_new_I_ICU_R_conf_1"));
  SET_STRING_ELT(nms, 574, mkChar("dim_new_I_ICU_R_conf_12"));
  SET_STRING_ELT(nms, 575, mkChar("dim_new_I_ICU_R_conf_2"));
  SET_STRING_ELT(nms, 576, mkChar("dim_new_I_ICU_R_conf_3"));
  SET_STRING_ELT(nms, 577, mkChar("dim_new_I_ICU_R_unconf"));
  SET_STRING_ELT(nms, 578, mkChar("dim_new_I_ICU_R_unconf_1"));
  SET_STRING_ELT(nms, 579, mkChar("dim_new_I_ICU_R_unconf_12"));
  SET_STRING_ELT(nms, 580, mkChar("dim_new_I_ICU_R_unconf_2"));
  SET_STRING_ELT(nms, 581, mkChar("dim_new_I_ICU_R_unconf_3"));
  SET_STRING_ELT(nms, 582, mkChar("dim_new_I_triage_D_conf"));
  SET_STRING_ELT(nms, 583, mkChar("dim_new_I_triage_D_conf_1"));
  SET_STRING_ELT(nms, 584, mkChar("dim_new_I_triage_D_conf_12"));
  SET_STRING_ELT(nms, 585, mkChar("dim_new_I_triage_D_conf_2"));
  SET_STRING_ELT(nms, 586, mkChar("dim_new_I_triage_D_conf_3"));
  SET_STRING_ELT(nms, 587, mkChar("dim_new_I_triage_D_unconf"));
  SET_STRING_ELT(nms, 588, mkChar("dim_new_I_triage_D_unconf_1"));
  SET_STRING_ELT(nms, 589, mkChar("dim_new_I_triage_D_unconf_12"));
  SET_STRING_ELT(nms, 590, mkChar("dim_new_I_triage_D_unconf_2"));
  SET_STRING_ELT(nms, 591, mkChar("dim_new_I_triage_D_unconf_3"));
  SET_STRING_ELT(nms, 592, mkChar("dim_new_I_triage_R_conf"));
  SET_STRING_ELT(nms, 593, mkChar("dim_new_I_triage_R_conf_1"));
  SET_STRING_ELT(nms, 594, mkChar("dim_new_I_triage_R_conf_12"));
  SET_STRING_ELT(nms, 595, mkChar("dim_new_I_triage_R_conf_2"));
  SET_STRING_ELT(nms, 596, mkChar("dim_new_I_triage_R_conf_3"));
  SET_STRING_ELT(nms, 597, mkChar("dim_new_I_triage_R_unconf"));
  SET_STRING_ELT(nms, 598, mkChar("dim_new_I_triage_R_unconf_1"));
  SET_STRING_ELT(nms, 599, mkChar("dim_new_I_triage_R_unconf_12"));
  SET_STRING_ELT(nms, 600, mkChar("dim_new_I_triage_R_unconf_2"));
  SET_STRING_ELT(nms, 601, mkChar("dim_new_I_triage_R_unconf_3"));
  SET_STRING_ELT(nms, 602, mkChar("dim_new_R_stepdown_conf"));
  SET_STRING_ELT(nms, 603, mkChar("dim_new_R_stepdown_conf_1"));
  SET_STRING_ELT(nms, 604, mkChar("dim_new_R_stepdown_conf_2"));
  SET_STRING_ELT(nms, 605, mkChar("dim_new_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 606, mkChar("dim_new_R_stepdown_unconf_1"));
  SET_STRING_ELT(nms, 607, mkChar("dim_new_R_stepdown_unconf_2"));
  SET_STRING_ELT(nms, 608, mkChar("dim_p_admit_conf"));
  SET_STRING_ELT(nms, 609, mkChar("dim_p_asympt"));
  SET_STRING_ELT(nms, 610, mkChar("dim_p_death_comm"));
  SET_STRING_ELT(nms, 611, mkChar("dim_p_death_hosp_D"));
  SET_STRING_ELT(nms, 612, mkChar("dim_p_death_ICU"));
  SET_STRING_ELT(nms, 613, mkChar("dim_p_ICU_hosp"));
  SET_STRING_ELT(nms, 614, mkChar("dim_p_R_pre"));
  SET_STRING_ELT(nms, 615, mkChar("dim_p_recov_ILI"));
  SET_STRING_ELT(nms, 616, mkChar("dim_p_SE"));
  SET_STRING_ELT(nms, 617, mkChar("dim_p_seroconversion"));
  SET_STRING_ELT(nms, 618, mkChar("dim_p_sympt_ILI"));
  SET_STRING_ELT(nms, 619, mkChar("dim_R"));
  SET_STRING_ELT(nms, 620, mkChar("dim_R_neg"));
  SET_STRING_ELT(nms, 621, mkChar("dim_R_pos"));
  SET_STRING_ELT(nms, 622, mkChar("dim_R_pre"));
  SET_STRING_ELT(nms, 623, mkChar("dim_R_pre_1"));
  SET_STRING_ELT(nms, 624, mkChar("dim_R_pre_2"));
  SET_STRING_ELT(nms, 625, mkChar("dim_R_stepdown_conf"));
  SET_STRING_ELT(nms, 626, mkChar("dim_R_stepdown_conf_1"));
  SET_STRING_ELT(nms, 627, mkChar("dim_R_stepdown_conf_2"));
  SET_STRING_ELT(nms, 628, mkChar("dim_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 629, mkChar("dim_R_stepdown_unconf_1"));
  SET_STRING_ELT(nms, 630, mkChar("dim_R_stepdown_unconf_2"));
  SET_STRING_ELT(nms, 631, mkChar("dim_R0"));
  SET_STRING_ELT(nms, 632, mkChar("dim_R0_neg"));
  SET_STRING_ELT(nms, 633, mkChar("dim_R0_pos"));
  SET_STRING_ELT(nms, 634, mkChar("dim_R0_pre"));
  SET_STRING_ELT(nms, 635, mkChar("dim_R0_pre_1"));
  SET_STRING_ELT(nms, 636, mkChar("dim_R0_pre_2"));
  SET_STRING_ELT(nms, 637, mkChar("dim_R0_stepdown_conf"));
  SET_STRING_ELT(nms, 638, mkChar("dim_R0_stepdown_conf_1"));
  SET_STRING_ELT(nms, 639, mkChar("dim_R0_stepdown_conf_2"));
  SET_STRING_ELT(nms, 640, mkChar("dim_R0_stepdown_unconf"));
  SET_STRING_ELT(nms, 641, mkChar("dim_R0_stepdown_unconf_1"));
  SET_STRING_ELT(nms, 642, mkChar("dim_R0_stepdown_unconf_2"));
  SET_STRING_ELT(nms, 643, mkChar("dim_S"));
  SET_STRING_ELT(nms, 644, mkChar("dim_s_ij"));
  SET_STRING_ELT(nms, 645, mkChar("dim_s_ij_1"));
  SET_STRING_ELT(nms, 646, mkChar("dim_s_ij_2"));
  SET_STRING_ELT(nms, 647, mkChar("dim_S0"));
  SET_STRING_ELT(nms, 648, mkChar("dim_trans_increase"));
  SET_STRING_ELT(nms, 649, mkChar("dim_trans_increase_1"));
  SET_STRING_ELT(nms, 650, mkChar("dim_trans_increase_2"));
  SET_STRING_ELT(nms, 651, mkChar("dim_trans_profile"));
  SET_STRING_ELT(nms, 652, mkChar("dim_trans_profile_1"));
  SET_STRING_ELT(nms, 653, mkChar("dim_trans_profile_2"));
  SET_STRING_ELT(nms, 654, mkChar("dt"));
  SET_STRING_ELT(nms, 655, mkChar("E0"));
  SET_STRING_ELT(nms, 656, mkChar("gamma_asympt"));
  SET_STRING_ELT(nms, 657, mkChar("gamma_comm_D"));
  SET_STRING_ELT(nms, 658, mkChar("gamma_E"));
  SET_STRING_ELT(nms, 659, mkChar("gamma_hosp_D"));
  SET_STRING_ELT(nms, 660, mkChar("gamma_hosp_R"));
  SET_STRING_ELT(nms, 661, mkChar("gamma_ICU_D"));
  SET_STRING_ELT(nms, 662, mkChar("gamma_ICU_R"));
  SET_STRING_ELT(nms, 663, mkChar("gamma_ILI"));
  SET_STRING_ELT(nms, 664, mkChar("gamma_mild"));
  SET_STRING_ELT(nms, 665, mkChar("gamma_R_pre"));
  SET_STRING_ELT(nms, 666, mkChar("gamma_stepdown"));
  SET_STRING_ELT(nms, 667, mkChar("gamma_test"));
  SET_STRING_ELT(nms, 668, mkChar("gamma_triage"));
  SET_STRING_ELT(nms, 669, mkChar("hosp_transmission"));
  SET_STRING_ELT(nms, 670, mkChar("I_with_diff_trans"));
  SET_STRING_ELT(nms, 671, mkChar("I0_asympt"));
  SET_STRING_ELT(nms, 672, mkChar("I0_comm_D"));
  SET_STRING_ELT(nms, 673, mkChar("I0_hosp_D_conf"));
  SET_STRING_ELT(nms, 674, mkChar("I0_hosp_D_unconf"));
  SET_STRING_ELT(nms, 675, mkChar("I0_hosp_R_conf"));
  SET_STRING_ELT(nms, 676, mkChar("I0_hosp_R_unconf"));
  SET_STRING_ELT(nms, 677, mkChar("I0_ICU_D_conf"));
  SET_STRING_ELT(nms, 678, mkChar("I0_ICU_D_unconf"));
  SET_STRING_ELT(nms, 679, mkChar("I0_ICU_R_conf"));
  SET_STRING_ELT(nms, 680, mkChar("I0_ICU_R_unconf"));
  SET_STRING_ELT(nms, 681, mkChar("I0_ILI"));
  SET_STRING_ELT(nms, 682, mkChar("I0_mild"));
  SET_STRING_ELT(nms, 683, mkChar("I0_triage_D_conf"));
  SET_STRING_ELT(nms, 684, mkChar("I0_triage_D_unconf"));
  SET_STRING_ELT(nms, 685, mkChar("I0_triage_R"));
  SET_STRING_ELT(nms, 686, mkChar("I0_triage_R_conf"));
  SET_STRING_ELT(nms, 687, mkChar("I0_triage_R_unconf"));
  SET_STRING_ELT(nms, 688, mkChar("ICU_transmission"));
  SET_STRING_ELT(nms, 689, mkChar("initial_cum_admit_conf"));
  SET_STRING_ELT(nms, 690, mkChar("initial_cum_new_conf"));
  SET_STRING_ELT(nms, 691, mkChar("initial_D_comm"));
  SET_STRING_ELT(nms, 692, mkChar("initial_D_hosp"));
  SET_STRING_ELT(nms, 693, mkChar("initial_E"));
  SET_STRING_ELT(nms, 694, mkChar("initial_I_asympt"));
  SET_STRING_ELT(nms, 695, mkChar("initial_I_comm_D"));
  SET_STRING_ELT(nms, 696, mkChar("initial_I_hosp_D_conf"));
  SET_STRING_ELT(nms, 697, mkChar("initial_I_hosp_D_unconf"));
  SET_STRING_ELT(nms, 698, mkChar("initial_I_hosp_R_conf"));
  SET_STRING_ELT(nms, 699, mkChar("initial_I_hosp_R_unconf"));
  SET_STRING_ELT(nms, 700, mkChar("initial_I_ICU_D_conf"));
  SET_STRING_ELT(nms, 701, mkChar("initial_I_ICU_D_unconf"));
  SET_STRING_ELT(nms, 702, mkChar("initial_I_ICU_R_conf"));
  SET_STRING_ELT(nms, 703, mkChar("initial_I_ICU_R_unconf"));
  SET_STRING_ELT(nms, 704, mkChar("initial_I_ILI"));
  SET_STRING_ELT(nms, 705, mkChar("initial_I_mild"));
  SET_STRING_ELT(nms, 706, mkChar("initial_I_triage_D_conf"));
  SET_STRING_ELT(nms, 707, mkChar("initial_I_triage_D_unconf"));
  SET_STRING_ELT(nms, 708, mkChar("initial_I_triage_R"));
  SET_STRING_ELT(nms, 709, mkChar("initial_I_triage_R_conf"));
  SET_STRING_ELT(nms, 710, mkChar("initial_I_triage_R_unconf"));
  SET_STRING_ELT(nms, 711, mkChar("initial_R"));
  SET_STRING_ELT(nms, 712, mkChar("initial_R_neg"));
  SET_STRING_ELT(nms, 713, mkChar("initial_R_pos"));
  SET_STRING_ELT(nms, 714, mkChar("initial_R_pre"));
  SET_STRING_ELT(nms, 715, mkChar("initial_R_stepdown_conf"));
  SET_STRING_ELT(nms, 716, mkChar("initial_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 717, mkChar("initial_S"));
  SET_STRING_ELT(nms, 718, mkChar("interpolate_beta"));
  SET_STRING_ELT(nms, 719, mkChar("lambda"));
  SET_STRING_ELT(nms, 720, mkChar("m"));
  SET_STRING_ELT(nms, 721, mkChar("N_age"));
  SET_STRING_ELT(nms, 722, mkChar("n_com_to_R_pre"));
  SET_STRING_ELT(nms, 723, mkChar("n_com_to_R_total"));
  SET_STRING_ELT(nms, 724, mkChar("n_EE"));
  SET_STRING_ELT(nms, 725, mkChar("n_EI_asympt"));
  SET_STRING_ELT(nms, 726, mkChar("n_EI_ILI"));
  SET_STRING_ELT(nms, 727, mkChar("n_EI_mild"));
  SET_STRING_ELT(nms, 728, mkChar("n_hosp_non_ICU"));
  SET_STRING_ELT(nms, 729, mkChar("n_I_hosp_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 730, mkChar("n_I_hosp_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 731, mkChar("n_I_ICU_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 732, mkChar("n_I_ICU_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 733, mkChar("n_I_triage_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 734, mkChar("n_I_triage_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 735, mkChar("n_II_asympt"));
  SET_STRING_ELT(nms, 736, mkChar("n_II_comm_D"));
  SET_STRING_ELT(nms, 737, mkChar("n_II_hosp_D_conf"));
  SET_STRING_ELT(nms, 738, mkChar("n_II_hosp_D_unconf"));
  SET_STRING_ELT(nms, 739, mkChar("n_II_hosp_R_conf"));
  SET_STRING_ELT(nms, 740, mkChar("n_II_hosp_R_unconf"));
  SET_STRING_ELT(nms, 741, mkChar("n_II_ICU_D_conf"));
  SET_STRING_ELT(nms, 742, mkChar("n_II_ICU_D_unconf"));
  SET_STRING_ELT(nms, 743, mkChar("n_II_ICU_R_conf"));
  SET_STRING_ELT(nms, 744, mkChar("n_II_ICU_R_unconf"));
  SET_STRING_ELT(nms, 745, mkChar("n_II_ILI"));
  SET_STRING_ELT(nms, 746, mkChar("n_II_mild"));
  SET_STRING_ELT(nms, 747, mkChar("n_II_triage_D_conf"));
  SET_STRING_ELT(nms, 748, mkChar("n_II_triage_D_unconf"));
  SET_STRING_ELT(nms, 749, mkChar("n_II_triage_R_conf"));
  SET_STRING_ELT(nms, 750, mkChar("n_II_triage_R_unconf"));
  SET_STRING_ELT(nms, 751, mkChar("n_ILI_to_comm_D"));
  SET_STRING_ELT(nms, 752, mkChar("n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 753, mkChar("n_ILI_to_hosp_D"));
  SET_STRING_ELT(nms, 754, mkChar("n_ILI_to_hosp_D_conf"));
  SET_STRING_ELT(nms, 755, mkChar("n_ILI_to_hosp_R"));
  SET_STRING_ELT(nms, 756, mkChar("n_ILI_to_hosp_R_conf"));
  SET_STRING_ELT(nms, 757, mkChar("n_ILI_to_triage"));
  SET_STRING_ELT(nms, 758, mkChar("n_ILI_to_triage_D"));
  SET_STRING_ELT(nms, 759, mkChar("n_ILI_to_triage_D_conf"));
  SET_STRING_ELT(nms, 760, mkChar("n_ILI_to_triage_R"));
  SET_STRING_ELT(nms, 761, mkChar("n_ILI_to_triage_R_conf"));
  SET_STRING_ELT(nms, 762, mkChar("n_R_pre"));
  SET_STRING_ELT(nms, 763, mkChar("n_R_stepdown_conf"));
  SET_STRING_ELT(nms, 764, mkChar("n_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 765, mkChar("n_R_stepdown_unconf_to_conf"));
  SET_STRING_ELT(nms, 766, mkChar("n_SE"));
  SET_STRING_ELT(nms, 767, mkChar("N_tot"));
  SET_STRING_ELT(nms, 768, mkChar("new_I_hosp_D_conf"));
  SET_STRING_ELT(nms, 769, mkChar("new_I_hosp_D_unconf"));
  SET_STRING_ELT(nms, 770, mkChar("new_I_hosp_R_conf"));
  SET_STRING_ELT(nms, 771, mkChar("new_I_hosp_R_unconf"));
  SET_STRING_ELT(nms, 772, mkChar("new_I_ICU_D_conf"));
  SET_STRING_ELT(nms, 773, mkChar("new_I_ICU_D_unconf"));
  SET_STRING_ELT(nms, 774, mkChar("new_I_ICU_R_conf"));
  SET_STRING_ELT(nms, 775, mkChar("new_I_ICU_R_unconf"));
  SET_STRING_ELT(nms, 776, mkChar("new_I_triage_D_conf"));
  SET_STRING_ELT(nms, 777, mkChar("new_I_triage_D_unconf"));
  SET_STRING_ELT(nms, 778, mkChar("new_I_triage_R_conf"));
  SET_STRING_ELT(nms, 779, mkChar("new_I_triage_R_unconf"));
  SET_STRING_ELT(nms, 780, mkChar("new_R_stepdown_conf"));
  SET_STRING_ELT(nms, 781, mkChar("new_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 782, mkChar("offset_variable_D_comm"));
  SET_STRING_ELT(nms, 783, mkChar("offset_variable_D_hosp"));
  SET_STRING_ELT(nms, 784, mkChar("offset_variable_E"));
  SET_STRING_ELT(nms, 785, mkChar("offset_variable_I_asympt"));
  SET_STRING_ELT(nms, 786, mkChar("offset_variable_I_comm_D"));
  SET_STRING_ELT(nms, 787, mkChar("offset_variable_I_hosp_D_conf"));
  SET_STRING_ELT(nms, 788, mkChar("offset_variable_I_hosp_D_unconf"));
  SET_STRING_ELT(nms, 789, mkChar("offset_variable_I_hosp_R_conf"));
  SET_STRING_ELT(nms, 790, mkChar("offset_variable_I_hosp_R_unconf"));
  SET_STRING_ELT(nms, 791, mkChar("offset_variable_I_ICU_D_conf"));
  SET_STRING_ELT(nms, 792, mkChar("offset_variable_I_ICU_D_unconf"));
  SET_STRING_ELT(nms, 793, mkChar("offset_variable_I_ICU_R_conf"));
  SET_STRING_ELT(nms, 794, mkChar("offset_variable_I_ICU_R_unconf"));
  SET_STRING_ELT(nms, 795, mkChar("offset_variable_I_ILI"));
  SET_STRING_ELT(nms, 796, mkChar("offset_variable_I_mild"));
  SET_STRING_ELT(nms, 797, mkChar("offset_variable_I_triage_D_conf"));
  SET_STRING_ELT(nms, 798, mkChar("offset_variable_I_triage_D_unconf"));
  SET_STRING_ELT(nms, 799, mkChar("offset_variable_I_triage_R"));
  SET_STRING_ELT(nms, 800, mkChar("offset_variable_I_triage_R_conf"));
  SET_STRING_ELT(nms, 801, mkChar("offset_variable_I_triage_R_unconf"));
  SET_STRING_ELT(nms, 802, mkChar("offset_variable_R"));
  SET_STRING_ELT(nms, 803, mkChar("offset_variable_R_neg"));
  SET_STRING_ELT(nms, 804, mkChar("offset_variable_R_pos"));
  SET_STRING_ELT(nms, 805, mkChar("offset_variable_R_pre"));
  SET_STRING_ELT(nms, 806, mkChar("offset_variable_R_stepdown_conf"));
  SET_STRING_ELT(nms, 807, mkChar("offset_variable_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 808, mkChar("p_admit_conf"));
  SET_STRING_ELT(nms, 809, mkChar("p_asympt"));
  SET_STRING_ELT(nms, 810, mkChar("p_death_comm"));
  SET_STRING_ELT(nms, 811, mkChar("p_death_hosp_D"));
  SET_STRING_ELT(nms, 812, mkChar("p_death_ICU"));
  SET_STRING_ELT(nms, 813, mkChar("p_EE"));
  SET_STRING_ELT(nms, 814, mkChar("p_ICU_hosp"));
  SET_STRING_ELT(nms, 815, mkChar("p_II_asympt"));
  SET_STRING_ELT(nms, 816, mkChar("p_II_comm_D"));
  SET_STRING_ELT(nms, 817, mkChar("p_II_hosp_D"));
  SET_STRING_ELT(nms, 818, mkChar("p_II_hosp_R"));
  SET_STRING_ELT(nms, 819, mkChar("p_II_ICU_D"));
  SET_STRING_ELT(nms, 820, mkChar("p_II_ICU_R"));
  SET_STRING_ELT(nms, 821, mkChar("p_II_ILI"));
  SET_STRING_ELT(nms, 822, mkChar("p_II_mild"));
  SET_STRING_ELT(nms, 823, mkChar("p_II_triage"));
  SET_STRING_ELT(nms, 824, mkChar("p_R_pre"));
  SET_STRING_ELT(nms, 825, mkChar("p_R_stepdown"));
  SET_STRING_ELT(nms, 826, mkChar("p_recov_ILI"));
  SET_STRING_ELT(nms, 827, mkChar("p_SE"));
  SET_STRING_ELT(nms, 828, mkChar("p_seroconversion"));
  SET_STRING_ELT(nms, 829, mkChar("p_sympt_ILI"));
  SET_STRING_ELT(nms, 830, mkChar("p_test"));
  SET_STRING_ELT(nms, 831, mkChar("R0"));
  SET_STRING_ELT(nms, 832, mkChar("R0_neg"));
  SET_STRING_ELT(nms, 833, mkChar("R0_pos"));
  SET_STRING_ELT(nms, 834, mkChar("R0_pre"));
  SET_STRING_ELT(nms, 835, mkChar("R0_stepdown_conf"));
  SET_STRING_ELT(nms, 836, mkChar("R0_stepdown_unconf"));
  SET_STRING_ELT(nms, 837, mkChar("s_asympt"));
  SET_STRING_ELT(nms, 838, mkChar("s_comm_D"));
  SET_STRING_ELT(nms, 839, mkChar("s_E"));
  SET_STRING_ELT(nms, 840, mkChar("s_hosp_D"));
  SET_STRING_ELT(nms, 841, mkChar("s_hosp_R"));
  SET_STRING_ELT(nms, 842, mkChar("s_ICU_D"));
  SET_STRING_ELT(nms, 843, mkChar("s_ICU_R"));
  SET_STRING_ELT(nms, 844, mkChar("s_ij"));
  SET_STRING_ELT(nms, 845, mkChar("s_ILI"));
  SET_STRING_ELT(nms, 846, mkChar("s_mild"));
  SET_STRING_ELT(nms, 847, mkChar("s_R_pre"));
  SET_STRING_ELT(nms, 848, mkChar("s_stepdown"));
  SET_STRING_ELT(nms, 849, mkChar("s_triage"));
  SET_STRING_ELT(nms, 850, mkChar("S0"));
  SET_STRING_ELT(nms, 851, mkChar("test_classes"));
  SET_STRING_ELT(nms, 852, mkChar("trans_classes"));
  SET_STRING_ELT(nms, 853, mkChar("trans_increase"));
  SET_STRING_ELT(nms, 854, mkChar("trans_profile"));
  setAttrib(contents, R_NamesSymbol, nms);
  UNPROTECT(167);
  return contents;
}
SEXP hospital_with_serology_testing_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->dim_I_triage_R_4 = internal->test_classes;
  ...
  internal->dim_I0_triage_R_4 = internal->test_classes;
  ...
  internal->dim_I_triage_R = internal->dim_I_triage_R_1 * internal->dim_I_triage_R_2 * internal->dim_I_triage_R_3 * internal->dim_I_triage_R_4;
  internal->dim_I_triage_R_12 = internal->dim_I_triage_R_1 * internal->dim_I_triage_R_2;
  internal->dim_I_triage_R_123 = internal->dim_I_triage_R_1 * internal->dim_I_triage_R_2 * internal->dim_I_triage_R_3;
  ...
  internal->dim_I0_triage_R = internal->dim_I0_triage_R_1 * internal->dim_I0_triage_R_2 * internal->dim_I0_triage_R_3 * internal->dim_I0_triage_R_4;
  internal->dim_I0_triage_R_12 = internal->dim_I0_triage_R_1 * internal->dim_I0_triage_R_2;
  internal->dim_I0_triage_R_123 = internal->dim_I0_triage_R_1 * internal->dim_I0_triage_R_2 * internal->dim_I0_triage_R_3;
  ...
  internal->I0_triage_R = (double*) user_get_array(user, false, internal->I0_triage_R, "I0_triage_R", NA_REAL, NA_REAL, 4, internal->dim_I0_triage_R_1, internal->dim_I0_triage_R_2, internal->dim_I0_triage_R_3, internal->dim_I0_triage_R_4);
  ...
  internal->offset_variable_I_triage_R = 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg + internal->dim_R + internal->dim_D_hosp + internal->dim_D_comm + internal->dim_R_stepdown_unconf + internal->dim_R_stepdown_conf + internal->dim_R_pre + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_comm_D + internal->dim_I_triage_R_unconf + internal->dim_I_triage_R_conf + internal->dim_I_triage_D_unconf + internal->dim_I_triage_D_conf + internal->dim_I_hosp_R_unconf + internal->dim_I_hosp_R_conf + internal->dim_I_hosp_D_unconf + internal->dim_I_hosp_D_conf + internal->dim_I_ICU_R_unconf + internal->dim_I_ICU_R_conf + internal->dim_I_ICU_D_unconf + internal->dim_I_ICU_D_conf;
  ...
  for (int i = 1; i <= internal->dim_I_triage_R_1; ++i) {
    for (int j = 1; j <= internal->dim_I_triage_R_2; ++j) {
      for (int k = 1; k <= internal->dim_I_triage_R_3; ++k) {
        for (int l = 1; l <= internal->dim_I_triage_R_4; ++l) {
          internal->initial_I_triage_R[i - 1 + internal->dim_I_triage_R_1 * (j - 1) + internal->dim_I_triage_R_12 * (k - 1) + internal->dim_I_triage_R_123 * (l - 1)] = internal->I0_triage_R[internal->dim_I0_triage_R_123 * (l - 1) + internal->dim_I0_triage_R_12 * (k - 1) + internal->dim_I0_triage_R_1 * (j - 1) + i - 1];
        }
      }
    }
  }
...
SEXP hospital_with_serology_testing_metadata(SEXP internal_p) {
  ...
  int * dim_I_triage_R = INTEGER(VECTOR_ELT(variable_length, 28));
  ...
  dim_I_triage_R[3] = internal->dim_I_triage_R_4;
  ...
  SET_STRING_ELT(variable_names, 28, mkChar("I_triage_R"));
  SET_VECTOR_ELT(ret, 0, variable_length);
  UNPROTECT(2);
...
SEXP hospital_with_serology_testing_initial_conditions(SEXP internal_p, SEXP step_ptr) {
  hospital_with_serology_testing_internal *internal = hospital_with_serology_testing_get_internal(internal_p, 1);
  SEXP r_state = PROTECT(allocVector(REALSXP, 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg + internal->dim_R + internal->dim_D_hosp + internal->dim_D_comm + internal->dim_R_stepdown_unconf + internal->dim_R_stepdown_conf + internal->dim_R_pre + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_comm_D + internal->dim_I_triage_R_unconf + internal->dim_I_triage_R_conf + internal->dim_I_triage_D_unconf + internal->dim_I_triage_D_conf + internal->dim_I_hosp_R_unconf + internal->dim_I_hosp_R_conf + internal->dim_I_hosp_D_unconf + internal->dim_I_hosp_D_conf + internal->dim_I_ICU_R_unconf + internal->dim_I_ICU_R_conf + internal->dim_I_ICU_D_unconf + internal->dim_I_ICU_D_conf + internal->dim_I_triage_R));
  double * state = REAL(r_state);
...
void hospital_with_serology_testing_rhs(hospital_with_serology_testing_internal* internal, size_t step, double * state, double * state_next, double * output) {
  ...
  for (int i = 1; i <= internal->dim_I_triage_R_1; ++i) {
    for (int j = 1; j <= internal->dim_I_triage_R_2; ++j) {
      for (int k = 1; k <= internal->dim_I_triage_R_3; ++k) {
        for (int l = 1; l <= internal->dim_I_triage_R_4; ++l) {
          state_next[internal->offset_variable_I_triage_R + i - 1 + internal->dim_I_triage_R_1 * (j - 1) + internal->dim_I_triage_R_12 * (k - 1) + internal->dim_I_triage_R_123 * (l - 1)] = I_triage_R[internal->dim_I_triage_R_123 * (l - 1) + internal->dim_I_triage_R_12 * (k - 1) + internal->dim_I_triage_R_1 * (j - 1) + i - 1];
        }
      }
    }
  }
