...
typedef struct diffusion_beta_tmp_internal {
  double *aux_EE;
  double *aux_II_asympt;
  double *aux_II_hosp;
  double *aux_II_ICU;
  ...
  double *trans_profile;
  double x0;
} diffusion_beta_tmp_internal;
typedef struct diffusion_beta_internal {
  double *aux_EE;
  double *aux_II_asympt;
...
diffusion_beta_tmp_internal* diffusion_beta_tmp_get_internal(SEXP internal_p, int closed_error);
static void diffusion_beta_tmp_finalise(SEXP internal_p);
SEXP diffusion_beta_tmp_create(SEXP user);
void diffusion_beta_tmp_initmod_desolve(void(* odeparms) (int *, double *));
SEXP diffusion_beta_tmp_contents(SEXP internal_p);
SEXP diffusion_beta_tmp_set_user(SEXP internal_p, SEXP user);
SEXP diffusion_beta_tmp_metadata(SEXP internal_p);
SEXP diffusion_beta_tmp_initial_conditions(SEXP internal_p, SEXP step_ptr);
void diffusion_beta_tmp_rhs(diffusion_beta_tmp_internal* internal, size_t step, double * state, double * state_next, double * output);
void diffusion_beta_tmp_rhs_dde(size_t n_eq, size_t step, double * state, double * state_next, size_t n_out, double * output, void * internal);
SEXP diffusion_beta_tmp_rhs_r(SEXP internal_p, SEXP step, SEXP state);
diffusion_beta_internal* diffusion_beta_get_internal(SEXP internal_p, int closed_error);
static void diffusion_beta_finalise(SEXP internal_p);
SEXP diffusion_beta_create(SEXP user);
void diffusion_beta_initmod_desolve(void(* odeparms) (int *, double *));
SEXP diffusion_beta_contents(SEXP internal_p);
SEXP diffusion_beta_set_user(SEXP internal_p, SEXP user);
SEXP diffusion_beta_metadata(SEXP internal_p);
SEXP diffusion_beta_initial_conditions(SEXP internal_p, SEXP step_ptr);
void diffusion_beta_rhs(diffusion_beta_internal* internal, size_t step, double * state, double * state_next, double * output);
void diffusion_beta_rhs_dde(size_t n_eq, size_t step, double * state, double * state_next, size_t n_out, double * output, void * internal);
SEXP diffusion_beta_rhs_r(SEXP internal_p, SEXP step, SEXP state);
...
diffusion_beta_tmp_internal* diffusion_beta_tmp_get_internal(SEXP internal_p, int closed_error) {
  diffusion_beta_tmp_internal *internal = NULL;
  if (TYPEOF(internal_p) != EXTPTRSXP) {
    Rf_error("Expected an external pointer");
  }
  internal = (diffusion_beta_tmp_internal*) R_ExternalPtrAddr(internal_p);
  if (!internal && closed_error) {
    Rf_error("Pointer has been invalidated");
  }
  return internal;
}
void diffusion_beta_tmp_finalise(SEXP internal_p) {
  diffusion_beta_tmp_internal *internal = diffusion_beta_tmp_get_internal(internal_p, 0);
  if (internal_p) {
    Free(internal->aux_EE);
    Free(internal->aux_II_asympt);
    Free(internal->aux_II_hosp);
...
SEXP diffusion_beta_tmp_create(SEXP user) {
  diffusion_beta_tmp_internal *internal = (diffusion_beta_tmp_internal*) Calloc(1, diffusion_beta_tmp_internal);
  internal->aux_EE = NULL;
  internal->aux_II_asympt = NULL;
  internal->aux_II_hosp = NULL;
  internal->aux_II_ICU = NULL;
  ...
  internal->gamma_mild = 0.10000000000000001;
  internal->gamma_rec = 0.10000000000000001;
  internal->sd_x = 0.10000000000000001;
  SEXP ptr = PROTECT(R_MakeExternalPtr(internal, R_NilValue, R_NilValue));
  R_RegisterCFinalizer(ptr, diffusion_beta_tmp_finalise);
  UNPROTECT(1);
  return ptr;
}
static diffusion_beta_tmp_internal *diffusion_beta_tmp_internal_ds;
void diffusion_beta_tmp_initmod_desolve(void(* odeparms) (int *, double *)) {
  static DL_FUNC get_desolve_gparms = NULL;
  if (get_desolve_gparms == NULL) {
    get_desolve_gparms =
  ...
  diffusion_beta_tmp_internal_ds = diffusion_beta_tmp_get_internal(get_desolve_gparms(), 1);
}
SEXP diffusion_beta_tmp_contents(SEXP internal_p) {
  diffusion_beta_tmp_internal *internal = diffusion_beta_tmp_get_internal(internal_p, 1);
  SEXP contents = PROTECT(allocVector(VECSXP, 338));
  SEXP aux_EE = PROTECT(allocVector(REALSXP, internal->dim_aux_EE));
  memcpy(REAL(aux_EE), internal->aux_EE, internal->dim_aux_EE * sizeof(double));
  odin_set_dim(aux_EE, 3, internal->dim_aux_EE_1, internal->dim_aux_EE_2, internal->dim_aux_EE_3);
  SET_VECTOR_ELT(contents, 0, aux_EE);
  ...
  SEXP D0 = PROTECT(allocVector(REALSXP, internal->dim_D0));
  memcpy(REAL(D0), internal->D0, internal->dim_D0 * sizeof(double));
  SET_VECTOR_ELT(contents, 8, D0);
  SEXP delta_D = PROTECT(allocVector(REALSXP, internal->dim_delta_D));
  memcpy(REAL(delta_D), internal->delta_D, internal->dim_delta_D * sizeof(double));
  SET_VECTOR_ELT(contents, 9, delta_D);
  SEXP delta_E = PROTECT(allocVector(REALSXP, internal->dim_delta_E));
  memcpy(REAL(delta_E), internal->delta_E, internal->dim_delta_E * sizeof(double));
  odin_set_dim(delta_E, 3, internal->dim_delta_E_1, internal->dim_delta_E_2, internal->dim_delta_E_3);
  SET_VECTOR_ELT(contents, 10, delta_E);
  SEXP delta_I_asympt = PROTECT(allocVector(REALSXP, internal->dim_delta_I_asympt));
  memcpy(REAL(delta_I_asympt), internal->delta_I_asympt, internal->dim_delta_I_asympt * sizeof(double));
  odin_set_dim(delta_I_asympt, 3, internal->dim_delta_I_asympt_1, internal->dim_delta_I_asympt_2, internal->dim_delta_I_asympt_3);
  SET_VECTOR_ELT(contents, 11, delta_I_asympt);
  SEXP delta_I_hosp = PROTECT(allocVector(REALSXP, internal->dim_delta_I_hosp));
  memcpy(REAL(delta_I_hosp), internal->delta_I_hosp, internal->dim_delta_I_hosp * sizeof(double));
  odin_set_dim(delta_I_hosp, 3, internal->dim_delta_I_hosp_1, internal->dim_delta_I_hosp_2, internal->dim_delta_I_hosp_3);
  SET_VECTOR_ELT(contents, 12, delta_I_hosp);
  SEXP delta_I_ICU = PROTECT(allocVector(REALSXP, internal->dim_delta_I_ICU));
  memcpy(REAL(delta_I_ICU), internal->delta_I_ICU, internal->dim_delta_I_ICU * sizeof(double));
  odin_set_dim(delta_I_ICU, 3, internal->dim_delta_I_ICU_1, internal->dim_delta_I_ICU_2, internal->dim_delta_I_ICU_3);
  SET_VECTOR_ELT(contents, 13, delta_I_ICU);
  SEXP delta_I_ILI = PROTECT(allocVector(REALSXP, internal->dim_delta_I_ILI));
  memcpy(REAL(delta_I_ILI), internal->delta_I_ILI, internal->dim_delta_I_ILI * sizeof(double));
  odin_set_dim(delta_I_ILI, 3, internal->dim_delta_I_ILI_1, internal->dim_delta_I_ILI_2, internal->dim_delta_I_ILI_3);
  SET_VECTOR_ELT(contents, 14, delta_I_ILI);
  SEXP delta_I_mild = PROTECT(allocVector(REALSXP, internal->dim_delta_I_mild));
  memcpy(REAL(delta_I_mild), internal->delta_I_mild, internal->dim_delta_I_mild * sizeof(double));
  odin_set_dim(delta_I_mild, 3, internal->dim_delta_I_mild_1, internal->dim_delta_I_mild_2, internal->dim_delta_I_mild_3);
  SET_VECTOR_ELT(contents, 15, delta_I_mild);
  SEXP delta_R = PROTECT(allocVector(REALSXP, internal->dim_delta_R));
  memcpy(REAL(delta_R), internal->delta_R, internal->dim_delta_R * sizeof(double));
  SET_VECTOR_ELT(contents, 16, delta_R);
  SEXP delta_R_hosp = PROTECT(allocVector(REALSXP, internal->dim_delta_R_hosp));
  memcpy(REAL(delta_R_hosp), internal->delta_R_hosp, internal->dim_delta_R_hosp * sizeof(double));
  odin_set_dim(delta_R_hosp, 3, internal->dim_delta_R_hosp_1, internal->dim_delta_R_hosp_2, internal->dim_delta_R_hosp_3);
  SET_VECTOR_ELT(contents, 17, delta_R_hosp);
  SET_VECTOR_ELT(contents, 18, ScalarInteger(internal->dim_aux_EE));
  SET_VECTOR_ELT(contents, 19, ScalarInteger(internal->dim_aux_EE_1));
  SET_VECTOR_ELT(contents, 20, ScalarInteger(internal->dim_aux_EE_12));
  SET_VECTOR_ELT(contents, 21, ScalarInteger(internal->dim_aux_EE_2));
  SET_VECTOR_ELT(contents, 22, ScalarInteger(internal->dim_aux_EE_3));
  SET_VECTOR_ELT(contents, 23, ScalarInteger(internal->dim_aux_II_asympt));
  SET_VECTOR_ELT(contents, 24, ScalarInteger(internal->dim_aux_II_asympt_1));
  SET_VECTOR_ELT(contents, 25, ScalarInteger(internal->dim_aux_II_asympt_12));
  SET_VECTOR_ELT(contents, 26, ScalarInteger(internal->dim_aux_II_asympt_2));
  SET_VECTOR_ELT(contents, 27, ScalarInteger(internal->dim_aux_II_asympt_3));
  SET_VECTOR_ELT(contents, 28, ScalarInteger(internal->dim_aux_II_hosp));
  SET_VECTOR_ELT(contents, 29, ScalarInteger(internal->dim_aux_II_hosp_1));
  SET_VECTOR_ELT(contents, 30, ScalarInteger(internal->dim_aux_II_hosp_12));
  SET_VECTOR_ELT(contents, 31, ScalarInteger(internal->dim_aux_II_hosp_2));
  SET_VECTOR_ELT(contents, 32, ScalarInteger(internal->dim_aux_II_hosp_3));
  SET_VECTOR_ELT(contents, 33, ScalarInteger(internal->dim_aux_II_ICU));
  SET_VECTOR_ELT(contents, 34, ScalarInteger(internal->dim_aux_II_ICU_1));
  SET_VECTOR_ELT(contents, 35, ScalarInteger(internal->dim_aux_II_ICU_12));
  SET_VECTOR_ELT(contents, 36, ScalarInteger(internal->dim_aux_II_ICU_2));
  SET_VECTOR_ELT(contents, 37, ScalarInteger(internal->dim_aux_II_ICU_3));
  SET_VECTOR_ELT(contents, 38, ScalarInteger(internal->dim_aux_II_ILI));
  SET_VECTOR_ELT(contents, 39, ScalarInteger(internal->dim_aux_II_ILI_1));
  SET_VECTOR_ELT(contents, 40, ScalarInteger(internal->dim_aux_II_ILI_12));
  SET_VECTOR_ELT(contents, 41, ScalarInteger(internal->dim_aux_II_ILI_2));
  SET_VECTOR_ELT(contents, 42, ScalarInteger(internal->dim_aux_II_ILI_3));
  SET_VECTOR_ELT(contents, 43, ScalarInteger(internal->dim_aux_II_mild));
  SET_VECTOR_ELT(contents, 44, ScalarInteger(internal->dim_aux_II_mild_1));
  SET_VECTOR_ELT(contents, 45, ScalarInteger(internal->dim_aux_II_mild_12));
  SET_VECTOR_ELT(contents, 46, ScalarInteger(internal->dim_aux_II_mild_2));
  SET_VECTOR_ELT(contents, 47, ScalarInteger(internal->dim_aux_II_mild_3));
  SET_VECTOR_ELT(contents, 48, ScalarInteger(internal->dim_aux_p_bin));
  SET_VECTOR_ELT(contents, 49, ScalarInteger(internal->dim_aux_p_bin_1));
  SET_VECTOR_ELT(contents, 50, ScalarInteger(internal->dim_aux_p_bin_2));
  SET_VECTOR_ELT(contents, 51, ScalarInteger(internal->dim_aux_R_hosp));
  SET_VECTOR_ELT(contents, 52, ScalarInteger(internal->dim_aux_R_hosp_1));
  SET_VECTOR_ELT(contents, 53, ScalarInteger(internal->dim_aux_R_hosp_12));
  SET_VECTOR_ELT(contents, 54, ScalarInteger(internal->dim_aux_R_hosp_2));
  SET_VECTOR_ELT(contents, 55, ScalarInteger(internal->dim_aux_R_hosp_3));
  SET_VECTOR_ELT(contents, 56, ScalarInteger(internal->dim_D));
  SET_VECTOR_ELT(contents, 57, ScalarInteger(internal->dim_D0));
  SET_VECTOR_ELT(contents, 58, ScalarInteger(internal->dim_delta_D));
  SET_VECTOR_ELT(contents, 59, ScalarInteger(internal->dim_delta_E));
  SET_VECTOR_ELT(contents, 60, ScalarInteger(internal->dim_delta_E_1));
  SET_VECTOR_ELT(contents, 61, ScalarInteger(internal->dim_delta_E_12));
  SET_VECTOR_ELT(contents, 62, ScalarInteger(internal->dim_delta_E_2));
  SET_VECTOR_ELT(contents, 63, ScalarInteger(internal->dim_delta_E_3));
  SET_VECTOR_ELT(contents, 64, ScalarInteger(internal->dim_delta_I_asympt));
  SET_VECTOR_ELT(contents, 65, ScalarInteger(internal->dim_delta_I_asympt_1));
  SET_VECTOR_ELT(contents, 66, ScalarInteger(internal->dim_delta_I_asympt_12));
  SET_VECTOR_ELT(contents, 67, ScalarInteger(internal->dim_delta_I_asympt_2));
  SET_VECTOR_ELT(contents, 68, ScalarInteger(internal->dim_delta_I_asympt_3));
  SET_VECTOR_ELT(contents, 69, ScalarInteger(internal->dim_delta_I_hosp));
  SET_VECTOR_ELT(contents, 70, ScalarInteger(internal->dim_delta_I_hosp_1));
  SET_VECTOR_ELT(contents, 71, ScalarInteger(internal->dim_delta_I_hosp_12));
  SET_VECTOR_ELT(contents, 72, ScalarInteger(internal->dim_delta_I_hosp_2));
  SET_VECTOR_ELT(contents, 73, ScalarInteger(internal->dim_delta_I_hosp_3));
  SET_VECTOR_ELT(contents, 74, ScalarInteger(internal->dim_delta_I_ICU));
  SET_VECTOR_ELT(contents, 75, ScalarInteger(internal->dim_delta_I_ICU_1));
  SET_VECTOR_ELT(contents, 76, ScalarInteger(internal->dim_delta_I_ICU_12));
  SET_VECTOR_ELT(contents, 77, ScalarInteger(internal->dim_delta_I_ICU_2));
  SET_VECTOR_ELT(contents, 78, ScalarInteger(internal->dim_delta_I_ICU_3));
  SET_VECTOR_ELT(contents, 79, ScalarInteger(internal->dim_delta_I_ILI));
  SET_VECTOR_ELT(contents, 80, ScalarInteger(internal->dim_delta_I_ILI_1));
  SET_VECTOR_ELT(contents, 81, ScalarInteger(internal->dim_delta_I_ILI_12));
  SET_VECTOR_ELT(contents, 82, ScalarInteger(internal->dim_delta_I_ILI_2));
  SET_VECTOR_ELT(contents, 83, ScalarInteger(internal->dim_delta_I_ILI_3));
  SET_VECTOR_ELT(contents, 84, ScalarInteger(internal->dim_delta_I_mild));
  SET_VECTOR_ELT(contents, 85, ScalarInteger(internal->dim_delta_I_mild_1));
  SET_VECTOR_ELT(contents, 86, ScalarInteger(internal->dim_delta_I_mild_12));
  SET_VECTOR_ELT(contents, 87, ScalarInteger(internal->dim_delta_I_mild_2));
  SET_VECTOR_ELT(contents, 88, ScalarInteger(internal->dim_delta_I_mild_3));
  SET_VECTOR_ELT(contents, 89, ScalarInteger(internal->dim_delta_R));
  SET_VECTOR_ELT(contents, 90, ScalarInteger(internal->dim_delta_R_hosp));
  SET_VECTOR_ELT(contents, 91, ScalarInteger(internal->dim_delta_R_hosp_1));
  SET_VECTOR_ELT(contents, 92, ScalarInteger(internal->dim_delta_R_hosp_12));
  SET_VECTOR_ELT(contents, 93, ScalarInteger(internal->dim_delta_R_hosp_2));
  SET_VECTOR_ELT(contents, 94, ScalarInteger(internal->dim_delta_R_hosp_3));
  SET_VECTOR_ELT(contents, 95, ScalarInteger(internal->dim_E));
  SET_VECTOR_ELT(contents, 96, ScalarInteger(internal->dim_E_1));
  SET_VECTOR_ELT(contents, 97, ScalarInteger(internal->dim_E_12));
  SET_VECTOR_ELT(contents, 98, ScalarInteger(internal->dim_E_2));
  SET_VECTOR_ELT(contents, 99, ScalarInteger(internal->dim_E_3));
  SET_VECTOR_ELT(contents, 100, ScalarInteger(internal->dim_E0));
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_E0_1));
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_E0_12));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_E0_2));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_E0_3));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_I_asympt));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_I_asympt_1));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_I_asympt_12));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_I_asympt_2));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_I_asympt_3));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_I_hosp));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_I_hosp_1));
  SET_VECTOR_ELT(contents, 112, ScalarInteger(internal->dim_I_hosp_12));
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_I_hosp_2));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_I_hosp_3));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_I_ICU));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_I_ICU_1));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_I_ICU_12));
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_I_ICU_2));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_I_ICU_3));
  SET_VECTOR_ELT(contents, 120, ScalarInteger(internal->dim_I_ILI));
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->dim_I_ILI_1));
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_I_ILI_12));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_I_ILI_2));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_I_ILI_3));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_I_mild));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_I_mild_1));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_I_mild_12));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_I_mild_2));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_I_mild_3));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_I_with_diff_trans));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_I_with_diff_trans_1));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_I_with_diff_trans_2));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_I0_asympt));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_I0_asympt_1));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_I0_asympt_12));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_I0_asympt_2));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_I0_asympt_3));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_I0_hosp));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->dim_I0_hosp_1));
  SET_VECTOR_ELT(contents, 140, ScalarInteger(internal->dim_I0_hosp_12));
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_I0_hosp_2));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_I0_hosp_3));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_I0_ICU));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_I0_ICU_1));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->dim_I0_ICU_12));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->dim_I0_ICU_2));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->dim_I0_ICU_3));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->dim_I0_ILI));
  SET_VECTOR_ELT(contents, 149, ScalarInteger(internal->dim_I0_ILI_1));
  SET_VECTOR_ELT(contents, 150, ScalarInteger(internal->dim_I0_ILI_12));
  SET_VECTOR_ELT(contents, 151, ScalarInteger(internal->dim_I0_ILI_2));
  SET_VECTOR_ELT(contents, 152, ScalarInteger(internal->dim_I0_ILI_3));
  SET_VECTOR_ELT(contents, 153, ScalarInteger(internal->dim_I0_mild));
  SET_VECTOR_ELT(contents, 154, ScalarInteger(internal->dim_I0_mild_1));
  SET_VECTOR_ELT(contents, 155, ScalarInteger(internal->dim_I0_mild_12));
  SET_VECTOR_ELT(contents, 156, ScalarInteger(internal->dim_I0_mild_2));
  SET_VECTOR_ELT(contents, 157, ScalarInteger(internal->dim_I0_mild_3));
  SET_VECTOR_ELT(contents, 158, ScalarInteger(internal->dim_lambda));
  SET_VECTOR_ELT(contents, 159, ScalarInteger(internal->dim_m));
  SET_VECTOR_ELT(contents, 160, ScalarInteger(internal->dim_m_1));
  SET_VECTOR_ELT(contents, 161, ScalarInteger(internal->dim_m_2));
  SET_VECTOR_ELT(contents, 162, ScalarInteger(internal->dim_n_death_hosp));
  SET_VECTOR_ELT(contents, 163, ScalarInteger(internal->dim_n_death_hosp_1));
  SET_VECTOR_ELT(contents, 164, ScalarInteger(internal->dim_n_death_hosp_2));
  SET_VECTOR_ELT(contents, 165, ScalarInteger(internal->dim_n_EE));
  SET_VECTOR_ELT(contents, 166, ScalarInteger(internal->dim_n_EE_1));
  SET_VECTOR_ELT(contents, 167, ScalarInteger(internal->dim_n_EE_12));
  SET_VECTOR_ELT(contents, 168, ScalarInteger(internal->dim_n_EE_2));
  SET_VECTOR_ELT(contents, 169, ScalarInteger(internal->dim_n_EE_3));
  SET_VECTOR_ELT(contents, 170, ScalarInteger(internal->dim_n_EI_asympt));
  SET_VECTOR_ELT(contents, 171, ScalarInteger(internal->dim_n_EI_asympt_1));
  SET_VECTOR_ELT(contents, 172, ScalarInteger(internal->dim_n_EI_asympt_2));
  SET_VECTOR_ELT(contents, 173, ScalarInteger(internal->dim_n_EI_ILI));
  SET_VECTOR_ELT(contents, 174, ScalarInteger(internal->dim_n_EI_ILI_1));
  SET_VECTOR_ELT(contents, 175, ScalarInteger(internal->dim_n_EI_ILI_2));
  SET_VECTOR_ELT(contents, 176, ScalarInteger(internal->dim_n_EI_mild));
  SET_VECTOR_ELT(contents, 177, ScalarInteger(internal->dim_n_EI_mild_1));
  SET_VECTOR_ELT(contents, 178, ScalarInteger(internal->dim_n_EI_mild_2));
  SET_VECTOR_ELT(contents, 179, ScalarInteger(internal->dim_n_hosp_to_ICU));
  SET_VECTOR_ELT(contents, 180, ScalarInteger(internal->dim_n_hosp_to_ICU_1));
  SET_VECTOR_ELT(contents, 181, ScalarInteger(internal->dim_n_hosp_to_ICU_2));
  SET_VECTOR_ELT(contents, 182, ScalarInteger(internal->dim_n_ICU_to_R_hosp));
  SET_VECTOR_ELT(contents, 183, ScalarInteger(internal->dim_n_ICU_to_R_hosp_1));
  SET_VECTOR_ELT(contents, 184, ScalarInteger(internal->dim_n_ICU_to_R_hosp_2));
  SET_VECTOR_ELT(contents, 185, ScalarInteger(internal->dim_n_II_asympt));
  SET_VECTOR_ELT(contents, 186, ScalarInteger(internal->dim_n_II_asympt_1));
  SET_VECTOR_ELT(contents, 187, ScalarInteger(internal->dim_n_II_asympt_12));
  SET_VECTOR_ELT(contents, 188, ScalarInteger(internal->dim_n_II_asympt_2));
  SET_VECTOR_ELT(contents, 189, ScalarInteger(internal->dim_n_II_asympt_3));
  SET_VECTOR_ELT(contents, 190, ScalarInteger(internal->dim_n_II_hosp));
  SET_VECTOR_ELT(contents, 191, ScalarInteger(internal->dim_n_II_hosp_1));
  SET_VECTOR_ELT(contents, 192, ScalarInteger(internal->dim_n_II_hosp_12));
  SET_VECTOR_ELT(contents, 193, ScalarInteger(internal->dim_n_II_hosp_2));
  SET_VECTOR_ELT(contents, 194, ScalarInteger(internal->dim_n_II_hosp_3));
  SET_VECTOR_ELT(contents, 195, ScalarInteger(internal->dim_n_II_ICU));
  SET_VECTOR_ELT(contents, 196, ScalarInteger(internal->dim_n_II_ICU_1));
  SET_VECTOR_ELT(contents, 197, ScalarInteger(internal->dim_n_II_ICU_12));
  SET_VECTOR_ELT(contents, 198, ScalarInteger(internal->dim_n_II_ICU_2));
  SET_VECTOR_ELT(contents, 199, ScalarInteger(internal->dim_n_II_ICU_3));
  SET_VECTOR_ELT(contents, 200, ScalarInteger(internal->dim_n_II_ILI));
  SET_VECTOR_ELT(contents, 201, ScalarInteger(internal->dim_n_II_ILI_1));
  SET_VECTOR_ELT(contents, 202, ScalarInteger(internal->dim_n_II_ILI_12));
  SET_VECTOR_ELT(contents, 203, ScalarInteger(internal->dim_n_II_ILI_2));
  SET_VECTOR_ELT(contents, 204, ScalarInteger(internal->dim_n_II_ILI_3));
  SET_VECTOR_ELT(contents, 205, ScalarInteger(internal->dim_n_II_mild));
  SET_VECTOR_ELT(contents, 206, ScalarInteger(internal->dim_n_II_mild_1));
  SET_VECTOR_ELT(contents, 207, ScalarInteger(internal->dim_n_II_mild_12));
  SET_VECTOR_ELT(contents, 208, ScalarInteger(internal->dim_n_II_mild_2));
  SET_VECTOR_ELT(contents, 209, ScalarInteger(internal->dim_n_II_mild_3));
  SET_VECTOR_ELT(contents, 210, ScalarInteger(internal->dim_n_ILI_to_hosp));
  SET_VECTOR_ELT(contents, 211, ScalarInteger(internal->dim_n_ILI_to_hosp_1));
  SET_VECTOR_ELT(contents, 212, ScalarInteger(internal->dim_n_ILI_to_hosp_2));
  SET_VECTOR_ELT(contents, 213, ScalarInteger(internal->dim_n_R_hosp));
  SET_VECTOR_ELT(contents, 214, ScalarInteger(internal->dim_n_R_hosp_1));
  SET_VECTOR_ELT(contents, 215, ScalarInteger(internal->dim_n_R_hosp_12));
  SET_VECTOR_ELT(contents, 216, ScalarInteger(internal->dim_n_R_hosp_2));
  SET_VECTOR_ELT(contents, 217, ScalarInteger(internal->dim_n_R_hosp_3));
  SET_VECTOR_ELT(contents, 218, ScalarInteger(internal->dim_n_SE));
  SET_VECTOR_ELT(contents, 219, ScalarInteger(internal->dim_p_asympt));
  SET_VECTOR_ELT(contents, 220, ScalarInteger(internal->dim_p_death_hosp));
  SET_VECTOR_ELT(contents, 221, ScalarInteger(internal->dim_p_recov_hosp));
  SET_VECTOR_ELT(contents, 222, ScalarInteger(internal->dim_p_recov_ICU));
  SET_VECTOR_ELT(contents, 223, ScalarInteger(internal->dim_p_recov_ILI));
  SET_VECTOR_ELT(contents, 224, ScalarInteger(internal->dim_p_SE));
  SET_VECTOR_ELT(contents, 225, ScalarInteger(internal->dim_p_sympt_ILI));
  SET_VECTOR_ELT(contents, 226, ScalarInteger(internal->dim_R));
  SET_VECTOR_ELT(contents, 227, ScalarInteger(internal->dim_R_hosp));
  SET_VECTOR_ELT(contents, 228, ScalarInteger(internal->dim_R_hosp_1));
  SET_VECTOR_ELT(contents, 229, ScalarInteger(internal->dim_R_hosp_12));
  SET_VECTOR_ELT(contents, 230, ScalarInteger(internal->dim_R_hosp_2));
  SET_VECTOR_ELT(contents, 231, ScalarInteger(internal->dim_R_hosp_3));
  SET_VECTOR_ELT(contents, 232, ScalarInteger(internal->dim_R0));
  SET_VECTOR_ELT(contents, 233, ScalarInteger(internal->dim_R0_hosp));
  SET_VECTOR_ELT(contents, 234, ScalarInteger(internal->dim_R0_hosp_1));
  SET_VECTOR_ELT(contents, 235, ScalarInteger(internal->dim_R0_hosp_12));
  SET_VECTOR_ELT(contents, 236, ScalarInteger(internal->dim_R0_hosp_2));
  SET_VECTOR_ELT(contents, 237, ScalarInteger(internal->dim_R0_hosp_3));
  SET_VECTOR_ELT(contents, 238, ScalarInteger(internal->dim_S));
  ...
  SET_VECTOR_ELT(contents, 242, ScalarInteger(internal->dim_S0));
  SET_VECTOR_ELT(contents, 243, ScalarInteger(internal->dim_trans_increase));
  SET_VECTOR_ELT(contents, 244, ScalarInteger(internal->dim_trans_increase_1));
  SET_VECTOR_ELT(contents, 245, ScalarInteger(internal->dim_trans_increase_2));
  SET_VECTOR_ELT(contents, 246, ScalarInteger(internal->dim_trans_profile));
  SET_VECTOR_ELT(contents, 247, ScalarInteger(internal->dim_trans_profile_1));
  SET_VECTOR_ELT(contents, 248, ScalarInteger(internal->dim_trans_profile_2));
  SET_VECTOR_ELT(contents, 249, ScalarReal(internal->dt));
  SEXP E0 = PROTECT(allocVector(REALSXP, internal->dim_E0));
  memcpy(REAL(E0), internal->E0, internal->dim_E0 * sizeof(double));
  odin_set_dim(E0, 3, internal->dim_E0_1, internal->dim_E0_2, internal->dim_E0_3);
  SET_VECTOR_ELT(contents, 250, E0);
  SET_VECTOR_ELT(contents, 251, ScalarReal(internal->gamma_asympt));
  SET_VECTOR_ELT(contents, 252, ScalarReal(internal->gamma_E));
  SET_VECTOR_ELT(contents, 253, ScalarReal(internal->gamma_hosp));
  SET_VECTOR_ELT(contents, 254, ScalarReal(internal->gamma_ICU));
  SET_VECTOR_ELT(contents, 255, ScalarReal(internal->gamma_ILI));
  SET_VECTOR_ELT(contents, 256, ScalarReal(internal->gamma_mild));
  SET_VECTOR_ELT(contents, 257, ScalarReal(internal->gamma_rec));
  SET_VECTOR_ELT(contents, 258, ScalarReal(internal->hosp_transmission));
  SEXP I_with_diff_trans = PROTECT(allocVector(REALSXP, internal->dim_I_with_diff_trans));
  memcpy(REAL(I_with_diff_trans), internal->I_with_diff_trans, internal->dim_I_with_diff_trans * sizeof(double));
  odin_set_dim(I_with_diff_trans, 2, internal->dim_I_with_diff_trans_1, internal->dim_I_with_diff_trans_2);
  SET_VECTOR_ELT(contents, 259, I_with_diff_trans);
  SEXP I0_asympt = PROTECT(allocVector(REALSXP, internal->dim_I0_asympt));
  memcpy(REAL(I0_asympt), internal->I0_asympt, internal->dim_I0_asympt * sizeof(double));
  odin_set_dim(I0_asympt, 3, internal->dim_I0_asympt_1, internal->dim_I0_asympt_2, internal->dim_I0_asympt_3);
  SET_VECTOR_ELT(contents, 260, I0_asympt);
  SEXP I0_hosp = PROTECT(allocVector(REALSXP, internal->dim_I0_hosp));
  memcpy(REAL(I0_hosp), internal->I0_hosp, internal->dim_I0_hosp * sizeof(double));
  odin_set_dim(I0_hosp, 3, internal->dim_I0_hosp_1, internal->dim_I0_hosp_2, internal->dim_I0_hosp_3);
  SET_VECTOR_ELT(contents, 261, I0_hosp);
  SEXP I0_ICU = PROTECT(allocVector(REALSXP, internal->dim_I0_ICU));
  memcpy(REAL(I0_ICU), internal->I0_ICU, internal->dim_I0_ICU * sizeof(double));
  odin_set_dim(I0_ICU, 3, internal->dim_I0_ICU_1, internal->dim_I0_ICU_2, internal->dim_I0_ICU_3);
  SET_VECTOR_ELT(contents, 262, I0_ICU);
  SEXP I0_ILI = PROTECT(allocVector(REALSXP, internal->dim_I0_ILI));
  memcpy(REAL(I0_ILI), internal->I0_ILI, internal->dim_I0_ILI * sizeof(double));
  odin_set_dim(I0_ILI, 3, internal->dim_I0_ILI_1, internal->dim_I0_ILI_2, internal->dim_I0_ILI_3);
  SET_VECTOR_ELT(contents, 263, I0_ILI);
  SEXP I0_mild = PROTECT(allocVector(REALSXP, internal->dim_I0_mild));
  memcpy(REAL(I0_mild), internal->I0_mild, internal->dim_I0_mild * sizeof(double));
  odin_set_dim(I0_mild, 3, internal->dim_I0_mild_1, internal->dim_I0_mild_2, internal->dim_I0_mild_3);
  SET_VECTOR_ELT(contents, 264, I0_mild);
  SET_VECTOR_ELT(contents, 265, ScalarReal(internal->ICU_transmission));
  SEXP initial_D = PROTECT(allocVector(REALSXP, internal->dim_D));
  memcpy(REAL(initial_D), internal->initial_D, internal->dim_D * sizeof(double));
  SET_VECTOR_ELT(contents, 266, initial_D);
  SEXP initial_E = PROTECT(allocVector(REALSXP, internal->dim_E));
  memcpy(REAL(initial_E), internal->initial_E, internal->dim_E * sizeof(double));
  odin_set_dim(initial_E, 3, internal->dim_E_1, internal->dim_E_2, internal->dim_E_3);
  SET_VECTOR_ELT(contents, 267, initial_E);
  SEXP initial_I_asympt = PROTECT(allocVector(REALSXP, internal->dim_I_asympt));
  memcpy(REAL(initial_I_asympt), internal->initial_I_asympt, internal->dim_I_asympt * sizeof(double));
  odin_set_dim(initial_I_asympt, 3, internal->dim_I_asympt_1, internal->dim_I_asympt_2, internal->dim_I_asympt_3);
  SET_VECTOR_ELT(contents, 268, initial_I_asympt);
  SEXP initial_I_hosp = PROTECT(allocVector(REALSXP, internal->dim_I_hosp));
  memcpy(REAL(initial_I_hosp), internal->initial_I_hosp, internal->dim_I_hosp * sizeof(double));
  odin_set_dim(initial_I_hosp, 3, internal->dim_I_hosp_1, internal->dim_I_hosp_2, internal->dim_I_hosp_3);
  SET_VECTOR_ELT(contents, 269, initial_I_hosp);
  SEXP initial_I_ICU = PROTECT(allocVector(REALSXP, internal->dim_I_ICU));
  memcpy(REAL(initial_I_ICU), internal->initial_I_ICU, internal->dim_I_ICU * sizeof(double));
  odin_set_dim(initial_I_ICU, 3, internal->dim_I_ICU_1, internal->dim_I_ICU_2, internal->dim_I_ICU_3);
  SET_VECTOR_ELT(contents, 270, initial_I_ICU);
  SEXP initial_I_ILI = PROTECT(allocVector(REALSXP, internal->dim_I_ILI));
  memcpy(REAL(initial_I_ILI), internal->initial_I_ILI, internal->dim_I_ILI * sizeof(double));
  odin_set_dim(initial_I_ILI, 3, internal->dim_I_ILI_1, internal->dim_I_ILI_2, internal->dim_I_ILI_3);
  SET_VECTOR_ELT(contents, 271, initial_I_ILI);
  SEXP initial_I_mild = PROTECT(allocVector(REALSXP, internal->dim_I_mild));
  memcpy(REAL(initial_I_mild), internal->initial_I_mild, internal->dim_I_mild * sizeof(double));
  odin_set_dim(initial_I_mild, 3, internal->dim_I_mild_1, internal->dim_I_mild_2, internal->dim_I_mild_3);
  SET_VECTOR_ELT(contents, 272, initial_I_mild);
  SEXP initial_R = PROTECT(allocVector(REALSXP, internal->dim_R));
  memcpy(REAL(initial_R), internal->initial_R, internal->dim_R * sizeof(double));
  SET_VECTOR_ELT(contents, 273, initial_R);
  SEXP initial_R_hosp = PROTECT(allocVector(REALSXP, internal->dim_R_hosp));
  memcpy(REAL(initial_R_hosp), internal->initial_R_hosp, internal->dim_R_hosp * sizeof(double));
  odin_set_dim(initial_R_hosp, 3, internal->dim_R_hosp_1, internal->dim_R_hosp_2, internal->dim_R_hosp_3);
  SET_VECTOR_ELT(contents, 274, initial_R_hosp);
  SEXP initial_S = PROTECT(allocVector(REALSXP, internal->dim_S));
  memcpy(REAL(initial_S), internal->initial_S, internal->dim_S * sizeof(double));
  SET_VECTOR_ELT(contents, 275, initial_S);
  SET_VECTOR_ELT(contents, 276, ScalarReal(internal->initial_x));
  SEXP lambda = PROTECT(allocVector(REALSXP, internal->dim_lambda));
  memcpy(REAL(lambda), internal->lambda, internal->dim_lambda * sizeof(double));
  SET_VECTOR_ELT(contents, 277, lambda);
  SEXP m = PROTECT(allocVector(REALSXP, internal->dim_m));
  memcpy(REAL(m), internal->m, internal->dim_m * sizeof(double));
  odin_set_dim(m, 2, internal->dim_m_1, internal->dim_m_2);
  SET_VECTOR_ELT(contents, 278, m);
  SET_VECTOR_ELT(contents, 279, ScalarInteger(internal->N_age));
  SEXP n_death_hosp = PROTECT(allocVector(REALSXP, internal->dim_n_death_hosp));
  memcpy(REAL(n_death_hosp), internal->n_death_hosp, internal->dim_n_death_hosp * sizeof(double));
  odin_set_dim(n_death_hosp, 2, internal->dim_n_death_hosp_1, internal->dim_n_death_hosp_2);
  SET_VECTOR_ELT(contents, 280, n_death_hosp);
  SEXP n_EE = PROTECT(allocVector(REALSXP, internal->dim_n_EE));
  memcpy(REAL(n_EE), internal->n_EE, internal->dim_n_EE * sizeof(double));
  odin_set_dim(n_EE, 3, internal->dim_n_EE_1, internal->dim_n_EE_2, internal->dim_n_EE_3);
  SET_VECTOR_ELT(contents, 281, n_EE);
  SEXP n_EI_asympt = PROTECT(allocVector(REALSXP, internal->dim_n_EI_asympt));
  memcpy(REAL(n_EI_asympt), internal->n_EI_asympt, internal->dim_n_EI_asympt * sizeof(double));
  odin_set_dim(n_EI_asympt, 2, internal->dim_n_EI_asympt_1, internal->dim_n_EI_asympt_2);
  SET_VECTOR_ELT(contents, 282, n_EI_asympt);
  SEXP n_EI_ILI = PROTECT(allocVector(REALSXP, internal->dim_n_EI_ILI));
  memcpy(REAL(n_EI_ILI), internal->n_EI_ILI, internal->dim_n_EI_ILI * sizeof(double));
  odin_set_dim(n_EI_ILI, 2, internal->dim_n_EI_ILI_1, internal->dim_n_EI_ILI_2);
  SET_VECTOR_ELT(contents, 283, n_EI_ILI);
  SEXP n_EI_mild = PROTECT(allocVector(REALSXP, internal->dim_n_EI_mild));
  memcpy(REAL(n_EI_mild), internal->n_EI_mild, internal->dim_n_EI_mild * sizeof(double));
  odin_set_dim(n_EI_mild, 2, internal->dim_n_EI_mild_1, internal->dim_n_EI_mild_2);
  SET_VECTOR_ELT(contents, 284, n_EI_mild);
  SEXP n_hosp_to_ICU = PROTECT(allocVector(REALSXP, internal->dim_n_hosp_to_ICU));
  memcpy(REAL(n_hosp_to_ICU), internal->n_hosp_to_ICU, internal->dim_n_hosp_to_ICU * sizeof(double));
  odin_set_dim(n_hosp_to_ICU, 2, internal->dim_n_hosp_to_ICU_1, internal->dim_n_hosp_to_ICU_2);
  SET_VECTOR_ELT(contents, 285, n_hosp_to_ICU);
  SEXP n_ICU_to_R_hosp = PROTECT(allocVector(REALSXP, internal->dim_n_ICU_to_R_hosp));
  memcpy(REAL(n_ICU_to_R_hosp), internal->n_ICU_to_R_hosp, internal->dim_n_ICU_to_R_hosp * sizeof(double));
  odin_set_dim(n_ICU_to_R_hosp, 2, internal->dim_n_ICU_to_R_hosp_1, internal->dim_n_ICU_to_R_hosp_2);
  SET_VECTOR_ELT(contents, 286, n_ICU_to_R_hosp);
  SEXP n_II_asympt = PROTECT(allocVector(REALSXP, internal->dim_n_II_asympt));
  memcpy(REAL(n_II_asympt), internal->n_II_asympt, internal->dim_n_II_asympt * sizeof(double));
  odin_set_dim(n_II_asympt, 3, internal->dim_n_II_asympt_1, internal->dim_n_II_asympt_2, internal->dim_n_II_asympt_3);
  SET_VECTOR_ELT(contents, 287, n_II_asympt);
  SEXP n_II_hosp = PROTECT(allocVector(REALSXP, internal->dim_n_II_hosp));
  memcpy(REAL(n_II_hosp), internal->n_II_hosp, internal->dim_n_II_hosp * sizeof(double));
  odin_set_dim(n_II_hosp, 3, internal->dim_n_II_hosp_1, internal->dim_n_II_hosp_2, internal->dim_n_II_hosp_3);
  SET_VECTOR_ELT(contents, 288, n_II_hosp);
  SEXP n_II_ICU = PROTECT(allocVector(REALSXP, internal->dim_n_II_ICU));
  memcpy(REAL(n_II_ICU), internal->n_II_ICU, internal->dim_n_II_ICU * sizeof(double));
  odin_set_dim(n_II_ICU, 3, internal->dim_n_II_ICU_1, internal->dim_n_II_ICU_2, internal->dim_n_II_ICU_3);
  SET_VECTOR_ELT(contents, 289, n_II_ICU);
  SEXP n_II_ILI = PROTECT(allocVector(REALSXP, internal->dim_n_II_ILI));
  memcpy(REAL(n_II_ILI), internal->n_II_ILI, internal->dim_n_II_ILI * sizeof(double));
  odin_set_dim(n_II_ILI, 3, internal->dim_n_II_ILI_1, internal->dim_n_II_ILI_2, internal->dim_n_II_ILI_3);
  SET_VECTOR_ELT(contents, 290, n_II_ILI);
  SEXP n_II_mild = PROTECT(allocVector(REALSXP, internal->dim_n_II_mild));
  memcpy(REAL(n_II_mild), internal->n_II_mild, internal->dim_n_II_mild * sizeof(double));
  odin_set_dim(n_II_mild, 3, internal->dim_n_II_mild_1, internal->dim_n_II_mild_2, internal->dim_n_II_mild_3);
  SET_VECTOR_ELT(contents, 291, n_II_mild);
  SEXP n_ILI_to_hosp = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_hosp));
  memcpy(REAL(n_ILI_to_hosp), internal->n_ILI_to_hosp, internal->dim_n_ILI_to_hosp * sizeof(double));
  odin_set_dim(n_ILI_to_hosp, 2, internal->dim_n_ILI_to_hosp_1, internal->dim_n_ILI_to_hosp_2);
  SET_VECTOR_ELT(contents, 292, n_ILI_to_hosp);
  SEXP n_R_hosp = PROTECT(allocVector(REALSXP, internal->dim_n_R_hosp));
  memcpy(REAL(n_R_hosp), internal->n_R_hosp, internal->dim_n_R_hosp * sizeof(double));
  odin_set_dim(n_R_hosp, 3, internal->dim_n_R_hosp_1, internal->dim_n_R_hosp_2, internal->dim_n_R_hosp_3);
  SET_VECTOR_ELT(contents, 293, n_R_hosp);
  SEXP n_SE = PROTECT(allocVector(REALSXP, internal->dim_n_SE));
  memcpy(REAL(n_SE), internal->n_SE, internal->dim_n_SE * sizeof(double));
  SET_VECTOR_ELT(contents, 294, n_SE);
  SET_VECTOR_ELT(contents, 295, ScalarInteger(internal->offset_output_n_EI_ILI));
  SET_VECTOR_ELT(contents, 296, ScalarInteger(internal->offset_output_n_EI_mild));
  SET_VECTOR_ELT(contents, 297, ScalarInteger(internal->offset_output_n_hosp_to_ICU));
  SET_VECTOR_ELT(contents, 298, ScalarInteger(internal->offset_output_n_ILI_to_hosp));
  SET_VECTOR_ELT(contents, 299, ScalarInteger(internal->offset_variable_D));
  SET_VECTOR_ELT(contents, 300, ScalarInteger(internal->offset_variable_E));
  SET_VECTOR_ELT(contents, 301, ScalarInteger(internal->offset_variable_I_asympt));
  SET_VECTOR_ELT(contents, 302, ScalarInteger(internal->offset_variable_I_hosp));
  SET_VECTOR_ELT(contents, 303, ScalarInteger(internal->offset_variable_I_ICU));
  SET_VECTOR_ELT(contents, 304, ScalarInteger(internal->offset_variable_I_ILI));
  SET_VECTOR_ELT(contents, 305, ScalarInteger(internal->offset_variable_I_mild));
  SET_VECTOR_ELT(contents, 306, ScalarInteger(internal->offset_variable_R));
  SET_VECTOR_ELT(contents, 307, ScalarInteger(internal->offset_variable_R_hosp));
  SEXP p_asympt = PROTECT(allocVector(REALSXP, internal->dim_p_asympt));
  memcpy(REAL(p_asympt), internal->p_asympt, internal->dim_p_asympt * sizeof(double));
  SET_VECTOR_ELT(contents, 308, p_asympt);
  SEXP p_death_hosp = PROTECT(allocVector(REALSXP, internal->dim_p_death_hosp));
  memcpy(REAL(p_death_hosp), internal->p_death_hosp, internal->dim_p_death_hosp * sizeof(double));
  SET_VECTOR_ELT(contents, 309, p_death_hosp);
  SET_VECTOR_ELT(contents, 310, ScalarReal(internal->p_EE));
  SET_VECTOR_ELT(contents, 311, ScalarReal(internal->p_II_asympt));
  SET_VECTOR_ELT(contents, 312, ScalarReal(internal->p_II_hosp));
  SET_VECTOR_ELT(contents, 313, ScalarReal(internal->p_II_ICU));
  SET_VECTOR_ELT(contents, 314, ScalarReal(internal->p_II_ILI));
  SET_VECTOR_ELT(contents, 315, ScalarReal(internal->p_II_mild));
  SET_VECTOR_ELT(contents, 316, ScalarReal(internal->p_R_hosp));
  SEXP p_recov_hosp = PROTECT(allocVector(REALSXP, internal->dim_p_recov_hosp));
  memcpy(REAL(p_recov_hosp), internal->p_recov_hosp, internal->dim_p_recov_hosp * sizeof(double));
  SET_VECTOR_ELT(contents, 317, p_recov_hosp);
  SEXP p_recov_ICU = PROTECT(allocVector(REALSXP, internal->dim_p_recov_ICU));
  memcpy(REAL(p_recov_ICU), internal->p_recov_ICU, internal->dim_p_recov_ICU * sizeof(double));
  SET_VECTOR_ELT(contents, 318, p_recov_ICU);
  SEXP p_recov_ILI = PROTECT(allocVector(REALSXP, internal->dim_p_recov_ILI));
  memcpy(REAL(p_recov_ILI), internal->p_recov_ILI, internal->dim_p_recov_ILI * sizeof(double));
  SET_VECTOR_ELT(contents, 319, p_recov_ILI);
  SEXP p_SE = PROTECT(allocVector(REALSXP, internal->dim_p_SE));
  memcpy(REAL(p_SE), internal->p_SE, internal->dim_p_SE * sizeof(double));
  SET_VECTOR_ELT(contents, 320, p_SE);
  SEXP p_sympt_ILI = PROTECT(allocVector(REALSXP, internal->dim_p_sympt_ILI));
  memcpy(REAL(p_sympt_ILI), internal->p_sympt_ILI, internal->dim_p_sympt_ILI * sizeof(double));
  SET_VECTOR_ELT(contents, 321, p_sympt_ILI);
  SEXP R0 = PROTECT(allocVector(REALSXP, internal->dim_R0));
  memcpy(REAL(R0), internal->R0, internal->dim_R0 * sizeof(double));
  SET_VECTOR_ELT(contents, 322, R0);
  SEXP R0_hosp = PROTECT(allocVector(REALSXP, internal->dim_R0_hosp));
  memcpy(REAL(R0_hosp), internal->R0_hosp, internal->dim_R0_hosp * sizeof(double));
  odin_set_dim(R0_hosp, 3, internal->dim_R0_hosp_1, internal->dim_R0_hosp_2, internal->dim_R0_hosp_3);
  SET_VECTOR_ELT(contents, 323, R0_hosp);
  SET_VECTOR_ELT(contents, 324, ScalarInteger(internal->s_asympt));
  SET_VECTOR_ELT(contents, 325, ScalarInteger(internal->s_E));
  SET_VECTOR_ELT(contents, 326, ScalarInteger(internal->s_hosp));
  SET_VECTOR_ELT(contents, 327, ScalarInteger(internal->s_ICU));
  SEXP s_ij = PROTECT(allocVector(REALSXP, internal->dim_s_ij));
  memcpy(REAL(s_ij), internal->s_ij, internal->dim_s_ij * sizeof(double));
  odin_set_dim(s_ij, 2, internal->dim_s_ij_1, internal->dim_s_ij_2);
  SET_VECTOR_ELT(contents, 328, s_ij);
  SET_VECTOR_ELT(contents, 329, ScalarInteger(internal->s_ILI));
  SET_VECTOR_ELT(contents, 330, ScalarInteger(internal->s_mild));
  SET_VECTOR_ELT(contents, 331, ScalarInteger(internal->s_rec));
  SEXP S0 = PROTECT(allocVector(REALSXP, internal->dim_S0));
  memcpy(REAL(S0), internal->S0, internal->dim_S0 * sizeof(double));
  SET_VECTOR_ELT(contents, 332, S0);
  SET_VECTOR_ELT(contents, 333, ScalarReal(internal->sd_x));
  SET_VECTOR_ELT(contents, 334, ScalarInteger(internal->trans_classes));
  SEXP trans_increase = PROTECT(allocVector(REALSXP, internal->dim_trans_increase));
  memcpy(REAL(trans_increase), internal->trans_increase, internal->dim_trans_increase * sizeof(double));
  odin_set_dim(trans_increase, 2, internal->dim_trans_increase_1, internal->dim_trans_increase_2);
  SET_VECTOR_ELT(contents, 335, trans_increase);
  SEXP trans_profile = PROTECT(allocVector(REALSXP, internal->dim_trans_profile));
  memcpy(REAL(trans_profile), internal->trans_profile, internal->dim_trans_profile * sizeof(double));
  odin_set_dim(trans_profile, 2, internal->dim_trans_profile_1, internal->dim_trans_profile_2);
  SET_VECTOR_ELT(contents, 336, trans_profile);
  SET_VECTOR_ELT(contents, 337, ScalarReal(internal->x0));
  SEXP nms = PROTECT(allocVector(STRSXP, 338));
  SET_STRING_ELT(nms, 0, mkChar("aux_EE"));
  SET_STRING_ELT(nms, 1, mkChar("aux_II_asympt"));
  SET_STRING_ELT(nms, 2, mkChar("aux_II_hosp"));
  SET_STRING_ELT(nms, 3, mkChar("aux_II_ICU"));
  ...
  SET_STRING_ELT(nms, 6, mkChar("aux_p_bin"));
  SET_STRING_ELT(nms, 7, mkChar("aux_R_hosp"));
  SET_STRING_ELT(nms, 8, mkChar("D0"));
  SET_STRING_ELT(nms, 9, mkChar("delta_D"));
  SET_STRING_ELT(nms, 10, mkChar("delta_E"));
  SET_STRING_ELT(nms, 11, mkChar("delta_I_asympt"));
  SET_STRING_ELT(nms, 12, mkChar("delta_I_hosp"));
  SET_STRING_ELT(nms, 13, mkChar("delta_I_ICU"));
  SET_STRING_ELT(nms, 14, mkChar("delta_I_ILI"));
  SET_STRING_ELT(nms, 15, mkChar("delta_I_mild"));
  SET_STRING_ELT(nms, 16, mkChar("delta_R"));
  SET_STRING_ELT(nms, 17, mkChar("delta_R_hosp"));
  SET_STRING_ELT(nms, 18, mkChar("dim_aux_EE"));
  SET_STRING_ELT(nms, 19, mkChar("dim_aux_EE_1"));
  SET_STRING_ELT(nms, 20, mkChar("dim_aux_EE_12"));
  SET_STRING_ELT(nms, 21, mkChar("dim_aux_EE_2"));
  SET_STRING_ELT(nms, 22, mkChar("dim_aux_EE_3"));
  SET_STRING_ELT(nms, 23, mkChar("dim_aux_II_asympt"));
  SET_STRING_ELT(nms, 24, mkChar("dim_aux_II_asympt_1"));
  SET_STRING_ELT(nms, 25, mkChar("dim_aux_II_asympt_12"));
  SET_STRING_ELT(nms, 26, mkChar("dim_aux_II_asympt_2"));
  SET_STRING_ELT(nms, 27, mkChar("dim_aux_II_asympt_3"));
  SET_STRING_ELT(nms, 28, mkChar("dim_aux_II_hosp"));
  SET_STRING_ELT(nms, 29, mkChar("dim_aux_II_hosp_1"));
  SET_STRING_ELT(nms, 30, mkChar("dim_aux_II_hosp_12"));
  SET_STRING_ELT(nms, 31, mkChar("dim_aux_II_hosp_2"));
  SET_STRING_ELT(nms, 32, mkChar("dim_aux_II_hosp_3"));
  SET_STRING_ELT(nms, 33, mkChar("dim_aux_II_ICU"));
  SET_STRING_ELT(nms, 34, mkChar("dim_aux_II_ICU_1"));
  SET_STRING_ELT(nms, 35, mkChar("dim_aux_II_ICU_12"));
  SET_STRING_ELT(nms, 36, mkChar("dim_aux_II_ICU_2"));
  SET_STRING_ELT(nms, 37, mkChar("dim_aux_II_ICU_3"));
  SET_STRING_ELT(nms, 38, mkChar("dim_aux_II_ILI"));
  SET_STRING_ELT(nms, 39, mkChar("dim_aux_II_ILI_1"));
  SET_STRING_ELT(nms, 40, mkChar("dim_aux_II_ILI_12"));
  SET_STRING_ELT(nms, 41, mkChar("dim_aux_II_ILI_2"));
  SET_STRING_ELT(nms, 42, mkChar("dim_aux_II_ILI_3"));
  SET_STRING_ELT(nms, 43, mkChar("dim_aux_II_mild"));
  SET_STRING_ELT(nms, 44, mkChar("dim_aux_II_mild_1"));
  SET_STRING_ELT(nms, 45, mkChar("dim_aux_II_mild_12"));
  SET_STRING_ELT(nms, 46, mkChar("dim_aux_II_mild_2"));
  SET_STRING_ELT(nms, 47, mkChar("dim_aux_II_mild_3"));
  SET_STRING_ELT(nms, 48, mkChar("dim_aux_p_bin"));
  SET_STRING_ELT(nms, 49, mkChar("dim_aux_p_bin_1"));
  SET_STRING_ELT(nms, 50, mkChar("dim_aux_p_bin_2"));
  SET_STRING_ELT(nms, 51, mkChar("dim_aux_R_hosp"));
  SET_STRING_ELT(nms, 52, mkChar("dim_aux_R_hosp_1"));
  SET_STRING_ELT(nms, 53, mkChar("dim_aux_R_hosp_12"));
  SET_STRING_ELT(nms, 54, mkChar("dim_aux_R_hosp_2"));
  SET_STRING_ELT(nms, 55, mkChar("dim_aux_R_hosp_3"));
  SET_STRING_ELT(nms, 56, mkChar("dim_D"));
  SET_STRING_ELT(nms, 57, mkChar("dim_D0"));
  SET_STRING_ELT(nms, 58, mkChar("dim_delta_D"));
  SET_STRING_ELT(nms, 59, mkChar("dim_delta_E"));
  SET_STRING_ELT(nms, 60, mkChar("dim_delta_E_1"));
  SET_STRING_ELT(nms, 61, mkChar("dim_delta_E_12"));
  SET_STRING_ELT(nms, 62, mkChar("dim_delta_E_2"));
  SET_STRING_ELT(nms, 63, mkChar("dim_delta_E_3"));
  SET_STRING_ELT(nms, 64, mkChar("dim_delta_I_asympt"));
  SET_STRING_ELT(nms, 65, mkChar("dim_delta_I_asympt_1"));
  SET_STRING_ELT(nms, 66, mkChar("dim_delta_I_asympt_12"));
  SET_STRING_ELT(nms, 67, mkChar("dim_delta_I_asympt_2"));
  SET_STRING_ELT(nms, 68, mkChar("dim_delta_I_asympt_3"));
  SET_STRING_ELT(nms, 69, mkChar("dim_delta_I_hosp"));
  SET_STRING_ELT(nms, 70, mkChar("dim_delta_I_hosp_1"));
  SET_STRING_ELT(nms, 71, mkChar("dim_delta_I_hosp_12"));
  SET_STRING_ELT(nms, 72, mkChar("dim_delta_I_hosp_2"));
  SET_STRING_ELT(nms, 73, mkChar("dim_delta_I_hosp_3"));
  SET_STRING_ELT(nms, 74, mkChar("dim_delta_I_ICU"));
  SET_STRING_ELT(nms, 75, mkChar("dim_delta_I_ICU_1"));
  SET_STRING_ELT(nms, 76, mkChar("dim_delta_I_ICU_12"));
  SET_STRING_ELT(nms, 77, mkChar("dim_delta_I_ICU_2"));
  SET_STRING_ELT(nms, 78, mkChar("dim_delta_I_ICU_3"));
  SET_STRING_ELT(nms, 79, mkChar("dim_delta_I_ILI"));
  SET_STRING_ELT(nms, 80, mkChar("dim_delta_I_ILI_1"));
  SET_STRING_ELT(nms, 81, mkChar("dim_delta_I_ILI_12"));
  SET_STRING_ELT(nms, 82, mkChar("dim_delta_I_ILI_2"));
  SET_STRING_ELT(nms, 83, mkChar("dim_delta_I_ILI_3"));
  SET_STRING_ELT(nms, 84, mkChar("dim_delta_I_mild"));
  SET_STRING_ELT(nms, 85, mkChar("dim_delta_I_mild_1"));
  SET_STRING_ELT(nms, 86, mkChar("dim_delta_I_mild_12"));
  SET_STRING_ELT(nms, 87, mkChar("dim_delta_I_mild_2"));
  SET_STRING_ELT(nms, 88, mkChar("dim_delta_I_mild_3"));
  SET_STRING_ELT(nms, 89, mkChar("dim_delta_R"));
  SET_STRING_ELT(nms, 90, mkChar("dim_delta_R_hosp"));
  SET_STRING_ELT(nms, 91, mkChar("dim_delta_R_hosp_1"));
  SET_STRING_ELT(nms, 92, mkChar("dim_delta_R_hosp_12"));
  SET_STRING_ELT(nms, 93, mkChar("dim_delta_R_hosp_2"));
  SET_STRING_ELT(nms, 94, mkChar("dim_delta_R_hosp_3"));
  SET_STRING_ELT(nms, 95, mkChar("dim_E"));
  SET_STRING_ELT(nms, 96, mkChar("dim_E_1"));
  SET_STRING_ELT(nms, 97, mkChar("dim_E_12"));
  SET_STRING_ELT(nms, 98, mkChar("dim_E_2"));
  SET_STRING_ELT(nms, 99, mkChar("dim_E_3"));
  SET_STRING_ELT(nms, 100, mkChar("dim_E0"));
  SET_STRING_ELT(nms, 101, mkChar("dim_E0_1"));
  SET_STRING_ELT(nms, 102, mkChar("dim_E0_12"));
  SET_STRING_ELT(nms, 103, mkChar("dim_E0_2"));
  SET_STRING_ELT(nms, 104, mkChar("dim_E0_3"));
  SET_STRING_ELT(nms, 105, mkChar("dim_I_asympt"));
  SET_STRING_ELT(nms, 106, mkChar("dim_I_asympt_1"));
  SET_STRING_ELT(nms, 107, mkChar("dim_I_asympt_12"));
  SET_STRING_ELT(nms, 108, mkChar("dim_I_asympt_2"));
  SET_STRING_ELT(nms, 109, mkChar("dim_I_asympt_3"));
  SET_STRING_ELT(nms, 110, mkChar("dim_I_hosp"));
  SET_STRING_ELT(nms, 111, mkChar("dim_I_hosp_1"));
  SET_STRING_ELT(nms, 112, mkChar("dim_I_hosp_12"));
  SET_STRING_ELT(nms, 113, mkChar("dim_I_hosp_2"));
  SET_STRING_ELT(nms, 114, mkChar("dim_I_hosp_3"));
  SET_STRING_ELT(nms, 115, mkChar("dim_I_ICU"));
  SET_STRING_ELT(nms, 116, mkChar("dim_I_ICU_1"));
  SET_STRING_ELT(nms, 117, mkChar("dim_I_ICU_12"));
  SET_STRING_ELT(nms, 118, mkChar("dim_I_ICU_2"));
  SET_STRING_ELT(nms, 119, mkChar("dim_I_ICU_3"));
  SET_STRING_ELT(nms, 120, mkChar("dim_I_ILI"));
  SET_STRING_ELT(nms, 121, mkChar("dim_I_ILI_1"));
  SET_STRING_ELT(nms, 122, mkChar("dim_I_ILI_12"));
  SET_STRING_ELT(nms, 123, mkChar("dim_I_ILI_2"));
  SET_STRING_ELT(nms, 124, mkChar("dim_I_ILI_3"));
  SET_STRING_ELT(nms, 125, mkChar("dim_I_mild"));
  SET_STRING_ELT(nms, 126, mkChar("dim_I_mild_1"));
  SET_STRING_ELT(nms, 127, mkChar("dim_I_mild_12"));
  SET_STRING_ELT(nms, 128, mkChar("dim_I_mild_2"));
  SET_STRING_ELT(nms, 129, mkChar("dim_I_mild_3"));
  SET_STRING_ELT(nms, 130, mkChar("dim_I_with_diff_trans"));
  SET_STRING_ELT(nms, 131, mkChar("dim_I_with_diff_trans_1"));
  SET_STRING_ELT(nms, 132, mkChar("dim_I_with_diff_trans_2"));
  SET_STRING_ELT(nms, 133, mkChar("dim_I0_asympt"));
  SET_STRING_ELT(nms, 134, mkChar("dim_I0_asympt_1"));
  SET_STRING_ELT(nms, 135, mkChar("dim_I0_asympt_12"));
  SET_STRING_ELT(nms, 136, mkChar("dim_I0_asympt_2"));
  SET_STRING_ELT(nms, 137, mkChar("dim_I0_asympt_3"));
  SET_STRING_ELT(nms, 138, mkChar("dim_I0_hosp"));
  SET_STRING_ELT(nms, 139, mkChar("dim_I0_hosp_1"));
  SET_STRING_ELT(nms, 140, mkChar("dim_I0_hosp_12"));
  SET_STRING_ELT(nms, 141, mkChar("dim_I0_hosp_2"));
  SET_STRING_ELT(nms, 142, mkChar("dim_I0_hosp_3"));
  SET_STRING_ELT(nms, 143, mkChar("dim_I0_ICU"));
  SET_STRING_ELT(nms, 144, mkChar("dim_I0_ICU_1"));
  SET_STRING_ELT(nms, 145, mkChar("dim_I0_ICU_12"));
  SET_STRING_ELT(nms, 146, mkChar("dim_I0_ICU_2"));
  SET_STRING_ELT(nms, 147, mkChar("dim_I0_ICU_3"));
  SET_STRING_ELT(nms, 148, mkChar("dim_I0_ILI"));
  SET_STRING_ELT(nms, 149, mkChar("dim_I0_ILI_1"));
  SET_STRING_ELT(nms, 150, mkChar("dim_I0_ILI_12"));
  SET_STRING_ELT(nms, 151, mkChar("dim_I0_ILI_2"));
  SET_STRING_ELT(nms, 152, mkChar("dim_I0_ILI_3"));
  SET_STRING_ELT(nms, 153, mkChar("dim_I0_mild"));
  SET_STRING_ELT(nms, 154, mkChar("dim_I0_mild_1"));
  SET_STRING_ELT(nms, 155, mkChar("dim_I0_mild_12"));
  SET_STRING_ELT(nms, 156, mkChar("dim_I0_mild_2"));
  SET_STRING_ELT(nms, 157, mkChar("dim_I0_mild_3"));
  SET_STRING_ELT(nms, 158, mkChar("dim_lambda"));
  SET_STRING_ELT(nms, 159, mkChar("dim_m"));
  SET_STRING_ELT(nms, 160, mkChar("dim_m_1"));
  SET_STRING_ELT(nms, 161, mkChar("dim_m_2"));
  SET_STRING_ELT(nms, 162, mkChar("dim_n_death_hosp"));
  SET_STRING_ELT(nms, 163, mkChar("dim_n_death_hosp_1"));
  SET_STRING_ELT(nms, 164, mkChar("dim_n_death_hosp_2"));
  SET_STRING_ELT(nms, 165, mkChar("dim_n_EE"));
  SET_STRING_ELT(nms, 166, mkChar("dim_n_EE_1"));
  SET_STRING_ELT(nms, 167, mkChar("dim_n_EE_12"));
  SET_STRING_ELT(nms, 168, mkChar("dim_n_EE_2"));
  SET_STRING_ELT(nms, 169, mkChar("dim_n_EE_3"));
  SET_STRING_ELT(nms, 170, mkChar("dim_n_EI_asympt"));
  SET_STRING_ELT(nms, 171, mkChar("dim_n_EI_asympt_1"));
  SET_STRING_ELT(nms, 172, mkChar("dim_n_EI_asympt_2"));
  SET_STRING_ELT(nms, 173, mkChar("dim_n_EI_ILI"));
  SET_STRING_ELT(nms, 174, mkChar("dim_n_EI_ILI_1"));
  SET_STRING_ELT(nms, 175, mkChar("dim_n_EI_ILI_2"));
  SET_STRING_ELT(nms, 176, mkChar("dim_n_EI_mild"));
  SET_STRING_ELT(nms, 177, mkChar("dim_n_EI_mild_1"));
  SET_STRING_ELT(nms, 178, mkChar("dim_n_EI_mild_2"));
  SET_STRING_ELT(nms, 179, mkChar("dim_n_hosp_to_ICU"));
  SET_STRING_ELT(nms, 180, mkChar("dim_n_hosp_to_ICU_1"));
  SET_STRING_ELT(nms, 181, mkChar("dim_n_hosp_to_ICU_2"));
  SET_STRING_ELT(nms, 182, mkChar("dim_n_ICU_to_R_hosp"));
  SET_STRING_ELT(nms, 183, mkChar("dim_n_ICU_to_R_hosp_1"));
  SET_STRING_ELT(nms, 184, mkChar("dim_n_ICU_to_R_hosp_2"));
  SET_STRING_ELT(nms, 185, mkChar("dim_n_II_asympt"));
  SET_STRING_ELT(nms, 186, mkChar("dim_n_II_asympt_1"));
  SET_STRING_ELT(nms, 187, mkChar("dim_n_II_asympt_12"));
  SET_STRING_ELT(nms, 188, mkChar("dim_n_II_asympt_2"));
  SET_STRING_ELT(nms, 189, mkChar("dim_n_II_asympt_3"));
  SET_STRING_ELT(nms, 190, mkChar("dim_n_II_hosp"));
  SET_STRING_ELT(nms, 191, mkChar("dim_n_II_hosp_1"));
  SET_STRING_ELT(nms, 192, mkChar("dim_n_II_hosp_12"));
  SET_STRING_ELT(nms, 193, mkChar("dim_n_II_hosp_2"));
  SET_STRING_ELT(nms, 194, mkChar("dim_n_II_hosp_3"));
  SET_STRING_ELT(nms, 195, mkChar("dim_n_II_ICU"));
  SET_STRING_ELT(nms, 196, mkChar("dim_n_II_ICU_1"));
  SET_STRING_ELT(nms, 197, mkChar("dim_n_II_ICU_12"));
  SET_STRING_ELT(nms, 198, mkChar("dim_n_II_ICU_2"));
  SET_STRING_ELT(nms, 199, mkChar("dim_n_II_ICU_3"));
  SET_STRING_ELT(nms, 200, mkChar("dim_n_II_ILI"));
  SET_STRING_ELT(nms, 201, mkChar("dim_n_II_ILI_1"));
  SET_STRING_ELT(nms, 202, mkChar("dim_n_II_ILI_12"));
  SET_STRING_ELT(nms, 203, mkChar("dim_n_II_ILI_2"));
  SET_STRING_ELT(nms, 204, mkChar("dim_n_II_ILI_3"));
  SET_STRING_ELT(nms, 205, mkChar("dim_n_II_mild"));
  SET_STRING_ELT(nms, 206, mkChar("dim_n_II_mild_1"));
  SET_STRING_ELT(nms, 207, mkChar("dim_n_II_mild_12"));
  SET_STRING_ELT(nms, 208, mkChar("dim_n_II_mild_2"));
  SET_STRING_ELT(nms, 209, mkChar("dim_n_II_mild_3"));
  SET_STRING_ELT(nms, 210, mkChar("dim_n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 211, mkChar("dim_n_ILI_to_hosp_1"));
  SET_STRING_ELT(nms, 212, mkChar("dim_n_ILI_to_hosp_2"));
  SET_STRING_ELT(nms, 213, mkChar("dim_n_R_hosp"));
  SET_STRING_ELT(nms, 214, mkChar("dim_n_R_hosp_1"));
  SET_STRING_ELT(nms, 215, mkChar("dim_n_R_hosp_12"));
  SET_STRING_ELT(nms, 216, mkChar("dim_n_R_hosp_2"));
  SET_STRING_ELT(nms, 217, mkChar("dim_n_R_hosp_3"));
  SET_STRING_ELT(nms, 218, mkChar("dim_n_SE"));
  SET_STRING_ELT(nms, 219, mkChar("dim_p_asympt"));
  SET_STRING_ELT(nms, 220, mkChar("dim_p_death_hosp"));
  SET_STRING_ELT(nms, 221, mkChar("dim_p_recov_hosp"));
  SET_STRING_ELT(nms, 222, mkChar("dim_p_recov_ICU"));
  SET_STRING_ELT(nms, 223, mkChar("dim_p_recov_ILI"));
  SET_STRING_ELT(nms, 224, mkChar("dim_p_SE"));
  SET_STRING_ELT(nms, 225, mkChar("dim_p_sympt_ILI"));
  SET_STRING_ELT(nms, 226, mkChar("dim_R"));
  SET_STRING_ELT(nms, 227, mkChar("dim_R_hosp"));
  SET_STRING_ELT(nms, 228, mkChar("dim_R_hosp_1"));
  SET_STRING_ELT(nms, 229, mkChar("dim_R_hosp_12"));
  SET_STRING_ELT(nms, 230, mkChar("dim_R_hosp_2"));
  SET_STRING_ELT(nms, 231, mkChar("dim_R_hosp_3"));
  SET_STRING_ELT(nms, 232, mkChar("dim_R0"));
  SET_STRING_ELT(nms, 233, mkChar("dim_R0_hosp"));
  SET_STRING_ELT(nms, 234, mkChar("dim_R0_hosp_1"));
  SET_STRING_ELT(nms, 235, mkChar("dim_R0_hosp_12"));
  SET_STRING_ELT(nms, 236, mkChar("dim_R0_hosp_2"));
  SET_STRING_ELT(nms, 237, mkChar("dim_R0_hosp_3"));
  SET_STRING_ELT(nms, 238, mkChar("dim_S"));
  SET_STRING_ELT(nms, 239, mkChar("dim_s_ij"));
  SET_STRING_ELT(nms, 240, mkChar("dim_s_ij_1"));
  SET_STRING_ELT(nms, 241, mkChar("dim_s_ij_2"));
  SET_STRING_ELT(nms, 242, mkChar("dim_S0"));
  SET_STRING_ELT(nms, 243, mkChar("dim_trans_increase"));
  SET_STRING_ELT(nms, 244, mkChar("dim_trans_increase_1"));
  SET_STRING_ELT(nms, 245, mkChar("dim_trans_increase_2"));
  SET_STRING_ELT(nms, 246, mkChar("dim_trans_profile"));
  SET_STRING_ELT(nms, 247, mkChar("dim_trans_profile_1"));
  SET_STRING_ELT(nms, 248, mkChar("dim_trans_profile_2"));
  SET_STRING_ELT(nms, 249, mkChar("dt"));
  SET_STRING_ELT(nms, 250, mkChar("E0"));
  SET_STRING_ELT(nms, 251, mkChar("gamma_asympt"));
  SET_STRING_ELT(nms, 252, mkChar("gamma_E"));
  SET_STRING_ELT(nms, 253, mkChar("gamma_hosp"));
  SET_STRING_ELT(nms, 254, mkChar("gamma_ICU"));
  SET_STRING_ELT(nms, 255, mkChar("gamma_ILI"));
  SET_STRING_ELT(nms, 256, mkChar("gamma_mild"));
  SET_STRING_ELT(nms, 257, mkChar("gamma_rec"));
  SET_STRING_ELT(nms, 258, mkChar("hosp_transmission"));
  SET_STRING_ELT(nms, 259, mkChar("I_with_diff_trans"));
  SET_STRING_ELT(nms, 260, mkChar("I0_asympt"));
  SET_STRING_ELT(nms, 261, mkChar("I0_hosp"));
  SET_STRING_ELT(nms, 262, mkChar("I0_ICU"));
  SET_STRING_ELT(nms, 263, mkChar("I0_ILI"));
  SET_STRING_ELT(nms, 264, mkChar("I0_mild"));
  SET_STRING_ELT(nms, 265, mkChar("ICU_transmission"));
  SET_STRING_ELT(nms, 266, mkChar("initial_D"));
  SET_STRING_ELT(nms, 267, mkChar("initial_E"));
  SET_STRING_ELT(nms, 268, mkChar("initial_I_asympt"));
  SET_STRING_ELT(nms, 269, mkChar("initial_I_hosp"));
  SET_STRING_ELT(nms, 270, mkChar("initial_I_ICU"));
  SET_STRING_ELT(nms, 271, mkChar("initial_I_ILI"));
  SET_STRING_ELT(nms, 272, mkChar("initial_I_mild"));
  SET_STRING_ELT(nms, 273, mkChar("initial_R"));
  SET_STRING_ELT(nms, 274, mkChar("initial_R_hosp"));
  SET_STRING_ELT(nms, 275, mkChar("initial_S"));
  SET_STRING_ELT(nms, 276, mkChar("initial_x"));
  SET_STRING_ELT(nms, 277, mkChar("lambda"));
  SET_STRING_ELT(nms, 278, mkChar("m"));
  SET_STRING_ELT(nms, 279, mkChar("N_age"));
  SET_STRING_ELT(nms, 280, mkChar("n_death_hosp"));
  SET_STRING_ELT(nms, 281, mkChar("n_EE"));
  SET_STRING_ELT(nms, 282, mkChar("n_EI_asympt"));
  SET_STRING_ELT(nms, 283, mkChar("n_EI_ILI"));
  SET_STRING_ELT(nms, 284, mkChar("n_EI_mild"));
  SET_STRING_ELT(nms, 285, mkChar("n_hosp_to_ICU"));
  SET_STRING_ELT(nms, 286, mkChar("n_ICU_to_R_hosp"));
  SET_STRING_ELT(nms, 287, mkChar("n_II_asympt"));
  SET_STRING_ELT(nms, 288, mkChar("n_II_hosp"));
  SET_STRING_ELT(nms, 289, mkChar("n_II_ICU"));
  SET_STRING_ELT(nms, 290, mkChar("n_II_ILI"));
  SET_STRING_ELT(nms, 291, mkChar("n_II_mild"));
  SET_STRING_ELT(nms, 292, mkChar("n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 293, mkChar("n_R_hosp"));
  SET_STRING_ELT(nms, 294, mkChar("n_SE"));
  SET_STRING_ELT(nms, 295, mkChar("offset_output_n_EI_ILI"));
  SET_STRING_ELT(nms, 296, mkChar("offset_output_n_EI_mild"));
  SET_STRING_ELT(nms, 297, mkChar("offset_output_n_hosp_to_ICU"));
  SET_STRING_ELT(nms, 298, mkChar("offset_output_n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 299, mkChar("offset_variable_D"));
  SET_STRING_ELT(nms, 300, mkChar("offset_variable_E"));
  SET_STRING_ELT(nms, 301, mkChar("offset_variable_I_asympt"));
  SET_STRING_ELT(nms, 302, mkChar("offset_variable_I_hosp"));
  SET_STRING_ELT(nms, 303, mkChar("offset_variable_I_ICU"));
  SET_STRING_ELT(nms, 304, mkChar("offset_variable_I_ILI"));
  SET_STRING_ELT(nms, 305, mkChar("offset_variable_I_mild"));
  SET_STRING_ELT(nms, 306, mkChar("offset_variable_R"));
  SET_STRING_ELT(nms, 307, mkChar("offset_variable_R_hosp"));
  SET_STRING_ELT(nms, 308, mkChar("p_asympt"));
  SET_STRING_ELT(nms, 309, mkChar("p_death_hosp"));
  SET_STRING_ELT(nms, 310, mkChar("p_EE"));
  SET_STRING_ELT(nms, 311, mkChar("p_II_asympt"));
  SET_STRING_ELT(nms, 312, mkChar("p_II_hosp"));
  SET_STRING_ELT(nms, 313, mkChar("p_II_ICU"));
  SET_STRING_ELT(nms, 314, mkChar("p_II_ILI"));
  SET_STRING_ELT(nms, 315, mkChar("p_II_mild"));
  SET_STRING_ELT(nms, 316, mkChar("p_R_hosp"));
  SET_STRING_ELT(nms, 317, mkChar("p_recov_hosp"));
  SET_STRING_ELT(nms, 318, mkChar("p_recov_ICU"));
  SET_STRING_ELT(nms, 319, mkChar("p_recov_ILI"));
  SET_STRING_ELT(nms, 320, mkChar("p_SE"));
  SET_STRING_ELT(nms, 321, mkChar("p_sympt_ILI"));
  SET_STRING_ELT(nms, 322, mkChar("R0"));
  SET_STRING_ELT(nms, 323, mkChar("R0_hosp"));
  SET_STRING_ELT(nms, 324, mkChar("s_asympt"));
  SET_STRING_ELT(nms, 325, mkChar("s_E"));
  SET_STRING_ELT(nms, 326, mkChar("s_hosp"));
  SET_STRING_ELT(nms, 327, mkChar("s_ICU"));
  SET_STRING_ELT(nms, 328, mkChar("s_ij"));
  SET_STRING_ELT(nms, 329, mkChar("s_ILI"));
  SET_STRING_ELT(nms, 330, mkChar("s_mild"));
  SET_STRING_ELT(nms, 331, mkChar("s_rec"));
  SET_STRING_ELT(nms, 332, mkChar("S0"));
  SET_STRING_ELT(nms, 333, mkChar("sd_x"));
  SET_STRING_ELT(nms, 334, mkChar("trans_classes"));
  SET_STRING_ELT(nms, 335, mkChar("trans_increase"));
  SET_STRING_ELT(nms, 336, mkChar("trans_profile"));
  SET_STRING_ELT(nms, 337, mkChar("x0"));
  setAttrib(contents, R_NamesSymbol, nms);
  UNPROTECT(67);
  return contents;
}
SEXP diffusion_beta_tmp_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->s_mild = user_get_scalar_int(user, "s_mild", internal->s_mild, NA_REAL, NA_REAL);
  internal->s_rec = user_get_scalar_int(user, "s_rec", internal->s_rec, NA_REAL, NA_REAL);
  internal->sd_x = user_get_scalar_double(user, "sd_x", internal->sd_x, NA_REAL, NA_REAL);
  internal->trans_classes = user_get_scalar_int(user, "trans_classes", internal->trans_classes, NA_REAL, NA_REAL);
  internal->x0 = user_get_scalar_double(user, "x0", internal->x0, NA_REAL, NA_REAL);
  internal->dim_aux_EE_1 = internal->N_age;
  internal->dim_aux_EE_2 = internal->s_E;
  internal->dim_aux_EE_3 = internal->trans_classes;
  internal->dim_aux_II_asympt_1 = internal->N_age;
  ...
  internal->dim_trans_profile_1 = internal->N_age;
  internal->dim_trans_profile_2 = internal->trans_classes;
  internal->initial_x = internal->x0;
  internal->p_EE = 1 - exp(-(internal->gamma_E) * internal->dt);
  internal->p_II_asympt = 1 - exp(-(internal->gamma_asympt) * internal->dt);
  internal->p_II_hosp = 1 - exp(-(internal->gamma_hosp) * internal->dt);
  internal->p_II_ICU = 1 - exp(-(internal->gamma_ICU) * internal->dt);
  ...
  internal->dim_trans_increase = internal->dim_trans_increase_1 * internal->dim_trans_increase_2;
  internal->dim_trans_profile = internal->dim_trans_profile_1 * internal->dim_trans_profile_2;
  internal->offset_variable_D = 1 + internal->dim_S + internal->dim_R;
  internal->offset_variable_E = 1 + internal->dim_S + internal->dim_R + internal->dim_D;
  internal->offset_variable_R = 1 + internal->dim_S;
  internal->p_asympt = (double*) user_get_array(user, false, internal->p_asympt, "p_asympt", NA_REAL, NA_REAL, 1, internal->dim_p_asympt);
  internal->p_death_hosp = (double*) user_get_array(user, false, internal->p_death_hosp, "p_death_hosp", NA_REAL, NA_REAL, 1, internal->dim_p_death_hosp);
  internal->p_recov_hosp = (double*) user_get_array(user, false, internal->p_recov_hosp, "p_recov_hosp", NA_REAL, NA_REAL, 1, internal->dim_p_recov_hosp);
  internal->p_recov_ICU = (double*) user_get_array(user, false, internal->p_recov_ICU, "p_recov_ICU", NA_REAL, NA_REAL, 1, internal->dim_p_recov_ICU);
  ...
  internal->offset_output_n_hosp_to_ICU = 3 + internal->dim_n_EI_asympt + internal->dim_n_EI_mild + internal->dim_n_EI_ILI + internal->dim_n_ILI_to_hosp;
  internal->offset_output_n_ILI_to_hosp = 3 + internal->dim_n_EI_asympt + internal->dim_n_EI_mild + internal->dim_n_EI_ILI;
  internal->offset_variable_I_asympt = 1 + internal->dim_S + internal->dim_R + internal->dim_D + internal->dim_E;
  internal->offset_variable_I_hosp = 1 + internal->dim_S + internal->dim_R + internal->dim_D + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI;
  internal->offset_variable_I_ICU = 1 + internal->dim_S + internal->dim_R + internal->dim_D + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_hosp;
  internal->offset_variable_I_ILI = 1 + internal->dim_S + internal->dim_R + internal->dim_D + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild;
  internal->offset_variable_I_mild = 1 + internal->dim_S + internal->dim_R + internal->dim_D + internal->dim_E + internal->dim_I_asympt;
  internal->offset_variable_R_hosp = 1 + internal->dim_S + internal->dim_R + internal->dim_D + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_hosp + internal->dim_I_ICU;
  internal->R0_hosp = (double*) user_get_array(user, false, internal->R0_hosp, "R0_hosp", NA_REAL, NA_REAL, 3, internal->dim_R0_hosp_1, internal->dim_R0_hosp_2, internal->dim_R0_hosp_3);
  internal->trans_increase = (double*) user_get_array(user, false, internal->trans_increase, "trans_increase", NA_REAL, NA_REAL, 2, internal->dim_trans_increase_1, internal->dim_trans_increase_2);
  internal->trans_profile = (double*) user_get_array(user, false, internal->trans_profile, "trans_profile", NA_REAL, NA_REAL, 2, internal->dim_trans_profile_1, internal->dim_trans_profile_2);
  for (int i = 1; i <= internal->dim_aux_p_bin_1; ++i) {
...
SEXP diffusion_beta_tmp_metadata(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(variable_length, 4, allocVector(INTSXP, 3));
  int * dim_E = INTEGER(VECTOR_ELT(variable_length, 4));
  dim_E[0] = internal->dim_E_1;
  dim_E[1] = internal->dim_E_2;
  dim_E[2] = internal->dim_E_3;
  SET_VECTOR_ELT(variable_length, 5, allocVector(INTSXP, 3));
  int * dim_I_asympt = INTEGER(VECTOR_ELT(variable_length, 5));
  dim_I_asympt[0] = internal->dim_I_asympt_1;
  dim_I_asympt[1] = internal->dim_I_asympt_2;
  dim_I_asympt[2] = internal->dim_I_asympt_3;
  SET_VECTOR_ELT(variable_length, 6, allocVector(INTSXP, 3));
  int * dim_I_mild = INTEGER(VECTOR_ELT(variable_length, 6));
  dim_I_mild[0] = internal->dim_I_mild_1;
  dim_I_mild[1] = internal->dim_I_mild_2;
  dim_I_mild[2] = internal->dim_I_mild_3;
  SET_VECTOR_ELT(variable_length, 7, allocVector(INTSXP, 3));
  int * dim_I_ILI = INTEGER(VECTOR_ELT(variable_length, 7));
  dim_I_ILI[0] = internal->dim_I_ILI_1;
  dim_I_ILI[1] = internal->dim_I_ILI_2;
  dim_I_ILI[2] = internal->dim_I_ILI_3;
  SET_VECTOR_ELT(variable_length, 8, allocVector(INTSXP, 3));
  int * dim_I_hosp = INTEGER(VECTOR_ELT(variable_length, 8));
  dim_I_hosp[0] = internal->dim_I_hosp_1;
  dim_I_hosp[1] = internal->dim_I_hosp_2;
  dim_I_hosp[2] = internal->dim_I_hosp_3;
  SET_VECTOR_ELT(variable_length, 9, allocVector(INTSXP, 3));
  int * dim_I_ICU = INTEGER(VECTOR_ELT(variable_length, 9));
  dim_I_ICU[0] = internal->dim_I_ICU_1;
  dim_I_ICU[1] = internal->dim_I_ICU_2;
  dim_I_ICU[2] = internal->dim_I_ICU_3;
  SET_VECTOR_ELT(variable_length, 10, allocVector(INTSXP, 3));
  int * dim_R_hosp = INTEGER(VECTOR_ELT(variable_length, 10));
  dim_R_hosp[0] = internal->dim_R_hosp_1;
  dim_R_hosp[1] = internal->dim_R_hosp_2;
  dim_R_hosp[2] = internal->dim_R_hosp_3;
  SET_STRING_ELT(variable_names, 0, mkChar("x"));
  ...
  SET_STRING_ELT(variable_names, 5, mkChar("I_asympt"));
  SET_STRING_ELT(variable_names, 6, mkChar("I_mild"));
  SET_STRING_ELT(variable_names, 7, mkChar("I_ILI"));
  SET_STRING_ELT(variable_names, 8, mkChar("I_hosp"));
  SET_STRING_ELT(variable_names, 9, mkChar("I_ICU"));
  SET_STRING_ELT(variable_names, 10, mkChar("R_hosp"));
  SET_VECTOR_ELT(ret, 0, variable_length);
  UNPROTECT(2);
  SEXP output_length = PROTECT(allocVector(VECSXP, 8));
  SEXP output_names = PROTECT(allocVector(STRSXP, 8));
...
SEXP diffusion_beta_tmp_initial_conditions(SEXP internal_p, SEXP step_ptr) {
  diffusion_beta_tmp_internal *internal = diffusion_beta_tmp_get_internal(internal_p, 1);
  SEXP r_state = PROTECT(allocVector(REALSXP, 1 + internal->dim_S + internal->dim_R + internal->dim_D + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_hosp + internal->dim_I_ICU + internal->dim_R_hosp));
  double * state = REAL(r_state);
...
void diffusion_beta_tmp_rhs(diffusion_beta_tmp_internal* internal, size_t step, double * state, double * state_next, double * output) {
  ...
  for (int i = 1; i <= internal->dim_S; ++i) {
    state_next[1 + i - 1] = S[i - 1] - internal->n_SE[i - 1];
  }
  for (int i = 1; i <= internal->dim_delta_E_1; ++i) {
    for (int j = 1; j <= internal->dim_delta_E_2; ++j) {
      for (int k = 1; k <= internal->dim_delta_E_3; ++k) {
...
void diffusion_beta_tmp_rhs_dde(size_t n_eq, size_t step, double * state, double * state_next, size_t n_out, double * output, void * internal) {
  diffusion_beta_tmp_rhs((diffusion_beta_tmp_internal*)internal, step, state, state_next, output);
}
SEXP diffusion_beta_tmp_rhs_r(SEXP internal_p, SEXP step, SEXP state) {
  SEXP state_next = PROTECT(allocVector(REALSXP, LENGTH(state)));
  diffusion_beta_tmp_internal *internal = diffusion_beta_tmp_get_internal(internal_p, 1);
  ...
  double *output = REAL(output_ptr);
  GetRNGstate();
  diffusion_beta_tmp_rhs(internal, INTEGER(step)[0], REAL(state), REAL(state_next), output);
  PutRNGstate();
  UNPROTECT(1);
  return state_next;
}
diffusion_beta_internal* diffusion_beta_get_internal(SEXP internal_p, int closed_error) {
  diffusion_beta_internal *internal = NULL;
  if (TYPEOF(internal_p) != EXTPTRSXP) {
    Rf_error("Expected an external pointer");
  }
  internal = (diffusion_beta_internal*) R_ExternalPtrAddr(internal_p);
  if (!internal && closed_error) {
    Rf_error("Pointer has been invalidated");
  }
  return internal;
}
void diffusion_beta_finalise(SEXP internal_p) {
  diffusion_beta_internal *internal = diffusion_beta_get_internal(internal_p, 0);
  if (internal_p) {
    Free(internal->aux_EE);
    Free(internal->aux_II_asympt);
...
SEXP diffusion_beta_create(SEXP user) {
  diffusion_beta_internal *internal = (diffusion_beta_internal*) Calloc(1, diffusion_beta_internal);
  internal->aux_EE = NULL;
  internal->aux_II_asympt = NULL;
  ...
  internal->sd_x = 0.050000000000000003;
  SEXP ptr = PROTECT(R_MakeExternalPtr(internal, R_NilValue, R_NilValue));
  R_RegisterCFinalizer(ptr, diffusion_beta_finalise);
  UNPROTECT(1);
  return ptr;
}
static diffusion_beta_internal *diffusion_beta_internal_ds;
void diffusion_beta_initmod_desolve(void(* odeparms) (int *, double *)) {
  static DL_FUNC get_desolve_gparms = NULL;
  if (get_desolve_gparms == NULL) {
    get_desolve_gparms =
  ...
  diffusion_beta_internal_ds = diffusion_beta_get_internal(get_desolve_gparms(), 1);
}
SEXP diffusion_beta_contents(SEXP internal_p) {
  diffusion_beta_internal *internal = diffusion_beta_get_internal(internal_p, 1);
  SEXP contents = PROTECT(allocVector(VECSXP, 459));
  SEXP aux_EE = PROTECT(allocVector(REALSXP, internal->dim_aux_EE));
  memcpy(REAL(aux_EE), internal->aux_EE, internal->dim_aux_EE * sizeof(double));
  odin_set_dim(aux_EE, 3, internal->dim_aux_EE_1, internal->dim_aux_EE_2, internal->dim_aux_EE_3);
  SET_VECTOR_ELT(contents, 0, aux_EE);
  ...
  SEXP D0 = PROTECT(allocVector(REALSXP, internal->dim_D0));
  memcpy(REAL(D0), internal->D0, internal->dim_D0 * sizeof(double));
  SET_VECTOR_ELT(contents, 11, D0);
  SEXP delta_D = PROTECT(allocVector(REALSXP, internal->dim_delta_D));
  memcpy(REAL(delta_D), internal->delta_D, internal->dim_delta_D * sizeof(double));
  SET_VECTOR_ELT(contents, 12, delta_D);
  SEXP delta_E = PROTECT(allocVector(REALSXP, internal->dim_delta_E));
  memcpy(REAL(delta_E), internal->delta_E, internal->dim_delta_E * sizeof(double));
  odin_set_dim(delta_E, 3, internal->dim_delta_E_1, internal->dim_delta_E_2, internal->dim_delta_E_3);
  SET_VECTOR_ELT(contents, 13, delta_E);
  SEXP delta_I_asympt = PROTECT(allocVector(REALSXP, internal->dim_delta_I_asympt));
  memcpy(REAL(delta_I_asympt), internal->delta_I_asympt, internal->dim_delta_I_asympt * sizeof(double));
  odin_set_dim(delta_I_asympt, 3, internal->dim_delta_I_asympt_1, internal->dim_delta_I_asympt_2, internal->dim_delta_I_asympt_3);
  SET_VECTOR_ELT(contents, 14, delta_I_asympt);
  ...
  SET_VECTOR_ELT(contents, 15, delta_I_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 16, delta_I_hosp_R);
  ...
  SET_VECTOR_ELT(contents, 17, delta_I_ICU_D);
  ...
  SET_VECTOR_ELT(contents, 18, delta_I_ICU_R);
  SEXP delta_I_ILI = PROTECT(allocVector(REALSXP, internal->dim_delta_I_ILI));
  memcpy(REAL(delta_I_ILI), internal->delta_I_ILI, internal->dim_delta_I_ILI * sizeof(double));
  odin_set_dim(delta_I_ILI, 3, internal->dim_delta_I_ILI_1, internal->dim_delta_I_ILI_2, internal->dim_delta_I_ILI_3);
  SET_VECTOR_ELT(contents, 19, delta_I_ILI);
  SEXP delta_I_mild = PROTECT(allocVector(REALSXP, internal->dim_delta_I_mild));
  memcpy(REAL(delta_I_mild), internal->delta_I_mild, internal->dim_delta_I_mild * sizeof(double));
  odin_set_dim(delta_I_mild, 3, internal->dim_delta_I_mild_1, internal->dim_delta_I_mild_2, internal->dim_delta_I_mild_3);
  SET_VECTOR_ELT(contents, 20, delta_I_mild);
  ...
  SET_VECTOR_ELT(contents, 21, delta_I_triage);
  SEXP delta_R = PROTECT(allocVector(REALSXP, internal->dim_delta_R));
  memcpy(REAL(delta_R), internal->delta_R, internal->dim_delta_R * sizeof(double));
  SET_VECTOR_ELT(contents, 22, delta_R);
  ...
  SET_VECTOR_ELT(contents, 23, delta_R_stepdown);
  SET_VECTOR_ELT(contents, 24, ScalarInteger(internal->dim_aux_EE));
  SET_VECTOR_ELT(contents, 25, ScalarInteger(internal->dim_aux_EE_1));
  SET_VECTOR_ELT(contents, 26, ScalarInteger(internal->dim_aux_EE_12));
  SET_VECTOR_ELT(contents, 27, ScalarInteger(internal->dim_aux_EE_2));
  SET_VECTOR_ELT(contents, 28, ScalarInteger(internal->dim_aux_EE_3));
  SET_VECTOR_ELT(contents, 29, ScalarInteger(internal->dim_aux_II_asympt));
  SET_VECTOR_ELT(contents, 30, ScalarInteger(internal->dim_aux_II_asympt_1));
  SET_VECTOR_ELT(contents, 31, ScalarInteger(internal->dim_aux_II_asympt_12));
  SET_VECTOR_ELT(contents, 32, ScalarInteger(internal->dim_aux_II_asympt_2));
  SET_VECTOR_ELT(contents, 33, ScalarInteger(internal->dim_aux_II_asympt_3));
  SET_VECTOR_ELT(contents, 34, ScalarInteger(internal->dim_aux_II_hosp_D));
  SET_VECTOR_ELT(contents, 35, ScalarInteger(internal->dim_aux_II_hosp_D_1));
  SET_VECTOR_ELT(contents, 36, ScalarInteger(internal->dim_aux_II_hosp_D_12));
  SET_VECTOR_ELT(contents, 37, ScalarInteger(internal->dim_aux_II_hosp_D_2));
  SET_VECTOR_ELT(contents, 38, ScalarInteger(internal->dim_aux_II_hosp_D_3));
  SET_VECTOR_ELT(contents, 39, ScalarInteger(internal->dim_aux_II_hosp_R));
  SET_VECTOR_ELT(contents, 40, ScalarInteger(internal->dim_aux_II_hosp_R_1));
  SET_VECTOR_ELT(contents, 41, ScalarInteger(internal->dim_aux_II_hosp_R_12));
  SET_VECTOR_ELT(contents, 42, ScalarInteger(internal->dim_aux_II_hosp_R_2));
  SET_VECTOR_ELT(contents, 43, ScalarInteger(internal->dim_aux_II_hosp_R_3));
  SET_VECTOR_ELT(contents, 44, ScalarInteger(internal->dim_aux_II_ICU_D));
  SET_VECTOR_ELT(contents, 45, ScalarInteger(internal->dim_aux_II_ICU_D_1));
  SET_VECTOR_ELT(contents, 46, ScalarInteger(internal->dim_aux_II_ICU_D_12));
  SET_VECTOR_ELT(contents, 47, ScalarInteger(internal->dim_aux_II_ICU_D_2));
  SET_VECTOR_ELT(contents, 48, ScalarInteger(internal->dim_aux_II_ICU_D_3));
  SET_VECTOR_ELT(contents, 49, ScalarInteger(internal->dim_aux_II_ICU_R));
  SET_VECTOR_ELT(contents, 50, ScalarInteger(internal->dim_aux_II_ICU_R_1));
  SET_VECTOR_ELT(contents, 51, ScalarInteger(internal->dim_aux_II_ICU_R_12));
  SET_VECTOR_ELT(contents, 52, ScalarInteger(internal->dim_aux_II_ICU_R_2));
  SET_VECTOR_ELT(contents, 53, ScalarInteger(internal->dim_aux_II_ICU_R_3));
  SET_VECTOR_ELT(contents, 54, ScalarInteger(internal->dim_aux_II_ILI));
  SET_VECTOR_ELT(contents, 55, ScalarInteger(internal->dim_aux_II_ILI_1));
  SET_VECTOR_ELT(contents, 56, ScalarInteger(internal->dim_aux_II_ILI_12));
  SET_VECTOR_ELT(contents, 57, ScalarInteger(internal->dim_aux_II_ILI_2));
  SET_VECTOR_ELT(contents, 58, ScalarInteger(internal->dim_aux_II_ILI_3));
  SET_VECTOR_ELT(contents, 59, ScalarInteger(internal->dim_aux_II_mild));
  SET_VECTOR_ELT(contents, 60, ScalarInteger(internal->dim_aux_II_mild_1));
  SET_VECTOR_ELT(contents, 61, ScalarInteger(internal->dim_aux_II_mild_12));
  SET_VECTOR_ELT(contents, 62, ScalarInteger(internal->dim_aux_II_mild_2));
  SET_VECTOR_ELT(contents, 63, ScalarInteger(internal->dim_aux_II_mild_3));
  SET_VECTOR_ELT(contents, 64, ScalarInteger(internal->dim_aux_II_triage));
  SET_VECTOR_ELT(contents, 65, ScalarInteger(internal->dim_aux_II_triage_1));
  SET_VECTOR_ELT(contents, 66, ScalarInteger(internal->dim_aux_II_triage_12));
  SET_VECTOR_ELT(contents, 67, ScalarInteger(internal->dim_aux_II_triage_2));
  SET_VECTOR_ELT(contents, 68, ScalarInteger(internal->dim_aux_II_triage_3));
  SET_VECTOR_ELT(contents, 69, ScalarInteger(internal->dim_aux_p_bin));
  SET_VECTOR_ELT(contents, 70, ScalarInteger(internal->dim_aux_p_bin_1));
  SET_VECTOR_ELT(contents, 71, ScalarInteger(internal->dim_aux_p_bin_2));
  SET_VECTOR_ELT(contents, 72, ScalarInteger(internal->dim_aux_R_stepdown));
  SET_VECTOR_ELT(contents, 73, ScalarInteger(internal->dim_aux_R_stepdown_1));
  SET_VECTOR_ELT(contents, 74, ScalarInteger(internal->dim_aux_R_stepdown_12));
  SET_VECTOR_ELT(contents, 75, ScalarInteger(internal->dim_aux_R_stepdown_2));
  SET_VECTOR_ELT(contents, 76, ScalarInteger(internal->dim_aux_R_stepdown_3));
  SET_VECTOR_ELT(contents, 77, ScalarInteger(internal->dim_D));
  SET_VECTOR_ELT(contents, 78, ScalarInteger(internal->dim_D0));
  SET_VECTOR_ELT(contents, 79, ScalarInteger(internal->dim_delta_D));
  SET_VECTOR_ELT(contents, 80, ScalarInteger(internal->dim_delta_E));
  SET_VECTOR_ELT(contents, 81, ScalarInteger(internal->dim_delta_E_1));
  SET_VECTOR_ELT(contents, 82, ScalarInteger(internal->dim_delta_E_12));
  SET_VECTOR_ELT(contents, 83, ScalarInteger(internal->dim_delta_E_2));
  SET_VECTOR_ELT(contents, 84, ScalarInteger(internal->dim_delta_E_3));
  SET_VECTOR_ELT(contents, 85, ScalarInteger(internal->dim_delta_I_asympt));
  SET_VECTOR_ELT(contents, 86, ScalarInteger(internal->dim_delta_I_asympt_1));
  SET_VECTOR_ELT(contents, 87, ScalarInteger(internal->dim_delta_I_asympt_12));
  SET_VECTOR_ELT(contents, 88, ScalarInteger(internal->dim_delta_I_asympt_2));
  SET_VECTOR_ELT(contents, 89, ScalarInteger(internal->dim_delta_I_asympt_3));
  SET_VECTOR_ELT(contents, 90, ScalarInteger(internal->dim_delta_I_hosp_D));
  SET_VECTOR_ELT(contents, 91, ScalarInteger(internal->dim_delta_I_hosp_D_1));
  SET_VECTOR_ELT(contents, 92, ScalarInteger(internal->dim_delta_I_hosp_D_12));
  SET_VECTOR_ELT(contents, 93, ScalarInteger(internal->dim_delta_I_hosp_D_2));
  SET_VECTOR_ELT(contents, 94, ScalarInteger(internal->dim_delta_I_hosp_D_3));
  SET_VECTOR_ELT(contents, 95, ScalarInteger(internal->dim_delta_I_hosp_R));
  SET_VECTOR_ELT(contents, 96, ScalarInteger(internal->dim_delta_I_hosp_R_1));
  SET_VECTOR_ELT(contents, 97, ScalarInteger(internal->dim_delta_I_hosp_R_12));
  SET_VECTOR_ELT(contents, 98, ScalarInteger(internal->dim_delta_I_hosp_R_2));
  SET_VECTOR_ELT(contents, 99, ScalarInteger(internal->dim_delta_I_hosp_R_3));
  SET_VECTOR_ELT(contents, 100, ScalarInteger(internal->dim_delta_I_ICU_D));
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_delta_I_ICU_D_1));
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_delta_I_ICU_D_12));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_delta_I_ICU_D_2));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_delta_I_ICU_D_3));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_delta_I_ICU_R));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_delta_I_ICU_R_1));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_delta_I_ICU_R_12));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_delta_I_ICU_R_2));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_delta_I_ICU_R_3));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_delta_I_ILI));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_delta_I_ILI_1));
  SET_VECTOR_ELT(contents, 112, ScalarInteger(internal->dim_delta_I_ILI_12));
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_delta_I_ILI_2));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_delta_I_ILI_3));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_delta_I_mild));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_delta_I_mild_1));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_delta_I_mild_12));
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_delta_I_mild_2));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_delta_I_mild_3));
  SET_VECTOR_ELT(contents, 120, ScalarInteger(internal->dim_delta_I_triage));
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->dim_delta_I_triage_1));
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_delta_I_triage_12));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_delta_I_triage_2));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_delta_I_triage_3));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_delta_R));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_delta_R_stepdown));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_delta_R_stepdown_1));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_delta_R_stepdown_12));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_delta_R_stepdown_2));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_delta_R_stepdown_3));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_E));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_E_1));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_E_12));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_E_2));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_E_3));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_E0));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_E0_1));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_E0_12));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->dim_E0_2));
  SET_VECTOR_ELT(contents, 140, ScalarInteger(internal->dim_E0_3));
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_I_asympt));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_I_asympt_1));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_I_asympt_12));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_I_asympt_2));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->dim_I_asympt_3));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->dim_I_hosp_D));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->dim_I_hosp_D_1));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->dim_I_hosp_D_12));
  SET_VECTOR_ELT(contents, 149, ScalarInteger(internal->dim_I_hosp_D_2));
  SET_VECTOR_ELT(contents, 150, ScalarInteger(internal->dim_I_hosp_D_3));
  SET_VECTOR_ELT(contents, 151, ScalarInteger(internal->dim_I_hosp_R));
  SET_VECTOR_ELT(contents, 152, ScalarInteger(internal->dim_I_hosp_R_1));
  SET_VECTOR_ELT(contents, 153, ScalarInteger(internal->dim_I_hosp_R_12));
  SET_VECTOR_ELT(contents, 154, ScalarInteger(internal->dim_I_hosp_R_2));
  SET_VECTOR_ELT(contents, 155, ScalarInteger(internal->dim_I_hosp_R_3));
  SET_VECTOR_ELT(contents, 156, ScalarInteger(internal->dim_I_ICU_D));
  SET_VECTOR_ELT(contents, 157, ScalarInteger(internal->dim_I_ICU_D_1));
  SET_VECTOR_ELT(contents, 158, ScalarInteger(internal->dim_I_ICU_D_12));
  SET_VECTOR_ELT(contents, 159, ScalarInteger(internal->dim_I_ICU_D_2));
  SET_VECTOR_ELT(contents, 160, ScalarInteger(internal->dim_I_ICU_D_3));
  SET_VECTOR_ELT(contents, 161, ScalarInteger(internal->dim_I_ICU_R));
  SET_VECTOR_ELT(contents, 162, ScalarInteger(internal->dim_I_ICU_R_1));
  SET_VECTOR_ELT(contents, 163, ScalarInteger(internal->dim_I_ICU_R_12));
  SET_VECTOR_ELT(contents, 164, ScalarInteger(internal->dim_I_ICU_R_2));
  SET_VECTOR_ELT(contents, 165, ScalarInteger(internal->dim_I_ICU_R_3));
  SET_VECTOR_ELT(contents, 166, ScalarInteger(internal->dim_I_ILI));
  SET_VECTOR_ELT(contents, 167, ScalarInteger(internal->dim_I_ILI_1));
  SET_VECTOR_ELT(contents, 168, ScalarInteger(internal->dim_I_ILI_12));
  SET_VECTOR_ELT(contents, 169, ScalarInteger(internal->dim_I_ILI_2));
  SET_VECTOR_ELT(contents, 170, ScalarInteger(internal->dim_I_ILI_3));
  SET_VECTOR_ELT(contents, 171, ScalarInteger(internal->dim_I_mild));
  SET_VECTOR_ELT(contents, 172, ScalarInteger(internal->dim_I_mild_1));
  SET_VECTOR_ELT(contents, 173, ScalarInteger(internal->dim_I_mild_12));
  SET_VECTOR_ELT(contents, 174, ScalarInteger(internal->dim_I_mild_2));
  SET_VECTOR_ELT(contents, 175, ScalarInteger(internal->dim_I_mild_3));
  SET_VECTOR_ELT(contents, 176, ScalarInteger(internal->dim_I_triage));
  SET_VECTOR_ELT(contents, 177, ScalarInteger(internal->dim_I_triage_1));
  SET_VECTOR_ELT(contents, 178, ScalarInteger(internal->dim_I_triage_12));
  SET_VECTOR_ELT(contents, 179, ScalarInteger(internal->dim_I_triage_2));
  SET_VECTOR_ELT(contents, 180, ScalarInteger(internal->dim_I_triage_3));
  SET_VECTOR_ELT(contents, 181, ScalarInteger(internal->dim_I_with_diff_trans));
  SET_VECTOR_ELT(contents, 182, ScalarInteger(internal->dim_I_with_diff_trans_1));
  SET_VECTOR_ELT(contents, 183, ScalarInteger(internal->dim_I_with_diff_trans_2));
  SET_VECTOR_ELT(contents, 184, ScalarInteger(internal->dim_I0_asympt));
  SET_VECTOR_ELT(contents, 185, ScalarInteger(internal->dim_I0_asympt_1));
  SET_VECTOR_ELT(contents, 186, ScalarInteger(internal->dim_I0_asympt_12));
  SET_VECTOR_ELT(contents, 187, ScalarInteger(internal->dim_I0_asympt_2));
  SET_VECTOR_ELT(contents, 188, ScalarInteger(internal->dim_I0_asympt_3));
  SET_VECTOR_ELT(contents, 189, ScalarInteger(internal->dim_I0_hosp_D));
  SET_VECTOR_ELT(contents, 190, ScalarInteger(internal->dim_I0_hosp_D_1));
  SET_VECTOR_ELT(contents, 191, ScalarInteger(internal->dim_I0_hosp_D_12));
  SET_VECTOR_ELT(contents, 192, ScalarInteger(internal->dim_I0_hosp_D_2));
  SET_VECTOR_ELT(contents, 193, ScalarInteger(internal->dim_I0_hosp_D_3));
  SET_VECTOR_ELT(contents, 194, ScalarInteger(internal->dim_I0_hosp_R));
  SET_VECTOR_ELT(contents, 195, ScalarInteger(internal->dim_I0_hosp_R_1));
  SET_VECTOR_ELT(contents, 196, ScalarInteger(internal->dim_I0_hosp_R_12));
  SET_VECTOR_ELT(contents, 197, ScalarInteger(internal->dim_I0_hosp_R_2));
  SET_VECTOR_ELT(contents, 198, ScalarInteger(internal->dim_I0_hosp_R_3));
  SET_VECTOR_ELT(contents, 199, ScalarInteger(internal->dim_I0_ICU_D));
  SET_VECTOR_ELT(contents, 200, ScalarInteger(internal->dim_I0_ICU_D_1));
  SET_VECTOR_ELT(contents, 201, ScalarInteger(internal->dim_I0_ICU_D_12));
  SET_VECTOR_ELT(contents, 202, ScalarInteger(internal->dim_I0_ICU_D_2));
  SET_VECTOR_ELT(contents, 203, ScalarInteger(internal->dim_I0_ICU_D_3));
  SET_VECTOR_ELT(contents, 204, ScalarInteger(internal->dim_I0_ICU_R));
  SET_VECTOR_ELT(contents, 205, ScalarInteger(internal->dim_I0_ICU_R_1));
  SET_VECTOR_ELT(contents, 206, ScalarInteger(internal->dim_I0_ICU_R_12));
  SET_VECTOR_ELT(contents, 207, ScalarInteger(internal->dim_I0_ICU_R_2));
  SET_VECTOR_ELT(contents, 208, ScalarInteger(internal->dim_I0_ICU_R_3));
  SET_VECTOR_ELT(contents, 209, ScalarInteger(internal->dim_I0_ILI));
  SET_VECTOR_ELT(contents, 210, ScalarInteger(internal->dim_I0_ILI_1));
  SET_VECTOR_ELT(contents, 211, ScalarInteger(internal->dim_I0_ILI_12));
  SET_VECTOR_ELT(contents, 212, ScalarInteger(internal->dim_I0_ILI_2));
  SET_VECTOR_ELT(contents, 213, ScalarInteger(internal->dim_I0_ILI_3));
  SET_VECTOR_ELT(contents, 214, ScalarInteger(internal->dim_I0_mild));
  SET_VECTOR_ELT(contents, 215, ScalarInteger(internal->dim_I0_mild_1));
  SET_VECTOR_ELT(contents, 216, ScalarInteger(internal->dim_I0_mild_12));
  SET_VECTOR_ELT(contents, 217, ScalarInteger(internal->dim_I0_mild_2));
  SET_VECTOR_ELT(contents, 218, ScalarInteger(internal->dim_I0_mild_3));
  SET_VECTOR_ELT(contents, 219, ScalarInteger(internal->dim_I0_triage));
  SET_VECTOR_ELT(contents, 220, ScalarInteger(internal->dim_I0_triage_1));
  SET_VECTOR_ELT(contents, 221, ScalarInteger(internal->dim_I0_triage_12));
  SET_VECTOR_ELT(contents, 222, ScalarInteger(internal->dim_I0_triage_2));
  SET_VECTOR_ELT(contents, 223, ScalarInteger(internal->dim_I0_triage_3));
  SET_VECTOR_ELT(contents, 224, ScalarInteger(internal->dim_lambda));
  SET_VECTOR_ELT(contents, 225, ScalarInteger(internal->dim_m));
  SET_VECTOR_ELT(contents, 226, ScalarInteger(internal->dim_m_1));
  SET_VECTOR_ELT(contents, 227, ScalarInteger(internal->dim_m_2));
  SET_VECTOR_ELT(contents, 228, ScalarInteger(internal->dim_n_EE));
  SET_VECTOR_ELT(contents, 229, ScalarInteger(internal->dim_n_EE_1));
  SET_VECTOR_ELT(contents, 230, ScalarInteger(internal->dim_n_EE_12));
  SET_VECTOR_ELT(contents, 231, ScalarInteger(internal->dim_n_EE_2));
  SET_VECTOR_ELT(contents, 232, ScalarInteger(internal->dim_n_EE_3));
  SET_VECTOR_ELT(contents, 233, ScalarInteger(internal->dim_n_EI_asympt));
  SET_VECTOR_ELT(contents, 234, ScalarInteger(internal->dim_n_EI_asympt_1));
  SET_VECTOR_ELT(contents, 235, ScalarInteger(internal->dim_n_EI_asympt_2));
  SET_VECTOR_ELT(contents, 236, ScalarInteger(internal->dim_n_EI_ILI));
  SET_VECTOR_ELT(contents, 237, ScalarInteger(internal->dim_n_EI_ILI_1));
  SET_VECTOR_ELT(contents, 238, ScalarInteger(internal->dim_n_EI_ILI_2));
  SET_VECTOR_ELT(contents, 239, ScalarInteger(internal->dim_n_EI_mild));
  SET_VECTOR_ELT(contents, 240, ScalarInteger(internal->dim_n_EI_mild_1));
  SET_VECTOR_ELT(contents, 241, ScalarInteger(internal->dim_n_EI_mild_2));
  SET_VECTOR_ELT(contents, 242, ScalarInteger(internal->dim_n_hosp_non_ICU));
  SET_VECTOR_ELT(contents, 243, ScalarInteger(internal->dim_n_hosp_non_ICU_1));
  SET_VECTOR_ELT(contents, 244, ScalarInteger(internal->dim_n_hosp_non_ICU_2));
  SET_VECTOR_ELT(contents, 245, ScalarInteger(internal->dim_n_ICU_to_R_stepdown));
  SET_VECTOR_ELT(contents, 246, ScalarInteger(internal->dim_n_ICU_to_R_stepdown_1));
  SET_VECTOR_ELT(contents, 247, ScalarInteger(internal->dim_n_ICU_to_R_stepdown_2));
  SET_VECTOR_ELT(contents, 248, ScalarInteger(internal->dim_n_II_asympt));
  SET_VECTOR_ELT(contents, 249, ScalarInteger(internal->dim_n_II_asympt_1));
  SET_VECTOR_ELT(contents, 250, ScalarInteger(internal->dim_n_II_asympt_12));
  SET_VECTOR_ELT(contents, 251, ScalarInteger(internal->dim_n_II_asympt_2));
  SET_VECTOR_ELT(contents, 252, ScalarInteger(internal->dim_n_II_asympt_3));
  SET_VECTOR_ELT(contents, 253, ScalarInteger(internal->dim_n_II_hosp_D));
  SET_VECTOR_ELT(contents, 254, ScalarInteger(internal->dim_n_II_hosp_D_1));
  SET_VECTOR_ELT(contents, 255, ScalarInteger(internal->dim_n_II_hosp_D_12));
  SET_VECTOR_ELT(contents, 256, ScalarInteger(internal->dim_n_II_hosp_D_2));
  SET_VECTOR_ELT(contents, 257, ScalarInteger(internal->dim_n_II_hosp_D_3));
  SET_VECTOR_ELT(contents, 258, ScalarInteger(internal->dim_n_II_hosp_R));
  SET_VECTOR_ELT(contents, 259, ScalarInteger(internal->dim_n_II_hosp_R_1));
  SET_VECTOR_ELT(contents, 260, ScalarInteger(internal->dim_n_II_hosp_R_12));
  SET_VECTOR_ELT(contents, 261, ScalarInteger(internal->dim_n_II_hosp_R_2));
  SET_VECTOR_ELT(contents, 262, ScalarInteger(internal->dim_n_II_hosp_R_3));
  SET_VECTOR_ELT(contents, 263, ScalarInteger(internal->dim_n_II_ICU_D));
  SET_VECTOR_ELT(contents, 264, ScalarInteger(internal->dim_n_II_ICU_D_1));
  SET_VECTOR_ELT(contents, 265, ScalarInteger(internal->dim_n_II_ICU_D_12));
  SET_VECTOR_ELT(contents, 266, ScalarInteger(internal->dim_n_II_ICU_D_2));
  SET_VECTOR_ELT(contents, 267, ScalarInteger(internal->dim_n_II_ICU_D_3));
  SET_VECTOR_ELT(contents, 268, ScalarInteger(internal->dim_n_II_ICU_R));
  SET_VECTOR_ELT(contents, 269, ScalarInteger(internal->dim_n_II_ICU_R_1));
  SET_VECTOR_ELT(contents, 270, ScalarInteger(internal->dim_n_II_ICU_R_12));
  SET_VECTOR_ELT(contents, 271, ScalarInteger(internal->dim_n_II_ICU_R_2));
  SET_VECTOR_ELT(contents, 272, ScalarInteger(internal->dim_n_II_ICU_R_3));
  SET_VECTOR_ELT(contents, 273, ScalarInteger(internal->dim_n_II_ILI));
  SET_VECTOR_ELT(contents, 274, ScalarInteger(internal->dim_n_II_ILI_1));
  SET_VECTOR_ELT(contents, 275, ScalarInteger(internal->dim_n_II_ILI_12));
  SET_VECTOR_ELT(contents, 276, ScalarInteger(internal->dim_n_II_ILI_2));
  SET_VECTOR_ELT(contents, 277, ScalarInteger(internal->dim_n_II_ILI_3));
  SET_VECTOR_ELT(contents, 278, ScalarInteger(internal->dim_n_II_mild));
  SET_VECTOR_ELT(contents, 279, ScalarInteger(internal->dim_n_II_mild_1));
  SET_VECTOR_ELT(contents, 280, ScalarInteger(internal->dim_n_II_mild_12));
  SET_VECTOR_ELT(contents, 281, ScalarInteger(internal->dim_n_II_mild_2));
  SET_VECTOR_ELT(contents, 282, ScalarInteger(internal->dim_n_II_mild_3));
  SET_VECTOR_ELT(contents, 283, ScalarInteger(internal->dim_n_II_triage));
  SET_VECTOR_ELT(contents, 284, ScalarInteger(internal->dim_n_II_triage_1));
  SET_VECTOR_ELT(contents, 285, ScalarInteger(internal->dim_n_II_triage_12));
  SET_VECTOR_ELT(contents, 286, ScalarInteger(internal->dim_n_II_triage_2));
  SET_VECTOR_ELT(contents, 287, ScalarInteger(internal->dim_n_II_triage_3));
  SET_VECTOR_ELT(contents, 288, ScalarInteger(internal->dim_n_ILI_to_hosp));
  SET_VECTOR_ELT(contents, 289, ScalarInteger(internal->dim_n_ILI_to_hosp_1));
  SET_VECTOR_ELT(contents, 290, ScalarInteger(internal->dim_n_ILI_to_hosp_2));
  SET_VECTOR_ELT(contents, 291, ScalarInteger(internal->dim_n_ILI_to_hosp_D));
  SET_VECTOR_ELT(contents, 292, ScalarInteger(internal->dim_n_ILI_to_hosp_D_1));
  SET_VECTOR_ELT(contents, 293, ScalarInteger(internal->dim_n_ILI_to_hosp_D_2));
  SET_VECTOR_ELT(contents, 294, ScalarInteger(internal->dim_n_ILI_to_hosp_R));
  SET_VECTOR_ELT(contents, 295, ScalarInteger(internal->dim_n_ILI_to_hosp_R_1));
  SET_VECTOR_ELT(contents, 296, ScalarInteger(internal->dim_n_ILI_to_hosp_R_2));
  SET_VECTOR_ELT(contents, 297, ScalarInteger(internal->dim_n_ILI_to_triage));
  SET_VECTOR_ELT(contents, 298, ScalarInteger(internal->dim_n_ILI_to_triage_1));
  SET_VECTOR_ELT(contents, 299, ScalarInteger(internal->dim_n_ILI_to_triage_2));
  SET_VECTOR_ELT(contents, 300, ScalarInteger(internal->dim_n_R_stepdown));
  SET_VECTOR_ELT(contents, 301, ScalarInteger(internal->dim_n_R_stepdown_1));
  SET_VECTOR_ELT(contents, 302, ScalarInteger(internal->dim_n_R_stepdown_12));
  SET_VECTOR_ELT(contents, 303, ScalarInteger(internal->dim_n_R_stepdown_2));
  SET_VECTOR_ELT(contents, 304, ScalarInteger(internal->dim_n_R_stepdown_3));
  SET_VECTOR_ELT(contents, 305, ScalarInteger(internal->dim_n_SE));
  SET_VECTOR_ELT(contents, 306, ScalarInteger(internal->dim_n_triage_to_ICU_D));
  SET_VECTOR_ELT(contents, 307, ScalarInteger(internal->dim_n_triage_to_ICU_D_1));
  SET_VECTOR_ELT(contents, 308, ScalarInteger(internal->dim_n_triage_to_ICU_D_2));
  SET_VECTOR_ELT(contents, 309, ScalarInteger(internal->dim_n_triage_to_ICU_R));
  SET_VECTOR_ELT(contents, 310, ScalarInteger(internal->dim_n_triage_to_ICU_R_1));
  SET_VECTOR_ELT(contents, 311, ScalarInteger(internal->dim_n_triage_to_ICU_R_2));
  SET_VECTOR_ELT(contents, 312, ScalarInteger(internal->dim_p_asympt));
  SET_VECTOR_ELT(contents, 313, ScalarInteger(internal->dim_p_death_hosp_D));
  SET_VECTOR_ELT(contents, 314, ScalarInteger(internal->dim_p_death_ICU));
  SET_VECTOR_ELT(contents, 315, ScalarInteger(internal->dim_p_ICU_hosp));
  SET_VECTOR_ELT(contents, 316, ScalarInteger(internal->dim_p_recov_ILI));
  SET_VECTOR_ELT(contents, 317, ScalarInteger(internal->dim_p_SE));
  SET_VECTOR_ELT(contents, 318, ScalarInteger(internal->dim_p_sympt_ILI));
  SET_VECTOR_ELT(contents, 319, ScalarInteger(internal->dim_R));
  SET_VECTOR_ELT(contents, 320, ScalarInteger(internal->dim_R_stepdown));
  SET_VECTOR_ELT(contents, 321, ScalarInteger(internal->dim_R_stepdown_1));
  SET_VECTOR_ELT(contents, 322, ScalarInteger(internal->dim_R_stepdown_12));
  SET_VECTOR_ELT(contents, 323, ScalarInteger(internal->dim_R_stepdown_2));
  SET_VECTOR_ELT(contents, 324, ScalarInteger(internal->dim_R_stepdown_3));
  SET_VECTOR_ELT(contents, 325, ScalarInteger(internal->dim_R0));
  SET_VECTOR_ELT(contents, 326, ScalarInteger(internal->dim_R0_stepdown));
  SET_VECTOR_ELT(contents, 327, ScalarInteger(internal->dim_R0_stepdown_1));
  SET_VECTOR_ELT(contents, 328, ScalarInteger(internal->dim_R0_stepdown_12));
  SET_VECTOR_ELT(contents, 329, ScalarInteger(internal->dim_R0_stepdown_2));
  SET_VECTOR_ELT(contents, 330, ScalarInteger(internal->dim_R0_stepdown_3));
  SET_VECTOR_ELT(contents, 331, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 332, ScalarInteger(internal->dim_s_ij));
  SET_VECTOR_ELT(contents, 333, ScalarInteger(internal->dim_s_ij_1));
  SET_VECTOR_ELT(contents, 334, ScalarInteger(internal->dim_s_ij_2));
  SET_VECTOR_ELT(contents, 335, ScalarInteger(internal->dim_S0));
  SET_VECTOR_ELT(contents, 336, ScalarInteger(internal->dim_trans_increase));
  SET_VECTOR_ELT(contents, 337, ScalarInteger(internal->dim_trans_increase_1));
  SET_VECTOR_ELT(contents, 338, ScalarInteger(internal->dim_trans_increase_2));
  SET_VECTOR_ELT(contents, 339, ScalarInteger(internal->dim_trans_profile));
  SET_VECTOR_ELT(contents, 340, ScalarInteger(internal->dim_trans_profile_1));
  SET_VECTOR_ELT(contents, 341, ScalarInteger(internal->dim_trans_profile_2));
  SET_VECTOR_ELT(contents, 342, ScalarReal(internal->dt));
  SEXP E0 = PROTECT(allocVector(REALSXP, internal->dim_E0));
  memcpy(REAL(E0), internal->E0, internal->dim_E0 * sizeof(double));
  odin_set_dim(E0, 3, internal->dim_E0_1, internal->dim_E0_2, internal->dim_E0_3);
  SET_VECTOR_ELT(contents, 343, E0);
  SET_VECTOR_ELT(contents, 344, ScalarReal(internal->gamma_asympt));
  SET_VECTOR_ELT(contents, 345, ScalarReal(internal->gamma_E));
  SET_VECTOR_ELT(contents, 346, ScalarReal(internal->gamma_hosp_D));
  SET_VECTOR_ELT(contents, 347, ScalarReal(internal->gamma_hosp_R));
  SET_VECTOR_ELT(contents, 348, ScalarReal(internal->gamma_ICU_D));
  SET_VECTOR_ELT(contents, 349, ScalarReal(internal->gamma_ICU_R));
  SET_VECTOR_ELT(contents, 350, ScalarReal(internal->gamma_ILI));
  SET_VECTOR_ELT(contents, 351, ScalarReal(internal->gamma_mild));
  SET_VECTOR_ELT(contents, 352, ScalarReal(internal->gamma_stepdown));
  SET_VECTOR_ELT(contents, 353, ScalarReal(internal->gamma_triage));
  SET_VECTOR_ELT(contents, 354, ScalarReal(internal->hosp_transmission));
  SEXP I_with_diff_trans = PROTECT(allocVector(REALSXP, internal->dim_I_with_diff_trans));
  memcpy(REAL(I_with_diff_trans), internal->I_with_diff_trans, internal->dim_I_with_diff_trans * sizeof(double));
  odin_set_dim(I_with_diff_trans, 2, internal->dim_I_with_diff_trans_1, internal->dim_I_with_diff_trans_2);
  SET_VECTOR_ELT(contents, 355, I_with_diff_trans);
  SEXP I0_asympt = PROTECT(allocVector(REALSXP, internal->dim_I0_asympt));
  memcpy(REAL(I0_asympt), internal->I0_asympt, internal->dim_I0_asympt * sizeof(double));
  odin_set_dim(I0_asympt, 3, internal->dim_I0_asympt_1, internal->dim_I0_asympt_2, internal->dim_I0_asympt_3);
  SET_VECTOR_ELT(contents, 356, I0_asympt);
  ...
  SET_VECTOR_ELT(contents, 357, I0_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 358, I0_hosp_R);
  ...
  SET_VECTOR_ELT(contents, 359, I0_ICU_D);
  ...
  SET_VECTOR_ELT(contents, 360, I0_ICU_R);
  SEXP I0_ILI = PROTECT(allocVector(REALSXP, internal->dim_I0_ILI));
  memcpy(REAL(I0_ILI), internal->I0_ILI, internal->dim_I0_ILI * sizeof(double));
  odin_set_dim(I0_ILI, 3, internal->dim_I0_ILI_1, internal->dim_I0_ILI_2, internal->dim_I0_ILI_3);
  SET_VECTOR_ELT(contents, 361, I0_ILI);
  SEXP I0_mild = PROTECT(allocVector(REALSXP, internal->dim_I0_mild));
  memcpy(REAL(I0_mild), internal->I0_mild, internal->dim_I0_mild * sizeof(double));
  odin_set_dim(I0_mild, 3, internal->dim_I0_mild_1, internal->dim_I0_mild_2, internal->dim_I0_mild_3);
  SET_VECTOR_ELT(contents, 362, I0_mild);
  ...
  SET_VECTOR_ELT(contents, 363, I0_triage);
  SET_VECTOR_ELT(contents, 364, ScalarReal(internal->ICU_transmission));
  SEXP initial_D = PROTECT(allocVector(REALSXP, internal->dim_D));
  memcpy(REAL(initial_D), internal->initial_D, internal->dim_D * sizeof(double));
  SET_VECTOR_ELT(contents, 365, initial_D);
  SEXP initial_E = PROTECT(allocVector(REALSXP, internal->dim_E));
  memcpy(REAL(initial_E), internal->initial_E, internal->dim_E * sizeof(double));
  odin_set_dim(initial_E, 3, internal->dim_E_1, internal->dim_E_2, internal->dim_E_3);
  SET_VECTOR_ELT(contents, 366, initial_E);
  SEXP initial_I_asympt = PROTECT(allocVector(REALSXP, internal->dim_I_asympt));
  memcpy(REAL(initial_I_asympt), internal->initial_I_asympt, internal->dim_I_asympt * sizeof(double));
  odin_set_dim(initial_I_asympt, 3, internal->dim_I_asympt_1, internal->dim_I_asympt_2, internal->dim_I_asympt_3);
  SET_VECTOR_ELT(contents, 367, initial_I_asympt);
  ...
  SET_VECTOR_ELT(contents, 368, initial_I_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 369, initial_I_hosp_R);
  ...
  SET_VECTOR_ELT(contents, 370, initial_I_ICU_D);
  ...
  SET_VECTOR_ELT(contents, 371, initial_I_ICU_R);
  SEXP initial_I_ILI = PROTECT(allocVector(REALSXP, internal->dim_I_ILI));
  memcpy(REAL(initial_I_ILI), internal->initial_I_ILI, internal->dim_I_ILI * sizeof(double));
  odin_set_dim(initial_I_ILI, 3, internal->dim_I_ILI_1, internal->dim_I_ILI_2, internal->dim_I_ILI_3);
  SET_VECTOR_ELT(contents, 372, initial_I_ILI);
  SEXP initial_I_mild = PROTECT(allocVector(REALSXP, internal->dim_I_mild));
  memcpy(REAL(initial_I_mild), internal->initial_I_mild, internal->dim_I_mild * sizeof(double));
  odin_set_dim(initial_I_mild, 3, internal->dim_I_mild_1, internal->dim_I_mild_2, internal->dim_I_mild_3);
  SET_VECTOR_ELT(contents, 373, initial_I_mild);
  ...
  SET_VECTOR_ELT(contents, 374, initial_I_triage);
  SEXP initial_R = PROTECT(allocVector(REALSXP, internal->dim_R));
  memcpy(REAL(initial_R), internal->initial_R, internal->dim_R * sizeof(double));
  SET_VECTOR_ELT(contents, 375, initial_R);
  ...
  SET_VECTOR_ELT(contents, 376, initial_R_stepdown);
  SEXP initial_S = PROTECT(allocVector(REALSXP, internal->dim_S));
  memcpy(REAL(initial_S), internal->initial_S, internal->dim_S * sizeof(double));
  SET_VECTOR_ELT(contents, 377, initial_S);
  SET_VECTOR_ELT(contents, 378, ScalarReal(internal->initial_x));
  SEXP lambda = PROTECT(allocVector(REALSXP, internal->dim_lambda));
  memcpy(REAL(lambda), internal->lambda, internal->dim_lambda * sizeof(double));
  SET_VECTOR_ELT(contents, 379, lambda);
  SEXP m = PROTECT(allocVector(REALSXP, internal->dim_m));
  memcpy(REAL(m), internal->m, internal->dim_m * sizeof(double));
  odin_set_dim(m, 2, internal->dim_m_1, internal->dim_m_2);
  SET_VECTOR_ELT(contents, 380, m);
  SET_VECTOR_ELT(contents, 381, ScalarInteger(internal->N_age));
  SEXP n_EE = PROTECT(allocVector(REALSXP, internal->dim_n_EE));
  memcpy(REAL(n_EE), internal->n_EE, internal->dim_n_EE * sizeof(double));
  odin_set_dim(n_EE, 3, internal->dim_n_EE_1, internal->dim_n_EE_2, internal->dim_n_EE_3);
  SET_VECTOR_ELT(contents, 382, n_EE);
  SEXP n_EI_asympt = PROTECT(allocVector(REALSXP, internal->dim_n_EI_asympt));
  memcpy(REAL(n_EI_asympt), internal->n_EI_asympt, internal->dim_n_EI_asympt * sizeof(double));
  odin_set_dim(n_EI_asympt, 2, internal->dim_n_EI_asympt_1, internal->dim_n_EI_asympt_2);
  SET_VECTOR_ELT(contents, 383, n_EI_asympt);
  SEXP n_EI_ILI = PROTECT(allocVector(REALSXP, internal->dim_n_EI_ILI));
  memcpy(REAL(n_EI_ILI), internal->n_EI_ILI, internal->dim_n_EI_ILI * sizeof(double));
  odin_set_dim(n_EI_ILI, 2, internal->dim_n_EI_ILI_1, internal->dim_n_EI_ILI_2);
  SET_VECTOR_ELT(contents, 384, n_EI_ILI);
  SEXP n_EI_mild = PROTECT(allocVector(REALSXP, internal->dim_n_EI_mild));
  memcpy(REAL(n_EI_mild), internal->n_EI_mild, internal->dim_n_EI_mild * sizeof(double));
  odin_set_dim(n_EI_mild, 2, internal->dim_n_EI_mild_1, internal->dim_n_EI_mild_2);
  SET_VECTOR_ELT(contents, 385, n_EI_mild);
  ...
  SET_VECTOR_ELT(contents, 386, n_hosp_non_ICU);
  ...
  SET_VECTOR_ELT(contents, 387, n_ICU_to_R_stepdown);
  SEXP n_II_asympt = PROTECT(allocVector(REALSXP, internal->dim_n_II_asympt));
  memcpy(REAL(n_II_asympt), internal->n_II_asympt, internal->dim_n_II_asympt * sizeof(double));
  odin_set_dim(n_II_asympt, 3, internal->dim_n_II_asympt_1, internal->dim_n_II_asympt_2, internal->dim_n_II_asympt_3);
  SET_VECTOR_ELT(contents, 388, n_II_asympt);
  ...
  SET_VECTOR_ELT(contents, 389, n_II_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 390, n_II_hosp_R);
  ...
  SET_VECTOR_ELT(contents, 391, n_II_ICU_D);
  ...
  SET_VECTOR_ELT(contents, 392, n_II_ICU_R);
  SEXP n_II_ILI = PROTECT(allocVector(REALSXP, internal->dim_n_II_ILI));
  memcpy(REAL(n_II_ILI), internal->n_II_ILI, internal->dim_n_II_ILI * sizeof(double));
  odin_set_dim(n_II_ILI, 3, internal->dim_n_II_ILI_1, internal->dim_n_II_ILI_2, internal->dim_n_II_ILI_3);
  SET_VECTOR_ELT(contents, 393, n_II_ILI);
  SEXP n_II_mild = PROTECT(allocVector(REALSXP, internal->dim_n_II_mild));
  memcpy(REAL(n_II_mild), internal->n_II_mild, internal->dim_n_II_mild * sizeof(double));
  odin_set_dim(n_II_mild, 3, internal->dim_n_II_mild_1, internal->dim_n_II_mild_2, internal->dim_n_II_mild_3);
  SET_VECTOR_ELT(contents, 394, n_II_mild);
  ...
  SET_VECTOR_ELT(contents, 395, n_II_triage);
  SEXP n_ILI_to_hosp = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_hosp));
  memcpy(REAL(n_ILI_to_hosp), internal->n_ILI_to_hosp, internal->dim_n_ILI_to_hosp * sizeof(double));
  odin_set_dim(n_ILI_to_hosp, 2, internal->dim_n_ILI_to_hosp_1, internal->dim_n_ILI_to_hosp_2);
  SET_VECTOR_ELT(contents, 396, n_ILI_to_hosp);
  ...
  SET_VECTOR_ELT(contents, 397, n_ILI_to_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 398, n_ILI_to_hosp_R);
  ...
  SET_VECTOR_ELT(contents, 399, n_ILI_to_triage);
  ...
  SET_VECTOR_ELT(contents, 400, n_R_stepdown);
  SEXP n_SE = PROTECT(allocVector(REALSXP, internal->dim_n_SE));
  memcpy(REAL(n_SE), internal->n_SE, internal->dim_n_SE * sizeof(double));
  SET_VECTOR_ELT(contents, 401, n_SE);
  ...
  SET_VECTOR_ELT(contents, 402, n_triage_to_ICU_D);
  ...
  SET_VECTOR_ELT(contents, 403, n_triage_to_ICU_R);
  SET_VECTOR_ELT(contents, 404, ScalarInteger(internal->offset_output_n_EI_ILI));
  SET_VECTOR_ELT(contents, 405, ScalarInteger(internal->offset_output_n_EI_mild));
  SET_VECTOR_ELT(contents, 406, ScalarInteger(internal->offset_output_n_ILI_to_hosp));
  SET_VECTOR_ELT(contents, 407, ScalarInteger(internal->offset_output_n_ILI_to_hosp_D));
  SET_VECTOR_ELT(contents, 408, ScalarInteger(internal->offset_output_n_ILI_to_hosp_R));
  SET_VECTOR_ELT(contents, 409, ScalarInteger(internal->offset_output_n_triage_to_ICU_D));
  SET_VECTOR_ELT(contents, 410, ScalarInteger(internal->offset_output_n_triage_to_ICU_R));
  SET_VECTOR_ELT(contents, 411, ScalarInteger(internal->offset_variable_D));
  SET_VECTOR_ELT(contents, 412, ScalarInteger(internal->offset_variable_E));
  SET_VECTOR_ELT(contents, 413, ScalarInteger(internal->offset_variable_I_asympt));
  SET_VECTOR_ELT(contents, 414, ScalarInteger(internal->offset_variable_I_hosp_D));
  SET_VECTOR_ELT(contents, 415, ScalarInteger(internal->offset_variable_I_hosp_R));
  SET_VECTOR_ELT(contents, 416, ScalarInteger(internal->offset_variable_I_ICU_D));
  SET_VECTOR_ELT(contents, 417, ScalarInteger(internal->offset_variable_I_ICU_R));
  SET_VECTOR_ELT(contents, 418, ScalarInteger(internal->offset_variable_I_ILI));
  SET_VECTOR_ELT(contents, 419, ScalarInteger(internal->offset_variable_I_mild));
  SET_VECTOR_ELT(contents, 420, ScalarInteger(internal->offset_variable_I_triage));
  SET_VECTOR_ELT(contents, 421, ScalarInteger(internal->offset_variable_R));
  SET_VECTOR_ELT(contents, 422, ScalarInteger(internal->offset_variable_R_stepdown));
  SEXP p_asympt = PROTECT(allocVector(REALSXP, internal->dim_p_asympt));
  memcpy(REAL(p_asympt), internal->p_asympt, internal->dim_p_asympt * sizeof(double));
  SET_VECTOR_ELT(contents, 423, p_asympt);
  ...
  SET_VECTOR_ELT(contents, 424, p_death_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 425, p_death_ICU);
  SET_VECTOR_ELT(contents, 426, ScalarReal(internal->p_EE));
  ...
  SET_VECTOR_ELT(contents, 427, p_ICU_hosp);
  SET_VECTOR_ELT(contents, 428, ScalarReal(internal->p_II_asympt));
  SET_VECTOR_ELT(contents, 429, ScalarReal(internal->p_II_hosp_D));
  SET_VECTOR_ELT(contents, 430, ScalarReal(internal->p_II_hosp_R));
  SET_VECTOR_ELT(contents, 431, ScalarReal(internal->p_II_ICU_D));
  SET_VECTOR_ELT(contents, 432, ScalarReal(internal->p_II_ICU_R));
  SET_VECTOR_ELT(contents, 433, ScalarReal(internal->p_II_ILI));
  SET_VECTOR_ELT(contents, 434, ScalarReal(internal->p_II_mild));
  SET_VECTOR_ELT(contents, 435, ScalarReal(internal->p_II_triage));
  SET_VECTOR_ELT(contents, 436, ScalarReal(internal->p_R_stepdown));
  SEXP p_recov_ILI = PROTECT(allocVector(REALSXP, internal->dim_p_recov_ILI));
  memcpy(REAL(p_recov_ILI), internal->p_recov_ILI, internal->dim_p_recov_ILI * sizeof(double));
  SET_VECTOR_ELT(contents, 437, p_recov_ILI);
  SEXP p_SE = PROTECT(allocVector(REALSXP, internal->dim_p_SE));
  memcpy(REAL(p_SE), internal->p_SE, internal->dim_p_SE * sizeof(double));
  SET_VECTOR_ELT(contents, 438, p_SE);
  SEXP p_sympt_ILI = PROTECT(allocVector(REALSXP, internal->dim_p_sympt_ILI));
  memcpy(REAL(p_sympt_ILI), internal->p_sympt_ILI, internal->dim_p_sympt_ILI * sizeof(double));
  SET_VECTOR_ELT(contents, 439, p_sympt_ILI);
  SEXP R0 = PROTECT(allocVector(REALSXP, internal->dim_R0));
  memcpy(REAL(R0), internal->R0, internal->dim_R0 * sizeof(double));
  SET_VECTOR_ELT(contents, 440, R0);
  ...
  SET_VECTOR_ELT(contents, 441, R0_stepdown);
  SET_VECTOR_ELT(contents, 442, ScalarInteger(internal->s_asympt));
  SET_VECTOR_ELT(contents, 443, ScalarInteger(internal->s_E));
  SET_VECTOR_ELT(contents, 444, ScalarInteger(internal->s_hosp_D));
  SET_VECTOR_ELT(contents, 445, ScalarInteger(internal->s_hosp_R));
  SET_VECTOR_ELT(contents, 446, ScalarInteger(internal->s_ICU_D));
  SET_VECTOR_ELT(contents, 447, ScalarInteger(internal->s_ICU_R));
  SEXP s_ij = PROTECT(allocVector(REALSXP, internal->dim_s_ij));
  memcpy(REAL(s_ij), internal->s_ij, internal->dim_s_ij * sizeof(double));
  odin_set_dim(s_ij, 2, internal->dim_s_ij_1, internal->dim_s_ij_2);
  SET_VECTOR_ELT(contents, 448, s_ij);
  SET_VECTOR_ELT(contents, 449, ScalarInteger(internal->s_ILI));
  SET_VECTOR_ELT(contents, 450, ScalarInteger(internal->s_mild));
  SET_VECTOR_ELT(contents, 451, ScalarInteger(internal->s_stepdown));
  SET_VECTOR_ELT(contents, 452, ScalarInteger(internal->s_triage));
  SEXP S0 = PROTECT(allocVector(REALSXP, internal->dim_S0));
  memcpy(REAL(S0), internal->S0, internal->dim_S0 * sizeof(double));
  SET_VECTOR_ELT(contents, 453, S0);
  SET_VECTOR_ELT(contents, 454, ScalarReal(internal->sd_x));
  SET_VECTOR_ELT(contents, 455, ScalarInteger(internal->trans_classes));
  SEXP trans_increase = PROTECT(allocVector(REALSXP, internal->dim_trans_increase));
  memcpy(REAL(trans_increase), internal->trans_increase, internal->dim_trans_increase * sizeof(double));
  odin_set_dim(trans_increase, 2, internal->dim_trans_increase_1, internal->dim_trans_increase_2);
  SET_VECTOR_ELT(contents, 456, trans_increase);
  SEXP trans_profile = PROTECT(allocVector(REALSXP, internal->dim_trans_profile));
  memcpy(REAL(trans_profile), internal->trans_profile, internal->dim_trans_profile * sizeof(double));
  odin_set_dim(trans_profile, 2, internal->dim_trans_profile_1, internal->dim_trans_profile_2);
  SET_VECTOR_ELT(contents, 457, trans_profile);
  SET_VECTOR_ELT(contents, 458, ScalarReal(internal->x0));
  SEXP nms = PROTECT(allocVector(STRSXP, 459));
  SET_STRING_ELT(nms, 0, mkChar("aux_EE"));
  SET_STRING_ELT(nms, 1, mkChar("aux_II_asympt"));
  ...
  SET_STRING_ELT(nms, 11, mkChar("D0"));
  SET_STRING_ELT(nms, 12, mkChar("delta_D"));
  SET_STRING_ELT(nms, 13, mkChar("delta_E"));
  SET_STRING_ELT(nms, 14, mkChar("delta_I_asympt"));
  SET_STRING_ELT(nms, 15, mkChar("delta_I_hosp_D"));
  SET_STRING_ELT(nms, 16, mkChar("delta_I_hosp_R"));
  SET_STRING_ELT(nms, 17, mkChar("delta_I_ICU_D"));
  SET_STRING_ELT(nms, 18, mkChar("delta_I_ICU_R"));
  SET_STRING_ELT(nms, 19, mkChar("delta_I_ILI"));
  SET_STRING_ELT(nms, 20, mkChar("delta_I_mild"));
  SET_STRING_ELT(nms, 21, mkChar("delta_I_triage"));
  SET_STRING_ELT(nms, 22, mkChar("delta_R"));
  SET_STRING_ELT(nms, 23, mkChar("delta_R_stepdown"));
  SET_STRING_ELT(nms, 24, mkChar("dim_aux_EE"));
  SET_STRING_ELT(nms, 25, mkChar("dim_aux_EE_1"));
  SET_STRING_ELT(nms, 26, mkChar("dim_aux_EE_12"));
  SET_STRING_ELT(nms, 27, mkChar("dim_aux_EE_2"));
  SET_STRING_ELT(nms, 28, mkChar("dim_aux_EE_3"));
  SET_STRING_ELT(nms, 29, mkChar("dim_aux_II_asympt"));
  SET_STRING_ELT(nms, 30, mkChar("dim_aux_II_asympt_1"));
  SET_STRING_ELT(nms, 31, mkChar("dim_aux_II_asympt_12"));
  SET_STRING_ELT(nms, 32, mkChar("dim_aux_II_asympt_2"));
  SET_STRING_ELT(nms, 33, mkChar("dim_aux_II_asympt_3"));
  SET_STRING_ELT(nms, 34, mkChar("dim_aux_II_hosp_D"));
  SET_STRING_ELT(nms, 35, mkChar("dim_aux_II_hosp_D_1"));
  SET_STRING_ELT(nms, 36, mkChar("dim_aux_II_hosp_D_12"));
  SET_STRING_ELT(nms, 37, mkChar("dim_aux_II_hosp_D_2"));
  SET_STRING_ELT(nms, 38, mkChar("dim_aux_II_hosp_D_3"));
  SET_STRING_ELT(nms, 39, mkChar("dim_aux_II_hosp_R"));
  SET_STRING_ELT(nms, 40, mkChar("dim_aux_II_hosp_R_1"));
  SET_STRING_ELT(nms, 41, mkChar("dim_aux_II_hosp_R_12"));
  SET_STRING_ELT(nms, 42, mkChar("dim_aux_II_hosp_R_2"));
  SET_STRING_ELT(nms, 43, mkChar("dim_aux_II_hosp_R_3"));
  SET_STRING_ELT(nms, 44, mkChar("dim_aux_II_ICU_D"));
  SET_STRING_ELT(nms, 45, mkChar("dim_aux_II_ICU_D_1"));
  SET_STRING_ELT(nms, 46, mkChar("dim_aux_II_ICU_D_12"));
  SET_STRING_ELT(nms, 47, mkChar("dim_aux_II_ICU_D_2"));
  SET_STRING_ELT(nms, 48, mkChar("dim_aux_II_ICU_D_3"));
  SET_STRING_ELT(nms, 49, mkChar("dim_aux_II_ICU_R"));
  SET_STRING_ELT(nms, 50, mkChar("dim_aux_II_ICU_R_1"));
  SET_STRING_ELT(nms, 51, mkChar("dim_aux_II_ICU_R_12"));
  SET_STRING_ELT(nms, 52, mkChar("dim_aux_II_ICU_R_2"));
  SET_STRING_ELT(nms, 53, mkChar("dim_aux_II_ICU_R_3"));
  SET_STRING_ELT(nms, 54, mkChar("dim_aux_II_ILI"));
  SET_STRING_ELT(nms, 55, mkChar("dim_aux_II_ILI_1"));
  SET_STRING_ELT(nms, 56, mkChar("dim_aux_II_ILI_12"));
  SET_STRING_ELT(nms, 57, mkChar("dim_aux_II_ILI_2"));
  SET_STRING_ELT(nms, 58, mkChar("dim_aux_II_ILI_3"));
  SET_STRING_ELT(nms, 59, mkChar("dim_aux_II_mild"));
  SET_STRING_ELT(nms, 60, mkChar("dim_aux_II_mild_1"));
  SET_STRING_ELT(nms, 61, mkChar("dim_aux_II_mild_12"));
  SET_STRING_ELT(nms, 62, mkChar("dim_aux_II_mild_2"));
  SET_STRING_ELT(nms, 63, mkChar("dim_aux_II_mild_3"));
  SET_STRING_ELT(nms, 64, mkChar("dim_aux_II_triage"));
  SET_STRING_ELT(nms, 65, mkChar("dim_aux_II_triage_1"));
  SET_STRING_ELT(nms, 66, mkChar("dim_aux_II_triage_12"));
  SET_STRING_ELT(nms, 67, mkChar("dim_aux_II_triage_2"));
  SET_STRING_ELT(nms, 68, mkChar("dim_aux_II_triage_3"));
  SET_STRING_ELT(nms, 69, mkChar("dim_aux_p_bin"));
  SET_STRING_ELT(nms, 70, mkChar("dim_aux_p_bin_1"));
  SET_STRING_ELT(nms, 71, mkChar("dim_aux_p_bin_2"));
  SET_STRING_ELT(nms, 72, mkChar("dim_aux_R_stepdown"));
  SET_STRING_ELT(nms, 73, mkChar("dim_aux_R_stepdown_1"));
  SET_STRING_ELT(nms, 74, mkChar("dim_aux_R_stepdown_12"));
  SET_STRING_ELT(nms, 75, mkChar("dim_aux_R_stepdown_2"));
  SET_STRING_ELT(nms, 76, mkChar("dim_aux_R_stepdown_3"));
  SET_STRING_ELT(nms, 77, mkChar("dim_D"));
  SET_STRING_ELT(nms, 78, mkChar("dim_D0"));
  SET_STRING_ELT(nms, 79, mkChar("dim_delta_D"));
  SET_STRING_ELT(nms, 80, mkChar("dim_delta_E"));
  SET_STRING_ELT(nms, 81, mkChar("dim_delta_E_1"));
  SET_STRING_ELT(nms, 82, mkChar("dim_delta_E_12"));
  SET_STRING_ELT(nms, 83, mkChar("dim_delta_E_2"));
  SET_STRING_ELT(nms, 84, mkChar("dim_delta_E_3"));
  SET_STRING_ELT(nms, 85, mkChar("dim_delta_I_asympt"));
  SET_STRING_ELT(nms, 86, mkChar("dim_delta_I_asympt_1"));
  SET_STRING_ELT(nms, 87, mkChar("dim_delta_I_asympt_12"));
  SET_STRING_ELT(nms, 88, mkChar("dim_delta_I_asympt_2"));
  SET_STRING_ELT(nms, 89, mkChar("dim_delta_I_asympt_3"));
  SET_STRING_ELT(nms, 90, mkChar("dim_delta_I_hosp_D"));
  SET_STRING_ELT(nms, 91, mkChar("dim_delta_I_hosp_D_1"));
  SET_STRING_ELT(nms, 92, mkChar("dim_delta_I_hosp_D_12"));
  SET_STRING_ELT(nms, 93, mkChar("dim_delta_I_hosp_D_2"));
  SET_STRING_ELT(nms, 94, mkChar("dim_delta_I_hosp_D_3"));
  SET_STRING_ELT(nms, 95, mkChar("dim_delta_I_hosp_R"));
  SET_STRING_ELT(nms, 96, mkChar("dim_delta_I_hosp_R_1"));
  SET_STRING_ELT(nms, 97, mkChar("dim_delta_I_hosp_R_12"));
  SET_STRING_ELT(nms, 98, mkChar("dim_delta_I_hosp_R_2"));
  SET_STRING_ELT(nms, 99, mkChar("dim_delta_I_hosp_R_3"));
  SET_STRING_ELT(nms, 100, mkChar("dim_delta_I_ICU_D"));
  SET_STRING_ELT(nms, 101, mkChar("dim_delta_I_ICU_D_1"));
  SET_STRING_ELT(nms, 102, mkChar("dim_delta_I_ICU_D_12"));
  SET_STRING_ELT(nms, 103, mkChar("dim_delta_I_ICU_D_2"));
  SET_STRING_ELT(nms, 104, mkChar("dim_delta_I_ICU_D_3"));
  SET_STRING_ELT(nms, 105, mkChar("dim_delta_I_ICU_R"));
  SET_STRING_ELT(nms, 106, mkChar("dim_delta_I_ICU_R_1"));
  SET_STRING_ELT(nms, 107, mkChar("dim_delta_I_ICU_R_12"));
  SET_STRING_ELT(nms, 108, mkChar("dim_delta_I_ICU_R_2"));
  SET_STRING_ELT(nms, 109, mkChar("dim_delta_I_ICU_R_3"));
  SET_STRING_ELT(nms, 110, mkChar("dim_delta_I_ILI"));
  SET_STRING_ELT(nms, 111, mkChar("dim_delta_I_ILI_1"));
  SET_STRING_ELT(nms, 112, mkChar("dim_delta_I_ILI_12"));
  SET_STRING_ELT(nms, 113, mkChar("dim_delta_I_ILI_2"));
  SET_STRING_ELT(nms, 114, mkChar("dim_delta_I_ILI_3"));
  SET_STRING_ELT(nms, 115, mkChar("dim_delta_I_mild"));
  SET_STRING_ELT(nms, 116, mkChar("dim_delta_I_mild_1"));
  SET_STRING_ELT(nms, 117, mkChar("dim_delta_I_mild_12"));
  SET_STRING_ELT(nms, 118, mkChar("dim_delta_I_mild_2"));
  SET_STRING_ELT(nms, 119, mkChar("dim_delta_I_mild_3"));
  SET_STRING_ELT(nms, 120, mkChar("dim_delta_I_triage"));
  SET_STRING_ELT(nms, 121, mkChar("dim_delta_I_triage_1"));
  SET_STRING_ELT(nms, 122, mkChar("dim_delta_I_triage_12"));
  SET_STRING_ELT(nms, 123, mkChar("dim_delta_I_triage_2"));
  SET_STRING_ELT(nms, 124, mkChar("dim_delta_I_triage_3"));
  SET_STRING_ELT(nms, 125, mkChar("dim_delta_R"));
  SET_STRING_ELT(nms, 126, mkChar("dim_delta_R_stepdown"));
  SET_STRING_ELT(nms, 127, mkChar("dim_delta_R_stepdown_1"));
  SET_STRING_ELT(nms, 128, mkChar("dim_delta_R_stepdown_12"));
  SET_STRING_ELT(nms, 129, mkChar("dim_delta_R_stepdown_2"));
  SET_STRING_ELT(nms, 130, mkChar("dim_delta_R_stepdown_3"));
  SET_STRING_ELT(nms, 131, mkChar("dim_E"));
  SET_STRING_ELT(nms, 132, mkChar("dim_E_1"));
  SET_STRING_ELT(nms, 133, mkChar("dim_E_12"));
  SET_STRING_ELT(nms, 134, mkChar("dim_E_2"));
  SET_STRING_ELT(nms, 135, mkChar("dim_E_3"));
  SET_STRING_ELT(nms, 136, mkChar("dim_E0"));
  SET_STRING_ELT(nms, 137, mkChar("dim_E0_1"));
  SET_STRING_ELT(nms, 138, mkChar("dim_E0_12"));
  SET_STRING_ELT(nms, 139, mkChar("dim_E0_2"));
  SET_STRING_ELT(nms, 140, mkChar("dim_E0_3"));
  SET_STRING_ELT(nms, 141, mkChar("dim_I_asympt"));
  SET_STRING_ELT(nms, 142, mkChar("dim_I_asympt_1"));
  SET_STRING_ELT(nms, 143, mkChar("dim_I_asympt_12"));
  SET_STRING_ELT(nms, 144, mkChar("dim_I_asympt_2"));
  SET_STRING_ELT(nms, 145, mkChar("dim_I_asympt_3"));
  SET_STRING_ELT(nms, 146, mkChar("dim_I_hosp_D"));
  SET_STRING_ELT(nms, 147, mkChar("dim_I_hosp_D_1"));
  SET_STRING_ELT(nms, 148, mkChar("dim_I_hosp_D_12"));
  SET_STRING_ELT(nms, 149, mkChar("dim_I_hosp_D_2"));
  SET_STRING_ELT(nms, 150, mkChar("dim_I_hosp_D_3"));
  SET_STRING_ELT(nms, 151, mkChar("dim_I_hosp_R"));
  SET_STRING_ELT(nms, 152, mkChar("dim_I_hosp_R_1"));
  SET_STRING_ELT(nms, 153, mkChar("dim_I_hosp_R_12"));
  SET_STRING_ELT(nms, 154, mkChar("dim_I_hosp_R_2"));
  SET_STRING_ELT(nms, 155, mkChar("dim_I_hosp_R_3"));
  SET_STRING_ELT(nms, 156, mkChar("dim_I_ICU_D"));
  SET_STRING_ELT(nms, 157, mkChar("dim_I_ICU_D_1"));
  SET_STRING_ELT(nms, 158, mkChar("dim_I_ICU_D_12"));
  SET_STRING_ELT(nms, 159, mkChar("dim_I_ICU_D_2"));
  SET_STRING_ELT(nms, 160, mkChar("dim_I_ICU_D_3"));
  SET_STRING_ELT(nms, 161, mkChar("dim_I_ICU_R"));
  SET_STRING_ELT(nms, 162, mkChar("dim_I_ICU_R_1"));
  SET_STRING_ELT(nms, 163, mkChar("dim_I_ICU_R_12"));
  SET_STRING_ELT(nms, 164, mkChar("dim_I_ICU_R_2"));
  SET_STRING_ELT(nms, 165, mkChar("dim_I_ICU_R_3"));
  SET_STRING_ELT(nms, 166, mkChar("dim_I_ILI"));
  SET_STRING_ELT(nms, 167, mkChar("dim_I_ILI_1"));
  SET_STRING_ELT(nms, 168, mkChar("dim_I_ILI_12"));
  SET_STRING_ELT(nms, 169, mkChar("dim_I_ILI_2"));
  SET_STRING_ELT(nms, 170, mkChar("dim_I_ILI_3"));
  SET_STRING_ELT(nms, 171, mkChar("dim_I_mild"));
  SET_STRING_ELT(nms, 172, mkChar("dim_I_mild_1"));
  SET_STRING_ELT(nms, 173, mkChar("dim_I_mild_12"));
  SET_STRING_ELT(nms, 174, mkChar("dim_I_mild_2"));
  SET_STRING_ELT(nms, 175, mkChar("dim_I_mild_3"));
  SET_STRING_ELT(nms, 176, mkChar("dim_I_triage"));
  SET_STRING_ELT(nms, 177, mkChar("dim_I_triage_1"));
  SET_STRING_ELT(nms, 178, mkChar("dim_I_triage_12"));
  SET_STRING_ELT(nms, 179, mkChar("dim_I_triage_2"));
  SET_STRING_ELT(nms, 180, mkChar("dim_I_triage_3"));
  SET_STRING_ELT(nms, 181, mkChar("dim_I_with_diff_trans"));
  SET_STRING_ELT(nms, 182, mkChar("dim_I_with_diff_trans_1"));
  SET_STRING_ELT(nms, 183, mkChar("dim_I_with_diff_trans_2"));
  SET_STRING_ELT(nms, 184, mkChar("dim_I0_asympt"));
  SET_STRING_ELT(nms, 185, mkChar("dim_I0_asympt_1"));
  SET_STRING_ELT(nms, 186, mkChar("dim_I0_asympt_12"));
  SET_STRING_ELT(nms, 187, mkChar("dim_I0_asympt_2"));
  SET_STRING_ELT(nms, 188, mkChar("dim_I0_asympt_3"));
  SET_STRING_ELT(nms, 189, mkChar("dim_I0_hosp_D"));
  SET_STRING_ELT(nms, 190, mkChar("dim_I0_hosp_D_1"));
  SET_STRING_ELT(nms, 191, mkChar("dim_I0_hosp_D_12"));
  SET_STRING_ELT(nms, 192, mkChar("dim_I0_hosp_D_2"));
  SET_STRING_ELT(nms, 193, mkChar("dim_I0_hosp_D_3"));
  SET_STRING_ELT(nms, 194, mkChar("dim_I0_hosp_R"));
  SET_STRING_ELT(nms, 195, mkChar("dim_I0_hosp_R_1"));
  SET_STRING_ELT(nms, 196, mkChar("dim_I0_hosp_R_12"));
  SET_STRING_ELT(nms, 197, mkChar("dim_I0_hosp_R_2"));
  SET_STRING_ELT(nms, 198, mkChar("dim_I0_hosp_R_3"));
  SET_STRING_ELT(nms, 199, mkChar("dim_I0_ICU_D"));
  SET_STRING_ELT(nms, 200, mkChar("dim_I0_ICU_D_1"));
  SET_STRING_ELT(nms, 201, mkChar("dim_I0_ICU_D_12"));
  SET_STRING_ELT(nms, 202, mkChar("dim_I0_ICU_D_2"));
  SET_STRING_ELT(nms, 203, mkChar("dim_I0_ICU_D_3"));
  SET_STRING_ELT(nms, 204, mkChar("dim_I0_ICU_R"));
  SET_STRING_ELT(nms, 205, mkChar("dim_I0_ICU_R_1"));
  SET_STRING_ELT(nms, 206, mkChar("dim_I0_ICU_R_12"));
  SET_STRING_ELT(nms, 207, mkChar("dim_I0_ICU_R_2"));
  SET_STRING_ELT(nms, 208, mkChar("dim_I0_ICU_R_3"));
  SET_STRING_ELT(nms, 209, mkChar("dim_I0_ILI"));
  SET_STRING_ELT(nms, 210, mkChar("dim_I0_ILI_1"));
  SET_STRING_ELT(nms, 211, mkChar("dim_I0_ILI_12"));
  SET_STRING_ELT(nms, 212, mkChar("dim_I0_ILI_2"));
  SET_STRING_ELT(nms, 213, mkChar("dim_I0_ILI_3"));
  SET_STRING_ELT(nms, 214, mkChar("dim_I0_mild"));
  SET_STRING_ELT(nms, 215, mkChar("dim_I0_mild_1"));
  SET_STRING_ELT(nms, 216, mkChar("dim_I0_mild_12"));
  SET_STRING_ELT(nms, 217, mkChar("dim_I0_mild_2"));
  SET_STRING_ELT(nms, 218, mkChar("dim_I0_mild_3"));
  SET_STRING_ELT(nms, 219, mkChar("dim_I0_triage"));
  SET_STRING_ELT(nms, 220, mkChar("dim_I0_triage_1"));
  SET_STRING_ELT(nms, 221, mkChar("dim_I0_triage_12"));
  SET_STRING_ELT(nms, 222, mkChar("dim_I0_triage_2"));
  SET_STRING_ELT(nms, 223, mkChar("dim_I0_triage_3"));
  SET_STRING_ELT(nms, 224, mkChar("dim_lambda"));
  SET_STRING_ELT(nms, 225, mkChar("dim_m"));
  SET_STRING_ELT(nms, 226, mkChar("dim_m_1"));
  SET_STRING_ELT(nms, 227, mkChar("dim_m_2"));
  SET_STRING_ELT(nms, 228, mkChar("dim_n_EE"));
  SET_STRING_ELT(nms, 229, mkChar("dim_n_EE_1"));
  SET_STRING_ELT(nms, 230, mkChar("dim_n_EE_12"));
  SET_STRING_ELT(nms, 231, mkChar("dim_n_EE_2"));
  SET_STRING_ELT(nms, 232, mkChar("dim_n_EE_3"));
  SET_STRING_ELT(nms, 233, mkChar("dim_n_EI_asympt"));
  SET_STRING_ELT(nms, 234, mkChar("dim_n_EI_asympt_1"));
  SET_STRING_ELT(nms, 235, mkChar("dim_n_EI_asympt_2"));
  SET_STRING_ELT(nms, 236, mkChar("dim_n_EI_ILI"));
  SET_STRING_ELT(nms, 237, mkChar("dim_n_EI_ILI_1"));
  SET_STRING_ELT(nms, 238, mkChar("dim_n_EI_ILI_2"));
  SET_STRING_ELT(nms, 239, mkChar("dim_n_EI_mild"));
  SET_STRING_ELT(nms, 240, mkChar("dim_n_EI_mild_1"));
  SET_STRING_ELT(nms, 241, mkChar("dim_n_EI_mild_2"));
  SET_STRING_ELT(nms, 242, mkChar("dim_n_hosp_non_ICU"));
  SET_STRING_ELT(nms, 243, mkChar("dim_n_hosp_non_ICU_1"));
  SET_STRING_ELT(nms, 244, mkChar("dim_n_hosp_non_ICU_2"));
  SET_STRING_ELT(nms, 245, mkChar("dim_n_ICU_to_R_stepdown"));
  SET_STRING_ELT(nms, 246, mkChar("dim_n_ICU_to_R_stepdown_1"));
  SET_STRING_ELT(nms, 247, mkChar("dim_n_ICU_to_R_stepdown_2"));
  SET_STRING_ELT(nms, 248, mkChar("dim_n_II_asympt"));
  SET_STRING_ELT(nms, 249, mkChar("dim_n_II_asympt_1"));
  SET_STRING_ELT(nms, 250, mkChar("dim_n_II_asympt_12"));
  SET_STRING_ELT(nms, 251, mkChar("dim_n_II_asympt_2"));
  SET_STRING_ELT(nms, 252, mkChar("dim_n_II_asympt_3"));
  SET_STRING_ELT(nms, 253, mkChar("dim_n_II_hosp_D"));
  SET_STRING_ELT(nms, 254, mkChar("dim_n_II_hosp_D_1"));
  SET_STRING_ELT(nms, 255, mkChar("dim_n_II_hosp_D_12"));
  SET_STRING_ELT(nms, 256, mkChar("dim_n_II_hosp_D_2"));
  SET_STRING_ELT(nms, 257, mkChar("dim_n_II_hosp_D_3"));
  SET_STRING_ELT(nms, 258, mkChar("dim_n_II_hosp_R"));
  SET_STRING_ELT(nms, 259, mkChar("dim_n_II_hosp_R_1"));
  SET_STRING_ELT(nms, 260, mkChar("dim_n_II_hosp_R_12"));
  SET_STRING_ELT(nms, 261, mkChar("dim_n_II_hosp_R_2"));
  SET_STRING_ELT(nms, 262, mkChar("dim_n_II_hosp_R_3"));
  SET_STRING_ELT(nms, 263, mkChar("dim_n_II_ICU_D"));
  SET_STRING_ELT(nms, 264, mkChar("dim_n_II_ICU_D_1"));
  SET_STRING_ELT(nms, 265, mkChar("dim_n_II_ICU_D_12"));
  SET_STRING_ELT(nms, 266, mkChar("dim_n_II_ICU_D_2"));
  SET_STRING_ELT(nms, 267, mkChar("dim_n_II_ICU_D_3"));
  SET_STRING_ELT(nms, 268, mkChar("dim_n_II_ICU_R"));
  SET_STRING_ELT(nms, 269, mkChar("dim_n_II_ICU_R_1"));
  SET_STRING_ELT(nms, 270, mkChar("dim_n_II_ICU_R_12"));
  SET_STRING_ELT(nms, 271, mkChar("dim_n_II_ICU_R_2"));
  SET_STRING_ELT(nms, 272, mkChar("dim_n_II_ICU_R_3"));
  SET_STRING_ELT(nms, 273, mkChar("dim_n_II_ILI"));
  SET_STRING_ELT(nms, 274, mkChar("dim_n_II_ILI_1"));
  SET_STRING_ELT(nms, 275, mkChar("dim_n_II_ILI_12"));
  SET_STRING_ELT(nms, 276, mkChar("dim_n_II_ILI_2"));
  SET_STRING_ELT(nms, 277, mkChar("dim_n_II_ILI_3"));
  SET_STRING_ELT(nms, 278, mkChar("dim_n_II_mild"));
  SET_STRING_ELT(nms, 279, mkChar("dim_n_II_mild_1"));
  SET_STRING_ELT(nms, 280, mkChar("dim_n_II_mild_12"));
  SET_STRING_ELT(nms, 281, mkChar("dim_n_II_mild_2"));
  SET_STRING_ELT(nms, 282, mkChar("dim_n_II_mild_3"));
  SET_STRING_ELT(nms, 283, mkChar("dim_n_II_triage"));
  SET_STRING_ELT(nms, 284, mkChar("dim_n_II_triage_1"));
  SET_STRING_ELT(nms, 285, mkChar("dim_n_II_triage_12"));
  SET_STRING_ELT(nms, 286, mkChar("dim_n_II_triage_2"));
  SET_STRING_ELT(nms, 287, mkChar("dim_n_II_triage_3"));
  SET_STRING_ELT(nms, 288, mkChar("dim_n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 289, mkChar("dim_n_ILI_to_hosp_1"));
  SET_STRING_ELT(nms, 290, mkChar("dim_n_ILI_to_hosp_2"));
  SET_STRING_ELT(nms, 291, mkChar("dim_n_ILI_to_hosp_D"));
  SET_STRING_ELT(nms, 292, mkChar("dim_n_ILI_to_hosp_D_1"));
  SET_STRING_ELT(nms, 293, mkChar("dim_n_ILI_to_hosp_D_2"));
  SET_STRING_ELT(nms, 294, mkChar("dim_n_ILI_to_hosp_R"));
  SET_STRING_ELT(nms, 295, mkChar("dim_n_ILI_to_hosp_R_1"));
  SET_STRING_ELT(nms, 296, mkChar("dim_n_ILI_to_hosp_R_2"));
  SET_STRING_ELT(nms, 297, mkChar("dim_n_ILI_to_triage"));
  SET_STRING_ELT(nms, 298, mkChar("dim_n_ILI_to_triage_1"));
  SET_STRING_ELT(nms, 299, mkChar("dim_n_ILI_to_triage_2"));
  SET_STRING_ELT(nms, 300, mkChar("dim_n_R_stepdown"));
  SET_STRING_ELT(nms, 301, mkChar("dim_n_R_stepdown_1"));
  SET_STRING_ELT(nms, 302, mkChar("dim_n_R_stepdown_12"));
  SET_STRING_ELT(nms, 303, mkChar("dim_n_R_stepdown_2"));
  SET_STRING_ELT(nms, 304, mkChar("dim_n_R_stepdown_3"));
  SET_STRING_ELT(nms, 305, mkChar("dim_n_SE"));
  SET_STRING_ELT(nms, 306, mkChar("dim_n_triage_to_ICU_D"));
  SET_STRING_ELT(nms, 307, mkChar("dim_n_triage_to_ICU_D_1"));
  SET_STRING_ELT(nms, 308, mkChar("dim_n_triage_to_ICU_D_2"));
  SET_STRING_ELT(nms, 309, mkChar("dim_n_triage_to_ICU_R"));
  SET_STRING_ELT(nms, 310, mkChar("dim_n_triage_to_ICU_R_1"));
  SET_STRING_ELT(nms, 311, mkChar("dim_n_triage_to_ICU_R_2"));
  SET_STRING_ELT(nms, 312, mkChar("dim_p_asympt"));
  SET_STRING_ELT(nms, 313, mkChar("dim_p_death_hosp_D"));
  SET_STRING_ELT(nms, 314, mkChar("dim_p_death_ICU"));
  SET_STRING_ELT(nms, 315, mkChar("dim_p_ICU_hosp"));
  SET_STRING_ELT(nms, 316, mkChar("dim_p_recov_ILI"));
  SET_STRING_ELT(nms, 317, mkChar("dim_p_SE"));
  SET_STRING_ELT(nms, 318, mkChar("dim_p_sympt_ILI"));
  SET_STRING_ELT(nms, 319, mkChar("dim_R"));
  SET_STRING_ELT(nms, 320, mkChar("dim_R_stepdown"));
  SET_STRING_ELT(nms, 321, mkChar("dim_R_stepdown_1"));
  SET_STRING_ELT(nms, 322, mkChar("dim_R_stepdown_12"));
  SET_STRING_ELT(nms, 323, mkChar("dim_R_stepdown_2"));
  SET_STRING_ELT(nms, 324, mkChar("dim_R_stepdown_3"));
  SET_STRING_ELT(nms, 325, mkChar("dim_R0"));
  SET_STRING_ELT(nms, 326, mkChar("dim_R0_stepdown"));
  SET_STRING_ELT(nms, 327, mkChar("dim_R0_stepdown_1"));
  SET_STRING_ELT(nms, 328, mkChar("dim_R0_stepdown_12"));
  SET_STRING_ELT(nms, 329, mkChar("dim_R0_stepdown_2"));
  SET_STRING_ELT(nms, 330, mkChar("dim_R0_stepdown_3"));
  SET_STRING_ELT(nms, 331, mkChar("dim_S"));
  SET_STRING_ELT(nms, 332, mkChar("dim_s_ij"));
  SET_STRING_ELT(nms, 333, mkChar("dim_s_ij_1"));
  SET_STRING_ELT(nms, 334, mkChar("dim_s_ij_2"));
  SET_STRING_ELT(nms, 335, mkChar("dim_S0"));
  SET_STRING_ELT(nms, 336, mkChar("dim_trans_increase"));
  SET_STRING_ELT(nms, 337, mkChar("dim_trans_increase_1"));
  SET_STRING_ELT(nms, 338, mkChar("dim_trans_increase_2"));
  SET_STRING_ELT(nms, 339, mkChar("dim_trans_profile"));
  SET_STRING_ELT(nms, 340, mkChar("dim_trans_profile_1"));
  SET_STRING_ELT(nms, 341, mkChar("dim_trans_profile_2"));
  SET_STRING_ELT(nms, 342, mkChar("dt"));
  SET_STRING_ELT(nms, 343, mkChar("E0"));
  SET_STRING_ELT(nms, 344, mkChar("gamma_asympt"));
  SET_STRING_ELT(nms, 345, mkChar("gamma_E"));
  SET_STRING_ELT(nms, 346, mkChar("gamma_hosp_D"));
  SET_STRING_ELT(nms, 347, mkChar("gamma_hosp_R"));
  SET_STRING_ELT(nms, 348, mkChar("gamma_ICU_D"));
  SET_STRING_ELT(nms, 349, mkChar("gamma_ICU_R"));
  SET_STRING_ELT(nms, 350, mkChar("gamma_ILI"));
  SET_STRING_ELT(nms, 351, mkChar("gamma_mild"));
  SET_STRING_ELT(nms, 352, mkChar("gamma_stepdown"));
  SET_STRING_ELT(nms, 353, mkChar("gamma_triage"));
  SET_STRING_ELT(nms, 354, mkChar("hosp_transmission"));
  SET_STRING_ELT(nms, 355, mkChar("I_with_diff_trans"));
  SET_STRING_ELT(nms, 356, mkChar("I0_asympt"));
  SET_STRING_ELT(nms, 357, mkChar("I0_hosp_D"));
  SET_STRING_ELT(nms, 358, mkChar("I0_hosp_R"));
  SET_STRING_ELT(nms, 359, mkChar("I0_ICU_D"));
  SET_STRING_ELT(nms, 360, mkChar("I0_ICU_R"));
  SET_STRING_ELT(nms, 361, mkChar("I0_ILI"));
  SET_STRING_ELT(nms, 362, mkChar("I0_mild"));
  SET_STRING_ELT(nms, 363, mkChar("I0_triage"));
  SET_STRING_ELT(nms, 364, mkChar("ICU_transmission"));
  SET_STRING_ELT(nms, 365, mkChar("initial_D"));
  SET_STRING_ELT(nms, 366, mkChar("initial_E"));
  SET_STRING_ELT(nms, 367, mkChar("initial_I_asympt"));
  SET_STRING_ELT(nms, 368, mkChar("initial_I_hosp_D"));
  SET_STRING_ELT(nms, 369, mkChar("initial_I_hosp_R"));
  SET_STRING_ELT(nms, 370, mkChar("initial_I_ICU_D"));
  SET_STRING_ELT(nms, 371, mkChar("initial_I_ICU_R"));
  SET_STRING_ELT(nms, 372, mkChar("initial_I_ILI"));
  SET_STRING_ELT(nms, 373, mkChar("initial_I_mild"));
  SET_STRING_ELT(nms, 374, mkChar("initial_I_triage"));
  SET_STRING_ELT(nms, 375, mkChar("initial_R"));
  SET_STRING_ELT(nms, 376, mkChar("initial_R_stepdown"));
  SET_STRING_ELT(nms, 377, mkChar("initial_S"));
  SET_STRING_ELT(nms, 378, mkChar("initial_x"));
  SET_STRING_ELT(nms, 379, mkChar("lambda"));
  SET_STRING_ELT(nms, 380, mkChar("m"));
  SET_STRING_ELT(nms, 381, mkChar("N_age"));
  SET_STRING_ELT(nms, 382, mkChar("n_EE"));
  SET_STRING_ELT(nms, 383, mkChar("n_EI_asympt"));
  SET_STRING_ELT(nms, 384, mkChar("n_EI_ILI"));
  SET_STRING_ELT(nms, 385, mkChar("n_EI_mild"));
  SET_STRING_ELT(nms, 386, mkChar("n_hosp_non_ICU"));
  SET_STRING_ELT(nms, 387, mkChar("n_ICU_to_R_stepdown"));
  SET_STRING_ELT(nms, 388, mkChar("n_II_asympt"));
  SET_STRING_ELT(nms, 389, mkChar("n_II_hosp_D"));
  SET_STRING_ELT(nms, 390, mkChar("n_II_hosp_R"));
  SET_STRING_ELT(nms, 391, mkChar("n_II_ICU_D"));
  SET_STRING_ELT(nms, 392, mkChar("n_II_ICU_R"));
  SET_STRING_ELT(nms, 393, mkChar("n_II_ILI"));
  SET_STRING_ELT(nms, 394, mkChar("n_II_mild"));
  SET_STRING_ELT(nms, 395, mkChar("n_II_triage"));
  SET_STRING_ELT(nms, 396, mkChar("n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 397, mkChar("n_ILI_to_hosp_D"));
  SET_STRING_ELT(nms, 398, mkChar("n_ILI_to_hosp_R"));
  SET_STRING_ELT(nms, 399, mkChar("n_ILI_to_triage"));
  SET_STRING_ELT(nms, 400, mkChar("n_R_stepdown"));
  SET_STRING_ELT(nms, 401, mkChar("n_SE"));
  SET_STRING_ELT(nms, 402, mkChar("n_triage_to_ICU_D"));
  SET_STRING_ELT(nms, 403, mkChar("n_triage_to_ICU_R"));
  SET_STRING_ELT(nms, 404, mkChar("offset_output_n_EI_ILI"));
  SET_STRING_ELT(nms, 405, mkChar("offset_output_n_EI_mild"));
  SET_STRING_ELT(nms, 406, mkChar("offset_output_n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 407, mkChar("offset_output_n_ILI_to_hosp_D"));
  SET_STRING_ELT(nms, 408, mkChar("offset_output_n_ILI_to_hosp_R"));
  SET_STRING_ELT(nms, 409, mkChar("offset_output_n_triage_to_ICU_D"));
  SET_STRING_ELT(nms, 410, mkChar("offset_output_n_triage_to_ICU_R"));
  SET_STRING_ELT(nms, 411, mkChar("offset_variable_D"));
  SET_STRING_ELT(nms, 412, mkChar("offset_variable_E"));
  SET_STRING_ELT(nms, 413, mkChar("offset_variable_I_asympt"));
  SET_STRING_ELT(nms, 414, mkChar("offset_variable_I_hosp_D"));
  SET_STRING_ELT(nms, 415, mkChar("offset_variable_I_hosp_R"));
  SET_STRING_ELT(nms, 416, mkChar("offset_variable_I_ICU_D"));
  SET_STRING_ELT(nms, 417, mkChar("offset_variable_I_ICU_R"));
  SET_STRING_ELT(nms, 418, mkChar("offset_variable_I_ILI"));
  SET_STRING_ELT(nms, 419, mkChar("offset_variable_I_mild"));
  SET_STRING_ELT(nms, 420, mkChar("offset_variable_I_triage"));
  SET_STRING_ELT(nms, 421, mkChar("offset_variable_R"));
  SET_STRING_ELT(nms, 422, mkChar("offset_variable_R_stepdown"));
  SET_STRING_ELT(nms, 423, mkChar("p_asympt"));
  SET_STRING_ELT(nms, 424, mkChar("p_death_hosp_D"));
  SET_STRING_ELT(nms, 425, mkChar("p_death_ICU"));
  SET_STRING_ELT(nms, 426, mkChar("p_EE"));
  SET_STRING_ELT(nms, 427, mkChar("p_ICU_hosp"));
  SET_STRING_ELT(nms, 428, mkChar("p_II_asympt"));
  SET_STRING_ELT(nms, 429, mkChar("p_II_hosp_D"));
  SET_STRING_ELT(nms, 430, mkChar("p_II_hosp_R"));
  SET_STRING_ELT(nms, 431, mkChar("p_II_ICU_D"));
  SET_STRING_ELT(nms, 432, mkChar("p_II_ICU_R"));
  SET_STRING_ELT(nms, 433, mkChar("p_II_ILI"));
  SET_STRING_ELT(nms, 434, mkChar("p_II_mild"));
  SET_STRING_ELT(nms, 435, mkChar("p_II_triage"));
  SET_STRING_ELT(nms, 436, mkChar("p_R_stepdown"));
  SET_STRING_ELT(nms, 437, mkChar("p_recov_ILI"));
  SET_STRING_ELT(nms, 438, mkChar("p_SE"));
  SET_STRING_ELT(nms, 439, mkChar("p_sympt_ILI"));
  SET_STRING_ELT(nms, 440, mkChar("R0"));
  SET_STRING_ELT(nms, 441, mkChar("R0_stepdown"));
  SET_STRING_ELT(nms, 442, mkChar("s_asympt"));
  SET_STRING_ELT(nms, 443, mkChar("s_E"));
  SET_STRING_ELT(nms, 444, mkChar("s_hosp_D"));
  SET_STRING_ELT(nms, 445, mkChar("s_hosp_R"));
  SET_STRING_ELT(nms, 446, mkChar("s_ICU_D"));
  SET_STRING_ELT(nms, 447, mkChar("s_ICU_R"));
  SET_STRING_ELT(nms, 448, mkChar("s_ij"));
  SET_STRING_ELT(nms, 449, mkChar("s_ILI"));
  SET_STRING_ELT(nms, 450, mkChar("s_mild"));
  SET_STRING_ELT(nms, 451, mkChar("s_stepdown"));
  SET_STRING_ELT(nms, 452, mkChar("s_triage"));
  SET_STRING_ELT(nms, 453, mkChar("S0"));
  SET_STRING_ELT(nms, 454, mkChar("sd_x"));
  SET_STRING_ELT(nms, 455, mkChar("trans_classes"));
  SET_STRING_ELT(nms, 456, mkChar("trans_increase"));
  SET_STRING_ELT(nms, 457, mkChar("trans_profile"));
  SET_STRING_ELT(nms, 458, mkChar("x0"));
  setAttrib(contents, R_NamesSymbol, nms);
  UNPROTECT(86);
  return contents;
}
SEXP diffusion_beta_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->offset_variable_I_asympt = 1 + internal->dim_S + internal->dim_R + internal->dim_D + internal->dim_E;
  internal->offset_variable_I_hosp_D = 1 + internal->dim_S + internal->dim_R + internal->dim_D + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_triage + internal->dim_I_hosp_R;
  internal->offset_variable_I_hosp_R = 1 + internal->dim_S + internal->dim_R + internal->dim_D + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_triage;
  internal->offset_variable_I_ICU_D = 1 + internal->dim_S + internal->dim_R + internal->dim_D + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_triage + internal->dim_I_hosp_R + internal->dim_I_hosp_D + internal->dim_I_ICU_R;
  internal->offset_variable_I_ICU_R = 1 + internal->dim_S + internal->dim_R + internal->dim_D + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_triage + internal->dim_I_hosp_R + internal->dim_I_hosp_D;
  internal->offset_variable_I_ILI = 1 + internal->dim_S + internal->dim_R + internal->dim_D + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild;
  internal->offset_variable_I_mild = 1 + internal->dim_S + internal->dim_R + internal->dim_D + internal->dim_E + internal->dim_I_asympt;
  internal->offset_variable_I_triage = 1 + internal->dim_S + internal->dim_R + internal->dim_D + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI;
  internal->offset_variable_R_stepdown = 1 + internal->dim_S + internal->dim_R + internal->dim_D + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_triage + internal->dim_I_hosp_R + internal->dim_I_hosp_D + internal->dim_I_ICU_R + internal->dim_I_ICU_D;
...
SEXP diffusion_beta_metadata(SEXP internal_p) {
  ...
  int * dim_I_ICU_R = INTEGER(VECTOR_ELT(variable_length, 11));
  ...
  int * dim_I_ICU_D = INTEGER(VECTOR_ELT(variable_length, 12));
  ...
  int * dim_R_stepdown = INTEGER(VECTOR_ELT(variable_length, 13));
  ...
  SET_STRING_ELT(variable_names, 6, mkChar("I_mild"));
  SET_STRING_ELT(variable_names, 7, mkChar("I_ILI"));
  SET_STRING_ELT(variable_names, 8, mkChar("I_triage"));
  SET_STRING_ELT(variable_names, 9, mkChar("I_hosp_R"));
  SET_STRING_ELT(variable_names, 10, mkChar("I_hosp_D"));
  SET_STRING_ELT(variable_names, 11, mkChar("I_ICU_R"));
  SET_STRING_ELT(variable_names, 12, mkChar("I_ICU_D"));
  SET_STRING_ELT(variable_names, 13, mkChar("R_stepdown"));
  SET_VECTOR_ELT(ret, 0, variable_length);
  UNPROTECT(2);
...
SEXP diffusion_beta_initial_conditions(SEXP internal_p, SEXP step_ptr) {
  diffusion_beta_internal *internal = diffusion_beta_get_internal(internal_p, 1);
  SEXP r_state = PROTECT(allocVector(REALSXP, 1 + internal->dim_S + internal->dim_R + internal->dim_D + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_triage + internal->dim_I_hosp_R + internal->dim_I_hosp_D + internal->dim_I_ICU_R + internal->dim_I_ICU_D + internal->dim_R_stepdown));
  double * state = REAL(r_state);
  state[0] = internal->initial_x;
  memcpy(state + 1, internal->initial_S, internal->dim_S * sizeof(double));
  memcpy(state + internal->offset_variable_R, internal->initial_R, internal->dim_R * sizeof(double));
...
void diffusion_beta_rhs_dde(size_t n_eq, size_t step, double * state, double * state_next, size_t n_out, double * output, void * internal) {
  diffusion_beta_rhs((diffusion_beta_internal*)internal, step, state, state_next, output);
}
SEXP diffusion_beta_rhs_r(SEXP internal_p, SEXP step, SEXP state) {
  SEXP state_next = PROTECT(allocVector(REALSXP, LENGTH(state)));
  diffusion_beta_internal *internal = diffusion_beta_get_internal(internal_p, 1);
  ...
  double *output = REAL(output_ptr);
  GetRNGstate();
  diffusion_beta_rhs(internal, INTEGER(step)[0], REAL(state), REAL(state_next), output);
  PutRNGstate();
  UNPROTECT(1);
  return state_next;
}
