...
SEXP basic_contents(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(contents, 251, E0);
  SET_VECTOR_ELT(contents, 252, ScalarReal(internal->gamma_asympt));
  SET_VECTOR_ELT(contents, 253, ScalarReal(internal->gamma_E));
  SET_VECTOR_ELT(contents, 254, ScalarReal(internal->gamma_hosp));
  SET_VECTOR_ELT(contents, 255, ScalarReal(internal->gamma_ICU));
  SET_VECTOR_ELT(contents, 256, ScalarReal(internal->gamma_ILI));
  SET_VECTOR_ELT(contents, 257, ScalarReal(internal->gamma_mild));
  SET_VECTOR_ELT(contents, 258, ScalarReal(internal->gamma_rec));
  SET_VECTOR_ELT(contents, 259, ScalarReal(internal->hosp_transmission));
  ...
  SET_VECTOR_ELT(contents, 260, I_with_diff_trans);
  ...
  SET_VECTOR_ELT(contents, 261, I0_asympt);
  ...
  SET_VECTOR_ELT(contents, 262, I0_hosp);
  ...
  SET_VECTOR_ELT(contents, 263, I0_ICU);
  ...
  SET_VECTOR_ELT(contents, 264, I0_ILI);
  ...
  SET_VECTOR_ELT(contents, 265, I0_mild);
  SET_VECTOR_ELT(contents, 266, ScalarReal(internal->ICU_transmission));
  ...
  SET_VECTOR_ELT(contents, 267, initial_D);
  ...
  SET_VECTOR_ELT(contents, 268, initial_E);
  ...
  SET_VECTOR_ELT(contents, 269, initial_I_asympt);
  ...
  SET_VECTOR_ELT(contents, 270, initial_I_hosp);
  ...
  SET_VECTOR_ELT(contents, 271, initial_I_ICU);
  ...
  SET_VECTOR_ELT(contents, 272, initial_I_ILI);
  ...
  SET_VECTOR_ELT(contents, 273, initial_I_mild);
  ...
  SET_VECTOR_ELT(contents, 274, initial_R);
  ...
  SET_VECTOR_ELT(contents, 275, initial_R_hosp);
  ...
  SET_VECTOR_ELT(contents, 306, ScalarInteger(internal->offset_variable_R_hosp));
  ...
  SET_VECTOR_ELT(contents, 307, p_asympt);
  ...
  SET_VECTOR_ELT(contents, 308, p_death_hosp);
  SET_VECTOR_ELT(contents, 309, ScalarReal(internal->p_EE));
  SET_VECTOR_ELT(contents, 310, ScalarReal(internal->p_II_asympt));
  SET_VECTOR_ELT(contents, 311, ScalarReal(internal->p_II_hosp));
  SET_VECTOR_ELT(contents, 312, ScalarReal(internal->p_II_ICU));
  SET_VECTOR_ELT(contents, 313, ScalarReal(internal->p_II_ILI));
  SET_VECTOR_ELT(contents, 314, ScalarReal(internal->p_II_mild));
  SET_VECTOR_ELT(contents, 315, ScalarReal(internal->p_R_hosp));
  ...
  SET_VECTOR_ELT(contents, 316, p_recov_hosp);
  ...
  SET_VECTOR_ELT(contents, 317, p_recov_ICU);
  ...
  SET_VECTOR_ELT(contents, 322, R0_hosp);
  SET_VECTOR_ELT(contents, 323, ScalarInteger(internal->s_asympt));
  SET_VECTOR_ELT(contents, 324, ScalarInteger(internal->s_E));
  SET_VECTOR_ELT(contents, 325, ScalarInteger(internal->s_hosp));
  SET_VECTOR_ELT(contents, 326, ScalarInteger(internal->s_ICU));
  ...
  SET_VECTOR_ELT(contents, 327, s_ij);
  SET_VECTOR_ELT(contents, 328, ScalarInteger(internal->s_ILI));
  SET_VECTOR_ELT(contents, 329, ScalarInteger(internal->s_mild));
  SET_VECTOR_ELT(contents, 330, ScalarInteger(internal->s_rec));
  SEXP S0 = PROTECT(allocVector(REALSXP, internal->dim_S0));
  memcpy(REAL(S0), internal->S0, internal->dim_S0 * sizeof(double));
  SET_VECTOR_ELT(contents, 331, S0);
  SET_VECTOR_ELT(contents, 332, ScalarInteger(internal->trans_classes));
  ...
  SET_VECTOR_ELT(contents, 333, trans_increase);
  ...
  SET_VECTOR_ELT(contents, 334, trans_profile);
  ...
  SET_STRING_ELT(nms, 251, mkChar("E0"));
  SET_STRING_ELT(nms, 252, mkChar("gamma_asympt"));
  SET_STRING_ELT(nms, 253, mkChar("gamma_E"));
  SET_STRING_ELT(nms, 254, mkChar("gamma_hosp"));
  SET_STRING_ELT(nms, 255, mkChar("gamma_ICU"));
  SET_STRING_ELT(nms, 256, mkChar("gamma_ILI"));
  SET_STRING_ELT(nms, 257, mkChar("gamma_mild"));
  SET_STRING_ELT(nms, 258, mkChar("gamma_rec"));
  SET_STRING_ELT(nms, 259, mkChar("hosp_transmission"));
  SET_STRING_ELT(nms, 260, mkChar("I_with_diff_trans"));
  SET_STRING_ELT(nms, 261, mkChar("I0_asympt"));
  SET_STRING_ELT(nms, 262, mkChar("I0_hosp"));
  SET_STRING_ELT(nms, 263, mkChar("I0_ICU"));
  SET_STRING_ELT(nms, 264, mkChar("I0_ILI"));
  SET_STRING_ELT(nms, 265, mkChar("I0_mild"));
  SET_STRING_ELT(nms, 266, mkChar("ICU_transmission"));
  SET_STRING_ELT(nms, 267, mkChar("initial_D"));
  SET_STRING_ELT(nms, 268, mkChar("initial_E"));
  SET_STRING_ELT(nms, 269, mkChar("initial_I_asympt"));
  SET_STRING_ELT(nms, 270, mkChar("initial_I_hosp"));
  SET_STRING_ELT(nms, 271, mkChar("initial_I_ICU"));
  SET_STRING_ELT(nms, 272, mkChar("initial_I_ILI"));
  SET_STRING_ELT(nms, 273, mkChar("initial_I_mild"));
  SET_STRING_ELT(nms, 274, mkChar("initial_R"));
  SET_STRING_ELT(nms, 275, mkChar("initial_R_hosp"));
  ...
  SET_STRING_ELT(nms, 306, mkChar("offset_variable_R_hosp"));
  SET_STRING_ELT(nms, 307, mkChar("p_asympt"));
  SET_STRING_ELT(nms, 308, mkChar("p_death_hosp"));
  SET_STRING_ELT(nms, 309, mkChar("p_EE"));
  SET_STRING_ELT(nms, 310, mkChar("p_II_asympt"));
  SET_STRING_ELT(nms, 311, mkChar("p_II_hosp"));
  SET_STRING_ELT(nms, 312, mkChar("p_II_ICU"));
  SET_STRING_ELT(nms, 313, mkChar("p_II_ILI"));
  SET_STRING_ELT(nms, 314, mkChar("p_II_mild"));
  SET_STRING_ELT(nms, 315, mkChar("p_R_hosp"));
  SET_STRING_ELT(nms, 316, mkChar("p_recov_hosp"));
  SET_STRING_ELT(nms, 317, mkChar("p_recov_ICU"));
  SET_STRING_ELT(nms, 318, mkChar("p_recov_ILI"));
  SET_STRING_ELT(nms, 319, mkChar("p_SE"));
  SET_STRING_ELT(nms, 320, mkChar("p_sympt_ILI"));
  SET_STRING_ELT(nms, 321, mkChar("R0"));
  SET_STRING_ELT(nms, 322, mkChar("R0_hosp"));
  SET_STRING_ELT(nms, 323, mkChar("s_asympt"));
  SET_STRING_ELT(nms, 324, mkChar("s_E"));
  SET_STRING_ELT(nms, 325, mkChar("s_hosp"));
  SET_STRING_ELT(nms, 326, mkChar("s_ICU"));
  SET_STRING_ELT(nms, 327, mkChar("s_ij"));
  SET_STRING_ELT(nms, 328, mkChar("s_ILI"));
  SET_STRING_ELT(nms, 329, mkChar("s_mild"));
  SET_STRING_ELT(nms, 330, mkChar("s_rec"));
  SET_STRING_ELT(nms, 331, mkChar("S0"));
  SET_STRING_ELT(nms, 332, mkChar("trans_classes"));
  SET_STRING_ELT(nms, 333, mkChar("trans_increase"));
  SET_STRING_ELT(nms, 334, mkChar("trans_profile"));
...
SEXP basic_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->offset_output_n_EI_ILI = 2 + internal->dim_n_EI_asympt + internal->dim_n_EI_mild;
  internal->offset_output_n_EI_mild = 2 + internal->dim_n_EI_asympt;
  internal->offset_output_n_hosp_to_ICU = 2 + internal->dim_n_EI_asympt + internal->dim_n_EI_mild + internal->dim_n_EI_ILI + internal->dim_n_ILI_to_hosp;
  internal->offset_output_n_ILI_to_hosp = 2 + internal->dim_n_EI_asympt + internal->dim_n_EI_mild + internal->dim_n_EI_ILI;
...
SEXP basic_metadata(SEXP internal_p) {
  ...
  int * dim_n_EI_asympt = INTEGER(VECTOR_ELT(output_length, 2));
  ...
  int * dim_n_EI_mild = INTEGER(VECTOR_ELT(output_length, 3));
  ...
  int * dim_n_EI_ILI = INTEGER(VECTOR_ELT(output_length, 4));
  ...
  int * dim_n_ILI_to_hosp = INTEGER(VECTOR_ELT(output_length, 5));
  ...
  int * dim_n_hosp_to_ICU = INTEGER(VECTOR_ELT(output_length, 6));
  ...
  SET_STRING_ELT(output_names, 1, mkChar("N_tot"));
  SET_STRING_ELT(output_names, 2, mkChar("n_EI_asympt"));
  SET_STRING_ELT(output_names, 3, mkChar("n_EI_mild"));
  SET_STRING_ELT(output_names, 4, mkChar("n_EI_ILI"));
  SET_STRING_ELT(output_names, 5, mkChar("n_ILI_to_hosp"));
  SET_STRING_ELT(output_names, 6, mkChar("n_hosp_to_ICU"));
  SET_VECTOR_ELT(ret, 1, output_length);
  UNPROTECT(2);
  SET_VECTOR_ELT(ret, 2, ScalarInteger(2 + internal->dim_n_EI_asympt + internal->dim_n_EI_mild + internal->dim_n_EI_ILI + internal->dim_n_ILI_to_hosp + internal->dim_n_hosp_to_ICU));
  UNPROTECT(2);
  return ret;
}
SEXP basic_initial_conditions(SEXP internal_p, SEXP step_ptr) {
...
void basic_rhs(basic_internal* internal, size_t step, double * state, double * state_next, double * output) {
  ...
  output[1] = N_tot;
  output[0] = time;
  memcpy(output + 2, internal->n_EI_asympt, internal->dim_n_EI_asympt * sizeof(double));
...
SEXP basic_rhs_r(SEXP internal_p, SEXP step, SEXP state) {
  ...
  basic_internal *internal = basic_get_internal(internal_p, 1);
  SEXP output_ptr = PROTECT(allocVector(REALSXP, 2 + internal->dim_n_EI_asympt + internal->dim_n_EI_mild + internal->dim_n_EI_ILI + internal->dim_n_ILI_to_hosp + internal->dim_n_hosp_to_ICU));
