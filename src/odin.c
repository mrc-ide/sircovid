...
SEXP hospital_with_serology_testing_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 837));
  SEXP aux_EE = PROTECT(allocVector(REALSXP, internal->dim_aux_EE));
  memcpy(REAL(aux_EE), internal->aux_EE, internal->dim_aux_EE * sizeof(double));
  odin_set_dim(aux_EE, 3, internal->dim_aux_EE_1, internal->dim_aux_EE_2, internal->dim_aux_EE_3);
  SET_VECTOR_ELT(contents, 0, aux_EE);
  ...
  SET_VECTOR_ELT(contents, 527, ScalarInteger(internal->dim_N_tot));
  SET_VECTOR_ELT(contents, 528, ScalarInteger(internal->dim_new_I_hosp_D_conf));
  SET_VECTOR_ELT(contents, 529, ScalarInteger(internal->dim_new_I_hosp_D_conf_1));
  SET_VECTOR_ELT(contents, 530, ScalarInteger(internal->dim_new_I_hosp_D_conf_12));
  SET_VECTOR_ELT(contents, 531, ScalarInteger(internal->dim_new_I_hosp_D_conf_2));
  SET_VECTOR_ELT(contents, 532, ScalarInteger(internal->dim_new_I_hosp_D_conf_3));
  SET_VECTOR_ELT(contents, 533, ScalarInteger(internal->dim_new_I_hosp_D_unconf));
  SET_VECTOR_ELT(contents, 534, ScalarInteger(internal->dim_new_I_hosp_D_unconf_1));
  SET_VECTOR_ELT(contents, 535, ScalarInteger(internal->dim_new_I_hosp_D_unconf_12));
  SET_VECTOR_ELT(contents, 536, ScalarInteger(internal->dim_new_I_hosp_D_unconf_2));
  SET_VECTOR_ELT(contents, 537, ScalarInteger(internal->dim_new_I_hosp_D_unconf_3));
  SET_VECTOR_ELT(contents, 538, ScalarInteger(internal->dim_new_I_hosp_R_conf));
  SET_VECTOR_ELT(contents, 539, ScalarInteger(internal->dim_new_I_hosp_R_conf_1));
  SET_VECTOR_ELT(contents, 540, ScalarInteger(internal->dim_new_I_hosp_R_conf_12));
  SET_VECTOR_ELT(contents, 541, ScalarInteger(internal->dim_new_I_hosp_R_conf_2));
  SET_VECTOR_ELT(contents, 542, ScalarInteger(internal->dim_new_I_hosp_R_conf_3));
  SET_VECTOR_ELT(contents, 543, ScalarInteger(internal->dim_new_I_hosp_R_unconf));
  SET_VECTOR_ELT(contents, 544, ScalarInteger(internal->dim_new_I_hosp_R_unconf_1));
  SET_VECTOR_ELT(contents, 545, ScalarInteger(internal->dim_new_I_hosp_R_unconf_12));
  SET_VECTOR_ELT(contents, 546, ScalarInteger(internal->dim_new_I_hosp_R_unconf_2));
  SET_VECTOR_ELT(contents, 547, ScalarInteger(internal->dim_new_I_hosp_R_unconf_3));
  SET_VECTOR_ELT(contents, 548, ScalarInteger(internal->dim_new_I_ICU_D_conf));
  SET_VECTOR_ELT(contents, 549, ScalarInteger(internal->dim_new_I_ICU_D_conf_1));
  SET_VECTOR_ELT(contents, 550, ScalarInteger(internal->dim_new_I_ICU_D_conf_12));
  SET_VECTOR_ELT(contents, 551, ScalarInteger(internal->dim_new_I_ICU_D_conf_2));
  SET_VECTOR_ELT(contents, 552, ScalarInteger(internal->dim_new_I_ICU_D_conf_3));
  SET_VECTOR_ELT(contents, 553, ScalarInteger(internal->dim_new_I_ICU_D_unconf));
  SET_VECTOR_ELT(contents, 554, ScalarInteger(internal->dim_new_I_ICU_D_unconf_1));
  SET_VECTOR_ELT(contents, 555, ScalarInteger(internal->dim_new_I_ICU_D_unconf_12));
  SET_VECTOR_ELT(contents, 556, ScalarInteger(internal->dim_new_I_ICU_D_unconf_2));
  SET_VECTOR_ELT(contents, 557, ScalarInteger(internal->dim_new_I_ICU_D_unconf_3));
  SET_VECTOR_ELT(contents, 558, ScalarInteger(internal->dim_new_I_ICU_R_conf));
  SET_VECTOR_ELT(contents, 559, ScalarInteger(internal->dim_new_I_ICU_R_conf_1));
  SET_VECTOR_ELT(contents, 560, ScalarInteger(internal->dim_new_I_ICU_R_conf_12));
  SET_VECTOR_ELT(contents, 561, ScalarInteger(internal->dim_new_I_ICU_R_conf_2));
  SET_VECTOR_ELT(contents, 562, ScalarInteger(internal->dim_new_I_ICU_R_conf_3));
  SET_VECTOR_ELT(contents, 563, ScalarInteger(internal->dim_new_I_ICU_R_unconf));
  SET_VECTOR_ELT(contents, 564, ScalarInteger(internal->dim_new_I_ICU_R_unconf_1));
  SET_VECTOR_ELT(contents, 565, ScalarInteger(internal->dim_new_I_ICU_R_unconf_12));
  SET_VECTOR_ELT(contents, 566, ScalarInteger(internal->dim_new_I_ICU_R_unconf_2));
  SET_VECTOR_ELT(contents, 567, ScalarInteger(internal->dim_new_I_ICU_R_unconf_3));
  SET_VECTOR_ELT(contents, 568, ScalarInteger(internal->dim_new_I_triage_D_conf));
  SET_VECTOR_ELT(contents, 569, ScalarInteger(internal->dim_new_I_triage_D_conf_1));
  SET_VECTOR_ELT(contents, 570, ScalarInteger(internal->dim_new_I_triage_D_conf_12));
  SET_VECTOR_ELT(contents, 571, ScalarInteger(internal->dim_new_I_triage_D_conf_2));
  SET_VECTOR_ELT(contents, 572, ScalarInteger(internal->dim_new_I_triage_D_conf_3));
  SET_VECTOR_ELT(contents, 573, ScalarInteger(internal->dim_new_I_triage_D_unconf));
  SET_VECTOR_ELT(contents, 574, ScalarInteger(internal->dim_new_I_triage_D_unconf_1));
  SET_VECTOR_ELT(contents, 575, ScalarInteger(internal->dim_new_I_triage_D_unconf_12));
  SET_VECTOR_ELT(contents, 576, ScalarInteger(internal->dim_new_I_triage_D_unconf_2));
  SET_VECTOR_ELT(contents, 577, ScalarInteger(internal->dim_new_I_triage_D_unconf_3));
  SET_VECTOR_ELT(contents, 578, ScalarInteger(internal->dim_new_I_triage_R_conf));
  SET_VECTOR_ELT(contents, 579, ScalarInteger(internal->dim_new_I_triage_R_conf_1));
  SET_VECTOR_ELT(contents, 580, ScalarInteger(internal->dim_new_I_triage_R_conf_12));
  SET_VECTOR_ELT(contents, 581, ScalarInteger(internal->dim_new_I_triage_R_conf_2));
  SET_VECTOR_ELT(contents, 582, ScalarInteger(internal->dim_new_I_triage_R_conf_3));
  SET_VECTOR_ELT(contents, 583, ScalarInteger(internal->dim_new_I_triage_R_unconf));
  SET_VECTOR_ELT(contents, 584, ScalarInteger(internal->dim_new_I_triage_R_unconf_1));
  SET_VECTOR_ELT(contents, 585, ScalarInteger(internal->dim_new_I_triage_R_unconf_12));
  SET_VECTOR_ELT(contents, 586, ScalarInteger(internal->dim_new_I_triage_R_unconf_2));
  SET_VECTOR_ELT(contents, 587, ScalarInteger(internal->dim_new_I_triage_R_unconf_3));
  SET_VECTOR_ELT(contents, 588, ScalarInteger(internal->dim_new_R_stepdown_conf));
  SET_VECTOR_ELT(contents, 589, ScalarInteger(internal->dim_new_R_stepdown_conf_1));
  SET_VECTOR_ELT(contents, 590, ScalarInteger(internal->dim_new_R_stepdown_conf_2));
  SET_VECTOR_ELT(contents, 591, ScalarInteger(internal->dim_new_R_stepdown_unconf));
  SET_VECTOR_ELT(contents, 592, ScalarInteger(internal->dim_new_R_stepdown_unconf_1));
  SET_VECTOR_ELT(contents, 593, ScalarInteger(internal->dim_new_R_stepdown_unconf_2));
  SET_VECTOR_ELT(contents, 594, ScalarInteger(internal->dim_p_admit_conf));
  SET_VECTOR_ELT(contents, 595, ScalarInteger(internal->dim_p_asympt));
  ...
  SET_VECTOR_ELT(contents, 605, ScalarInteger(internal->dim_R));
  SET_VECTOR_ELT(contents, 606, ScalarInteger(internal->dim_R_neg));
  SET_VECTOR_ELT(contents, 607, ScalarInteger(internal->dim_R_pos));
  SET_VECTOR_ELT(contents, 608, ScalarInteger(internal->dim_R_pre));
  SET_VECTOR_ELT(contents, 609, ScalarInteger(internal->dim_R_pre_1));
  SET_VECTOR_ELT(contents, 610, ScalarInteger(internal->dim_R_pre_2));
  SET_VECTOR_ELT(contents, 611, ScalarInteger(internal->dim_R_stepdown_conf));
  SET_VECTOR_ELT(contents, 612, ScalarInteger(internal->dim_R_stepdown_conf_1));
  SET_VECTOR_ELT(contents, 613, ScalarInteger(internal->dim_R_stepdown_conf_2));
  SET_VECTOR_ELT(contents, 614, ScalarInteger(internal->dim_R_stepdown_unconf));
  SET_VECTOR_ELT(contents, 615, ScalarInteger(internal->dim_R_stepdown_unconf_1));
  SET_VECTOR_ELT(contents, 616, ScalarInteger(internal->dim_R_stepdown_unconf_2));
  SET_VECTOR_ELT(contents, 617, ScalarInteger(internal->dim_R0));
  SET_VECTOR_ELT(contents, 618, ScalarInteger(internal->dim_R0_neg));
  SET_VECTOR_ELT(contents, 619, ScalarInteger(internal->dim_R0_pos));
  SET_VECTOR_ELT(contents, 620, ScalarInteger(internal->dim_R0_pre));
  SET_VECTOR_ELT(contents, 621, ScalarInteger(internal->dim_R0_pre_1));
  SET_VECTOR_ELT(contents, 622, ScalarInteger(internal->dim_R0_pre_2));
  SET_VECTOR_ELT(contents, 623, ScalarInteger(internal->dim_R0_stepdown_conf));
  SET_VECTOR_ELT(contents, 624, ScalarInteger(internal->dim_R0_stepdown_conf_1));
  SET_VECTOR_ELT(contents, 625, ScalarInteger(internal->dim_R0_stepdown_conf_2));
  SET_VECTOR_ELT(contents, 626, ScalarInteger(internal->dim_R0_stepdown_unconf));
  SET_VECTOR_ELT(contents, 627, ScalarInteger(internal->dim_R0_stepdown_unconf_1));
  SET_VECTOR_ELT(contents, 628, ScalarInteger(internal->dim_R0_stepdown_unconf_2));
  SET_VECTOR_ELT(contents, 629, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 630, ScalarInteger(internal->dim_s_ij));
  SET_VECTOR_ELT(contents, 631, ScalarInteger(internal->dim_s_ij_1));
  SET_VECTOR_ELT(contents, 632, ScalarInteger(internal->dim_s_ij_2));
  SET_VECTOR_ELT(contents, 633, ScalarInteger(internal->dim_S0));
  SET_VECTOR_ELT(contents, 634, ScalarInteger(internal->dim_trans_increase));
  SET_VECTOR_ELT(contents, 635, ScalarInteger(internal->dim_trans_increase_1));
  SET_VECTOR_ELT(contents, 636, ScalarInteger(internal->dim_trans_increase_2));
  SET_VECTOR_ELT(contents, 637, ScalarInteger(internal->dim_trans_profile));
  SET_VECTOR_ELT(contents, 638, ScalarInteger(internal->dim_trans_profile_1));
  SET_VECTOR_ELT(contents, 639, ScalarInteger(internal->dim_trans_profile_2));
  SET_VECTOR_ELT(contents, 640, ScalarReal(internal->dt));
  SEXP E0 = PROTECT(allocVector(REALSXP, internal->dim_E0));
  memcpy(REAL(E0), internal->E0, internal->dim_E0 * sizeof(double));
  odin_set_dim(E0, 3, internal->dim_E0_1, internal->dim_E0_2, internal->dim_E0_3);
  SET_VECTOR_ELT(contents, 641, E0);
  SET_VECTOR_ELT(contents, 642, ScalarReal(internal->gamma_asympt));
  SET_VECTOR_ELT(contents, 643, ScalarReal(internal->gamma_comm_D));
  SET_VECTOR_ELT(contents, 644, ScalarReal(internal->gamma_E));
  SET_VECTOR_ELT(contents, 645, ScalarReal(internal->gamma_hosp_D));
  SET_VECTOR_ELT(contents, 646, ScalarReal(internal->gamma_hosp_R));
  SET_VECTOR_ELT(contents, 647, ScalarReal(internal->gamma_ICU_D));
  SET_VECTOR_ELT(contents, 648, ScalarReal(internal->gamma_ICU_R));
  SET_VECTOR_ELT(contents, 649, ScalarReal(internal->gamma_ILI));
  SET_VECTOR_ELT(contents, 650, ScalarReal(internal->gamma_mild));
  SET_VECTOR_ELT(contents, 651, ScalarReal(internal->gamma_R_pre));
  SET_VECTOR_ELT(contents, 652, ScalarReal(internal->gamma_stepdown));
  SET_VECTOR_ELT(contents, 653, ScalarReal(internal->gamma_test));
  SET_VECTOR_ELT(contents, 654, ScalarReal(internal->gamma_triage));
  SET_VECTOR_ELT(contents, 655, ScalarReal(internal->hosp_transmission));
  SEXP I_with_diff_trans = PROTECT(allocVector(REALSXP, internal->dim_I_with_diff_trans));
  memcpy(REAL(I_with_diff_trans), internal->I_with_diff_trans, internal->dim_I_with_diff_trans * sizeof(double));
  odin_set_dim(I_with_diff_trans, 2, internal->dim_I_with_diff_trans_1, internal->dim_I_with_diff_trans_2);
  SET_VECTOR_ELT(contents, 656, I_with_diff_trans);
  SEXP I0_asympt = PROTECT(allocVector(REALSXP, internal->dim_I0_asympt));
  memcpy(REAL(I0_asympt), internal->I0_asympt, internal->dim_I0_asympt * sizeof(double));
  odin_set_dim(I0_asympt, 3, internal->dim_I0_asympt_1, internal->dim_I0_asympt_2, internal->dim_I0_asympt_3);
  SET_VECTOR_ELT(contents, 657, I0_asympt);
  ...
  SET_VECTOR_ELT(contents, 658, I0_comm_D);
  ...
  SET_VECTOR_ELT(contents, 659, I0_hosp_D_conf);
  ...
  SET_VECTOR_ELT(contents, 660, I0_hosp_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 661, I0_hosp_R_conf);
  ...
  SET_VECTOR_ELT(contents, 662, I0_hosp_R_unconf);
  ...
  SET_VECTOR_ELT(contents, 663, I0_ICU_D_conf);
  ...
  SET_VECTOR_ELT(contents, 664, I0_ICU_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 665, I0_ICU_R_conf);
  ...
  SET_VECTOR_ELT(contents, 666, I0_ICU_R_unconf);
  SEXP I0_ILI = PROTECT(allocVector(REALSXP, internal->dim_I0_ILI));
  memcpy(REAL(I0_ILI), internal->I0_ILI, internal->dim_I0_ILI * sizeof(double));
  odin_set_dim(I0_ILI, 3, internal->dim_I0_ILI_1, internal->dim_I0_ILI_2, internal->dim_I0_ILI_3);
  SET_VECTOR_ELT(contents, 667, I0_ILI);
  SEXP I0_mild = PROTECT(allocVector(REALSXP, internal->dim_I0_mild));
  memcpy(REAL(I0_mild), internal->I0_mild, internal->dim_I0_mild * sizeof(double));
  odin_set_dim(I0_mild, 3, internal->dim_I0_mild_1, internal->dim_I0_mild_2, internal->dim_I0_mild_3);
  SET_VECTOR_ELT(contents, 668, I0_mild);
  ...
  SET_VECTOR_ELT(contents, 669, I0_triage_D_conf);
  ...
  SET_VECTOR_ELT(contents, 670, I0_triage_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 671, I0_triage_R_conf);
  ...
  SET_VECTOR_ELT(contents, 672, I0_triage_R_unconf);
  SET_VECTOR_ELT(contents, 673, ScalarReal(internal->ICU_transmission));
  SET_VECTOR_ELT(contents, 674, ScalarReal(internal->initial_cum_admit_conf));
  SET_VECTOR_ELT(contents, 675, ScalarReal(internal->initial_cum_new_conf));
  ...
  SET_VECTOR_ELT(contents, 676, initial_D_comm);
  ...
  SET_VECTOR_ELT(contents, 677, initial_D_hosp);
  SEXP initial_E = PROTECT(allocVector(REALSXP, internal->dim_E));
  memcpy(REAL(initial_E), internal->initial_E, internal->dim_E * sizeof(double));
  odin_set_dim(initial_E, 3, internal->dim_E_1, internal->dim_E_2, internal->dim_E_3);
  SET_VECTOR_ELT(contents, 678, initial_E);
  SEXP initial_I_asympt = PROTECT(allocVector(REALSXP, internal->dim_I_asympt));
  memcpy(REAL(initial_I_asympt), internal->initial_I_asympt, internal->dim_I_asympt * sizeof(double));
  odin_set_dim(initial_I_asympt, 3, internal->dim_I_asympt_1, internal->dim_I_asympt_2, internal->dim_I_asympt_3);
  SET_VECTOR_ELT(contents, 679, initial_I_asympt);
  ...
  SET_VECTOR_ELT(contents, 680, initial_I_comm_D);
  ...
  SET_VECTOR_ELT(contents, 681, initial_I_hosp_D_conf);
  ...
  SET_VECTOR_ELT(contents, 682, initial_I_hosp_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 683, initial_I_hosp_R_conf);
  ...
  SET_VECTOR_ELT(contents, 684, initial_I_hosp_R_unconf);
  ...
  SET_VECTOR_ELT(contents, 685, initial_I_ICU_D_conf);
  ...
  SET_VECTOR_ELT(contents, 686, initial_I_ICU_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 687, initial_I_ICU_R_conf);
  ...
  SET_VECTOR_ELT(contents, 688, initial_I_ICU_R_unconf);
  SEXP initial_I_ILI = PROTECT(allocVector(REALSXP, internal->dim_I_ILI));
  memcpy(REAL(initial_I_ILI), internal->initial_I_ILI, internal->dim_I_ILI * sizeof(double));
  odin_set_dim(initial_I_ILI, 3, internal->dim_I_ILI_1, internal->dim_I_ILI_2, internal->dim_I_ILI_3);
  SET_VECTOR_ELT(contents, 689, initial_I_ILI);
  SEXP initial_I_mild = PROTECT(allocVector(REALSXP, internal->dim_I_mild));
  memcpy(REAL(initial_I_mild), internal->initial_I_mild, internal->dim_I_mild * sizeof(double));
  odin_set_dim(initial_I_mild, 3, internal->dim_I_mild_1, internal->dim_I_mild_2, internal->dim_I_mild_3);
  SET_VECTOR_ELT(contents, 690, initial_I_mild);
  ...
  SET_VECTOR_ELT(contents, 691, initial_I_triage_D_conf);
  ...
  SET_VECTOR_ELT(contents, 692, initial_I_triage_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 693, initial_I_triage_R_conf);
  ...
  SET_VECTOR_ELT(contents, 694, initial_I_triage_R_unconf);
  SEXP initial_R = PROTECT(allocVector(REALSXP, internal->dim_R));
  memcpy(REAL(initial_R), internal->initial_R, internal->dim_R * sizeof(double));
  SET_VECTOR_ELT(contents, 695, initial_R);
  ...
  SET_VECTOR_ELT(contents, 696, initial_R_neg);
  ...
  SET_VECTOR_ELT(contents, 697, initial_R_pos);
  ...
  SET_VECTOR_ELT(contents, 698, initial_R_pre);
  ...
  SET_VECTOR_ELT(contents, 699, initial_R_stepdown_conf);
  ...
  SET_VECTOR_ELT(contents, 700, initial_R_stepdown_unconf);
  SEXP initial_S = PROTECT(allocVector(REALSXP, internal->dim_S));
  memcpy(REAL(initial_S), internal->initial_S, internal->dim_S * sizeof(double));
  SET_VECTOR_ELT(contents, 701, initial_S);
  SEXP lambda = PROTECT(allocVector(REALSXP, internal->dim_lambda));
  memcpy(REAL(lambda), internal->lambda, internal->dim_lambda * sizeof(double));
  SET_VECTOR_ELT(contents, 703, lambda);
  SEXP m = PROTECT(allocVector(REALSXP, internal->dim_m));
  memcpy(REAL(m), internal->m, internal->dim_m * sizeof(double));
  odin_set_dim(m, 2, internal->dim_m_1, internal->dim_m_2);
  SET_VECTOR_ELT(contents, 704, m);
  SET_VECTOR_ELT(contents, 705, ScalarInteger(internal->N_age));
  ...
  SET_VECTOR_ELT(contents, 706, n_com_to_R_pre);
  ...
  SET_VECTOR_ELT(contents, 707, n_com_to_R_total);
  SEXP n_EE = PROTECT(allocVector(REALSXP, internal->dim_n_EE));
  memcpy(REAL(n_EE), internal->n_EE, internal->dim_n_EE * sizeof(double));
  odin_set_dim(n_EE, 3, internal->dim_n_EE_1, internal->dim_n_EE_2, internal->dim_n_EE_3);
  SET_VECTOR_ELT(contents, 708, n_EE);
  SEXP n_EI_asympt = PROTECT(allocVector(REALSXP, internal->dim_n_EI_asympt));
  memcpy(REAL(n_EI_asympt), internal->n_EI_asympt, internal->dim_n_EI_asympt * sizeof(double));
  odin_set_dim(n_EI_asympt, 2, internal->dim_n_EI_asympt_1, internal->dim_n_EI_asympt_2);
  SET_VECTOR_ELT(contents, 709, n_EI_asympt);
  SEXP n_EI_ILI = PROTECT(allocVector(REALSXP, internal->dim_n_EI_ILI));
  memcpy(REAL(n_EI_ILI), internal->n_EI_ILI, internal->dim_n_EI_ILI * sizeof(double));
  odin_set_dim(n_EI_ILI, 2, internal->dim_n_EI_ILI_1, internal->dim_n_EI_ILI_2);
  SET_VECTOR_ELT(contents, 710, n_EI_ILI);
  SEXP n_EI_mild = PROTECT(allocVector(REALSXP, internal->dim_n_EI_mild));
  memcpy(REAL(n_EI_mild), internal->n_EI_mild, internal->dim_n_EI_mild * sizeof(double));
  odin_set_dim(n_EI_mild, 2, internal->dim_n_EI_mild_1, internal->dim_n_EI_mild_2);
  SET_VECTOR_ELT(contents, 711, n_EI_mild);
  ...
  SET_VECTOR_ELT(contents, 712, n_hosp_non_ICU);
  ...
  SET_VECTOR_ELT(contents, 713, n_I_hosp_D_unconf_to_conf);
  ...
  SET_VECTOR_ELT(contents, 714, n_I_hosp_R_unconf_to_conf);
  ...
  SET_VECTOR_ELT(contents, 715, n_I_ICU_D_unconf_to_conf);
  ...
  SET_VECTOR_ELT(contents, 716, n_I_ICU_R_unconf_to_conf);
  ...
  SET_VECTOR_ELT(contents, 717, n_I_triage_D_unconf_to_conf);
  ...
  SET_VECTOR_ELT(contents, 718, n_I_triage_R_unconf_to_conf);
  SEXP n_II_asympt = PROTECT(allocVector(REALSXP, internal->dim_n_II_asympt));
  memcpy(REAL(n_II_asympt), internal->n_II_asympt, internal->dim_n_II_asympt * sizeof(double));
  odin_set_dim(n_II_asympt, 3, internal->dim_n_II_asympt_1, internal->dim_n_II_asympt_2, internal->dim_n_II_asympt_3);
  SET_VECTOR_ELT(contents, 719, n_II_asympt);
  ...
  SET_VECTOR_ELT(contents, 720, n_II_comm_D);
  ...
  SET_VECTOR_ELT(contents, 721, n_II_hosp_D_conf);
  ...
  SET_VECTOR_ELT(contents, 722, n_II_hosp_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 723, n_II_hosp_R_conf);
  ...
  SET_VECTOR_ELT(contents, 724, n_II_hosp_R_unconf);
  ...
  SET_VECTOR_ELT(contents, 725, n_II_ICU_D_conf);
  ...
  SET_VECTOR_ELT(contents, 726, n_II_ICU_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 727, n_II_ICU_R_conf);
  ...
  SET_VECTOR_ELT(contents, 728, n_II_ICU_R_unconf);
  SEXP n_II_ILI = PROTECT(allocVector(REALSXP, internal->dim_n_II_ILI));
  memcpy(REAL(n_II_ILI), internal->n_II_ILI, internal->dim_n_II_ILI * sizeof(double));
  odin_set_dim(n_II_ILI, 3, internal->dim_n_II_ILI_1, internal->dim_n_II_ILI_2, internal->dim_n_II_ILI_3);
  SET_VECTOR_ELT(contents, 729, n_II_ILI);
  SEXP n_II_mild = PROTECT(allocVector(REALSXP, internal->dim_n_II_mild));
  memcpy(REAL(n_II_mild), internal->n_II_mild, internal->dim_n_II_mild * sizeof(double));
  odin_set_dim(n_II_mild, 3, internal->dim_n_II_mild_1, internal->dim_n_II_mild_2, internal->dim_n_II_mild_3);
  SET_VECTOR_ELT(contents, 730, n_II_mild);
  ...
  SET_VECTOR_ELT(contents, 731, n_II_triage_D_conf);
  ...
  SET_VECTOR_ELT(contents, 732, n_II_triage_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 733, n_II_triage_R_conf);
  ...
  SET_VECTOR_ELT(contents, 734, n_II_triage_R_unconf);
  ...
  SET_VECTOR_ELT(contents, 735, n_ILI_to_comm_D);
  SEXP n_ILI_to_hosp = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_hosp));
  memcpy(REAL(n_ILI_to_hosp), internal->n_ILI_to_hosp, internal->dim_n_ILI_to_hosp * sizeof(double));
  odin_set_dim(n_ILI_to_hosp, 2, internal->dim_n_ILI_to_hosp_1, internal->dim_n_ILI_to_hosp_2);
  SET_VECTOR_ELT(contents, 736, n_ILI_to_hosp);
  ...
  SET_VECTOR_ELT(contents, 737, n_ILI_to_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 738, n_ILI_to_hosp_D_conf);
  ...
  SET_VECTOR_ELT(contents, 739, n_ILI_to_hosp_R);
  ...
  SET_VECTOR_ELT(contents, 740, n_ILI_to_hosp_R_conf);
  ...
  SET_VECTOR_ELT(contents, 741, n_ILI_to_triage);
  ...
  SET_VECTOR_ELT(contents, 742, n_ILI_to_triage_D);
  ...
  SET_VECTOR_ELT(contents, 743, n_ILI_to_triage_D_conf);
  ...
  SET_VECTOR_ELT(contents, 744, n_ILI_to_triage_R);
  ...
  SET_VECTOR_ELT(contents, 745, n_ILI_to_triage_R_conf);
  ...
  SET_VECTOR_ELT(contents, 746, n_R_pre);
  ...
  SET_VECTOR_ELT(contents, 747, n_R_stepdown_conf);
  ...
  SET_VECTOR_ELT(contents, 748, n_R_stepdown_unconf);
  ...
  SET_VECTOR_ELT(contents, 749, n_R_stepdown_unconf_to_conf);
  SEXP n_SE = PROTECT(allocVector(REALSXP, internal->dim_n_SE));
  memcpy(REAL(n_SE), internal->n_SE, internal->dim_n_SE * sizeof(double));
  SET_VECTOR_ELT(contents, 750, n_SE);
  ...
  SET_VECTOR_ELT(contents, 751, N_tot);
  ...
  SET_VECTOR_ELT(contents, 752, new_I_hosp_D_conf);
  ...
  SET_VECTOR_ELT(contents, 753, new_I_hosp_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 754, new_I_hosp_R_conf);
  ...
  SET_VECTOR_ELT(contents, 755, new_I_hosp_R_unconf);
  ...
  SET_VECTOR_ELT(contents, 756, new_I_ICU_D_conf);
  ...
  SET_VECTOR_ELT(contents, 757, new_I_ICU_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 758, new_I_ICU_R_conf);
  ...
  SET_VECTOR_ELT(contents, 759, new_I_ICU_R_unconf);
  ...
  SET_VECTOR_ELT(contents, 760, new_I_triage_D_conf);
  ...
  SET_VECTOR_ELT(contents, 761, new_I_triage_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 762, new_I_triage_R_conf);
  ...
  SET_VECTOR_ELT(contents, 763, new_I_triage_R_unconf);
  ...
  SET_VECTOR_ELT(contents, 764, new_R_stepdown_conf);
  ...
  SET_VECTOR_ELT(contents, 765, new_R_stepdown_unconf);
  SET_VECTOR_ELT(contents, 766, ScalarInteger(internal->offset_variable_D_comm));
  SET_VECTOR_ELT(contents, 767, ScalarInteger(internal->offset_variable_D_hosp));
  SET_VECTOR_ELT(contents, 768, ScalarInteger(internal->offset_variable_E));
  SET_VECTOR_ELT(contents, 769, ScalarInteger(internal->offset_variable_I_asympt));
  SET_VECTOR_ELT(contents, 770, ScalarInteger(internal->offset_variable_I_comm_D));
  SET_VECTOR_ELT(contents, 771, ScalarInteger(internal->offset_variable_I_hosp_D_conf));
  SET_VECTOR_ELT(contents, 772, ScalarInteger(internal->offset_variable_I_hosp_D_unconf));
  SET_VECTOR_ELT(contents, 773, ScalarInteger(internal->offset_variable_I_hosp_R_conf));
  SET_VECTOR_ELT(contents, 774, ScalarInteger(internal->offset_variable_I_hosp_R_unconf));
  SET_VECTOR_ELT(contents, 775, ScalarInteger(internal->offset_variable_I_ICU_D_conf));
  SET_VECTOR_ELT(contents, 776, ScalarInteger(internal->offset_variable_I_ICU_D_unconf));
  SET_VECTOR_ELT(contents, 777, ScalarInteger(internal->offset_variable_I_ICU_R_conf));
  SET_VECTOR_ELT(contents, 778, ScalarInteger(internal->offset_variable_I_ICU_R_unconf));
  SET_VECTOR_ELT(contents, 779, ScalarInteger(internal->offset_variable_I_ILI));
  SET_VECTOR_ELT(contents, 780, ScalarInteger(internal->offset_variable_I_mild));
  SET_VECTOR_ELT(contents, 781, ScalarInteger(internal->offset_variable_I_triage_D_conf));
  SET_VECTOR_ELT(contents, 782, ScalarInteger(internal->offset_variable_I_triage_D_unconf));
  SET_VECTOR_ELT(contents, 783, ScalarInteger(internal->offset_variable_I_triage_R_conf));
  SET_VECTOR_ELT(contents, 784, ScalarInteger(internal->offset_variable_I_triage_R_unconf));
  SET_VECTOR_ELT(contents, 785, ScalarInteger(internal->offset_variable_R));
  SET_VECTOR_ELT(contents, 786, ScalarInteger(internal->offset_variable_R_neg));
  SET_VECTOR_ELT(contents, 787, ScalarInteger(internal->offset_variable_R_pos));
  SET_VECTOR_ELT(contents, 788, ScalarInteger(internal->offset_variable_R_pre));
  SET_VECTOR_ELT(contents, 789, ScalarInteger(internal->offset_variable_R_stepdown_conf));
  SET_VECTOR_ELT(contents, 790, ScalarInteger(internal->offset_variable_R_stepdown_unconf));
  ...
  SET_VECTOR_ELT(contents, 791, p_admit_conf);
  SEXP p_asympt = PROTECT(allocVector(REALSXP, internal->dim_p_asympt));
  memcpy(REAL(p_asympt), internal->p_asympt, internal->dim_p_asympt * sizeof(double));
  SET_VECTOR_ELT(contents, 792, p_asympt);
  ...
  SET_VECTOR_ELT(contents, 793, p_death_comm);
  ...
  SET_VECTOR_ELT(contents, 794, p_death_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 811, p_seroconversion);
  SEXP p_sympt_ILI = PROTECT(allocVector(REALSXP, internal->dim_p_sympt_ILI));
  memcpy(REAL(p_sympt_ILI), internal->p_sympt_ILI, internal->dim_p_sympt_ILI * sizeof(double));
  SET_VECTOR_ELT(contents, 812, p_sympt_ILI);
  SET_VECTOR_ELT(contents, 813, ScalarReal(internal->p_test));
  SEXP R0 = PROTECT(allocVector(REALSXP, internal->dim_R0));
  memcpy(REAL(R0), internal->R0, internal->dim_R0 * sizeof(double));
  SET_VECTOR_ELT(contents, 814, R0);
  ...
  SET_VECTOR_ELT(contents, 815, R0_neg);
  ...
  SET_VECTOR_ELT(contents, 816, R0_pos);
  ...
  SET_VECTOR_ELT(contents, 817, R0_pre);
  ...
  SET_VECTOR_ELT(contents, 818, R0_stepdown_conf);
  ...
  SET_VECTOR_ELT(contents, 819, R0_stepdown_unconf);
  SET_VECTOR_ELT(contents, 820, ScalarInteger(internal->s_asympt));
  SET_VECTOR_ELT(contents, 821, ScalarInteger(internal->s_comm_D));
  SET_VECTOR_ELT(contents, 822, ScalarInteger(internal->s_E));
  SET_VECTOR_ELT(contents, 823, ScalarInteger(internal->s_hosp_D));
  SET_VECTOR_ELT(contents, 824, ScalarInteger(internal->s_hosp_R));
  SET_VECTOR_ELT(contents, 825, ScalarInteger(internal->s_ICU_D));
  SET_VECTOR_ELT(contents, 826, ScalarInteger(internal->s_ICU_R));
  SEXP s_ij = PROTECT(allocVector(REALSXP, internal->dim_s_ij));
  memcpy(REAL(s_ij), internal->s_ij, internal->dim_s_ij * sizeof(double));
  odin_set_dim(s_ij, 2, internal->dim_s_ij_1, internal->dim_s_ij_2);
  SET_VECTOR_ELT(contents, 827, s_ij);
  SET_VECTOR_ELT(contents, 828, ScalarInteger(internal->s_ILI));
  SET_VECTOR_ELT(contents, 829, ScalarInteger(internal->s_mild));
  SET_VECTOR_ELT(contents, 830, ScalarInteger(internal->s_R_pre));
  SET_VECTOR_ELT(contents, 831, ScalarInteger(internal->s_stepdown));
  SET_VECTOR_ELT(contents, 832, ScalarInteger(internal->s_triage));
  SEXP S0 = PROTECT(allocVector(REALSXP, internal->dim_S0));
  memcpy(REAL(S0), internal->S0, internal->dim_S0 * sizeof(double));
  SET_VECTOR_ELT(contents, 833, S0);
  SET_VECTOR_ELT(contents, 834, ScalarInteger(internal->trans_classes));
  SEXP trans_increase = PROTECT(allocVector(REALSXP, internal->dim_trans_increase));
  memcpy(REAL(trans_increase), internal->trans_increase, internal->dim_trans_increase * sizeof(double));
  odin_set_dim(trans_increase, 2, internal->dim_trans_increase_1, internal->dim_trans_increase_2);
  SET_VECTOR_ELT(contents, 835, trans_increase);
  SEXP trans_profile = PROTECT(allocVector(REALSXP, internal->dim_trans_profile));
  memcpy(REAL(trans_profile), internal->trans_profile, internal->dim_trans_profile * sizeof(double));
  odin_set_dim(trans_profile, 2, internal->dim_trans_profile_1, internal->dim_trans_profile_2);
  SET_VECTOR_ELT(contents, 836, trans_profile);
  SEXP nms = PROTECT(allocVector(STRSXP, 837));
  SET_STRING_ELT(nms, 0, mkChar("aux_EE"));
  SET_STRING_ELT(nms, 1, mkChar("aux_II_asympt"));
  ...
  SET_STRING_ELT(nms, 527, mkChar("dim_N_tot"));
  SET_STRING_ELT(nms, 528, mkChar("dim_new_I_hosp_D_conf"));
  SET_STRING_ELT(nms, 529, mkChar("dim_new_I_hosp_D_conf_1"));
  SET_STRING_ELT(nms, 530, mkChar("dim_new_I_hosp_D_conf_12"));
  SET_STRING_ELT(nms, 531, mkChar("dim_new_I_hosp_D_conf_2"));
  SET_STRING_ELT(nms, 532, mkChar("dim_new_I_hosp_D_conf_3"));
  SET_STRING_ELT(nms, 533, mkChar("dim_new_I_hosp_D_unconf"));
  SET_STRING_ELT(nms, 534, mkChar("dim_new_I_hosp_D_unconf_1"));
  SET_STRING_ELT(nms, 535, mkChar("dim_new_I_hosp_D_unconf_12"));
  SET_STRING_ELT(nms, 536, mkChar("dim_new_I_hosp_D_unconf_2"));
  SET_STRING_ELT(nms, 537, mkChar("dim_new_I_hosp_D_unconf_3"));
  SET_STRING_ELT(nms, 538, mkChar("dim_new_I_hosp_R_conf"));
  SET_STRING_ELT(nms, 539, mkChar("dim_new_I_hosp_R_conf_1"));
  SET_STRING_ELT(nms, 540, mkChar("dim_new_I_hosp_R_conf_12"));
  SET_STRING_ELT(nms, 541, mkChar("dim_new_I_hosp_R_conf_2"));
  SET_STRING_ELT(nms, 542, mkChar("dim_new_I_hosp_R_conf_3"));
  SET_STRING_ELT(nms, 543, mkChar("dim_new_I_hosp_R_unconf"));
  SET_STRING_ELT(nms, 544, mkChar("dim_new_I_hosp_R_unconf_1"));
  SET_STRING_ELT(nms, 545, mkChar("dim_new_I_hosp_R_unconf_12"));
  SET_STRING_ELT(nms, 546, mkChar("dim_new_I_hosp_R_unconf_2"));
  SET_STRING_ELT(nms, 547, mkChar("dim_new_I_hosp_R_unconf_3"));
  SET_STRING_ELT(nms, 548, mkChar("dim_new_I_ICU_D_conf"));
  SET_STRING_ELT(nms, 549, mkChar("dim_new_I_ICU_D_conf_1"));
  SET_STRING_ELT(nms, 550, mkChar("dim_new_I_ICU_D_conf_12"));
  SET_STRING_ELT(nms, 551, mkChar("dim_new_I_ICU_D_conf_2"));
  SET_STRING_ELT(nms, 552, mkChar("dim_new_I_ICU_D_conf_3"));
  SET_STRING_ELT(nms, 553, mkChar("dim_new_I_ICU_D_unconf"));
  SET_STRING_ELT(nms, 554, mkChar("dim_new_I_ICU_D_unconf_1"));
  SET_STRING_ELT(nms, 555, mkChar("dim_new_I_ICU_D_unconf_12"));
  SET_STRING_ELT(nms, 556, mkChar("dim_new_I_ICU_D_unconf_2"));
  SET_STRING_ELT(nms, 557, mkChar("dim_new_I_ICU_D_unconf_3"));
  SET_STRING_ELT(nms, 558, mkChar("dim_new_I_ICU_R_conf"));
  SET_STRING_ELT(nms, 559, mkChar("dim_new_I_ICU_R_conf_1"));
  SET_STRING_ELT(nms, 560, mkChar("dim_new_I_ICU_R_conf_12"));
  SET_STRING_ELT(nms, 561, mkChar("dim_new_I_ICU_R_conf_2"));
  SET_STRING_ELT(nms, 562, mkChar("dim_new_I_ICU_R_conf_3"));
  SET_STRING_ELT(nms, 563, mkChar("dim_new_I_ICU_R_unconf"));
  SET_STRING_ELT(nms, 564, mkChar("dim_new_I_ICU_R_unconf_1"));
  SET_STRING_ELT(nms, 565, mkChar("dim_new_I_ICU_R_unconf_12"));
  SET_STRING_ELT(nms, 566, mkChar("dim_new_I_ICU_R_unconf_2"));
  SET_STRING_ELT(nms, 567, mkChar("dim_new_I_ICU_R_unconf_3"));
  SET_STRING_ELT(nms, 568, mkChar("dim_new_I_triage_D_conf"));
  SET_STRING_ELT(nms, 569, mkChar("dim_new_I_triage_D_conf_1"));
  SET_STRING_ELT(nms, 570, mkChar("dim_new_I_triage_D_conf_12"));
  SET_STRING_ELT(nms, 571, mkChar("dim_new_I_triage_D_conf_2"));
  SET_STRING_ELT(nms, 572, mkChar("dim_new_I_triage_D_conf_3"));
  SET_STRING_ELT(nms, 573, mkChar("dim_new_I_triage_D_unconf"));
  SET_STRING_ELT(nms, 574, mkChar("dim_new_I_triage_D_unconf_1"));
  SET_STRING_ELT(nms, 575, mkChar("dim_new_I_triage_D_unconf_12"));
  SET_STRING_ELT(nms, 576, mkChar("dim_new_I_triage_D_unconf_2"));
  SET_STRING_ELT(nms, 577, mkChar("dim_new_I_triage_D_unconf_3"));
  SET_STRING_ELT(nms, 578, mkChar("dim_new_I_triage_R_conf"));
  SET_STRING_ELT(nms, 579, mkChar("dim_new_I_triage_R_conf_1"));
  SET_STRING_ELT(nms, 580, mkChar("dim_new_I_triage_R_conf_12"));
  SET_STRING_ELT(nms, 581, mkChar("dim_new_I_triage_R_conf_2"));
  SET_STRING_ELT(nms, 582, mkChar("dim_new_I_triage_R_conf_3"));
  SET_STRING_ELT(nms, 583, mkChar("dim_new_I_triage_R_unconf"));
  SET_STRING_ELT(nms, 584, mkChar("dim_new_I_triage_R_unconf_1"));
  SET_STRING_ELT(nms, 585, mkChar("dim_new_I_triage_R_unconf_12"));
  SET_STRING_ELT(nms, 586, mkChar("dim_new_I_triage_R_unconf_2"));
  SET_STRING_ELT(nms, 587, mkChar("dim_new_I_triage_R_unconf_3"));
  SET_STRING_ELT(nms, 588, mkChar("dim_new_R_stepdown_conf"));
  SET_STRING_ELT(nms, 589, mkChar("dim_new_R_stepdown_conf_1"));
  SET_STRING_ELT(nms, 590, mkChar("dim_new_R_stepdown_conf_2"));
  SET_STRING_ELT(nms, 591, mkChar("dim_new_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 592, mkChar("dim_new_R_stepdown_unconf_1"));
  SET_STRING_ELT(nms, 593, mkChar("dim_new_R_stepdown_unconf_2"));
  SET_STRING_ELT(nms, 594, mkChar("dim_p_admit_conf"));
  SET_STRING_ELT(nms, 595, mkChar("dim_p_asympt"));
  ...
  SET_STRING_ELT(nms, 605, mkChar("dim_R"));
  SET_STRING_ELT(nms, 606, mkChar("dim_R_neg"));
  SET_STRING_ELT(nms, 607, mkChar("dim_R_pos"));
  SET_STRING_ELT(nms, 608, mkChar("dim_R_pre"));
  SET_STRING_ELT(nms, 609, mkChar("dim_R_pre_1"));
  SET_STRING_ELT(nms, 610, mkChar("dim_R_pre_2"));
  SET_STRING_ELT(nms, 611, mkChar("dim_R_stepdown_conf"));
  SET_STRING_ELT(nms, 612, mkChar("dim_R_stepdown_conf_1"));
  SET_STRING_ELT(nms, 613, mkChar("dim_R_stepdown_conf_2"));
  SET_STRING_ELT(nms, 614, mkChar("dim_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 615, mkChar("dim_R_stepdown_unconf_1"));
  SET_STRING_ELT(nms, 616, mkChar("dim_R_stepdown_unconf_2"));
  SET_STRING_ELT(nms, 617, mkChar("dim_R0"));
  SET_STRING_ELT(nms, 618, mkChar("dim_R0_neg"));
  SET_STRING_ELT(nms, 619, mkChar("dim_R0_pos"));
  SET_STRING_ELT(nms, 620, mkChar("dim_R0_pre"));
  SET_STRING_ELT(nms, 621, mkChar("dim_R0_pre_1"));
  SET_STRING_ELT(nms, 622, mkChar("dim_R0_pre_2"));
  SET_STRING_ELT(nms, 623, mkChar("dim_R0_stepdown_conf"));
  SET_STRING_ELT(nms, 624, mkChar("dim_R0_stepdown_conf_1"));
  SET_STRING_ELT(nms, 625, mkChar("dim_R0_stepdown_conf_2"));
  SET_STRING_ELT(nms, 626, mkChar("dim_R0_stepdown_unconf"));
  SET_STRING_ELT(nms, 627, mkChar("dim_R0_stepdown_unconf_1"));
  SET_STRING_ELT(nms, 628, mkChar("dim_R0_stepdown_unconf_2"));
  SET_STRING_ELT(nms, 629, mkChar("dim_S"));
  SET_STRING_ELT(nms, 630, mkChar("dim_s_ij"));
  SET_STRING_ELT(nms, 631, mkChar("dim_s_ij_1"));
  SET_STRING_ELT(nms, 632, mkChar("dim_s_ij_2"));
  SET_STRING_ELT(nms, 633, mkChar("dim_S0"));
  SET_STRING_ELT(nms, 634, mkChar("dim_trans_increase"));
  SET_STRING_ELT(nms, 635, mkChar("dim_trans_increase_1"));
  SET_STRING_ELT(nms, 636, mkChar("dim_trans_increase_2"));
  SET_STRING_ELT(nms, 637, mkChar("dim_trans_profile"));
  SET_STRING_ELT(nms, 638, mkChar("dim_trans_profile_1"));
  SET_STRING_ELT(nms, 639, mkChar("dim_trans_profile_2"));
  SET_STRING_ELT(nms, 640, mkChar("dt"));
  SET_STRING_ELT(nms, 641, mkChar("E0"));
  SET_STRING_ELT(nms, 642, mkChar("gamma_asympt"));
  SET_STRING_ELT(nms, 643, mkChar("gamma_comm_D"));
  SET_STRING_ELT(nms, 644, mkChar("gamma_E"));
  SET_STRING_ELT(nms, 645, mkChar("gamma_hosp_D"));
  SET_STRING_ELT(nms, 646, mkChar("gamma_hosp_R"));
  SET_STRING_ELT(nms, 647, mkChar("gamma_ICU_D"));
  SET_STRING_ELT(nms, 648, mkChar("gamma_ICU_R"));
  SET_STRING_ELT(nms, 649, mkChar("gamma_ILI"));
  SET_STRING_ELT(nms, 650, mkChar("gamma_mild"));
  SET_STRING_ELT(nms, 651, mkChar("gamma_R_pre"));
  SET_STRING_ELT(nms, 652, mkChar("gamma_stepdown"));
  SET_STRING_ELT(nms, 653, mkChar("gamma_test"));
  SET_STRING_ELT(nms, 654, mkChar("gamma_triage"));
  SET_STRING_ELT(nms, 655, mkChar("hosp_transmission"));
  SET_STRING_ELT(nms, 656, mkChar("I_with_diff_trans"));
  SET_STRING_ELT(nms, 657, mkChar("I0_asympt"));
  SET_STRING_ELT(nms, 658, mkChar("I0_comm_D"));
  SET_STRING_ELT(nms, 659, mkChar("I0_hosp_D_conf"));
  SET_STRING_ELT(nms, 660, mkChar("I0_hosp_D_unconf"));
  SET_STRING_ELT(nms, 661, mkChar("I0_hosp_R_conf"));
  SET_STRING_ELT(nms, 662, mkChar("I0_hosp_R_unconf"));
  SET_STRING_ELT(nms, 663, mkChar("I0_ICU_D_conf"));
  SET_STRING_ELT(nms, 664, mkChar("I0_ICU_D_unconf"));
  SET_STRING_ELT(nms, 665, mkChar("I0_ICU_R_conf"));
  SET_STRING_ELT(nms, 666, mkChar("I0_ICU_R_unconf"));
  SET_STRING_ELT(nms, 667, mkChar("I0_ILI"));
  SET_STRING_ELT(nms, 668, mkChar("I0_mild"));
  SET_STRING_ELT(nms, 669, mkChar("I0_triage_D_conf"));
  SET_STRING_ELT(nms, 670, mkChar("I0_triage_D_unconf"));
  SET_STRING_ELT(nms, 671, mkChar("I0_triage_R_conf"));
  SET_STRING_ELT(nms, 672, mkChar("I0_triage_R_unconf"));
  SET_STRING_ELT(nms, 673, mkChar("ICU_transmission"));
  SET_STRING_ELT(nms, 674, mkChar("initial_cum_admit_conf"));
  SET_STRING_ELT(nms, 675, mkChar("initial_cum_new_conf"));
  SET_STRING_ELT(nms, 676, mkChar("initial_D_comm"));
  SET_STRING_ELT(nms, 677, mkChar("initial_D_hosp"));
  SET_STRING_ELT(nms, 678, mkChar("initial_E"));
  SET_STRING_ELT(nms, 679, mkChar("initial_I_asympt"));
  SET_STRING_ELT(nms, 680, mkChar("initial_I_comm_D"));
  SET_STRING_ELT(nms, 681, mkChar("initial_I_hosp_D_conf"));
  SET_STRING_ELT(nms, 682, mkChar("initial_I_hosp_D_unconf"));
  SET_STRING_ELT(nms, 683, mkChar("initial_I_hosp_R_conf"));
  SET_STRING_ELT(nms, 684, mkChar("initial_I_hosp_R_unconf"));
  SET_STRING_ELT(nms, 685, mkChar("initial_I_ICU_D_conf"));
  SET_STRING_ELT(nms, 686, mkChar("initial_I_ICU_D_unconf"));
  SET_STRING_ELT(nms, 687, mkChar("initial_I_ICU_R_conf"));
  SET_STRING_ELT(nms, 688, mkChar("initial_I_ICU_R_unconf"));
  SET_STRING_ELT(nms, 689, mkChar("initial_I_ILI"));
  SET_STRING_ELT(nms, 690, mkChar("initial_I_mild"));
  SET_STRING_ELT(nms, 691, mkChar("initial_I_triage_D_conf"));
  SET_STRING_ELT(nms, 692, mkChar("initial_I_triage_D_unconf"));
  SET_STRING_ELT(nms, 693, mkChar("initial_I_triage_R_conf"));
  SET_STRING_ELT(nms, 694, mkChar("initial_I_triage_R_unconf"));
  SET_STRING_ELT(nms, 695, mkChar("initial_R"));
  SET_STRING_ELT(nms, 696, mkChar("initial_R_neg"));
  SET_STRING_ELT(nms, 697, mkChar("initial_R_pos"));
  SET_STRING_ELT(nms, 698, mkChar("initial_R_pre"));
  SET_STRING_ELT(nms, 699, mkChar("initial_R_stepdown_conf"));
  SET_STRING_ELT(nms, 700, mkChar("initial_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 701, mkChar("initial_S"));
  SET_STRING_ELT(nms, 702, mkChar("interpolate_beta"));
  SET_STRING_ELT(nms, 703, mkChar("lambda"));
  SET_STRING_ELT(nms, 704, mkChar("m"));
  SET_STRING_ELT(nms, 705, mkChar("N_age"));
  SET_STRING_ELT(nms, 706, mkChar("n_com_to_R_pre"));
  SET_STRING_ELT(nms, 707, mkChar("n_com_to_R_total"));
  SET_STRING_ELT(nms, 708, mkChar("n_EE"));
  SET_STRING_ELT(nms, 709, mkChar("n_EI_asympt"));
  SET_STRING_ELT(nms, 710, mkChar("n_EI_ILI"));
  SET_STRING_ELT(nms, 711, mkChar("n_EI_mild"));
  SET_STRING_ELT(nms, 712, mkChar("n_hosp_non_ICU"));
  SET_STRING_ELT(nms, 713, mkChar("n_I_hosp_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 714, mkChar("n_I_hosp_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 715, mkChar("n_I_ICU_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 716, mkChar("n_I_ICU_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 717, mkChar("n_I_triage_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 718, mkChar("n_I_triage_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 719, mkChar("n_II_asympt"));
  SET_STRING_ELT(nms, 720, mkChar("n_II_comm_D"));
  SET_STRING_ELT(nms, 721, mkChar("n_II_hosp_D_conf"));
  SET_STRING_ELT(nms, 722, mkChar("n_II_hosp_D_unconf"));
  SET_STRING_ELT(nms, 723, mkChar("n_II_hosp_R_conf"));
  SET_STRING_ELT(nms, 724, mkChar("n_II_hosp_R_unconf"));
  SET_STRING_ELT(nms, 725, mkChar("n_II_ICU_D_conf"));
  SET_STRING_ELT(nms, 726, mkChar("n_II_ICU_D_unconf"));
  SET_STRING_ELT(nms, 727, mkChar("n_II_ICU_R_conf"));
  SET_STRING_ELT(nms, 728, mkChar("n_II_ICU_R_unconf"));
  SET_STRING_ELT(nms, 729, mkChar("n_II_ILI"));
  SET_STRING_ELT(nms, 730, mkChar("n_II_mild"));
  SET_STRING_ELT(nms, 731, mkChar("n_II_triage_D_conf"));
  SET_STRING_ELT(nms, 732, mkChar("n_II_triage_D_unconf"));
  SET_STRING_ELT(nms, 733, mkChar("n_II_triage_R_conf"));
  SET_STRING_ELT(nms, 734, mkChar("n_II_triage_R_unconf"));
  SET_STRING_ELT(nms, 735, mkChar("n_ILI_to_comm_D"));
  SET_STRING_ELT(nms, 736, mkChar("n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 737, mkChar("n_ILI_to_hosp_D"));
  SET_STRING_ELT(nms, 738, mkChar("n_ILI_to_hosp_D_conf"));
  SET_STRING_ELT(nms, 739, mkChar("n_ILI_to_hosp_R"));
  SET_STRING_ELT(nms, 740, mkChar("n_ILI_to_hosp_R_conf"));
  SET_STRING_ELT(nms, 741, mkChar("n_ILI_to_triage"));
  SET_STRING_ELT(nms, 742, mkChar("n_ILI_to_triage_D"));
  SET_STRING_ELT(nms, 743, mkChar("n_ILI_to_triage_D_conf"));
  SET_STRING_ELT(nms, 744, mkChar("n_ILI_to_triage_R"));
  SET_STRING_ELT(nms, 745, mkChar("n_ILI_to_triage_R_conf"));
  SET_STRING_ELT(nms, 746, mkChar("n_R_pre"));
  SET_STRING_ELT(nms, 747, mkChar("n_R_stepdown_conf"));
  SET_STRING_ELT(nms, 748, mkChar("n_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 749, mkChar("n_R_stepdown_unconf_to_conf"));
  SET_STRING_ELT(nms, 750, mkChar("n_SE"));
  SET_STRING_ELT(nms, 751, mkChar("N_tot"));
  SET_STRING_ELT(nms, 752, mkChar("new_I_hosp_D_conf"));
  SET_STRING_ELT(nms, 753, mkChar("new_I_hosp_D_unconf"));
  SET_STRING_ELT(nms, 754, mkChar("new_I_hosp_R_conf"));
  SET_STRING_ELT(nms, 755, mkChar("new_I_hosp_R_unconf"));
  SET_STRING_ELT(nms, 756, mkChar("new_I_ICU_D_conf"));
  SET_STRING_ELT(nms, 757, mkChar("new_I_ICU_D_unconf"));
  SET_STRING_ELT(nms, 758, mkChar("new_I_ICU_R_conf"));
  SET_STRING_ELT(nms, 759, mkChar("new_I_ICU_R_unconf"));
  SET_STRING_ELT(nms, 760, mkChar("new_I_triage_D_conf"));
  SET_STRING_ELT(nms, 761, mkChar("new_I_triage_D_unconf"));
  SET_STRING_ELT(nms, 762, mkChar("new_I_triage_R_conf"));
  SET_STRING_ELT(nms, 763, mkChar("new_I_triage_R_unconf"));
  SET_STRING_ELT(nms, 764, mkChar("new_R_stepdown_conf"));
  SET_STRING_ELT(nms, 765, mkChar("new_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 766, mkChar("offset_variable_D_comm"));
  SET_STRING_ELT(nms, 767, mkChar("offset_variable_D_hosp"));
  SET_STRING_ELT(nms, 768, mkChar("offset_variable_E"));
  SET_STRING_ELT(nms, 769, mkChar("offset_variable_I_asympt"));
  SET_STRING_ELT(nms, 770, mkChar("offset_variable_I_comm_D"));
  SET_STRING_ELT(nms, 771, mkChar("offset_variable_I_hosp_D_conf"));
  SET_STRING_ELT(nms, 772, mkChar("offset_variable_I_hosp_D_unconf"));
  SET_STRING_ELT(nms, 773, mkChar("offset_variable_I_hosp_R_conf"));
  SET_STRING_ELT(nms, 774, mkChar("offset_variable_I_hosp_R_unconf"));
  SET_STRING_ELT(nms, 775, mkChar("offset_variable_I_ICU_D_conf"));
  SET_STRING_ELT(nms, 776, mkChar("offset_variable_I_ICU_D_unconf"));
  SET_STRING_ELT(nms, 777, mkChar("offset_variable_I_ICU_R_conf"));
  SET_STRING_ELT(nms, 778, mkChar("offset_variable_I_ICU_R_unconf"));
  SET_STRING_ELT(nms, 779, mkChar("offset_variable_I_ILI"));
  SET_STRING_ELT(nms, 780, mkChar("offset_variable_I_mild"));
  SET_STRING_ELT(nms, 781, mkChar("offset_variable_I_triage_D_conf"));
  SET_STRING_ELT(nms, 782, mkChar("offset_variable_I_triage_D_unconf"));
  SET_STRING_ELT(nms, 783, mkChar("offset_variable_I_triage_R_conf"));
  SET_STRING_ELT(nms, 784, mkChar("offset_variable_I_triage_R_unconf"));
  SET_STRING_ELT(nms, 785, mkChar("offset_variable_R"));
  SET_STRING_ELT(nms, 786, mkChar("offset_variable_R_neg"));
  SET_STRING_ELT(nms, 787, mkChar("offset_variable_R_pos"));
  SET_STRING_ELT(nms, 788, mkChar("offset_variable_R_pre"));
  SET_STRING_ELT(nms, 789, mkChar("offset_variable_R_stepdown_conf"));
  SET_STRING_ELT(nms, 790, mkChar("offset_variable_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 791, mkChar("p_admit_conf"));
  SET_STRING_ELT(nms, 792, mkChar("p_asympt"));
  SET_STRING_ELT(nms, 793, mkChar("p_death_comm"));
  ...
  SET_STRING_ELT(nms, 813, mkChar("p_test"));
  SET_STRING_ELT(nms, 814, mkChar("R0"));
  SET_STRING_ELT(nms, 815, mkChar("R0_neg"));
  SET_STRING_ELT(nms, 816, mkChar("R0_pos"));
  SET_STRING_ELT(nms, 817, mkChar("R0_pre"));
  SET_STRING_ELT(nms, 818, mkChar("R0_stepdown_conf"));
  SET_STRING_ELT(nms, 819, mkChar("R0_stepdown_unconf"));
  SET_STRING_ELT(nms, 820, mkChar("s_asympt"));
  SET_STRING_ELT(nms, 821, mkChar("s_comm_D"));
  SET_STRING_ELT(nms, 822, mkChar("s_E"));
  SET_STRING_ELT(nms, 823, mkChar("s_hosp_D"));
  SET_STRING_ELT(nms, 824, mkChar("s_hosp_R"));
  SET_STRING_ELT(nms, 825, mkChar("s_ICU_D"));
  SET_STRING_ELT(nms, 826, mkChar("s_ICU_R"));
  SET_STRING_ELT(nms, 827, mkChar("s_ij"));
  SET_STRING_ELT(nms, 828, mkChar("s_ILI"));
  SET_STRING_ELT(nms, 829, mkChar("s_mild"));
  SET_STRING_ELT(nms, 830, mkChar("s_R_pre"));
  SET_STRING_ELT(nms, 831, mkChar("s_stepdown"));
  SET_STRING_ELT(nms, 832, mkChar("s_triage"));
  SET_STRING_ELT(nms, 833, mkChar("S0"));
  SET_STRING_ELT(nms, 834, mkChar("trans_classes"));
  SET_STRING_ELT(nms, 835, mkChar("trans_increase"));
  SET_STRING_ELT(nms, 836, mkChar("trans_profile"));
  setAttrib(contents, R_NamesSymbol, nms);
  UNPROTECT(165);
  return contents;
}
