...
typedef struct hospital_with_serology_testing_internal {
  ...
  int dim_aux_II_triage_R_123;
  int dim_aux_II_triage_R_2;
  int dim_aux_II_triage_R_3;
  int dim_aux_II_triage_R_4;
  int dim_aux_p_bin;
  int dim_aux_p_bin_1;
  int dim_aux_p_bin_2;
  int dim_aux_R_pre;
  ...
  int dim_n_II_triage_R_123;
  int dim_n_II_triage_R_2;
  int dim_n_II_triage_R_3;
  int dim_n_II_triage_R_4;
  ...
  int dim_new_I_triage_R;
  int dim_new_I_triage_R_1;
  int dim_new_I_triage_R_12;
  int dim_new_I_triage_R_123;
  int dim_new_I_triage_R_2;
  int dim_new_I_triage_R_3;
  int dim_new_I_triage_R_4;
...
SEXP hospital_with_serology_testing_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 775));
  SEXP aux_EE = PROTECT(allocVector(REALSXP, internal->dim_aux_EE));
  memcpy(REAL(aux_EE), internal->aux_EE, internal->dim_aux_EE * sizeof(double));
  odin_set_dim(aux_EE, 3, internal->dim_aux_EE_1, internal->dim_aux_EE_2, internal->dim_aux_EE_3);
  SET_VECTOR_ELT(contents, 0, aux_EE);
  ...
  odin_set_dim(aux_II_triage_R, 4, internal->dim_aux_II_triage_R_1, internal->dim_aux_II_triage_R_2, internal->dim_aux_II_triage_R_3, internal->dim_aux_II_triage_R_4);
  SET_VECTOR_ELT(contents, 13, aux_II_triage_R);
  SEXP aux_p_bin = PROTECT(allocVector(REALSXP, internal->dim_aux_p_bin));
  memcpy(REAL(aux_p_bin), internal->aux_p_bin, internal->dim_aux_p_bin * sizeof(double));
  odin_set_dim(aux_p_bin, 2, internal->dim_aux_p_bin_1, internal->dim_aux_p_bin_2);
  SET_VECTOR_ELT(contents, 14, aux_p_bin);
  ...
  SET_VECTOR_ELT(contents, 15, aux_R_pre);
  ...
  SET_VECTOR_ELT(contents, 16, aux_R_stepdown_conf);
  ...
  SET_VECTOR_ELT(contents, 17, aux_R_stepdown_unconf);
  SEXP beta_t = PROTECT(allocVector(REALSXP, internal->dim_beta_t));
  memcpy(REAL(beta_t), internal->beta_t, internal->dim_beta_t * sizeof(double));
  ...
  SET_VECTOR_ELT(contents, 21, ScalarReal(internal->cum0_admit_conf));
  SET_VECTOR_ELT(contents, 22, ScalarReal(internal->cum0_new_conf));
  ...
  SET_VECTOR_ELT(contents, 54, ScalarInteger(internal->dim_aux_II_hosp_D_123));
  SET_VECTOR_ELT(contents, 55, ScalarInteger(internal->dim_aux_II_hosp_D_2));
  SET_VECTOR_ELT(contents, 56, ScalarInteger(internal->dim_aux_II_hosp_D_3));
  SET_VECTOR_ELT(contents, 57, ScalarInteger(internal->dim_aux_II_hosp_D_4));
  SET_VECTOR_ELT(contents, 58, ScalarInteger(internal->dim_aux_II_hosp_R));
  SET_VECTOR_ELT(contents, 59, ScalarInteger(internal->dim_aux_II_hosp_R_1));
  SET_VECTOR_ELT(contents, 60, ScalarInteger(internal->dim_aux_II_hosp_R_12));
  SET_VECTOR_ELT(contents, 61, ScalarInteger(internal->dim_aux_II_hosp_R_123));
  SET_VECTOR_ELT(contents, 62, ScalarInteger(internal->dim_aux_II_hosp_R_2));
  SET_VECTOR_ELT(contents, 63, ScalarInteger(internal->dim_aux_II_hosp_R_3));
  SET_VECTOR_ELT(contents, 64, ScalarInteger(internal->dim_aux_II_hosp_R_4));
  SET_VECTOR_ELT(contents, 65, ScalarInteger(internal->dim_aux_II_ICU_D_conf));
  SET_VECTOR_ELT(contents, 66, ScalarInteger(internal->dim_aux_II_ICU_D_conf_1));
  SET_VECTOR_ELT(contents, 67, ScalarInteger(internal->dim_aux_II_ICU_D_conf_12));
  SET_VECTOR_ELT(contents, 68, ScalarInteger(internal->dim_aux_II_ICU_D_conf_2));
  SET_VECTOR_ELT(contents, 69, ScalarInteger(internal->dim_aux_II_ICU_D_conf_3));
  SET_VECTOR_ELT(contents, 70, ScalarInteger(internal->dim_aux_II_ICU_D_unconf));
  SET_VECTOR_ELT(contents, 71, ScalarInteger(internal->dim_aux_II_ICU_D_unconf_1));
  SET_VECTOR_ELT(contents, 72, ScalarInteger(internal->dim_aux_II_ICU_D_unconf_12));
  SET_VECTOR_ELT(contents, 73, ScalarInteger(internal->dim_aux_II_ICU_D_unconf_2));
  SET_VECTOR_ELT(contents, 74, ScalarInteger(internal->dim_aux_II_ICU_D_unconf_3));
  SET_VECTOR_ELT(contents, 75, ScalarInteger(internal->dim_aux_II_ICU_R_conf));
  SET_VECTOR_ELT(contents, 76, ScalarInteger(internal->dim_aux_II_ICU_R_conf_1));
  SET_VECTOR_ELT(contents, 77, ScalarInteger(internal->dim_aux_II_ICU_R_conf_12));
  SET_VECTOR_ELT(contents, 78, ScalarInteger(internal->dim_aux_II_ICU_R_conf_2));
  SET_VECTOR_ELT(contents, 79, ScalarInteger(internal->dim_aux_II_ICU_R_conf_3));
  SET_VECTOR_ELT(contents, 80, ScalarInteger(internal->dim_aux_II_ICU_R_unconf));
  SET_VECTOR_ELT(contents, 81, ScalarInteger(internal->dim_aux_II_ICU_R_unconf_1));
  SET_VECTOR_ELT(contents, 82, ScalarInteger(internal->dim_aux_II_ICU_R_unconf_12));
  SET_VECTOR_ELT(contents, 83, ScalarInteger(internal->dim_aux_II_ICU_R_unconf_2));
  SET_VECTOR_ELT(contents, 84, ScalarInteger(internal->dim_aux_II_ICU_R_unconf_3));
  SET_VECTOR_ELT(contents, 85, ScalarInteger(internal->dim_aux_II_ILI));
  SET_VECTOR_ELT(contents, 86, ScalarInteger(internal->dim_aux_II_ILI_1));
  SET_VECTOR_ELT(contents, 87, ScalarInteger(internal->dim_aux_II_ILI_12));
  SET_VECTOR_ELT(contents, 88, ScalarInteger(internal->dim_aux_II_ILI_2));
  SET_VECTOR_ELT(contents, 89, ScalarInteger(internal->dim_aux_II_ILI_3));
  SET_VECTOR_ELT(contents, 90, ScalarInteger(internal->dim_aux_II_mild));
  SET_VECTOR_ELT(contents, 91, ScalarInteger(internal->dim_aux_II_mild_1));
  SET_VECTOR_ELT(contents, 92, ScalarInteger(internal->dim_aux_II_mild_12));
  SET_VECTOR_ELT(contents, 93, ScalarInteger(internal->dim_aux_II_mild_2));
  SET_VECTOR_ELT(contents, 94, ScalarInteger(internal->dim_aux_II_mild_3));
  SET_VECTOR_ELT(contents, 95, ScalarInteger(internal->dim_aux_II_triage_D_conf));
  SET_VECTOR_ELT(contents, 96, ScalarInteger(internal->dim_aux_II_triage_D_conf_1));
  SET_VECTOR_ELT(contents, 97, ScalarInteger(internal->dim_aux_II_triage_D_conf_12));
  SET_VECTOR_ELT(contents, 98, ScalarInteger(internal->dim_aux_II_triage_D_conf_2));
  SET_VECTOR_ELT(contents, 99, ScalarInteger(internal->dim_aux_II_triage_D_conf_3));
  SET_VECTOR_ELT(contents, 100, ScalarInteger(internal->dim_aux_II_triage_D_unconf));
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_aux_II_triage_D_unconf_1));
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_aux_II_triage_D_unconf_12));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_aux_II_triage_D_unconf_2));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_aux_II_triage_D_unconf_3));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_aux_II_triage_R));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_aux_II_triage_R_1));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_aux_II_triage_R_12));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_aux_II_triage_R_123));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_aux_II_triage_R_2));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_aux_II_triage_R_3));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_aux_II_triage_R_4));
  ...
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_aux_R_stepdown_conf));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_aux_R_stepdown_conf_1));
  SET_VECTOR_ELT(contents, 120, ScalarInteger(internal->dim_aux_R_stepdown_conf_2));
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->dim_aux_R_stepdown_unconf));
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_aux_R_stepdown_unconf_1));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_aux_R_stepdown_unconf_2));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_beta_t));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_beta_y));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_D_comm));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_D_hosp));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_D0_comm));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_D0_hosp));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_delta_D_comm));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_delta_D_hosp));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_delta_E));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_delta_E_1));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_delta_E_12));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_delta_E_2));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_delta_E_3));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_delta_I_asympt));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_delta_I_asympt_1));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->dim_delta_I_asympt_12));
  SET_VECTOR_ELT(contents, 140, ScalarInteger(internal->dim_delta_I_asympt_2));
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_delta_I_asympt_3));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_delta_I_comm_D));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_delta_I_comm_D_1));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_delta_I_comm_D_12));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->dim_delta_I_comm_D_2));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->dim_delta_I_comm_D_3));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->dim_delta_I_ILI));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->dim_delta_I_ILI_1));
  SET_VECTOR_ELT(contents, 149, ScalarInteger(internal->dim_delta_I_ILI_12));
  SET_VECTOR_ELT(contents, 150, ScalarInteger(internal->dim_delta_I_ILI_2));
  SET_VECTOR_ELT(contents, 151, ScalarInteger(internal->dim_delta_I_ILI_3));
  SET_VECTOR_ELT(contents, 152, ScalarInteger(internal->dim_delta_I_mild));
  SET_VECTOR_ELT(contents, 153, ScalarInteger(internal->dim_delta_I_mild_1));
  SET_VECTOR_ELT(contents, 154, ScalarInteger(internal->dim_delta_I_mild_12));
  SET_VECTOR_ELT(contents, 155, ScalarInteger(internal->dim_delta_I_mild_2));
  SET_VECTOR_ELT(contents, 156, ScalarInteger(internal->dim_delta_I_mild_3));
  SET_VECTOR_ELT(contents, 157, ScalarInteger(internal->dim_delta_R));
  SET_VECTOR_ELT(contents, 158, ScalarInteger(internal->dim_delta_R_neg));
  SET_VECTOR_ELT(contents, 159, ScalarInteger(internal->dim_delta_R_pos));
  SET_VECTOR_ELT(contents, 160, ScalarInteger(internal->dim_delta_R_pre));
  SET_VECTOR_ELT(contents, 161, ScalarInteger(internal->dim_delta_R_pre_1));
  SET_VECTOR_ELT(contents, 162, ScalarInteger(internal->dim_delta_R_pre_2));
  SET_VECTOR_ELT(contents, 163, ScalarInteger(internal->dim_E));
  SET_VECTOR_ELT(contents, 164, ScalarInteger(internal->dim_E_1));
  SET_VECTOR_ELT(contents, 165, ScalarInteger(internal->dim_E_12));
  SET_VECTOR_ELT(contents, 166, ScalarInteger(internal->dim_E_2));
  SET_VECTOR_ELT(contents, 167, ScalarInteger(internal->dim_E_3));
  SET_VECTOR_ELT(contents, 168, ScalarInteger(internal->dim_E0));
  SET_VECTOR_ELT(contents, 169, ScalarInteger(internal->dim_E0_1));
  SET_VECTOR_ELT(contents, 170, ScalarInteger(internal->dim_E0_12));
  SET_VECTOR_ELT(contents, 171, ScalarInteger(internal->dim_E0_2));
  SET_VECTOR_ELT(contents, 172, ScalarInteger(internal->dim_E0_3));
  SET_VECTOR_ELT(contents, 173, ScalarInteger(internal->dim_I_asympt));
  SET_VECTOR_ELT(contents, 174, ScalarInteger(internal->dim_I_asympt_1));
  SET_VECTOR_ELT(contents, 175, ScalarInteger(internal->dim_I_asympt_12));
  SET_VECTOR_ELT(contents, 176, ScalarInteger(internal->dim_I_asympt_2));
  SET_VECTOR_ELT(contents, 177, ScalarInteger(internal->dim_I_asympt_3));
  SET_VECTOR_ELT(contents, 178, ScalarInteger(internal->dim_I_comm_D));
  SET_VECTOR_ELT(contents, 179, ScalarInteger(internal->dim_I_comm_D_1));
  SET_VECTOR_ELT(contents, 180, ScalarInteger(internal->dim_I_comm_D_12));
  SET_VECTOR_ELT(contents, 181, ScalarInteger(internal->dim_I_comm_D_2));
  SET_VECTOR_ELT(contents, 182, ScalarInteger(internal->dim_I_comm_D_3));
  SET_VECTOR_ELT(contents, 183, ScalarInteger(internal->dim_I_hosp_D));
  SET_VECTOR_ELT(contents, 184, ScalarInteger(internal->dim_I_hosp_D_1));
  SET_VECTOR_ELT(contents, 185, ScalarInteger(internal->dim_I_hosp_D_12));
  SET_VECTOR_ELT(contents, 186, ScalarInteger(internal->dim_I_hosp_D_123));
  SET_VECTOR_ELT(contents, 187, ScalarInteger(internal->dim_I_hosp_D_2));
  SET_VECTOR_ELT(contents, 188, ScalarInteger(internal->dim_I_hosp_D_3));
  SET_VECTOR_ELT(contents, 189, ScalarInteger(internal->dim_I_hosp_D_4));
  SET_VECTOR_ELT(contents, 190, ScalarInteger(internal->dim_I_hosp_R));
  SET_VECTOR_ELT(contents, 191, ScalarInteger(internal->dim_I_hosp_R_1));
  SET_VECTOR_ELT(contents, 192, ScalarInteger(internal->dim_I_hosp_R_12));
  SET_VECTOR_ELT(contents, 193, ScalarInteger(internal->dim_I_hosp_R_123));
  SET_VECTOR_ELT(contents, 194, ScalarInteger(internal->dim_I_hosp_R_2));
  SET_VECTOR_ELT(contents, 195, ScalarInteger(internal->dim_I_hosp_R_3));
  SET_VECTOR_ELT(contents, 196, ScalarInteger(internal->dim_I_hosp_R_4));
  SET_VECTOR_ELT(contents, 197, ScalarInteger(internal->dim_I_ICU_D_conf));
  SET_VECTOR_ELT(contents, 198, ScalarInteger(internal->dim_I_ICU_D_conf_1));
  SET_VECTOR_ELT(contents, 199, ScalarInteger(internal->dim_I_ICU_D_conf_12));
  SET_VECTOR_ELT(contents, 200, ScalarInteger(internal->dim_I_ICU_D_conf_2));
  SET_VECTOR_ELT(contents, 201, ScalarInteger(internal->dim_I_ICU_D_conf_3));
  SET_VECTOR_ELT(contents, 202, ScalarInteger(internal->dim_I_ICU_D_unconf));
  SET_VECTOR_ELT(contents, 203, ScalarInteger(internal->dim_I_ICU_D_unconf_1));
  SET_VECTOR_ELT(contents, 204, ScalarInteger(internal->dim_I_ICU_D_unconf_12));
  SET_VECTOR_ELT(contents, 205, ScalarInteger(internal->dim_I_ICU_D_unconf_2));
  SET_VECTOR_ELT(contents, 206, ScalarInteger(internal->dim_I_ICU_D_unconf_3));
  SET_VECTOR_ELT(contents, 207, ScalarInteger(internal->dim_I_ICU_R_conf));
  SET_VECTOR_ELT(contents, 208, ScalarInteger(internal->dim_I_ICU_R_conf_1));
  SET_VECTOR_ELT(contents, 209, ScalarInteger(internal->dim_I_ICU_R_conf_12));
  SET_VECTOR_ELT(contents, 210, ScalarInteger(internal->dim_I_ICU_R_conf_2));
  SET_VECTOR_ELT(contents, 211, ScalarInteger(internal->dim_I_ICU_R_conf_3));
  SET_VECTOR_ELT(contents, 212, ScalarInteger(internal->dim_I_ICU_R_unconf));
  SET_VECTOR_ELT(contents, 213, ScalarInteger(internal->dim_I_ICU_R_unconf_1));
  SET_VECTOR_ELT(contents, 214, ScalarInteger(internal->dim_I_ICU_R_unconf_12));
  SET_VECTOR_ELT(contents, 215, ScalarInteger(internal->dim_I_ICU_R_unconf_2));
  SET_VECTOR_ELT(contents, 216, ScalarInteger(internal->dim_I_ICU_R_unconf_3));
  SET_VECTOR_ELT(contents, 217, ScalarInteger(internal->dim_I_ILI));
  SET_VECTOR_ELT(contents, 218, ScalarInteger(internal->dim_I_ILI_1));
  SET_VECTOR_ELT(contents, 219, ScalarInteger(internal->dim_I_ILI_12));
  SET_VECTOR_ELT(contents, 220, ScalarInteger(internal->dim_I_ILI_2));
  SET_VECTOR_ELT(contents, 221, ScalarInteger(internal->dim_I_ILI_3));
  SET_VECTOR_ELT(contents, 222, ScalarInteger(internal->dim_I_mild));
  SET_VECTOR_ELT(contents, 223, ScalarInteger(internal->dim_I_mild_1));
  SET_VECTOR_ELT(contents, 224, ScalarInteger(internal->dim_I_mild_12));
  SET_VECTOR_ELT(contents, 225, ScalarInteger(internal->dim_I_mild_2));
  SET_VECTOR_ELT(contents, 226, ScalarInteger(internal->dim_I_mild_3));
  SET_VECTOR_ELT(contents, 227, ScalarInteger(internal->dim_I_triage_D_conf));
  SET_VECTOR_ELT(contents, 228, ScalarInteger(internal->dim_I_triage_D_conf_1));
  SET_VECTOR_ELT(contents, 229, ScalarInteger(internal->dim_I_triage_D_conf_12));
  SET_VECTOR_ELT(contents, 230, ScalarInteger(internal->dim_I_triage_D_conf_2));
  SET_VECTOR_ELT(contents, 231, ScalarInteger(internal->dim_I_triage_D_conf_3));
  SET_VECTOR_ELT(contents, 232, ScalarInteger(internal->dim_I_triage_D_unconf));
  SET_VECTOR_ELT(contents, 233, ScalarInteger(internal->dim_I_triage_D_unconf_1));
  SET_VECTOR_ELT(contents, 234, ScalarInteger(internal->dim_I_triage_D_unconf_12));
  SET_VECTOR_ELT(contents, 235, ScalarInteger(internal->dim_I_triage_D_unconf_2));
  SET_VECTOR_ELT(contents, 236, ScalarInteger(internal->dim_I_triage_D_unconf_3));
  SET_VECTOR_ELT(contents, 237, ScalarInteger(internal->dim_I_triage_R));
  SET_VECTOR_ELT(contents, 238, ScalarInteger(internal->dim_I_triage_R_1));
  SET_VECTOR_ELT(contents, 239, ScalarInteger(internal->dim_I_triage_R_12));
  SET_VECTOR_ELT(contents, 240, ScalarInteger(internal->dim_I_triage_R_123));
  SET_VECTOR_ELT(contents, 241, ScalarInteger(internal->dim_I_triage_R_2));
  SET_VECTOR_ELT(contents, 242, ScalarInteger(internal->dim_I_triage_R_3));
  SET_VECTOR_ELT(contents, 243, ScalarInteger(internal->dim_I_triage_R_4));
  SET_VECTOR_ELT(contents, 244, ScalarInteger(internal->dim_I_with_diff_trans));
  SET_VECTOR_ELT(contents, 245, ScalarInteger(internal->dim_I_with_diff_trans_1));
  SET_VECTOR_ELT(contents, 246, ScalarInteger(internal->dim_I_with_diff_trans_2));
  SET_VECTOR_ELT(contents, 247, ScalarInteger(internal->dim_I0_asympt));
  SET_VECTOR_ELT(contents, 248, ScalarInteger(internal->dim_I0_asympt_1));
  SET_VECTOR_ELT(contents, 249, ScalarInteger(internal->dim_I0_asympt_12));
  SET_VECTOR_ELT(contents, 250, ScalarInteger(internal->dim_I0_asympt_2));
  SET_VECTOR_ELT(contents, 251, ScalarInteger(internal->dim_I0_asympt_3));
  SET_VECTOR_ELT(contents, 252, ScalarInteger(internal->dim_I0_comm_D));
  SET_VECTOR_ELT(contents, 253, ScalarInteger(internal->dim_I0_comm_D_1));
  SET_VECTOR_ELT(contents, 254, ScalarInteger(internal->dim_I0_comm_D_12));
  SET_VECTOR_ELT(contents, 255, ScalarInteger(internal->dim_I0_comm_D_2));
  SET_VECTOR_ELT(contents, 256, ScalarInteger(internal->dim_I0_comm_D_3));
  SET_VECTOR_ELT(contents, 257, ScalarInteger(internal->dim_I0_hosp_D));
  SET_VECTOR_ELT(contents, 258, ScalarInteger(internal->dim_I0_hosp_D_1));
  SET_VECTOR_ELT(contents, 259, ScalarInteger(internal->dim_I0_hosp_D_12));
  SET_VECTOR_ELT(contents, 260, ScalarInteger(internal->dim_I0_hosp_D_123));
  SET_VECTOR_ELT(contents, 261, ScalarInteger(internal->dim_I0_hosp_D_2));
  SET_VECTOR_ELT(contents, 262, ScalarInteger(internal->dim_I0_hosp_D_3));
  SET_VECTOR_ELT(contents, 263, ScalarInteger(internal->dim_I0_hosp_D_4));
  SET_VECTOR_ELT(contents, 264, ScalarInteger(internal->dim_I0_hosp_R));
  SET_VECTOR_ELT(contents, 265, ScalarInteger(internal->dim_I0_hosp_R_1));
  SET_VECTOR_ELT(contents, 266, ScalarInteger(internal->dim_I0_hosp_R_12));
  SET_VECTOR_ELT(contents, 267, ScalarInteger(internal->dim_I0_hosp_R_123));
  SET_VECTOR_ELT(contents, 268, ScalarInteger(internal->dim_I0_hosp_R_2));
  SET_VECTOR_ELT(contents, 269, ScalarInteger(internal->dim_I0_hosp_R_3));
  SET_VECTOR_ELT(contents, 270, ScalarInteger(internal->dim_I0_hosp_R_4));
  SET_VECTOR_ELT(contents, 271, ScalarInteger(internal->dim_I0_ICU_D_conf));
  SET_VECTOR_ELT(contents, 272, ScalarInteger(internal->dim_I0_ICU_D_conf_1));
  SET_VECTOR_ELT(contents, 273, ScalarInteger(internal->dim_I0_ICU_D_conf_12));
  SET_VECTOR_ELT(contents, 274, ScalarInteger(internal->dim_I0_ICU_D_conf_2));
  SET_VECTOR_ELT(contents, 275, ScalarInteger(internal->dim_I0_ICU_D_conf_3));
  SET_VECTOR_ELT(contents, 276, ScalarInteger(internal->dim_I0_ICU_D_unconf));
  SET_VECTOR_ELT(contents, 277, ScalarInteger(internal->dim_I0_ICU_D_unconf_1));
  SET_VECTOR_ELT(contents, 278, ScalarInteger(internal->dim_I0_ICU_D_unconf_12));
  SET_VECTOR_ELT(contents, 279, ScalarInteger(internal->dim_I0_ICU_D_unconf_2));
  SET_VECTOR_ELT(contents, 280, ScalarInteger(internal->dim_I0_ICU_D_unconf_3));
  SET_VECTOR_ELT(contents, 281, ScalarInteger(internal->dim_I0_ICU_R_conf));
  SET_VECTOR_ELT(contents, 282, ScalarInteger(internal->dim_I0_ICU_R_conf_1));
  SET_VECTOR_ELT(contents, 283, ScalarInteger(internal->dim_I0_ICU_R_conf_12));
  SET_VECTOR_ELT(contents, 284, ScalarInteger(internal->dim_I0_ICU_R_conf_2));
  SET_VECTOR_ELT(contents, 285, ScalarInteger(internal->dim_I0_ICU_R_conf_3));
  SET_VECTOR_ELT(contents, 286, ScalarInteger(internal->dim_I0_ICU_R_unconf));
  SET_VECTOR_ELT(contents, 287, ScalarInteger(internal->dim_I0_ICU_R_unconf_1));
  SET_VECTOR_ELT(contents, 288, ScalarInteger(internal->dim_I0_ICU_R_unconf_12));
  SET_VECTOR_ELT(contents, 289, ScalarInteger(internal->dim_I0_ICU_R_unconf_2));
  SET_VECTOR_ELT(contents, 290, ScalarInteger(internal->dim_I0_ICU_R_unconf_3));
  SET_VECTOR_ELT(contents, 291, ScalarInteger(internal->dim_I0_ILI));
  SET_VECTOR_ELT(contents, 292, ScalarInteger(internal->dim_I0_ILI_1));
  SET_VECTOR_ELT(contents, 293, ScalarInteger(internal->dim_I0_ILI_12));
  SET_VECTOR_ELT(contents, 294, ScalarInteger(internal->dim_I0_ILI_2));
  SET_VECTOR_ELT(contents, 295, ScalarInteger(internal->dim_I0_ILI_3));
  SET_VECTOR_ELT(contents, 296, ScalarInteger(internal->dim_I0_mild));
  SET_VECTOR_ELT(contents, 297, ScalarInteger(internal->dim_I0_mild_1));
  SET_VECTOR_ELT(contents, 298, ScalarInteger(internal->dim_I0_mild_12));
  SET_VECTOR_ELT(contents, 299, ScalarInteger(internal->dim_I0_mild_2));
  SET_VECTOR_ELT(contents, 300, ScalarInteger(internal->dim_I0_mild_3));
  SET_VECTOR_ELT(contents, 301, ScalarInteger(internal->dim_I0_triage_D_conf));
  SET_VECTOR_ELT(contents, 302, ScalarInteger(internal->dim_I0_triage_D_conf_1));
  SET_VECTOR_ELT(contents, 303, ScalarInteger(internal->dim_I0_triage_D_conf_12));
  SET_VECTOR_ELT(contents, 304, ScalarInteger(internal->dim_I0_triage_D_conf_2));
  SET_VECTOR_ELT(contents, 305, ScalarInteger(internal->dim_I0_triage_D_conf_3));
  SET_VECTOR_ELT(contents, 306, ScalarInteger(internal->dim_I0_triage_D_unconf));
  SET_VECTOR_ELT(contents, 307, ScalarInteger(internal->dim_I0_triage_D_unconf_1));
  SET_VECTOR_ELT(contents, 308, ScalarInteger(internal->dim_I0_triage_D_unconf_12));
  SET_VECTOR_ELT(contents, 309, ScalarInteger(internal->dim_I0_triage_D_unconf_2));
  SET_VECTOR_ELT(contents, 310, ScalarInteger(internal->dim_I0_triage_D_unconf_3));
  SET_VECTOR_ELT(contents, 311, ScalarInteger(internal->dim_I0_triage_R));
  SET_VECTOR_ELT(contents, 312, ScalarInteger(internal->dim_I0_triage_R_1));
  SET_VECTOR_ELT(contents, 313, ScalarInteger(internal->dim_I0_triage_R_12));
  SET_VECTOR_ELT(contents, 314, ScalarInteger(internal->dim_I0_triage_R_123));
  SET_VECTOR_ELT(contents, 315, ScalarInteger(internal->dim_I0_triage_R_2));
  SET_VECTOR_ELT(contents, 316, ScalarInteger(internal->dim_I0_triage_R_3));
  SET_VECTOR_ELT(contents, 317, ScalarInteger(internal->dim_I0_triage_R_4));
  SET_VECTOR_ELT(contents, 318, ScalarInteger(internal->dim_lambda));
  SET_VECTOR_ELT(contents, 319, ScalarInteger(internal->dim_m));
  SET_VECTOR_ELT(contents, 320, ScalarInteger(internal->dim_m_1));
  SET_VECTOR_ELT(contents, 321, ScalarInteger(internal->dim_m_2));
  SET_VECTOR_ELT(contents, 322, ScalarInteger(internal->dim_n_com_to_R_pre));
  SET_VECTOR_ELT(contents, 323, ScalarInteger(internal->dim_n_com_to_R_total));
  SET_VECTOR_ELT(contents, 324, ScalarInteger(internal->dim_n_EE));
  SET_VECTOR_ELT(contents, 325, ScalarInteger(internal->dim_n_EE_1));
  SET_VECTOR_ELT(contents, 326, ScalarInteger(internal->dim_n_EE_12));
  SET_VECTOR_ELT(contents, 327, ScalarInteger(internal->dim_n_EE_2));
  SET_VECTOR_ELT(contents, 328, ScalarInteger(internal->dim_n_EE_3));
  SET_VECTOR_ELT(contents, 329, ScalarInteger(internal->dim_n_EI_asympt));
  SET_VECTOR_ELT(contents, 330, ScalarInteger(internal->dim_n_EI_asympt_1));
  SET_VECTOR_ELT(contents, 331, ScalarInteger(internal->dim_n_EI_asympt_2));
  SET_VECTOR_ELT(contents, 332, ScalarInteger(internal->dim_n_EI_ILI));
  SET_VECTOR_ELT(contents, 333, ScalarInteger(internal->dim_n_EI_ILI_1));
  SET_VECTOR_ELT(contents, 334, ScalarInteger(internal->dim_n_EI_ILI_2));
  SET_VECTOR_ELT(contents, 335, ScalarInteger(internal->dim_n_EI_mild));
  SET_VECTOR_ELT(contents, 336, ScalarInteger(internal->dim_n_EI_mild_1));
  SET_VECTOR_ELT(contents, 337, ScalarInteger(internal->dim_n_EI_mild_2));
  SET_VECTOR_ELT(contents, 338, ScalarInteger(internal->dim_n_hosp_non_ICU));
  SET_VECTOR_ELT(contents, 339, ScalarInteger(internal->dim_n_hosp_non_ICU_1));
  SET_VECTOR_ELT(contents, 340, ScalarInteger(internal->dim_n_hosp_non_ICU_2));
  SET_VECTOR_ELT(contents, 341, ScalarInteger(internal->dim_n_I_hosp_D_unconf_to_conf));
  SET_VECTOR_ELT(contents, 342, ScalarInteger(internal->dim_n_I_hosp_D_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 343, ScalarInteger(internal->dim_n_I_hosp_D_unconf_to_conf_12));
  SET_VECTOR_ELT(contents, 344, ScalarInteger(internal->dim_n_I_hosp_D_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 345, ScalarInteger(internal->dim_n_I_hosp_D_unconf_to_conf_3));
  SET_VECTOR_ELT(contents, 346, ScalarInteger(internal->dim_n_I_hosp_R_unconf_to_conf));
  SET_VECTOR_ELT(contents, 347, ScalarInteger(internal->dim_n_I_hosp_R_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 348, ScalarInteger(internal->dim_n_I_hosp_R_unconf_to_conf_12));
  SET_VECTOR_ELT(contents, 349, ScalarInteger(internal->dim_n_I_hosp_R_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 350, ScalarInteger(internal->dim_n_I_hosp_R_unconf_to_conf_3));
  SET_VECTOR_ELT(contents, 351, ScalarInteger(internal->dim_n_I_ICU_D_unconf_to_conf));
  SET_VECTOR_ELT(contents, 352, ScalarInteger(internal->dim_n_I_ICU_D_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 353, ScalarInteger(internal->dim_n_I_ICU_D_unconf_to_conf_12));
  SET_VECTOR_ELT(contents, 354, ScalarInteger(internal->dim_n_I_ICU_D_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 355, ScalarInteger(internal->dim_n_I_ICU_D_unconf_to_conf_3));
  SET_VECTOR_ELT(contents, 356, ScalarInteger(internal->dim_n_I_ICU_R_unconf_to_conf));
  SET_VECTOR_ELT(contents, 357, ScalarInteger(internal->dim_n_I_ICU_R_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 358, ScalarInteger(internal->dim_n_I_ICU_R_unconf_to_conf_12));
  SET_VECTOR_ELT(contents, 359, ScalarInteger(internal->dim_n_I_ICU_R_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 360, ScalarInteger(internal->dim_n_I_ICU_R_unconf_to_conf_3));
  SET_VECTOR_ELT(contents, 361, ScalarInteger(internal->dim_n_I_triage_D_unconf_to_conf));
  SET_VECTOR_ELT(contents, 362, ScalarInteger(internal->dim_n_I_triage_D_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 363, ScalarInteger(internal->dim_n_I_triage_D_unconf_to_conf_12));
  SET_VECTOR_ELT(contents, 364, ScalarInteger(internal->dim_n_I_triage_D_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 365, ScalarInteger(internal->dim_n_I_triage_D_unconf_to_conf_3));
  SET_VECTOR_ELT(contents, 366, ScalarInteger(internal->dim_n_I_triage_R_unconf_to_conf));
  SET_VECTOR_ELT(contents, 367, ScalarInteger(internal->dim_n_I_triage_R_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 368, ScalarInteger(internal->dim_n_I_triage_R_unconf_to_conf_12));
  SET_VECTOR_ELT(contents, 369, ScalarInteger(internal->dim_n_I_triage_R_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 370, ScalarInteger(internal->dim_n_I_triage_R_unconf_to_conf_3));
  SET_VECTOR_ELT(contents, 371, ScalarInteger(internal->dim_n_II_asympt));
  SET_VECTOR_ELT(contents, 372, ScalarInteger(internal->dim_n_II_asympt_1));
  SET_VECTOR_ELT(contents, 373, ScalarInteger(internal->dim_n_II_asympt_12));
  SET_VECTOR_ELT(contents, 374, ScalarInteger(internal->dim_n_II_asympt_2));
  SET_VECTOR_ELT(contents, 375, ScalarInteger(internal->dim_n_II_asympt_3));
  SET_VECTOR_ELT(contents, 376, ScalarInteger(internal->dim_n_II_comm_D));
  SET_VECTOR_ELT(contents, 377, ScalarInteger(internal->dim_n_II_comm_D_1));
  SET_VECTOR_ELT(contents, 378, ScalarInteger(internal->dim_n_II_comm_D_12));
  SET_VECTOR_ELT(contents, 379, ScalarInteger(internal->dim_n_II_comm_D_2));
  SET_VECTOR_ELT(contents, 380, ScalarInteger(internal->dim_n_II_comm_D_3));
  SET_VECTOR_ELT(contents, 381, ScalarInteger(internal->dim_n_II_hosp_D));
  SET_VECTOR_ELT(contents, 382, ScalarInteger(internal->dim_n_II_hosp_D_1));
  SET_VECTOR_ELT(contents, 383, ScalarInteger(internal->dim_n_II_hosp_D_12));
  SET_VECTOR_ELT(contents, 384, ScalarInteger(internal->dim_n_II_hosp_D_123));
  SET_VECTOR_ELT(contents, 385, ScalarInteger(internal->dim_n_II_hosp_D_2));
  SET_VECTOR_ELT(contents, 386, ScalarInteger(internal->dim_n_II_hosp_D_3));
  SET_VECTOR_ELT(contents, 387, ScalarInteger(internal->dim_n_II_hosp_D_4));
  SET_VECTOR_ELT(contents, 388, ScalarInteger(internal->dim_n_II_hosp_R));
  SET_VECTOR_ELT(contents, 389, ScalarInteger(internal->dim_n_II_hosp_R_1));
  SET_VECTOR_ELT(contents, 390, ScalarInteger(internal->dim_n_II_hosp_R_12));
  SET_VECTOR_ELT(contents, 391, ScalarInteger(internal->dim_n_II_hosp_R_123));
  SET_VECTOR_ELT(contents, 392, ScalarInteger(internal->dim_n_II_hosp_R_2));
  SET_VECTOR_ELT(contents, 393, ScalarInteger(internal->dim_n_II_hosp_R_3));
  SET_VECTOR_ELT(contents, 394, ScalarInteger(internal->dim_n_II_hosp_R_4));
  SET_VECTOR_ELT(contents, 395, ScalarInteger(internal->dim_n_II_ICU_D_conf));
  SET_VECTOR_ELT(contents, 396, ScalarInteger(internal->dim_n_II_ICU_D_conf_1));
  SET_VECTOR_ELT(contents, 397, ScalarInteger(internal->dim_n_II_ICU_D_conf_12));
  SET_VECTOR_ELT(contents, 398, ScalarInteger(internal->dim_n_II_ICU_D_conf_2));
  SET_VECTOR_ELT(contents, 399, ScalarInteger(internal->dim_n_II_ICU_D_conf_3));
  SET_VECTOR_ELT(contents, 400, ScalarInteger(internal->dim_n_II_ICU_D_unconf));
  SET_VECTOR_ELT(contents, 401, ScalarInteger(internal->dim_n_II_ICU_D_unconf_1));
  SET_VECTOR_ELT(contents, 402, ScalarInteger(internal->dim_n_II_ICU_D_unconf_12));
  SET_VECTOR_ELT(contents, 403, ScalarInteger(internal->dim_n_II_ICU_D_unconf_2));
  SET_VECTOR_ELT(contents, 404, ScalarInteger(internal->dim_n_II_ICU_D_unconf_3));
  SET_VECTOR_ELT(contents, 405, ScalarInteger(internal->dim_n_II_ICU_R_conf));
  SET_VECTOR_ELT(contents, 406, ScalarInteger(internal->dim_n_II_ICU_R_conf_1));
  SET_VECTOR_ELT(contents, 407, ScalarInteger(internal->dim_n_II_ICU_R_conf_12));
  SET_VECTOR_ELT(contents, 408, ScalarInteger(internal->dim_n_II_ICU_R_conf_2));
  SET_VECTOR_ELT(contents, 409, ScalarInteger(internal->dim_n_II_ICU_R_conf_3));
  SET_VECTOR_ELT(contents, 410, ScalarInteger(internal->dim_n_II_ICU_R_unconf));
  SET_VECTOR_ELT(contents, 411, ScalarInteger(internal->dim_n_II_ICU_R_unconf_1));
  SET_VECTOR_ELT(contents, 412, ScalarInteger(internal->dim_n_II_ICU_R_unconf_12));
  SET_VECTOR_ELT(contents, 413, ScalarInteger(internal->dim_n_II_ICU_R_unconf_2));
  SET_VECTOR_ELT(contents, 414, ScalarInteger(internal->dim_n_II_ICU_R_unconf_3));
  SET_VECTOR_ELT(contents, 415, ScalarInteger(internal->dim_n_II_ILI));
  SET_VECTOR_ELT(contents, 416, ScalarInteger(internal->dim_n_II_ILI_1));
  SET_VECTOR_ELT(contents, 417, ScalarInteger(internal->dim_n_II_ILI_12));
  SET_VECTOR_ELT(contents, 418, ScalarInteger(internal->dim_n_II_ILI_2));
  SET_VECTOR_ELT(contents, 419, ScalarInteger(internal->dim_n_II_ILI_3));
  SET_VECTOR_ELT(contents, 420, ScalarInteger(internal->dim_n_II_mild));
  SET_VECTOR_ELT(contents, 421, ScalarInteger(internal->dim_n_II_mild_1));
  SET_VECTOR_ELT(contents, 422, ScalarInteger(internal->dim_n_II_mild_12));
  SET_VECTOR_ELT(contents, 423, ScalarInteger(internal->dim_n_II_mild_2));
  SET_VECTOR_ELT(contents, 424, ScalarInteger(internal->dim_n_II_mild_3));
  SET_VECTOR_ELT(contents, 425, ScalarInteger(internal->dim_n_II_triage_D_conf));
  SET_VECTOR_ELT(contents, 426, ScalarInteger(internal->dim_n_II_triage_D_conf_1));
  SET_VECTOR_ELT(contents, 427, ScalarInteger(internal->dim_n_II_triage_D_conf_12));
  SET_VECTOR_ELT(contents, 428, ScalarInteger(internal->dim_n_II_triage_D_conf_2));
  SET_VECTOR_ELT(contents, 429, ScalarInteger(internal->dim_n_II_triage_D_conf_3));
  SET_VECTOR_ELT(contents, 430, ScalarInteger(internal->dim_n_II_triage_D_unconf));
  SET_VECTOR_ELT(contents, 431, ScalarInteger(internal->dim_n_II_triage_D_unconf_1));
  SET_VECTOR_ELT(contents, 432, ScalarInteger(internal->dim_n_II_triage_D_unconf_12));
  SET_VECTOR_ELT(contents, 433, ScalarInteger(internal->dim_n_II_triage_D_unconf_2));
  SET_VECTOR_ELT(contents, 434, ScalarInteger(internal->dim_n_II_triage_D_unconf_3));
  SET_VECTOR_ELT(contents, 435, ScalarInteger(internal->dim_n_II_triage_R));
  SET_VECTOR_ELT(contents, 436, ScalarInteger(internal->dim_n_II_triage_R_1));
  SET_VECTOR_ELT(contents, 437, ScalarInteger(internal->dim_n_II_triage_R_12));
  SET_VECTOR_ELT(contents, 438, ScalarInteger(internal->dim_n_II_triage_R_123));
  SET_VECTOR_ELT(contents, 439, ScalarInteger(internal->dim_n_II_triage_R_2));
  SET_VECTOR_ELT(contents, 440, ScalarInteger(internal->dim_n_II_triage_R_3));
  SET_VECTOR_ELT(contents, 441, ScalarInteger(internal->dim_n_II_triage_R_4));
  SET_VECTOR_ELT(contents, 442, ScalarInteger(internal->dim_n_ILI_to_comm_D));
  SET_VECTOR_ELT(contents, 443, ScalarInteger(internal->dim_n_ILI_to_comm_D_1));
  SET_VECTOR_ELT(contents, 444, ScalarInteger(internal->dim_n_ILI_to_comm_D_2));
  SET_VECTOR_ELT(contents, 445, ScalarInteger(internal->dim_n_ILI_to_hosp));
  SET_VECTOR_ELT(contents, 446, ScalarInteger(internal->dim_n_ILI_to_hosp_1));
  SET_VECTOR_ELT(contents, 447, ScalarInteger(internal->dim_n_ILI_to_hosp_2));
  SET_VECTOR_ELT(contents, 448, ScalarInteger(internal->dim_n_ILI_to_hosp_D));
  SET_VECTOR_ELT(contents, 449, ScalarInteger(internal->dim_n_ILI_to_hosp_D_1));
  SET_VECTOR_ELT(contents, 450, ScalarInteger(internal->dim_n_ILI_to_hosp_D_2));
  SET_VECTOR_ELT(contents, 451, ScalarInteger(internal->dim_n_ILI_to_hosp_D_conf));
  SET_VECTOR_ELT(contents, 452, ScalarInteger(internal->dim_n_ILI_to_hosp_D_conf_1));
  SET_VECTOR_ELT(contents, 453, ScalarInteger(internal->dim_n_ILI_to_hosp_D_conf_2));
  SET_VECTOR_ELT(contents, 454, ScalarInteger(internal->dim_n_ILI_to_hosp_R));
  SET_VECTOR_ELT(contents, 455, ScalarInteger(internal->dim_n_ILI_to_hosp_R_1));
  SET_VECTOR_ELT(contents, 456, ScalarInteger(internal->dim_n_ILI_to_hosp_R_2));
  SET_VECTOR_ELT(contents, 457, ScalarInteger(internal->dim_n_ILI_to_hosp_R_conf));
  SET_VECTOR_ELT(contents, 458, ScalarInteger(internal->dim_n_ILI_to_hosp_R_conf_1));
  SET_VECTOR_ELT(contents, 459, ScalarInteger(internal->dim_n_ILI_to_hosp_R_conf_2));
  SET_VECTOR_ELT(contents, 460, ScalarInteger(internal->dim_n_ILI_to_triage));
  SET_VECTOR_ELT(contents, 461, ScalarInteger(internal->dim_n_ILI_to_triage_1));
  SET_VECTOR_ELT(contents, 462, ScalarInteger(internal->dim_n_ILI_to_triage_2));
  SET_VECTOR_ELT(contents, 463, ScalarInteger(internal->dim_n_ILI_to_triage_D));
  SET_VECTOR_ELT(contents, 464, ScalarInteger(internal->dim_n_ILI_to_triage_D_1));
  SET_VECTOR_ELT(contents, 465, ScalarInteger(internal->dim_n_ILI_to_triage_D_2));
  SET_VECTOR_ELT(contents, 466, ScalarInteger(internal->dim_n_ILI_to_triage_D_conf));
  SET_VECTOR_ELT(contents, 467, ScalarInteger(internal->dim_n_ILI_to_triage_D_conf_1));
  SET_VECTOR_ELT(contents, 468, ScalarInteger(internal->dim_n_ILI_to_triage_D_conf_2));
  SET_VECTOR_ELT(contents, 469, ScalarInteger(internal->dim_n_ILI_to_triage_R));
  SET_VECTOR_ELT(contents, 470, ScalarInteger(internal->dim_n_ILI_to_triage_R_1));
  SET_VECTOR_ELT(contents, 471, ScalarInteger(internal->dim_n_ILI_to_triage_R_2));
  SET_VECTOR_ELT(contents, 472, ScalarInteger(internal->dim_n_ILI_to_triage_R_conf));
  SET_VECTOR_ELT(contents, 473, ScalarInteger(internal->dim_n_ILI_to_triage_R_conf_1));
  SET_VECTOR_ELT(contents, 474, ScalarInteger(internal->dim_n_ILI_to_triage_R_conf_2));
  SET_VECTOR_ELT(contents, 475, ScalarInteger(internal->dim_n_R_pre));
  SET_VECTOR_ELT(contents, 476, ScalarInteger(internal->dim_n_R_pre_1));
  SET_VECTOR_ELT(contents, 477, ScalarInteger(internal->dim_n_R_pre_2));
  SET_VECTOR_ELT(contents, 478, ScalarInteger(internal->dim_n_R_stepdown_conf));
  SET_VECTOR_ELT(contents, 479, ScalarInteger(internal->dim_n_R_stepdown_conf_1));
  SET_VECTOR_ELT(contents, 480, ScalarInteger(internal->dim_n_R_stepdown_conf_2));
  SET_VECTOR_ELT(contents, 481, ScalarInteger(internal->dim_n_R_stepdown_unconf));
  SET_VECTOR_ELT(contents, 482, ScalarInteger(internal->dim_n_R_stepdown_unconf_1));
  SET_VECTOR_ELT(contents, 483, ScalarInteger(internal->dim_n_R_stepdown_unconf_2));
  SET_VECTOR_ELT(contents, 484, ScalarInteger(internal->dim_n_R_stepdown_unconf_to_conf));
  SET_VECTOR_ELT(contents, 485, ScalarInteger(internal->dim_n_R_stepdown_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 486, ScalarInteger(internal->dim_n_R_stepdown_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 487, ScalarInteger(internal->dim_n_SE));
  SET_VECTOR_ELT(contents, 488, ScalarInteger(internal->dim_N_tot));
  SET_VECTOR_ELT(contents, 489, ScalarInteger(internal->dim_new_I_hosp_D));
  SET_VECTOR_ELT(contents, 490, ScalarInteger(internal->dim_new_I_hosp_D_1));
  SET_VECTOR_ELT(contents, 491, ScalarInteger(internal->dim_new_I_hosp_D_12));
  SET_VECTOR_ELT(contents, 492, ScalarInteger(internal->dim_new_I_hosp_D_123));
  SET_VECTOR_ELT(contents, 493, ScalarInteger(internal->dim_new_I_hosp_D_2));
  SET_VECTOR_ELT(contents, 494, ScalarInteger(internal->dim_new_I_hosp_D_3));
  SET_VECTOR_ELT(contents, 495, ScalarInteger(internal->dim_new_I_hosp_D_4));
  SET_VECTOR_ELT(contents, 496, ScalarInteger(internal->dim_new_I_hosp_R));
  SET_VECTOR_ELT(contents, 497, ScalarInteger(internal->dim_new_I_hosp_R_1));
  SET_VECTOR_ELT(contents, 498, ScalarInteger(internal->dim_new_I_hosp_R_12));
  SET_VECTOR_ELT(contents, 499, ScalarInteger(internal->dim_new_I_hosp_R_123));
  SET_VECTOR_ELT(contents, 500, ScalarInteger(internal->dim_new_I_hosp_R_2));
  SET_VECTOR_ELT(contents, 501, ScalarInteger(internal->dim_new_I_hosp_R_3));
  SET_VECTOR_ELT(contents, 502, ScalarInteger(internal->dim_new_I_hosp_R_4));
  SET_VECTOR_ELT(contents, 503, ScalarInteger(internal->dim_new_I_ICU_D_conf));
  SET_VECTOR_ELT(contents, 504, ScalarInteger(internal->dim_new_I_ICU_D_conf_1));
  SET_VECTOR_ELT(contents, 505, ScalarInteger(internal->dim_new_I_ICU_D_conf_12));
  SET_VECTOR_ELT(contents, 506, ScalarInteger(internal->dim_new_I_ICU_D_conf_2));
  SET_VECTOR_ELT(contents, 507, ScalarInteger(internal->dim_new_I_ICU_D_conf_3));
  SET_VECTOR_ELT(contents, 508, ScalarInteger(internal->dim_new_I_ICU_D_unconf));
  SET_VECTOR_ELT(contents, 509, ScalarInteger(internal->dim_new_I_ICU_D_unconf_1));
  SET_VECTOR_ELT(contents, 510, ScalarInteger(internal->dim_new_I_ICU_D_unconf_12));
  SET_VECTOR_ELT(contents, 511, ScalarInteger(internal->dim_new_I_ICU_D_unconf_2));
  SET_VECTOR_ELT(contents, 512, ScalarInteger(internal->dim_new_I_ICU_D_unconf_3));
  SET_VECTOR_ELT(contents, 513, ScalarInteger(internal->dim_new_I_ICU_R_conf));
  SET_VECTOR_ELT(contents, 514, ScalarInteger(internal->dim_new_I_ICU_R_conf_1));
  SET_VECTOR_ELT(contents, 515, ScalarInteger(internal->dim_new_I_ICU_R_conf_12));
  SET_VECTOR_ELT(contents, 516, ScalarInteger(internal->dim_new_I_ICU_R_conf_2));
  SET_VECTOR_ELT(contents, 517, ScalarInteger(internal->dim_new_I_ICU_R_conf_3));
  SET_VECTOR_ELT(contents, 518, ScalarInteger(internal->dim_new_I_ICU_R_unconf));
  SET_VECTOR_ELT(contents, 519, ScalarInteger(internal->dim_new_I_ICU_R_unconf_1));
  SET_VECTOR_ELT(contents, 520, ScalarInteger(internal->dim_new_I_ICU_R_unconf_12));
  SET_VECTOR_ELT(contents, 521, ScalarInteger(internal->dim_new_I_ICU_R_unconf_2));
  SET_VECTOR_ELT(contents, 522, ScalarInteger(internal->dim_new_I_ICU_R_unconf_3));
  SET_VECTOR_ELT(contents, 523, ScalarInteger(internal->dim_new_I_triage_D_conf));
  SET_VECTOR_ELT(contents, 524, ScalarInteger(internal->dim_new_I_triage_D_conf_1));
  SET_VECTOR_ELT(contents, 525, ScalarInteger(internal->dim_new_I_triage_D_conf_12));
  SET_VECTOR_ELT(contents, 526, ScalarInteger(internal->dim_new_I_triage_D_conf_2));
  SET_VECTOR_ELT(contents, 527, ScalarInteger(internal->dim_new_I_triage_D_conf_3));
  SET_VECTOR_ELT(contents, 528, ScalarInteger(internal->dim_new_I_triage_D_unconf));
  SET_VECTOR_ELT(contents, 529, ScalarInteger(internal->dim_new_I_triage_D_unconf_1));
  SET_VECTOR_ELT(contents, 530, ScalarInteger(internal->dim_new_I_triage_D_unconf_12));
  SET_VECTOR_ELT(contents, 531, ScalarInteger(internal->dim_new_I_triage_D_unconf_2));
  SET_VECTOR_ELT(contents, 532, ScalarInteger(internal->dim_new_I_triage_D_unconf_3));
  SET_VECTOR_ELT(contents, 533, ScalarInteger(internal->dim_new_I_triage_R));
  SET_VECTOR_ELT(contents, 534, ScalarInteger(internal->dim_new_I_triage_R_1));
  SET_VECTOR_ELT(contents, 535, ScalarInteger(internal->dim_new_I_triage_R_12));
  SET_VECTOR_ELT(contents, 536, ScalarInteger(internal->dim_new_I_triage_R_123));
  SET_VECTOR_ELT(contents, 537, ScalarInteger(internal->dim_new_I_triage_R_2));
  SET_VECTOR_ELT(contents, 538, ScalarInteger(internal->dim_new_I_triage_R_3));
  SET_VECTOR_ELT(contents, 539, ScalarInteger(internal->dim_new_I_triage_R_4));
  SET_VECTOR_ELT(contents, 540, ScalarInteger(internal->dim_new_R_stepdown_conf));
  SET_VECTOR_ELT(contents, 541, ScalarInteger(internal->dim_new_R_stepdown_conf_1));
  SET_VECTOR_ELT(contents, 542, ScalarInteger(internal->dim_new_R_stepdown_conf_2));
  SET_VECTOR_ELT(contents, 543, ScalarInteger(internal->dim_new_R_stepdown_unconf));
  SET_VECTOR_ELT(contents, 544, ScalarInteger(internal->dim_new_R_stepdown_unconf_1));
  SET_VECTOR_ELT(contents, 545, ScalarInteger(internal->dim_new_R_stepdown_unconf_2));
  SET_VECTOR_ELT(contents, 546, ScalarInteger(internal->dim_p_admit_conf));
  SET_VECTOR_ELT(contents, 547, ScalarInteger(internal->dim_p_asympt));
  SET_VECTOR_ELT(contents, 548, ScalarInteger(internal->dim_p_death_comm));
  SET_VECTOR_ELT(contents, 549, ScalarInteger(internal->dim_p_death_hosp_D));
  SET_VECTOR_ELT(contents, 550, ScalarInteger(internal->dim_p_death_ICU));
  SET_VECTOR_ELT(contents, 551, ScalarInteger(internal->dim_p_ICU_hosp));
  SET_VECTOR_ELT(contents, 552, ScalarInteger(internal->dim_p_R_pre));
  SET_VECTOR_ELT(contents, 553, ScalarInteger(internal->dim_p_recov_ILI));
  SET_VECTOR_ELT(contents, 554, ScalarInteger(internal->dim_p_SE));
  SET_VECTOR_ELT(contents, 555, ScalarInteger(internal->dim_p_seroconversion));
  SET_VECTOR_ELT(contents, 556, ScalarInteger(internal->dim_p_sympt_ILI));
  SET_VECTOR_ELT(contents, 557, ScalarInteger(internal->dim_R));
  SET_VECTOR_ELT(contents, 558, ScalarInteger(internal->dim_R_neg));
  SET_VECTOR_ELT(contents, 559, ScalarInteger(internal->dim_R_pos));
  SET_VECTOR_ELT(contents, 560, ScalarInteger(internal->dim_R_pre));
  SET_VECTOR_ELT(contents, 561, ScalarInteger(internal->dim_R_pre_1));
  SET_VECTOR_ELT(contents, 562, ScalarInteger(internal->dim_R_pre_2));
  SET_VECTOR_ELT(contents, 563, ScalarInteger(internal->dim_R_stepdown_conf));
  SET_VECTOR_ELT(contents, 564, ScalarInteger(internal->dim_R_stepdown_conf_1));
  SET_VECTOR_ELT(contents, 565, ScalarInteger(internal->dim_R_stepdown_conf_2));
  SET_VECTOR_ELT(contents, 566, ScalarInteger(internal->dim_R_stepdown_unconf));
  SET_VECTOR_ELT(contents, 567, ScalarInteger(internal->dim_R_stepdown_unconf_1));
  SET_VECTOR_ELT(contents, 568, ScalarInteger(internal->dim_R_stepdown_unconf_2));
  SET_VECTOR_ELT(contents, 569, ScalarInteger(internal->dim_R0));
  SET_VECTOR_ELT(contents, 570, ScalarInteger(internal->dim_R0_neg));
  SET_VECTOR_ELT(contents, 571, ScalarInteger(internal->dim_R0_pos));
  SET_VECTOR_ELT(contents, 572, ScalarInteger(internal->dim_R0_pre));
  SET_VECTOR_ELT(contents, 573, ScalarInteger(internal->dim_R0_pre_1));
  SET_VECTOR_ELT(contents, 574, ScalarInteger(internal->dim_R0_pre_2));
  SET_VECTOR_ELT(contents, 575, ScalarInteger(internal->dim_R0_stepdown_conf));
  SET_VECTOR_ELT(contents, 576, ScalarInteger(internal->dim_R0_stepdown_conf_1));
  SET_VECTOR_ELT(contents, 577, ScalarInteger(internal->dim_R0_stepdown_conf_2));
  SET_VECTOR_ELT(contents, 578, ScalarInteger(internal->dim_R0_stepdown_unconf));
  SET_VECTOR_ELT(contents, 579, ScalarInteger(internal->dim_R0_stepdown_unconf_1));
  SET_VECTOR_ELT(contents, 580, ScalarInteger(internal->dim_R0_stepdown_unconf_2));
  SET_VECTOR_ELT(contents, 581, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 582, ScalarInteger(internal->dim_s_ij));
  SET_VECTOR_ELT(contents, 583, ScalarInteger(internal->dim_s_ij_1));
  SET_VECTOR_ELT(contents, 584, ScalarInteger(internal->dim_s_ij_2));
  SET_VECTOR_ELT(contents, 585, ScalarInteger(internal->dim_S0));
  SET_VECTOR_ELT(contents, 586, ScalarInteger(internal->dim_trans_increase));
  SET_VECTOR_ELT(contents, 587, ScalarInteger(internal->dim_trans_increase_1));
  SET_VECTOR_ELT(contents, 588, ScalarInteger(internal->dim_trans_increase_2));
  SET_VECTOR_ELT(contents, 589, ScalarInteger(internal->dim_trans_profile));
  SET_VECTOR_ELT(contents, 590, ScalarInteger(internal->dim_trans_profile_1));
  SET_VECTOR_ELT(contents, 591, ScalarInteger(internal->dim_trans_profile_2));
  SET_VECTOR_ELT(contents, 592, ScalarReal(internal->dt));
  SEXP E0 = PROTECT(allocVector(REALSXP, internal->dim_E0));
  memcpy(REAL(E0), internal->E0, internal->dim_E0 * sizeof(double));
  odin_set_dim(E0, 3, internal->dim_E0_1, internal->dim_E0_2, internal->dim_E0_3);
  SET_VECTOR_ELT(contents, 593, E0);
  SET_VECTOR_ELT(contents, 594, ScalarReal(internal->gamma_asympt));
  SET_VECTOR_ELT(contents, 595, ScalarReal(internal->gamma_comm_D));
  SET_VECTOR_ELT(contents, 596, ScalarReal(internal->gamma_E));
  SET_VECTOR_ELT(contents, 597, ScalarReal(internal->gamma_hosp_D));
  SET_VECTOR_ELT(contents, 598, ScalarReal(internal->gamma_hosp_R));
  SET_VECTOR_ELT(contents, 599, ScalarReal(internal->gamma_ICU_D));
  SET_VECTOR_ELT(contents, 600, ScalarReal(internal->gamma_ICU_R));
  SET_VECTOR_ELT(contents, 601, ScalarReal(internal->gamma_ILI));
  SET_VECTOR_ELT(contents, 602, ScalarReal(internal->gamma_mild));
  SET_VECTOR_ELT(contents, 603, ScalarReal(internal->gamma_R_pre));
  SET_VECTOR_ELT(contents, 604, ScalarReal(internal->gamma_stepdown));
  SET_VECTOR_ELT(contents, 605, ScalarReal(internal->gamma_test));
  SET_VECTOR_ELT(contents, 606, ScalarReal(internal->gamma_triage));
  SET_VECTOR_ELT(contents, 607, ScalarReal(internal->hosp_transmission));
  SEXP I_with_diff_trans = PROTECT(allocVector(REALSXP, internal->dim_I_with_diff_trans));
  memcpy(REAL(I_with_diff_trans), internal->I_with_diff_trans, internal->dim_I_with_diff_trans * sizeof(double));
  odin_set_dim(I_with_diff_trans, 2, internal->dim_I_with_diff_trans_1, internal->dim_I_with_diff_trans_2);
  SET_VECTOR_ELT(contents, 608, I_with_diff_trans);
  SEXP I0_asympt = PROTECT(allocVector(REALSXP, internal->dim_I0_asympt));
  memcpy(REAL(I0_asympt), internal->I0_asympt, internal->dim_I0_asympt * sizeof(double));
  odin_set_dim(I0_asympt, 3, internal->dim_I0_asympt_1, internal->dim_I0_asympt_2, internal->dim_I0_asympt_3);
  SET_VECTOR_ELT(contents, 609, I0_asympt);
  ...
  SET_VECTOR_ELT(contents, 610, I0_comm_D);
  ...
  SET_VECTOR_ELT(contents, 611, I0_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 612, I0_hosp_R);
  ...
  SET_VECTOR_ELT(contents, 613, I0_ICU_D_conf);
  ...
  SET_VECTOR_ELT(contents, 614, I0_ICU_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 615, I0_ICU_R_conf);
  ...
  SET_VECTOR_ELT(contents, 616, I0_ICU_R_unconf);
  SEXP I0_ILI = PROTECT(allocVector(REALSXP, internal->dim_I0_ILI));
  memcpy(REAL(I0_ILI), internal->I0_ILI, internal->dim_I0_ILI * sizeof(double));
  odin_set_dim(I0_ILI, 3, internal->dim_I0_ILI_1, internal->dim_I0_ILI_2, internal->dim_I0_ILI_3);
  SET_VECTOR_ELT(contents, 617, I0_ILI);
  SEXP I0_mild = PROTECT(allocVector(REALSXP, internal->dim_I0_mild));
  memcpy(REAL(I0_mild), internal->I0_mild, internal->dim_I0_mild * sizeof(double));
  odin_set_dim(I0_mild, 3, internal->dim_I0_mild_1, internal->dim_I0_mild_2, internal->dim_I0_mild_3);
  SET_VECTOR_ELT(contents, 618, I0_mild);
  ...
  SET_VECTOR_ELT(contents, 619, I0_triage_D_conf);
  ...
  SET_VECTOR_ELT(contents, 620, I0_triage_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 621, I0_triage_R);
  ...
  SET_VECTOR_ELT(contents, 630, initial_I_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 631, initial_I_hosp_R);
  ...
  SET_VECTOR_ELT(contents, 632, initial_I_ICU_D_conf);
  ...
  SET_VECTOR_ELT(contents, 633, initial_I_ICU_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 634, initial_I_ICU_R_conf);
  ...
  SET_VECTOR_ELT(contents, 635, initial_I_ICU_R_unconf);
  SEXP initial_I_ILI = PROTECT(allocVector(REALSXP, internal->dim_I_ILI));
  memcpy(REAL(initial_I_ILI), internal->initial_I_ILI, internal->dim_I_ILI * sizeof(double));
  odin_set_dim(initial_I_ILI, 3, internal->dim_I_ILI_1, internal->dim_I_ILI_2, internal->dim_I_ILI_3);
  SET_VECTOR_ELT(contents, 636, initial_I_ILI);
  SEXP initial_I_mild = PROTECT(allocVector(REALSXP, internal->dim_I_mild));
  memcpy(REAL(initial_I_mild), internal->initial_I_mild, internal->dim_I_mild * sizeof(double));
  odin_set_dim(initial_I_mild, 3, internal->dim_I_mild_1, internal->dim_I_mild_2, internal->dim_I_mild_3);
  SET_VECTOR_ELT(contents, 637, initial_I_mild);
  ...
  SET_VECTOR_ELT(contents, 638, initial_I_triage_D_conf);
  ...
  SET_VECTOR_ELT(contents, 639, initial_I_triage_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 640, initial_I_triage_R);
  SEXP initial_R = PROTECT(allocVector(REALSXP, internal->dim_R));
  memcpy(REAL(initial_R), internal->initial_R, internal->dim_R * sizeof(double));
  SET_VECTOR_ELT(contents, 641, initial_R);
  ...
  SET_VECTOR_ELT(contents, 642, initial_R_neg);
  ...
  SET_VECTOR_ELT(contents, 643, initial_R_pos);
  ...
  SET_VECTOR_ELT(contents, 644, initial_R_pre);
  ...
  SET_VECTOR_ELT(contents, 645, initial_R_stepdown_conf);
  ...
  SET_VECTOR_ELT(contents, 646, initial_R_stepdown_unconf);
  SEXP initial_S = PROTECT(allocVector(REALSXP, internal->dim_S));
  memcpy(REAL(initial_S), internal->initial_S, internal->dim_S * sizeof(double));
  SET_VECTOR_ELT(contents, 647, initial_S);
  SEXP lambda = PROTECT(allocVector(REALSXP, internal->dim_lambda));
  memcpy(REAL(lambda), internal->lambda, internal->dim_lambda * sizeof(double));
  SET_VECTOR_ELT(contents, 649, lambda);
  SEXP m = PROTECT(allocVector(REALSXP, internal->dim_m));
  memcpy(REAL(m), internal->m, internal->dim_m * sizeof(double));
  odin_set_dim(m, 2, internal->dim_m_1, internal->dim_m_2);
  SET_VECTOR_ELT(contents, 650, m);
  SET_VECTOR_ELT(contents, 651, ScalarInteger(internal->N_age));
  ...
  SET_VECTOR_ELT(contents, 652, n_com_to_R_pre);
  ...
  SET_VECTOR_ELT(contents, 653, n_com_to_R_total);
  SEXP n_EE = PROTECT(allocVector(REALSXP, internal->dim_n_EE));
  memcpy(REAL(n_EE), internal->n_EE, internal->dim_n_EE * sizeof(double));
  odin_set_dim(n_EE, 3, internal->dim_n_EE_1, internal->dim_n_EE_2, internal->dim_n_EE_3);
  SET_VECTOR_ELT(contents, 654, n_EE);
  SEXP n_EI_asympt = PROTECT(allocVector(REALSXP, internal->dim_n_EI_asympt));
  memcpy(REAL(n_EI_asympt), internal->n_EI_asympt, internal->dim_n_EI_asympt * sizeof(double));
  odin_set_dim(n_EI_asympt, 2, internal->dim_n_EI_asympt_1, internal->dim_n_EI_asympt_2);
  SET_VECTOR_ELT(contents, 655, n_EI_asympt);
  SEXP n_EI_ILI = PROTECT(allocVector(REALSXP, internal->dim_n_EI_ILI));
  memcpy(REAL(n_EI_ILI), internal->n_EI_ILI, internal->dim_n_EI_ILI * sizeof(double));
  odin_set_dim(n_EI_ILI, 2, internal->dim_n_EI_ILI_1, internal->dim_n_EI_ILI_2);
  SET_VECTOR_ELT(contents, 656, n_EI_ILI);
  SEXP n_EI_mild = PROTECT(allocVector(REALSXP, internal->dim_n_EI_mild));
  memcpy(REAL(n_EI_mild), internal->n_EI_mild, internal->dim_n_EI_mild * sizeof(double));
  odin_set_dim(n_EI_mild, 2, internal->dim_n_EI_mild_1, internal->dim_n_EI_mild_2);
  SET_VECTOR_ELT(contents, 657, n_EI_mild);
  ...
  SET_VECTOR_ELT(contents, 658, n_hosp_non_ICU);
  ...
  SET_VECTOR_ELT(contents, 659, n_I_hosp_D_unconf_to_conf);
  ...
  SET_VECTOR_ELT(contents, 660, n_I_hosp_R_unconf_to_conf);
  ...
  SET_VECTOR_ELT(contents, 661, n_I_ICU_D_unconf_to_conf);
  ...
  memcpy(REAL(n_II_asympt), internal->n_II_asympt, internal->dim_n_II_asympt * sizeof(double));
  odin_set_dim(n_II_asympt, 3, internal->dim_n_II_asympt_1, internal->dim_n_II_asympt_2, internal->dim_n_II_asympt_3);
  SET_VECTOR_ELT(contents, 665, n_II_asympt);
  ...
  SET_VECTOR_ELT(contents, 666, n_II_comm_D);
  ...
  SET_VECTOR_ELT(contents, 667, n_II_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 668, n_II_hosp_R);
  ...
  SET_VECTOR_ELT(contents, 669, n_II_ICU_D_conf);
  ...
  SET_VECTOR_ELT(contents, 670, n_II_ICU_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 671, n_II_ICU_R_conf);
  ...
  SET_VECTOR_ELT(contents, 672, n_II_ICU_R_unconf);
  SEXP n_II_ILI = PROTECT(allocVector(REALSXP, internal->dim_n_II_ILI));
  memcpy(REAL(n_II_ILI), internal->n_II_ILI, internal->dim_n_II_ILI * sizeof(double));
  odin_set_dim(n_II_ILI, 3, internal->dim_n_II_ILI_1, internal->dim_n_II_ILI_2, internal->dim_n_II_ILI_3);
  SET_VECTOR_ELT(contents, 673, n_II_ILI);
  SEXP n_II_mild = PROTECT(allocVector(REALSXP, internal->dim_n_II_mild));
  memcpy(REAL(n_II_mild), internal->n_II_mild, internal->dim_n_II_mild * sizeof(double));
  odin_set_dim(n_II_mild, 3, internal->dim_n_II_mild_1, internal->dim_n_II_mild_2, internal->dim_n_II_mild_3);
  SET_VECTOR_ELT(contents, 674, n_II_mild);
  ...
  SET_VECTOR_ELT(contents, 675, n_II_triage_D_conf);
  ...
  SET_VECTOR_ELT(contents, 676, n_II_triage_D_unconf);
  ...
  odin_set_dim(n_II_triage_R, 4, internal->dim_n_II_triage_R_1, internal->dim_n_II_triage_R_2, internal->dim_n_II_triage_R_3, internal->dim_n_II_triage_R_4);
  SET_VECTOR_ELT(contents, 677, n_II_triage_R);
  ...
  SET_VECTOR_ELT(contents, 678, n_ILI_to_comm_D);
  SEXP n_ILI_to_hosp = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_hosp));
  memcpy(REAL(n_ILI_to_hosp), internal->n_ILI_to_hosp, internal->dim_n_ILI_to_hosp * sizeof(double));
  odin_set_dim(n_ILI_to_hosp, 2, internal->dim_n_ILI_to_hosp_1, internal->dim_n_ILI_to_hosp_2);
  SET_VECTOR_ELT(contents, 679, n_ILI_to_hosp);
  ...
  SET_VECTOR_ELT(contents, 680, n_ILI_to_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 681, n_ILI_to_hosp_D_conf);
  ...
  SET_VECTOR_ELT(contents, 682, n_ILI_to_hosp_R);
  ...
  SET_VECTOR_ELT(contents, 683, n_ILI_to_hosp_R_conf);
  ...
  SET_VECTOR_ELT(contents, 684, n_ILI_to_triage);
  ...
  SET_VECTOR_ELT(contents, 685, n_ILI_to_triage_D);
  ...
  SET_VECTOR_ELT(contents, 686, n_ILI_to_triage_D_conf);
  ...
  SET_VECTOR_ELT(contents, 687, n_ILI_to_triage_R);
  ...
  SET_VECTOR_ELT(contents, 688, n_ILI_to_triage_R_conf);
  ...
  SET_VECTOR_ELT(contents, 689, n_R_pre);
  ...
  SET_VECTOR_ELT(contents, 690, n_R_stepdown_conf);
  ...
  SET_VECTOR_ELT(contents, 691, n_R_stepdown_unconf);
  ...
  SET_VECTOR_ELT(contents, 692, n_R_stepdown_unconf_to_conf);
  SEXP n_SE = PROTECT(allocVector(REALSXP, internal->dim_n_SE));
  memcpy(REAL(n_SE), internal->n_SE, internal->dim_n_SE * sizeof(double));
  SET_VECTOR_ELT(contents, 693, n_SE);
  ...
  SET_VECTOR_ELT(contents, 694, N_tot);
  ...
  SET_VECTOR_ELT(contents, 695, new_I_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 696, new_I_hosp_R);
  ...
  SET_VECTOR_ELT(contents, 697, new_I_ICU_D_conf);
  ...
  SET_VECTOR_ELT(contents, 698, new_I_ICU_D_unconf);
  ...
  SEXP new_I_triage_R = PROTECT(allocVector(REALSXP, internal->dim_new_I_triage_R));
  memcpy(REAL(new_I_triage_R), internal->new_I_triage_R, internal->dim_new_I_triage_R * sizeof(double));
  odin_set_dim(new_I_triage_R, 4, internal->dim_new_I_triage_R_1, internal->dim_new_I_triage_R_2, internal->dim_new_I_triage_R_3, internal->dim_new_I_triage_R_4);
  SET_VECTOR_ELT(contents, 703, new_I_triage_R);
  ...
  SET_VECTOR_ELT(contents, 704, new_R_stepdown_conf);
  ...
  SET_VECTOR_ELT(contents, 705, new_R_stepdown_unconf);
  SET_VECTOR_ELT(contents, 706, ScalarInteger(internal->offset_variable_D_comm));
  SET_VECTOR_ELT(contents, 707, ScalarInteger(internal->offset_variable_D_hosp));
  SET_VECTOR_ELT(contents, 708, ScalarInteger(internal->offset_variable_E));
  SET_VECTOR_ELT(contents, 709, ScalarInteger(internal->offset_variable_I_asympt));
  SET_VECTOR_ELT(contents, 710, ScalarInteger(internal->offset_variable_I_comm_D));
  SET_VECTOR_ELT(contents, 711, ScalarInteger(internal->offset_variable_I_hosp_D));
  SET_VECTOR_ELT(contents, 712, ScalarInteger(internal->offset_variable_I_hosp_R));
  SET_VECTOR_ELT(contents, 713, ScalarInteger(internal->offset_variable_I_ICU_D_conf));
  SET_VECTOR_ELT(contents, 714, ScalarInteger(internal->offset_variable_I_ICU_D_unconf));
  ...
  SET_VECTOR_ELT(contents, 721, ScalarInteger(internal->offset_variable_I_triage_R));
  SET_VECTOR_ELT(contents, 722, ScalarInteger(internal->offset_variable_R));
  SET_VECTOR_ELT(contents, 723, ScalarInteger(internal->offset_variable_R_neg));
  SET_VECTOR_ELT(contents, 724, ScalarInteger(internal->offset_variable_R_pos));
  SET_VECTOR_ELT(contents, 725, ScalarInteger(internal->offset_variable_R_pre));
  SET_VECTOR_ELT(contents, 726, ScalarInteger(internal->offset_variable_R_stepdown_conf));
  SET_VECTOR_ELT(contents, 727, ScalarInteger(internal->offset_variable_R_stepdown_unconf));
  ...
  SET_VECTOR_ELT(contents, 755, R0_stepdown_conf);
  ...
  SET_VECTOR_ELT(contents, 756, R0_stepdown_unconf);
  SET_VECTOR_ELT(contents, 757, ScalarInteger(internal->s_asympt));
  SET_VECTOR_ELT(contents, 758, ScalarInteger(internal->s_comm_D));
  SET_VECTOR_ELT(contents, 759, ScalarInteger(internal->s_E));
  SET_VECTOR_ELT(contents, 760, ScalarInteger(internal->s_hosp_D));
  SET_VECTOR_ELT(contents, 761, ScalarInteger(internal->s_hosp_R));
  SET_VECTOR_ELT(contents, 762, ScalarInteger(internal->s_ICU_D));
  SET_VECTOR_ELT(contents, 763, ScalarInteger(internal->s_ICU_R));
  SEXP s_ij = PROTECT(allocVector(REALSXP, internal->dim_s_ij));
  memcpy(REAL(s_ij), internal->s_ij, internal->dim_s_ij * sizeof(double));
  odin_set_dim(s_ij, 2, internal->dim_s_ij_1, internal->dim_s_ij_2);
  SET_VECTOR_ELT(contents, 764, s_ij);
  SET_VECTOR_ELT(contents, 765, ScalarInteger(internal->s_ILI));
  SET_VECTOR_ELT(contents, 766, ScalarInteger(internal->s_mild));
  SET_VECTOR_ELT(contents, 767, ScalarInteger(internal->s_R_pre));
  SET_VECTOR_ELT(contents, 768, ScalarInteger(internal->s_stepdown));
  SET_VECTOR_ELT(contents, 769, ScalarInteger(internal->s_triage));
  SEXP S0 = PROTECT(allocVector(REALSXP, internal->dim_S0));
  memcpy(REAL(S0), internal->S0, internal->dim_S0 * sizeof(double));
  SET_VECTOR_ELT(contents, 770, S0);
  SET_VECTOR_ELT(contents, 771, ScalarInteger(internal->test_classes));
  SET_VECTOR_ELT(contents, 772, ScalarInteger(internal->trans_classes));
  SEXP trans_increase = PROTECT(allocVector(REALSXP, internal->dim_trans_increase));
  memcpy(REAL(trans_increase), internal->trans_increase, internal->dim_trans_increase * sizeof(double));
  odin_set_dim(trans_increase, 2, internal->dim_trans_increase_1, internal->dim_trans_increase_2);
  SET_VECTOR_ELT(contents, 773, trans_increase);
  SEXP trans_profile = PROTECT(allocVector(REALSXP, internal->dim_trans_profile));
  memcpy(REAL(trans_profile), internal->trans_profile, internal->dim_trans_profile * sizeof(double));
  odin_set_dim(trans_profile, 2, internal->dim_trans_profile_1, internal->dim_trans_profile_2);
  SET_VECTOR_ELT(contents, 774, trans_profile);
  SEXP nms = PROTECT(allocVector(STRSXP, 775));
  SET_STRING_ELT(nms, 0, mkChar("aux_EE"));
  SET_STRING_ELT(nms, 1, mkChar("aux_II_asympt"));
  ...
  SET_STRING_ELT(nms, 13, mkChar("aux_II_triage_R"));
  SET_STRING_ELT(nms, 14, mkChar("aux_p_bin"));
  SET_STRING_ELT(nms, 15, mkChar("aux_R_pre"));
  SET_STRING_ELT(nms, 16, mkChar("aux_R_stepdown_conf"));
  SET_STRING_ELT(nms, 17, mkChar("aux_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 18, mkChar("beta_t"));
  SET_STRING_ELT(nms, 19, mkChar("beta_y"));
  SET_STRING_ELT(nms, 20, mkChar("comm_D_transmission"));
  SET_STRING_ELT(nms, 21, mkChar("cum0_admit_conf"));
  SET_STRING_ELT(nms, 22, mkChar("cum0_new_conf"));
  ...
  SET_STRING_ELT(nms, 54, mkChar("dim_aux_II_hosp_D_123"));
  SET_STRING_ELT(nms, 55, mkChar("dim_aux_II_hosp_D_2"));
  SET_STRING_ELT(nms, 56, mkChar("dim_aux_II_hosp_D_3"));
  SET_STRING_ELT(nms, 57, mkChar("dim_aux_II_hosp_D_4"));
  SET_STRING_ELT(nms, 58, mkChar("dim_aux_II_hosp_R"));
  SET_STRING_ELT(nms, 59, mkChar("dim_aux_II_hosp_R_1"));
  SET_STRING_ELT(nms, 60, mkChar("dim_aux_II_hosp_R_12"));
  SET_STRING_ELT(nms, 61, mkChar("dim_aux_II_hosp_R_123"));
  SET_STRING_ELT(nms, 62, mkChar("dim_aux_II_hosp_R_2"));
  SET_STRING_ELT(nms, 63, mkChar("dim_aux_II_hosp_R_3"));
  SET_STRING_ELT(nms, 64, mkChar("dim_aux_II_hosp_R_4"));
  SET_STRING_ELT(nms, 65, mkChar("dim_aux_II_ICU_D_conf"));
  SET_STRING_ELT(nms, 66, mkChar("dim_aux_II_ICU_D_conf_1"));
  SET_STRING_ELT(nms, 67, mkChar("dim_aux_II_ICU_D_conf_12"));
  SET_STRING_ELT(nms, 68, mkChar("dim_aux_II_ICU_D_conf_2"));
  SET_STRING_ELT(nms, 69, mkChar("dim_aux_II_ICU_D_conf_3"));
  SET_STRING_ELT(nms, 70, mkChar("dim_aux_II_ICU_D_unconf"));
  SET_STRING_ELT(nms, 71, mkChar("dim_aux_II_ICU_D_unconf_1"));
  SET_STRING_ELT(nms, 72, mkChar("dim_aux_II_ICU_D_unconf_12"));
  SET_STRING_ELT(nms, 73, mkChar("dim_aux_II_ICU_D_unconf_2"));
  SET_STRING_ELT(nms, 74, mkChar("dim_aux_II_ICU_D_unconf_3"));
  SET_STRING_ELT(nms, 75, mkChar("dim_aux_II_ICU_R_conf"));
  SET_STRING_ELT(nms, 76, mkChar("dim_aux_II_ICU_R_conf_1"));
  SET_STRING_ELT(nms, 77, mkChar("dim_aux_II_ICU_R_conf_12"));
  SET_STRING_ELT(nms, 78, mkChar("dim_aux_II_ICU_R_conf_2"));
  SET_STRING_ELT(nms, 79, mkChar("dim_aux_II_ICU_R_conf_3"));
  SET_STRING_ELT(nms, 80, mkChar("dim_aux_II_ICU_R_unconf"));
  SET_STRING_ELT(nms, 81, mkChar("dim_aux_II_ICU_R_unconf_1"));
  SET_STRING_ELT(nms, 82, mkChar("dim_aux_II_ICU_R_unconf_12"));
  SET_STRING_ELT(nms, 83, mkChar("dim_aux_II_ICU_R_unconf_2"));
  SET_STRING_ELT(nms, 84, mkChar("dim_aux_II_ICU_R_unconf_3"));
  SET_STRING_ELT(nms, 85, mkChar("dim_aux_II_ILI"));
  SET_STRING_ELT(nms, 86, mkChar("dim_aux_II_ILI_1"));
  SET_STRING_ELT(nms, 87, mkChar("dim_aux_II_ILI_12"));
  SET_STRING_ELT(nms, 88, mkChar("dim_aux_II_ILI_2"));
  SET_STRING_ELT(nms, 89, mkChar("dim_aux_II_ILI_3"));
  SET_STRING_ELT(nms, 90, mkChar("dim_aux_II_mild"));
  SET_STRING_ELT(nms, 91, mkChar("dim_aux_II_mild_1"));
  SET_STRING_ELT(nms, 92, mkChar("dim_aux_II_mild_12"));
  SET_STRING_ELT(nms, 93, mkChar("dim_aux_II_mild_2"));
  SET_STRING_ELT(nms, 94, mkChar("dim_aux_II_mild_3"));
  SET_STRING_ELT(nms, 95, mkChar("dim_aux_II_triage_D_conf"));
  SET_STRING_ELT(nms, 96, mkChar("dim_aux_II_triage_D_conf_1"));
  SET_STRING_ELT(nms, 97, mkChar("dim_aux_II_triage_D_conf_12"));
  SET_STRING_ELT(nms, 98, mkChar("dim_aux_II_triage_D_conf_2"));
  SET_STRING_ELT(nms, 99, mkChar("dim_aux_II_triage_D_conf_3"));
  SET_STRING_ELT(nms, 100, mkChar("dim_aux_II_triage_D_unconf"));
  SET_STRING_ELT(nms, 101, mkChar("dim_aux_II_triage_D_unconf_1"));
  SET_STRING_ELT(nms, 102, mkChar("dim_aux_II_triage_D_unconf_12"));
  SET_STRING_ELT(nms, 103, mkChar("dim_aux_II_triage_D_unconf_2"));
  SET_STRING_ELT(nms, 104, mkChar("dim_aux_II_triage_D_unconf_3"));
  SET_STRING_ELT(nms, 105, mkChar("dim_aux_II_triage_R"));
  SET_STRING_ELT(nms, 106, mkChar("dim_aux_II_triage_R_1"));
  SET_STRING_ELT(nms, 107, mkChar("dim_aux_II_triage_R_12"));
  SET_STRING_ELT(nms, 108, mkChar("dim_aux_II_triage_R_123"));
  SET_STRING_ELT(nms, 109, mkChar("dim_aux_II_triage_R_2"));
  SET_STRING_ELT(nms, 110, mkChar("dim_aux_II_triage_R_3"));
  SET_STRING_ELT(nms, 111, mkChar("dim_aux_II_triage_R_4"));
  ...
  SET_STRING_ELT(nms, 118, mkChar("dim_aux_R_stepdown_conf"));
  SET_STRING_ELT(nms, 119, mkChar("dim_aux_R_stepdown_conf_1"));
  SET_STRING_ELT(nms, 120, mkChar("dim_aux_R_stepdown_conf_2"));
  SET_STRING_ELT(nms, 121, mkChar("dim_aux_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 122, mkChar("dim_aux_R_stepdown_unconf_1"));
  SET_STRING_ELT(nms, 123, mkChar("dim_aux_R_stepdown_unconf_2"));
  SET_STRING_ELT(nms, 124, mkChar("dim_beta_t"));
  SET_STRING_ELT(nms, 125, mkChar("dim_beta_y"));
  SET_STRING_ELT(nms, 126, mkChar("dim_D_comm"));
  SET_STRING_ELT(nms, 127, mkChar("dim_D_hosp"));
  SET_STRING_ELT(nms, 128, mkChar("dim_D0_comm"));
  SET_STRING_ELT(nms, 129, mkChar("dim_D0_hosp"));
  SET_STRING_ELT(nms, 130, mkChar("dim_delta_D_comm"));
  SET_STRING_ELT(nms, 131, mkChar("dim_delta_D_hosp"));
  SET_STRING_ELT(nms, 132, mkChar("dim_delta_E"));
  SET_STRING_ELT(nms, 133, mkChar("dim_delta_E_1"));
  SET_STRING_ELT(nms, 134, mkChar("dim_delta_E_12"));
  SET_STRING_ELT(nms, 135, mkChar("dim_delta_E_2"));
  SET_STRING_ELT(nms, 136, mkChar("dim_delta_E_3"));
  SET_STRING_ELT(nms, 137, mkChar("dim_delta_I_asympt"));
  SET_STRING_ELT(nms, 138, mkChar("dim_delta_I_asympt_1"));
  SET_STRING_ELT(nms, 139, mkChar("dim_delta_I_asympt_12"));
  SET_STRING_ELT(nms, 140, mkChar("dim_delta_I_asympt_2"));
  SET_STRING_ELT(nms, 141, mkChar("dim_delta_I_asympt_3"));
  SET_STRING_ELT(nms, 142, mkChar("dim_delta_I_comm_D"));
  SET_STRING_ELT(nms, 143, mkChar("dim_delta_I_comm_D_1"));
  SET_STRING_ELT(nms, 144, mkChar("dim_delta_I_comm_D_12"));
  SET_STRING_ELT(nms, 145, mkChar("dim_delta_I_comm_D_2"));
  SET_STRING_ELT(nms, 146, mkChar("dim_delta_I_comm_D_3"));
  SET_STRING_ELT(nms, 147, mkChar("dim_delta_I_ILI"));
  SET_STRING_ELT(nms, 148, mkChar("dim_delta_I_ILI_1"));
  SET_STRING_ELT(nms, 149, mkChar("dim_delta_I_ILI_12"));
  SET_STRING_ELT(nms, 150, mkChar("dim_delta_I_ILI_2"));
  SET_STRING_ELT(nms, 151, mkChar("dim_delta_I_ILI_3"));
  SET_STRING_ELT(nms, 152, mkChar("dim_delta_I_mild"));
  SET_STRING_ELT(nms, 153, mkChar("dim_delta_I_mild_1"));
  SET_STRING_ELT(nms, 154, mkChar("dim_delta_I_mild_12"));
  SET_STRING_ELT(nms, 155, mkChar("dim_delta_I_mild_2"));
  SET_STRING_ELT(nms, 156, mkChar("dim_delta_I_mild_3"));
  SET_STRING_ELT(nms, 157, mkChar("dim_delta_R"));
  SET_STRING_ELT(nms, 158, mkChar("dim_delta_R_neg"));
  SET_STRING_ELT(nms, 159, mkChar("dim_delta_R_pos"));
  SET_STRING_ELT(nms, 160, mkChar("dim_delta_R_pre"));
  SET_STRING_ELT(nms, 161, mkChar("dim_delta_R_pre_1"));
  SET_STRING_ELT(nms, 162, mkChar("dim_delta_R_pre_2"));
  SET_STRING_ELT(nms, 163, mkChar("dim_E"));
  SET_STRING_ELT(nms, 164, mkChar("dim_E_1"));
  SET_STRING_ELT(nms, 165, mkChar("dim_E_12"));
  SET_STRING_ELT(nms, 166, mkChar("dim_E_2"));
  SET_STRING_ELT(nms, 167, mkChar("dim_E_3"));
  SET_STRING_ELT(nms, 168, mkChar("dim_E0"));
  SET_STRING_ELT(nms, 169, mkChar("dim_E0_1"));
  SET_STRING_ELT(nms, 170, mkChar("dim_E0_12"));
  SET_STRING_ELT(nms, 171, mkChar("dim_E0_2"));
  SET_STRING_ELT(nms, 172, mkChar("dim_E0_3"));
  SET_STRING_ELT(nms, 173, mkChar("dim_I_asympt"));
  SET_STRING_ELT(nms, 174, mkChar("dim_I_asympt_1"));
  SET_STRING_ELT(nms, 175, mkChar("dim_I_asympt_12"));
  SET_STRING_ELT(nms, 176, mkChar("dim_I_asympt_2"));
  SET_STRING_ELT(nms, 177, mkChar("dim_I_asympt_3"));
  SET_STRING_ELT(nms, 178, mkChar("dim_I_comm_D"));
  SET_STRING_ELT(nms, 179, mkChar("dim_I_comm_D_1"));
  SET_STRING_ELT(nms, 180, mkChar("dim_I_comm_D_12"));
  SET_STRING_ELT(nms, 181, mkChar("dim_I_comm_D_2"));
  SET_STRING_ELT(nms, 182, mkChar("dim_I_comm_D_3"));
  SET_STRING_ELT(nms, 183, mkChar("dim_I_hosp_D"));
  SET_STRING_ELT(nms, 184, mkChar("dim_I_hosp_D_1"));
  SET_STRING_ELT(nms, 185, mkChar("dim_I_hosp_D_12"));
  SET_STRING_ELT(nms, 186, mkChar("dim_I_hosp_D_123"));
  SET_STRING_ELT(nms, 187, mkChar("dim_I_hosp_D_2"));
  SET_STRING_ELT(nms, 188, mkChar("dim_I_hosp_D_3"));
  SET_STRING_ELT(nms, 189, mkChar("dim_I_hosp_D_4"));
  SET_STRING_ELT(nms, 190, mkChar("dim_I_hosp_R"));
  SET_STRING_ELT(nms, 191, mkChar("dim_I_hosp_R_1"));
  SET_STRING_ELT(nms, 192, mkChar("dim_I_hosp_R_12"));
  SET_STRING_ELT(nms, 193, mkChar("dim_I_hosp_R_123"));
  SET_STRING_ELT(nms, 194, mkChar("dim_I_hosp_R_2"));
  SET_STRING_ELT(nms, 195, mkChar("dim_I_hosp_R_3"));
  SET_STRING_ELT(nms, 196, mkChar("dim_I_hosp_R_4"));
  SET_STRING_ELT(nms, 197, mkChar("dim_I_ICU_D_conf"));
  SET_STRING_ELT(nms, 198, mkChar("dim_I_ICU_D_conf_1"));
  SET_STRING_ELT(nms, 199, mkChar("dim_I_ICU_D_conf_12"));
  SET_STRING_ELT(nms, 200, mkChar("dim_I_ICU_D_conf_2"));
  SET_STRING_ELT(nms, 201, mkChar("dim_I_ICU_D_conf_3"));
  SET_STRING_ELT(nms, 202, mkChar("dim_I_ICU_D_unconf"));
  SET_STRING_ELT(nms, 203, mkChar("dim_I_ICU_D_unconf_1"));
  SET_STRING_ELT(nms, 204, mkChar("dim_I_ICU_D_unconf_12"));
  SET_STRING_ELT(nms, 205, mkChar("dim_I_ICU_D_unconf_2"));
  SET_STRING_ELT(nms, 206, mkChar("dim_I_ICU_D_unconf_3"));
  SET_STRING_ELT(nms, 207, mkChar("dim_I_ICU_R_conf"));
  SET_STRING_ELT(nms, 208, mkChar("dim_I_ICU_R_conf_1"));
  SET_STRING_ELT(nms, 209, mkChar("dim_I_ICU_R_conf_12"));
  SET_STRING_ELT(nms, 210, mkChar("dim_I_ICU_R_conf_2"));
  SET_STRING_ELT(nms, 211, mkChar("dim_I_ICU_R_conf_3"));
  SET_STRING_ELT(nms, 212, mkChar("dim_I_ICU_R_unconf"));
  SET_STRING_ELT(nms, 213, mkChar("dim_I_ICU_R_unconf_1"));
  SET_STRING_ELT(nms, 214, mkChar("dim_I_ICU_R_unconf_12"));
  SET_STRING_ELT(nms, 215, mkChar("dim_I_ICU_R_unconf_2"));
  SET_STRING_ELT(nms, 216, mkChar("dim_I_ICU_R_unconf_3"));
  SET_STRING_ELT(nms, 217, mkChar("dim_I_ILI"));
  SET_STRING_ELT(nms, 218, mkChar("dim_I_ILI_1"));
  SET_STRING_ELT(nms, 219, mkChar("dim_I_ILI_12"));
  SET_STRING_ELT(nms, 220, mkChar("dim_I_ILI_2"));
  SET_STRING_ELT(nms, 221, mkChar("dim_I_ILI_3"));
  SET_STRING_ELT(nms, 222, mkChar("dim_I_mild"));
  SET_STRING_ELT(nms, 223, mkChar("dim_I_mild_1"));
  SET_STRING_ELT(nms, 224, mkChar("dim_I_mild_12"));
  SET_STRING_ELT(nms, 225, mkChar("dim_I_mild_2"));
  SET_STRING_ELT(nms, 226, mkChar("dim_I_mild_3"));
  SET_STRING_ELT(nms, 227, mkChar("dim_I_triage_D_conf"));
  SET_STRING_ELT(nms, 228, mkChar("dim_I_triage_D_conf_1"));
  SET_STRING_ELT(nms, 229, mkChar("dim_I_triage_D_conf_12"));
  SET_STRING_ELT(nms, 230, mkChar("dim_I_triage_D_conf_2"));
  SET_STRING_ELT(nms, 231, mkChar("dim_I_triage_D_conf_3"));
  SET_STRING_ELT(nms, 232, mkChar("dim_I_triage_D_unconf"));
  SET_STRING_ELT(nms, 233, mkChar("dim_I_triage_D_unconf_1"));
  SET_STRING_ELT(nms, 234, mkChar("dim_I_triage_D_unconf_12"));
  SET_STRING_ELT(nms, 235, mkChar("dim_I_triage_D_unconf_2"));
  SET_STRING_ELT(nms, 236, mkChar("dim_I_triage_D_unconf_3"));
  SET_STRING_ELT(nms, 237, mkChar("dim_I_triage_R"));
  SET_STRING_ELT(nms, 238, mkChar("dim_I_triage_R_1"));
  SET_STRING_ELT(nms, 239, mkChar("dim_I_triage_R_12"));
  SET_STRING_ELT(nms, 240, mkChar("dim_I_triage_R_123"));
  SET_STRING_ELT(nms, 241, mkChar("dim_I_triage_R_2"));
  SET_STRING_ELT(nms, 242, mkChar("dim_I_triage_R_3"));
  SET_STRING_ELT(nms, 243, mkChar("dim_I_triage_R_4"));
  SET_STRING_ELT(nms, 244, mkChar("dim_I_with_diff_trans"));
  SET_STRING_ELT(nms, 245, mkChar("dim_I_with_diff_trans_1"));
  SET_STRING_ELT(nms, 246, mkChar("dim_I_with_diff_trans_2"));
  SET_STRING_ELT(nms, 247, mkChar("dim_I0_asympt"));
  SET_STRING_ELT(nms, 248, mkChar("dim_I0_asympt_1"));
  SET_STRING_ELT(nms, 249, mkChar("dim_I0_asympt_12"));
  SET_STRING_ELT(nms, 250, mkChar("dim_I0_asympt_2"));
  SET_STRING_ELT(nms, 251, mkChar("dim_I0_asympt_3"));
  SET_STRING_ELT(nms, 252, mkChar("dim_I0_comm_D"));
  SET_STRING_ELT(nms, 253, mkChar("dim_I0_comm_D_1"));
  SET_STRING_ELT(nms, 254, mkChar("dim_I0_comm_D_12"));
  SET_STRING_ELT(nms, 255, mkChar("dim_I0_comm_D_2"));
  SET_STRING_ELT(nms, 256, mkChar("dim_I0_comm_D_3"));
  SET_STRING_ELT(nms, 257, mkChar("dim_I0_hosp_D"));
  SET_STRING_ELT(nms, 258, mkChar("dim_I0_hosp_D_1"));
  SET_STRING_ELT(nms, 259, mkChar("dim_I0_hosp_D_12"));
  SET_STRING_ELT(nms, 260, mkChar("dim_I0_hosp_D_123"));
  SET_STRING_ELT(nms, 261, mkChar("dim_I0_hosp_D_2"));
  SET_STRING_ELT(nms, 262, mkChar("dim_I0_hosp_D_3"));
  SET_STRING_ELT(nms, 263, mkChar("dim_I0_hosp_D_4"));
  SET_STRING_ELT(nms, 264, mkChar("dim_I0_hosp_R"));
  SET_STRING_ELT(nms, 265, mkChar("dim_I0_hosp_R_1"));
  SET_STRING_ELT(nms, 266, mkChar("dim_I0_hosp_R_12"));
  SET_STRING_ELT(nms, 267, mkChar("dim_I0_hosp_R_123"));
  SET_STRING_ELT(nms, 268, mkChar("dim_I0_hosp_R_2"));
  SET_STRING_ELT(nms, 269, mkChar("dim_I0_hosp_R_3"));
  SET_STRING_ELT(nms, 270, mkChar("dim_I0_hosp_R_4"));
  SET_STRING_ELT(nms, 271, mkChar("dim_I0_ICU_D_conf"));
  SET_STRING_ELT(nms, 272, mkChar("dim_I0_ICU_D_conf_1"));
  SET_STRING_ELT(nms, 273, mkChar("dim_I0_ICU_D_conf_12"));
  SET_STRING_ELT(nms, 274, mkChar("dim_I0_ICU_D_conf_2"));
  SET_STRING_ELT(nms, 275, mkChar("dim_I0_ICU_D_conf_3"));
  SET_STRING_ELT(nms, 276, mkChar("dim_I0_ICU_D_unconf"));
  SET_STRING_ELT(nms, 277, mkChar("dim_I0_ICU_D_unconf_1"));
  SET_STRING_ELT(nms, 278, mkChar("dim_I0_ICU_D_unconf_12"));
  SET_STRING_ELT(nms, 279, mkChar("dim_I0_ICU_D_unconf_2"));
  SET_STRING_ELT(nms, 280, mkChar("dim_I0_ICU_D_unconf_3"));
  SET_STRING_ELT(nms, 281, mkChar("dim_I0_ICU_R_conf"));
  SET_STRING_ELT(nms, 282, mkChar("dim_I0_ICU_R_conf_1"));
  SET_STRING_ELT(nms, 283, mkChar("dim_I0_ICU_R_conf_12"));
  SET_STRING_ELT(nms, 284, mkChar("dim_I0_ICU_R_conf_2"));
  SET_STRING_ELT(nms, 285, mkChar("dim_I0_ICU_R_conf_3"));
  SET_STRING_ELT(nms, 286, mkChar("dim_I0_ICU_R_unconf"));
  SET_STRING_ELT(nms, 287, mkChar("dim_I0_ICU_R_unconf_1"));
  SET_STRING_ELT(nms, 288, mkChar("dim_I0_ICU_R_unconf_12"));
  SET_STRING_ELT(nms, 289, mkChar("dim_I0_ICU_R_unconf_2"));
  SET_STRING_ELT(nms, 290, mkChar("dim_I0_ICU_R_unconf_3"));
  SET_STRING_ELT(nms, 291, mkChar("dim_I0_ILI"));
  SET_STRING_ELT(nms, 292, mkChar("dim_I0_ILI_1"));
  SET_STRING_ELT(nms, 293, mkChar("dim_I0_ILI_12"));
  SET_STRING_ELT(nms, 294, mkChar("dim_I0_ILI_2"));
  SET_STRING_ELT(nms, 295, mkChar("dim_I0_ILI_3"));
  SET_STRING_ELT(nms, 296, mkChar("dim_I0_mild"));
  SET_STRING_ELT(nms, 297, mkChar("dim_I0_mild_1"));
  SET_STRING_ELT(nms, 298, mkChar("dim_I0_mild_12"));
  SET_STRING_ELT(nms, 299, mkChar("dim_I0_mild_2"));
  SET_STRING_ELT(nms, 300, mkChar("dim_I0_mild_3"));
  SET_STRING_ELT(nms, 301, mkChar("dim_I0_triage_D_conf"));
  SET_STRING_ELT(nms, 302, mkChar("dim_I0_triage_D_conf_1"));
  SET_STRING_ELT(nms, 303, mkChar("dim_I0_triage_D_conf_12"));
  SET_STRING_ELT(nms, 304, mkChar("dim_I0_triage_D_conf_2"));
  SET_STRING_ELT(nms, 305, mkChar("dim_I0_triage_D_conf_3"));
  SET_STRING_ELT(nms, 306, mkChar("dim_I0_triage_D_unconf"));
  SET_STRING_ELT(nms, 307, mkChar("dim_I0_triage_D_unconf_1"));
  SET_STRING_ELT(nms, 308, mkChar("dim_I0_triage_D_unconf_12"));
  SET_STRING_ELT(nms, 309, mkChar("dim_I0_triage_D_unconf_2"));
  SET_STRING_ELT(nms, 310, mkChar("dim_I0_triage_D_unconf_3"));
  SET_STRING_ELT(nms, 311, mkChar("dim_I0_triage_R"));
  SET_STRING_ELT(nms, 312, mkChar("dim_I0_triage_R_1"));
  SET_STRING_ELT(nms, 313, mkChar("dim_I0_triage_R_12"));
  SET_STRING_ELT(nms, 314, mkChar("dim_I0_triage_R_123"));
  SET_STRING_ELT(nms, 315, mkChar("dim_I0_triage_R_2"));
  SET_STRING_ELT(nms, 316, mkChar("dim_I0_triage_R_3"));
  SET_STRING_ELT(nms, 317, mkChar("dim_I0_triage_R_4"));
  SET_STRING_ELT(nms, 318, mkChar("dim_lambda"));
  SET_STRING_ELT(nms, 319, mkChar("dim_m"));
  SET_STRING_ELT(nms, 320, mkChar("dim_m_1"));
  SET_STRING_ELT(nms, 321, mkChar("dim_m_2"));
  SET_STRING_ELT(nms, 322, mkChar("dim_n_com_to_R_pre"));
  SET_STRING_ELT(nms, 323, mkChar("dim_n_com_to_R_total"));
  SET_STRING_ELT(nms, 324, mkChar("dim_n_EE"));
  SET_STRING_ELT(nms, 325, mkChar("dim_n_EE_1"));
  SET_STRING_ELT(nms, 326, mkChar("dim_n_EE_12"));
  SET_STRING_ELT(nms, 327, mkChar("dim_n_EE_2"));
  SET_STRING_ELT(nms, 328, mkChar("dim_n_EE_3"));
  SET_STRING_ELT(nms, 329, mkChar("dim_n_EI_asympt"));
  SET_STRING_ELT(nms, 330, mkChar("dim_n_EI_asympt_1"));
  SET_STRING_ELT(nms, 331, mkChar("dim_n_EI_asympt_2"));
  SET_STRING_ELT(nms, 332, mkChar("dim_n_EI_ILI"));
  SET_STRING_ELT(nms, 333, mkChar("dim_n_EI_ILI_1"));
  SET_STRING_ELT(nms, 334, mkChar("dim_n_EI_ILI_2"));
  SET_STRING_ELT(nms, 335, mkChar("dim_n_EI_mild"));
  SET_STRING_ELT(nms, 336, mkChar("dim_n_EI_mild_1"));
  SET_STRING_ELT(nms, 337, mkChar("dim_n_EI_mild_2"));
  SET_STRING_ELT(nms, 338, mkChar("dim_n_hosp_non_ICU"));
  SET_STRING_ELT(nms, 339, mkChar("dim_n_hosp_non_ICU_1"));
  SET_STRING_ELT(nms, 340, mkChar("dim_n_hosp_non_ICU_2"));
  SET_STRING_ELT(nms, 341, mkChar("dim_n_I_hosp_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 342, mkChar("dim_n_I_hosp_D_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 343, mkChar("dim_n_I_hosp_D_unconf_to_conf_12"));
  SET_STRING_ELT(nms, 344, mkChar("dim_n_I_hosp_D_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 345, mkChar("dim_n_I_hosp_D_unconf_to_conf_3"));
  SET_STRING_ELT(nms, 346, mkChar("dim_n_I_hosp_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 347, mkChar("dim_n_I_hosp_R_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 348, mkChar("dim_n_I_hosp_R_unconf_to_conf_12"));
  SET_STRING_ELT(nms, 349, mkChar("dim_n_I_hosp_R_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 350, mkChar("dim_n_I_hosp_R_unconf_to_conf_3"));
  SET_STRING_ELT(nms, 351, mkChar("dim_n_I_ICU_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 352, mkChar("dim_n_I_ICU_D_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 353, mkChar("dim_n_I_ICU_D_unconf_to_conf_12"));
  SET_STRING_ELT(nms, 354, mkChar("dim_n_I_ICU_D_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 355, mkChar("dim_n_I_ICU_D_unconf_to_conf_3"));
  SET_STRING_ELT(nms, 356, mkChar("dim_n_I_ICU_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 357, mkChar("dim_n_I_ICU_R_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 358, mkChar("dim_n_I_ICU_R_unconf_to_conf_12"));
  SET_STRING_ELT(nms, 359, mkChar("dim_n_I_ICU_R_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 360, mkChar("dim_n_I_ICU_R_unconf_to_conf_3"));
  SET_STRING_ELT(nms, 361, mkChar("dim_n_I_triage_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 362, mkChar("dim_n_I_triage_D_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 363, mkChar("dim_n_I_triage_D_unconf_to_conf_12"));
  SET_STRING_ELT(nms, 364, mkChar("dim_n_I_triage_D_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 365, mkChar("dim_n_I_triage_D_unconf_to_conf_3"));
  SET_STRING_ELT(nms, 366, mkChar("dim_n_I_triage_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 367, mkChar("dim_n_I_triage_R_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 368, mkChar("dim_n_I_triage_R_unconf_to_conf_12"));
  SET_STRING_ELT(nms, 369, mkChar("dim_n_I_triage_R_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 370, mkChar("dim_n_I_triage_R_unconf_to_conf_3"));
  SET_STRING_ELT(nms, 371, mkChar("dim_n_II_asympt"));
  SET_STRING_ELT(nms, 372, mkChar("dim_n_II_asympt_1"));
  SET_STRING_ELT(nms, 373, mkChar("dim_n_II_asympt_12"));
  SET_STRING_ELT(nms, 374, mkChar("dim_n_II_asympt_2"));
  SET_STRING_ELT(nms, 375, mkChar("dim_n_II_asympt_3"));
  SET_STRING_ELT(nms, 376, mkChar("dim_n_II_comm_D"));
  SET_STRING_ELT(nms, 377, mkChar("dim_n_II_comm_D_1"));
  SET_STRING_ELT(nms, 378, mkChar("dim_n_II_comm_D_12"));
  SET_STRING_ELT(nms, 379, mkChar("dim_n_II_comm_D_2"));
  SET_STRING_ELT(nms, 380, mkChar("dim_n_II_comm_D_3"));
  SET_STRING_ELT(nms, 381, mkChar("dim_n_II_hosp_D"));
  SET_STRING_ELT(nms, 382, mkChar("dim_n_II_hosp_D_1"));
  SET_STRING_ELT(nms, 383, mkChar("dim_n_II_hosp_D_12"));
  SET_STRING_ELT(nms, 384, mkChar("dim_n_II_hosp_D_123"));
  SET_STRING_ELT(nms, 385, mkChar("dim_n_II_hosp_D_2"));
  SET_STRING_ELT(nms, 386, mkChar("dim_n_II_hosp_D_3"));
  SET_STRING_ELT(nms, 387, mkChar("dim_n_II_hosp_D_4"));
  SET_STRING_ELT(nms, 388, mkChar("dim_n_II_hosp_R"));
  SET_STRING_ELT(nms, 389, mkChar("dim_n_II_hosp_R_1"));
  SET_STRING_ELT(nms, 390, mkChar("dim_n_II_hosp_R_12"));
  SET_STRING_ELT(nms, 391, mkChar("dim_n_II_hosp_R_123"));
  SET_STRING_ELT(nms, 392, mkChar("dim_n_II_hosp_R_2"));
  SET_STRING_ELT(nms, 393, mkChar("dim_n_II_hosp_R_3"));
  SET_STRING_ELT(nms, 394, mkChar("dim_n_II_hosp_R_4"));
  SET_STRING_ELT(nms, 395, mkChar("dim_n_II_ICU_D_conf"));
  SET_STRING_ELT(nms, 396, mkChar("dim_n_II_ICU_D_conf_1"));
  SET_STRING_ELT(nms, 397, mkChar("dim_n_II_ICU_D_conf_12"));
  SET_STRING_ELT(nms, 398, mkChar("dim_n_II_ICU_D_conf_2"));
  SET_STRING_ELT(nms, 399, mkChar("dim_n_II_ICU_D_conf_3"));
  SET_STRING_ELT(nms, 400, mkChar("dim_n_II_ICU_D_unconf"));
  SET_STRING_ELT(nms, 401, mkChar("dim_n_II_ICU_D_unconf_1"));
  SET_STRING_ELT(nms, 402, mkChar("dim_n_II_ICU_D_unconf_12"));
  SET_STRING_ELT(nms, 403, mkChar("dim_n_II_ICU_D_unconf_2"));
  SET_STRING_ELT(nms, 404, mkChar("dim_n_II_ICU_D_unconf_3"));
  SET_STRING_ELT(nms, 405, mkChar("dim_n_II_ICU_R_conf"));
  SET_STRING_ELT(nms, 406, mkChar("dim_n_II_ICU_R_conf_1"));
  SET_STRING_ELT(nms, 407, mkChar("dim_n_II_ICU_R_conf_12"));
  SET_STRING_ELT(nms, 408, mkChar("dim_n_II_ICU_R_conf_2"));
  SET_STRING_ELT(nms, 409, mkChar("dim_n_II_ICU_R_conf_3"));
  SET_STRING_ELT(nms, 410, mkChar("dim_n_II_ICU_R_unconf"));
  SET_STRING_ELT(nms, 411, mkChar("dim_n_II_ICU_R_unconf_1"));
  SET_STRING_ELT(nms, 412, mkChar("dim_n_II_ICU_R_unconf_12"));
  SET_STRING_ELT(nms, 413, mkChar("dim_n_II_ICU_R_unconf_2"));
  SET_STRING_ELT(nms, 414, mkChar("dim_n_II_ICU_R_unconf_3"));
  SET_STRING_ELT(nms, 415, mkChar("dim_n_II_ILI"));
  SET_STRING_ELT(nms, 416, mkChar("dim_n_II_ILI_1"));
  SET_STRING_ELT(nms, 417, mkChar("dim_n_II_ILI_12"));
  SET_STRING_ELT(nms, 418, mkChar("dim_n_II_ILI_2"));
  SET_STRING_ELT(nms, 419, mkChar("dim_n_II_ILI_3"));
  SET_STRING_ELT(nms, 420, mkChar("dim_n_II_mild"));
  SET_STRING_ELT(nms, 421, mkChar("dim_n_II_mild_1"));
  SET_STRING_ELT(nms, 422, mkChar("dim_n_II_mild_12"));
  SET_STRING_ELT(nms, 423, mkChar("dim_n_II_mild_2"));
  SET_STRING_ELT(nms, 424, mkChar("dim_n_II_mild_3"));
  SET_STRING_ELT(nms, 425, mkChar("dim_n_II_triage_D_conf"));
  SET_STRING_ELT(nms, 426, mkChar("dim_n_II_triage_D_conf_1"));
  SET_STRING_ELT(nms, 427, mkChar("dim_n_II_triage_D_conf_12"));
  SET_STRING_ELT(nms, 428, mkChar("dim_n_II_triage_D_conf_2"));
  SET_STRING_ELT(nms, 429, mkChar("dim_n_II_triage_D_conf_3"));
  SET_STRING_ELT(nms, 430, mkChar("dim_n_II_triage_D_unconf"));
  SET_STRING_ELT(nms, 431, mkChar("dim_n_II_triage_D_unconf_1"));
  SET_STRING_ELT(nms, 432, mkChar("dim_n_II_triage_D_unconf_12"));
  SET_STRING_ELT(nms, 433, mkChar("dim_n_II_triage_D_unconf_2"));
  SET_STRING_ELT(nms, 434, mkChar("dim_n_II_triage_D_unconf_3"));
  SET_STRING_ELT(nms, 435, mkChar("dim_n_II_triage_R"));
  SET_STRING_ELT(nms, 436, mkChar("dim_n_II_triage_R_1"));
  SET_STRING_ELT(nms, 437, mkChar("dim_n_II_triage_R_12"));
  SET_STRING_ELT(nms, 438, mkChar("dim_n_II_triage_R_123"));
  SET_STRING_ELT(nms, 439, mkChar("dim_n_II_triage_R_2"));
  SET_STRING_ELT(nms, 440, mkChar("dim_n_II_triage_R_3"));
  SET_STRING_ELT(nms, 441, mkChar("dim_n_II_triage_R_4"));
  SET_STRING_ELT(nms, 442, mkChar("dim_n_ILI_to_comm_D"));
  SET_STRING_ELT(nms, 443, mkChar("dim_n_ILI_to_comm_D_1"));
  SET_STRING_ELT(nms, 444, mkChar("dim_n_ILI_to_comm_D_2"));
  SET_STRING_ELT(nms, 445, mkChar("dim_n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 446, mkChar("dim_n_ILI_to_hosp_1"));
  SET_STRING_ELT(nms, 447, mkChar("dim_n_ILI_to_hosp_2"));
  SET_STRING_ELT(nms, 448, mkChar("dim_n_ILI_to_hosp_D"));
  SET_STRING_ELT(nms, 449, mkChar("dim_n_ILI_to_hosp_D_1"));
  SET_STRING_ELT(nms, 450, mkChar("dim_n_ILI_to_hosp_D_2"));
  SET_STRING_ELT(nms, 451, mkChar("dim_n_ILI_to_hosp_D_conf"));
  SET_STRING_ELT(nms, 452, mkChar("dim_n_ILI_to_hosp_D_conf_1"));
  SET_STRING_ELT(nms, 453, mkChar("dim_n_ILI_to_hosp_D_conf_2"));
  SET_STRING_ELT(nms, 454, mkChar("dim_n_ILI_to_hosp_R"));
  SET_STRING_ELT(nms, 455, mkChar("dim_n_ILI_to_hosp_R_1"));
  SET_STRING_ELT(nms, 456, mkChar("dim_n_ILI_to_hosp_R_2"));
  SET_STRING_ELT(nms, 457, mkChar("dim_n_ILI_to_hosp_R_conf"));
  SET_STRING_ELT(nms, 458, mkChar("dim_n_ILI_to_hosp_R_conf_1"));
  SET_STRING_ELT(nms, 459, mkChar("dim_n_ILI_to_hosp_R_conf_2"));
  SET_STRING_ELT(nms, 460, mkChar("dim_n_ILI_to_triage"));
  SET_STRING_ELT(nms, 461, mkChar("dim_n_ILI_to_triage_1"));
  SET_STRING_ELT(nms, 462, mkChar("dim_n_ILI_to_triage_2"));
  SET_STRING_ELT(nms, 463, mkChar("dim_n_ILI_to_triage_D"));
  SET_STRING_ELT(nms, 464, mkChar("dim_n_ILI_to_triage_D_1"));
  SET_STRING_ELT(nms, 465, mkChar("dim_n_ILI_to_triage_D_2"));
  SET_STRING_ELT(nms, 466, mkChar("dim_n_ILI_to_triage_D_conf"));
  SET_STRING_ELT(nms, 467, mkChar("dim_n_ILI_to_triage_D_conf_1"));
  SET_STRING_ELT(nms, 468, mkChar("dim_n_ILI_to_triage_D_conf_2"));
  SET_STRING_ELT(nms, 469, mkChar("dim_n_ILI_to_triage_R"));
  SET_STRING_ELT(nms, 470, mkChar("dim_n_ILI_to_triage_R_1"));
  SET_STRING_ELT(nms, 471, mkChar("dim_n_ILI_to_triage_R_2"));
  SET_STRING_ELT(nms, 472, mkChar("dim_n_ILI_to_triage_R_conf"));
  SET_STRING_ELT(nms, 473, mkChar("dim_n_ILI_to_triage_R_conf_1"));
  SET_STRING_ELT(nms, 474, mkChar("dim_n_ILI_to_triage_R_conf_2"));
  SET_STRING_ELT(nms, 475, mkChar("dim_n_R_pre"));
  SET_STRING_ELT(nms, 476, mkChar("dim_n_R_pre_1"));
  SET_STRING_ELT(nms, 477, mkChar("dim_n_R_pre_2"));
  SET_STRING_ELT(nms, 478, mkChar("dim_n_R_stepdown_conf"));
  SET_STRING_ELT(nms, 479, mkChar("dim_n_R_stepdown_conf_1"));
  SET_STRING_ELT(nms, 480, mkChar("dim_n_R_stepdown_conf_2"));
  SET_STRING_ELT(nms, 481, mkChar("dim_n_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 482, mkChar("dim_n_R_stepdown_unconf_1"));
  SET_STRING_ELT(nms, 483, mkChar("dim_n_R_stepdown_unconf_2"));
  SET_STRING_ELT(nms, 484, mkChar("dim_n_R_stepdown_unconf_to_conf"));
  SET_STRING_ELT(nms, 485, mkChar("dim_n_R_stepdown_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 486, mkChar("dim_n_R_stepdown_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 487, mkChar("dim_n_SE"));
  SET_STRING_ELT(nms, 488, mkChar("dim_N_tot"));
  SET_STRING_ELT(nms, 489, mkChar("dim_new_I_hosp_D"));
  SET_STRING_ELT(nms, 490, mkChar("dim_new_I_hosp_D_1"));
  SET_STRING_ELT(nms, 491, mkChar("dim_new_I_hosp_D_12"));
  SET_STRING_ELT(nms, 492, mkChar("dim_new_I_hosp_D_123"));
  SET_STRING_ELT(nms, 493, mkChar("dim_new_I_hosp_D_2"));
  SET_STRING_ELT(nms, 494, mkChar("dim_new_I_hosp_D_3"));
  SET_STRING_ELT(nms, 495, mkChar("dim_new_I_hosp_D_4"));
  SET_STRING_ELT(nms, 496, mkChar("dim_new_I_hosp_R"));
  SET_STRING_ELT(nms, 497, mkChar("dim_new_I_hosp_R_1"));
  SET_STRING_ELT(nms, 498, mkChar("dim_new_I_hosp_R_12"));
  SET_STRING_ELT(nms, 499, mkChar("dim_new_I_hosp_R_123"));
  SET_STRING_ELT(nms, 500, mkChar("dim_new_I_hosp_R_2"));
  SET_STRING_ELT(nms, 501, mkChar("dim_new_I_hosp_R_3"));
  SET_STRING_ELT(nms, 502, mkChar("dim_new_I_hosp_R_4"));
  SET_STRING_ELT(nms, 503, mkChar("dim_new_I_ICU_D_conf"));
  SET_STRING_ELT(nms, 504, mkChar("dim_new_I_ICU_D_conf_1"));
  SET_STRING_ELT(nms, 505, mkChar("dim_new_I_ICU_D_conf_12"));
  SET_STRING_ELT(nms, 506, mkChar("dim_new_I_ICU_D_conf_2"));
  SET_STRING_ELT(nms, 507, mkChar("dim_new_I_ICU_D_conf_3"));
  SET_STRING_ELT(nms, 508, mkChar("dim_new_I_ICU_D_unconf"));
  SET_STRING_ELT(nms, 509, mkChar("dim_new_I_ICU_D_unconf_1"));
  SET_STRING_ELT(nms, 510, mkChar("dim_new_I_ICU_D_unconf_12"));
  SET_STRING_ELT(nms, 511, mkChar("dim_new_I_ICU_D_unconf_2"));
  SET_STRING_ELT(nms, 512, mkChar("dim_new_I_ICU_D_unconf_3"));
  SET_STRING_ELT(nms, 513, mkChar("dim_new_I_ICU_R_conf"));
  SET_STRING_ELT(nms, 514, mkChar("dim_new_I_ICU_R_conf_1"));
  SET_STRING_ELT(nms, 515, mkChar("dim_new_I_ICU_R_conf_12"));
  SET_STRING_ELT(nms, 516, mkChar("dim_new_I_ICU_R_conf_2"));
  SET_STRING_ELT(nms, 517, mkChar("dim_new_I_ICU_R_conf_3"));
  SET_STRING_ELT(nms, 518, mkChar("dim_new_I_ICU_R_unconf"));
  SET_STRING_ELT(nms, 519, mkChar("dim_new_I_ICU_R_unconf_1"));
  SET_STRING_ELT(nms, 520, mkChar("dim_new_I_ICU_R_unconf_12"));
  SET_STRING_ELT(nms, 521, mkChar("dim_new_I_ICU_R_unconf_2"));
  SET_STRING_ELT(nms, 522, mkChar("dim_new_I_ICU_R_unconf_3"));
  SET_STRING_ELT(nms, 523, mkChar("dim_new_I_triage_D_conf"));
  SET_STRING_ELT(nms, 524, mkChar("dim_new_I_triage_D_conf_1"));
  SET_STRING_ELT(nms, 525, mkChar("dim_new_I_triage_D_conf_12"));
  SET_STRING_ELT(nms, 526, mkChar("dim_new_I_triage_D_conf_2"));
  SET_STRING_ELT(nms, 527, mkChar("dim_new_I_triage_D_conf_3"));
  SET_STRING_ELT(nms, 528, mkChar("dim_new_I_triage_D_unconf"));
  SET_STRING_ELT(nms, 529, mkChar("dim_new_I_triage_D_unconf_1"));
  SET_STRING_ELT(nms, 530, mkChar("dim_new_I_triage_D_unconf_12"));
  SET_STRING_ELT(nms, 531, mkChar("dim_new_I_triage_D_unconf_2"));
  SET_STRING_ELT(nms, 532, mkChar("dim_new_I_triage_D_unconf_3"));
  SET_STRING_ELT(nms, 533, mkChar("dim_new_I_triage_R"));
  SET_STRING_ELT(nms, 534, mkChar("dim_new_I_triage_R_1"));
  SET_STRING_ELT(nms, 535, mkChar("dim_new_I_triage_R_12"));
  SET_STRING_ELT(nms, 536, mkChar("dim_new_I_triage_R_123"));
  SET_STRING_ELT(nms, 537, mkChar("dim_new_I_triage_R_2"));
  SET_STRING_ELT(nms, 538, mkChar("dim_new_I_triage_R_3"));
  SET_STRING_ELT(nms, 539, mkChar("dim_new_I_triage_R_4"));
  SET_STRING_ELT(nms, 540, mkChar("dim_new_R_stepdown_conf"));
  SET_STRING_ELT(nms, 541, mkChar("dim_new_R_stepdown_conf_1"));
  SET_STRING_ELT(nms, 542, mkChar("dim_new_R_stepdown_conf_2"));
  SET_STRING_ELT(nms, 543, mkChar("dim_new_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 544, mkChar("dim_new_R_stepdown_unconf_1"));
  SET_STRING_ELT(nms, 545, mkChar("dim_new_R_stepdown_unconf_2"));
  SET_STRING_ELT(nms, 546, mkChar("dim_p_admit_conf"));
  SET_STRING_ELT(nms, 547, mkChar("dim_p_asympt"));
  SET_STRING_ELT(nms, 548, mkChar("dim_p_death_comm"));
  SET_STRING_ELT(nms, 549, mkChar("dim_p_death_hosp_D"));
  SET_STRING_ELT(nms, 550, mkChar("dim_p_death_ICU"));
  SET_STRING_ELT(nms, 551, mkChar("dim_p_ICU_hosp"));
  SET_STRING_ELT(nms, 552, mkChar("dim_p_R_pre"));
  SET_STRING_ELT(nms, 553, mkChar("dim_p_recov_ILI"));
  SET_STRING_ELT(nms, 554, mkChar("dim_p_SE"));
  SET_STRING_ELT(nms, 555, mkChar("dim_p_seroconversion"));
  SET_STRING_ELT(nms, 556, mkChar("dim_p_sympt_ILI"));
  SET_STRING_ELT(nms, 557, mkChar("dim_R"));
  SET_STRING_ELT(nms, 558, mkChar("dim_R_neg"));
  SET_STRING_ELT(nms, 559, mkChar("dim_R_pos"));
  SET_STRING_ELT(nms, 560, mkChar("dim_R_pre"));
  SET_STRING_ELT(nms, 561, mkChar("dim_R_pre_1"));
  SET_STRING_ELT(nms, 562, mkChar("dim_R_pre_2"));
  SET_STRING_ELT(nms, 563, mkChar("dim_R_stepdown_conf"));
  SET_STRING_ELT(nms, 564, mkChar("dim_R_stepdown_conf_1"));
  SET_STRING_ELT(nms, 565, mkChar("dim_R_stepdown_conf_2"));
  SET_STRING_ELT(nms, 566, mkChar("dim_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 567, mkChar("dim_R_stepdown_unconf_1"));
  SET_STRING_ELT(nms, 568, mkChar("dim_R_stepdown_unconf_2"));
  SET_STRING_ELT(nms, 569, mkChar("dim_R0"));
  SET_STRING_ELT(nms, 570, mkChar("dim_R0_neg"));
  SET_STRING_ELT(nms, 571, mkChar("dim_R0_pos"));
  SET_STRING_ELT(nms, 572, mkChar("dim_R0_pre"));
  SET_STRING_ELT(nms, 573, mkChar("dim_R0_pre_1"));
  SET_STRING_ELT(nms, 574, mkChar("dim_R0_pre_2"));
  SET_STRING_ELT(nms, 575, mkChar("dim_R0_stepdown_conf"));
  SET_STRING_ELT(nms, 576, mkChar("dim_R0_stepdown_conf_1"));
  SET_STRING_ELT(nms, 577, mkChar("dim_R0_stepdown_conf_2"));
  SET_STRING_ELT(nms, 578, mkChar("dim_R0_stepdown_unconf"));
  SET_STRING_ELT(nms, 579, mkChar("dim_R0_stepdown_unconf_1"));
  SET_STRING_ELT(nms, 580, mkChar("dim_R0_stepdown_unconf_2"));
  SET_STRING_ELT(nms, 581, mkChar("dim_S"));
  SET_STRING_ELT(nms, 582, mkChar("dim_s_ij"));
  SET_STRING_ELT(nms, 583, mkChar("dim_s_ij_1"));
  SET_STRING_ELT(nms, 584, mkChar("dim_s_ij_2"));
  SET_STRING_ELT(nms, 585, mkChar("dim_S0"));
  SET_STRING_ELT(nms, 586, mkChar("dim_trans_increase"));
  SET_STRING_ELT(nms, 587, mkChar("dim_trans_increase_1"));
  SET_STRING_ELT(nms, 588, mkChar("dim_trans_increase_2"));
  SET_STRING_ELT(nms, 589, mkChar("dim_trans_profile"));
  SET_STRING_ELT(nms, 590, mkChar("dim_trans_profile_1"));
  SET_STRING_ELT(nms, 591, mkChar("dim_trans_profile_2"));
  SET_STRING_ELT(nms, 592, mkChar("dt"));
  SET_STRING_ELT(nms, 593, mkChar("E0"));
  SET_STRING_ELT(nms, 594, mkChar("gamma_asympt"));
  SET_STRING_ELT(nms, 595, mkChar("gamma_comm_D"));
  SET_STRING_ELT(nms, 596, mkChar("gamma_E"));
  SET_STRING_ELT(nms, 597, mkChar("gamma_hosp_D"));
  SET_STRING_ELT(nms, 598, mkChar("gamma_hosp_R"));
  SET_STRING_ELT(nms, 599, mkChar("gamma_ICU_D"));
  SET_STRING_ELT(nms, 600, mkChar("gamma_ICU_R"));
  SET_STRING_ELT(nms, 601, mkChar("gamma_ILI"));
  SET_STRING_ELT(nms, 602, mkChar("gamma_mild"));
  SET_STRING_ELT(nms, 603, mkChar("gamma_R_pre"));
  SET_STRING_ELT(nms, 604, mkChar("gamma_stepdown"));
  SET_STRING_ELT(nms, 605, mkChar("gamma_test"));
  SET_STRING_ELT(nms, 606, mkChar("gamma_triage"));
  SET_STRING_ELT(nms, 607, mkChar("hosp_transmission"));
  SET_STRING_ELT(nms, 608, mkChar("I_with_diff_trans"));
  SET_STRING_ELT(nms, 609, mkChar("I0_asympt"));
  SET_STRING_ELT(nms, 610, mkChar("I0_comm_D"));
  SET_STRING_ELT(nms, 611, mkChar("I0_hosp_D"));
  SET_STRING_ELT(nms, 612, mkChar("I0_hosp_R"));
  SET_STRING_ELT(nms, 613, mkChar("I0_ICU_D_conf"));
  SET_STRING_ELT(nms, 614, mkChar("I0_ICU_D_unconf"));
  SET_STRING_ELT(nms, 615, mkChar("I0_ICU_R_conf"));
  SET_STRING_ELT(nms, 616, mkChar("I0_ICU_R_unconf"));
  SET_STRING_ELT(nms, 617, mkChar("I0_ILI"));
  SET_STRING_ELT(nms, 618, mkChar("I0_mild"));
  SET_STRING_ELT(nms, 619, mkChar("I0_triage_D_conf"));
  SET_STRING_ELT(nms, 620, mkChar("I0_triage_D_unconf"));
  SET_STRING_ELT(nms, 621, mkChar("I0_triage_R"));
  ...
  SET_STRING_ELT(nms, 630, mkChar("initial_I_hosp_D"));
  SET_STRING_ELT(nms, 631, mkChar("initial_I_hosp_R"));
  SET_STRING_ELT(nms, 632, mkChar("initial_I_ICU_D_conf"));
  SET_STRING_ELT(nms, 633, mkChar("initial_I_ICU_D_unconf"));
  SET_STRING_ELT(nms, 634, mkChar("initial_I_ICU_R_conf"));
  SET_STRING_ELT(nms, 635, mkChar("initial_I_ICU_R_unconf"));
  SET_STRING_ELT(nms, 636, mkChar("initial_I_ILI"));
  SET_STRING_ELT(nms, 637, mkChar("initial_I_mild"));
  SET_STRING_ELT(nms, 638, mkChar("initial_I_triage_D_conf"));
  SET_STRING_ELT(nms, 639, mkChar("initial_I_triage_D_unconf"));
  SET_STRING_ELT(nms, 640, mkChar("initial_I_triage_R"));
  SET_STRING_ELT(nms, 641, mkChar("initial_R"));
  SET_STRING_ELT(nms, 642, mkChar("initial_R_neg"));
  SET_STRING_ELT(nms, 643, mkChar("initial_R_pos"));
  SET_STRING_ELT(nms, 644, mkChar("initial_R_pre"));
  SET_STRING_ELT(nms, 645, mkChar("initial_R_stepdown_conf"));
  SET_STRING_ELT(nms, 646, mkChar("initial_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 647, mkChar("initial_S"));
  SET_STRING_ELT(nms, 648, mkChar("interpolate_beta"));
  SET_STRING_ELT(nms, 649, mkChar("lambda"));
  SET_STRING_ELT(nms, 650, mkChar("m"));
  SET_STRING_ELT(nms, 651, mkChar("N_age"));
  SET_STRING_ELT(nms, 652, mkChar("n_com_to_R_pre"));
  SET_STRING_ELT(nms, 653, mkChar("n_com_to_R_total"));
  SET_STRING_ELT(nms, 654, mkChar("n_EE"));
  SET_STRING_ELT(nms, 655, mkChar("n_EI_asympt"));
  SET_STRING_ELT(nms, 656, mkChar("n_EI_ILI"));
  SET_STRING_ELT(nms, 657, mkChar("n_EI_mild"));
  SET_STRING_ELT(nms, 658, mkChar("n_hosp_non_ICU"));
  SET_STRING_ELT(nms, 659, mkChar("n_I_hosp_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 660, mkChar("n_I_hosp_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 661, mkChar("n_I_ICU_D_unconf_to_conf"));
  ...
  SET_STRING_ELT(nms, 665, mkChar("n_II_asympt"));
  SET_STRING_ELT(nms, 666, mkChar("n_II_comm_D"));
  SET_STRING_ELT(nms, 667, mkChar("n_II_hosp_D"));
  SET_STRING_ELT(nms, 668, mkChar("n_II_hosp_R"));
  SET_STRING_ELT(nms, 669, mkChar("n_II_ICU_D_conf"));
  SET_STRING_ELT(nms, 670, mkChar("n_II_ICU_D_unconf"));
  SET_STRING_ELT(nms, 671, mkChar("n_II_ICU_R_conf"));
  SET_STRING_ELT(nms, 672, mkChar("n_II_ICU_R_unconf"));
  SET_STRING_ELT(nms, 673, mkChar("n_II_ILI"));
  SET_STRING_ELT(nms, 674, mkChar("n_II_mild"));
  SET_STRING_ELT(nms, 675, mkChar("n_II_triage_D_conf"));
  SET_STRING_ELT(nms, 676, mkChar("n_II_triage_D_unconf"));
  SET_STRING_ELT(nms, 677, mkChar("n_II_triage_R"));
  SET_STRING_ELT(nms, 678, mkChar("n_ILI_to_comm_D"));
  SET_STRING_ELT(nms, 679, mkChar("n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 680, mkChar("n_ILI_to_hosp_D"));
  SET_STRING_ELT(nms, 681, mkChar("n_ILI_to_hosp_D_conf"));
  SET_STRING_ELT(nms, 682, mkChar("n_ILI_to_hosp_R"));
  SET_STRING_ELT(nms, 683, mkChar("n_ILI_to_hosp_R_conf"));
  SET_STRING_ELT(nms, 684, mkChar("n_ILI_to_triage"));
  SET_STRING_ELT(nms, 685, mkChar("n_ILI_to_triage_D"));
  SET_STRING_ELT(nms, 686, mkChar("n_ILI_to_triage_D_conf"));
  SET_STRING_ELT(nms, 687, mkChar("n_ILI_to_triage_R"));
  SET_STRING_ELT(nms, 688, mkChar("n_ILI_to_triage_R_conf"));
  SET_STRING_ELT(nms, 689, mkChar("n_R_pre"));
  SET_STRING_ELT(nms, 690, mkChar("n_R_stepdown_conf"));
  SET_STRING_ELT(nms, 691, mkChar("n_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 692, mkChar("n_R_stepdown_unconf_to_conf"));
  SET_STRING_ELT(nms, 693, mkChar("n_SE"));
  SET_STRING_ELT(nms, 694, mkChar("N_tot"));
  SET_STRING_ELT(nms, 695, mkChar("new_I_hosp_D"));
  SET_STRING_ELT(nms, 696, mkChar("new_I_hosp_R"));
  SET_STRING_ELT(nms, 697, mkChar("new_I_ICU_D_conf"));
  SET_STRING_ELT(nms, 698, mkChar("new_I_ICU_D_unconf"));
  ...
  SET_STRING_ELT(nms, 703, mkChar("new_I_triage_R"));
  SET_STRING_ELT(nms, 704, mkChar("new_R_stepdown_conf"));
  SET_STRING_ELT(nms, 705, mkChar("new_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 706, mkChar("offset_variable_D_comm"));
  SET_STRING_ELT(nms, 707, mkChar("offset_variable_D_hosp"));
  SET_STRING_ELT(nms, 708, mkChar("offset_variable_E"));
  SET_STRING_ELT(nms, 709, mkChar("offset_variable_I_asympt"));
  SET_STRING_ELT(nms, 710, mkChar("offset_variable_I_comm_D"));
  SET_STRING_ELT(nms, 711, mkChar("offset_variable_I_hosp_D"));
  SET_STRING_ELT(nms, 712, mkChar("offset_variable_I_hosp_R"));
  SET_STRING_ELT(nms, 713, mkChar("offset_variable_I_ICU_D_conf"));
  SET_STRING_ELT(nms, 714, mkChar("offset_variable_I_ICU_D_unconf"));
  ...
  SET_STRING_ELT(nms, 721, mkChar("offset_variable_I_triage_R"));
  SET_STRING_ELT(nms, 722, mkChar("offset_variable_R"));
  SET_STRING_ELT(nms, 723, mkChar("offset_variable_R_neg"));
  SET_STRING_ELT(nms, 724, mkChar("offset_variable_R_pos"));
  SET_STRING_ELT(nms, 725, mkChar("offset_variable_R_pre"));
  SET_STRING_ELT(nms, 726, mkChar("offset_variable_R_stepdown_conf"));
  SET_STRING_ELT(nms, 727, mkChar("offset_variable_R_stepdown_unconf"));
  ...
  SET_STRING_ELT(nms, 755, mkChar("R0_stepdown_conf"));
  SET_STRING_ELT(nms, 756, mkChar("R0_stepdown_unconf"));
  SET_STRING_ELT(nms, 757, mkChar("s_asympt"));
  SET_STRING_ELT(nms, 758, mkChar("s_comm_D"));
  SET_STRING_ELT(nms, 759, mkChar("s_E"));
  SET_STRING_ELT(nms, 760, mkChar("s_hosp_D"));
  SET_STRING_ELT(nms, 761, mkChar("s_hosp_R"));
  SET_STRING_ELT(nms, 762, mkChar("s_ICU_D"));
  SET_STRING_ELT(nms, 763, mkChar("s_ICU_R"));
  SET_STRING_ELT(nms, 764, mkChar("s_ij"));
  SET_STRING_ELT(nms, 765, mkChar("s_ILI"));
  SET_STRING_ELT(nms, 766, mkChar("s_mild"));
  SET_STRING_ELT(nms, 767, mkChar("s_R_pre"));
  SET_STRING_ELT(nms, 768, mkChar("s_stepdown"));
  SET_STRING_ELT(nms, 769, mkChar("s_triage"));
  SET_STRING_ELT(nms, 770, mkChar("S0"));
  SET_STRING_ELT(nms, 771, mkChar("test_classes"));
  SET_STRING_ELT(nms, 772, mkChar("trans_classes"));
  SET_STRING_ELT(nms, 773, mkChar("trans_increase"));
  SET_STRING_ELT(nms, 774, mkChar("trans_profile"));
  setAttrib(contents, R_NamesSymbol, nms);
  UNPROTECT(150);
  return contents;
}
SEXP hospital_with_serology_testing_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->dim_aux_II_triage_R_4 = internal->test_classes;
  internal->dim_aux_p_bin_1 = internal->N_age;
  internal->dim_aux_p_bin_2 = internal->trans_classes;
  ...
  internal->dim_n_II_triage_R_4 = internal->test_classes;
  ...
  internal->dim_new_I_triage_R_1 = internal->N_age;
  internal->dim_new_I_triage_R_2 = internal->s_triage;
  internal->dim_new_I_triage_R_3 = internal->trans_classes;
  internal->dim_new_I_triage_R_4 = internal->test_classes;
  ...
  internal->dim_aux_II_triage_R = internal->dim_aux_II_triage_R_1 * internal->dim_aux_II_triage_R_2 * internal->dim_aux_II_triage_R_3 * internal->dim_aux_II_triage_R_4;
  internal->dim_aux_II_triage_R_12 = internal->dim_aux_II_triage_R_1 * internal->dim_aux_II_triage_R_2;
  internal->dim_aux_II_triage_R_123 = internal->dim_aux_II_triage_R_1 * internal->dim_aux_II_triage_R_2 * internal->dim_aux_II_triage_R_3;
  internal->dim_aux_p_bin = internal->dim_aux_p_bin_1 * internal->dim_aux_p_bin_2;
  ...
  internal->dim_n_II_triage_R = internal->dim_n_II_triage_R_1 * internal->dim_n_II_triage_R_2 * internal->dim_n_II_triage_R_3 * internal->dim_n_II_triage_R_4;
  internal->dim_n_II_triage_R_12 = internal->dim_n_II_triage_R_1 * internal->dim_n_II_triage_R_2;
  internal->dim_n_II_triage_R_123 = internal->dim_n_II_triage_R_1 * internal->dim_n_II_triage_R_2 * internal->dim_n_II_triage_R_3;
  ...
  internal->dim_new_I_triage_R = internal->dim_new_I_triage_R_1 * internal->dim_new_I_triage_R_2 * internal->dim_new_I_triage_R_3 * internal->dim_new_I_triage_R_4;
  internal->dim_new_I_triage_R_12 = internal->dim_new_I_triage_R_1 * internal->dim_new_I_triage_R_2;
  internal->dim_new_I_triage_R_123 = internal->dim_new_I_triage_R_1 * internal->dim_new_I_triage_R_2 * internal->dim_new_I_triage_R_3;
  ...
  Free(internal->new_I_triage_R);
  internal->new_I_triage_R = (double*) Calloc(internal->dim_new_I_triage_R, double);
  Free(internal->new_R_stepdown_conf);
...
SEXP hospital_with_serology_testing_metadata(SEXP internal_p) {
  ...
  int * dim_I_triage_D_unconf = INTEGER(VECTOR_ELT(variable_length, 16));
  ...
  int * dim_I_triage_D_conf = INTEGER(VECTOR_ELT(variable_length, 17));
  ...
  int * dim_I_ICU_R_unconf = INTEGER(VECTOR_ELT(variable_length, 18));
  ...
  int * dim_I_ICU_R_conf = INTEGER(VECTOR_ELT(variable_length, 19));
  ...
  int * dim_I_ICU_D_unconf = INTEGER(VECTOR_ELT(variable_length, 20));
  ...
  int * dim_I_ICU_D_conf = INTEGER(VECTOR_ELT(variable_length, 21));
  ...
  int * dim_I_triage_R = INTEGER(VECTOR_ELT(variable_length, 22));
  ...
  int * dim_I_hosp_R = INTEGER(VECTOR_ELT(variable_length, 23));
  ...
  int * dim_I_hosp_D = INTEGER(VECTOR_ELT(variable_length, 24));
  ...
  SET_STRING_ELT(variable_names, 16, mkChar("I_triage_D_unconf"));
  SET_STRING_ELT(variable_names, 17, mkChar("I_triage_D_conf"));
  SET_STRING_ELT(variable_names, 18, mkChar("I_ICU_R_unconf"));
  SET_STRING_ELT(variable_names, 19, mkChar("I_ICU_R_conf"));
  SET_STRING_ELT(variable_names, 20, mkChar("I_ICU_D_unconf"));
  SET_STRING_ELT(variable_names, 21, mkChar("I_ICU_D_conf"));
  SET_STRING_ELT(variable_names, 22, mkChar("I_triage_R"));
  SET_STRING_ELT(variable_names, 23, mkChar("I_hosp_R"));
  SET_STRING_ELT(variable_names, 24, mkChar("I_hosp_D"));
  SET_VECTOR_ELT(ret, 0, variable_length);
  UNPROTECT(2);
...
SEXP hospital_with_serology_testing_initial_conditions(SEXP internal_p, SEXP step_ptr) {
  hospital_with_serology_testing_internal *internal = hospital_with_serology_testing_get_internal(internal_p, 1);
  SEXP r_state = PROTECT(allocVector(REALSXP, 2 + internal->dim_S + internal->dim_R_pos + internal->dim_R_neg + internal->dim_R + internal->dim_D_hosp + internal->dim_D_comm + internal->dim_R_stepdown_unconf + internal->dim_R_stepdown_conf + internal->dim_R_pre + internal->dim_E + internal->dim_I_asympt + internal->dim_I_mild + internal->dim_I_ILI + internal->dim_I_comm_D + internal->dim_I_triage_D_unconf + internal->dim_I_triage_D_conf + internal->dim_I_ICU_R_unconf + internal->dim_I_ICU_R_conf + internal->dim_I_ICU_D_unconf + internal->dim_I_ICU_D_conf + internal->dim_I_triage_R + internal->dim_I_hosp_R + internal->dim_I_hosp_D));
  double * state = REAL(r_state);
...
void hospital_with_serology_testing_rhs(hospital_with_serology_testing_internal* internal, size_t step, double * state, double * state_next, double * output) {
  ...
  for (int i = 1; i <= internal->dim_n_II_triage_R_1; ++i) {
    for (int j = 1; j <= internal->dim_n_II_triage_R_2; ++j) {
      for (int k = 1; k <= internal->dim_n_II_triage_R_3; ++k) {
        for (int l = 1; l <= internal->dim_n_II_triage_R_4; ++l) {
          internal->n_II_triage_R[i - 1 + internal->dim_n_II_triage_R_1 * (j - 1) + internal->dim_n_II_triage_R_12 * (k - 1) + internal->dim_n_II_triage_R_123 * (l - 1)] = Rf_rbinom(round(I_triage_R[internal->dim_I_triage_R_123 * (l - 1) + internal->dim_I_triage_R_12 * (k - 1) + internal->dim_I_triage_R_1 * (j - 1) + i - 1]), internal->p_II_triage);
        }
      }
    }
  }
  ...
  for (int i = 1; i <= internal->dim_aux_II_ICU_R_unconf_1; ++i) {
    int j = 1;
    for (int k = 1; k <= internal->dim_aux_II_ICU_R_unconf_3; ++k) {
      internal->aux_II_ICU_R_unconf[i - 1 + internal->dim_aux_II_ICU_R_unconf_1 * (j - 1) + internal->dim_aux_II_ICU_R_unconf_12 * (k - 1)] = internal->aux_II_ICU_R_unconf[internal->dim_aux_II_ICU_R_unconf_12 * (k - 1) + internal->dim_aux_II_ICU_R_unconf_1 * (j - 1) + i - 1] + internal->n_II_triage_R[internal->dim_n_II_triage_R_123 * 0 + internal->dim_n_II_triage_R_12 * (k - 1) + internal->dim_n_II_triage_R_1 * (internal->s_triage - 1) + i - 1];
    }
  }
  for (int i = 1; i <= internal->dim_aux_II_ICU_R_unconf_1; ++i) {
    for (int j = 2; j <= internal->s_ICU_R; ++j) {
  ...
  for (int i = 1; i <= internal->dim_aux_II_triage_R_1; ++i) {
    for (int j = 1; j <= internal->dim_aux_II_triage_R_2; ++j) {
      for (int k = 1; k <= internal->dim_aux_II_triage_R_3; ++k) {
        for (int l = 1; l <= internal->dim_aux_II_triage_R_4; ++l) {
          internal->aux_II_triage_R[i - 1 + internal->dim_aux_II_triage_R_1 * (j - 1) + internal->dim_aux_II_triage_R_12 * (k - 1) + internal->dim_aux_II_triage_R_123 * (l - 1)] = I_triage_R[internal->dim_I_triage_R_123 * (l - 1) + internal->dim_I_triage_R_12 * (k - 1) + internal->dim_I_triage_R_1 * (j - 1) + i - 1];
        }
      }
    }
  }
  for (int i = 1; i <= internal->dim_aux_II_triage_R_1; ++i) {
    for (int j = 2; j <= internal->s_triage; ++j) {
      for (int k = 1; k <= internal->dim_aux_II_triage_R_3; ++k) {
        for (int l = 1; l <= internal->dim_aux_II_triage_R_4; ++l) {
          internal->aux_II_triage_R[i - 1 + internal->dim_aux_II_triage_R_1 * (j - 1) + internal->dim_aux_II_triage_R_12 * (k - 1) + internal->dim_aux_II_triage_R_123 * (l - 1)] = internal->aux_II_triage_R[internal->dim_aux_II_triage_R_123 * (l - 1) + internal->dim_aux_II_triage_R_12 * (k - 1) + internal->dim_aux_II_triage_R_1 * (j - 1) + i - 1] + internal->n_II_triage_R[internal->dim_n_II_triage_R_123 * (l - 1) + internal->dim_n_II_triage_R_12 * (k - 1) + internal->dim_n_II_triage_R_1 * (j - 1 - 1) + i - 1];
        }
      }
    }
  }
  for (int i = 1; i <= internal->dim_aux_II_triage_R_1; ++i) {
    for (int j = 1; j <= internal->s_triage; ++j) {
      for (int k = 1; k <= internal->dim_aux_II_triage_R_3; ++k) {
        for (int l = 1; l <= internal->dim_aux_II_triage_R_4; ++l) {
          internal->aux_II_triage_R[i - 1 + internal->dim_aux_II_triage_R_1 * (j - 1) + internal->dim_aux_II_triage_R_12 * (k - 1) + internal->dim_aux_II_triage_R_123 * (l - 1)] = internal->aux_II_triage_R[internal->dim_aux_II_triage_R_123 * (l - 1) + internal->dim_aux_II_triage_R_12 * (k - 1) + internal->dim_aux_II_triage_R_1 * (j - 1) + i - 1] - internal->n_II_triage_R[internal->dim_n_II_triage_R_123 * (l - 1) + internal->dim_n_II_triage_R_12 * (k - 1) + internal->dim_n_II_triage_R_1 * (j - 1) + i - 1];
        }
      }
    }
  }
  ...
  for (int i = 1; i <= internal->dim_n_I_triage_R_unconf_to_conf_1; ++i) {
    for (int j = 1; j <= internal->dim_n_I_triage_R_unconf_to_conf_2; ++j) {
      for (int k = 1; k <= internal->dim_n_I_triage_R_unconf_to_conf_3; ++k) {
        internal->n_I_triage_R_unconf_to_conf[i - 1 + internal->dim_n_I_triage_R_unconf_to_conf_1 * (j - 1) + internal->dim_n_I_triage_R_unconf_to_conf_12 * (k - 1)] = Rf_rbinom(round(internal->aux_II_triage_R[internal->dim_aux_II_triage_R_123 * 0 + internal->dim_aux_II_triage_R_12 * (k - 1) + internal->dim_aux_II_triage_R_1 * (j - 1) + i - 1]), internal->p_test);
      }
    }
  }
  ...
  for (int i = 1; i <= internal->dim_new_I_triage_R_1; ++i) {
    for (int j = 1; j <= internal->dim_new_I_triage_R_2; ++j) {
      for (int k = 1; k <= internal->dim_new_I_triage_R_3; ++k) {
        int l = 1;
        internal->new_I_triage_R[i - 1 + internal->dim_new_I_triage_R_1 * (j - 1) + internal->dim_new_I_triage_R_12 * (k - 1) + internal->dim_new_I_triage_R_123 * (l - 1)] = internal->aux_II_triage_R[internal->dim_aux_II_triage_R_123 * 0 + internal->dim_aux_II_triage_R_12 * (k - 1) + internal->dim_aux_II_triage_R_1 * (j - 1) + i - 1] - internal->n_I_triage_R_unconf_to_conf[internal->dim_n_I_triage_R_unconf_to_conf_12 * (k - 1) + internal->dim_n_I_triage_R_unconf_to_conf_1 * (j - 1) + i - 1];
      }
    }
  }
  for (int i = 1; i <= internal->dim_new_I_triage_R_1; ++i) {
    ...
    for (int k = 1; k <= internal->dim_new_I_triage_R_3; ++k) {
      int l = 1;
      internal->new_I_triage_R[i - 1 + internal->dim_new_I_triage_R_1 * (j - 1) + internal->dim_new_I_triage_R_12 * (k - 1) + internal->dim_new_I_triage_R_123 * (l - 1)] = internal->new_I_triage_R[internal->dim_new_I_triage_R_123 * 0 + internal->dim_new_I_triage_R_12 * (k - 1) + internal->dim_new_I_triage_R_1 * 0 + i - 1] + internal->n_ILI_to_triage_R[internal->dim_n_ILI_to_triage_R_1 * (k - 1) + i - 1] - internal->n_ILI_to_triage_R_conf[internal->dim_n_ILI_to_triage_R_conf_1 * (k - 1) + i - 1];
    }
  }
  for (int i = 1; i <= internal->dim_new_I_triage_R_1; ++i) {
    for (int j = 1; j <= internal->dim_new_I_triage_R_2; ++j) {
      for (int k = 1; k <= internal->dim_new_I_triage_R_3; ++k) {
        int l = 2;
        internal->new_I_triage_R[i - 1 + internal->dim_new_I_triage_R_1 * (j - 1) + internal->dim_new_I_triage_R_12 * (k - 1) + internal->dim_new_I_triage_R_123 * (l - 1)] = internal->aux_II_triage_R[internal->dim_aux_II_triage_R_123 * 1 + internal->dim_aux_II_triage_R_12 * (k - 1) + internal->dim_aux_II_triage_R_1 * (j - 1) + i - 1] + internal->n_I_triage_R_unconf_to_conf[internal->dim_n_I_triage_R_unconf_to_conf_12 * (k - 1) + internal->dim_n_I_triage_R_unconf_to_conf_1 * (j - 1) + i - 1];
      }
    }
  }
  for (int i = 1; i <= internal->dim_new_I_triage_R_1; ++i) {
    ...
    for (int k = 1; k <= internal->dim_new_I_triage_R_3; ++k) {
      int l = 2;
      internal->new_I_triage_R[i - 1 + internal->dim_new_I_triage_R_1 * (j - 1) + internal->dim_new_I_triage_R_12 * (k - 1) + internal->dim_new_I_triage_R_123 * (l - 1)] = internal->new_I_triage_R[internal->dim_new_I_triage_R_123 * 1 + internal->dim_new_I_triage_R_12 * (k - 1) + internal->dim_new_I_triage_R_1 * 0 + i - 1] + internal->n_ILI_to_triage_R_conf[internal->dim_n_ILI_to_triage_R_conf_1 * (k - 1) + i - 1];
    }
  }
  for (int i = 1; i <= internal->dim_I_ILI_1; ++i) {
    for (int j = 1; j <= internal->dim_I_ILI_2; ++j) {
  ...
  for (int i = 1; i <= internal->dim_I_triage_R_1; ++i) {
    for (int j = 1; j <= internal->dim_I_triage_R_2; ++j) {
      for (int k = 1; k <= internal->dim_I_triage_R_3; ++k) {
        for (int l = 1; l <= internal->dim_I_triage_R_4; ++l) {
          state_next[internal->offset_variable_I_triage_R + i - 1 + internal->dim_I_triage_R_1 * (j - 1) + internal->dim_I_triage_R_12 * (k - 1) + internal->dim_I_triage_R_123 * (l - 1)] = internal->new_I_triage_R[internal->dim_new_I_triage_R_123 * (l - 1) + internal->dim_new_I_triage_R_12 * (k - 1) + internal->dim_new_I_triage_R_1 * (j - 1) + i - 1];
        }
      }
    }
  }
