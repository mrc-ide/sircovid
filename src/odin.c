...
SEXP hospital_with_serology_testing_contents(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(contents, 353, ScalarInteger(internal->dim_n_EE));
  SET_VECTOR_ELT(contents, 354, ScalarInteger(internal->dim_n_EE_1));
  SET_VECTOR_ELT(contents, 355, ScalarInteger(internal->dim_n_EE_12));
  SET_VECTOR_ELT(contents, 356, ScalarInteger(internal->dim_n_EE_2));
  SET_VECTOR_ELT(contents, 357, ScalarInteger(internal->dim_n_EE_3));
  SET_VECTOR_ELT(contents, 358, ScalarInteger(internal->dim_n_EI_asympt));
  SET_VECTOR_ELT(contents, 359, ScalarInteger(internal->dim_n_EI_asympt_1));
  SET_VECTOR_ELT(contents, 360, ScalarInteger(internal->dim_n_EI_asympt_2));
  SET_VECTOR_ELT(contents, 361, ScalarInteger(internal->dim_n_EI_ILI));
  SET_VECTOR_ELT(contents, 362, ScalarInteger(internal->dim_n_EI_ILI_1));
  SET_VECTOR_ELT(contents, 363, ScalarInteger(internal->dim_n_EI_ILI_2));
  SET_VECTOR_ELT(contents, 364, ScalarInteger(internal->dim_n_EI_mild));
  SET_VECTOR_ELT(contents, 365, ScalarInteger(internal->dim_n_EI_mild_1));
  SET_VECTOR_ELT(contents, 366, ScalarInteger(internal->dim_n_EI_mild_2));
  SET_VECTOR_ELT(contents, 367, ScalarInteger(internal->dim_n_hosp_non_ICU));
  SET_VECTOR_ELT(contents, 368, ScalarInteger(internal->dim_n_hosp_non_ICU_1));
  SET_VECTOR_ELT(contents, 369, ScalarInteger(internal->dim_n_hosp_non_ICU_2));
  SET_VECTOR_ELT(contents, 370, ScalarInteger(internal->dim_n_I_hosp_D_unconf_to_conf));
  SET_VECTOR_ELT(contents, 371, ScalarInteger(internal->dim_n_I_hosp_D_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 372, ScalarInteger(internal->dim_n_I_hosp_D_unconf_to_conf_12));
  SET_VECTOR_ELT(contents, 373, ScalarInteger(internal->dim_n_I_hosp_D_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 374, ScalarInteger(internal->dim_n_I_hosp_D_unconf_to_conf_3));
  SET_VECTOR_ELT(contents, 375, ScalarInteger(internal->dim_n_I_hosp_R_unconf_to_conf));
  SET_VECTOR_ELT(contents, 376, ScalarInteger(internal->dim_n_I_hosp_R_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 377, ScalarInteger(internal->dim_n_I_hosp_R_unconf_to_conf_12));
  SET_VECTOR_ELT(contents, 378, ScalarInteger(internal->dim_n_I_hosp_R_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 379, ScalarInteger(internal->dim_n_I_hosp_R_unconf_to_conf_3));
  SET_VECTOR_ELT(contents, 380, ScalarInteger(internal->dim_n_I_ICU_D_unconf_to_conf));
  SET_VECTOR_ELT(contents, 381, ScalarInteger(internal->dim_n_I_ICU_D_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 382, ScalarInteger(internal->dim_n_I_ICU_D_unconf_to_conf_12));
  SET_VECTOR_ELT(contents, 383, ScalarInteger(internal->dim_n_I_ICU_D_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 384, ScalarInteger(internal->dim_n_I_ICU_D_unconf_to_conf_3));
  SET_VECTOR_ELT(contents, 385, ScalarInteger(internal->dim_n_I_ICU_R_unconf_to_conf));
  SET_VECTOR_ELT(contents, 386, ScalarInteger(internal->dim_n_I_ICU_R_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 387, ScalarInteger(internal->dim_n_I_ICU_R_unconf_to_conf_12));
  SET_VECTOR_ELT(contents, 388, ScalarInteger(internal->dim_n_I_ICU_R_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 389, ScalarInteger(internal->dim_n_I_ICU_R_unconf_to_conf_3));
  SET_VECTOR_ELT(contents, 390, ScalarInteger(internal->dim_n_I_triage_D_unconf_to_conf));
  SET_VECTOR_ELT(contents, 391, ScalarInteger(internal->dim_n_I_triage_D_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 392, ScalarInteger(internal->dim_n_I_triage_D_unconf_to_conf_12));
  SET_VECTOR_ELT(contents, 393, ScalarInteger(internal->dim_n_I_triage_D_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 394, ScalarInteger(internal->dim_n_I_triage_D_unconf_to_conf_3));
  SET_VECTOR_ELT(contents, 395, ScalarInteger(internal->dim_n_I_triage_R_unconf_to_conf));
  SET_VECTOR_ELT(contents, 396, ScalarInteger(internal->dim_n_I_triage_R_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 397, ScalarInteger(internal->dim_n_I_triage_R_unconf_to_conf_12));
  SET_VECTOR_ELT(contents, 398, ScalarInteger(internal->dim_n_I_triage_R_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 399, ScalarInteger(internal->dim_n_I_triage_R_unconf_to_conf_3));
  ...
  SET_VECTOR_ELT(contents, 516, ScalarInteger(internal->dim_n_R_stepdown_conf));
  SET_VECTOR_ELT(contents, 517, ScalarInteger(internal->dim_n_R_stepdown_conf_1));
  SET_VECTOR_ELT(contents, 518, ScalarInteger(internal->dim_n_R_stepdown_conf_2));
  SET_VECTOR_ELT(contents, 519, ScalarInteger(internal->dim_n_R_stepdown_unconf));
  SET_VECTOR_ELT(contents, 520, ScalarInteger(internal->dim_n_R_stepdown_unconf_1));
  SET_VECTOR_ELT(contents, 521, ScalarInteger(internal->dim_n_R_stepdown_unconf_2));
  SET_VECTOR_ELT(contents, 522, ScalarInteger(internal->dim_n_R_stepdown_unconf_to_conf));
  SET_VECTOR_ELT(contents, 523, ScalarInteger(internal->dim_n_R_stepdown_unconf_to_conf_1));
  SET_VECTOR_ELT(contents, 524, ScalarInteger(internal->dim_n_R_stepdown_unconf_to_conf_2));
  SET_VECTOR_ELT(contents, 525, ScalarInteger(internal->dim_n_SE));
  SET_VECTOR_ELT(contents, 526, ScalarInteger(internal->dim_N_tot));
  ...
  SET_VECTOR_ELT(contents, 598, ScalarInteger(internal->dim_p_hosp_ILI));
  ...
  memcpy(REAL(n_EE), internal->n_EE, internal->dim_n_EE * sizeof(double));
  odin_set_dim(n_EE, 3, internal->dim_n_EE_1, internal->dim_n_EE_2, internal->dim_n_EE_3);
  SET_VECTOR_ELT(contents, 706, n_EE);
  SEXP n_EI_asympt = PROTECT(allocVector(REALSXP, internal->dim_n_EI_asympt));
  memcpy(REAL(n_EI_asympt), internal->n_EI_asympt, internal->dim_n_EI_asympt * sizeof(double));
  odin_set_dim(n_EI_asympt, 2, internal->dim_n_EI_asympt_1, internal->dim_n_EI_asympt_2);
  SET_VECTOR_ELT(contents, 707, n_EI_asympt);
  SEXP n_EI_ILI = PROTECT(allocVector(REALSXP, internal->dim_n_EI_ILI));
  memcpy(REAL(n_EI_ILI), internal->n_EI_ILI, internal->dim_n_EI_ILI * sizeof(double));
  odin_set_dim(n_EI_ILI, 2, internal->dim_n_EI_ILI_1, internal->dim_n_EI_ILI_2);
  SET_VECTOR_ELT(contents, 708, n_EI_ILI);
  SEXP n_EI_mild = PROTECT(allocVector(REALSXP, internal->dim_n_EI_mild));
  memcpy(REAL(n_EI_mild), internal->n_EI_mild, internal->dim_n_EI_mild * sizeof(double));
  odin_set_dim(n_EI_mild, 2, internal->dim_n_EI_mild_1, internal->dim_n_EI_mild_2);
  SET_VECTOR_ELT(contents, 709, n_EI_mild);
  ...
  SET_VECTOR_ELT(contents, 710, n_hosp_non_ICU);
  ...
  SET_VECTOR_ELT(contents, 711, n_I_hosp_D_unconf_to_conf);
  ...
  SET_VECTOR_ELT(contents, 712, n_I_hosp_R_unconf_to_conf);
  ...
  SET_VECTOR_ELT(contents, 713, n_I_ICU_D_unconf_to_conf);
  ...
  SET_VECTOR_ELT(contents, 714, n_I_ICU_R_unconf_to_conf);
  ...
  SET_VECTOR_ELT(contents, 715, n_I_triage_D_unconf_to_conf);
  ...
  SET_VECTOR_ELT(contents, 716, n_I_triage_R_unconf_to_conf);
  SEXP n_II_asympt = PROTECT(allocVector(REALSXP, internal->dim_n_II_asympt));
  memcpy(REAL(n_II_asympt), internal->n_II_asympt, internal->dim_n_II_asympt * sizeof(double));
  odin_set_dim(n_II_asympt, 3, internal->dim_n_II_asympt_1, internal->dim_n_II_asympt_2, internal->dim_n_II_asympt_3);
  SET_VECTOR_ELT(contents, 717, n_II_asympt);
  ...
  SET_VECTOR_ELT(contents, 718, n_II_comm_D);
  ...
  SET_VECTOR_ELT(contents, 719, n_II_hosp_D_conf);
  ...
  SET_VECTOR_ELT(contents, 720, n_II_hosp_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 721, n_II_hosp_R_conf);
  ...
  SET_VECTOR_ELT(contents, 722, n_II_hosp_R_unconf);
  ...
  SET_VECTOR_ELT(contents, 723, n_II_ICU_D_conf);
  ...
  SET_VECTOR_ELT(contents, 724, n_II_ICU_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 725, n_II_ICU_R_conf);
  ...
  SET_VECTOR_ELT(contents, 726, n_II_ICU_R_unconf);
  SEXP n_II_ILI = PROTECT(allocVector(REALSXP, internal->dim_n_II_ILI));
  memcpy(REAL(n_II_ILI), internal->n_II_ILI, internal->dim_n_II_ILI * sizeof(double));
  odin_set_dim(n_II_ILI, 3, internal->dim_n_II_ILI_1, internal->dim_n_II_ILI_2, internal->dim_n_II_ILI_3);
  SET_VECTOR_ELT(contents, 727, n_II_ILI);
  SEXP n_II_mild = PROTECT(allocVector(REALSXP, internal->dim_n_II_mild));
  memcpy(REAL(n_II_mild), internal->n_II_mild, internal->dim_n_II_mild * sizeof(double));
  odin_set_dim(n_II_mild, 3, internal->dim_n_II_mild_1, internal->dim_n_II_mild_2, internal->dim_n_II_mild_3);
  SET_VECTOR_ELT(contents, 728, n_II_mild);
  ...
  SET_VECTOR_ELT(contents, 729, n_II_triage_D_conf);
  ...
  SET_VECTOR_ELT(contents, 730, n_II_triage_D_unconf);
  ...
  SET_VECTOR_ELT(contents, 731, n_II_triage_R_conf);
  ...
  SET_VECTOR_ELT(contents, 732, n_II_triage_R_unconf);
  ...
  SET_VECTOR_ELT(contents, 733, n_ILI_to_comm_D);
  SEXP n_ILI_to_hosp = PROTECT(allocVector(REALSXP, internal->dim_n_ILI_to_hosp));
  memcpy(REAL(n_ILI_to_hosp), internal->n_ILI_to_hosp, internal->dim_n_ILI_to_hosp * sizeof(double));
  odin_set_dim(n_ILI_to_hosp, 2, internal->dim_n_ILI_to_hosp_1, internal->dim_n_ILI_to_hosp_2);
  SET_VECTOR_ELT(contents, 734, n_ILI_to_hosp);
  ...
  SET_VECTOR_ELT(contents, 735, n_ILI_to_hosp_D);
  ...
  SET_VECTOR_ELT(contents, 736, n_ILI_to_hosp_D_conf);
  ...
  SET_VECTOR_ELT(contents, 737, n_ILI_to_hosp_R);
  ...
  SET_VECTOR_ELT(contents, 738, n_ILI_to_hosp_R_conf);
  ...
  SET_VECTOR_ELT(contents, 739, n_ILI_to_triage);
  ...
  SET_VECTOR_ELT(contents, 740, n_ILI_to_triage_D);
  ...
  SET_VECTOR_ELT(contents, 741, n_ILI_to_triage_D_conf);
  ...
  SET_VECTOR_ELT(contents, 742, n_ILI_to_triage_R);
  ...
  SET_VECTOR_ELT(contents, 743, n_ILI_to_triage_R_conf);
  ...
  SET_VECTOR_ELT(contents, 744, n_R_pre);
  ...
  SET_VECTOR_ELT(contents, 745, n_R_stepdown_conf);
  ...
  SET_VECTOR_ELT(contents, 746, n_R_stepdown_unconf);
  ...
  SET_VECTOR_ELT(contents, 747, n_R_stepdown_unconf_to_conf);
  SEXP n_SE = PROTECT(allocVector(REALSXP, internal->dim_n_SE));
  memcpy(REAL(n_SE), internal->n_SE, internal->dim_n_SE * sizeof(double));
  SET_VECTOR_ELT(contents, 748, n_SE);
  ...
  SET_VECTOR_ELT(contents, 749, N_tot);
  ...
  SET_VECTOR_ELT(contents, 795, p_hosp_ILI);
  ...
  SET_VECTOR_ELT(contents, 796, p_ICU_hosp);
  SET_VECTOR_ELT(contents, 797, ScalarReal(internal->p_II_asympt));
  SET_VECTOR_ELT(contents, 798, ScalarReal(internal->p_II_comm_D));
  SET_VECTOR_ELT(contents, 799, ScalarReal(internal->p_II_hosp_D));
  SET_VECTOR_ELT(contents, 800, ScalarReal(internal->p_II_hosp_R));
  SET_VECTOR_ELT(contents, 801, ScalarReal(internal->p_II_ICU_D));
  SET_VECTOR_ELT(contents, 802, ScalarReal(internal->p_II_ICU_R));
  SET_VECTOR_ELT(contents, 803, ScalarReal(internal->p_II_ILI));
  SET_VECTOR_ELT(contents, 804, ScalarReal(internal->p_II_mild));
  SET_VECTOR_ELT(contents, 805, ScalarReal(internal->p_II_triage));
  ...
  SET_VECTOR_ELT(contents, 806, p_R_pre);
  SET_VECTOR_ELT(contents, 807, ScalarReal(internal->p_R_stepdown));
  SEXP p_SE = PROTECT(allocVector(REALSXP, internal->dim_p_SE));
  memcpy(REAL(p_SE), internal->p_SE, internal->dim_p_SE * sizeof(double));
  ...
  SET_STRING_ELT(nms, 353, mkChar("dim_n_EE"));
  SET_STRING_ELT(nms, 354, mkChar("dim_n_EE_1"));
  SET_STRING_ELT(nms, 355, mkChar("dim_n_EE_12"));
  SET_STRING_ELT(nms, 356, mkChar("dim_n_EE_2"));
  SET_STRING_ELT(nms, 357, mkChar("dim_n_EE_3"));
  SET_STRING_ELT(nms, 358, mkChar("dim_n_EI_asympt"));
  SET_STRING_ELT(nms, 359, mkChar("dim_n_EI_asympt_1"));
  SET_STRING_ELT(nms, 360, mkChar("dim_n_EI_asympt_2"));
  SET_STRING_ELT(nms, 361, mkChar("dim_n_EI_ILI"));
  SET_STRING_ELT(nms, 362, mkChar("dim_n_EI_ILI_1"));
  SET_STRING_ELT(nms, 363, mkChar("dim_n_EI_ILI_2"));
  SET_STRING_ELT(nms, 364, mkChar("dim_n_EI_mild"));
  SET_STRING_ELT(nms, 365, mkChar("dim_n_EI_mild_1"));
  SET_STRING_ELT(nms, 366, mkChar("dim_n_EI_mild_2"));
  SET_STRING_ELT(nms, 367, mkChar("dim_n_hosp_non_ICU"));
  SET_STRING_ELT(nms, 368, mkChar("dim_n_hosp_non_ICU_1"));
  SET_STRING_ELT(nms, 369, mkChar("dim_n_hosp_non_ICU_2"));
  SET_STRING_ELT(nms, 370, mkChar("dim_n_I_hosp_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 371, mkChar("dim_n_I_hosp_D_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 372, mkChar("dim_n_I_hosp_D_unconf_to_conf_12"));
  SET_STRING_ELT(nms, 373, mkChar("dim_n_I_hosp_D_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 374, mkChar("dim_n_I_hosp_D_unconf_to_conf_3"));
  SET_STRING_ELT(nms, 375, mkChar("dim_n_I_hosp_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 376, mkChar("dim_n_I_hosp_R_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 377, mkChar("dim_n_I_hosp_R_unconf_to_conf_12"));
  SET_STRING_ELT(nms, 378, mkChar("dim_n_I_hosp_R_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 379, mkChar("dim_n_I_hosp_R_unconf_to_conf_3"));
  SET_STRING_ELT(nms, 380, mkChar("dim_n_I_ICU_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 381, mkChar("dim_n_I_ICU_D_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 382, mkChar("dim_n_I_ICU_D_unconf_to_conf_12"));
  SET_STRING_ELT(nms, 383, mkChar("dim_n_I_ICU_D_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 384, mkChar("dim_n_I_ICU_D_unconf_to_conf_3"));
  SET_STRING_ELT(nms, 385, mkChar("dim_n_I_ICU_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 386, mkChar("dim_n_I_ICU_R_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 387, mkChar("dim_n_I_ICU_R_unconf_to_conf_12"));
  SET_STRING_ELT(nms, 388, mkChar("dim_n_I_ICU_R_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 389, mkChar("dim_n_I_ICU_R_unconf_to_conf_3"));
  SET_STRING_ELT(nms, 390, mkChar("dim_n_I_triage_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 391, mkChar("dim_n_I_triage_D_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 392, mkChar("dim_n_I_triage_D_unconf_to_conf_12"));
  SET_STRING_ELT(nms, 393, mkChar("dim_n_I_triage_D_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 394, mkChar("dim_n_I_triage_D_unconf_to_conf_3"));
  SET_STRING_ELT(nms, 395, mkChar("dim_n_I_triage_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 396, mkChar("dim_n_I_triage_R_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 397, mkChar("dim_n_I_triage_R_unconf_to_conf_12"));
  SET_STRING_ELT(nms, 398, mkChar("dim_n_I_triage_R_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 399, mkChar("dim_n_I_triage_R_unconf_to_conf_3"));
  ...
  SET_STRING_ELT(nms, 516, mkChar("dim_n_R_stepdown_conf"));
  SET_STRING_ELT(nms, 517, mkChar("dim_n_R_stepdown_conf_1"));
  SET_STRING_ELT(nms, 518, mkChar("dim_n_R_stepdown_conf_2"));
  SET_STRING_ELT(nms, 519, mkChar("dim_n_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 520, mkChar("dim_n_R_stepdown_unconf_1"));
  SET_STRING_ELT(nms, 521, mkChar("dim_n_R_stepdown_unconf_2"));
  SET_STRING_ELT(nms, 522, mkChar("dim_n_R_stepdown_unconf_to_conf"));
  SET_STRING_ELT(nms, 523, mkChar("dim_n_R_stepdown_unconf_to_conf_1"));
  SET_STRING_ELT(nms, 524, mkChar("dim_n_R_stepdown_unconf_to_conf_2"));
  SET_STRING_ELT(nms, 525, mkChar("dim_n_SE"));
  SET_STRING_ELT(nms, 526, mkChar("dim_N_tot"));
  ...
  SET_STRING_ELT(nms, 598, mkChar("dim_p_hosp_ILI"));
  ...
  SET_STRING_ELT(nms, 706, mkChar("n_EE"));
  SET_STRING_ELT(nms, 707, mkChar("n_EI_asympt"));
  SET_STRING_ELT(nms, 708, mkChar("n_EI_ILI"));
  SET_STRING_ELT(nms, 709, mkChar("n_EI_mild"));
  SET_STRING_ELT(nms, 710, mkChar("n_hosp_non_ICU"));
  SET_STRING_ELT(nms, 711, mkChar("n_I_hosp_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 712, mkChar("n_I_hosp_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 713, mkChar("n_I_ICU_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 714, mkChar("n_I_ICU_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 715, mkChar("n_I_triage_D_unconf_to_conf"));
  SET_STRING_ELT(nms, 716, mkChar("n_I_triage_R_unconf_to_conf"));
  SET_STRING_ELT(nms, 717, mkChar("n_II_asympt"));
  SET_STRING_ELT(nms, 718, mkChar("n_II_comm_D"));
  SET_STRING_ELT(nms, 719, mkChar("n_II_hosp_D_conf"));
  SET_STRING_ELT(nms, 720, mkChar("n_II_hosp_D_unconf"));
  SET_STRING_ELT(nms, 721, mkChar("n_II_hosp_R_conf"));
  SET_STRING_ELT(nms, 722, mkChar("n_II_hosp_R_unconf"));
  SET_STRING_ELT(nms, 723, mkChar("n_II_ICU_D_conf"));
  SET_STRING_ELT(nms, 724, mkChar("n_II_ICU_D_unconf"));
  SET_STRING_ELT(nms, 725, mkChar("n_II_ICU_R_conf"));
  SET_STRING_ELT(nms, 726, mkChar("n_II_ICU_R_unconf"));
  SET_STRING_ELT(nms, 727, mkChar("n_II_ILI"));
  SET_STRING_ELT(nms, 728, mkChar("n_II_mild"));
  SET_STRING_ELT(nms, 729, mkChar("n_II_triage_D_conf"));
  SET_STRING_ELT(nms, 730, mkChar("n_II_triage_D_unconf"));
  SET_STRING_ELT(nms, 731, mkChar("n_II_triage_R_conf"));
  SET_STRING_ELT(nms, 732, mkChar("n_II_triage_R_unconf"));
  SET_STRING_ELT(nms, 733, mkChar("n_ILI_to_comm_D"));
  SET_STRING_ELT(nms, 734, mkChar("n_ILI_to_hosp"));
  SET_STRING_ELT(nms, 735, mkChar("n_ILI_to_hosp_D"));
  SET_STRING_ELT(nms, 736, mkChar("n_ILI_to_hosp_D_conf"));
  SET_STRING_ELT(nms, 737, mkChar("n_ILI_to_hosp_R"));
  SET_STRING_ELT(nms, 738, mkChar("n_ILI_to_hosp_R_conf"));
  SET_STRING_ELT(nms, 739, mkChar("n_ILI_to_triage"));
  SET_STRING_ELT(nms, 740, mkChar("n_ILI_to_triage_D"));
  SET_STRING_ELT(nms, 741, mkChar("n_ILI_to_triage_D_conf"));
  SET_STRING_ELT(nms, 742, mkChar("n_ILI_to_triage_R"));
  SET_STRING_ELT(nms, 743, mkChar("n_ILI_to_triage_R_conf"));
  SET_STRING_ELT(nms, 744, mkChar("n_R_pre"));
  SET_STRING_ELT(nms, 745, mkChar("n_R_stepdown_conf"));
  SET_STRING_ELT(nms, 746, mkChar("n_R_stepdown_unconf"));
  SET_STRING_ELT(nms, 747, mkChar("n_R_stepdown_unconf_to_conf"));
  SET_STRING_ELT(nms, 748, mkChar("n_SE"));
  SET_STRING_ELT(nms, 749, mkChar("N_tot"));
  ...
  SET_STRING_ELT(nms, 795, mkChar("p_hosp_ILI"));
  SET_STRING_ELT(nms, 796, mkChar("p_ICU_hosp"));
  SET_STRING_ELT(nms, 797, mkChar("p_II_asympt"));
  SET_STRING_ELT(nms, 798, mkChar("p_II_comm_D"));
  SET_STRING_ELT(nms, 799, mkChar("p_II_hosp_D"));
  SET_STRING_ELT(nms, 800, mkChar("p_II_hosp_R"));
  SET_STRING_ELT(nms, 801, mkChar("p_II_ICU_D"));
  SET_STRING_ELT(nms, 802, mkChar("p_II_ICU_R"));
  SET_STRING_ELT(nms, 803, mkChar("p_II_ILI"));
  SET_STRING_ELT(nms, 804, mkChar("p_II_mild"));
  SET_STRING_ELT(nms, 805, mkChar("p_II_triage"));
  SET_STRING_ELT(nms, 806, mkChar("p_R_pre"));
  SET_STRING_ELT(nms, 807, mkChar("p_R_stepdown"));
...
void hospital_with_serology_testing_rhs(hospital_with_serology_testing_internal* internal, size_t step, double * state, double * state_next, double * output) {
  ...
  for (int i = 1; i <= internal->dim_delta_R_pos; ++i) {
    internal->delta_R_pos[i - 1] = Rf_rbinom(round(internal->n_R_pre[internal->dim_n_R_pre_1 * (internal->s_R_pre - 1) + i - 1]), internal->p_seroconversion[i - 1]);
  }
  for (int i = 1; i <= internal->dim_n_com_to_R_pre; ++i) {
    internal->n_com_to_R_pre[i - 1] = odin_sum3(internal->n_EE, i - 1, i, internal->s_E - 1, internal->s_E, 0, internal->dim_n_EE_3, internal->dim_n_EE_1, internal->dim_n_EE_12);
  }
  for (int i = 1; i <= internal->dim_n_EI_asympt_1; ++i) {
    for (int j = 1; j <= internal->dim_n_EI_asympt_2; ++j) {
      internal->n_EI_asympt[i - 1 + internal->dim_n_EI_asympt_1 * (j - 1)] = Rf_rbinom(round(internal->n_EE[internal->dim_n_EE_12 * (j - 1) + internal->dim_n_EE_1 * (internal->s_E - 1) + i - 1]), internal->p_asympt[i - 1]);
  ...
  for (int i = 1; i <= internal->dim_delta_R_neg; ++i) {
    internal->delta_R_neg[i - 1] = internal->n_R_pre[internal->dim_n_R_pre_1 * (internal->s_R_pre - 1) + i - 1] - internal->delta_R_pos[i - 1];
  }
  for (int i = 1; i <= internal->dim_lambda; ++i) {
    internal->lambda[i - 1] = beta * odin_sum2(internal->s_ij, i - 1, i, 0, internal->dim_s_ij_2, internal->dim_s_ij_1);
  }
