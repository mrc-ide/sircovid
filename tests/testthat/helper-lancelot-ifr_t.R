...
reference_data_lancelot_ifr_t <- function() {
  load_reference("data/lancelot_ifr_t.rds", {
...
calculate_lancelot_ifr_t_simple <- function(dat) {
  ...
  lancelot_ifr_t_trajectories(dat$trajectories$step, S, I_weighted, p)
}
