...
test_that("can run the basic model", {
  ...
  expected <-
    rbind(icu        = c(91, 38, 81, 66, 73, 59, 40, 48, 28, 119),
          deaths     = c(267882, 268268, 267244, 267537, 268241, 268749,
                         267639, 267850, 266956, 267189),
          deaths_inc = c(33, 14, 28, 19, 27, 33, 10, 20, 4, 43))
