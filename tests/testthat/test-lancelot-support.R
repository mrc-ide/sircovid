...
test_that("lancelot_index switches work as expected", {
  ...
  expect_equal(
    ...
    c(info$index$hosp_tot,
      ...
      info$index$all_cases_0_9_inc,
      info$index$all_cases_10_19_inc,
      info$index$all_cases_20_29_inc,
      info$index$all_cases_30_39_inc,
      info$index$all_cases_40_49_inc,
      info$index$all_cases_50_59_inc,
      info$index$all_cases_60_69_inc,
      info$index$all_cases_70_79_inc,
      info$index$all_cases_80_plus_inc,
