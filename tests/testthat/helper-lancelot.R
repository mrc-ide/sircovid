helper_lancelot_data <- function(data, start_date, dt) {
  expected <- c(deaths_hosp = NA_real_, deaths_comm = NA_real_,
                ...
                all_admission = NA_real_, admissions_0_9 = NA_real_,
                admissions_10_19 = NA_real_, admissions_20_29 = NA_real_,
                admissions_30_39 = NA_real_, admissions_40_49 = NA_real_,
                admissions_50_59 = NA_real_, admissions_60_69 = NA_real_,
                admissions_70_79 = NA_real_, admissions_80_plus = NA_real_,
                sero_pos_15_64_1 = NA_real_,
