...
test_that("can run the carehomes model", {
  ...
  expected <-
    rbind(icu                                = c(103, 185, 101, 1236,
                                                 168),
          general                            = c(421, 758, 489, 4882,
                                                 686),
          deaths_carehomes_inc               = c(0, 0, 0, 0, 0),
          deaths_comm_inc                    = c(0, 0, 0, 0, 0),
          deaths_hosp_inc                    = c(21, 47, 23, 289, 34),
          admitted_inc                       = c(8, 7, 12, 52, 5),
          diagnoses_inc                      = c(20, 47, 24, 344, 42),
          sero_pos                           = c(3628879, 4402733, 3751595,
                                                 7584582, 4135012),
          sympt_cases_inc                    = c(283, 523, 339, 3514,
                                                 405),
          sympt_cases_over25_inc             = c(242, 444, 272, 2906,
                                                 329),
          sympt_cases_non_variant_over25_inc = c(242, 444, 272, 2906,
                                                 329),
          react_pos                          = c(22085, 39869, 24069,
                                                 263002, 32085),
          deaths_carehomes                   = c(23294, 23346, 23320,
                                                 23469, 23599),
          deaths_comm                        = c(0, 0, 0, 0, 0),
          deaths_hosp                        = c(194744, 195114, 196428,
                                                 192244, 195593),
          admitted                           = c(88520, 88876, 89397,
                                                 88090, 88955),
          diagnoses                          = c(296464, 296122, 296283,
                                                 292785, 295754),
          sympt_cases                        = c(9762818, 9760427, 9755310,
                                                 9721745, 9755652),
          sympt_cases_over25                 = c(7447813, 7443110, 7440901,
                                                 7410852, 7441381))
