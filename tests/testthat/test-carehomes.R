...
test_that("can run the carehomes model", {
  ...
  expected <-
    rbind(icu                                = c(1550, 64, 302, 419,
                                                 27),
          general                            = c(6047, 273, 1213, 1585,
                                                 122),
          deaths_carehomes_inc               = c(0, 0, 0, 0, 0),
          deaths_comm_inc                    = c(0, 0, 0, 0, 0),
          deaths_hosp_inc                    = c(375, 11, 64, 75, 7),
          admitted_inc                       = c(99, 3, 14, 19, 2),
          diagnoses_inc                      = c(367, 9, 81, 98, 7),
          sero_pos_1                         = c(9854272, 4551807, 6864515,
                                                 7404383, 3665056),
          sympt_cases_inc                    = c(4745, 186, 812, 1001,
                                                 93),
          sympt_cases_over25_inc             = c(3916, 146, 659, 829,
                                                 79),
          sympt_cases_non_variant_over25_inc = c(3916, 146, 659, 829,
                                                 79),
          react_pos                          = c(343892, 13446, 60258,
                                                 82067, 6387),
          deaths_carehomes                   = c(23308, 23548, 23727,
                                                 23660, 23466),
          deaths_comm                        = c(0, 0, 0, 0, 0),
          deaths_hosp                        = c(191332, 194991, 195175,
                                                 195676, 195952),
          admitted                           = c(88022, 88633, 89224,
                                                 89153, 89475),
          diagnoses                          = c(291857, 295204, 295651,
                                                 296424, 296497),
          sympt_cases                        = c(9712372, 9751264, 9756159,
                                                 9756519, 9767247),
          sympt_cases_over25                 = c(7404013, 7435732, 7441811,
                                                 7441375, 7451372))
