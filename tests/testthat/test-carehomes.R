...
test_that("can run the carehomes model", {
  ...
  expected <- rbind(
    c(4, 26, 2, 13, 6),
    c(32, 72, 11, 37, 33),
    c(15825, 15971, 15955, 15914, 15882),
    c(305577, 305933, 305954, 305572, 306014),
    c(321401, 321903, 321909, 321486, 321896),
    c(151349, 150757, 151137, 150569, 150964),
    c(483755, 484827, 484942, 483498, 483546),
    c(2033, 5320, 932, 3088, 2122),
    c(5470674, 5472544, 5474482, 5473012, 5475747),
    c(25149548, 25144489, 25147586, 25147430, 25145179))
