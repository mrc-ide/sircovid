...
test_that("can run the carehomes model", {
  ...
  expected <-
    rbind(icu                                = c(484, 1816, 293, 89,
                                                 99),
          general                            = c(1777, 6764, 1227, 394,
                                                 379),
          deaths_carehomes_inc               = c(0, 0, 0, 0, 0),
          deaths_comm_inc                    = c(0, 0, 0, 0, 0),
          deaths_hosp_inc                    = c(103, 408, 75, 22, 28),
          admitted_inc                       = c(29, 111, 21, 7, 6),
          diagnoses_inc                      = c(99, 453, 74, 22, 21),
          sero_pos                           = c(6106244, 8861204, 5416835,
                                                 3757215, 3695089),
          sympt_cases_inc                    = c(1226, 5242, 753, 241,
                                                 273),
          sympt_cases_over25_inc             = c(1023, 4299, 626, 204,
                                                 217),
          sympt_cases_non_variant_over25_inc = c(1023, 4299, 626, 204,
                                                 217),
          react_pos                          = c(94195, 382269, 62796,
                                                 19478, 18445),
          deaths_carehomes                   = c(23257, 23768, 23552,
                                                 23397, 23476),
          deaths_comm                        = c(0, 0, 0, 0, 0),
          deaths_hosp                        = c(194027, 191527, 195246,
                                                 196452, 195591),
          admitted                           = c(92333, 91160, 91762,
                                                 92209, 92586),
          diagnoses                          = c(292300, 289947, 294044,
                                                 293879, 293710),
          sympt_cases                        = c(9754186, 9709688, 9756572,
                                                 9766508, 9757159),
          sympt_cases_over25                 = c(7439021, 7403703, 7441029,
                                                 7447411, 7441091))
