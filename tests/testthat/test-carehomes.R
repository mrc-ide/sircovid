...
test_that("can run the carehomes model", {
  ...
  expected <-
    rbind(icu                                = c(104, 155, 122, 819,
                                                 186),
          general                            = c(391, 635, 410, 3114,
                                                 650),
          deaths_carehomes_inc               = c(0, 0, 0, 0, 0),
          deaths_comm_inc                    = c(0, 3, 2, 19, 4),
          deaths_hosp_inc                    = c(23, 35, 30, 166, 37),
          admitted_inc                       = c(6, 5, 5, 38, 9),
          diagnoses_inc                      = c(22, 37, 23, 212, 41),
          sero_pos                           = c(3618143, 4213121, 3738090,
                                                 6836608, 4239324),
          sympt_cases_inc                    = c(279, 424, 313, 2356,
                                                 476),
          sympt_cases_over25_inc             = c(229, 346, 266, 1898,
                                                 388),
          sympt_cases_non_variant_over25_inc = c(229, 346, 266, 1898,
                                                 388),
          react_pos                          = c(21692, 34565, 24032,
                                                 177155, 35786),
          deaths_carehomes                   = c(1615, 1707, 1661, 1683,
                                                 1668),
          deaths_comm                        = c(22570, 22569, 22451,
                                                 22621, 22294),
          deaths_hosp                        = c(196458, 196182, 197168,
                                                 194572, 196897),
          admitted                           = c(89072, 89034, 89036,
                                                 88700, 88866),
          diagnoses                          = c(295420, 294845, 295105,
                                                 293057, 293990),
          sympt_cases                        = c(9759088, 9761332, 9763443,
                                                 9735526, 9745510),
          sympt_cases_over25                 = c(7444234, 7446175, 7447082,
                                                 7424086, 7430691))
