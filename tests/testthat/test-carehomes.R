...
test_that("can run the carehomes model", {
  ...
  expected <-
    rbind(icu                                = c(2, 1, 6, 8, 0),
          general                            = c(8, 10, 31, 18, 2),
          deaths_comm_inc                    = c(0, 0, 0, 0, 0),
          deaths_hosp_inc                    = c(1, 0, 1, 0, 0),
          admitted_inc                       = c(0, 0, 0, 0, 0),
          diagnoses_inc                      = c(1, 0, 1, 0, 0),
          sero_pos                           = c(2968054, 2874820, 3867715,
                                                 3617388, 2223439),
          sympt_cases_inc                    = c(3, 1, 4, 9, 0),
          sympt_cases_over25_inc             = c(2, 1, 3, 8, 0),
          sympt_cases_non_variant_over25_inc = c(2, 1, 3, 8, 0),
          react_pos                          = c(217, 194, 695, 587,
                                                 62),
          deaths_comm                        = c(23323, 23610, 23351,
                                                 23614, 23525),
          deaths_hosp                        = c(285576, 286187, 286132,
                                                 285598, 287147),
          admitted                           = c(133056, 133317, 133566,
                                                 133342, 133581),
          diagnoses                          = c(425408, 424899, 424862,
                                                 425331, 425413),
          sympt_cases                        = c(13053218, 13054506,
                                                 13058035, 13058705, 13068512),
          sympt_cases_over25                 = c(10156764, 10153203,
                                                 10157030, 10158010, 10166892))
