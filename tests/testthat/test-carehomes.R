...
test_that("can run the carehomes model", {
  ...
  expected <- rbind(
    ...
    deaths_comm = c(23673, 23552, 23356, 23393, 23559),
    deaths_hosp = c(283863, 283386, 282999, 283381, 282816),
    admitted = c(132186, 132127, 132194, 132371, 131876),
    new = c(420641, 420342, 421052, 420902, 420616),
    sero_pos = c(33479733, 4526778, 3009279, 3530181, 2305953),
    sympt_cases = c(12981502, 12975660, 12980511, 12978842, 12976269),
    sympt_cases_over25 = c(10089657, 10087311, 10087309, 10089215, 10085237),
