...
test_that("Test compiled lancelot components", {
  ...
  partial <- list(
    ...
    c(general = 50),
    c(hosp = 50),
    c(deaths_hosp_0_49 = 1, deaths_hosp_50_54 = 1, deaths_hosp_55_59 = 1,
      deaths_hosp_60_64 = 2, deaths_hosp_65_69 = 5, deaths_hosp_70_74 = 5,
      deaths_hosp_75_79 = 5, deaths_hosp_80_plus = 10,
      deaths_hosp = 30, deaths_carehomes = 10, deaths_comm = 10),
