...
test_that("can run the lancelot model", {
  ...
  expected <-
    rbind(time                               = c(213, 213, 213, 213,
          ...
          deaths_hosp_inc_0_49               = c(1, 0, 1, 1, 1),
          deaths_hosp_inc_50_54              = c(0, 1, 0, 1, 1),
          deaths_hosp_inc_55_59              = c(3, 3, 0, 0, 0),
          deaths_hosp_inc_60_64              = c(6, 4, 2, 2, 3),
          deaths_hosp_inc_65_69              = c(4, 12, 0, 3, 1),
          deaths_hosp_inc_70_74              = c(2, 4, 1, 2, 3),
          deaths_hosp_inc_75_79              = c(3, 1, 1, 1, 3),
          deaths_hosp_inc_80_plus            = c(6, 9, 4, 6, 1),
...
test_that("Test compiled lancelot components", {
  ...
  partial <- list(
    ...
    c(general = 50),
    c(hosp = 50),
    c(deaths_hosp_0_49 = 1, deaths_hosp_50_54 = 1, deaths_hosp_55_59 = 3,
      deaths_hosp_60_64 = 5, deaths_hosp_65_69 = 5, deaths_hosp_70_74 = 5,
      deaths_hosp_75_79 = 5, deaths_hosp_80_plus = 5, deaths_hosp = 30,
      deaths_carehomes = 10, deaths_comm = 10),
