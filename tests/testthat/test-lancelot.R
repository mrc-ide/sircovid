...
test_that("can run the lancelot model", {
  ...
  expected <-
    rbind(time                               = c(213, 213, 213, 213,
          ...
          admitted_0_9_inc                   = c(0, 0, 0, 0, 0),
          admitted_10_19_inc                 = c(0, 0, 0, 0, 0),
          admitted_20_29_inc                 = c(0, 1, 0, 0, 0),
          admitted_30_39_inc                 = c(1, 0, 1, 0, 0),
          admitted_40_49_inc                 = c(0, 0, 0, 0, 0),
          admitted_50_59_inc                 = c(1, 1, 0, 1, 1),
          admitted_60_69_inc                 = c(1, 2, 0, 1, 1),
          admitted_70_79_inc                 = c(0, 3, 1, 0, 0),
          admitted_80_plus_inc               = c(1, 1, 0, 2, 0),
          diagnoses_inc                      = c(21, 35, 13, 19, 12),
          diagnoses_0_9_inc                  = c(0, 1, 0, 0, 0),
          diagnoses_10_19_inc                = c(0, 0, 0, 0, 0),
          diagnoses_20_29_inc                = c(0, 1, 0, 0, 0),
          diagnoses_30_39_inc                = c(0, 1, 0, 1, 0),
          diagnoses_40_49_inc                = c(0, 0, 0, 1, 0),
          diagnoses_50_59_inc                = c(5, 10, 1, 3, 2),
          diagnoses_60_69_inc                = c(4, 8, 6, 4, 4),
          diagnoses_70_79_inc                = c(5, 5, 4, 6, 4),
          diagnoses_80_plus_inc              = c(7, 9, 2, 4, 2),
