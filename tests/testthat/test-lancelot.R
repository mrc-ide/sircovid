...
test_that("can run the lancelot model", {
  ...
  expected <-
    rbind(time                               = c(213, 213, 213, 213,
          ...
          deaths_comm_50_54_inc              = c(0, 0, 0, 0, 1),
          deaths_comm_55_59_inc              = c(0, 0, 0, 0, 1),
          deaths_comm_60_64_inc              = c(0, 1, 0, 0, 0),
          deaths_comm_65_69_inc              = c(0, 0, 0, 0, 1),
          deaths_comm_70_74_inc              = c(0, 0, 0, 1, 0),
          deaths_comm_75_79_inc              = c(0, 0, 0, 0, 0),
          deaths_comm_80_plus_inc            = c(2, 1, 0, 1, 0),
          ...
          all_admission_0_9_inc              = c(0, 1, 0, 0, 0),
          all_admission_10_19_inc            = c(0, 0, 0, 0, 0),
          all_admission_20_29_inc            = c(0, 2, 0, 0, 0),
          all_admission_30_39_inc            = c(1, 1, 1, 1, 0),
          all_admission_40_49_inc            = c(0, 0, 0, 1, 0),
          all_admission_50_59_inc            = c(6, 11, 1, 4, 3),
          all_admission_60_69_inc            = c(5, 10, 6, 5, 5),
          all_admission_70_79_inc            = c(5, 8, 5, 6, 4),
          all_admission_80_plus_inc          = c(8, 10, 2, 6, 2),
          ...
          react_pos                          = c(17991, 34665, 8306,
                                                 16312, 12742),
          react_5_24_pos                     = c(3806, 7206, 1691, 3394, 2691),
          react_25_34_pos                    = c(2486, 4975.50, 1116, 2336,
                                                 1838.25),
          react_35_44_pos                    = c(2350, 4556.50, 1085, 2154,
                                                 1653.25),
          react_45_54_pos                    = c(2716, 5273.50, 1277, 2500,
                                                 1932.25),
          react_55_64_pos                    = c(2728, 5236.50, 1291, 2359,
                                                 1945.25),
          react_65_plus_pos                  = c(3905, 7417, 1846, 3569, 2682),
