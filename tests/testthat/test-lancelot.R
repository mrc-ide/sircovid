...
test_that("can run the lancelot model", {
  ...
  expected <-
    rbind(time                               = c(213, 213, 213, 213,
                                                 213),
          icu                                = c(66, 49, 88, 96, 63),
          general                            = c(259, 188, 358, 421,
                                                 235),
          deaths_carehomes_inc               = c(0, 0, 0, 0, 0),
          deaths_comm_inc                    = c(1, 0, 0, 2, 1),
          deaths_comm_0_49_inc               = c(0, 0, 0, 0, 0),
          deaths_comm_50_54_inc              = c(0, 0, 0, 0, 0),
          deaths_comm_55_59_inc              = c(0, 0, 0, 0, 0),
          deaths_comm_60_64_inc              = c(0, 0, 0, 0, 0),
          deaths_comm_65_69_inc              = c(0, 0, 0, 1, 0),
          deaths_comm_70_74_inc              = c(0, 0, 0, 0, 0),
          deaths_comm_75_79_inc              = c(0, 0, 0, 0, 0),
          deaths_comm_80_plus_inc            = c(1, 0, 0, 1, 1),
          deaths_hosp_inc                    = c(14, 7, 17, 25, 8),
          deaths_hosp_0_49_inc               = c(2, 0, 0, 2, 1),
          deaths_hosp_50_54_inc              = c(0, 0, 0, 4, 0),
          deaths_hosp_55_59_inc              = c(0, 1, 3, 1, 0),
          deaths_hosp_60_64_inc              = c(2, 0, 1, 3, 3),
          deaths_hosp_65_69_inc              = c(1, 1, 2, 2, 1),
          deaths_hosp_70_74_inc              = c(1, 1, 1, 2, 2),
          deaths_hosp_75_79_inc              = c(1, 0, 4, 4, 0),
          deaths_hosp_80_plus_inc            = c(7, 4, 6, 7, 1),
          admitted_inc                       = c(5, 1, 4, 7, 2),
          all_admission_0_9_inc              = c(0, 0, 0, 0, 0),
          all_admission_10_19_inc            = c(0, 0, 0, 0, 0),
          all_admission_20_29_inc            = c(1, 0, 0, 0, 0),
          all_admission_30_39_inc            = c(1, 0, 1, 1, 0),
          all_admission_40_49_inc            = c(1, 1, 3, 3, 1),
          all_admission_50_59_inc            = c(3, 4, 3, 7, 5),
          all_admission_60_69_inc            = c(5, 2, 8, 8, 4),
          all_admission_70_79_inc            = c(3, 1, 4, 8, 3),
          all_admission_80_plus_inc          = c(5, 5, 1, 7, 2),
          diagnoses_inc                      = c(14, 12, 16, 27, 13),
          sero_pos_1                         = c(5103097, 4594396, 5411812,
                                                 5614766, 4742622),
          sero_pos_2                         = c(5099404, 4592730, 5413549,
                                                 5616868, 4740861),
          sympt_cases_inc                    = c(173, 91, 207, 222, 129),
          sympt_cases_non_variant_inc        = c(173, 91, 207, 222, 129),
          sympt_cases_over25_inc             = c(147, 76, 174, 192, 108),
          sympt_cases_under15_inc            = c(14, 13, 20, 21, 11),
          sympt_cases_15_24_inc              = c(12, 2, 13, 9, 10),
          sympt_cases_25_49_inc              = c(49, 27, 57, 58, 31),
          sympt_cases_50_64_inc              = c(32, 17, 59, 56, 40),
          sympt_cases_65_79_inc              = c(40, 24, 37, 46, 27),
          sympt_cases_80_plus_inc            = c(26, 8, 21, 32, 10),
          sympt_cases_non_variant_over25_inc = c(147, 76, 174, 192, 108),
          ons_pos                            = c(14094.6, 9680.4, 17572.2,
                                                 20238.2, 10726.2),
          react_pos                          = c(13578, 9354, 16911,
                                                 19472, 10323),
          react_5_24_pos                     = c(2830, 1937, 3537, 4105,
                                                 2092),
          react_25_34_pos                    = c(2015, 1380, 2422, 2825,
                                                 1540),
          react_35_44_pos                    = c(1743, 1211, 2264, 2502,
                                                 1376),
          react_45_54_pos                    = c(2046, 1378, 2508, 2887,
                                                 1509),
          react_55_64_pos                    = c(2037, 1415, 2621, 3031,
                                                 1558),
          react_65_plus_pos                  = c(2907, 2033, 3559, 4122,
                                                 2248),
          deaths_carehomes                   = c(1702, 1657, 1626, 1708,
                                                 1682),
          deaths_comm                        = c(24479, 24203, 24291,
                                                 24392, 24190),
          deaths_hosp                        = c(212115, 211328, 211115,
                                                 211460, 211861),
          admitted                           = c(96195, 95986, 95802,
                                                 95327, 96060),
          diagnoses                          = c(316826, 316375, 316694,
                                                 316332, 315649),
          sympt_cases                        = c(10271060, 10264841,
                                                 10260773, 10259895, 10262460),
          sympt_cases_over25                 = c(7894127, 7885560, 7881931,
                                                 7883051, 7884470))
