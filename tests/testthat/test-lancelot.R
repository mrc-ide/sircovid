  ...
  expected <-
    rbind(time                               = c(213, 213, 213, 213,
          ...
          sympt_cases_non_variant_over25_inc = c(205, 324, 103, 176,
                                                 119),
          ons_pos                            = c(18636.6, 35986.2, 8608.4,
                                                 16931.2, 13236.4),
          react_pos                          = c(17991, 34665, 8306,
                                                 16312, 12742),
          react_5_24_pos                     = c(3806, 7206, 1691, 3394,
                                                 2691),
          react_25_34_pos                    = c(2486, 4975.5, 1116,
                                                 2336, 1838.25),
          react_35_44_pos                    = c(2350, 4556.5, 1085,
                                                 2154, 1653.25),
          react_45_54_pos                    = c(2716, 5273.5, 1277,
                                                 2500, 1932.25),
          react_55_64_pos                    = c(2728, 5236.5, 1291,
                                                 2359, 1945.25),
          react_65_plus_pos                  = c(3905, 7417, 1846, 3569,
                                                 2682),
