...
update(S[, 1]) <- S[i, 1] - n_SS[i, 1] - n_SE[i, 1]
...
dim(p_SS) <- c(N_age, N_vacc_classes_minus_1)
dim(n_S_out) <- c(N_age, N_vacc_classes_minus_1)
dim(n_SS) <- c(N_age, N_vacc_classes_minus_1)
