...
update(I_triage_R[,,,]) <- new_I_triage_R[i,j,k,l]
update(I_triage_D[,,,]) <- new_I_triage_D[i,j,k,l]
update(I_hosp_R[,,,]) <- new_I_hosp_R[i,j,k,l]
...
n_II_triage_R[,,,] <- rbinom(I_triage_R[i,j,k,l], p_II_triage)
n_II_triage_D[,,,] <- rbinom(I_triage_D[i,j,k,l], p_II_triage)
n_II_hosp_R[,,,] <- rbinom(I_hosp_R[i,j,k,l], p_II_hosp_R)
...
aux_II_triage_R[,,,] <- I_triage_R[i,j,k,l]
aux_II_triage_R[,2:s_triage,,] <- aux_II_triage_R[i,j,k,l] + n_II_triage_R[i,j-1,k,l]
aux_II_triage_R[,1:s_triage,,] <- aux_II_triage_R[i,j,k,l] - n_II_triage_R[i,j,k,l]
n_I_triage_R_unconf_to_conf[,,] <- rbinom(aux_II_triage_R[i,j,k,1],p_test)
new_I_triage_R[,,,1] <- aux_II_triage_R[i,j,k,1] - n_I_triage_R_unconf_to_conf[i,j,k]
new_I_triage_R[,1,,1] <- new_I_triage_R[i,1,k,1] + n_ILI_to_triage_R[i,k] - n_ILI_to_triage_R_conf[i,k]
new_I_triage_R[,,,2] <- aux_II_triage_R[i,j,k,2] + n_I_triage_R_unconf_to_conf[i,j,k]
new_I_triage_R[,1,,2] <- new_I_triage_R[i,1,k,2] + n_ILI_to_triage_R_conf[i,k]

#Work out the I_triage_D -> I_triage_D transitions
aux_II_triage_D[,,,] <- I_triage_D[i,j,k,l]
aux_II_triage_D[,2:s_triage,,] <- aux_II_triage_D[i,j,k,l] + n_II_triage_D[i,j-1,k,l]
aux_II_triage_D[,1:s_triage,,] <- aux_II_triage_D[i,j,k,l] - n_II_triage_D[i,j,k,l]
n_I_triage_D_unconf_to_conf[,,] <- rbinom(aux_II_triage_D[i,j,k,1],p_test)
new_I_triage_D[,,,1] <- aux_II_triage_D[i,j,k,1] - n_I_triage_D_unconf_to_conf[i,j,k]
new_I_triage_D[,1,,1] <- new_I_triage_D[i,1,k,1] + n_ILI_to_triage_D[i,k] - n_ILI_to_triage_D_conf[i,k]
new_I_triage_D[,,,2] <- aux_II_triage_D[i,j,k,2] + n_I_triage_D_unconf_to_conf[i,j,k]
new_I_triage_D[,1,,2] <- new_I_triage_D[i,1,k,2] + n_ILI_to_triage_D_conf[i,k]

#Work out the I_hosp_R->I_hosp_R transitions
aux_II_hosp_R[,,,] <- I_hosp_R[i,j,k,l]
aux_II_hosp_R[,2:s_hosp_R,,] <- aux_II_hosp_R[i,j,k,l] + n_II_hosp_R[i,j-1,k,l]
aux_II_hosp_R[,1:s_hosp_R,,] <- aux_II_hosp_R[i,j,k,l] - n_II_hosp_R[i,j,k,l]
n_I_hosp_R_unconf_to_conf[,,] <- rbinom(aux_II_hosp_R[i,j,k,1],p_test)
new_I_hosp_R[,,,1] <- aux_II_hosp_R[i,j,k,1] - n_I_hosp_R_unconf_to_conf[i,j,k]
new_I_hosp_R[,1,,1] <- new_I_hosp_R[i,1,k,1] + n_ILI_to_hosp_R[i,k] - n_ILI_to_hosp_R_conf[i,k]
new_I_hosp_R[,,,2] <- aux_II_hosp_R[i,j,k,2] + n_I_hosp_R_unconf_to_conf[i,j,k]
new_I_hosp_R[,1,,2] <- new_I_hosp_R[i,1,k,2] + n_ILI_to_hosp_R_conf[i,k]

#Work out the I_hosp_D->I_hosp_D transitions
aux_II_hosp_D[,,,] <- I_hosp_D[i,j,k,l]
aux_II_hosp_D[,2:s_hosp_D,,] <- aux_II_hosp_D[i,j,k,l] + n_II_hosp_D[i,j-1,k,l]
aux_II_hosp_D[,1:s_hosp_D,,] <- aux_II_hosp_D[i,j,k,l] - n_II_hosp_D[i,j,k,l]
n_I_hosp_D_unconf_to_conf[,,] <- rbinom(aux_II_hosp_D[i,j,k,1],p_test)
new_I_hosp_D[,,,1] <- aux_II_hosp_D[i,j,k,1] - n_I_hosp_D_unconf_to_conf[i,j,k]
new_I_hosp_D[,1,,1] <- new_I_hosp_D[i,1,k,1] + n_ILI_to_hosp_D[i,k] - n_ILI_to_hosp_D_conf[i,k]
new_I_hosp_D[,,,2] <- aux_II_hosp_D[i,j,k,2] + n_I_hosp_D_unconf_to_conf[i,j,k]
new_I_hosp_D[,1,,2] <- new_I_hosp_D[i,1,k,2] + n_ILI_to_hosp_D_conf[i,k]

#Work out the I_ICU_R->I_ICU_R transitions
aux_II_ICU_R[,,,] <- I_ICU_R[i,j,k,l]
aux_II_ICU_R[,1,,] <- aux_II_ICU_R[i,j,k,l] + n_II_triage_R[i,s_triage,k,l]
aux_II_ICU_R[,2:s_ICU_R,,] <- aux_II_ICU_R[i,j,k,l] + n_II_ICU_R[i,j-1,k,l]
aux_II_ICU_R[,1:s_ICU_R,,] <- aux_II_ICU_R[i,j,k,l] - n_II_ICU_R[i,j,k,l]
n_I_ICU_R_unconf_to_conf[,,] <- rbinom(aux_II_ICU_R[i,j,k,1],p_test)
new_I_ICU_R[,,,1] <- aux_II_ICU_R[i,j,k,1] - n_I_ICU_R_unconf_to_conf[i,j,k]
new_I_ICU_R[,,,2] <- aux_II_ICU_R[i,j,k,2] + n_I_ICU_R_unconf_to_conf[i,j,k]

#Work out the I_ICU_D->I_ICU_D transitions
aux_II_ICU_D[,,,] <- I_ICU_D[i,j,k,l]
aux_II_ICU_D[,1,,] <- aux_II_ICU_D[i,j,k,l] + n_II_triage_D[i,s_triage,k,l]
aux_II_ICU_D[,2:s_ICU_D,,] <- aux_II_ICU_D[i,j,k,l] + n_II_ICU_D[i,j-1,k,l]
aux_II_ICU_D[,1:s_ICU_D,,] <- aux_II_ICU_D[i,j,k,l] - n_II_ICU_D[i,j,k,l]
n_I_ICU_D_unconf_to_conf[,,] <- rbinom(aux_II_ICU_D[i,j,k,1],p_test)
new_I_ICU_D[,,,1] <- aux_II_ICU_D[i,j,k,1] - n_I_ICU_D_unconf_to_conf[i,j,k]
...
initial(I_triage_D[,,,]) <- I0_triage_D[i,j,k,l]
initial(I_hosp_R[,,,]) <- I0_hosp_R[i,j,k,l]
...
dim(aux_II_triage_R) <- c(N_age,s_triage,trans_classes,test_classes)
dim(new_I_triage_R) <- c(N_age,s_triage,trans_classes,test_classes)
dim(n_II_triage_R) <- c(N_age,s_triage,trans_classes,test_classes)
dim(n_I_triage_R_unconf_to_conf) <- c(N_age,s_triage,trans_classes)

#Vectors handling the I_triage_D class
dim(I_triage_D) <- c(N_age,s_triage,trans_classes,test_classes)
dim(I0_triage_D) <- c(N_age,s_triage,trans_classes,test_classes)
dim(aux_II_triage_D) <- c(N_age,s_triage,trans_classes,test_classes)
dim(new_I_triage_D) <- c(N_age,s_triage,trans_classes,test_classes)
dim(n_II_triage_D) <- c(N_age,s_triage,trans_classes,test_classes)
...
dim(I_hosp_R) <- c(N_age,s_hosp_R,trans_classes,test_classes)
dim(I0_hosp_R) <- c(N_age,s_hosp_R,trans_classes,test_classes)
dim(aux_II_hosp_R) <- c(N_age,s_hosp_R,trans_classes,test_classes)
dim(new_I_hosp_R) <- c(N_age,s_hosp_R,trans_classes,test_classes)
dim(n_II_hosp_R) <- c(N_age,s_hosp_R,trans_classes,test_classes)
dim(n_I_hosp_R_unconf_to_conf) <- c(N_age,s_hosp_R,trans_classes)

#Vectors handling the I_hosp_D class
dim(I_hosp_D) <- c(N_age,s_hosp_D,trans_classes,test_classes)
dim(I0_hosp_D) <- c(N_age,s_hosp_D,trans_classes,test_classes)
dim(aux_II_hosp_D) <- c(N_age,s_hosp_D,trans_classes,test_classes)
dim(new_I_hosp_D) <- c(N_age,s_hosp_D,trans_classes,test_classes)
dim(n_II_hosp_D) <- c(N_age,s_hosp_D,trans_classes,test_classes)
dim(n_I_hosp_D_unconf_to_conf) <- c(N_age,s_hosp_D,trans_classes)

#Vectors handling the I_ICU_R class
dim(I_ICU_R) <- c(N_age,s_ICU_R,trans_classes,test_classes)
dim(I0_ICU_R) <- c(N_age,s_ICU_R,trans_classes,test_classes)
dim(aux_II_ICU_R) <- c(N_age,s_ICU_R,trans_classes,test_classes)
dim(new_I_ICU_R) <- c(N_age,s_ICU_R,trans_classes,test_classes)
dim(n_II_ICU_R) <- c(N_age,s_ICU_R,trans_classes,test_classes)
dim(n_I_ICU_R_unconf_to_conf) <- c(N_age,s_ICU_R,trans_classes)

#Vectors handling the I_ICU_D class
dim(I_ICU_D) <- c(N_age,s_ICU_D,trans_classes,test_classes)
dim(I0_ICU_D) <- c(N_age,s_ICU_D,trans_classes,test_classes)
dim(aux_II_ICU_D) <- c(N_age,s_ICU_D,trans_classes,test_classes)
dim(new_I_ICU_D) <- c(N_age,s_ICU_D,trans_classes,test_classes)
dim(n_II_ICU_D) <- c(N_age,s_ICU_D,trans_classes,test_classes)
