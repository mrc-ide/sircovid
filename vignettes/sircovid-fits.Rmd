...
beta2_param <- mcstate::pmcmc_parameter("beta2", initial = 0.1, min = beta_min, max = beta_max)
...
diag(mcmc_proposals) <- c(0.5, 5e-6, 4e-4, 2e-6)
...
cum_deaths <- samples$trajectories$state[c("deaths_hosp", "deaths_comm"), n_steps, ]
