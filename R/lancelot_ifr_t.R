...
##'
##' @export
lancelot_ifr_t <- function(step, S, I_weighted, p, type = NULL, R = NULL) {
  ...
  IFR_by_group_and_vacc_class <-
    lancelot_IFR_t_by_group_and_vacc_class(step, p)
...
##'   multi-strain models.
##'
##' @inheritParams lancelot_ifr_t
##'
##' @return As for [lancelot_ifr_t()], except that every element is a
##'   matrix, not a vector.
##'
##' @export
...
lancelot_IFR_t_by_group_and_vacc_class <- function(step, pars) {
