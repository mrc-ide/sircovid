...
dust_basic_alloc <- function(r_pars, pars_multi, step, n_particles, n_threads, r_seed) {
  .Call("_sircovid_dust_basic_alloc", r_pars, pars_multi, step, n_particles, n_threads, r_seed, PACKAGE = "sircovid")
}
...
dust_basic_reset <- function(ptr, r_pars, step) {
  .Call("_sircovid_dust_basic_reset", ptr, r_pars, step, PACKAGE = "sircovid")
}
...
dust_basic_set_pars <- function(ptr, r_pars) {
  .Call("_sircovid_dust_basic_set_pars", ptr, r_pars, PACKAGE = "sircovid")
}
...
dust_carehomes_alloc <- function(r_pars, pars_multi, step, n_particles, n_threads, r_seed) {
  .Call("_sircovid_dust_carehomes_alloc", r_pars, pars_multi, step, n_particles, n_threads, r_seed, PACKAGE = "sircovid")
}
...
dust_carehomes_reset <- function(ptr, r_pars, step) {
  .Call("_sircovid_dust_carehomes_reset", ptr, r_pars, step, PACKAGE = "sircovid")
}
...
dust_carehomes_set_pars <- function(ptr, r_pars) {
  .Call("_sircovid_dust_carehomes_set_pars", ptr, r_pars, PACKAGE = "sircovid")
}
