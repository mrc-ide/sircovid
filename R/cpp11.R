...
dust_basic_alloc <- function(r_data, step, n_particles, n_threads, r_seed) {
  .Call("_sircovid_dust_basic_alloc", r_data, step, n_particles, n_threads, r_seed)
}
...
dust_basic_reset <- function(ptr, r_data, step) {
  .Call("_sircovid_dust_basic_reset", ptr, r_data, step)
}
...
dust_basic_simulate <- function(r_steps, r_data, r_state, r_index, n_threads, r_seed) {
  .Call("_sircovid_dust_basic_simulate", r_steps, r_data, r_state, r_index, n_threads, r_seed)
}

dust_basic_has_openmp <- function() {
  .Call("_sircovid_dust_basic_has_openmp")
}

dust_carehomes_alloc <- function(r_data, step, n_particles, n_threads, r_seed) {
  .Call("_sircovid_dust_carehomes_alloc", r_data, step, n_particles, n_threads, r_seed)
}
...
dust_carehomes_reset <- function(ptr, r_data, step) {
  .Call("_sircovid_dust_carehomes_reset", ptr, r_data, step)
}
...
dust_carehomes_simulate <- function(r_steps, r_data, r_state, r_index, n_threads, r_seed) {
  .Call("_sircovid_dust_carehomes_simulate", r_steps, r_data, r_state, r_index, n_threads, r_seed)
}

dust_carehomes_has_openmp <- function() {
  .Call("_sircovid_dust_carehomes_has_openmp")
}
