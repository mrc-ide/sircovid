...
dust_cpu_basic_filter <- function(ptr, step, save_trajectories, step_snapshot, min_log_likelihood) {
  .Call(`_sircovid_dust_cpu_basic_filter`, ptr, step, save_trajectories, step_snapshot, min_log_likelihood)
}
...
dust_cpu_lancelot_filter <- function(ptr, step, save_trajectories, step_snapshot, min_log_likelihood) {
  .Call(`_sircovid_dust_cpu_lancelot_filter`, ptr, step, save_trajectories, step_snapshot, min_log_likelihood)
}
