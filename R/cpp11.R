...
dust_basic_alloc <- function(r_pars, pars_multi, step, r_n_particles, n_threads, r_seed) {
  .Call(`_sircovid_dust_basic_alloc`, r_pars, pars_multi, step, r_n_particles, n_threads, r_seed)
}
...
dust_carehomes_alloc <- function(r_pars, pars_multi, step, r_n_particles, n_threads, r_seed) {
  .Call(`_sircovid_dust_carehomes_alloc`, r_pars, pars_multi, step, r_n_particles, n_threads, r_seed)
}
