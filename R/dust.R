...
carehomes <- R6::R6Class(
  ...
  private = list(
    ...
    I_C_1_transmission = list(has_default = FALSE, default_value = NULL,
        ...
        has_default = FALSE, default_value = NULL, rank = 0,
        min = -Inf, max = Inf, integer = FALSE), k_L = list(has_default = FALSE,
        default_value = NULL, rank = 0, min = -Inf, max = Inf,
        integer = FALSE), k_P = list(has_default = FALSE, default_value = NULL,
        rank = 0, min = -Inf, max = Inf, integer = FALSE), k_PCR_pos = list(
        has_default = FALSE, default_value = NULL, rank = 0,
        ...
        default_value = 0.1, rank = 0, min = -Inf, max = Inf,
        integer = FALSE), gamma_L = list(has_default = TRUE,
        default_value = 0.1, rank = 0, min = -Inf, max = Inf,
