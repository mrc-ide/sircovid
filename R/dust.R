...
basic <- R6::R6Class(
  ...
  public = list(
    ...
    simulate = function(step_end, device = FALSE) {
      m <- dust_basic_simulate(private$ptr_, step_end, device)
      rownames(m) <- names(private$index_)
      m
    },
    ...
    update_state = function(pars = NULL, state = NULL, step = NULL,
      ...
      info <- dust_basic_update_state(private$ptr_, pars, state, step,
                                         set_initial_state)
      if (!is.null(pars)) {
        private$info_ <- info
        private$pars_ <- pars
...
carehomes <- R6::R6Class(
  ...
  public = list(
    ...
    simulate = function(step_end, device = FALSE) {
      m <- dust_carehomes_simulate(private$ptr_, step_end, device)
      rownames(m) <- names(private$index_)
      m
    },
    ...
    update_state = function(pars = NULL, state = NULL, step = NULL,
                            set_initial_state = NULL) {
      info <- dust_carehomes_update_state(private$ptr_, pars, state, step,
                                         set_initial_state)
      if (!is.null(pars)) {
        private$info_ <- info
        private$pars_ <- pars
...
lancelot <- R6::R6Class(
  ...
  public = list(
    ...
    run = function(step_end, device = FALSE) {
      m <- dust_lancelot_run(private$ptr_, step_end, device)
      rownames(m) <- names(private$index_)
      m
    },

    simulate = function(step_end, device = FALSE) {
      m <- dust_lancelot_simulate(private$ptr_, step_end, device)
      rownames(m) <- names(private$index_)
      m
    },
    ...
    update_state = function(pars = NULL, state = NULL, step = NULL,
                            set_initial_state = NULL) {
      info <- dust_lancelot_update_state(private$ptr_, pars, state, step,
                                         set_initial_state)
      if (!is.null(pars)) {
        private$info_ <- info
        private$pars_ <- pars
